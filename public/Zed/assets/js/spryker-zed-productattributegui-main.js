(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-productattributegui-main"],{
...
function AttributeManager() {
  ...
  _attributeManager.generateDataToAdd = function (key, idAttribute, attributeMetadata) {
    ...
    for (var i in locales) {
      ...
      var item = '<input type="' + attributeMetadata.input_type + '"' + ' class="spryker-form-autocomplete form-control ui-autocomplete-input kv_attribute_autocomplete" ' + ' data-allow_input="' + attributeMetadata.allow_input + '"' + ' data-is_super="' + attributeMetadata.is_super + '"' + ' data-is_attribute_input ' + ' data-attribute_key="' + key + '" ' + ' value="" ' + ' data-id_attribute="' + idAttribute + '" ' + ' data-locale_code="' + localeData['locale_name'] + '"' + readOnly + '>' + '<span style="display: none"></span>';
      dataToAdd.push(item);
    }
