(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-productsearch-filter-reorder"],{
...
var showLoaderBar = function showLoaderBar(btn) {
  $('.progress').removeClass('hidden');
  $(btn).addClass('hidden');
};

var closeLoaderBar = function closeLoaderBar(btn) {
