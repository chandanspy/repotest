(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-item-list-table"],{
...
var ItemListContentItem = function ItemListContentItem(options) {
  $.extend(this, options);
