(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-product-set-add"],{
...
var ContentProductSetGui = function ContentProductSetGui(options) {
  $.extend(this, options);
