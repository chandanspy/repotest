(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-product-option-main"],{
...
/***/ "./vendor/spryker/product-option/assets/Zed/js/modules/assign-product.js":
/*!*******************************************************************************!*\
  !*** ./vendor/spryker/product-option/assets/Zed/js/modules/assign-product.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./main */ "./vendor/spryker/product-option/assets/Zed/js/modules/main.js");
...
function TableHandler(sourceTable, destinationTable, checkBoxNamePrefix, labelCaption, labelId, action, formFieldId) {
  ...
  tableHandler.addSelectedProduct = function (idProduct, sku, name) {
    ...
    destinationTable.dataTable().fnAddData([idProduct, decodeURIComponent((sku + '').replace(/\+/g, '%20')), decodeURIComponent((name + '').replace(/\+/g, '%20')), '<div><a data-id="' + idProduct + '" data-action="' + tableHandler.getAction() + '" href="#" class="btn btn-xs remove-item">Remove</a></div>']);
...
$(document).ready(function () {
  ...
  allProductsTable = new TableHandler($('#product-table'), $('#selectedProductsTable'), 'all_products_checkbox_', 'Products to be assigned', 'products-to-be-assigned', 'select', 'product_option_general_products_to_be_assigned');
  productOptionTable = new TableHandler($('#product-option-table'), $('#deselectedProductsTable'), 'product_category_checkbox_', 'Products to be deassigned', 'to-be-deassigned', 'deselect', 'product_option_general_products_to_be_de_assigned');
  $('#product-table').dataTable({
    destroy: true,
    fnDrawCallback: function fnDrawCallback(settings) {
...
/***/ "./vendor/spryker/product-option/assets/Zed/js/modules/main.js":
/*!*********************************************************************!*\
  !*** ./vendor/spryker/product-option/assets/Zed/js/modules/main.js ***!
  \*********************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ../../sass/main.scss */ "./vendor/spryker/product-option/assets/Zed/sass/main.scss");

var OptionValueFormHandler = __webpack_require__(/*! ./product-option-value-form-handler */ "./vendor/spryker/product-option/assets/Zed/js/modules/product-option-value-form-handler.js");
...
/***/ "./vendor/spryker/product-option/assets/Zed/js/modules/product-option-value-form-handler.js":
/*!**************************************************************************************************!*\
  !*** ./vendor/spryker/product-option/assets/Zed/js/modules/product-option-value-form-handler.js ***!
  \**************************************************************************************************/
/*! no static exports found */
...
var TranslationCopyFields = __webpack_require__(/*! ZedGuiModules/libs/translation-copy-fields */ "./vendor/spryker/gui/assets/Zed/js/modules/libs/translation-copy-fields.js");
...
OptionValueFormHandler.prototype.addOptionTranslations = function addOptionTranslations(idOfRelatedOption, productOptionValueFormSelector) {
  ...
  translationPanels.each(function (index, element) {
    ...
    productOptionValueTranslationFormSelector.getLocaleCodeField().val($(element).parent().parent().data('locale-code'));
    productOptionValueTranslationFormSelector.getNameField().attr({
      'data-translation-key': idOfRelatedOption
    });
    productOptionValueTranslationFormSelector.getKeyField().val(productOptionValueFormSelector.getValueField().val());
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./vendor/spryker/discount/assets/Zed/node_modules/jquery/dist/jquery.js"), __webpack_require__(/*! jquery */ "./vendor/spryker/discount/assets/Zed/node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./vendor/spryker/product-option/assets/Zed/js/spryker-zed-product-option-main.entry.js":
/*!**********************************************************************************************!*\
  !*** ./vendor/spryker/product-option/assets/Zed/js/spryker-zed-product-option-main.entry.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./modules/main */ "./vendor/spryker/product-option/assets/Zed/js/modules/main.js");

__webpack_require__(/*! ./modules/assign-product */ "./vendor/spryker/product-option/assets/Zed/js/modules/assign-product.js");

__webpack_require__(/*! ./modules/product-option-value-form-handler */ "./vendor/spryker/product-option/assets/Zed/js/modules/product-option-value-form-handler.js");

/***/ }),

/***/ "./vendor/spryker/product-option/assets/Zed/sass/main.scss":
/*!*****************************************************************!*\
  !*** ./vendor/spryker/product-option/assets/Zed/sass/main.scss ***!
  \*****************************************************************/
/*! no static exports found */
