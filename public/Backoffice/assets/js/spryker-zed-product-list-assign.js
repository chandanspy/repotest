(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-product-list-assign"],{
...
var inputFileRemoveFile = {
  ...
  removeFile: function removeFile($clickedBtn) {
    $clickedBtn.prev().val('');
    $clickedBtn.remove();
  }
};
...
var SelectTableAPI = function SelectTableAPI() {
  ...
  this.findSelectedProductsInTable = function (checkBox, productItemId) {
    var itemEqualId = function itemEqualId(item) {
