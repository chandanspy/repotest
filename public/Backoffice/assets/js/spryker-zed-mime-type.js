(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-mime-type"],{
...
var mimeType = {
  ...
  updateStorage: function updateStorage(idMimeType, isAllowed) {
    var index = this.getStorageElementIndexByIdMimeType(idMimeType);
  ...
  getStorageElementIndexByIdMimeType: function getStorageElementIndexByIdMimeType(idMimeType) {
  ...
  syncWithStorage: function syncWithStorage($tableBody) {
