(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["spryker-zed-product-label-form"],{
...
function TableHandler(sourceTable, destinationTable, labelCaption, labelId, formFieldId, onRemoveCallback) {
  ...
  tableHandler.addSelectedProduct = function (idProduct, sku, name) {
    ...
    destinationTable.DataTable().row.add([idProduct, decodeURIComponent((sku + '').replace(/\+/g, '%20')), decodeURIComponent((name + '').replace(/\+/g, '%20')), '<div><a data-id="' + idProduct + '" href="#" class="btn btn-xs remove-item">Remove</a></div>']).draw();
...
module.exports = {
   ...
   * @return {TableHandler}
   */
  create: function create(sourceTable, destinationTable, labelCaption, labelId, formFieldId, onRemoveCallback) {
