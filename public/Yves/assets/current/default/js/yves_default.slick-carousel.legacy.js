(window["webpackJsonp_yves_default"] = window["webpackJsonp_yves_default"] || []).push([["slick-carousel"],{
...
/***/ "./src/Pyz/Yves/ShopUi/Theme/default/components/molecules/slick-carousel/slick-carousel.ts":
/*!*************************************************************************************************!*\
  !*** ./src/Pyz/Yves/ShopUi/Theme/default/components/molecules/slick-carousel/slick-carousel.ts ***!
  \*************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SlickCarousel; });
...
var SlickCarousel = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_3___default()(SlickCarousel, _Component);
  ...
  function SlickCarousel() {
    ...
    _this.slider = void 0;
    _this.customSelects = void 0;
    return _this;
  }

  var _proto = SlickCarousel.prototype;

  _proto.readyCallback = function readyCallback() {};

  _proto.init = function init() {
    this.slider = this.getElementsByClassName(this.jsName + "__container")[0];
  ...
  _proto.mapEvents = function mapEvents() {
    ...
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_6___default()(this.slider).on('init', /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  ...
  _proto.showSlider = function showSlider() {
    this.slider.classList.add(this.name + "__container--is-inited");
  };

  _proto.sliderInit = function sliderInit() {
    var _this3 = this;

    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_6___default()(this.slider).on('init', function () {
      if (_this3.customSelects) {
        _this3.customSelects.forEach(function (select) {
          select.initSelect();
          select.changeSelectEvent();
        });
      }
    });
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_6___default()(this.slider).slick(this.sliderConfig);
  };

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(SlickCarousel, [{
    key: "sliderConfig",
    get: function get() {
      return JSON.parse(this.getAttribute('slider-config'));
    }
  }, {
    key: "customSelectClassName",
    get: function get() {
