...
/* harmony import */ var password_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! password-validator */ "./node_modules/password-validator/src/index.js");
/* harmony import */ var password_validator__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(password_validator__WEBPACK_IMPORTED_MODULE_4__);
...
var PasswordComplexityIndicator = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_1___default()(PasswordComplexityIndicator, _Component);
  ...
  function PasswordComplexityIndicator() {
    ...
    _this.availableProperties = ['min', 'lowercase', 'uppercase', 'digits', 'symbols'];
    _this.complexityGradation = new Map([['weak', 0], ['medium', 25], ['strong', 50], ['very-strong', 75]]);
    _this.currentComplexity = '';
    _this.maxPasswordComplexity = 0;
    _this.factor = 100;
    _this.inputElement = void 0;
    _this.notificationElement = void 0;
    _this.indicatorListElement = void 0;
    _this.schema = void 0;
    return _this;
  }
  ...
  _proto.init = function init() {
    ...
    this.schema = new password_validator__WEBPACK_IMPORTED_MODULE_4___default.a();
    this.initValidator();
    this.mapEvents();
  };
  ...
  _proto.mapInputElementKeyUpEvent = function mapInputElementKeyUpEvent() {
    ...
    this.inputElement.addEventListener('keyup', Object(lodash_es_debounce__WEBPACK_IMPORTED_MODULE_3__["default"])(function () {
