...
var RangeSlider = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_1___default()(RangeSlider, _Component);
  ...
  function RangeSlider() {
    ...
    _this.sliderContainer = void 0;
    _this.rangeInputs = void 0;
    _this.numberDigitsAfterDecimalPoint = 2;
    return _this;
  }
  ...
  _proto.mapEvents = function mapEvents() {
    ...
    this.rangeInputs.forEach(function (input, index) {
      input.addEventListener('change', function (event) {
        _this2.setInputValueToSlider(index, event.currentTarget.value);
      });
    });
    this.valueUpdate();
  };

  _proto.initUiSlider = function initUiSlider() {
    nouislider__WEBPACK_IMPORTED_MODULE_3___default.a.create(this.sliderContainer, this.sliderConfig);
  };

  _proto.setInputValueToSlider = function setInputValueToSlider(index, value) {
    var inputsValue = [];
    inputsValue[index] = value;
    this.sliderContainer.noUiSlider.set(inputsValue);
  };

  _proto.valueUpdate = function valueUpdate() {
    var _this3 = this;

    this.sliderContainer.noUiSlider.on('update', function (values, handle) {
      _this3.rangeInputs[handle].value = String(values[handle]);
    });
  };

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0___default()(RangeSlider, [{
    key: "wrapClassName",
    get: function get() {
      ...
      return Object.assign(JSON.parse(this.getAttribute('slider-config')), {
        format: {
          ...
          to: function to(value) {
            value = value.toFixed(_this4.numberDigitsAfterDecimalPoint) % 1 === 0 ? Math.floor(value) : value.toFixed(_this4.numberDigitsAfterDecimalPoint);
            return value;
          }
        }
      });
