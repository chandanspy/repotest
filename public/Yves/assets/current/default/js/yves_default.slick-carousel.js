...
class SlickCarousel extends ShopUi_models_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super(...arguments);
    this.slider = void 0;
    this.customSelects = void 0;
  }
  ...
  mapEvents() {
    ...
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_2___default()(this.slider).on('init', /*#__PURE__*/_asyncToGenerator(function* () {
      _this.showSlider();
  ...
  sliderInit() {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_2___default()(this.slider).on('init', () => {
    ...
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_2___default()(this.slider).slick(this.sliderConfig);
  }
