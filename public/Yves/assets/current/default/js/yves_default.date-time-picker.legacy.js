...
/* harmony import */ var jquery_datetimepicker_build_jquery_datetimepicker_full__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jquery-datetimepicker/build/jquery.datetimepicker.full */ "./node_modules/jquery-datetimepicker/build/jquery.datetimepicker.full.js");
/* harmony import */ var jquery_datetimepicker_build_jquery_datetimepicker_full__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(jquery_datetimepicker_build_jquery_datetimepicker_full__WEBPACK_IMPORTED_MODULE_4__);
...
var DateTimePicker = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_1___default()(DateTimePicker, _Component);
  ...
  _proto.datetimepickerInit = function datetimepickerInit() {
    if (this.formattedDateTime && jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.trigger).val()) {
      jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.trigger).val(this.formattedDateTime);
    }

    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default()(this.trigger).datetimepicker(this.config);
  };

  _proto.setLanguage = function setLanguage(language) {
    jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_3___default.a.datetimepicker.setLocale(language);
  };
