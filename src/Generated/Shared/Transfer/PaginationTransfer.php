...
class PaginationTransfer extends AbstractTransfer
{
    ...
    /**
     * @module CompanyPage|CompanyUserInvitationPage|CustomerPage|QuoteRequestAgentPage|QuoteRequestAgentWidget|QuoteRequestPage|SalesReturnPage|Agent|AvailabilityNotification|AvailabilityNotificationsRestApi|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|CompanyBusinessUnit|CompanyRole|CompanyUnitAddressGui|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Customer|MerchantRelationship|Merchant|Product|QuoteRequestAgent|QuoteRequest|SalesReturn|Sales
     *
     * @param int|null $page
     *
     * @return $this
    ...
    /**
     * @module CompanyPage|CompanyUserInvitationPage|CustomerPage|QuoteRequestAgentPage|QuoteRequestAgentWidget|QuoteRequestPage|SalesReturnPage|AgentAuthRestApi|Agent|AvailabilityNotification|AvailabilityNotificationsRestApi|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|CompanyBusinessUnit|CompanyRole|CompanyUnitAddressGui|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Customer|MerchantRelationship|Merchant|Product|QuoteRequestAgent|QuoteRequest|SalesReturn|Sales
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|AgentAuthRestApi|Agent|AvailabilityNotification|AvailabilityNotificationsRestApi|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Customer|MerchantRelationship|Merchant|OrdersRestApi|ProductAttribute|ProductAttributesRestApi|QuoteRequest|SalesReturn|SalesReturnsRestApi|Sales
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Customer|MerchantRelationship|Merchant|QuoteRequest|SalesReturn|Sales
     *
    ...
    /**
     * @module CustomerPage|SalesReturnPage|Agent|AvailabilityNotification|CmsBlockProductConnector|CmsSlotBlockGui|CmsSlotBlockProductCategoryGui|CmsSlotBlock|CompanyBusinessUnit|CompanyRole|CompanyUnitAddress|CompanyUserInvitation|CompanyUser|Customer|MerchantRelationship|Merchant|Product|QuoteRequest|SalesReturn|Sales
     *
