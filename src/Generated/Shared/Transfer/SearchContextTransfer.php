...
class SearchContextTransfer extends AbstractTransfer
{
    ...
    /**
     * @module Catalog|CmsPageSearch|ConfigurableBundlePageSearch|ProductNew|ProductReview|ProductSetPageSearch|ProductSet|PublishAndSynchronizeHealthCheckSearch|SalesReturnSearch|SearchElasticsearch|SearchExtension|Search
     *
