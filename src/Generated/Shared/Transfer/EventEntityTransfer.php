...
class EventEntityTransfer extends AbstractTransfer
{
    ...
    /**
     * @module AssetStorage|Asset|EventBehavior
     *
    ...
    /**
     * @module Asset|Category|CmsSlotBlockStorage|CmsSlotBlock|EventBehavior|ProductOption|ProductSearch
     *
     * @param int|null $id
     *
     * @return $this
    ...
    /**
     * @module EventBehavior|ProductOption|ProductSearch
     *
