...
class PaginationConfigTransfer extends AbstractTransfer
{
     ...
     * @var string
     */
    public const MAX_ITEMS_PER_PAGE = 'maxItemsPerPage';
    ...
    protected $transferMetadata = [
        ...
        self::MAX_ITEMS_PER_PAGE => [
            'type' => 'int',
            'type_shim' => null,
            'name_underscore' => 'max_items_per_page',
            'is_collection' => false,
            'is_transfer' => false,
            'is_value_object' => false,
            'rest_request_parameter' => 'no',
    ...
    /**
     * @module CatalogPage|Catalog|CmsPageSearch|ProductReview|SalesReturnSearch|SearchElasticsearch|Search
     *
    ...
    /**
     * @module Catalog|CmsPageSearch|ProductReview|SalesReturnSearch|SearchElasticsearch|Search
     *
    ...
    /**
     * @module Catalog|CmsPageSearch|ProductReview|SearchElasticsearch|Search
     *
     ...
     *
     * @param int|null $maxItemsPerPage
     *
     * @return $this
     */
    public function setMaxItemsPerPage($maxItemsPerPage)
    {
        ...
        $this->modifiedProperties[self::MAX_ITEMS_PER_PAGE] = true;
     ...
     * @return $this
     */
    public function setMaxItemsPerPageOrFail($maxItemsPerPage)
    {
        if ($maxItemsPerPage === null) {
            $this->throwNullValueException(static::MAX_ITEMS_PER_PAGE);
        }

        return $this->setMaxItemsPerPage($maxItemsPerPage);
    }
     ...
     * @return int
     */
    public function getMaxItemsPerPageOrFail()
    {
        if ($this->maxItemsPerPage === null) {
            $this->throwNullValueException(static::MAX_ITEMS_PER_PAGE);
        }
     ...
     * @return $this
     */
    public function requireMaxItemsPerPage()
    {
        $this->assertPropertyIsSet(self::MAX_ITEMS_PER_PAGE);
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'max_items_per_page' => $this->maxItemsPerPage,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'max_items_per_page' => $this->maxItemsPerPage instanceof AbstractTransfer ? $this->maxItemsPerPage->toArray(true, false) : $this->maxItemsPerPage,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'maxItemsPerPage' => $this->maxItemsPerPage instanceof AbstractTransfer ? $this->maxItemsPerPage->toArray(true, true) : $this->maxItemsPerPage,
        ];
    }
}
