 ...
 */
class CartCodeRequestTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const CART_CODE = 'cartCode';
    ...
    /**
     * @module CartCodeWidget|CartCode|CartCodesRestApi
     *
    ...
    public function setCartCode($cartCode)
    {
        ...
        $this->modifiedProperties[self::CART_CODE] = true;
     ...
     * @return $this
     */
    public function setCartCodeOrFail($cartCode)
    {
        if ($cartCode === null) {
            $this->throwNullValueException(static::CART_CODE);
        }

        return $this->setCartCode($cartCode);
    }
     ...
     * @return string
     */
    public function getCartCodeOrFail()
    {
     ...
     * @return $this
     */
    public function requireCartCode()
    {
        $this->assertPropertyIsSet(self::CART_CODE);
    ...
    {
        return [
            'cart_code' => $this->cartCode instanceof AbstractTransfer ? $this->cartCode->toArray(true, false) : $this->cartCode,
    ...
    {
        return [
            'cartCode' => $this->cartCode instanceof AbstractTransfer ? $this->cartCode->toArray(true, true) : $this->cartCode,
