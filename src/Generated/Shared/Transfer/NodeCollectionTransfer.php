 ...
 */
class NodeCollectionTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    ...
    /**
     * @module CategoryGui|CategoryPageSearch|CategoryStorage|Category|ProductCategoryFilterGui|ProductCategoryStorage|ProductListGui
     *
     * @param \ArrayObject|\Generated\Shared\Transfer\NodeTransfer[] $nodes
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function addNode(NodeTransfer $node)
    {
        $this->nodes[] = $node;
        $this->modifiedProperties[self::NODES] = true;
