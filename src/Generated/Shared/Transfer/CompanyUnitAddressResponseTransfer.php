 ...
 */
class CompanyUnitAddressResponseTransfer extends AbstractTransfer
{
    /**
     * @var string
     */
    public const COMPANY_UNIT_ADDRESS_TRANSFER = 'companyUnitAddressTransfer';
    ...
    /**
     * @var \Generated\Shared\Transfer\CompanyUnitAddressTransfer|null
     */
    ...
    protected $transferPropertyNameMap = [
        'company_unit_address_transfer' => 'companyUnitAddressTransfer',
    ...
    protected $transferMetadata = [
        self::COMPANY_UNIT_ADDRESS_TRANSFER => [
            'type' => 'Generated\Shared\Transfer\CompanyUnitAddressTransfer',
            'type_shim' => null,
            'name_underscore' => 'company_unit_address_transfer',
            'is_collection' => false,
            'is_transfer' => true,
     ...
     *
     * @param \Generated\Shared\Transfer\CompanyUnitAddressTransfer|null $companyUnitAddressTransfer
     *
     * @return $this
     */
    public function setCompanyUnitAddressTransfer(CompanyUnitAddressTransfer $companyUnitAddressTransfer = null)
    {
        $this->companyUnitAddressTransfer = $companyUnitAddressTransfer;
        $this->modifiedProperties[self::COMPANY_UNIT_ADDRESS_TRANSFER] = true;
     ...
     */
    public function getCompanyUnitAddressTransfer()
    {
     ...
     * @return $this
     */
    public function setCompanyUnitAddressTransferOrFail(CompanyUnitAddressTransfer $companyUnitAddressTransfer)
    {
        return $this->setCompanyUnitAddressTransfer($companyUnitAddressTransfer);
    }
     ...
     */
    public function getCompanyUnitAddressTransferOrFail()
    {
        if ($this->companyUnitAddressTransfer === null) {
            $this->throwNullValueException(static::COMPANY_UNIT_ADDRESS_TRANSFER);
        }
     ...
     * @return $this
     */
    public function requireCompanyUnitAddressTransfer()
    {
        $this->assertPropertyIsSet(self::COMPANY_UNIT_ADDRESS_TRANSFER);
        ...
        foreach ($data as $property => $value) {
            ...
            switch ($normalizedPropertyName) {
                case 'isSuccessful':
                    ...
                    break;
                case 'companyUnitAddressTransfer':
                    if (is_array($value)) {
    ...
    public function toArrayNotRecursiveCamelCased(): array
    {
        return [
            ...
            'companyUnitAddressTransfer' => $this->companyUnitAddressTransfer,
    ...
    public function toArrayNotRecursiveNotCamelCased(): array
    {
        return [
            ...
            'company_unit_address_transfer' => $this->companyUnitAddressTransfer,
            'messages' => $this->messages,
        ];
    }
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'company_unit_address_transfer' => $this->companyUnitAddressTransfer instanceof AbstractTransfer ? $this->companyUnitAddressTransfer->toArray(true, false) : $this->companyUnitAddressTransfer,
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'companyUnitAddressTransfer' => $this->companyUnitAddressTransfer instanceof AbstractTransfer ? $this->companyUnitAddressTransfer->toArray(true, true) : $this->companyUnitAddressTransfer,
