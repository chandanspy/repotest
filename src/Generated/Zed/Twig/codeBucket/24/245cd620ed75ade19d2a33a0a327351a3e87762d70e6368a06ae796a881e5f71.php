...
class __TwigTemplate_14c6fe40902fd774b752f49c6c3915d8e944b92953a19ec328bbbaed0a9576c4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_product_image_set_widget($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "product_image_collection", [], "any", false, false, false, 11));
...
";
    ...
    {
        return "@ProductSetGui/_template/product-image-set-theme.twig";
    }
    ...
    <div class=\"panel panel-default image-set\">
        ...
        <div class=\"panel-body\">
            <div class=\"sep_down m-t-sm\">
                ...
                <h3>{{ 'Images' | trans }}</h3>
                <div class=\"image-collection-container\">
                    {% for productImage in form.product_image_collection %}
...
{% endblock %}
", "@ProductSetGui/_template/product-image-set-theme.twig", "/data/vendor/spryker/product-set-gui/src/Spryker/Zed/ProductSetGui/Presentation//_template/product-image-set-theme.twig");
    }
}
