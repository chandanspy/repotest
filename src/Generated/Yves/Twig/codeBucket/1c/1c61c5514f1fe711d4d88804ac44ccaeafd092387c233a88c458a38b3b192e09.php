...
class __TwigTemplate_5b879fa0ad6fc7386e888c689e95b085bb38100ddf0d7d0d7c06f842bab2d408 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 5
        echo "    ";
        $this->loadTemplate("@CmsBlock/template/section_dark_block.twig", "@CmsBlock/template/section_dark_block.twig", 5, "483482383")->display(twig_to_array(["modifiers" => [0 => "secondary", 1 => "bg-dark"], "data" => ["blockTitle" => call_user_func_array($this->env->getFunction('spyCmsBlockPlaceholder')->getCallable(), [$context, "title"]), "blockContent" => call_user_func_array($this->env->getFunction('spyCmsBlockPlaceholder')->getCallable(), [$context, "content"]), "innerClass" => "container"]]));
    }
...
/* @CmsBlock/template/section_dark_block.twig */
class __TwigTemplate_5b879fa0ad6fc7386e888c689e95b085bb38100ddf0d7d0d7c06f842bab2d408___483482383 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return $this->loadTemplate(call_user_func_array($this->env->getFunction('organism')->getCallable(), ["section"]), "@CmsBlock/template/section_dark_block.twig", 5);
    }
