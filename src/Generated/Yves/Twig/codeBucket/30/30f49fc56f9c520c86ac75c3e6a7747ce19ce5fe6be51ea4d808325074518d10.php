...
class __TwigTemplate_aaf666b487d27c83e0bc0650c5498bb07ac1e6aff8ad18bae0690a4e1df069f9 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 1
        return $this->loadTemplate(call_user_func_array($this->env->getFunction('model')->getCallable(), ["component"]), "@@SprykerShop:ShopUi/components/molecules/toggler-click/toggler-click.twig", 1);
    }
...
if (!array_key_exists('attributes', $context)) {$context['attributes'] = [];}$context['attributes'] = array_replace_recursive(["trigger-selector" => "", "trigger-class-name" => "", "target-selector" => "", "target-class-name" => "", "class-to-toggle" => "is-hidden"], $context['attributes']);        // line 1
    ...
    {
        return array (  43 => 1,  42 => 10,  41 => 3,  34 => 1,);
    }
