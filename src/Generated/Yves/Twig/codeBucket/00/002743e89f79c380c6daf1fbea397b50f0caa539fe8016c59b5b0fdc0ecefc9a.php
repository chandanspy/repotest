...
class __TwigTemplate_abc9fbffad0cf31117fa6fcd52da2479af072c41808e31d211ee7641df84be6a extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 1
        return $this->loadTemplate(call_user_func_array($this->env->getFunction('template')->getCallable(), ["page-layout-catalog", "CatalogPage"]), "@CatalogPage/views/catalog/catalog.twig", 1);
    }
...
(isset($context["_view"]) || array_key_exists("_view", $context) ? $context["_view"] : (function () { throw new RuntimeError('Variable "_view" does not exist.', 7, $this->source); })()), "searchString", [], "any", false, false, false, 7), "category" => ((twig_get_attribute($this->env, $this->source,         // line 8
($context["_view"] ?? null), "category", [], "any", true, true, false, 8)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["_view"] ?? null), "category", [], "any", false, false, false, 8))) : ("")), "categories" => ((        // line 9
array_key_exists("categories", $context)) ? (_twig_default_filter((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 9, $this->source); })()), [])) : ([])), "categoryId" => ((twig_get_attribute($this->env, $this->source,         // line 10
($context["_view"] ?? null), "idCategory", [], "any", true, true, false, 10)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["_view"] ?? null), "idCategory", [], "any", false, false, false, 10))) : ("")), "isEmptyCategoryFilterValueVisible" => ((twig_get_attribute($this->env, $this->source,         // line 11
($context["_view"] ?? null), "isEmptyCategoryFilterValueVisible", [], "any", true, true, false, 11)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["_view"] ?? null), "isEmptyCategoryFilterValueVisible", [], "any", false, false, false, 11))) : ("")), "filterPath" => ((twig_get_attribute($this->env, $this->source,         // line 12
($context["_view"] ?? null), "filterPath", [], "any", true, true, false, 12)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["_view"] ?? null), "filterPath", [], "any", false, false, false, 12))) : ("")), "viewMode" => ((twig_get_attribute($this->env, $this->source,         // line 13
($context["_view"] ?? null), "viewMode", [], "any", true, true, false, 13)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["_view"] ?? null), "viewMode", [], "any", false, false, false, 13))) : ("")), "title" => ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 15
...
(isset($context["_view"]) || array_key_exists("_view", $context) ? $context["_view"] : (function () { throw new RuntimeError('Variable "_view" does not exist.', 24, $this->source); })()), "pagination", [], "any", false, false, false, 24), "maxPage", [], "any", false, false, false, 24), "showAlwaysFirstAndLast" => true]], $context['data']);        // line 1
    ...
    ";
        // line 31
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 31, $this->source); })()), "searchString", [], "any", false, false, false, 31))) {
            // line 32
            echo "        <input type=\"hidden\" name=\"q\" value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 32, $this->source); })()), "searchString", [], "any", false, false, false, 32), "html", null, true);
            echo "\">
    ";
        }
    }
    ...
    {
        return "@CatalogPage/views/catalog/catalog.twig";
    }
    ...
    {
        return array (  76 => 32,  74 => 31,  69 => 30,  65 => 29,  61 => 1,  60 => 24,  59 => 23,  58 => 22,  57 => 21,  56 => 18,  55 => 17,  54 => 16,  53 => 15,  52 => 13,  51 => 12,  50 => 11,  49 => 10,  48 => 9,  47 => 8,  46 => 7,  45 => 6,  44 => 5,  43 => 4,  42 => 3,  35 => 1,);
    }
...
{% block form %}
    ...
    {% endif %}
{% endblock %}
", "@CatalogPage/views/catalog/catalog.twig", "/data/vendor/spryker-shop/catalog-page/src/SprykerShop/Yves/CatalogPage/Theme/default/views/catalog/catalog.twig");
    }
}
