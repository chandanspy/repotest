...
class SpyCmsSlotToCmsSlotTemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsSlot.Persistence.Map.SpyCmsSlotToCmsSlotTemplateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_slot_to_cms_slot_template';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsSlot\\Persistence\\SpyCmsSlotToCmsSlotTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsSlot.Persistence.SpyCmsSlotToCmsSlotTemplate';
     ...
     */
    const COL_ID_CMS_SLOT_TO_CMS_SLOT_TEMPLATE = 'spy_cms_slot_to_cms_slot_template.id_cms_slot_to_cms_slot_template';

    /**
     * the column name for the fk_cms_slot field
     */
    const COL_FK_CMS_SLOT = 'spy_cms_slot_to_cms_slot_template.fk_cms_slot';

    /**
     * the column name for the fk_cms_slot_template field
     */
    const COL_FK_CMS_SLOT_TEMPLATE = 'spy_cms_slot_to_cms_slot_template.fk_cms_slot_template';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotToCmsSlotTemplate', 'FkCmsSlot', 'FkCmsSlotTemplate', ),
        self::TYPE_CAMELNAME     => array('idCmsSlotToCmsSlotTemplate', 'fkCmsSlot', 'fkCmsSlotTemplate', ),
        self::TYPE_COLNAME       => array(SpyCmsSlotToCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TO_CMS_SLOT_TEMPLATE, SpyCmsSlotToCmsSlotTemplateTableMap::COL_FK_CMS_SLOT, SpyCmsSlotToCmsSlotTemplateTableMap::COL_FK_CMS_SLOT_TEMPLATE, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_to_cms_slot_template', 'fk_cms_slot', 'fk_cms_slot_template', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotToCmsSlotTemplate' => 0, 'FkCmsSlot' => 1, 'FkCmsSlotTemplate' => 2, ),
        self::TYPE_CAMELNAME     => array('idCmsSlotToCmsSlotTemplate' => 0, 'fkCmsSlot' => 1, 'fkCmsSlotTemplate' => 2, ),
        self::TYPE_COLNAME       => array(SpyCmsSlotToCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TO_CMS_SLOT_TEMPLATE => 0, SpyCmsSlotToCmsSlotTemplateTableMap::COL_FK_CMS_SLOT => 1, SpyCmsSlotToCmsSlotTemplateTableMap::COL_FK_CMS_SLOT_TEMPLATE => 2, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_to_cms_slot_template' => 0, 'fk_cms_slot' => 1, 'fk_cms_slot_template' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyCmsSlotToCmsSlotTemplateTableMap
