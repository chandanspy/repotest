...
class SpyCmsSlotTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsSlot.Persistence.Map.SpyCmsSlotTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_slot';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsSlot\\Persistence\\SpyCmsSlot';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsSlot.Persistence.SpyCmsSlot';
     ...
     */
    const COL_ID_CMS_SLOT = 'spy_cms_slot.id_cms_slot';

    /**
     * the column name for the content_provider_type field
     */
    const COL_CONTENT_PROVIDER_TYPE = 'spy_cms_slot.content_provider_type';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_cms_slot.description';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_cms_slot.is_active';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_cms_slot.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_cms_slot.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsSlot', 'ContentProviderType', 'Description', 'IsActive', 'Key', 'Name', ),
        self::TYPE_CAMELNAME     => array('idCmsSlot', 'contentProviderType', 'description', 'isActive', 'key', 'name', ),
        self::TYPE_COLNAME       => array(SpyCmsSlotTableMap::COL_ID_CMS_SLOT, SpyCmsSlotTableMap::COL_CONTENT_PROVIDER_TYPE, SpyCmsSlotTableMap::COL_DESCRIPTION, SpyCmsSlotTableMap::COL_IS_ACTIVE, SpyCmsSlotTableMap::COL_KEY, SpyCmsSlotTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot', 'content_provider_type', 'description', 'is_active', 'key', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsSlot' => 0, 'ContentProviderType' => 1, 'Description' => 2, 'IsActive' => 3, 'Key' => 4, 'Name' => 5, ),
        self::TYPE_CAMELNAME     => array('idCmsSlot' => 0, 'contentProviderType' => 1, 'description' => 2, 'isActive' => 3, 'key' => 4, 'name' => 5, ),
        self::TYPE_COLNAME       => array(SpyCmsSlotTableMap::COL_ID_CMS_SLOT => 0, SpyCmsSlotTableMap::COL_CONTENT_PROVIDER_TYPE => 1, SpyCmsSlotTableMap::COL_DESCRIPTION => 2, SpyCmsSlotTableMap::COL_IS_ACTIVE => 3, SpyCmsSlotTableMap::COL_KEY => 4, SpyCmsSlotTableMap::COL_NAME => 5, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot' => 0, 'content_provider_type' => 1, 'description' => 2, 'is_active' => 3, 'key' => 4, 'name' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
