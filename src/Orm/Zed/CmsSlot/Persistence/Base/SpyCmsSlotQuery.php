 ...
 *
 * @method     ChildSpyCmsSlot[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsSlot objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> find(ConnectionInterface $con = null) Return ChildSpyCmsSlot objects based on current ModelCriteria
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByIdCmsSlot(int $id_cms_slot) Return ChildSpyCmsSlot objects filtered by the id_cms_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByIdCmsSlot(int $id_cms_slot) Return ChildSpyCmsSlot objects filtered by the id_cms_slot column
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByContentProviderType(string $content_provider_type) Return ChildSpyCmsSlot objects filtered by the content_provider_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByContentProviderType(string $content_provider_type) Return ChildSpyCmsSlot objects filtered by the content_provider_type column
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByDescription(string $description) Return ChildSpyCmsSlot objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByDescription(string $description) Return ChildSpyCmsSlot objects filtered by the description column
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyCmsSlot objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByIsActive(boolean $is_active) Return ChildSpyCmsSlot objects filtered by the is_active column
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByKey(string $key) Return ChildSpyCmsSlot objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByKey(string $key) Return ChildSpyCmsSlot objects filtered by the key column
 * @method     ChildSpyCmsSlot[]|ObjectCollection findByName(string $name) Return ChildSpyCmsSlot objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlot> findByName(string $name) Return ChildSpyCmsSlot objects filtered by the name column
...
abstract class SpyCmsSlotQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsSlotQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsSlotTableMap::COL_ID_CMS_SLOT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsSlotTableMap::COL_ID_CMS_SLOT, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCmsSlotQuery The current query, for fluid interface
     */
    public function filterBySpyCmsSlotToCmsSlotTemplate($spyCmsSlotToCmsSlotTemplate, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsSlotQuery The current query, for fluid interface
     */
    public function joinSpyCmsSlotToCmsSlotTemplate($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyCmsSlotToCmsSlotTemplate', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCmsSlotToCmsSlotTemplate', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
