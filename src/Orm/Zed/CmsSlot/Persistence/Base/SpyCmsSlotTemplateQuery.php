 ...
 *
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsSlotTemplate objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> find(ConnectionInterface $con = null) Return ChildSpyCmsSlotTemplate objects based on current ModelCriteria
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection findByIdCmsSlotTemplate(int $id_cms_slot_template) Return ChildSpyCmsSlotTemplate objects filtered by the id_cms_slot_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> findByIdCmsSlotTemplate(int $id_cms_slot_template) Return ChildSpyCmsSlotTemplate objects filtered by the id_cms_slot_template column
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection findByDescription(string $description) Return ChildSpyCmsSlotTemplate objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> findByDescription(string $description) Return ChildSpyCmsSlotTemplate objects filtered by the description column
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection findByName(string $name) Return ChildSpyCmsSlotTemplate objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> findByName(string $name) Return ChildSpyCmsSlotTemplate objects filtered by the name column
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection findByPath(string $path) Return ChildSpyCmsSlotTemplate objects filtered by the path column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> findByPath(string $path) Return ChildSpyCmsSlotTemplate objects filtered by the path column
 * @method     ChildSpyCmsSlotTemplate[]|ObjectCollection findByPathHash(string $path_hash) Return ChildSpyCmsSlotTemplate objects filtered by the path_hash column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotTemplate> findByPathHash(string $path_hash) Return ChildSpyCmsSlotTemplate objects filtered by the path_hash column
...
abstract class SpyCmsSlotTemplateQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsSlotTemplateQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TEMPLATE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TEMPLATE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCmsSlotTemplateQuery The current query, for fluid interface
     */
