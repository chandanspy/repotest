...
class SpyCmsBlockProductConnectorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlockProductConnector.Persistence.Map.SpyCmsBlockProductConnectorTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_product_connector';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlockProductConnector\\Persistence\\SpyCmsBlockProductConnector';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlockProductConnector.Persistence.SpyCmsBlockProductConnector';
     ...
     */
    const COL_ID_CMS_BLOCK_PRODUCT_CONNECTOR = 'spy_cms_block_product_connector.id_cms_block_product_connector';

    /**
     * the column name for the fk_cms_block field
     */
    const COL_FK_CMS_BLOCK = 'spy_cms_block_product_connector.fk_cms_block';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_cms_block_product_connector.fk_product_abstract';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockProductConnector', 'FkCmsBlock', 'FkProductAbstract', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockProductConnector', 'fkCmsBlock', 'fkProductAbstract', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockProductConnectorTableMap::COL_ID_CMS_BLOCK_PRODUCT_CONNECTOR, SpyCmsBlockProductConnectorTableMap::COL_FK_CMS_BLOCK, SpyCmsBlockProductConnectorTableMap::COL_FK_PRODUCT_ABSTRACT, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_product_connector', 'fk_cms_block', 'fk_product_abstract', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockProductConnector' => 0, 'FkCmsBlock' => 1, 'FkProductAbstract' => 2, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockProductConnector' => 0, 'fkCmsBlock' => 1, 'fkProductAbstract' => 2, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockProductConnectorTableMap::COL_ID_CMS_BLOCK_PRODUCT_CONNECTOR => 0, SpyCmsBlockProductConnectorTableMap::COL_FK_CMS_BLOCK => 1, SpyCmsBlockProductConnectorTableMap::COL_FK_PRODUCT_ABSTRACT => 2, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_product_connector' => 0, 'fk_cms_block' => 1, 'fk_product_abstract' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyCmsBlockProductConnectorTableMap
