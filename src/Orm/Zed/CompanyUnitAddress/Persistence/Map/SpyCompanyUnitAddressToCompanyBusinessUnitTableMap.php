...
class SpyCompanyUnitAddressToCompanyBusinessUnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CompanyUnitAddress.Persistence.Map.SpyCompanyUnitAddressToCompanyBusinessUnitTableMap';
     ...
     */
    const TABLE_NAME = 'spy_company_unit_address_to_company_business_unit';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CompanyUnitAddress\\Persistence\\SpyCompanyUnitAddressToCompanyBusinessUnit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CompanyUnitAddress.Persistence.SpyCompanyUnitAddressToCompanyBusinessUnit';
     ...
     */
    const COL_ID_COMPANY_UNIT_ADDRESS_TO_COMPANY_BUSINESS_UNIT = 'spy_company_unit_address_to_company_business_unit.id_company_unit_address_to_company_business_unit';

    /**
     * the column name for the fk_company_business_unit field
     */
    const COL_FK_COMPANY_BUSINESS_UNIT = 'spy_company_unit_address_to_company_business_unit.fk_company_business_unit';

    /**
     * the column name for the fk_company_unit_address field
     */
    const COL_FK_COMPANY_UNIT_ADDRESS = 'spy_company_unit_address_to_company_business_unit.fk_company_unit_address';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCompanyUnitAddressToCompanyBusinessUnit', 'FkCompanyBusinessUnit', 'FkCompanyUnitAddress', ),
        self::TYPE_CAMELNAME     => array('idCompanyUnitAddressToCompanyBusinessUnit', 'fkCompanyBusinessUnit', 'fkCompanyUnitAddress', ),
        self::TYPE_COLNAME       => array(SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_ID_COMPANY_UNIT_ADDRESS_TO_COMPANY_BUSINESS_UNIT, SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_FK_COMPANY_BUSINESS_UNIT, SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_FK_COMPANY_UNIT_ADDRESS, ),
        self::TYPE_FIELDNAME     => array('id_company_unit_address_to_company_business_unit', 'fk_company_business_unit', 'fk_company_unit_address', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCompanyUnitAddressToCompanyBusinessUnit' => 0, 'FkCompanyBusinessUnit' => 1, 'FkCompanyUnitAddress' => 2, ),
        self::TYPE_CAMELNAME     => array('idCompanyUnitAddressToCompanyBusinessUnit' => 0, 'fkCompanyBusinessUnit' => 1, 'fkCompanyUnitAddress' => 2, ),
        self::TYPE_COLNAME       => array(SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_ID_COMPANY_UNIT_ADDRESS_TO_COMPANY_BUSINESS_UNIT => 0, SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_FK_COMPANY_BUSINESS_UNIT => 1, SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_FK_COMPANY_UNIT_ADDRESS => 2, ),
        self::TYPE_FIELDNAME     => array('id_company_unit_address_to_company_business_unit' => 0, 'fk_company_business_unit' => 1, 'fk_company_unit_address' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyCompanyUnitAddressToCompanyBusinessUnitTableMap
