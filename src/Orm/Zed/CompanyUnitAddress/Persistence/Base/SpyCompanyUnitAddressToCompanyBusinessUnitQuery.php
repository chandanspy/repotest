 ...
 *
 * @method     ChildSpyCompanyUnitAddressToCompanyBusinessUnit[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddressToCompanyBusinessUnit> find(ConnectionInterface $con = null) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects based on current ModelCriteria
 * @method     ChildSpyCompanyUnitAddressToCompanyBusinessUnit[]|ObjectCollection findByIdCompanyUnitAddressToCompanyBusinessUnit(int $id_company_unit_address_to_company_business_unit) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the id_company_unit_address_to_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddressToCompanyBusinessUnit> findByIdCompanyUnitAddressToCompanyBusinessUnit(int $id_company_unit_address_to_company_business_unit) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the id_company_unit_address_to_company_business_unit column
 * @method     ChildSpyCompanyUnitAddressToCompanyBusinessUnit[]|ObjectCollection findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddressToCompanyBusinessUnit> findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @method     ChildSpyCompanyUnitAddressToCompanyBusinessUnit[]|ObjectCollection findByFkCompanyUnitAddress(int $fk_company_unit_address) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the fk_company_unit_address column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddressToCompanyBusinessUnit> findByFkCompanyUnitAddress(int $fk_company_unit_address) Return ChildSpyCompanyUnitAddressToCompanyBusinessUnit objects filtered by the fk_company_unit_address column
...
abstract class SpyCompanyUnitAddressToCompanyBusinessUnitQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyUnitAddressToCompanyBusinessUnitQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_ID_COMPANY_UNIT_ADDRESS_TO_COMPANY_BUSINESS_UNIT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyUnitAddressToCompanyBusinessUnitTableMap::COL_ID_COMPANY_UNIT_ADDRESS_TO_COMPANY_BUSINESS_UNIT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyUnitAddressToCompanyBusinessUnitQuery The current query, for fluid interface
     */
...
} // SpyCompanyUnitAddressToCompanyBusinessUnitQuery
