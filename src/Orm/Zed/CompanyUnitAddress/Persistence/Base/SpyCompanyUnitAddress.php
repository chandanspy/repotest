...
abstract class SpyCompanyUnitAddress implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CompanyUnitAddress\\Persistence\\Map\\SpyCompanyUnitAddressTableMap';
     ...
     * @return $this|\Orm\Zed\CompanyUnitAddress\Persistence\SpyCompanyUnitAddress The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CompanyUnitAddress\Persistence\SpyCompanyUnitAddress
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CompanyUnitAddress\Persistence\SpyCompanyUnitAddress The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyCompanyBusinessUnits($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCompanyBusinessUnits($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCompanyUnitAddress The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyCompanyBusinessUnits(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCompanyBusinessUnitsPartial && !$this->isNew();
        if (null === $this->collSpyCompanyBusinessUnits || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCompanyBusinessUnit(SpyCompanyBusinessUnit $spyCompanyBusinessUnit)
    {
     ...
     */
    protected function doAddSpyCompanyUnitAddressToCompanyBusinessUnit(ChildSpyCompanyUnitAddressToCompanyBusinessUnit $spyCompanyUnitAddressToCompanyBusinessUnit)
    {
     ...
     */
    protected function doAddSpyCompanyUnitAddressLabelToCompanyUnitAddress(SpyCompanyUnitAddressLabelToCompanyUnitAddress $spyCompanyUnitAddressLabelToCompanyUnitAddress)
    {
