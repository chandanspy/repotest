 ...
 *
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyUnitAddress objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> find(ConnectionInterface $con = null) Return ChildSpyCompanyUnitAddress objects based on current ModelCriteria
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByIdCompanyUnitAddress(int $id_company_unit_address) Return ChildSpyCompanyUnitAddress objects filtered by the id_company_unit_address column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByIdCompanyUnitAddress(int $id_company_unit_address) Return ChildSpyCompanyUnitAddress objects filtered by the id_company_unit_address column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByFkCompany(int $fk_company) Return ChildSpyCompanyUnitAddress objects filtered by the fk_company column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByFkCompany(int $fk_company) Return ChildSpyCompanyUnitAddress objects filtered by the fk_company column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByFkCountry(int $fk_country) Return ChildSpyCompanyUnitAddress objects filtered by the fk_country column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByFkCountry(int $fk_country) Return ChildSpyCompanyUnitAddress objects filtered by the fk_country column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByFkRegion(int $fk_region) Return ChildSpyCompanyUnitAddress objects filtered by the fk_region column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByFkRegion(int $fk_region) Return ChildSpyCompanyUnitAddress objects filtered by the fk_region column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByAddress1(string $address1) Return ChildSpyCompanyUnitAddress objects filtered by the address1 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByAddress1(string $address1) Return ChildSpyCompanyUnitAddress objects filtered by the address1 column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByAddress2(string $address2) Return ChildSpyCompanyUnitAddress objects filtered by the address2 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByAddress2(string $address2) Return ChildSpyCompanyUnitAddress objects filtered by the address2 column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByAddress3(string $address3) Return ChildSpyCompanyUnitAddress objects filtered by the address3 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByAddress3(string $address3) Return ChildSpyCompanyUnitAddress objects filtered by the address3 column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByCity(string $city) Return ChildSpyCompanyUnitAddress objects filtered by the city column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByCity(string $city) Return ChildSpyCompanyUnitAddress objects filtered by the city column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByComment(string $comment) Return ChildSpyCompanyUnitAddress objects filtered by the comment column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByComment(string $comment) Return ChildSpyCompanyUnitAddress objects filtered by the comment column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByKey(string $key) Return ChildSpyCompanyUnitAddress objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByKey(string $key) Return ChildSpyCompanyUnitAddress objects filtered by the key column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByPhone(string $phone) Return ChildSpyCompanyUnitAddress objects filtered by the phone column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByPhone(string $phone) Return ChildSpyCompanyUnitAddress objects filtered by the phone column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCompanyUnitAddress objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByUuid(string $uuid) Return ChildSpyCompanyUnitAddress objects filtered by the uuid column
 * @method     ChildSpyCompanyUnitAddress[]|ObjectCollection findByZipCode(string $zip_code) Return ChildSpyCompanyUnitAddress objects filtered by the zip_code column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUnitAddress> findByZipCode(string $zip_code) Return ChildSpyCompanyUnitAddress objects filtered by the zip_code column
...
abstract class SpyCompanyUnitAddressQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyUnitAddressQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyUnitAddressTableMap::COL_ID_COMPANY_UNIT_ADDRESS, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyUnitAddressTableMap::COL_ID_COMPANY_UNIT_ADDRESS, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyUnitAddressQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyCompanyUnitAddressQuery The current query, for fluid interface
     */
    public function filterBySpyCompanyBusinessUnit($spyCompanyBusinessUnit, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUnitAddressQuery The current query, for fluid interface
     */
    public function joinSpyCompanyBusinessUnit($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCompanyBusinessUnit', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCompanyBusinessUnit', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
