...
class SpyPriceProductAbstractStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProductStorage.Persistence.Map.SpyPriceProductAbstractStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_abstract_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProductStorage\\Persistence\\SpyPriceProductAbstractStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProductStorage.Persistence.SpyPriceProductAbstractStorage';
     ...
     */
    const COL_ID_PRICE_PRODUCT_ABSTRACT_STORAGE = 'spy_price_product_abstract_storage.id_price_product_abstract_storage';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_price_product_abstract_storage.fk_product_abstract';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_price_product_abstract_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_price_product_abstract_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_price_product_abstract_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_price_product_abstract_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_price_product_abstract_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_price_product_abstract_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductAbstractStorage', 'FkProductAbstract', 'Data', 'Store', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPriceProductAbstractStorage', 'fkProductAbstract', 'data', 'store', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPriceProductAbstractStorageTableMap::COL_ID_PRICE_PRODUCT_ABSTRACT_STORAGE, SpyPriceProductAbstractStorageTableMap::COL_FK_PRODUCT_ABSTRACT, SpyPriceProductAbstractStorageTableMap::COL_DATA, SpyPriceProductAbstractStorageTableMap::COL_STORE, SpyPriceProductAbstractStorageTableMap::COL_ALIAS_KEYS, SpyPriceProductAbstractStorageTableMap::COL_KEY, SpyPriceProductAbstractStorageTableMap::COL_CREATED_AT, SpyPriceProductAbstractStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_price_product_abstract_storage', 'fk_product_abstract', 'data', 'store', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductAbstractStorage' => 0, 'FkProductAbstract' => 1, 'Data' => 2, 'Store' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idPriceProductAbstractStorage' => 0, 'fkProductAbstract' => 1, 'data' => 2, 'store' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyPriceProductAbstractStorageTableMap::COL_ID_PRICE_PRODUCT_ABSTRACT_STORAGE => 0, SpyPriceProductAbstractStorageTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyPriceProductAbstractStorageTableMap::COL_DATA => 2, SpyPriceProductAbstractStorageTableMap::COL_STORE => 3, SpyPriceProductAbstractStorageTableMap::COL_ALIAS_KEYS => 4, SpyPriceProductAbstractStorageTableMap::COL_KEY => 5, SpyPriceProductAbstractStorageTableMap::COL_CREATED_AT => 6, SpyPriceProductAbstractStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_price_product_abstract_storage' => 0, 'fk_product_abstract' => 1, 'data' => 2, 'store' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyPriceProductAbstractStorageTableMap
