...
class SpyPriceProductConcreteStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProductStorage.Persistence.Map.SpyPriceProductConcreteStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_concrete_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProductStorage\\Persistence\\SpyPriceProductConcreteStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProductStorage.Persistence.SpyPriceProductConcreteStorage';
     ...
     */
    const COL_ID_PRICE_PRODUCT_CONCRETE_STORAGE = 'spy_price_product_concrete_storage.id_price_product_concrete_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_price_product_concrete_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_price_product_concrete_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_price_product_concrete_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_price_product_concrete_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_price_product_concrete_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_price_product_concrete_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_price_product_concrete_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductConcreteStorage', 'FkProduct', 'Data', 'Store', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPriceProductConcreteStorage', 'fkProduct', 'data', 'store', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPriceProductConcreteStorageTableMap::COL_ID_PRICE_PRODUCT_CONCRETE_STORAGE, SpyPriceProductConcreteStorageTableMap::COL_FK_PRODUCT, SpyPriceProductConcreteStorageTableMap::COL_DATA, SpyPriceProductConcreteStorageTableMap::COL_STORE, SpyPriceProductConcreteStorageTableMap::COL_ALIAS_KEYS, SpyPriceProductConcreteStorageTableMap::COL_KEY, SpyPriceProductConcreteStorageTableMap::COL_CREATED_AT, SpyPriceProductConcreteStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_price_product_concrete_storage', 'fk_product', 'data', 'store', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductConcreteStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Store' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idPriceProductConcreteStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'store' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_price_product_concrete_storage' => 0, 'fk_product' => 1, 'data' => 2, 'store' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
