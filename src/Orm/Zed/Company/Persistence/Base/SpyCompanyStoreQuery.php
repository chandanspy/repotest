 ...
 *
 * @method     ChildSpyCompanyStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyStore> find(ConnectionInterface $con = null) Return ChildSpyCompanyStore objects based on current ModelCriteria
 * @method     ChildSpyCompanyStore[]|ObjectCollection findByIdCompanyStore(int $id_company_store) Return ChildSpyCompanyStore objects filtered by the id_company_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyStore> findByIdCompanyStore(int $id_company_store) Return ChildSpyCompanyStore objects filtered by the id_company_store column
 * @method     ChildSpyCompanyStore[]|ObjectCollection findByFkCompany(int $fk_company) Return ChildSpyCompanyStore objects filtered by the fk_company column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyStore> findByFkCompany(int $fk_company) Return ChildSpyCompanyStore objects filtered by the fk_company column
 * @method     ChildSpyCompanyStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyCompanyStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyStore> findByFkStore(int $fk_store) Return ChildSpyCompanyStore objects filtered by the fk_store column
...
abstract class SpyCompanyStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyStoreTableMap::COL_ID_COMPANY_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyStoreTableMap::COL_ID_COMPANY_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyStoreQuery The current query, for fluid interface
     */
