 ...
 *
 * @method     ChildSpyCompany[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompany objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> find(ConnectionInterface $con = null) Return ChildSpyCompany objects based on current ModelCriteria
 * @method     ChildSpyCompany[]|ObjectCollection findByIdCompany(int $id_company) Return ChildSpyCompany objects filtered by the id_company column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByIdCompany(int $id_company) Return ChildSpyCompany objects filtered by the id_company column
 * @method     ChildSpyCompany[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyCompany objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByIsActive(boolean $is_active) Return ChildSpyCompany objects filtered by the is_active column
 * @method     ChildSpyCompany[]|ObjectCollection findByKey(string $key) Return ChildSpyCompany objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByKey(string $key) Return ChildSpyCompany objects filtered by the key column
 * @method     ChildSpyCompany[]|ObjectCollection findByName(string $name) Return ChildSpyCompany objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByName(string $name) Return ChildSpyCompany objects filtered by the name column
 * @method     ChildSpyCompany[]|ObjectCollection findByStatus(int $status) Return ChildSpyCompany objects filtered by the status column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByStatus(int $status) Return ChildSpyCompany objects filtered by the status column
 * @method     ChildSpyCompany[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCompany objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompany> findByUuid(string $uuid) Return ChildSpyCompany objects filtered by the uuid column
...
abstract class SpyCompanyQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyTableMap::COL_ID_COMPANY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyTableMap::COL_ID_COMPANY, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCompanyQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCompanyQuery The current query, for fluid interface
     */
    public function joinCompanyUnitAddress($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
