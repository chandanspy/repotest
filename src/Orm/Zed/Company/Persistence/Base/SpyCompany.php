...
abstract class SpyCompany implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Company\\Persistence\\Map\\SpyCompanyTableMap';
     ...
     * @return $this|\Orm\Zed\Company\Persistence\SpyCompany The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Company\Persistence\SpyCompany
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Company\Persistence\SpyCompany The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCompany The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyCompanyStore(ChildSpyCompanyStore $spyCompanyStore)
    {
     ...
     */
    public function resetPartialCompanyBusinessUnits($v = true)
    {
     ...
     * @return void
     */
    public function initCompanyBusinessUnits($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countCompanyBusinessUnits(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collCompanyBusinessUnitsPartial && !$this->isNew();
        if (null === $this->collCompanyBusinessUnits || null !== $criteria || $partial) {
     ...
     */
    protected function doAddCompanyBusinessUnit(SpyCompanyBusinessUnit $companyBusinessUnit)
    {
     ...
     */
    public function resetPartialCompanyRoles($v = true)
    {
     ...
     * @return void
     */
    public function initCompanyRoles($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countCompanyRoles(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collCompanyRolesPartial && !$this->isNew();
        if (null === $this->collCompanyRoles || null !== $criteria || $partial) {
     ...
     */
    protected function doAddCompanyRole(SpyCompanyRole $companyRole)
    {
