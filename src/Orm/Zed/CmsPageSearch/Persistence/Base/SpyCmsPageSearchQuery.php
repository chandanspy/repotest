 ...
 *
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsPageSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> find(ConnectionInterface $con = null) Return ChildSpyCmsPageSearch objects based on current ModelCriteria
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByIdCmsPageSearch(string $id_cms_page_search) Return ChildSpyCmsPageSearch objects filtered by the id_cms_page_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByIdCmsPageSearch(string $id_cms_page_search) Return ChildSpyCmsPageSearch objects filtered by the id_cms_page_search column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsPageSearch objects filtered by the fk_cms_page column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsPageSearch objects filtered by the fk_cms_page column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByStructuredData(string $structured_data) Return ChildSpyCmsPageSearch objects filtered by the structured_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByStructuredData(string $structured_data) Return ChildSpyCmsPageSearch objects filtered by the structured_data column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByData(string $data) Return ChildSpyCmsPageSearch objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByData(string $data) Return ChildSpyCmsPageSearch objects filtered by the data column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByStore(string $store) Return ChildSpyCmsPageSearch objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByStore(string $store) Return ChildSpyCmsPageSearch objects filtered by the store column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByLocale(string $locale) Return ChildSpyCmsPageSearch objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByLocale(string $locale) Return ChildSpyCmsPageSearch objects filtered by the locale column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyCmsPageSearch objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByAliasKeys(string $alias_keys) Return ChildSpyCmsPageSearch objects filtered by the alias_keys column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByKey(string $key) Return ChildSpyCmsPageSearch objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByKey(string $key) Return ChildSpyCmsPageSearch objects filtered by the key column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCmsPageSearch objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByCreatedAt(string $created_at) Return ChildSpyCmsPageSearch objects filtered by the created_at column
 * @method     ChildSpyCmsPageSearch[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCmsPageSearch objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageSearch> findByUpdatedAt(string $updated_at) Return ChildSpyCmsPageSearch objects filtered by the updated_at column
...
abstract class SpyCmsPageSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsPageSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsPageSearchTableMap::COL_ID_CMS_PAGE_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsPageSearchTableMap::COL_ID_CMS_PAGE_SEARCH, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsPageSearchTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsPageSearchTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsPageSearchTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsPageSearchTableMap::COL_CREATED_AT);
    }
