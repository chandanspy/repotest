...
class SpyQuoteApprovalTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.QuoteApproval.Persistence.Map.SpyQuoteApprovalTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_approval';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\QuoteApproval\\Persistence\\SpyQuoteApproval';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.QuoteApproval.Persistence.SpyQuoteApproval';
     ...
     */
    const COL_ID_QUOTE_APPROVAL = 'spy_quote_approval.id_quote_approval';

    /**
     * the column name for the fk_quote field
     */
    const COL_FK_QUOTE = 'spy_quote_approval.fk_quote';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_quote_approval.fk_company_user';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'spy_quote_approval.status';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_quote_approval.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_quote_approval.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_quote_approval.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuoteApproval', 'FkQuote', 'FkCompanyUser', 'Status', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idQuoteApproval', 'fkQuote', 'fkCompanyUser', 'status', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyQuoteApprovalTableMap::COL_ID_QUOTE_APPROVAL, SpyQuoteApprovalTableMap::COL_FK_QUOTE, SpyQuoteApprovalTableMap::COL_FK_COMPANY_USER, SpyQuoteApprovalTableMap::COL_STATUS, SpyQuoteApprovalTableMap::COL_UUID, SpyQuoteApprovalTableMap::COL_CREATED_AT, SpyQuoteApprovalTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_quote_approval', 'fk_quote', 'fk_company_user', 'status', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuoteApproval' => 0, 'FkQuote' => 1, 'FkCompanyUser' => 2, 'Status' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idQuoteApproval' => 0, 'fkQuote' => 1, 'fkCompanyUser' => 2, 'status' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyQuoteApprovalTableMap::COL_ID_QUOTE_APPROVAL => 0, SpyQuoteApprovalTableMap::COL_FK_QUOTE => 1, SpyQuoteApprovalTableMap::COL_FK_COMPANY_USER => 2, SpyQuoteApprovalTableMap::COL_STATUS => 3, SpyQuoteApprovalTableMap::COL_UUID => 4, SpyQuoteApprovalTableMap::COL_CREATED_AT => 5, SpyQuoteApprovalTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_quote_approval' => 0, 'fk_quote' => 1, 'fk_company_user' => 2, 'status' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
