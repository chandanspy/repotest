 ...
 *
 * @method     ChildSpyQuoteApproval[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuoteApproval objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> find(ConnectionInterface $con = null) Return ChildSpyQuoteApproval objects based on current ModelCriteria
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByIdQuoteApproval(int $id_quote_approval) Return ChildSpyQuoteApproval objects filtered by the id_quote_approval column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByIdQuoteApproval(int $id_quote_approval) Return ChildSpyQuoteApproval objects filtered by the id_quote_approval column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByFkQuote(int $fk_quote) Return ChildSpyQuoteApproval objects filtered by the fk_quote column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByFkQuote(int $fk_quote) Return ChildSpyQuoteApproval objects filtered by the fk_quote column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteApproval objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteApproval objects filtered by the fk_company_user column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByStatus(string $status) Return ChildSpyQuoteApproval objects filtered by the status column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByStatus(string $status) Return ChildSpyQuoteApproval objects filtered by the status column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyQuoteApproval objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByUuid(string $uuid) Return ChildSpyQuoteApproval objects filtered by the uuid column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyQuoteApproval objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByCreatedAt(string $created_at) Return ChildSpyQuoteApproval objects filtered by the created_at column
 * @method     ChildSpyQuoteApproval[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyQuoteApproval objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteApproval> findByUpdatedAt(string $updated_at) Return ChildSpyQuoteApproval objects filtered by the updated_at column
...
abstract class SpyQuoteApprovalQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuoteApprovalQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuoteApprovalTableMap::COL_ID_QUOTE_APPROVAL, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuoteApprovalTableMap::COL_ID_QUOTE_APPROVAL, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuoteApprovalQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyQuoteApprovalTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteApprovalTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteApprovalTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteApprovalTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyQuoteApprovalTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteApprovalTableMap::COL_CREATED_AT);
    }

} // SpyQuoteApprovalQuery
