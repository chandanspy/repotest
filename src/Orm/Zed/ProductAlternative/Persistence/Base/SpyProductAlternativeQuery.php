 ...
 *
 * @method     \Orm\Zed\Product\Persistence\SpyProductQuery|\Orm\Zed\Product\Persistence\SpyProductAbstractQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyProductAlternative[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAlternative objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAlternative> find(ConnectionInterface $con = null) Return ChildSpyProductAlternative objects based on current ModelCriteria
 * @method     ChildSpyProductAlternative[]|ObjectCollection findByIdProductAlternative(int $id_product_alternative) Return ChildSpyProductAlternative objects filtered by the id_product_alternative column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAlternative> findByIdProductAlternative(int $id_product_alternative) Return ChildSpyProductAlternative objects filtered by the id_product_alternative column
 * @method     ChildSpyProductAlternative[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductAlternative objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAlternative> findByFkProduct(int $fk_product) Return ChildSpyProductAlternative objects filtered by the fk_product column
 * @method     ChildSpyProductAlternative[]|ObjectCollection findByFkProductAbstractAlternative(int $fk_product_abstract_alternative) Return ChildSpyProductAlternative objects filtered by the fk_product_abstract_alternative column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAlternative> findByFkProductAbstractAlternative(int $fk_product_abstract_alternative) Return ChildSpyProductAlternative objects filtered by the fk_product_abstract_alternative column
 * @method     ChildSpyProductAlternative[]|ObjectCollection findByFkProductConcreteAlternative(int $fk_product_concrete_alternative) Return ChildSpyProductAlternative objects filtered by the fk_product_concrete_alternative column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAlternative> findByFkProductConcreteAlternative(int $fk_product_concrete_alternative) Return ChildSpyProductAlternative objects filtered by the fk_product_concrete_alternative column
...
abstract class SpyProductAlternativeQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAlternativeTableMap::COL_ID_PRODUCT_ALTERNATIVE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAlternativeTableMap::COL_ID_PRODUCT_ALTERNATIVE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function filterByProductConcrete($spyProduct, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function joinProductConcrete($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('ProductConcrete', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductConcrete', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function filterByProductAbstractAlternative($spyProductAbstract, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function joinProductAbstractAlternative($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductAbstractAlternative', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductAbstractAlternative', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\Product\Persistence\SpyProduct object
     *
     ...
     * @return ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function filterByProductConcreteAlternative($spyProduct, $comparison = null)
    {
        if ($spyProduct instanceof \Orm\Zed\Product\Persistence\SpyProduct) {
            return $this
     ...
     * @return $this|ChildSpyProductAlternativeQuery The current query, for fluid interface
     */
    public function joinProductConcreteAlternative($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductConcreteAlternative', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductConcreteAlternative', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
