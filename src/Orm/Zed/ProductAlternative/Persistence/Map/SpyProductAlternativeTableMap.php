...
class SpyProductAlternativeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductAlternative.Persistence.Map.SpyProductAlternativeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_alternative';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductAlternative\\Persistence\\SpyProductAlternative';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductAlternative.Persistence.SpyProductAlternative';
     ...
     */
    const COL_ID_PRODUCT_ALTERNATIVE = 'spy_product_alternative.id_product_alternative';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_alternative.fk_product';

    /**
     * the column name for the fk_product_abstract_alternative field
     */
    const COL_FK_PRODUCT_ABSTRACT_ALTERNATIVE = 'spy_product_alternative.fk_product_abstract_alternative';

    /**
     * the column name for the fk_product_concrete_alternative field
     */
    const COL_FK_PRODUCT_CONCRETE_ALTERNATIVE = 'spy_product_alternative.fk_product_concrete_alternative';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAlternative', 'FkProduct', 'FkProductAbstractAlternative', 'FkProductConcreteAlternative', ),
        self::TYPE_CAMELNAME     => array('idProductAlternative', 'fkProduct', 'fkProductAbstractAlternative', 'fkProductConcreteAlternative', ),
        self::TYPE_COLNAME       => array(SpyProductAlternativeTableMap::COL_ID_PRODUCT_ALTERNATIVE, SpyProductAlternativeTableMap::COL_FK_PRODUCT, SpyProductAlternativeTableMap::COL_FK_PRODUCT_ABSTRACT_ALTERNATIVE, SpyProductAlternativeTableMap::COL_FK_PRODUCT_CONCRETE_ALTERNATIVE, ),
        self::TYPE_FIELDNAME     => array('id_product_alternative', 'fk_product', 'fk_product_abstract_alternative', 'fk_product_concrete_alternative', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAlternative' => 0, 'FkProduct' => 1, 'FkProductAbstractAlternative' => 2, 'FkProductConcreteAlternative' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductAlternative' => 0, 'fkProduct' => 1, 'fkProductAbstractAlternative' => 2, 'fkProductConcreteAlternative' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductAlternativeTableMap::COL_ID_PRODUCT_ALTERNATIVE => 0, SpyProductAlternativeTableMap::COL_FK_PRODUCT => 1, SpyProductAlternativeTableMap::COL_FK_PRODUCT_ABSTRACT_ALTERNATIVE => 2, SpyProductAlternativeTableMap::COL_FK_PRODUCT_CONCRETE_ALTERNATIVE => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_alternative' => 0, 'fk_product' => 1, 'fk_product_abstract_alternative' => 2, 'fk_product_concrete_alternative' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
