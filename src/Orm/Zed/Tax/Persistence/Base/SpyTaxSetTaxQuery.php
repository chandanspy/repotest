 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetTax> find(ConnectionInterface $con = null) Return ChildSpyTaxSetTax objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetTax> findByFkTaxRate(int $fk_tax_rate) Return ChildSpyTaxSetTax objects filtered by the fk_tax_rate column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetTax> findByFkTaxSet(int $fk_tax_set) Return ChildSpyTaxSetTax objects filtered by the fk_tax_set column
