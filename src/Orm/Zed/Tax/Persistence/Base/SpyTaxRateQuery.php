 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> find(ConnectionInterface $con = null) Return ChildSpyTaxRate objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByIdTaxRate(int $id_tax_rate) Return ChildSpyTaxRate objects filtered by the id_tax_rate column
 * @method     ChildSpyTaxRate[]|ObjectCollection findByFkCountry(int $fk_country) Return ChildSpyTaxRate objects filtered by the fk_country column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByFkCountry(int $fk_country) Return ChildSpyTaxRate objects filtered by the fk_country column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByName(string $name) Return ChildSpyTaxRate objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByRate(string $rate) Return ChildSpyTaxRate objects filtered by the rate column
 * @method     ChildSpyTaxRate[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyTaxRate objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByCreatedAt(string $created_at) Return ChildSpyTaxRate objects filtered by the created_at column
 * @method     ChildSpyTaxRate[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyTaxRate objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxRate> findByUpdatedAt(string $updated_at) Return ChildSpyTaxRate objects filtered by the updated_at column
...
abstract class SpyTaxRateQuery extends ModelCriteria
{
    ...
    {
        return $this->addUsingAlias(SpyTaxRateTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyTaxRateTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyTaxRateTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyTaxRateTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyTaxRateTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyTaxRateTableMap::COL_CREATED_AT);
    }
