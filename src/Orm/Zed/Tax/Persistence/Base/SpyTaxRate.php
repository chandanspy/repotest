...
abstract class SpyTaxRate implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Tax\\Persistence\\Map\\SpyTaxRateTableMap';
     ...
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxRate The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxRate
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxRate The current object, for fluid interface
     */
