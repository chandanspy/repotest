...
abstract class SpyTaxSet implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Tax\\Persistence\\Map\\SpyTaxSetTableMap';
     ...
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxSet The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxSet
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Tax\Persistence\SpyTaxSet The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyProductAbstracts($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAbstracts($overrideExisting = true)
    {
     ...
     */
    public function resetPartialSpyProductOptionGroups($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductOptionGroups($overrideExisting = true)
    {
     ...
     */
    public function resetPartialSpySalesOrderThresholdTaxSets($v = true)
    {
     ...
     * @return void
     */
    public function initSpySalesOrderThresholdTaxSets($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpySalesOrderThresholdTaxSets(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpySalesOrderThresholdTaxSetsPartial && !$this->isNew();
        if (null === $this->collSpySalesOrderThresholdTaxSets || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpySalesOrderThresholdTaxSet(SpySalesOrderThresholdTaxSet $spySalesOrderThresholdTaxSet)
    {
     ...
     */
    protected function doAddShipmentMethods(SpyShipmentMethod $shipmentMethods)
    {
