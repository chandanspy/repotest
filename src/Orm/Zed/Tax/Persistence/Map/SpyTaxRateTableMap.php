...
class SpyTaxRateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Tax.Persistence.Map.SpyTaxRateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_tax_rate';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Tax\\Persistence\\SpyTaxRate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Tax.Persistence.SpyTaxRate';
     ...
     */
    const COL_ID_TAX_RATE = 'spy_tax_rate.id_tax_rate';

    /**
     * the column name for the fk_country field
     */
    const COL_FK_COUNTRY = 'spy_tax_rate.fk_country';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_tax_rate.name';

    /**
     * the column name for the rate field
     */
    const COL_RATE = 'spy_tax_rate.rate';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_tax_rate.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_tax_rate.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTaxRate', 'FkCountry', 'Name', 'Rate', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idTaxRate', 'fkCountry', 'name', 'rate', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyTaxRateTableMap::COL_ID_TAX_RATE, SpyTaxRateTableMap::COL_FK_COUNTRY, SpyTaxRateTableMap::COL_NAME, SpyTaxRateTableMap::COL_RATE, SpyTaxRateTableMap::COL_CREATED_AT, SpyTaxRateTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_tax_rate', 'fk_country', 'name', 'rate', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTaxRate' => 0, 'FkCountry' => 1, 'Name' => 2, 'Rate' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idTaxRate' => 0, 'fkCountry' => 1, 'name' => 2, 'rate' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyTaxRateTableMap::COL_ID_TAX_RATE => 0, SpyTaxRateTableMap::COL_FK_COUNTRY => 1, SpyTaxRateTableMap::COL_NAME => 2, SpyTaxRateTableMap::COL_RATE => 3, SpyTaxRateTableMap::COL_CREATED_AT => 4, SpyTaxRateTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_tax_rate' => 0, 'fk_country' => 1, 'name' => 2, 'rate' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
