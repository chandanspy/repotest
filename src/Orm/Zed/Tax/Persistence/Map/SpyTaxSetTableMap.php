...
class SpyTaxSetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Tax.Persistence.Map.SpyTaxSetTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Tax\\Persistence\\SpyTaxSet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Tax.Persistence.SpyTaxSet';
     ...
     */
    const COL_UUID = 'spy_tax_set.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_tax_set.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_tax_set.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTaxSet', 'Name', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idTaxSet', 'name', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyTaxSetTableMap::COL_ID_TAX_SET, SpyTaxSetTableMap::COL_NAME, SpyTaxSetTableMap::COL_UUID, SpyTaxSetTableMap::COL_CREATED_AT, SpyTaxSetTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_tax_set', 'name', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTaxSet' => 0, 'Name' => 1, 'Uuid' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idTaxSet' => 0, 'name' => 1, 'uuid' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyTaxSetTableMap::COL_ID_TAX_SET => 0, SpyTaxSetTableMap::COL_NAME => 1, SpyTaxSetTableMap::COL_UUID => 2, SpyTaxSetTableMap::COL_CREATED_AT => 3, SpyTaxSetTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_tax_set' => 0, 'name' => 1, 'uuid' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
