...
class SpyTaxSetTaxTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Tax.Persistence.Map.SpyTaxSetTaxTableMap';
     ...
     */
    const TABLE_NAME = 'spy_tax_set_tax';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Tax\\Persistence\\SpyTaxSetTax';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Tax.Persistence.SpyTaxSetTax';
     ...
     */
    const COL_FK_TAX_RATE = 'spy_tax_set_tax.fk_tax_rate';

    /**
     * the column name for the fk_tax_set field
     */
    const COL_FK_TAX_SET = 'spy_tax_set_tax.fk_tax_set';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkTaxRate', 'FkTaxSet', ),
        self::TYPE_CAMELNAME     => array('fkTaxRate', 'fkTaxSet', ),
        self::TYPE_COLNAME       => array(SpyTaxSetTaxTableMap::COL_FK_TAX_RATE, SpyTaxSetTaxTableMap::COL_FK_TAX_SET, ),
        self::TYPE_FIELDNAME     => array('fk_tax_rate', 'fk_tax_set', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkTaxRate' => 0, 'FkTaxSet' => 1, ),
        self::TYPE_CAMELNAME     => array('fkTaxRate' => 0, 'fkTaxSet' => 1, ),
        self::TYPE_COLNAME       => array(SpyTaxSetTaxTableMap::COL_FK_TAX_RATE => 0, SpyTaxSetTaxTableMap::COL_FK_TAX_SET => 1, ),
        self::TYPE_FIELDNAME     => array('fk_tax_rate' => 0, 'fk_tax_set' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
