 ...
 *
 * @method     ChildSpyPaymentProvider[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPaymentProvider objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentProvider> find(ConnectionInterface $con = null) Return ChildSpyPaymentProvider objects based on current ModelCriteria
 * @method     ChildSpyPaymentProvider[]|ObjectCollection findByIdPaymentProvider(int $id_payment_provider) Return ChildSpyPaymentProvider objects filtered by the id_payment_provider column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentProvider> findByIdPaymentProvider(int $id_payment_provider) Return ChildSpyPaymentProvider objects filtered by the id_payment_provider column
 * @method     ChildSpyPaymentProvider[]|ObjectCollection findByName(string $name) Return ChildSpyPaymentProvider objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentProvider> findByName(string $name) Return ChildSpyPaymentProvider objects filtered by the name column
 * @method     ChildSpyPaymentProvider[]|ObjectCollection findByPaymentProviderKey(string $payment_provider_key) Return ChildSpyPaymentProvider objects filtered by the payment_provider_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentProvider> findByPaymentProviderKey(string $payment_provider_key) Return ChildSpyPaymentProvider objects filtered by the payment_provider_key column
...
abstract class SpyPaymentProviderQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPaymentProviderQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPaymentProviderTableMap::COL_ID_PAYMENT_PROVIDER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPaymentProviderTableMap::COL_ID_PAYMENT_PROVIDER, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyPaymentProviderQuery The current query, for fluid interface
     */
