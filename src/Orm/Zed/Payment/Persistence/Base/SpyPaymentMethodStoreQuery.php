 ...
 *
 * @method     ChildSpyPaymentMethodStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPaymentMethodStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethodStore> find(ConnectionInterface $con = null) Return ChildSpyPaymentMethodStore objects based on current ModelCriteria
 * @method     ChildSpyPaymentMethodStore[]|ObjectCollection findByIdPaymentMethodStore(int $id_payment_method_store) Return ChildSpyPaymentMethodStore objects filtered by the id_payment_method_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethodStore> findByIdPaymentMethodStore(int $id_payment_method_store) Return ChildSpyPaymentMethodStore objects filtered by the id_payment_method_store column
 * @method     ChildSpyPaymentMethodStore[]|ObjectCollection findByFkPaymentMethod(int $fk_payment_method) Return ChildSpyPaymentMethodStore objects filtered by the fk_payment_method column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethodStore> findByFkPaymentMethod(int $fk_payment_method) Return ChildSpyPaymentMethodStore objects filtered by the fk_payment_method column
 * @method     ChildSpyPaymentMethodStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyPaymentMethodStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethodStore> findByFkStore(int $fk_store) Return ChildSpyPaymentMethodStore objects filtered by the fk_store column
...
abstract class SpyPaymentMethodStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPaymentMethodStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPaymentMethodStoreTableMap::COL_ID_PAYMENT_METHOD_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPaymentMethodStoreTableMap::COL_ID_PAYMENT_METHOD_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPaymentMethodStoreQuery The current query, for fluid interface
     */
    public function filterBySpyPaymentMethod($spyPaymentMethod, $comparison = null)
    {
     ...
     * @return $this|ChildSpyPaymentMethodStoreQuery The current query, for fluid interface
     */
    public function joinSpyPaymentMethod($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyPaymentMethod', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyPaymentMethod', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
