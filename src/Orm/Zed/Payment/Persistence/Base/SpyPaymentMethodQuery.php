 ...
 *
 * @method     ChildSpyPaymentMethod[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPaymentMethod objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> find(ConnectionInterface $con = null) Return ChildSpyPaymentMethod objects based on current ModelCriteria
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByIdPaymentMethod(int $id_payment_method) Return ChildSpyPaymentMethod objects filtered by the id_payment_method column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByIdPaymentMethod(int $id_payment_method) Return ChildSpyPaymentMethod objects filtered by the id_payment_method column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByFkPaymentProvider(int $fk_payment_provider) Return ChildSpyPaymentMethod objects filtered by the fk_payment_provider column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByFkPaymentProvider(int $fk_payment_provider) Return ChildSpyPaymentMethod objects filtered by the fk_payment_provider column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByGroupName(string $group_name) Return ChildSpyPaymentMethod objects filtered by the group_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByGroupName(string $group_name) Return ChildSpyPaymentMethod objects filtered by the group_name column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyPaymentMethod objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByIsActive(boolean $is_active) Return ChildSpyPaymentMethod objects filtered by the is_active column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByIsHidden(boolean $is_hidden) Return ChildSpyPaymentMethod objects filtered by the is_hidden column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByIsHidden(boolean $is_hidden) Return ChildSpyPaymentMethod objects filtered by the is_hidden column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByLabelName(string $label_name) Return ChildSpyPaymentMethod objects filtered by the label_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByLabelName(string $label_name) Return ChildSpyPaymentMethod objects filtered by the label_name column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByName(string $name) Return ChildSpyPaymentMethod objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByName(string $name) Return ChildSpyPaymentMethod objects filtered by the name column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByPaymentAuthorizationEndpoint(string $payment_authorization_endpoint) Return ChildSpyPaymentMethod objects filtered by the payment_authorization_endpoint column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByPaymentAuthorizationEndpoint(string $payment_authorization_endpoint) Return ChildSpyPaymentMethod objects filtered by the payment_authorization_endpoint column
 * @method     ChildSpyPaymentMethod[]|ObjectCollection findByPaymentMethodKey(string $payment_method_key) Return ChildSpyPaymentMethod objects filtered by the payment_method_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPaymentMethod> findByPaymentMethodKey(string $payment_method_key) Return ChildSpyPaymentMethod objects filtered by the payment_method_key column
...
abstract class SpyPaymentMethodQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_payment_method`, `fk_payment_provider`, `group_name`, `is_active`, `is_hidden`, `label_name`, `name`, `payment_authorization_endpoint`, `payment_method_key` FROM `spy_payment_method` WHERE `id_payment_method` = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPaymentMethodQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPaymentMethodTableMap::COL_ID_PAYMENT_METHOD, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPaymentMethodTableMap::COL_ID_PAYMENT_METHOD, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPaymentMethodQuery The current query, for fluid interface
     */
    public function filterBySpyPaymentProvider($spyPaymentProvider, $comparison = null)
    {
     ...
     * @return $this|ChildSpyPaymentMethodQuery The current query, for fluid interface
     */
    public function joinSpyPaymentProvider($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyPaymentProvider', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyPaymentProvider', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
