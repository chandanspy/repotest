...
class SpySalesPaymentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Payment.Persistence.Map.SpySalesPaymentTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_payment';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Payment\\Persistence\\SpySalesPayment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Payment.Persistence.SpySalesPayment';
     ...
     */
    const COL_ID_SALES_PAYMENT = 'spy_sales_payment.id_sales_payment';

    /**
     * the column name for the fk_sales_order field
     */
    const COL_FK_SALES_ORDER = 'spy_sales_payment.fk_sales_order';

    /**
     * the column name for the fk_sales_payment_method_type field
     */
    const COL_FK_SALES_PAYMENT_METHOD_TYPE = 'spy_sales_payment.fk_sales_payment_method_type';

    /**
     * the column name for the amount field
     */
    const COL_AMOUNT = 'spy_sales_payment.amount';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_payment.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_payment.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesPayment', 'FkSalesOrder', 'FkSalesPaymentMethodType', 'Amount', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesPayment', 'fkSalesOrder', 'fkSalesPaymentMethodType', 'amount', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesPaymentTableMap::COL_ID_SALES_PAYMENT, SpySalesPaymentTableMap::COL_FK_SALES_ORDER, SpySalesPaymentTableMap::COL_FK_SALES_PAYMENT_METHOD_TYPE, SpySalesPaymentTableMap::COL_AMOUNT, SpySalesPaymentTableMap::COL_CREATED_AT, SpySalesPaymentTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_payment', 'fk_sales_order', 'fk_sales_payment_method_type', 'amount', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesPayment' => 0, 'FkSalesOrder' => 1, 'FkSalesPaymentMethodType' => 2, 'Amount' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idSalesPayment' => 0, 'fkSalesOrder' => 1, 'fkSalesPaymentMethodType' => 2, 'amount' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpySalesPaymentTableMap::COL_ID_SALES_PAYMENT => 0, SpySalesPaymentTableMap::COL_FK_SALES_ORDER => 1, SpySalesPaymentTableMap::COL_FK_SALES_PAYMENT_METHOD_TYPE => 2, SpySalesPaymentTableMap::COL_AMOUNT => 3, SpySalesPaymentTableMap::COL_CREATED_AT => 4, SpySalesPaymentTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_sales_payment' => 0, 'fk_sales_order' => 1, 'fk_sales_payment_method_type' => 2, 'amount' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
