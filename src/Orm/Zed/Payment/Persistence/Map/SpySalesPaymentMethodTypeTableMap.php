...
class SpySalesPaymentMethodTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Payment.Persistence.Map.SpySalesPaymentMethodTypeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_payment_method_type';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Payment\\Persistence\\SpySalesPaymentMethodType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Payment.Persistence.SpySalesPaymentMethodType';
     ...
     */
    const COL_ID_SALES_PAYMENT_METHOD_TYPE = 'spy_sales_payment_method_type.id_sales_payment_method_type';

    /**
     * the column name for the payment_method field
     */
    const COL_PAYMENT_METHOD = 'spy_sales_payment_method_type.payment_method';

    /**
     * the column name for the payment_provider field
     */
    const COL_PAYMENT_PROVIDER = 'spy_sales_payment_method_type.payment_provider';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesPaymentMethodType', 'PaymentMethod', 'PaymentProvider', ),
        self::TYPE_CAMELNAME     => array('idSalesPaymentMethodType', 'paymentMethod', 'paymentProvider', ),
        self::TYPE_COLNAME       => array(SpySalesPaymentMethodTypeTableMap::COL_ID_SALES_PAYMENT_METHOD_TYPE, SpySalesPaymentMethodTypeTableMap::COL_PAYMENT_METHOD, SpySalesPaymentMethodTypeTableMap::COL_PAYMENT_PROVIDER, ),
        self::TYPE_FIELDNAME     => array('id_sales_payment_method_type', 'payment_method', 'payment_provider', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesPaymentMethodType' => 0, 'PaymentMethod' => 1, 'PaymentProvider' => 2, ),
        self::TYPE_CAMELNAME     => array('idSalesPaymentMethodType' => 0, 'paymentMethod' => 1, 'paymentProvider' => 2, ),
        self::TYPE_COLNAME       => array(SpySalesPaymentMethodTypeTableMap::COL_ID_SALES_PAYMENT_METHOD_TYPE => 0, SpySalesPaymentMethodTypeTableMap::COL_PAYMENT_METHOD => 1, SpySalesPaymentMethodTypeTableMap::COL_PAYMENT_PROVIDER => 2, ),
        self::TYPE_FIELDNAME     => array('id_sales_payment_method_type' => 0, 'payment_method' => 1, 'payment_provider' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpySalesPaymentMethodTypeTableMap
