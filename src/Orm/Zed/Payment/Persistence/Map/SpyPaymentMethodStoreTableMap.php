...
class SpyPaymentMethodStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Payment.Persistence.Map.SpyPaymentMethodStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_payment_method_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Payment\\Persistence\\SpyPaymentMethodStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Payment.Persistence.SpyPaymentMethodStore';
     ...
     */
    const COL_ID_PAYMENT_METHOD_STORE = 'spy_payment_method_store.id_payment_method_store';

    /**
     * the column name for the fk_payment_method field
     */
    const COL_FK_PAYMENT_METHOD = 'spy_payment_method_store.fk_payment_method';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_payment_method_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPaymentMethodStore', 'FkPaymentMethod', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idPaymentMethodStore', 'fkPaymentMethod', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyPaymentMethodStoreTableMap::COL_ID_PAYMENT_METHOD_STORE, SpyPaymentMethodStoreTableMap::COL_FK_PAYMENT_METHOD, SpyPaymentMethodStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_payment_method_store', 'fk_payment_method', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPaymentMethodStore' => 0, 'FkPaymentMethod' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idPaymentMethodStore' => 0, 'fkPaymentMethod' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyPaymentMethodStoreTableMap::COL_ID_PAYMENT_METHOD_STORE => 0, SpyPaymentMethodStoreTableMap::COL_FK_PAYMENT_METHOD => 1, SpyPaymentMethodStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_payment_method_store' => 0, 'fk_payment_method' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
