...
class SpyProductConcreteImageStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductImageStorage.Persistence.Map.SpyProductConcreteImageStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_concrete_image_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductImageStorage\\Persistence\\SpyProductConcreteImageStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductImageStorage.Persistence.SpyProductConcreteImageStorage';
     ...
     */
    const COL_ID_PRODUCT_CONCRETE_IMAGE_STORAGE = 'spy_product_concrete_image_storage.id_product_concrete_image_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_concrete_image_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_concrete_image_storage.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_product_concrete_image_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_concrete_image_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_concrete_image_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_concrete_image_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_concrete_image_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductConcreteImageStorage', 'FkProduct', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductConcreteImageStorage', 'fkProduct', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductConcreteImageStorageTableMap::COL_ID_PRODUCT_CONCRETE_IMAGE_STORAGE, SpyProductConcreteImageStorageTableMap::COL_FK_PRODUCT, SpyProductConcreteImageStorageTableMap::COL_DATA, SpyProductConcreteImageStorageTableMap::COL_LOCALE, SpyProductConcreteImageStorageTableMap::COL_ALIAS_KEYS, SpyProductConcreteImageStorageTableMap::COL_KEY, SpyProductConcreteImageStorageTableMap::COL_CREATED_AT, SpyProductConcreteImageStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_concrete_image_storage', 'fk_product', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductConcreteImageStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Locale' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductConcreteImageStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'locale' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_concrete_image_storage' => 0, 'fk_product' => 1, 'data' => 2, 'locale' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
