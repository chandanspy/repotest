...
class SpyProductAbstractImageStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductImageStorage.Persistence.Map.SpyProductAbstractImageStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_image_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductImageStorage\\Persistence\\SpyProductAbstractImageStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductImageStorage.Persistence.SpyProductAbstractImageStorage';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_IMAGE_STORAGE = 'spy_product_abstract_image_storage.id_product_abstract_image_storage';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_image_storage.fk_product_abstract';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_abstract_image_storage.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_product_abstract_image_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_abstract_image_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_abstract_image_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_abstract_image_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_abstract_image_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractImageStorage', 'FkProductAbstract', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractImageStorage', 'fkProductAbstract', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractImageStorageTableMap::COL_ID_PRODUCT_ABSTRACT_IMAGE_STORAGE, SpyProductAbstractImageStorageTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractImageStorageTableMap::COL_DATA, SpyProductAbstractImageStorageTableMap::COL_LOCALE, SpyProductAbstractImageStorageTableMap::COL_ALIAS_KEYS, SpyProductAbstractImageStorageTableMap::COL_KEY, SpyProductAbstractImageStorageTableMap::COL_CREATED_AT, SpyProductAbstractImageStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_image_storage', 'fk_product_abstract', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractImageStorage' => 0, 'FkProductAbstract' => 1, 'Data' => 2, 'Locale' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractImageStorage' => 0, 'fkProductAbstract' => 1, 'data' => 2, 'locale' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyProductAbstractImageStorageTableMap::COL_ID_PRODUCT_ABSTRACT_IMAGE_STORAGE => 0, SpyProductAbstractImageStorageTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductAbstractImageStorageTableMap::COL_DATA => 2, SpyProductAbstractImageStorageTableMap::COL_LOCALE => 3, SpyProductAbstractImageStorageTableMap::COL_ALIAS_KEYS => 4, SpyProductAbstractImageStorageTableMap::COL_KEY => 5, SpyProductAbstractImageStorageTableMap::COL_CREATED_AT => 6, SpyProductAbstractImageStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_image_storage' => 0, 'fk_product_abstract' => 1, 'data' => 2, 'locale' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyProductAbstractImageStorageTableMap
