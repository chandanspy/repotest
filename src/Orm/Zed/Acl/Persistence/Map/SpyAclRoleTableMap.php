...
class SpyAclRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Acl.Persistence.Map.SpyAclRoleTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Acl.Persistence.SpyAclRole';
