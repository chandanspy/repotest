...
class SpyAclGroupsHasRolesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Acl.Persistence.Map.SpyAclGroupsHasRolesTableMap';
     ...
     */
    const TABLE_NAME = 'spy_acl_groups_has_roles';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclGroupsHasRoles';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Acl.Persistence.SpyAclGroupsHasRoles';
     ...
     */
    const COL_FK_ACL_ROLE = 'spy_acl_groups_has_roles.fk_acl_role';

    /**
     * the column name for the fk_acl_group field
     */
    const COL_FK_ACL_GROUP = 'spy_acl_groups_has_roles.fk_acl_group';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkAclRole', 'FkAclGroup', ),
        self::TYPE_CAMELNAME     => array('fkAclRole', 'fkAclGroup', ),
        self::TYPE_COLNAME       => array(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE, SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP, ),
        self::TYPE_FIELDNAME     => array('fk_acl_role', 'fk_acl_group', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkAclRole' => 0, 'FkAclGroup' => 1, ),
        self::TYPE_CAMELNAME     => array('fkAclRole' => 0, 'fkAclGroup' => 1, ),
        self::TYPE_COLNAME       => array(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE => 0, SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP => 1, ),
        self::TYPE_FIELDNAME     => array('fk_acl_role' => 0, 'fk_acl_group' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getFkAclRole() || is_scalar($obj->getFkAclRole()) || is_callable([$obj->getFkAclRole(), '__toString']) ? (string) $obj->getFkAclRole() : $obj->getFkAclRole()), (null === $obj->getFkAclGroup() || is_scalar($obj->getFkAclGroup()) || is_callable([$obj->getFkAclGroup(), '__toString']) ? (string) $obj->getFkAclGroup() : $obj->getFkAclGroup())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Orm\Zed\Acl\Persistence\SpyAclGroupsHasRoles) {
                $key = serialize([(null === $value->getFkAclRole() || is_scalar($value->getFkAclRole()) || is_callable([$value->getFkAclRole(), '__toString']) ? (string) $value->getFkAclRole() : $value->getFkAclRole()), (null === $value->getFkAclGroup() || is_scalar($value->getFkAclGroup()) || is_callable([$value->getFkAclGroup(), '__toString']) ? (string) $value->getFkAclGroup() : $value->getFkAclGroup())]);
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclRole', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP, $value[1]));
