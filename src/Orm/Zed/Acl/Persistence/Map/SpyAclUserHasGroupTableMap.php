...
class SpyAclUserHasGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Acl.Persistence.Map.SpyAclUserHasGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_acl_user_has_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclUserHasGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Acl.Persistence.SpyAclUserHasGroup';
     ...
     */
    const COL_FK_USER = 'spy_acl_user_has_group.fk_user';

    /**
     * the column name for the fk_acl_group field
     */
    const COL_FK_ACL_GROUP = 'spy_acl_user_has_group.fk_acl_group';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkUser', 'FkAclGroup', ),
        self::TYPE_CAMELNAME     => array('fkUser', 'fkAclGroup', ),
        self::TYPE_COLNAME       => array(SpyAclUserHasGroupTableMap::COL_FK_USER, SpyAclUserHasGroupTableMap::COL_FK_ACL_GROUP, ),
        self::TYPE_FIELDNAME     => array('fk_user', 'fk_acl_group', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkUser' => 0, 'FkAclGroup' => 1, ),
        self::TYPE_CAMELNAME     => array('fkUser' => 0, 'fkAclGroup' => 1, ),
        self::TYPE_COLNAME       => array(SpyAclUserHasGroupTableMap::COL_FK_USER => 0, SpyAclUserHasGroupTableMap::COL_FK_ACL_GROUP => 1, ),
        self::TYPE_FIELDNAME     => array('fk_user' => 0, 'fk_acl_group' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
