...
class SpyAclGroupArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Acl.Persistence.Map.SpyAclGroupArchiveTableMap';
     ...
     */
    const TABLE_NAME = 'spy_acl_group_archive';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclGroupArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Acl.Persistence.SpyAclGroupArchive';
     ...
     */
    const COL_ID_ACL_GROUP = 'spy_acl_group_archive.id_acl_group';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_acl_group_archive.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_acl_group_archive.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_acl_group_archive.updated_at';

    /**
     * the column name for the archived_at field
     */
    const COL_ARCHIVED_AT = 'spy_acl_group_archive.archived_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAclGroup', 'Name', 'CreatedAt', 'UpdatedAt', 'ArchivedAt', ),
        self::TYPE_CAMELNAME     => array('idAclGroup', 'name', 'createdAt', 'updatedAt', 'archivedAt', ),
        self::TYPE_COLNAME       => array(SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP, SpyAclGroupArchiveTableMap::COL_NAME, SpyAclGroupArchiveTableMap::COL_CREATED_AT, SpyAclGroupArchiveTableMap::COL_UPDATED_AT, SpyAclGroupArchiveTableMap::COL_ARCHIVED_AT, ),
        self::TYPE_FIELDNAME     => array('id_acl_group', 'name', 'created_at', 'updated_at', 'archived_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAclGroup' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'ArchivedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idAclGroup' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'archivedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP => 0, SpyAclGroupArchiveTableMap::COL_NAME => 1, SpyAclGroupArchiveTableMap::COL_CREATED_AT => 2, SpyAclGroupArchiveTableMap::COL_UPDATED_AT => 3, SpyAclGroupArchiveTableMap::COL_ARCHIVED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_acl_group' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, 'archived_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
