...
class SpyAclGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Acl.Persistence.Map.SpyAclGroupTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Acl.Persistence.SpyAclGroup';
