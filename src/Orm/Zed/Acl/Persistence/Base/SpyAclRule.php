...
abstract class SpyAclRule implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Acl\\Persistence\\Map\\SpyAclRuleTableMap';
     ...
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRule The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRule The current object, for fluid interface
     */
