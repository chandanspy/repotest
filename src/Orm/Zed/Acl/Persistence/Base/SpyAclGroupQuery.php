 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroup> find(ConnectionInterface $con = null) Return ChildSpyAclGroup objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroup> findByIdAclGroup(int $id_acl_group) Return ChildSpyAclGroup objects filtered by the id_acl_group column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroup> findByName(string $name) Return ChildSpyAclGroup objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroup> findByCreatedAt(string $created_at) Return ChildSpyAclGroup objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroup> findByUpdatedAt(string $updated_at) Return ChildSpyAclGroup objects filtered by the updated_at column
