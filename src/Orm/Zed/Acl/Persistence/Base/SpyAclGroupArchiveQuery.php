 ...
 *
 * @method     ChildSpyAclGroupArchiveQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSpyAclGroupArchiveQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSpyAclGroupArchiveQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSpyAclGroupArchive|null findOne(ConnectionInterface $con = null) Return the first ChildSpyAclGroupArchive matching the query
 ...
 *
 * @method     ChildSpyAclGroupArchive|null findOneByIdAclGroup(int $id_acl_group) Return the first ChildSpyAclGroupArchive filtered by the id_acl_group column
 * @method     ChildSpyAclGroupArchive|null findOneByName(string $name) Return the first ChildSpyAclGroupArchive filtered by the name column
 * @method     ChildSpyAclGroupArchive|null findOneByCreatedAt(string $created_at) Return the first ChildSpyAclGroupArchive filtered by the created_at column
 * @method     ChildSpyAclGroupArchive|null findOneByUpdatedAt(string $updated_at) Return the first ChildSpyAclGroupArchive filtered by the updated_at column
 * @method     ChildSpyAclGroupArchive|null findOneByArchivedAt(string $archived_at) Return the first ChildSpyAclGroupArchive filtered by the archived_at column *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> find(ConnectionInterface $con = null) Return ChildSpyAclGroupArchive objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> findByIdAclGroup(int $id_acl_group) Return ChildSpyAclGroupArchive objects filtered by the id_acl_group column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> findByName(string $name) Return ChildSpyAclGroupArchive objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> findByCreatedAt(string $created_at) Return ChildSpyAclGroupArchive objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> findByUpdatedAt(string $updated_at) Return ChildSpyAclGroupArchive objects filtered by the updated_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclGroupArchive> findByArchivedAt(string $archived_at) Return ChildSpyAclGroupArchive objects filtered by the archived_at column
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSpyAclGroupArchive> paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
abstract class SpyAclGroupArchiveQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Orm\Zed\Acl\Persistence\Base\SpyAclGroupArchiveQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclGroupArchive', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyAclGroupArchiveTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyAclGroupArchiveTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByIdAclGroup($idAclGroup = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP, $idAclGroup, $comparison);
    ...
    public function filterByName($name = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_CREATED_AT, $createdAt, $comparison);
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    ...
    public function filterByArchivedAt($archivedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_ARCHIVED_AT, $archivedAt, $comparison);
