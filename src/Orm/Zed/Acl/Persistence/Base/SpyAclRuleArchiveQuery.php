 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> find(ConnectionInterface $con = null) Return ChildSpyAclRuleArchive objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByIdAclRule(int $id_acl_rule) Return ChildSpyAclRuleArchive objects filtered by the id_acl_rule column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByFkAclRole(int $fk_acl_role) Return ChildSpyAclRuleArchive objects filtered by the fk_acl_role column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByBundle(string $bundle) Return ChildSpyAclRuleArchive objects filtered by the bundle column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByController(string $controller) Return ChildSpyAclRuleArchive objects filtered by the controller column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByAction(string $action) Return ChildSpyAclRuleArchive objects filtered by the action column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByType(int $type) Return ChildSpyAclRuleArchive objects filtered by the type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByCreatedAt(string $created_at) Return ChildSpyAclRuleArchive objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByUpdatedAt(string $updated_at) Return ChildSpyAclRuleArchive objects filtered by the updated_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRuleArchive> findByArchivedAt(string $archived_at) Return ChildSpyAclRuleArchive objects filtered by the archived_at column
