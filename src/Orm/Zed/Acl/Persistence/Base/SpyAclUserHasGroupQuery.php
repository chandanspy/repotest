 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclUserHasGroup> find(ConnectionInterface $con = null) Return ChildSpyAclUserHasGroup objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclUserHasGroup> findByFkUser(int $fk_user) Return ChildSpyAclUserHasGroup objects filtered by the fk_user column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclUserHasGroup> findByFkAclGroup(int $fk_acl_group) Return ChildSpyAclUserHasGroup objects filtered by the fk_acl_group column
