...
use Orm\Zed\Acl\Persistence\Map\SpyAclRoleArchiveTableMap;
 ...
 *
 * @method     ChildSpyAclRoleArchiveQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSpyAclRoleArchiveQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSpyAclRoleArchiveQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSpyAclRoleArchive|null findOne(ConnectionInterface $con = null) Return the first ChildSpyAclRoleArchive matching the query
 ...
 *
 * @method     ChildSpyAclRoleArchive|null findOneByIdAclRole(int $id_acl_role) Return the first ChildSpyAclRoleArchive filtered by the id_acl_role column
 * @method     ChildSpyAclRoleArchive|null findOneByName(string $name) Return the first ChildSpyAclRoleArchive filtered by the name column
 * @method     ChildSpyAclRoleArchive|null findOneByCreatedAt(string $created_at) Return the first ChildSpyAclRoleArchive filtered by the created_at column
 * @method     ChildSpyAclRoleArchive|null findOneByUpdatedAt(string $updated_at) Return the first ChildSpyAclRoleArchive filtered by the updated_at column
 * @method     ChildSpyAclRoleArchive|null findOneByArchivedAt(string $archived_at) Return the first ChildSpyAclRoleArchive filtered by the archived_at column *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> find(ConnectionInterface $con = null) Return ChildSpyAclRoleArchive objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> findByIdAclRole(int $id_acl_role) Return ChildSpyAclRoleArchive objects filtered by the id_acl_role column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> findByName(string $name) Return ChildSpyAclRoleArchive objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> findByCreatedAt(string $created_at) Return ChildSpyAclRoleArchive objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> findByUpdatedAt(string $updated_at) Return ChildSpyAclRoleArchive objects filtered by the updated_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRoleArchive> findByArchivedAt(string $archived_at) Return ChildSpyAclRoleArchive objects filtered by the archived_at column
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSpyAclRoleArchive> paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
abstract class SpyAclRoleArchiveQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Orm\Zed\Acl\Persistence\Base\SpyAclRoleArchiveQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclRoleArchive', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyAclRoleArchiveTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyAclRoleArchiveTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByIdAclRole($idAclRole = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_ID_ACL_ROLE, $idAclRole, $comparison);
    ...
    public function filterByName($name = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_CREATED_AT, $createdAt, $comparison);
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    ...
    public function filterByArchivedAt($archivedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_ARCHIVED_AT, $archivedAt, $comparison);
