 ...
 *
 * @method     ChildSpyAclRoleQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSpyAclRoleQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSpyAclRoleQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildSpyAclRoleQuery joinWithAclRule($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AclRule relation
 *
 * @method     ChildSpyAclRoleQuery leftJoinWithAclRule() Adds a LEFT JOIN clause and with to the query using the AclRule relation
 * @method     ChildSpyAclRoleQuery rightJoinWithAclRule() Adds a RIGHT JOIN clause and with to the query using the AclRule relation
 * @method     ChildSpyAclRoleQuery innerJoinWithAclRule() Adds a INNER JOIN clause and with to the query using the AclRule relation
 *
 ...
 *
 * @method     ChildSpyAclRoleQuery joinWithSpyAclGroupsHasRoles($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyAclGroupsHasRoles relation
 *
 * @method     ChildSpyAclRoleQuery leftJoinWithSpyAclGroupsHasRoles() Adds a LEFT JOIN clause and with to the query using the SpyAclGroupsHasRoles relation
 * @method     ChildSpyAclRoleQuery rightJoinWithSpyAclGroupsHasRoles() Adds a RIGHT JOIN clause and with to the query using the SpyAclGroupsHasRoles relation
 * @method     ChildSpyAclRoleQuery innerJoinWithSpyAclGroupsHasRoles() Adds a INNER JOIN clause and with to the query using the SpyAclGroupsHasRoles relation
 *
 * @method     \Orm\Zed\Acl\Persistence\SpyAclRuleQuery|\Orm\Zed\Acl\Persistence\SpyAclGroupsHasRolesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildSpyAclRole|null findOne(ConnectionInterface $con = null) Return the first ChildSpyAclRole matching the query
 ...
 *
 * @method     ChildSpyAclRole|null findOneByIdAclRole(int $id_acl_role) Return the first ChildSpyAclRole filtered by the id_acl_role column
 * @method     ChildSpyAclRole|null findOneByName(string $name) Return the first ChildSpyAclRole filtered by the name column
 * @method     ChildSpyAclRole|null findOneByCreatedAt(string $created_at) Return the first ChildSpyAclRole filtered by the created_at column
 * @method     ChildSpyAclRole|null findOneByUpdatedAt(string $updated_at) Return the first ChildSpyAclRole filtered by the updated_at column *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRole> find(ConnectionInterface $con = null) Return ChildSpyAclRole objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRole> findByIdAclRole(int $id_acl_role) Return ChildSpyAclRole objects filtered by the id_acl_role column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRole> findByName(string $name) Return ChildSpyAclRole objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRole> findByCreatedAt(string $created_at) Return ChildSpyAclRole objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRole> findByUpdatedAt(string $updated_at) Return ChildSpyAclRole objects filtered by the updated_at column
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSpyAclRole> paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    /**
     * Initializes internal state of \Orm\Zed\Acl\Persistence\Base\SpyAclRoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Orm\\Zed\\Acl\\Persistence\\SpyAclRole', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyAclRoleTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyAclRoleTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
     ...
     *
     * @param array $idAclRole Filter value.
     * [
     *    'min' => 3, 'max' => 5
     * ]
     *
     ...
     */
    public function filterByIdAclRole_Between(array $idAclRole)
    {
        return $this->filterByIdAclRole($idAclRole, SprykerCriteria::BETWEEN);
    }

    /**
     * Applies Criteria::IN filtering criteria for the column.
     *
     * @param array $idAclRoles Filter value.
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByIdAclRole_In(array $idAclRoles)
    {
        return $this->filterByIdAclRole($idAclRoles, Criteria::IN);
    }
     ...
     * $query->filterByIdAclRole(array(12, 34), Criteria::IN); // WHERE id_acl_role IN (12, 34)
     * $query->filterByIdAclRole(array('min' => 12), SprykerCriteria::BETWEEN); // WHERE id_acl_role > 12
     * </code>
     *
     ...
     */
    public function filterByIdAclRole($idAclRole = null, $comparison = Criteria::EQUAL)
    {
        ...
        if (is_array($idAclRole)) {
            ...
            if (!in_array($comparison, [Criteria::IN, Criteria::NOT_IN])) {
                throw new AmbiguousComparisonException('$idAclRole of type array requires one of [Criteria::IN, Criteria::NOT_IN] as comparison criteria.');
            }
        }

        $query = $this->addUsingAlias(SpyAclRoleTableMap::COL_ID_ACL_ROLE, $idAclRole, $comparison);
    ...
    public function filterByName($name = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleTableMap::COL_CREATED_AT, $createdAt, $comparison);
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleTableMap::COL_UPDATED_AT, $updatedAt, $comparison);

        return $query;
    }

    /**
     * Filter the query by a related \Orm\Zed\Acl\Persistence\SpyAclRule object
     *
     * @param \Orm\Zed\Acl\Persistence\SpyAclRule|ObjectCollection $spyAclRule the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($spyAclRule instanceof \Orm\Zed\Acl\Persistence\SpyAclRule) {
            return $this
            ...
            throw new PropelException('filterByAclRule() only accepts arguments of type \Orm\Zed\Acl\Persistence\SpyAclRule or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Orm\Zed\Acl\Persistence\SpyAclRuleQuery A secondary query class using the current class as primary query
     */
    public function useAclRuleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAclRule($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'AclRule', '\Orm\Zed\Acl\Persistence\SpyAclRuleQuery');
    }

    /**
     * Use the AclRule relation SpyAclRule object
     *
     * @param callable(\Orm\Zed\Acl\Persistence\SpyAclRuleQuery):\Orm\Zed\Acl\Persistence\SpyAclRuleQuery $callable A function working on the related query
     *
     ...
     * @return $this
     */
    public function withAclRuleQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useAclRuleQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the AclRule relation to the SpyAclRule table for an EXISTS query.
     *
     ...
     *
     * @return \Orm\Zed\Acl\Persistence\SpyAclRuleQuery The inner query object of the EXISTS statement
     */
    public function useAclRuleExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        return $this->useExistsQuery('AclRule', $modelAlias, $queryClass, $typeOfExists);
    }

    /**
     * Use the AclRule relation to the SpyAclRule table for a NOT EXISTS query.
     *
     * @see useAclRuleExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\Acl\Persistence\SpyAclRuleQuery The inner query object of the NOT EXISTS statement
     */
    public function useAclRuleNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        return $this->useExistsQuery('AclRule', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->useExistsQuery('SpyAclGroupsHasRoles', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyAclGroupsHasRoles', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
