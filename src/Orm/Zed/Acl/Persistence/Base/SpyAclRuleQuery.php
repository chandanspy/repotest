 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> find(ConnectionInterface $con = null) Return ChildSpyAclRule objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByIdAclRule(int $id_acl_rule) Return ChildSpyAclRule objects filtered by the id_acl_rule column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByFkAclRole(int $fk_acl_role) Return ChildSpyAclRule objects filtered by the fk_acl_role column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByBundle(string $bundle) Return ChildSpyAclRule objects filtered by the bundle column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByController(string $controller) Return ChildSpyAclRule objects filtered by the controller column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByAction(string $action) Return ChildSpyAclRule objects filtered by the action column
 * @method     ChildSpyAclRule[]|ObjectCollection findByType(int $type) Return ChildSpyAclRule objects filtered by the type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByType(int $type) Return ChildSpyAclRule objects filtered by the type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByCreatedAt(string $created_at) Return ChildSpyAclRule objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAclRule> findByUpdatedAt(string $updated_at) Return ChildSpyAclRule objects filtered by the updated_at column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
    ...
    {
        return $this->useExistsQuery('AclRole', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('AclRole', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
