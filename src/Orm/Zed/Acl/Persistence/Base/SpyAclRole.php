...
abstract class SpyAclRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Acl\\Persistence\\Map\\SpyAclRoleTableMap';
     ...
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyAclRoleTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyAclRoleTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = SpyAclRoleTableMap::NUM_HYDRATE_COLUMNS.
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Acl\Persistence\SpyAclRole The current object, for fluid interface
     */
     ...
     */
    public function resetPartialAclRules($v = true)
    {
     ...
     * @return void
     */
    public function initAclRules($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countAclRules(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collAclRulesPartial && !$this->isNew();
        if (null === $this->collAclRules || null !== $criteria || $partial) {
     ...
     */
    protected function doAddAclRule(ChildSpyAclRule $aclRule)
    {
