 ...
 *
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductDiscontinuedNote objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> find(ConnectionInterface $con = null) Return ChildSpyProductDiscontinuedNote objects based on current ModelCriteria
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByIdProductDiscontinuedNote(int $id_product_discontinued_note) Return ChildSpyProductDiscontinuedNote objects filtered by the id_product_discontinued_note column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByIdProductDiscontinuedNote(int $id_product_discontinued_note) Return ChildSpyProductDiscontinuedNote objects filtered by the id_product_discontinued_note column
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductDiscontinuedNote objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByFkLocale(int $fk_locale) Return ChildSpyProductDiscontinuedNote objects filtered by the fk_locale column
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByFkProductDiscontinued(int $fk_product_discontinued) Return ChildSpyProductDiscontinuedNote objects filtered by the fk_product_discontinued column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByFkProductDiscontinued(int $fk_product_discontinued) Return ChildSpyProductDiscontinuedNote objects filtered by the fk_product_discontinued column
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByNote(string $note) Return ChildSpyProductDiscontinuedNote objects filtered by the note column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByNote(string $note) Return ChildSpyProductDiscontinuedNote objects filtered by the note column
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductDiscontinuedNote objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByCreatedAt(string $created_at) Return ChildSpyProductDiscontinuedNote objects filtered by the created_at column
 * @method     ChildSpyProductDiscontinuedNote[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductDiscontinuedNote objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinuedNote> findByUpdatedAt(string $updated_at) Return ChildSpyProductDiscontinuedNote objects filtered by the updated_at column
...
abstract class SpyProductDiscontinuedNoteQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductDiscontinuedNoteQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductDiscontinuedNoteTableMap::COL_ID_PRODUCT_DISCONTINUED_NOTE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductDiscontinuedNoteTableMap::COL_ID_PRODUCT_DISCONTINUED_NOTE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductDiscontinuedNoteQuery The current query, for fluid interface
     */
    public function filterByProductDiscontinued($spyProductDiscontinued, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductDiscontinuedNoteQuery The current query, for fluid interface
     */
    public function joinProductDiscontinued($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('ProductDiscontinued', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductDiscontinued', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductDiscontinuedNoteTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductDiscontinuedNoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductDiscontinuedNoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductDiscontinuedNoteTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductDiscontinuedNoteTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductDiscontinuedNoteTableMap::COL_CREATED_AT);
    }
