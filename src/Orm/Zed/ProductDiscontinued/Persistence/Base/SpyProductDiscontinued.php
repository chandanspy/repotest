...
abstract class SpyProductDiscontinued implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductDiscontinued\\Persistence\\Map\\SpyProductDiscontinuedTableMap';
     ...
     * @return $this|\Orm\Zed\ProductDiscontinued\Persistence\SpyProductDiscontinued The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductDiscontinued\Persistence\SpyProductDiscontinued
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductDiscontinued\Persistence\SpyProductDiscontinued The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductDiscontinued The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductDiscontinuedNote(ChildSpyProductDiscontinuedNote $spyProductDiscontinuedNote)
    {
