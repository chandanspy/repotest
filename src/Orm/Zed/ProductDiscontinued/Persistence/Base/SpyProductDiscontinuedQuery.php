 ...
 *
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductDiscontinued objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> find(ConnectionInterface $con = null) Return ChildSpyProductDiscontinued objects based on current ModelCriteria
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection findByIdProductDiscontinued(int $id_product_discontinued) Return ChildSpyProductDiscontinued objects filtered by the id_product_discontinued column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> findByIdProductDiscontinued(int $id_product_discontinued) Return ChildSpyProductDiscontinued objects filtered by the id_product_discontinued column
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductDiscontinued objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> findByFkProduct(int $fk_product) Return ChildSpyProductDiscontinued objects filtered by the fk_product column
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection findByActiveUntil(string $active_until) Return ChildSpyProductDiscontinued objects filtered by the active_until column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> findByActiveUntil(string $active_until) Return ChildSpyProductDiscontinued objects filtered by the active_until column
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection findByDiscontinuedOn(string $discontinued_on) Return ChildSpyProductDiscontinued objects filtered by the discontinued_on column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> findByDiscontinuedOn(string $discontinued_on) Return ChildSpyProductDiscontinued objects filtered by the discontinued_on column
 * @method     ChildSpyProductDiscontinued[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductDiscontinued objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductDiscontinued> findByUpdatedAt(string $updated_at) Return ChildSpyProductDiscontinued objects filtered by the updated_at column
...
abstract class SpyProductDiscontinuedQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductDiscontinuedQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductDiscontinuedTableMap::COL_ID_PRODUCT_DISCONTINUED, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductDiscontinuedTableMap::COL_ID_PRODUCT_DISCONTINUED, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductDiscontinuedQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductDiscontinuedTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductDiscontinuedTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductDiscontinuedTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductDiscontinuedTableMap::COL_DISCONTINUED_ON);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductDiscontinuedTableMap::COL_DISCONTINUED_ON, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductDiscontinuedTableMap::COL_DISCONTINUED_ON);
    }
