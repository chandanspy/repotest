...
class SpyProductDiscontinuedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductDiscontinued.Persistence.Map.SpyProductDiscontinuedTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_discontinued';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductDiscontinued\\Persistence\\SpyProductDiscontinued';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductDiscontinued.Persistence.SpyProductDiscontinued';
     ...
     */
    const COL_ID_PRODUCT_DISCONTINUED = 'spy_product_discontinued.id_product_discontinued';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_discontinued.fk_product';

    /**
     * the column name for the active_until field
     */
    const COL_ACTIVE_UNTIL = 'spy_product_discontinued.active_until';

    /**
     * the column name for the discontinued_on field
     */
    const COL_DISCONTINUED_ON = 'spy_product_discontinued.discontinued_on';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_discontinued.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductDiscontinued', 'FkProduct', 'ActiveUntil', 'DiscontinuedOn', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductDiscontinued', 'fkProduct', 'activeUntil', 'discontinuedOn', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductDiscontinuedTableMap::COL_ID_PRODUCT_DISCONTINUED, SpyProductDiscontinuedTableMap::COL_FK_PRODUCT, SpyProductDiscontinuedTableMap::COL_ACTIVE_UNTIL, SpyProductDiscontinuedTableMap::COL_DISCONTINUED_ON, SpyProductDiscontinuedTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_discontinued', 'fk_product', 'active_until', 'discontinued_on', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductDiscontinued' => 0, 'FkProduct' => 1, 'ActiveUntil' => 2, 'DiscontinuedOn' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idProductDiscontinued' => 0, 'fkProduct' => 1, 'activeUntil' => 2, 'discontinuedOn' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyProductDiscontinuedTableMap::COL_ID_PRODUCT_DISCONTINUED => 0, SpyProductDiscontinuedTableMap::COL_FK_PRODUCT => 1, SpyProductDiscontinuedTableMap::COL_ACTIVE_UNTIL => 2, SpyProductDiscontinuedTableMap::COL_DISCONTINUED_ON => 3, SpyProductDiscontinuedTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_product_discontinued' => 0, 'fk_product' => 1, 'active_until' => 2, 'discontinued_on' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    {
        return array(
            'timestampable' => ['create_column' => 'discontinued_on', 'update_column' => 'updated_at', 'disable_created_at' => 'false', 'disable_updated_at' => 'false'],
...
} // SpyProductDiscontinuedTableMap
