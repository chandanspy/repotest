...
class SpyProductDiscontinuedNoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductDiscontinued.Persistence.Map.SpyProductDiscontinuedNoteTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_discontinued_note';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductDiscontinued\\Persistence\\SpyProductDiscontinuedNote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductDiscontinued.Persistence.SpyProductDiscontinuedNote';
     ...
     */
    const COL_ID_PRODUCT_DISCONTINUED_NOTE = 'spy_product_discontinued_note.id_product_discontinued_note';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_product_discontinued_note.fk_locale';

    /**
     * the column name for the fk_product_discontinued field
     */
    const COL_FK_PRODUCT_DISCONTINUED = 'spy_product_discontinued_note.fk_product_discontinued';

    /**
     * the column name for the note field
     */
    const COL_NOTE = 'spy_product_discontinued_note.note';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_discontinued_note.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_discontinued_note.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductDiscontinuedNote', 'FkLocale', 'FkProductDiscontinued', 'Note', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductDiscontinuedNote', 'fkLocale', 'fkProductDiscontinued', 'note', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductDiscontinuedNoteTableMap::COL_ID_PRODUCT_DISCONTINUED_NOTE, SpyProductDiscontinuedNoteTableMap::COL_FK_LOCALE, SpyProductDiscontinuedNoteTableMap::COL_FK_PRODUCT_DISCONTINUED, SpyProductDiscontinuedNoteTableMap::COL_NOTE, SpyProductDiscontinuedNoteTableMap::COL_CREATED_AT, SpyProductDiscontinuedNoteTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_discontinued_note', 'fk_locale', 'fk_product_discontinued', 'note', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductDiscontinuedNote' => 0, 'FkLocale' => 1, 'FkProductDiscontinued' => 2, 'Note' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductDiscontinuedNote' => 0, 'fkLocale' => 1, 'fkProductDiscontinued' => 2, 'note' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductDiscontinuedNoteTableMap::COL_ID_PRODUCT_DISCONTINUED_NOTE => 0, SpyProductDiscontinuedNoteTableMap::COL_FK_LOCALE => 1, SpyProductDiscontinuedNoteTableMap::COL_FK_PRODUCT_DISCONTINUED => 2, SpyProductDiscontinuedNoteTableMap::COL_NOTE => 3, SpyProductDiscontinuedNoteTableMap::COL_CREATED_AT => 4, SpyProductDiscontinuedNoteTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_discontinued_note' => 0, 'fk_locale' => 1, 'fk_product_discontinued' => 2, 'note' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpyProductDiscontinuedNoteTableMap
