...
class SpyProductAbstractRelationStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductRelationStorage.Persistence.Map.SpyProductAbstractRelationStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_relation_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductRelationStorage\\Persistence\\SpyProductAbstractRelationStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductRelationStorage.Persistence.SpyProductAbstractRelationStorage';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_RELATION_STORAGE = 'spy_product_abstract_relation_storage.id_product_abstract_relation_storage';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_relation_storage.fk_product_abstract';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_abstract_relation_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_product_abstract_relation_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_abstract_relation_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_abstract_relation_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_abstract_relation_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_abstract_relation_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractRelationStorage', 'FkProductAbstract', 'Data', 'Store', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractRelationStorage', 'fkProductAbstract', 'data', 'store', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractRelationStorageTableMap::COL_ID_PRODUCT_ABSTRACT_RELATION_STORAGE, SpyProductAbstractRelationStorageTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractRelationStorageTableMap::COL_DATA, SpyProductAbstractRelationStorageTableMap::COL_STORE, SpyProductAbstractRelationStorageTableMap::COL_ALIAS_KEYS, SpyProductAbstractRelationStorageTableMap::COL_KEY, SpyProductAbstractRelationStorageTableMap::COL_CREATED_AT, SpyProductAbstractRelationStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_relation_storage', 'fk_product_abstract', 'data', 'store', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractRelationStorage' => 0, 'FkProductAbstract' => 1, 'Data' => 2, 'Store' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractRelationStorage' => 0, 'fkProductAbstract' => 1, 'data' => 2, 'store' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_abstract_relation_storage' => 0, 'fk_product_abstract' => 1, 'data' => 2, 'store' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyProductAbstractRelationStorageTableMap
