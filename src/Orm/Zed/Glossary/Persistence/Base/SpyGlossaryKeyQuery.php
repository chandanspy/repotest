 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryKey> find(ConnectionInterface $con = null) Return ChildSpyGlossaryKey objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryKey> findByIdGlossaryKey(int $id_glossary_key) Return ChildSpyGlossaryKey objects filtered by the id_glossary_key column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryKey> findByIsActive(boolean $is_active) Return ChildSpyGlossaryKey objects filtered by the is_active column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryKey> findByKey(string $key) Return ChildSpyGlossaryKey objects filtered by the key column
