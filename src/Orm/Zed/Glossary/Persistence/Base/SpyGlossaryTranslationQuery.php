 ...
 *
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyGlossaryTranslation objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> find(ConnectionInterface $con = null) Return ChildSpyGlossaryTranslation objects based on current ModelCriteria
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection findByIdGlossaryTranslation(int $id_glossary_translation) Return ChildSpyGlossaryTranslation objects filtered by the id_glossary_translation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> findByIdGlossaryTranslation(int $id_glossary_translation) Return ChildSpyGlossaryTranslation objects filtered by the id_glossary_translation column
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyGlossaryTranslation objects filtered by the fk_glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyGlossaryTranslation objects filtered by the fk_glossary_key column
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyGlossaryTranslation objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> findByFkLocale(int $fk_locale) Return ChildSpyGlossaryTranslation objects filtered by the fk_locale column
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyGlossaryTranslation objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> findByIsActive(boolean $is_active) Return ChildSpyGlossaryTranslation objects filtered by the is_active column
 * @method     ChildSpyGlossaryTranslation[]|ObjectCollection findByValue(string $value) Return ChildSpyGlossaryTranslation objects filtered by the value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryTranslation> findByValue(string $value) Return ChildSpyGlossaryTranslation objects filtered by the value column
...
abstract class SpyGlossaryTranslationQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_glossary_translation`, `fk_glossary_key`, `fk_locale`, `is_active`, `value` FROM `spy_glossary_translation` WHERE `id_glossary_translation` = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyGlossaryTranslationQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyGlossaryTranslationTableMap::COL_ID_GLOSSARY_TRANSLATION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyGlossaryTranslationTableMap::COL_ID_GLOSSARY_TRANSLATION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyGlossaryTranslationQuery The current query, for fluid interface
     */
