 ...
 *
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyTaxSetStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> find(ConnectionInterface $con = null) Return ChildSpyTaxSetStorage objects based on current ModelCriteria
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByIdTaxSetStorage(int $id_tax_set_storage) Return ChildSpyTaxSetStorage objects filtered by the id_tax_set_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByIdTaxSetStorage(int $id_tax_set_storage) Return ChildSpyTaxSetStorage objects filtered by the id_tax_set_storage column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByFkTaxSet(int $fk_tax_set) Return ChildSpyTaxSetStorage objects filtered by the fk_tax_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByFkTaxSet(int $fk_tax_set) Return ChildSpyTaxSetStorage objects filtered by the fk_tax_set column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByData(string $data) Return ChildSpyTaxSetStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByData(string $data) Return ChildSpyTaxSetStorage objects filtered by the data column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyTaxSetStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByAliasKeys(string $alias_keys) Return ChildSpyTaxSetStorage objects filtered by the alias_keys column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyTaxSetStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByKey(string $key) Return ChildSpyTaxSetStorage objects filtered by the key column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyTaxSetStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByCreatedAt(string $created_at) Return ChildSpyTaxSetStorage objects filtered by the created_at column
 * @method     ChildSpyTaxSetStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyTaxSetStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTaxSetStorage> findByUpdatedAt(string $updated_at) Return ChildSpyTaxSetStorage objects filtered by the updated_at column
...
abstract class SpyTaxSetStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyTaxSetStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyTaxSetStorageTableMap::COL_ID_TAX_SET_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyTaxSetStorageTableMap::COL_ID_TAX_SET_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyTaxSetStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyTaxSetStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyTaxSetStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyTaxSetStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyTaxSetStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyTaxSetStorageTableMap::COL_CREATED_AT);
    }

} // SpyTaxSetStorageQuery
