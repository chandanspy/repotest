...
class SpyTaxSetStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.TaxStorage.Persistence.Map.SpyTaxSetStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_tax_set_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\TaxStorage\\Persistence\\SpyTaxSetStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.TaxStorage.Persistence.SpyTaxSetStorage';
     ...
     */
    const COL_ID_TAX_SET_STORAGE = 'spy_tax_set_storage.id_tax_set_storage';

    /**
     * the column name for the fk_tax_set field
     */
    const COL_FK_TAX_SET = 'spy_tax_set_storage.fk_tax_set';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_tax_set_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_tax_set_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_tax_set_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_tax_set_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_tax_set_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTaxSetStorage', 'FkTaxSet', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idTaxSetStorage', 'fkTaxSet', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyTaxSetStorageTableMap::COL_ID_TAX_SET_STORAGE, SpyTaxSetStorageTableMap::COL_FK_TAX_SET, SpyTaxSetStorageTableMap::COL_DATA, SpyTaxSetStorageTableMap::COL_ALIAS_KEYS, SpyTaxSetStorageTableMap::COL_KEY, SpyTaxSetStorageTableMap::COL_CREATED_AT, SpyTaxSetStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_tax_set_storage', 'fk_tax_set', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTaxSetStorage' => 0, 'FkTaxSet' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idTaxSetStorage' => 0, 'fkTaxSet' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyTaxSetStorageTableMap::COL_ID_TAX_SET_STORAGE => 0, SpyTaxSetStorageTableMap::COL_FK_TAX_SET => 1, SpyTaxSetStorageTableMap::COL_DATA => 2, SpyTaxSetStorageTableMap::COL_ALIAS_KEYS => 3, SpyTaxSetStorageTableMap::COL_KEY => 4, SpyTaxSetStorageTableMap::COL_CREATED_AT => 5, SpyTaxSetStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_tax_set_storage' => 0, 'fk_tax_set' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        return array(
            'synchronization' => ['resource' => ['value' => 'tax_set'], 'queue_group' => ['value' => 'sync.storage.tax_set'], 'queue_pool' => NULL, 'key_suffix_column' => ['value' => 'fk_tax_set']],
