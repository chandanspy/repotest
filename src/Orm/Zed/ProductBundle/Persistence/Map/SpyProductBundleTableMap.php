...
class SpyProductBundleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductBundle.Persistence.Map.SpyProductBundleTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_bundle';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductBundle\\Persistence\\SpyProductBundle';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductBundle.Persistence.SpyProductBundle';
     ...
     */
    const COL_ID_PRODUCT_BUNDLE = 'spy_product_bundle.id_product_bundle';

    /**
     * the column name for the fk_bundled_product field
     */
    const COL_FK_BUNDLED_PRODUCT = 'spy_product_bundle.fk_bundled_product';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_bundle.fk_product';

    /**
     * the column name for the quantity field
     */
    const COL_QUANTITY = 'spy_product_bundle.quantity';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_bundle.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_bundle.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductBundle', 'FkBundledProduct', 'FkProduct', 'Quantity', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductBundle', 'fkBundledProduct', 'fkProduct', 'quantity', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductBundleTableMap::COL_ID_PRODUCT_BUNDLE, SpyProductBundleTableMap::COL_FK_BUNDLED_PRODUCT, SpyProductBundleTableMap::COL_FK_PRODUCT, SpyProductBundleTableMap::COL_QUANTITY, SpyProductBundleTableMap::COL_CREATED_AT, SpyProductBundleTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_bundle', 'fk_bundled_product', 'fk_product', 'quantity', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductBundle' => 0, 'FkBundledProduct' => 1, 'FkProduct' => 2, 'Quantity' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductBundle' => 0, 'fkBundledProduct' => 1, 'fkProduct' => 2, 'quantity' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductBundleTableMap::COL_ID_PRODUCT_BUNDLE => 0, SpyProductBundleTableMap::COL_FK_BUNDLED_PRODUCT => 1, SpyProductBundleTableMap::COL_FK_PRODUCT => 2, SpyProductBundleTableMap::COL_QUANTITY => 3, SpyProductBundleTableMap::COL_CREATED_AT => 4, SpyProductBundleTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_bundle' => 0, 'fk_bundled_product' => 1, 'fk_product' => 2, 'quantity' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        $this->addRelation('SpyProductRelatedByFkBundledProduct', '\\Orm\\Zed\\Product\\Persistence\\SpyProduct', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
