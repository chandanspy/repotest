 ...
 *
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderItemBundle objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> find(ConnectionInterface $con = null) Return ChildSpySalesOrderItemBundle objects based on current ModelCriteria
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByIdSalesOrderItemBundle(int $id_sales_order_item_bundle) Return ChildSpySalesOrderItemBundle objects filtered by the id_sales_order_item_bundle column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByIdSalesOrderItemBundle(int $id_sales_order_item_bundle) Return ChildSpySalesOrderItemBundle objects filtered by the id_sales_order_item_bundle column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByCartNote(string $cart_note) Return ChildSpySalesOrderItemBundle objects filtered by the cart_note column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByCartNote(string $cart_note) Return ChildSpySalesOrderItemBundle objects filtered by the cart_note column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByGrossPrice(int $gross_price) Return ChildSpySalesOrderItemBundle objects filtered by the gross_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByGrossPrice(int $gross_price) Return ChildSpySalesOrderItemBundle objects filtered by the gross_price column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByImage(string $image) Return ChildSpySalesOrderItemBundle objects filtered by the image column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByImage(string $image) Return ChildSpySalesOrderItemBundle objects filtered by the image column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByName(string $name) Return ChildSpySalesOrderItemBundle objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByName(string $name) Return ChildSpySalesOrderItemBundle objects filtered by the name column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByNetPrice(int $net_price) Return ChildSpySalesOrderItemBundle objects filtered by the net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByNetPrice(int $net_price) Return ChildSpySalesOrderItemBundle objects filtered by the net_price column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByPrice(int $price) Return ChildSpySalesOrderItemBundle objects filtered by the price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByPrice(int $price) Return ChildSpySalesOrderItemBundle objects filtered by the price column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findBySku(string $sku) Return ChildSpySalesOrderItemBundle objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findBySku(string $sku) Return ChildSpySalesOrderItemBundle objects filtered by the sku column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderItemBundle objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByCreatedAt(string $created_at) Return ChildSpySalesOrderItemBundle objects filtered by the created_at column
 * @method     ChildSpySalesOrderItemBundle[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderItemBundle objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemBundle> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderItemBundle objects filtered by the updated_at column
...
abstract class SpySalesOrderItemBundleQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderItemBundleQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderItemBundleTableMap::COL_ID_SALES_ORDER_ITEM_BUNDLE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderItemBundleTableMap::COL_ID_SALES_ORDER_ITEM_BUNDLE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpySalesOrderItemBundleQuery The current query, for fluid interface
     */
    public function filterBySalesOrderItem($spySalesOrderItem, $comparison = null)
    {
    ...
    {
        return $this->useExistsQuery('SalesOrderItem', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SalesOrderItem', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpySalesOrderItemBundleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderItemBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderItemBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderItemBundleTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderItemBundleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderItemBundleTableMap::COL_CREATED_AT);
    }

} // SpySalesOrderItemBundleQuery
