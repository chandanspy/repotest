 ...
 *
 * @method     ChildSpyProductBundle[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductBundle objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> find(ConnectionInterface $con = null) Return ChildSpyProductBundle objects based on current ModelCriteria
 * @method     ChildSpyProductBundle[]|ObjectCollection findByIdProductBundle(int $id_product_bundle) Return ChildSpyProductBundle objects filtered by the id_product_bundle column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByIdProductBundle(int $id_product_bundle) Return ChildSpyProductBundle objects filtered by the id_product_bundle column
 * @method     ChildSpyProductBundle[]|ObjectCollection findByFkBundledProduct(int $fk_bundled_product) Return ChildSpyProductBundle objects filtered by the fk_bundled_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByFkBundledProduct(int $fk_bundled_product) Return ChildSpyProductBundle objects filtered by the fk_bundled_product column
 * @method     ChildSpyProductBundle[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductBundle objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByFkProduct(int $fk_product) Return ChildSpyProductBundle objects filtered by the fk_product column
 * @method     ChildSpyProductBundle[]|ObjectCollection findByQuantity(int $quantity) Return ChildSpyProductBundle objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByQuantity(int $quantity) Return ChildSpyProductBundle objects filtered by the quantity column
 * @method     ChildSpyProductBundle[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductBundle objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByCreatedAt(string $created_at) Return ChildSpyProductBundle objects filtered by the created_at column
 * @method     ChildSpyProductBundle[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductBundle objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductBundle> findByUpdatedAt(string $updated_at) Return ChildSpyProductBundle objects filtered by the updated_at column
...
abstract class SpyProductBundleQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductBundleQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductBundleTableMap::COL_ID_PRODUCT_BUNDLE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductBundleTableMap::COL_ID_PRODUCT_BUNDLE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductBundleQuery The current query, for fluid interface
     */
    public function filterBySpyProductRelatedByFkBundledProduct($spyProduct, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductBundleQuery The current query, for fluid interface
     */
    public function joinSpyProductRelatedByFkBundledProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyProductRelatedByFkBundledProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductRelatedByFkBundledProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\Product\Persistence\SpyProduct object
     *
    ...
    {
        return $this->useExistsQuery('SpyProductRelatedByFkProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductRelatedByFkProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductBundleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductBundleTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductBundleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductBundleTableMap::COL_CREATED_AT);
    }
