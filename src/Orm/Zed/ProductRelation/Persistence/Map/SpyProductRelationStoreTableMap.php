...
class SpyProductRelationStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductRelation.Persistence.Map.SpyProductRelationStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_relation_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductRelation\\Persistence\\SpyProductRelationStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductRelation.Persistence.SpyProductRelationStore';
     ...
     */
    const COL_ID_PRODUCT_RELATION_STORE = 'spy_product_relation_store.id_product_relation_store';

    /**
     * the column name for the fk_product_relation field
     */
    const COL_FK_PRODUCT_RELATION = 'spy_product_relation_store.fk_product_relation';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_product_relation_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductRelationStore', 'FkProductRelation', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idProductRelationStore', 'fkProductRelation', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyProductRelationStoreTableMap::COL_ID_PRODUCT_RELATION_STORE, SpyProductRelationStoreTableMap::COL_FK_PRODUCT_RELATION, SpyProductRelationStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_store', 'fk_product_relation', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductRelationStore' => 0, 'FkProductRelation' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductRelationStore' => 0, 'fkProductRelation' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductRelationStoreTableMap::COL_ID_PRODUCT_RELATION_STORE => 0, SpyProductRelationStoreTableMap::COL_FK_PRODUCT_RELATION => 1, SpyProductRelationStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_store' => 0, 'fk_product_relation' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductRelationStoreTableMap
