...
class SpyProductRelationTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductRelation.Persistence.Map.SpyProductRelationTypeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_relation_type';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductRelation\\Persistence\\SpyProductRelationType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductRelation.Persistence.SpyProductRelationType';
     ...
     */
    const COL_ID_PRODUCT_RELATION_TYPE = 'spy_product_relation_type.id_product_relation_type';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_relation_type.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_relation_type.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_relation_type.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductRelationType', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductRelationType', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductRelationTypeTableMap::COL_ID_PRODUCT_RELATION_TYPE, SpyProductRelationTypeTableMap::COL_KEY, SpyProductRelationTypeTableMap::COL_CREATED_AT, SpyProductRelationTypeTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_type', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductRelationType' => 0, 'Key' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductRelationType' => 0, 'key' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductRelationTypeTableMap::COL_ID_PRODUCT_RELATION_TYPE => 0, SpyProductRelationTypeTableMap::COL_KEY => 1, SpyProductRelationTypeTableMap::COL_CREATED_AT => 2, SpyProductRelationTypeTableMap::COL_UPDATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_type' => 0, 'key' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductRelationTypeTableMap
