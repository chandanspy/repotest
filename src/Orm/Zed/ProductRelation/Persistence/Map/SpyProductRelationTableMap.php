...
class SpyProductRelationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductRelation.Persistence.Map.SpyProductRelationTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_relation';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductRelation\\Persistence\\SpyProductRelation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductRelation.Persistence.SpyProductRelation';
     ...
     */
    const COL_ID_PRODUCT_RELATION = 'spy_product_relation.id_product_relation';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_relation.fk_product_abstract';

    /**
     * the column name for the fk_product_relation_type field
     */
    const COL_FK_PRODUCT_RELATION_TYPE = 'spy_product_relation.fk_product_relation_type';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_product_relation.is_active';

    /**
     * the column name for the is_rebuild_scheduled field
     */
    const COL_IS_REBUILD_SCHEDULED = 'spy_product_relation.is_rebuild_scheduled';

    /**
     * the column name for the product_relation_key field
     */
    const COL_PRODUCT_RELATION_KEY = 'spy_product_relation.product_relation_key';

    /**
     * the column name for the query_set_data field
     */
    const COL_QUERY_SET_DATA = 'spy_product_relation.query_set_data';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_relation.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_relation.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductRelation', 'FkProductAbstract', 'FkProductRelationType', 'IsActive', 'IsRebuildScheduled', 'ProductRelationKey', 'QuerySetData', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductRelation', 'fkProductAbstract', 'fkProductRelationType', 'isActive', 'isRebuildScheduled', 'productRelationKey', 'querySetData', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductRelationTableMap::COL_ID_PRODUCT_RELATION, SpyProductRelationTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductRelationTableMap::COL_FK_PRODUCT_RELATION_TYPE, SpyProductRelationTableMap::COL_IS_ACTIVE, SpyProductRelationTableMap::COL_IS_REBUILD_SCHEDULED, SpyProductRelationTableMap::COL_PRODUCT_RELATION_KEY, SpyProductRelationTableMap::COL_QUERY_SET_DATA, SpyProductRelationTableMap::COL_CREATED_AT, SpyProductRelationTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_relation', 'fk_product_abstract', 'fk_product_relation_type', 'is_active', 'is_rebuild_scheduled', 'product_relation_key', 'query_set_data', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductRelation' => 0, 'FkProductAbstract' => 1, 'FkProductRelationType' => 2, 'IsActive' => 3, 'IsRebuildScheduled' => 4, 'ProductRelationKey' => 5, 'QuerySetData' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idProductRelation' => 0, 'fkProductAbstract' => 1, 'fkProductRelationType' => 2, 'isActive' => 3, 'isRebuildScheduled' => 4, 'productRelationKey' => 5, 'querySetData' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_relation' => 0, 'fk_product_abstract' => 1, 'fk_product_relation_type' => 2, 'is_active' => 3, 'is_rebuild_scheduled' => 4, 'product_relation_key' => 5, 'query_set_data' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
