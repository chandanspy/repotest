...
class SpyProductRelationProductAbstractTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductRelation.Persistence.Map.SpyProductRelationProductAbstractTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_relation_product_abstract';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductRelation\\Persistence\\SpyProductRelationProductAbstract';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductRelation.Persistence.SpyProductRelationProductAbstract';
     ...
     */
    const COL_ID_PRODUCT_RELATION_PRODUCT_ABSTRACT = 'spy_product_relation_product_abstract.id_product_relation_product_abstract';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_relation_product_abstract.fk_product_abstract';

    /**
     * the column name for the fk_product_relation field
     */
    const COL_FK_PRODUCT_RELATION = 'spy_product_relation_product_abstract.fk_product_relation';

    /**
     * the column name for the order field
     */
    const COL_ORDER = 'spy_product_relation_product_abstract.order';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_relation_product_abstract.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_relation_product_abstract.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductRelationProductAbstract', 'FkProductAbstract', 'FkProductRelation', 'Order', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductRelationProductAbstract', 'fkProductAbstract', 'fkProductRelation', 'order', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductRelationProductAbstractTableMap::COL_ID_PRODUCT_RELATION_PRODUCT_ABSTRACT, SpyProductRelationProductAbstractTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductRelationProductAbstractTableMap::COL_FK_PRODUCT_RELATION, SpyProductRelationProductAbstractTableMap::COL_ORDER, SpyProductRelationProductAbstractTableMap::COL_CREATED_AT, SpyProductRelationProductAbstractTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_product_abstract', 'fk_product_abstract', 'fk_product_relation', 'order', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductRelationProductAbstract' => 0, 'FkProductAbstract' => 1, 'FkProductRelation' => 2, 'Order' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductRelationProductAbstract' => 0, 'fkProductAbstract' => 1, 'fkProductRelation' => 2, 'order' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductRelationProductAbstractTableMap::COL_ID_PRODUCT_RELATION_PRODUCT_ABSTRACT => 0, SpyProductRelationProductAbstractTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductRelationProductAbstractTableMap::COL_FK_PRODUCT_RELATION => 2, SpyProductRelationProductAbstractTableMap::COL_ORDER => 3, SpyProductRelationProductAbstractTableMap::COL_CREATED_AT => 4, SpyProductRelationProductAbstractTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_relation_product_abstract' => 0, 'fk_product_abstract' => 1, 'fk_product_relation' => 2, 'order' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpyProductRelationProductAbstractTableMap
