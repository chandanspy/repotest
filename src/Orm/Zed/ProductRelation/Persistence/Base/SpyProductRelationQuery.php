 ...
 *
 * @method     ChildSpyProductRelation[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductRelation objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> find(ConnectionInterface $con = null) Return ChildSpyProductRelation objects based on current ModelCriteria
 * @method     ChildSpyProductRelation[]|ObjectCollection findByIdProductRelation(int $id_product_relation) Return ChildSpyProductRelation objects filtered by the id_product_relation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByIdProductRelation(int $id_product_relation) Return ChildSpyProductRelation objects filtered by the id_product_relation column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductRelation objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductRelation objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByFkProductRelationType(int $fk_product_relation_type) Return ChildSpyProductRelation objects filtered by the fk_product_relation_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByFkProductRelationType(int $fk_product_relation_type) Return ChildSpyProductRelation objects filtered by the fk_product_relation_type column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyProductRelation objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByIsActive(boolean $is_active) Return ChildSpyProductRelation objects filtered by the is_active column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByIsRebuildScheduled(boolean $is_rebuild_scheduled) Return ChildSpyProductRelation objects filtered by the is_rebuild_scheduled column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByIsRebuildScheduled(boolean $is_rebuild_scheduled) Return ChildSpyProductRelation objects filtered by the is_rebuild_scheduled column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByProductRelationKey(string $product_relation_key) Return ChildSpyProductRelation objects filtered by the product_relation_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByProductRelationKey(string $product_relation_key) Return ChildSpyProductRelation objects filtered by the product_relation_key column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByQuerySetData(string $query_set_data) Return ChildSpyProductRelation objects filtered by the query_set_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByQuerySetData(string $query_set_data) Return ChildSpyProductRelation objects filtered by the query_set_data column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductRelation objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByCreatedAt(string $created_at) Return ChildSpyProductRelation objects filtered by the created_at column
 * @method     ChildSpyProductRelation[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductRelation objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelation> findByUpdatedAt(string $updated_at) Return ChildSpyProductRelation objects filtered by the updated_at column
...
abstract class SpyProductRelationQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductRelationQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductRelationTableMap::COL_ID_PRODUCT_RELATION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductRelationTableMap::COL_ID_PRODUCT_RELATION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductRelationQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyProductRelationQuery The current query, for fluid interface
     */
    public function filterBySpyProductRelationType($spyProductRelationType, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductRelationQuery The current query, for fluid interface
     */
    public function joinSpyProductRelationType($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductRelationType', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductRelationType', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductRelationTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductRelationTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductRelationTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductRelationTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductRelationTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductRelationTableMap::COL_CREATED_AT);
    }

} // SpyProductRelationQuery
