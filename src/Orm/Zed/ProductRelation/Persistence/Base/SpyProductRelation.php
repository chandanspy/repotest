...
abstract class SpyProductRelation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductRelation\\Persistence\\Map\\SpyProductRelationTableMap';
     ...
     * @return $this|\Orm\Zed\ProductRelation\Persistence\SpyProductRelation The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductRelation\Persistence\SpyProductRelation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductRelation\Persistence\SpyProductRelation The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductRelation The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductRelationProductAbstract(ChildSpyProductRelationProductAbstract $spyProductRelationProductAbstract)
    {
     ...
     */
    protected function doAddProductRelationStore(ChildSpyProductRelationStore $productRelationStore)
    {
