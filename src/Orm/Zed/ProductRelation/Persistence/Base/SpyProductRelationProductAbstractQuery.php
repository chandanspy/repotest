 ...
 *
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductRelationProductAbstract objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> find(ConnectionInterface $con = null) Return ChildSpyProductRelationProductAbstract objects based on current ModelCriteria
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByIdProductRelationProductAbstract(int $id_product_relation_product_abstract) Return ChildSpyProductRelationProductAbstract objects filtered by the id_product_relation_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByIdProductRelationProductAbstract(int $id_product_relation_product_abstract) Return ChildSpyProductRelationProductAbstract objects filtered by the id_product_relation_product_abstract column
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductRelationProductAbstract objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductRelationProductAbstract objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByFkProductRelation(int $fk_product_relation) Return ChildSpyProductRelationProductAbstract objects filtered by the fk_product_relation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByFkProductRelation(int $fk_product_relation) Return ChildSpyProductRelationProductAbstract objects filtered by the fk_product_relation column
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByOrder(int $order) Return ChildSpyProductRelationProductAbstract objects filtered by the order column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByOrder(int $order) Return ChildSpyProductRelationProductAbstract objects filtered by the order column
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductRelationProductAbstract objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByCreatedAt(string $created_at) Return ChildSpyProductRelationProductAbstract objects filtered by the created_at column
 * @method     ChildSpyProductRelationProductAbstract[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductRelationProductAbstract objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductRelationProductAbstract> findByUpdatedAt(string $updated_at) Return ChildSpyProductRelationProductAbstract objects filtered by the updated_at column
...
abstract class SpyProductRelationProductAbstractQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductRelationProductAbstractQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductRelationProductAbstractTableMap::COL_ID_PRODUCT_RELATION_PRODUCT_ABSTRACT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductRelationProductAbstractTableMap::COL_ID_PRODUCT_RELATION_PRODUCT_ABSTRACT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductRelationProductAbstractQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductRelationProductAbstractTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductRelationProductAbstractTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductRelationProductAbstractTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductRelationProductAbstractTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductRelationProductAbstractTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductRelationProductAbstractTableMap::COL_CREATED_AT);
    }

} // SpyProductRelationProductAbstractQuery
