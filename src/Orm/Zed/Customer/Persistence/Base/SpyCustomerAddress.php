...
abstract class SpyCustomerAddress implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Customer\\Persistence\\Map\\SpyCustomerAddressTableMap';
     ...
     * @return $this|\Orm\Zed\Customer\Persistence\SpyCustomerAddress The current object (for fluent API support)
     */
    public function setIdCustomerAddress($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_customer_address !== $v) {
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyCustomerAddressTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SpyCustomerAddressTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SpyCustomerAddressTableMap::translateFieldName('ZipCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SpyCustomerAddressTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SpyCustomerAddressTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 20; // 20 = SpyCustomerAddressTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyCustomerAddressTableMap::COL_UUID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Customer\Persistence\SpyCustomerAddress
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[16], $arr)) {
            $this->setUuid($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setZipCode($arr[$keys[17]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Customer\Persistence\SpyCustomerAddress The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyCustomerAddressTableMap::COL_UUID)) {
            $criteria->add(SpyCustomerAddressTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyCustomerAddressTableMap::COL_ZIP_CODE)) {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyCustomer}> List of ChildSpyCustomer objects
     */
    public function getCustomerBillingAddressesJoinSpyUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyCustomerQuery::create(null, $criteria);
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyCustomer}> List of ChildSpyCustomer objects
     */
    public function getCustomerShippingAddressesJoinSpyUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyCustomerQuery::create(null, $criteria);
        $query->joinWith('SpyUser', $joinBehavior);
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'customer_address' . '.' . $this->getIdCustomerAddress() . '.' . $this->getFkCustomer();
