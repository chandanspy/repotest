 ...
 * @method     ChildSpyCustomerAddressQuery orderByUuid($order = Criteria::ASC) Order by the uuid column
 ...
 * @method     ChildSpyCustomerAddressQuery groupByUuid() Group by the uuid column
 ...
 * @method     ChildSpyCustomerAddress|null findOneByUuid(string $uuid) Return the first ChildSpyCustomerAddress filtered by the uuid column
 ...
 * @method     ChildSpyCustomerAddress requireOneByUuid(string $uuid) Return the first ChildSpyCustomerAddress filtered by the uuid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> find(ConnectionInterface $con = null) Return ChildSpyCustomerAddress objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByIdCustomerAddress(int $id_customer_address) Return ChildSpyCustomerAddress objects filtered by the id_customer_address column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByFkCountry(int $fk_country) Return ChildSpyCustomerAddress objects filtered by the fk_country column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByFkCustomer(int $fk_customer) Return ChildSpyCustomerAddress objects filtered by the fk_customer column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByFkRegion(int $fk_region) Return ChildSpyCustomerAddress objects filtered by the fk_region column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByAddress1(string $address1) Return ChildSpyCustomerAddress objects filtered by the address1 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByAddress2(string $address2) Return ChildSpyCustomerAddress objects filtered by the address2 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByAddress3(string $address3) Return ChildSpyCustomerAddress objects filtered by the address3 column
 * @method     ChildSpyCustomerAddress[]|ObjectCollection findByAnonymizedAt(string $anonymized_at) Return ChildSpyCustomerAddress objects filtered by the anonymized_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByAnonymizedAt(string $anonymized_at) Return ChildSpyCustomerAddress objects filtered by the anonymized_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByCity(string $city) Return ChildSpyCustomerAddress objects filtered by the city column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByComment(string $comment) Return ChildSpyCustomerAddress objects filtered by the comment column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByCompany(string $company) Return ChildSpyCustomerAddress objects filtered by the company column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByDeletedAt(string $deleted_at) Return ChildSpyCustomerAddress objects filtered by the deleted_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByFirstName(string $first_name) Return ChildSpyCustomerAddress objects filtered by the first_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByLastName(string $last_name) Return ChildSpyCustomerAddress objects filtered by the last_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByPhone(string $phone) Return ChildSpyCustomerAddress objects filtered by the phone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findBySalutation(int $salutation) Return ChildSpyCustomerAddress objects filtered by the salutation column
 * @method     ChildSpyCustomerAddress[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCustomerAddress objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByUuid(string $uuid) Return ChildSpyCustomerAddress objects filtered by the uuid column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByZipCode(string $zip_code) Return ChildSpyCustomerAddress objects filtered by the zip_code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByCreatedAt(string $created_at) Return ChildSpyCustomerAddress objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCustomerAddress> findByUpdatedAt(string $updated_at) Return ChildSpyCustomerAddress objects filtered by the updated_at column
...
abstract class SpyCustomerAddressQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_customer_address, fk_country, fk_customer, fk_region, address1, address2, address3, anonymized_at, city, comment, company, deleted_at, first_name, last_name, phone, salutation, uuid, zip_code, created_at, updated_at FROM spy_customer_address WHERE id_customer_address = :p0';
        try {
    ...
    public function filterByUuid($uuid = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyCustomerAddressTableMap::COL_UUID, $uuid, $comparison);
