...
class SpyNavigationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Navigation.Persistence.Map.SpyNavigationTableMap';
     ...
     */
    const TABLE_NAME = 'spy_navigation';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Navigation\\Persistence\\SpyNavigation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Navigation.Persistence.SpyNavigation';
     ...
     */
    const COL_ID_NAVIGATION = 'spy_navigation.id_navigation';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_navigation.is_active';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_navigation.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_navigation.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_navigation.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_navigation.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdNavigation', 'IsActive', 'Key', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idNavigation', 'isActive', 'key', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyNavigationTableMap::COL_ID_NAVIGATION, SpyNavigationTableMap::COL_IS_ACTIVE, SpyNavigationTableMap::COL_KEY, SpyNavigationTableMap::COL_NAME, SpyNavigationTableMap::COL_CREATED_AT, SpyNavigationTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_navigation', 'is_active', 'key', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdNavigation' => 0, 'IsActive' => 1, 'Key' => 2, 'Name' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idNavigation' => 0, 'isActive' => 1, 'key' => 2, 'name' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyNavigationTableMap::COL_ID_NAVIGATION => 0, SpyNavigationTableMap::COL_IS_ACTIVE => 1, SpyNavigationTableMap::COL_KEY => 2, SpyNavigationTableMap::COL_NAME => 3, SpyNavigationTableMap::COL_CREATED_AT => 4, SpyNavigationTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_navigation' => 0, 'is_active' => 1, 'key' => 2, 'name' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
