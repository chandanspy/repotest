...
class SpyNavigationNodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Navigation.Persistence.Map.SpyNavigationNodeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_navigation_node';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Navigation\\Persistence\\SpyNavigationNode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Navigation.Persistence.SpyNavigationNode';
     ...
     */
    const COL_ID_NAVIGATION_NODE = 'spy_navigation_node.id_navigation_node';

    /**
     * the column name for the fk_navigation field
     */
    const COL_FK_NAVIGATION = 'spy_navigation_node.fk_navigation';

    /**
     * the column name for the fk_parent_navigation_node field
     */
    const COL_FK_PARENT_NAVIGATION_NODE = 'spy_navigation_node.fk_parent_navigation_node';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_navigation_node.is_active';

    /**
     * the column name for the node_key field
     */
    const COL_NODE_KEY = 'spy_navigation_node.node_key';

    /**
     * the column name for the node_type field
     */
    const COL_NODE_TYPE = 'spy_navigation_node.node_type';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_navigation_node.position';

    /**
     * the column name for the valid_from field
     */
    const COL_VALID_FROM = 'spy_navigation_node.valid_from';

    /**
     * the column name for the valid_to field
     */
    const COL_VALID_TO = 'spy_navigation_node.valid_to';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdNavigationNode', 'FkNavigation', 'FkParentNavigationNode', 'IsActive', 'NodeKey', 'NodeType', 'Position', 'ValidFrom', 'ValidTo', ),
        self::TYPE_CAMELNAME     => array('idNavigationNode', 'fkNavigation', 'fkParentNavigationNode', 'isActive', 'nodeKey', 'nodeType', 'position', 'validFrom', 'validTo', ),
        self::TYPE_COLNAME       => array(SpyNavigationNodeTableMap::COL_ID_NAVIGATION_NODE, SpyNavigationNodeTableMap::COL_FK_NAVIGATION, SpyNavigationNodeTableMap::COL_FK_PARENT_NAVIGATION_NODE, SpyNavigationNodeTableMap::COL_IS_ACTIVE, SpyNavigationNodeTableMap::COL_NODE_KEY, SpyNavigationNodeTableMap::COL_NODE_TYPE, SpyNavigationNodeTableMap::COL_POSITION, SpyNavigationNodeTableMap::COL_VALID_FROM, SpyNavigationNodeTableMap::COL_VALID_TO, ),
        self::TYPE_FIELDNAME     => array('id_navigation_node', 'fk_navigation', 'fk_parent_navigation_node', 'is_active', 'node_key', 'node_type', 'position', 'valid_from', 'valid_to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdNavigationNode' => 0, 'FkNavigation' => 1, 'FkParentNavigationNode' => 2, 'IsActive' => 3, 'NodeKey' => 4, 'NodeType' => 5, 'Position' => 6, 'ValidFrom' => 7, 'ValidTo' => 8, ),
        self::TYPE_CAMELNAME     => array('idNavigationNode' => 0, 'fkNavigation' => 1, 'fkParentNavigationNode' => 2, 'isActive' => 3, 'nodeKey' => 4, 'nodeType' => 5, 'position' => 6, 'validFrom' => 7, 'validTo' => 8, ),
        self::TYPE_COLNAME       => array(SpyNavigationNodeTableMap::COL_ID_NAVIGATION_NODE => 0, SpyNavigationNodeTableMap::COL_FK_NAVIGATION => 1, SpyNavigationNodeTableMap::COL_FK_PARENT_NAVIGATION_NODE => 2, SpyNavigationNodeTableMap::COL_IS_ACTIVE => 3, SpyNavigationNodeTableMap::COL_NODE_KEY => 4, SpyNavigationNodeTableMap::COL_NODE_TYPE => 5, SpyNavigationNodeTableMap::COL_POSITION => 6, SpyNavigationNodeTableMap::COL_VALID_FROM => 7, SpyNavigationNodeTableMap::COL_VALID_TO => 8, ),
        self::TYPE_FIELDNAME     => array('id_navigation_node' => 0, 'fk_navigation' => 1, 'fk_parent_navigation_node' => 2, 'is_active' => 3, 'node_key' => 4, 'node_type' => 5, 'position' => 6, 'valid_from' => 7, 'valid_to' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
