 ...
 *
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyNavigationNodeLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyNavigationNodeLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByIdNavigationNodeLocalizedAttributes(int $id_navigation_node_localized_attributes) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the id_navigation_node_localized_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByIdNavigationNodeLocalizedAttributes(int $id_navigation_node_localized_attributes) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the id_navigation_node_localized_attributes column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByFkNavigationNode(int $fk_navigation_node) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_navigation_node column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByFkNavigationNode(int $fk_navigation_node) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_navigation_node column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByFkUrl(int $fk_url) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_url column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByFkUrl(int $fk_url) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the fk_url column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByCssClass(string $css_class) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the css_class column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByCssClass(string $css_class) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the css_class column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByExternalUrl(string $external_url) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the external_url column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByExternalUrl(string $external_url) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the external_url column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByLink(string $link) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the link column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByLink(string $link) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the link column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByTitle(string $title) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByTitle(string $title) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the title column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByCreatedAt(string $created_at) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the created_at column
 * @method     ChildSpyNavigationNodeLocalizedAttributes[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNodeLocalizedAttributes> findByUpdatedAt(string $updated_at) Return ChildSpyNavigationNodeLocalizedAttributes objects filtered by the updated_at column
...
abstract class SpyNavigationNodeLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyNavigationNodeLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyNavigationNodeLocalizedAttributesTableMap::COL_ID_NAVIGATION_NODE_LOCALIZED_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyNavigationNodeLocalizedAttributesTableMap::COL_ID_NAVIGATION_NODE_LOCALIZED_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyNavigationNodeLocalizedAttributesQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyNavigationNodeLocalizedAttributesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyNavigationNodeLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyNavigationNodeLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyNavigationNodeLocalizedAttributesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyNavigationNodeLocalizedAttributesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyNavigationNodeLocalizedAttributesTableMap::COL_CREATED_AT);
    }

} // SpyNavigationNodeLocalizedAttributesQuery
