 ...
 *
 * @method     \Orm\Zed\Navigation\Persistence\SpyNavigationNodeQuery|\Orm\Zed\Navigation\Persistence\SpyNavigationQuery|\Orm\Zed\Navigation\Persistence\SpyNavigationNodeLocalizedAttributesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyNavigationNode[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyNavigationNode objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> find(ConnectionInterface $con = null) Return ChildSpyNavigationNode objects based on current ModelCriteria
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByIdNavigationNode(int $id_navigation_node) Return ChildSpyNavigationNode objects filtered by the id_navigation_node column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByIdNavigationNode(int $id_navigation_node) Return ChildSpyNavigationNode objects filtered by the id_navigation_node column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByFkNavigation(int $fk_navigation) Return ChildSpyNavigationNode objects filtered by the fk_navigation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByFkNavigation(int $fk_navigation) Return ChildSpyNavigationNode objects filtered by the fk_navigation column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByFkParentNavigationNode(int $fk_parent_navigation_node) Return ChildSpyNavigationNode objects filtered by the fk_parent_navigation_node column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByFkParentNavigationNode(int $fk_parent_navigation_node) Return ChildSpyNavigationNode objects filtered by the fk_parent_navigation_node column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyNavigationNode objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByIsActive(boolean $is_active) Return ChildSpyNavigationNode objects filtered by the is_active column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByNodeKey(string $node_key) Return ChildSpyNavigationNode objects filtered by the node_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByNodeKey(string $node_key) Return ChildSpyNavigationNode objects filtered by the node_key column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByNodeType(string $node_type) Return ChildSpyNavigationNode objects filtered by the node_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByNodeType(string $node_type) Return ChildSpyNavigationNode objects filtered by the node_type column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByPosition(int $position) Return ChildSpyNavigationNode objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByPosition(int $position) Return ChildSpyNavigationNode objects filtered by the position column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByValidFrom(string $valid_from) Return ChildSpyNavigationNode objects filtered by the valid_from column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByValidFrom(string $valid_from) Return ChildSpyNavigationNode objects filtered by the valid_from column
 * @method     ChildSpyNavigationNode[]|ObjectCollection findByValidTo(string $valid_to) Return ChildSpyNavigationNode objects filtered by the valid_to column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNavigationNode> findByValidTo(string $valid_to) Return ChildSpyNavigationNode objects filtered by the valid_to column
...
abstract class SpyNavigationNodeQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyNavigationNodeTableMap::COL_ID_NAVIGATION_NODE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyNavigationNodeTableMap::COL_ID_NAVIGATION_NODE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function filterByParentNavigationNode($spyNavigationNode, $comparison = null)
    {
     ...
     * @return $this|ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function joinParentNavigationNode($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('ParentNavigationNode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ParentNavigationNode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function filterBySpyNavigation($spyNavigation, $comparison = null)
    {
     ...
     * @return $this|ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function joinSpyNavigation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyNavigation', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyNavigation', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\Navigation\Persistence\SpyNavigationNode object
     *
     ...
     * @return ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function filterByChildrenNavigationNode($spyNavigationNode, $comparison = null)
    {
        if ($spyNavigationNode instanceof \Orm\Zed\Navigation\Persistence\SpyNavigationNode) {
            return $this
     ...
     * @return $this|ChildSpyNavigationNodeQuery The current query, for fluid interface
     */
    public function joinChildrenNavigationNode($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ChildrenNavigationNode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ChildrenNavigationNode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
