...
class SpyCompanyUserStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CompanyUserStorage.Persistence.Map.SpyCompanyUserStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_company_user_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CompanyUserStorage\\Persistence\\SpyCompanyUserStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CompanyUserStorage.Persistence.SpyCompanyUserStorage';
     ...
     */
    const COL_ID_COMPANY_USER_STORAGE = 'spy_company_user_storage.id_company_user_storage';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_company_user_storage.fk_company_user';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_company_user_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_company_user_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_company_user_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_company_user_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_company_user_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_company_user_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCompanyUserStorage', 'FkCompanyUser', 'Data', 'Store', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCompanyUserStorage', 'fkCompanyUser', 'data', 'store', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCompanyUserStorageTableMap::COL_ID_COMPANY_USER_STORAGE, SpyCompanyUserStorageTableMap::COL_FK_COMPANY_USER, SpyCompanyUserStorageTableMap::COL_DATA, SpyCompanyUserStorageTableMap::COL_STORE, SpyCompanyUserStorageTableMap::COL_ALIAS_KEYS, SpyCompanyUserStorageTableMap::COL_KEY, SpyCompanyUserStorageTableMap::COL_CREATED_AT, SpyCompanyUserStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_company_user_storage', 'fk_company_user', 'data', 'store', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCompanyUserStorage' => 0, 'FkCompanyUser' => 1, 'Data' => 2, 'Store' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idCompanyUserStorage' => 0, 'fkCompanyUser' => 1, 'data' => 2, 'store' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_company_user_storage' => 0, 'fk_company_user' => 1, 'data' => 2, 'store' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
