...
class SpyNavigationStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.NavigationStorage.Persistence.Map.SpyNavigationStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_navigation_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\NavigationStorage\\Persistence\\SpyNavigationStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.NavigationStorage.Persistence.SpyNavigationStorage';
     ...
     */
    const COL_ID_NAVIGATION_STORAGE = 'spy_navigation_storage.id_navigation_storage';

    /**
     * the column name for the fk_navigation field
     */
    const COL_FK_NAVIGATION = 'spy_navigation_storage.fk_navigation';

    /**
     * the column name for the navigation_key field
     */
    const COL_NAVIGATION_KEY = 'spy_navigation_storage.navigation_key';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_navigation_storage.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_navigation_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_navigation_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_navigation_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_navigation_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_navigation_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdNavigationStorage', 'FkNavigation', 'NavigationKey', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idNavigationStorage', 'fkNavigation', 'navigationKey', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyNavigationStorageTableMap::COL_ID_NAVIGATION_STORAGE, SpyNavigationStorageTableMap::COL_FK_NAVIGATION, SpyNavigationStorageTableMap::COL_NAVIGATION_KEY, SpyNavigationStorageTableMap::COL_DATA, SpyNavigationStorageTableMap::COL_LOCALE, SpyNavigationStorageTableMap::COL_ALIAS_KEYS, SpyNavigationStorageTableMap::COL_KEY, SpyNavigationStorageTableMap::COL_CREATED_AT, SpyNavigationStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_navigation_storage', 'fk_navigation', 'navigation_key', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdNavigationStorage' => 0, 'FkNavigation' => 1, 'NavigationKey' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idNavigationStorage' => 0, 'fkNavigation' => 1, 'navigationKey' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyNavigationStorageTableMap::COL_ID_NAVIGATION_STORAGE => 0, SpyNavigationStorageTableMap::COL_FK_NAVIGATION => 1, SpyNavigationStorageTableMap::COL_NAVIGATION_KEY => 2, SpyNavigationStorageTableMap::COL_DATA => 3, SpyNavigationStorageTableMap::COL_LOCALE => 4, SpyNavigationStorageTableMap::COL_ALIAS_KEYS => 5, SpyNavigationStorageTableMap::COL_KEY => 6, SpyNavigationStorageTableMap::COL_CREATED_AT => 7, SpyNavigationStorageTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_navigation_storage' => 0, 'fk_navigation' => 1, 'navigation_key' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
