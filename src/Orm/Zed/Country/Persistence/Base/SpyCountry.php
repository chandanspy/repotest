...
abstract class SpyCountry implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Country\\Persistence\\Map\\SpyCountryTableMap';
     ...
     * @return $this|\Orm\Zed\Country\Persistence\SpyCountry The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Country\Persistence\SpyCountry
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Country\Persistence\SpyCountry The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyTaxRates($v = true)
    {
     ...
     * @return void
     */
    public function initSpyTaxRates($overrideExisting = true)
    {
     ...
     */
    protected function doAddSpyTaxRate(SpyTaxRate $spyTaxRate)
    {
