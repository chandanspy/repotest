...
class SpyCountryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Country.Persistence.Map.SpyCountryTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Country\\Persistence\\SpyCountry';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Country.Persistence.SpyCountry';
  ...
  array (
    ...
    1 => ':id_country',
        ...
        $this->addRelation('SpyTaxRate', '\\Orm\\Zed\\Tax\\Persistence\\SpyTaxRate', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_country',
    1 => ':id_country',
  ),
), null, null, 'SpyTaxRates', false);
    } // buildRelations()
