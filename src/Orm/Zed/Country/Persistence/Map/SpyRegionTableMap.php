...
class SpyRegionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Country.Persistence.Map.SpyRegionTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Country\\Persistence\\SpyRegion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Country.Persistence.SpyRegion';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdRegion', 'FkCountry', 'Iso2Code', 'Name', ),
        self::TYPE_CAMELNAME     => array('idRegion', 'fkCountry', 'iso2Code', 'name', ),
        self::TYPE_COLNAME       => array(SpyRegionTableMap::COL_ID_REGION, SpyRegionTableMap::COL_FK_COUNTRY, SpyRegionTableMap::COL_ISO2_CODE, SpyRegionTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_region', 'fk_country', 'iso2_code', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdRegion' => 0, 'FkCountry' => 1, 'Iso2Code' => 2, 'Name' => 3, ),
        self::TYPE_CAMELNAME     => array('idRegion' => 0, 'fkCountry' => 1, 'iso2Code' => 2, 'name' => 3, ),
        self::TYPE_COLNAME       => array(SpyRegionTableMap::COL_ID_REGION => 0, SpyRegionTableMap::COL_FK_COUNTRY => 1, SpyRegionTableMap::COL_ISO2_CODE => 2, SpyRegionTableMap::COL_NAME => 3, ),
        self::TYPE_FIELDNAME     => array('id_region' => 0, 'fk_country' => 1, 'iso2_code' => 2, 'name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPackage('src.Orm.Zed.Country.Persistence');
  ...
  array (
    ...
    1 => ':id_region',
        ...
        $this->addRelation('SalesOrderAddress', '\\Orm\\Zed\\Sales\\Persistence\\SpySalesOrderAddress', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_region',
    1 => ':id_region',
