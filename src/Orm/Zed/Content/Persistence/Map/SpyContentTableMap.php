...
class SpyContentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Content.Persistence.Map.SpyContentTableMap';
     ...
     */
    const TABLE_NAME = 'spy_content';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Content\\Persistence\\SpyContent';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Content.Persistence.SpyContent';
     ...
     */
    const COL_ID_CONTENT = 'spy_content.id_content';

    /**
     * the column name for the content_term_key field
     */
    const COL_CONTENT_TERM_KEY = 'spy_content.content_term_key';

    /**
     * the column name for the content_type_key field
     */
    const COL_CONTENT_TYPE_KEY = 'spy_content.content_type_key';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_content.description';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_content.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_content.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_content.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_content.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdContent', 'ContentTermKey', 'ContentTypeKey', 'Description', 'Key', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idContent', 'contentTermKey', 'contentTypeKey', 'description', 'key', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyContentTableMap::COL_ID_CONTENT, SpyContentTableMap::COL_CONTENT_TERM_KEY, SpyContentTableMap::COL_CONTENT_TYPE_KEY, SpyContentTableMap::COL_DESCRIPTION, SpyContentTableMap::COL_KEY, SpyContentTableMap::COL_NAME, SpyContentTableMap::COL_CREATED_AT, SpyContentTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_content', 'content_term_key', 'content_type_key', 'description', 'key', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdContent' => 0, 'ContentTermKey' => 1, 'ContentTypeKey' => 2, 'Description' => 3, 'Key' => 4, 'Name' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idContent' => 0, 'contentTermKey' => 1, 'contentTypeKey' => 2, 'description' => 3, 'key' => 4, 'name' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyContentTableMap::COL_ID_CONTENT => 0, SpyContentTableMap::COL_CONTENT_TERM_KEY => 1, SpyContentTableMap::COL_CONTENT_TYPE_KEY => 2, SpyContentTableMap::COL_DESCRIPTION => 3, SpyContentTableMap::COL_KEY => 4, SpyContentTableMap::COL_NAME => 5, SpyContentTableMap::COL_CREATED_AT => 6, SpyContentTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_content' => 0, 'content_term_key' => 1, 'content_type_key' => 2, 'description' => 3, 'key' => 4, 'name' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
