...
class SpyContentLocalizedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Content.Persistence.Map.SpyContentLocalizedTableMap';
     ...
     */
    const TABLE_NAME = 'spy_content_localized';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Content\\Persistence\\SpyContentLocalized';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Content.Persistence.SpyContentLocalized';
     ...
     */
    const COL_ID_CONTENT_LOCALIZED = 'spy_content_localized.id_content_localized';

    /**
     * the column name for the fk_content field
     */
    const COL_FK_CONTENT = 'spy_content_localized.fk_content';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_content_localized.fk_locale';

    /**
     * the column name for the parameters field
     */
    const COL_PARAMETERS = 'spy_content_localized.parameters';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_content_localized.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_content_localized.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdContentLocalized', 'FkContent', 'FkLocale', 'Parameters', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idContentLocalized', 'fkContent', 'fkLocale', 'parameters', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyContentLocalizedTableMap::COL_ID_CONTENT_LOCALIZED, SpyContentLocalizedTableMap::COL_FK_CONTENT, SpyContentLocalizedTableMap::COL_FK_LOCALE, SpyContentLocalizedTableMap::COL_PARAMETERS, SpyContentLocalizedTableMap::COL_CREATED_AT, SpyContentLocalizedTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_content_localized', 'fk_content', 'fk_locale', 'parameters', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdContentLocalized' => 0, 'FkContent' => 1, 'FkLocale' => 2, 'Parameters' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idContentLocalized' => 0, 'fkContent' => 1, 'fkLocale' => 2, 'parameters' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyContentLocalizedTableMap::COL_ID_CONTENT_LOCALIZED => 0, SpyContentLocalizedTableMap::COL_FK_CONTENT => 1, SpyContentLocalizedTableMap::COL_FK_LOCALE => 2, SpyContentLocalizedTableMap::COL_PARAMETERS => 3, SpyContentLocalizedTableMap::COL_CREATED_AT => 4, SpyContentLocalizedTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_content_localized' => 0, 'fk_content' => 1, 'fk_locale' => 2, 'parameters' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
