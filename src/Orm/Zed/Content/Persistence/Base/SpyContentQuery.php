 ...
 *
 * @method     ChildSpyContent[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyContent objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> find(ConnectionInterface $con = null) Return ChildSpyContent objects based on current ModelCriteria
 * @method     ChildSpyContent[]|ObjectCollection findByIdContent(int $id_content) Return ChildSpyContent objects filtered by the id_content column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByIdContent(int $id_content) Return ChildSpyContent objects filtered by the id_content column
 * @method     ChildSpyContent[]|ObjectCollection findByContentTermKey(string $content_term_key) Return ChildSpyContent objects filtered by the content_term_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByContentTermKey(string $content_term_key) Return ChildSpyContent objects filtered by the content_term_key column
 * @method     ChildSpyContent[]|ObjectCollection findByContentTypeKey(string $content_type_key) Return ChildSpyContent objects filtered by the content_type_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByContentTypeKey(string $content_type_key) Return ChildSpyContent objects filtered by the content_type_key column
 * @method     ChildSpyContent[]|ObjectCollection findByDescription(string $description) Return ChildSpyContent objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByDescription(string $description) Return ChildSpyContent objects filtered by the description column
 * @method     ChildSpyContent[]|ObjectCollection findByKey(string $key) Return ChildSpyContent objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByKey(string $key) Return ChildSpyContent objects filtered by the key column
 * @method     ChildSpyContent[]|ObjectCollection findByName(string $name) Return ChildSpyContent objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByName(string $name) Return ChildSpyContent objects filtered by the name column
 * @method     ChildSpyContent[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyContent objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByCreatedAt(string $created_at) Return ChildSpyContent objects filtered by the created_at column
 * @method     ChildSpyContent[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyContent objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyContent> findByUpdatedAt(string $updated_at) Return ChildSpyContent objects filtered by the updated_at column
...
abstract class SpyContentQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyContentQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyContentTableMap::COL_ID_CONTENT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyContentTableMap::COL_ID_CONTENT, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyContentQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyContentQuery The current query, for fluid interface
     */
    public function joinSpyContentLocalized($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->addUsingAlias(SpyContentTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyContentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyContentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyContentTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyContentTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyContentTableMap::COL_CREATED_AT);
    }
