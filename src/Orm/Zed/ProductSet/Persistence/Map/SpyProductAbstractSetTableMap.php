...
class SpyProductAbstractSetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSet.Persistence.Map.SpyProductAbstractSetTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_set';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSet\\Persistence\\SpyProductAbstractSet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSet.Persistence.SpyProductAbstractSet';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_SET = 'spy_product_abstract_set.id_product_abstract_set';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_set.fk_product_abstract';

    /**
     * the column name for the fk_product_set field
     */
    const COL_FK_PRODUCT_SET = 'spy_product_abstract_set.fk_product_set';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_product_abstract_set.position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractSet', 'FkProductAbstract', 'FkProductSet', 'Position', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractSet', 'fkProductAbstract', 'fkProductSet', 'position', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractSetTableMap::COL_ID_PRODUCT_ABSTRACT_SET, SpyProductAbstractSetTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractSetTableMap::COL_FK_PRODUCT_SET, SpyProductAbstractSetTableMap::COL_POSITION, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_set', 'fk_product_abstract', 'fk_product_set', 'position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractSet' => 0, 'FkProductAbstract' => 1, 'FkProductSet' => 2, 'Position' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractSet' => 0, 'fkProductAbstract' => 1, 'fkProductSet' => 2, 'position' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductAbstractSetTableMap::COL_ID_PRODUCT_ABSTRACT_SET => 0, SpyProductAbstractSetTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductAbstractSetTableMap::COL_FK_PRODUCT_SET => 2, SpyProductAbstractSetTableMap::COL_POSITION => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_set' => 0, 'fk_product_abstract' => 1, 'fk_product_set' => 2, 'position' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
