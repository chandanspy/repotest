...
class SpyProductSetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSet.Persistence.Map.SpyProductSetTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_set';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSet\\Persistence\\SpyProductSet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSet.Persistence.SpyProductSet';
     ...
     */
    const COL_ID_PRODUCT_SET = 'spy_product_set.id_product_set';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_product_set.is_active';

    /**
     * the column name for the product_set_key field
     */
    const COL_PRODUCT_SET_KEY = 'spy_product_set.product_set_key';

    /**
     * the column name for the weight field
     */
    const COL_WEIGHT = 'spy_product_set.weight';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_set.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_set.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductSet', 'IsActive', 'ProductSetKey', 'Weight', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductSet', 'isActive', 'productSetKey', 'weight', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductSetTableMap::COL_ID_PRODUCT_SET, SpyProductSetTableMap::COL_IS_ACTIVE, SpyProductSetTableMap::COL_PRODUCT_SET_KEY, SpyProductSetTableMap::COL_WEIGHT, SpyProductSetTableMap::COL_CREATED_AT, SpyProductSetTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_set', 'is_active', 'product_set_key', 'weight', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductSet' => 0, 'IsActive' => 1, 'ProductSetKey' => 2, 'Weight' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductSet' => 0, 'isActive' => 1, 'productSetKey' => 2, 'weight' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductSetTableMap::COL_ID_PRODUCT_SET => 0, SpyProductSetTableMap::COL_IS_ACTIVE => 1, SpyProductSetTableMap::COL_PRODUCT_SET_KEY => 2, SpyProductSetTableMap::COL_WEIGHT => 3, SpyProductSetTableMap::COL_CREATED_AT => 4, SpyProductSetTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_set' => 0, 'is_active' => 1, 'product_set_key' => 2, 'weight' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
