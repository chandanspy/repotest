 ...
 *
 * @method     ChildSpyProductSet[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSet objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> find(ConnectionInterface $con = null) Return ChildSpyProductSet objects based on current ModelCriteria
 * @method     ChildSpyProductSet[]|ObjectCollection findByIdProductSet(int $id_product_set) Return ChildSpyProductSet objects filtered by the id_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByIdProductSet(int $id_product_set) Return ChildSpyProductSet objects filtered by the id_product_set column
 * @method     ChildSpyProductSet[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyProductSet objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByIsActive(boolean $is_active) Return ChildSpyProductSet objects filtered by the is_active column
 * @method     ChildSpyProductSet[]|ObjectCollection findByProductSetKey(string $product_set_key) Return ChildSpyProductSet objects filtered by the product_set_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByProductSetKey(string $product_set_key) Return ChildSpyProductSet objects filtered by the product_set_key column
 * @method     ChildSpyProductSet[]|ObjectCollection findByWeight(int $weight) Return ChildSpyProductSet objects filtered by the weight column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByWeight(int $weight) Return ChildSpyProductSet objects filtered by the weight column
 * @method     ChildSpyProductSet[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductSet objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByCreatedAt(string $created_at) Return ChildSpyProductSet objects filtered by the created_at column
 * @method     ChildSpyProductSet[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductSet objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSet> findByUpdatedAt(string $updated_at) Return ChildSpyProductSet objects filtered by the updated_at column
...
abstract class SpyProductSetQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductSetTableMap::COL_ID_PRODUCT_SET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductSetTableMap::COL_ID_PRODUCT_SET, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductSetQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductSetTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductSetTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetTableMap::COL_CREATED_AT);
    }
