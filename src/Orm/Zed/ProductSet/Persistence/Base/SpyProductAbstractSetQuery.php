 ...
 *
 * @method     ChildSpyProductAbstractSet[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractSet objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractSet> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractSet objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractSet[]|ObjectCollection findByIdProductAbstractSet(int $id_product_abstract_set) Return ChildSpyProductAbstractSet objects filtered by the id_product_abstract_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractSet> findByIdProductAbstractSet(int $id_product_abstract_set) Return ChildSpyProductAbstractSet objects filtered by the id_product_abstract_set column
 * @method     ChildSpyProductAbstractSet[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractSet objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractSet> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractSet objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractSet[]|ObjectCollection findByFkProductSet(int $fk_product_set) Return ChildSpyProductAbstractSet objects filtered by the fk_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractSet> findByFkProductSet(int $fk_product_set) Return ChildSpyProductAbstractSet objects filtered by the fk_product_set column
 * @method     ChildSpyProductAbstractSet[]|ObjectCollection findByPosition(int $position) Return ChildSpyProductAbstractSet objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractSet> findByPosition(int $position) Return ChildSpyProductAbstractSet objects filtered by the position column
...
abstract class SpyProductAbstractSetQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractSetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAbstractSetTableMap::COL_ID_PRODUCT_ABSTRACT_SET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAbstractSetTableMap::COL_ID_PRODUCT_ABSTRACT_SET, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductAbstractSetQuery The current query, for fluid interface
     */
