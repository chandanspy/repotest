...
abstract class SpyProductSet implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductSet\\Persistence\\Map\\SpyProductSetTableMap';
     ...
     * @return $this|\Orm\Zed\ProductSet\Persistence\SpyProductSet The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductSet\Persistence\SpyProductSet
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductSet\Persistence\SpyProductSet The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductSet The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductAbstractSet(ChildSpyProductAbstractSet $spyProductAbstractSet)
    {
     ...
     */
    protected function doAddSpyProductSetData(ChildSpyProductSetData $spyProductSetData)
    {
