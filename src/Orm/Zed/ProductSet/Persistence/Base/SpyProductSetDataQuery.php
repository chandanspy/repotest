 ...
 *
 * @method     ChildSpyProductSetData[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSetData objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> find(ConnectionInterface $con = null) Return ChildSpyProductSetData objects based on current ModelCriteria
 * @method     ChildSpyProductSetData[]|ObjectCollection findByIdProductSetData(int $id_product_set_data) Return ChildSpyProductSetData objects filtered by the id_product_set_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByIdProductSetData(int $id_product_set_data) Return ChildSpyProductSetData objects filtered by the id_product_set_data column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductSetData objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByFkLocale(int $fk_locale) Return ChildSpyProductSetData objects filtered by the fk_locale column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByFkProductSet(int $fk_product_set) Return ChildSpyProductSetData objects filtered by the fk_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByFkProductSet(int $fk_product_set) Return ChildSpyProductSetData objects filtered by the fk_product_set column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByDescription(string $description) Return ChildSpyProductSetData objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByDescription(string $description) Return ChildSpyProductSetData objects filtered by the description column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByMetaDescription(string $meta_description) Return ChildSpyProductSetData objects filtered by the meta_description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByMetaDescription(string $meta_description) Return ChildSpyProductSetData objects filtered by the meta_description column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByMetaKeywords(string $meta_keywords) Return ChildSpyProductSetData objects filtered by the meta_keywords column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByMetaKeywords(string $meta_keywords) Return ChildSpyProductSetData objects filtered by the meta_keywords column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByMetaTitle(string $meta_title) Return ChildSpyProductSetData objects filtered by the meta_title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByMetaTitle(string $meta_title) Return ChildSpyProductSetData objects filtered by the meta_title column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByName(string $name) Return ChildSpyProductSetData objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByName(string $name) Return ChildSpyProductSetData objects filtered by the name column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductSetData objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByCreatedAt(string $created_at) Return ChildSpyProductSetData objects filtered by the created_at column
 * @method     ChildSpyProductSetData[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductSetData objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetData> findByUpdatedAt(string $updated_at) Return ChildSpyProductSetData objects filtered by the updated_at column
...
abstract class SpyProductSetDataQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSetDataQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductSetDataTableMap::COL_ID_PRODUCT_SET_DATA, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductSetDataTableMap::COL_ID_PRODUCT_SET_DATA, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductSetDataQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyProductSetDataQuery The current query, for fluid interface
     */
    public function joinSpyProductSet($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->addUsingAlias(SpyProductSetDataTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetDataTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetDataTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetDataTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductSetDataTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetDataTableMap::COL_CREATED_AT);
    }
