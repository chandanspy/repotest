...
class SpyCmsSlotStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsSlotStorage.Persistence.Map.SpyCmsSlotStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_slot_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsSlotStorage\\Persistence\\SpyCmsSlotStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsSlotStorage.Persistence.SpyCmsSlotStorage';
     ...
     */
    const COL_ID_CMS_SLOT_STORAGE = 'spy_cms_slot_storage.id_cms_slot_storage';

    /**
     * the column name for the cms_slot_key field
     */
    const COL_CMS_SLOT_KEY = 'spy_cms_slot_storage.cms_slot_key';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_cms_slot_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_cms_slot_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_cms_slot_storage.alias_keys';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotStorage', 'CmsSlotKey', 'Data', 'Key', 'AliasKeys', ),
        self::TYPE_CAMELNAME     => array('idCmsSlotStorage', 'cmsSlotKey', 'data', 'key', 'aliasKeys', ),
        self::TYPE_COLNAME       => array(SpyCmsSlotStorageTableMap::COL_ID_CMS_SLOT_STORAGE, SpyCmsSlotStorageTableMap::COL_CMS_SLOT_KEY, SpyCmsSlotStorageTableMap::COL_DATA, SpyCmsSlotStorageTableMap::COL_KEY, SpyCmsSlotStorageTableMap::COL_ALIAS_KEYS, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_storage', 'cms_slot_key', 'data', 'key', 'alias_keys', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotStorage' => 0, 'CmsSlotKey' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, ),
        self::TYPE_CAMELNAME     => array('idCmsSlotStorage' => 0, 'cmsSlotKey' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, ),
        self::TYPE_COLNAME       => array(SpyCmsSlotStorageTableMap::COL_ID_CMS_SLOT_STORAGE => 0, SpyCmsSlotStorageTableMap::COL_CMS_SLOT_KEY => 1, SpyCmsSlotStorageTableMap::COL_DATA => 2, SpyCmsSlotStorageTableMap::COL_KEY => 3, SpyCmsSlotStorageTableMap::COL_ALIAS_KEYS => 4, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_storage' => 0, 'cms_slot_key' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
