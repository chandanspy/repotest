...
class SpyConfigurableBundleTemplatePageSearchTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ConfigurableBundlePageSearch.Persistence.Map.SpyConfigurableBundleTemplatePageSearchTableMap';
     ...
     */
    const TABLE_NAME = 'spy_configurable_bundle_template_page_search';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ConfigurableBundlePageSearch\\Persistence\\SpyConfigurableBundleTemplatePageSearch';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ConfigurableBundlePageSearch.Persistence.SpyConfigurableBundleTemplatePageSearch';
     ...
     */
    const COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_PAGE_SEARCH = 'spy_configurable_bundle_template_page_search.id_configurable_bundle_template_page_search';

    /**
     * the column name for the fk_configurable_bundle_template field
     */
    const COL_FK_CONFIGURABLE_BUNDLE_TEMPLATE = 'spy_configurable_bundle_template_page_search.fk_configurable_bundle_template';

    /**
     * the column name for the structured_data field
     */
    const COL_STRUCTURED_DATA = 'spy_configurable_bundle_template_page_search.structured_data';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_configurable_bundle_template_page_search.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_configurable_bundle_template_page_search.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_configurable_bundle_template_page_search.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_configurable_bundle_template_page_search.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_configurable_bundle_template_page_search.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_configurable_bundle_template_page_search.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplatePageSearch', 'FkConfigurableBundleTemplate', 'StructuredData', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplatePageSearch', 'fkConfigurableBundleTemplate', 'structuredData', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyConfigurableBundleTemplatePageSearchTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_PAGE_SEARCH, SpyConfigurableBundleTemplatePageSearchTableMap::COL_FK_CONFIGURABLE_BUNDLE_TEMPLATE, SpyConfigurableBundleTemplatePageSearchTableMap::COL_STRUCTURED_DATA, SpyConfigurableBundleTemplatePageSearchTableMap::COL_DATA, SpyConfigurableBundleTemplatePageSearchTableMap::COL_LOCALE, SpyConfigurableBundleTemplatePageSearchTableMap::COL_ALIAS_KEYS, SpyConfigurableBundleTemplatePageSearchTableMap::COL_KEY, SpyConfigurableBundleTemplatePageSearchTableMap::COL_CREATED_AT, SpyConfigurableBundleTemplatePageSearchTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template_page_search', 'fk_configurable_bundle_template', 'structured_data', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplatePageSearch' => 0, 'FkConfigurableBundleTemplate' => 1, 'StructuredData' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplatePageSearch' => 0, 'fkConfigurableBundleTemplate' => 1, 'structuredData' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyConfigurableBundleTemplatePageSearchTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_PAGE_SEARCH => 0, SpyConfigurableBundleTemplatePageSearchTableMap::COL_FK_CONFIGURABLE_BUNDLE_TEMPLATE => 1, SpyConfigurableBundleTemplatePageSearchTableMap::COL_STRUCTURED_DATA => 2, SpyConfigurableBundleTemplatePageSearchTableMap::COL_DATA => 3, SpyConfigurableBundleTemplatePageSearchTableMap::COL_LOCALE => 4, SpyConfigurableBundleTemplatePageSearchTableMap::COL_ALIAS_KEYS => 5, SpyConfigurableBundleTemplatePageSearchTableMap::COL_KEY => 6, SpyConfigurableBundleTemplatePageSearchTableMap::COL_CREATED_AT => 7, SpyConfigurableBundleTemplatePageSearchTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template_page_search' => 0, 'fk_configurable_bundle_template' => 1, 'structured_data' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
