...
class SpyResetPasswordTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.UserPasswordReset.Persistence.Map.SpyResetPasswordTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\UserPasswordReset\\Persistence\\SpyResetPassword';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.UserPasswordReset.Persistence.SpyResetPassword';
