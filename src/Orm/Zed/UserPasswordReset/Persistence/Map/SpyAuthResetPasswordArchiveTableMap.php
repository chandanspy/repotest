...
class SpyAuthResetPasswordArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.UserPasswordReset.Persistence.Map.SpyAuthResetPasswordArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\UserPasswordReset\\Persistence\\SpyAuthResetPasswordArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.UserPasswordReset.Persistence.SpyAuthResetPasswordArchive';
