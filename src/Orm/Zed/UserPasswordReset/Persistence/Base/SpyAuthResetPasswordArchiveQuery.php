 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> find(ConnectionInterface $con = null) Return ChildSpyAuthResetPasswordArchive objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByIdAuthResetPassword(int $id_auth_reset_password) Return ChildSpyAuthResetPasswordArchive objects filtered by the id_auth_reset_password column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByFkUser(int $fk_user) Return ChildSpyAuthResetPasswordArchive objects filtered by the fk_user column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByCode(string $code) Return ChildSpyAuthResetPasswordArchive objects filtered by the code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByStatus(int $status) Return ChildSpyAuthResetPasswordArchive objects filtered by the status column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByCreatedAt(string $created_at) Return ChildSpyAuthResetPasswordArchive objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByUpdatedAt(string $updated_at) Return ChildSpyAuthResetPasswordArchive objects filtered by the updated_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAuthResetPasswordArchive> findByArchivedAt(string $archived_at) Return ChildSpyAuthResetPasswordArchive objects filtered by the archived_at column
