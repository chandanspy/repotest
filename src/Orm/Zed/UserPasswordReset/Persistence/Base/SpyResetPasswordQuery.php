 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> find(ConnectionInterface $con = null) Return ChildSpyResetPassword objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByIdAuthResetPassword(int $id_auth_reset_password) Return ChildSpyResetPassword objects filtered by the id_auth_reset_password column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByFkUser(int $fk_user) Return ChildSpyResetPassword objects filtered by the fk_user column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByCode(string $code) Return ChildSpyResetPassword objects filtered by the code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByStatus(int $status) Return ChildSpyResetPassword objects filtered by the status column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByCreatedAt(string $created_at) Return ChildSpyResetPassword objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResetPassword> findByUpdatedAt(string $updated_at) Return ChildSpyResetPassword objects filtered by the updated_at column
