...
class SpyShoppingListItemNoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingListNote.Persistence.Map.SpyShoppingListItemNoteTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_item_note';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingListNote\\Persistence\\SpyShoppingListItemNote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingListNote.Persistence.SpyShoppingListItemNote';
     ...
     */
    const COL_ID_SHOPPING_LIST_ITEM_NOTE = 'spy_shopping_list_item_note.id_shopping_list_item_note';

    /**
     * the column name for the fk_shopping_list_item field
     */
    const COL_FK_SHOPPING_LIST_ITEM = 'spy_shopping_list_item_note.fk_shopping_list_item';

    /**
     * the column name for the note field
     */
    const COL_NOTE = 'spy_shopping_list_item_note.note';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_shopping_list_item_note.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_shopping_list_item_note.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListItemNote', 'FkShoppingListItem', 'Note', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idShoppingListItemNote', 'fkShoppingListItem', 'note', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyShoppingListItemNoteTableMap::COL_ID_SHOPPING_LIST_ITEM_NOTE, SpyShoppingListItemNoteTableMap::COL_FK_SHOPPING_LIST_ITEM, SpyShoppingListItemNoteTableMap::COL_NOTE, SpyShoppingListItemNoteTableMap::COL_CREATED_AT, SpyShoppingListItemNoteTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_item_note', 'fk_shopping_list_item', 'note', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListItemNote' => 0, 'FkShoppingListItem' => 1, 'Note' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idShoppingListItemNote' => 0, 'fkShoppingListItem' => 1, 'note' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyShoppingListItemNoteTableMap::COL_ID_SHOPPING_LIST_ITEM_NOTE => 0, SpyShoppingListItemNoteTableMap::COL_FK_SHOPPING_LIST_ITEM => 1, SpyShoppingListItemNoteTableMap::COL_NOTE => 2, SpyShoppingListItemNoteTableMap::COL_CREATED_AT => 3, SpyShoppingListItemNoteTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_item_note' => 0, 'fk_shopping_list_item' => 1, 'note' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyShoppingListItemNoteTableMap
