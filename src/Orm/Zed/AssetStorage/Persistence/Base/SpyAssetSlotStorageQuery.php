 ...
 *
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyAssetSlotStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> find(ConnectionInterface $con = null) Return ChildSpyAssetSlotStorage objects based on current ModelCriteria
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByIdAssetSlotStorage(int $id_asset_slot_storage) Return ChildSpyAssetSlotStorage objects filtered by the id_asset_slot_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByIdAssetSlotStorage(int $id_asset_slot_storage) Return ChildSpyAssetSlotStorage objects filtered by the id_asset_slot_storage column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByAssetSlot(string $asset_slot) Return ChildSpyAssetSlotStorage objects filtered by the asset_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByAssetSlot(string $asset_slot) Return ChildSpyAssetSlotStorage objects filtered by the asset_slot column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByData(string $data) Return ChildSpyAssetSlotStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByData(string $data) Return ChildSpyAssetSlotStorage objects filtered by the data column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByStore(string $store) Return ChildSpyAssetSlotStorage objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByStore(string $store) Return ChildSpyAssetSlotStorage objects filtered by the store column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyAssetSlotStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByAliasKeys(string $alias_keys) Return ChildSpyAssetSlotStorage objects filtered by the alias_keys column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyAssetSlotStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByKey(string $key) Return ChildSpyAssetSlotStorage objects filtered by the key column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyAssetSlotStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByCreatedAt(string $created_at) Return ChildSpyAssetSlotStorage objects filtered by the created_at column
 * @method     ChildSpyAssetSlotStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyAssetSlotStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetSlotStorage> findByUpdatedAt(string $updated_at) Return ChildSpyAssetSlotStorage objects filtered by the updated_at column
...
abstract class SpyAssetSlotStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyAssetSlotStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyAssetSlotStorageTableMap::COL_ID_ASSET_SLOT_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyAssetSlotStorageTableMap::COL_ID_ASSET_SLOT_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyAssetSlotStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyAssetSlotStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyAssetSlotStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyAssetSlotStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyAssetSlotStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyAssetSlotStorageTableMap::COL_CREATED_AT);
    }

} // SpyAssetSlotStorageQuery
