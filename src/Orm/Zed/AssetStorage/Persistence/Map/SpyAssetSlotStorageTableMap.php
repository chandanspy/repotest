...
class SpyAssetSlotStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.AssetStorage.Persistence.Map.SpyAssetSlotStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_asset_slot_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\AssetStorage\\Persistence\\SpyAssetSlotStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.AssetStorage.Persistence.SpyAssetSlotStorage';
     ...
     */
    const COL_ID_ASSET_SLOT_STORAGE = 'spy_asset_slot_storage.id_asset_slot_storage';

    /**
     * the column name for the asset_slot field
     */
    const COL_ASSET_SLOT = 'spy_asset_slot_storage.asset_slot';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_asset_slot_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_asset_slot_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_asset_slot_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_asset_slot_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_asset_slot_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_asset_slot_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAssetSlotStorage', 'AssetSlot', 'Data', 'Store', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idAssetSlotStorage', 'assetSlot', 'data', 'store', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyAssetSlotStorageTableMap::COL_ID_ASSET_SLOT_STORAGE, SpyAssetSlotStorageTableMap::COL_ASSET_SLOT, SpyAssetSlotStorageTableMap::COL_DATA, SpyAssetSlotStorageTableMap::COL_STORE, SpyAssetSlotStorageTableMap::COL_ALIAS_KEYS, SpyAssetSlotStorageTableMap::COL_KEY, SpyAssetSlotStorageTableMap::COL_CREATED_AT, SpyAssetSlotStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_asset_slot_storage', 'asset_slot', 'data', 'store', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAssetSlotStorage' => 0, 'AssetSlot' => 1, 'Data' => 2, 'Store' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idAssetSlotStorage' => 0, 'assetSlot' => 1, 'data' => 2, 'store' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyAssetSlotStorageTableMap::COL_ID_ASSET_SLOT_STORAGE => 0, SpyAssetSlotStorageTableMap::COL_ASSET_SLOT => 1, SpyAssetSlotStorageTableMap::COL_DATA => 2, SpyAssetSlotStorageTableMap::COL_STORE => 3, SpyAssetSlotStorageTableMap::COL_ALIAS_KEYS => 4, SpyAssetSlotStorageTableMap::COL_KEY => 5, SpyAssetSlotStorageTableMap::COL_CREATED_AT => 6, SpyAssetSlotStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_asset_slot_storage' => 0, 'asset_slot' => 1, 'data' => 2, 'store' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
