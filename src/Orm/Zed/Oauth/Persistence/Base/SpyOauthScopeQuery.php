 ...
 *
 * @method     ChildSpyOauthScope[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOauthScope objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthScope> find(ConnectionInterface $con = null) Return ChildSpyOauthScope objects based on current ModelCriteria
 * @method     ChildSpyOauthScope[]|ObjectCollection findByIdOauthScope(int $id_oauth_scope) Return ChildSpyOauthScope objects filtered by the id_oauth_scope column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthScope> findByIdOauthScope(int $id_oauth_scope) Return ChildSpyOauthScope objects filtered by the id_oauth_scope column
 * @method     ChildSpyOauthScope[]|ObjectCollection findByDescription(string $description) Return ChildSpyOauthScope objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthScope> findByDescription(string $description) Return ChildSpyOauthScope objects filtered by the description column
 * @method     ChildSpyOauthScope[]|ObjectCollection findByIdentifier(string $identifier) Return ChildSpyOauthScope objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthScope> findByIdentifier(string $identifier) Return ChildSpyOauthScope objects filtered by the identifier column
...
abstract class SpyOauthScopeQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOauthScopeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOauthScopeTableMap::COL_ID_OAUTH_SCOPE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOauthScopeTableMap::COL_ID_OAUTH_SCOPE, $keys, Criteria::IN);
    }
