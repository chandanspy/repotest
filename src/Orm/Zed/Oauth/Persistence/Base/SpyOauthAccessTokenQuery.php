 ...
 *
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOauthAccessToken objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> find(ConnectionInterface $con = null) Return ChildSpyOauthAccessToken objects based on current ModelCriteria
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByIdOauthAccessToken(int $id_oauth_access_token) Return ChildSpyOauthAccessToken objects filtered by the id_oauth_access_token column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByIdOauthAccessToken(int $id_oauth_access_token) Return ChildSpyOauthAccessToken objects filtered by the id_oauth_access_token column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByFkOauthClient(string $fk_oauth_client) Return ChildSpyOauthAccessToken objects filtered by the fk_oauth_client column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByFkOauthClient(string $fk_oauth_client) Return ChildSpyOauthAccessToken objects filtered by the fk_oauth_client column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByExpirityDate(string $expirity_date) Return ChildSpyOauthAccessToken objects filtered by the expirity_date column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByExpirityDate(string $expirity_date) Return ChildSpyOauthAccessToken objects filtered by the expirity_date column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByIdentifier(string $identifier) Return ChildSpyOauthAccessToken objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByIdentifier(string $identifier) Return ChildSpyOauthAccessToken objects filtered by the identifier column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByScopes(string $scopes) Return ChildSpyOauthAccessToken objects filtered by the scopes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByScopes(string $scopes) Return ChildSpyOauthAccessToken objects filtered by the scopes column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByUserIdentifier(string $user_identifier) Return ChildSpyOauthAccessToken objects filtered by the user_identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByUserIdentifier(string $user_identifier) Return ChildSpyOauthAccessToken objects filtered by the user_identifier column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyOauthAccessToken objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByCreatedAt(string $created_at) Return ChildSpyOauthAccessToken objects filtered by the created_at column
 * @method     ChildSpyOauthAccessToken[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyOauthAccessToken objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOauthAccessToken> findByUpdatedAt(string $updated_at) Return ChildSpyOauthAccessToken objects filtered by the updated_at column
...
abstract class SpyOauthAccessTokenQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOauthAccessTokenQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOauthAccessTokenTableMap::COL_ID_OAUTH_ACCESS_TOKEN, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOauthAccessTokenTableMap::COL_ID_OAUTH_ACCESS_TOKEN, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyOauthAccessTokenQuery The current query, for fluid interface
     */
    public function filterByOauthClient($spyOauthClient, $comparison = null)
    {
     ...
     * @return $this|ChildSpyOauthAccessTokenQuery The current query, for fluid interface
     */
    public function joinOauthClient($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('OauthClient', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('OauthClient', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyOauthAccessTokenTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOauthAccessTokenTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOauthAccessTokenTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOauthAccessTokenTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyOauthAccessTokenTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOauthAccessTokenTableMap::COL_CREATED_AT);
    }

} // SpyOauthAccessTokenQuery
