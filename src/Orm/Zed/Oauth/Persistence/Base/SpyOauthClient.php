...
abstract class SpyOauthClient implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Oauth\\Persistence\\Map\\SpyOauthClientTableMap';
     ...
     * @return $this|\Orm\Zed\Oauth\Persistence\SpyOauthClient The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Oauth\Persistence\SpyOauthClient
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Oauth\Persistence\SpyOauthClient The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyOauthClient The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countOauthAccessTokens(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collOauthAccessTokensPartial && !$this->isNew();
        if (null === $this->collOauthAccessTokens || null !== $criteria || $partial) {
     ...
     */
    protected function doAddOauthAccessToken(ChildSpyOauthAccessToken $oauthAccessToken)
    {
     ...
     */
    public function resetPartialSpyOauthRefreshTokens($v = true)
    {
     ...
     * @return void
     */
    public function initSpyOauthRefreshTokens($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyOauthRefreshTokens(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyOauthRefreshTokensPartial && !$this->isNew();
        if (null === $this->collSpyOauthRefreshTokens || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyOauthRefreshToken(SpyOauthRefreshToken $spyOauthRefreshToken)
    {
