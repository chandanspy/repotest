...
class SpyOauthAccessTokenTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oauth.Persistence.Map.SpyOauthAccessTokenTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oauth_access_token';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oauth\\Persistence\\SpyOauthAccessToken';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oauth.Persistence.SpyOauthAccessToken';
     ...
     */
    const COL_ID_OAUTH_ACCESS_TOKEN = 'spy_oauth_access_token.id_oauth_access_token';

    /**
     * the column name for the fk_oauth_client field
     */
    const COL_FK_OAUTH_CLIENT = 'spy_oauth_access_token.fk_oauth_client';

    /**
     * the column name for the expirity_date field
     */
    const COL_EXPIRITY_DATE = 'spy_oauth_access_token.expirity_date';

    /**
     * the column name for the identifier field
     */
    const COL_IDENTIFIER = 'spy_oauth_access_token.identifier';

    /**
     * the column name for the scopes field
     */
    const COL_SCOPES = 'spy_oauth_access_token.scopes';

    /**
     * the column name for the user_identifier field
     */
    const COL_USER_IDENTIFIER = 'spy_oauth_access_token.user_identifier';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_oauth_access_token.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_oauth_access_token.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOauthAccessToken', 'FkOauthClient', 'ExpirityDate', 'Identifier', 'Scopes', 'UserIdentifier', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idOauthAccessToken', 'fkOauthClient', 'expirityDate', 'identifier', 'scopes', 'userIdentifier', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyOauthAccessTokenTableMap::COL_ID_OAUTH_ACCESS_TOKEN, SpyOauthAccessTokenTableMap::COL_FK_OAUTH_CLIENT, SpyOauthAccessTokenTableMap::COL_EXPIRITY_DATE, SpyOauthAccessTokenTableMap::COL_IDENTIFIER, SpyOauthAccessTokenTableMap::COL_SCOPES, SpyOauthAccessTokenTableMap::COL_USER_IDENTIFIER, SpyOauthAccessTokenTableMap::COL_CREATED_AT, SpyOauthAccessTokenTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oauth_access_token', 'fk_oauth_client', 'expirity_date', 'identifier', 'scopes', 'user_identifier', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOauthAccessToken' => 0, 'FkOauthClient' => 1, 'ExpirityDate' => 2, 'Identifier' => 3, 'Scopes' => 4, 'UserIdentifier' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idOauthAccessToken' => 0, 'fkOauthClient' => 1, 'expirityDate' => 2, 'identifier' => 3, 'scopes' => 4, 'userIdentifier' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyOauthAccessTokenTableMap::COL_ID_OAUTH_ACCESS_TOKEN => 0, SpyOauthAccessTokenTableMap::COL_FK_OAUTH_CLIENT => 1, SpyOauthAccessTokenTableMap::COL_EXPIRITY_DATE => 2, SpyOauthAccessTokenTableMap::COL_IDENTIFIER => 3, SpyOauthAccessTokenTableMap::COL_SCOPES => 4, SpyOauthAccessTokenTableMap::COL_USER_IDENTIFIER => 5, SpyOauthAccessTokenTableMap::COL_CREATED_AT => 6, SpyOauthAccessTokenTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_oauth_access_token' => 0, 'fk_oauth_client' => 1, 'expirity_date' => 2, 'identifier' => 3, 'scopes' => 4, 'user_identifier' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
