...
class SpyOauthClientTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oauth.Persistence.Map.SpyOauthClientTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oauth_client';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oauth\\Persistence\\SpyOauthClient';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oauth.Persistence.SpyOauthClient';
     ...
     */
    const COL_ID_OAUTH_CLIENT = 'spy_oauth_client.id_oauth_client';

    /**
     * the column name for the identifier field
     */
    const COL_IDENTIFIER = 'spy_oauth_client.identifier';

    /**
     * the column name for the is_confidential field
     */
    const COL_IS_CONFIDENTIAL = 'spy_oauth_client.is_confidential';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_oauth_client.name';

    /**
     * the column name for the redirect_uri field
     */
    const COL_REDIRECT_URI = 'spy_oauth_client.redirect_uri';

    /**
     * the column name for the secret field
     */
    const COL_SECRET = 'spy_oauth_client.secret';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOauthClient', 'Identifier', 'IsConfidential', 'Name', 'RedirectUri', 'Secret', ),
        self::TYPE_CAMELNAME     => array('idOauthClient', 'identifier', 'isConfidential', 'name', 'redirectUri', 'secret', ),
        self::TYPE_COLNAME       => array(SpyOauthClientTableMap::COL_ID_OAUTH_CLIENT, SpyOauthClientTableMap::COL_IDENTIFIER, SpyOauthClientTableMap::COL_IS_CONFIDENTIAL, SpyOauthClientTableMap::COL_NAME, SpyOauthClientTableMap::COL_REDIRECT_URI, SpyOauthClientTableMap::COL_SECRET, ),
        self::TYPE_FIELDNAME     => array('id_oauth_client', 'identifier', 'is_confidential', 'name', 'redirect_uri', 'secret', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOauthClient' => 0, 'Identifier' => 1, 'IsConfidential' => 2, 'Name' => 3, 'RedirectUri' => 4, 'Secret' => 5, ),
        self::TYPE_CAMELNAME     => array('idOauthClient' => 0, 'identifier' => 1, 'isConfidential' => 2, 'name' => 3, 'redirectUri' => 4, 'secret' => 5, ),
        self::TYPE_COLNAME       => array(SpyOauthClientTableMap::COL_ID_OAUTH_CLIENT => 0, SpyOauthClientTableMap::COL_IDENTIFIER => 1, SpyOauthClientTableMap::COL_IS_CONFIDENTIAL => 2, SpyOauthClientTableMap::COL_NAME => 3, SpyOauthClientTableMap::COL_REDIRECT_URI => 4, SpyOauthClientTableMap::COL_SECRET => 5, ),
        self::TYPE_FIELDNAME     => array('id_oauth_client' => 0, 'identifier' => 1, 'is_confidential' => 2, 'name' => 3, 'redirect_uri' => 4, 'secret' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
