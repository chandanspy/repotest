...
class SpyOauthScopeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oauth.Persistence.Map.SpyOauthScopeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oauth_scope';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oauth\\Persistence\\SpyOauthScope';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oauth.Persistence.SpyOauthScope';
     ...
     */
    const COL_ID_OAUTH_SCOPE = 'spy_oauth_scope.id_oauth_scope';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_oauth_scope.description';

    /**
     * the column name for the identifier field
     */
    const COL_IDENTIFIER = 'spy_oauth_scope.identifier';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOauthScope', 'Description', 'Identifier', ),
        self::TYPE_CAMELNAME     => array('idOauthScope', 'description', 'identifier', ),
        self::TYPE_COLNAME       => array(SpyOauthScopeTableMap::COL_ID_OAUTH_SCOPE, SpyOauthScopeTableMap::COL_DESCRIPTION, SpyOauthScopeTableMap::COL_IDENTIFIER, ),
        self::TYPE_FIELDNAME     => array('id_oauth_scope', 'description', 'identifier', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOauthScope' => 0, 'Description' => 1, 'Identifier' => 2, ),
        self::TYPE_CAMELNAME     => array('idOauthScope' => 0, 'description' => 1, 'identifier' => 2, ),
        self::TYPE_COLNAME       => array(SpyOauthScopeTableMap::COL_ID_OAUTH_SCOPE => 0, SpyOauthScopeTableMap::COL_DESCRIPTION => 1, SpyOauthScopeTableMap::COL_IDENTIFIER => 2, ),
        self::TYPE_FIELDNAME     => array('id_oauth_scope' => 0, 'description' => 1, 'identifier' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
