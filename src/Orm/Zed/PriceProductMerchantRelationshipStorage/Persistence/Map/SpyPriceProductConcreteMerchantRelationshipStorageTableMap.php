...
class SpyPriceProductConcreteMerchantRelationshipStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProductMerchantRelationshipStorage.Persistence.Map.SpyPriceProductConcreteMerchantRelationshipStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_concrete_merchant_relationship_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProductMerchantRelationshipStorage\\Persistence\\SpyPriceProductConcreteMerchantRelationshipStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProductMerchantRelationshipStorage.Persistence.SpyPriceProductConcreteMerchantRelationshipStorage';
     ...
     */
    const COL_ID_PRICE_PRODUCT_CONCRETE_MERCHANT_RELATIONSHIP_STORAGE = 'spy_price_product_concrete_merchant_relationship_storage.id_price_product_concrete_merchant_relationship_storage';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_price_product_concrete_merchant_relationship_storage.key';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_price_product_concrete_merchant_relationship_storage.fk_product';

    /**
     * the column name for the fk_company_business_unit field
     */
    const COL_FK_COMPANY_BUSINESS_UNIT = 'spy_price_product_concrete_merchant_relationship_storage.fk_company_business_unit';

    /**
     * the column name for the price_key field
     */
    const COL_PRICE_KEY = 'spy_price_product_concrete_merchant_relationship_storage.price_key';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_price_product_concrete_merchant_relationship_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_price_product_concrete_merchant_relationship_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_price_product_concrete_merchant_relationship_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_price_product_concrete_merchant_relationship_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductConcreteMerchantRelationshipStorage', 'Key', 'FkProduct', 'FkCompanyBusinessUnit', 'PriceKey', 'Data', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPriceProductConcreteMerchantRelationshipStorage', 'key', 'fkProduct', 'fkCompanyBusinessUnit', 'priceKey', 'data', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_ID_PRICE_PRODUCT_CONCRETE_MERCHANT_RELATIONSHIP_STORAGE, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_KEY, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_FK_PRODUCT, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_FK_COMPANY_BUSINESS_UNIT, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_PRICE_KEY, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_DATA, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_ALIAS_KEYS, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_CREATED_AT, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_price_product_concrete_merchant_relationship_storage', 'key', 'fk_product', 'fk_company_business_unit', 'price_key', 'data', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductConcreteMerchantRelationshipStorage' => 0, 'Key' => 1, 'FkProduct' => 2, 'FkCompanyBusinessUnit' => 3, 'PriceKey' => 4, 'Data' => 5, 'AliasKeys' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idPriceProductConcreteMerchantRelationshipStorage' => 0, 'key' => 1, 'fkProduct' => 2, 'fkCompanyBusinessUnit' => 3, 'priceKey' => 4, 'data' => 5, 'aliasKeys' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_ID_PRICE_PRODUCT_CONCRETE_MERCHANT_RELATIONSHIP_STORAGE => 0, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_KEY => 1, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_FK_PRODUCT => 2, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_FK_COMPANY_BUSINESS_UNIT => 3, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_PRICE_KEY => 4, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_DATA => 5, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_ALIAS_KEYS => 6, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_CREATED_AT => 7, SpyPriceProductConcreteMerchantRelationshipStorageTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_price_product_concrete_merchant_relationship_storage' => 0, 'key' => 1, 'fk_product' => 2, 'fk_company_business_unit' => 3, 'price_key' => 4, 'data' => 5, 'alias_keys' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
