...
class SpyProductListTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductList.Persistence.Map.SpyProductListTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_list';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductList\\Persistence\\SpyProductList';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductList.Persistence.SpyProductList';
     ...
     */
    const COL_ID_PRODUCT_LIST = 'spy_product_list.id_product_list';

    /**
     * the column name for the fk_merchant_relationship field
     */
    const COL_FK_MERCHANT_RELATIONSHIP = 'spy_product_list.fk_merchant_relationship';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_list.key';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'spy_product_list.title';

    /**
     * the column name for the type field
     */
    const COL_TYPE = 'spy_product_list.type';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_list.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_list.updated_at';
    ...
    const COL_TYPE_BLACKLIST = 'blacklist';
    const COL_TYPE_WHITELIST = 'whitelist';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductList', 'FkMerchantRelationship', 'Key', 'Title', 'Type', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductList', 'fkMerchantRelationship', 'key', 'title', 'type', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductListTableMap::COL_ID_PRODUCT_LIST, SpyProductListTableMap::COL_FK_MERCHANT_RELATIONSHIP, SpyProductListTableMap::COL_KEY, SpyProductListTableMap::COL_TITLE, SpyProductListTableMap::COL_TYPE, SpyProductListTableMap::COL_CREATED_AT, SpyProductListTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_list', 'fk_merchant_relationship', 'key', 'title', 'type', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductList' => 0, 'FkMerchantRelationship' => 1, 'Key' => 2, 'Title' => 3, 'Type' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductList' => 0, 'fkMerchantRelationship' => 1, 'key' => 2, 'title' => 3, 'type' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductListTableMap::COL_ID_PRODUCT_LIST => 0, SpyProductListTableMap::COL_FK_MERCHANT_RELATIONSHIP => 1, SpyProductListTableMap::COL_KEY => 2, SpyProductListTableMap::COL_TITLE => 3, SpyProductListTableMap::COL_TYPE => 4, SpyProductListTableMap::COL_CREATED_AT => 5, SpyProductListTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_list' => 0, 'fk_merchant_relationship' => 1, 'key' => 2, 'title' => 3, 'type' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    protected static $enumValueSets = array(
                SpyProductListTableMap::COL_TYPE => array(
