...
class SpyProductListProductConcreteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductList.Persistence.Map.SpyProductListProductConcreteTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_list_product_concrete';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductList\\Persistence\\SpyProductListProductConcrete';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductList.Persistence.SpyProductListProductConcrete';
     ...
     */
    const COL_FK_PRODUCT = 'spy_product_list_product_concrete.fk_product';

    /**
     * the column name for the fk_product_list field
     */
    const COL_FK_PRODUCT_LIST = 'spy_product_list_product_concrete.fk_product_list';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkProduct', 'FkProductList', ),
        self::TYPE_CAMELNAME     => array('fkProduct', 'fkProductList', ),
        self::TYPE_COLNAME       => array(SpyProductListProductConcreteTableMap::COL_FK_PRODUCT, SpyProductListProductConcreteTableMap::COL_FK_PRODUCT_LIST, ),
        self::TYPE_FIELDNAME     => array('fk_product', 'fk_product_list', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkProduct' => 0, 'FkProductList' => 1, ),
        self::TYPE_CAMELNAME     => array('fkProduct' => 0, 'fkProductList' => 1, ),
        self::TYPE_COLNAME       => array(SpyProductListProductConcreteTableMap::COL_FK_PRODUCT => 0, SpyProductListProductConcreteTableMap::COL_FK_PRODUCT_LIST => 1, ),
        self::TYPE_FIELDNAME     => array('fk_product' => 0, 'fk_product_list' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
...
} // SpyProductListProductConcreteTableMap
