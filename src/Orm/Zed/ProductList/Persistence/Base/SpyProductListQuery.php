 ...
 *
 * @method     ChildSpyProductList[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductList objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> find(ConnectionInterface $con = null) Return ChildSpyProductList objects based on current ModelCriteria
 * @method     ChildSpyProductList[]|ObjectCollection findByIdProductList(int $id_product_list) Return ChildSpyProductList objects filtered by the id_product_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByIdProductList(int $id_product_list) Return ChildSpyProductList objects filtered by the id_product_list column
 * @method     ChildSpyProductList[]|ObjectCollection findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyProductList objects filtered by the fk_merchant_relationship column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyProductList objects filtered by the fk_merchant_relationship column
 * @method     ChildSpyProductList[]|ObjectCollection findByKey(string $key) Return ChildSpyProductList objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByKey(string $key) Return ChildSpyProductList objects filtered by the key column
 * @method     ChildSpyProductList[]|ObjectCollection findByTitle(string $title) Return ChildSpyProductList objects filtered by the title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByTitle(string $title) Return ChildSpyProductList objects filtered by the title column
 * @method     ChildSpyProductList[]|ObjectCollection findByType(int $type) Return ChildSpyProductList objects filtered by the type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByType(int $type) Return ChildSpyProductList objects filtered by the type column
 * @method     ChildSpyProductList[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductList objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByCreatedAt(string $created_at) Return ChildSpyProductList objects filtered by the created_at column
 * @method     ChildSpyProductList[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductList objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductList> findByUpdatedAt(string $updated_at) Return ChildSpyProductList objects filtered by the updated_at column
...
abstract class SpyProductListQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductListQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductListTableMap::COL_ID_PRODUCT_LIST, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductListTableMap::COL_ID_PRODUCT_LIST, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductListQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyProductListQuery The current query, for fluid interface
     */
    public function joinSpyMerchantRelationship($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     * @return ChildSpyProductListQuery The current query, for fluid interface
     */
    public function filterBySpyConfigurableBundleTemplateSlot($spyConfigurableBundleTemplateSlot, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductListQuery The current query, for fluid interface
     */
    public function joinSpyConfigurableBundleTemplateSlot($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyConfigurableBundleTemplateSlot', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyConfigurableBundleTemplateSlot', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductListQuery The current query, for fluid interface
     */
    public function filterBySpyProductListCategory($spyProductListCategory, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductListQuery The current query, for fluid interface
     */
    public function joinSpyProductListCategory($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductListCategory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductListCategory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductListQuery The current query, for fluid interface
     */
    public function filterBySpyProduct($spyProduct, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useSpyProductListProductConcreteQuery()
     ...
     * @return ChildSpyProductListQuery The current query, for fluid interface
     */
    public function filterBySpyCategory($spyCategory, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useSpyProductListCategoryQuery()
    ...
    {
        return $this->addUsingAlias(SpyProductListTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductListTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductListTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductListTableMap::COL_CREATED_AT);
    }
