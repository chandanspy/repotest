...
abstract class SpyProductList implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductList\\Persistence\\Map\\SpyProductListTableMap';
     ...
     * @return $this|\Orm\Zed\ProductList\Persistence\SpyProductList The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductList\Persistence\SpyProductList
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductList\Persistence\SpyProductList The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductList The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyConfigurableBundleTemplateSlot(SpyConfigurableBundleTemplateSlot $spyConfigurableBundleTemplateSlot)
    {
     ...
     */
    protected function doAddSpyProductListProductConcrete(ChildSpyProductListProductConcrete $spyProductListProductConcrete)
    {
     ...
     */
    protected function doAddSpyProductListCategory(ChildSpyProductListCategory $spyProductListCategory)
    {
     ...
     * @return bool
     */
    public function isSpyProductsLoaded()
    {
     ...
     * @return bool
     */
    public function isSpyCategoriesLoaded()
    {
     ...
     */
    public function countSpyCategories(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCategoriesPartial && !$this->isNew();
        if (null === $this->collSpyCategories || null !== $criteria || $partial) {
