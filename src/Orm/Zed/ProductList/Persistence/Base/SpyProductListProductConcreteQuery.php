 ...
 *
 * @method     ChildSpyProductListProductConcrete[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductListProductConcrete objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListProductConcrete> find(ConnectionInterface $con = null) Return ChildSpyProductListProductConcrete objects based on current ModelCriteria
 * @method     ChildSpyProductListProductConcrete[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductListProductConcrete objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListProductConcrete> findByFkProduct(int $fk_product) Return ChildSpyProductListProductConcrete objects filtered by the fk_product column
 * @method     ChildSpyProductListProductConcrete[]|ObjectCollection findByFkProductList(int $fk_product_list) Return ChildSpyProductListProductConcrete objects filtered by the fk_product_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListProductConcrete> findByFkProductList(int $fk_product_list) Return ChildSpyProductListProductConcrete objects filtered by the fk_product_list column
...
abstract class SpyProductListProductConcreteQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductListProductConcreteQuery The current query, for fluid interface
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductListProductConcreteQuery The current query, for fluid interface
     */
...
} // SpyProductListProductConcreteQuery
