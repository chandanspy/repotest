 ...
 *
 * @method     ChildSpyProductListCategory[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductListCategory objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListCategory> find(ConnectionInterface $con = null) Return ChildSpyProductListCategory objects based on current ModelCriteria
 * @method     ChildSpyProductListCategory[]|ObjectCollection findByFkCategory(int $fk_category) Return ChildSpyProductListCategory objects filtered by the fk_category column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListCategory> findByFkCategory(int $fk_category) Return ChildSpyProductListCategory objects filtered by the fk_category column
 * @method     ChildSpyProductListCategory[]|ObjectCollection findByFkProductList(int $fk_product_list) Return ChildSpyProductListCategory objects filtered by the fk_product_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductListCategory> findByFkProductList(int $fk_product_list) Return ChildSpyProductListCategory objects filtered by the fk_product_list column
...
abstract class SpyProductListCategoryQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductListCategoryQuery The current query, for fluid interface
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductListCategoryQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyProductListCategoryQuery The current query, for fluid interface
     */
    public function joinSpyProductList($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
