...
class SpyProductAlternativeStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductAlternativeStorage.Persistence.Map.SpyProductAlternativeStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_alternative_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductAlternativeStorage\\Persistence\\SpyProductAlternativeStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductAlternativeStorage.Persistence.SpyProductAlternativeStorage';
     ...
     */
    const COL_ID_PRODUCT_ALTERNATIVE_STORAGE = 'spy_product_alternative_storage.id_product_alternative_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_alternative_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_alternative_storage.data';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_product_alternative_storage.sku';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_alternative_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_alternative_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_alternative_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_alternative_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAlternativeStorage', 'FkProduct', 'Data', 'Sku', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductAlternativeStorage', 'fkProduct', 'data', 'sku', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductAlternativeStorageTableMap::COL_ID_PRODUCT_ALTERNATIVE_STORAGE, SpyProductAlternativeStorageTableMap::COL_FK_PRODUCT, SpyProductAlternativeStorageTableMap::COL_DATA, SpyProductAlternativeStorageTableMap::COL_SKU, SpyProductAlternativeStorageTableMap::COL_ALIAS_KEYS, SpyProductAlternativeStorageTableMap::COL_KEY, SpyProductAlternativeStorageTableMap::COL_CREATED_AT, SpyProductAlternativeStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_alternative_storage', 'fk_product', 'data', 'sku', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAlternativeStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Sku' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductAlternativeStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'sku' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_alternative_storage' => 0, 'fk_product' => 1, 'data' => 2, 'sku' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyProductAlternativeStorageTableMap
