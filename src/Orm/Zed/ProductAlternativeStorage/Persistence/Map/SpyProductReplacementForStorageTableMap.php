...
class SpyProductReplacementForStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductAlternativeStorage.Persistence.Map.SpyProductReplacementForStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_replacement_for_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductAlternativeStorage\\Persistence\\SpyProductReplacementForStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductAlternativeStorage.Persistence.SpyProductReplacementForStorage';
     ...
     */
    const COL_ID_PRODUCT_REPLACEMENT_FOR_STORAGE = 'spy_product_replacement_for_storage.id_product_replacement_for_storage';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_replacement_for_storage.data';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_product_replacement_for_storage.sku';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_replacement_for_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_replacement_for_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_replacement_for_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_replacement_for_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductReplacementForStorage', 'Data', 'Sku', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductReplacementForStorage', 'data', 'sku', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductReplacementForStorageTableMap::COL_ID_PRODUCT_REPLACEMENT_FOR_STORAGE, SpyProductReplacementForStorageTableMap::COL_DATA, SpyProductReplacementForStorageTableMap::COL_SKU, SpyProductReplacementForStorageTableMap::COL_ALIAS_KEYS, SpyProductReplacementForStorageTableMap::COL_KEY, SpyProductReplacementForStorageTableMap::COL_CREATED_AT, SpyProductReplacementForStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_replacement_for_storage', 'data', 'sku', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductReplacementForStorage' => 0, 'Data' => 1, 'Sku' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductReplacementForStorage' => 0, 'data' => 1, 'sku' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductReplacementForStorageTableMap::COL_ID_PRODUCT_REPLACEMENT_FOR_STORAGE => 0, SpyProductReplacementForStorageTableMap::COL_DATA => 1, SpyProductReplacementForStorageTableMap::COL_SKU => 2, SpyProductReplacementForStorageTableMap::COL_ALIAS_KEYS => 3, SpyProductReplacementForStorageTableMap::COL_KEY => 4, SpyProductReplacementForStorageTableMap::COL_CREATED_AT => 5, SpyProductReplacementForStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_replacement_for_storage' => 0, 'data' => 1, 'sku' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyProductReplacementForStorageTableMap
