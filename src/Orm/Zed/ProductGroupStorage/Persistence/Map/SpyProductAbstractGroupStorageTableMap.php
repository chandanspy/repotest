...
class SpyProductAbstractGroupStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductGroupStorage.Persistence.Map.SpyProductAbstractGroupStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_group_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductGroupStorage\\Persistence\\SpyProductAbstractGroupStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductGroupStorage.Persistence.SpyProductAbstractGroupStorage';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_GROUP_STORAGE = 'spy_product_abstract_group_storage.id_product_abstract_group_storage';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_group_storage.fk_product_abstract';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_abstract_group_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_abstract_group_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_abstract_group_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_abstract_group_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_abstract_group_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractGroupStorage', 'FkProductAbstract', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractGroupStorage', 'fkProductAbstract', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractGroupStorageTableMap::COL_ID_PRODUCT_ABSTRACT_GROUP_STORAGE, SpyProductAbstractGroupStorageTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractGroupStorageTableMap::COL_DATA, SpyProductAbstractGroupStorageTableMap::COL_ALIAS_KEYS, SpyProductAbstractGroupStorageTableMap::COL_KEY, SpyProductAbstractGroupStorageTableMap::COL_CREATED_AT, SpyProductAbstractGroupStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_group_storage', 'fk_product_abstract', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractGroupStorage' => 0, 'FkProductAbstract' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractGroupStorage' => 0, 'fkProductAbstract' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_abstract_group_storage' => 0, 'fk_product_abstract' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
