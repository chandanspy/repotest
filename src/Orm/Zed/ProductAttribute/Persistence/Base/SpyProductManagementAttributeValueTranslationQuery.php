 ...
 *
 * @method     ChildSpyProductManagementAttributeValueTranslation[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductManagementAttributeValueTranslation objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductManagementAttributeValueTranslation> find(ConnectionInterface $con = null) Return ChildSpyProductManagementAttributeValueTranslation objects based on current ModelCriteria
 * @method     ChildSpyProductManagementAttributeValueTranslation[]|ObjectCollection findByIdProductManagementAttributeValueTranslation(int $id_product_management_attribute_value_translation) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the id_product_management_attribute_value_translation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductManagementAttributeValueTranslation> findByIdProductManagementAttributeValueTranslation(int $id_product_management_attribute_value_translation) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the id_product_management_attribute_value_translation column
 * @method     ChildSpyProductManagementAttributeValueTranslation[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductManagementAttributeValueTranslation> findByFkLocale(int $fk_locale) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the fk_locale column
 * @method     ChildSpyProductManagementAttributeValueTranslation[]|ObjectCollection findByFkProductManagementAttributeValue(int $fk_product_management_attribute_value) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the fk_product_management_attribute_value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductManagementAttributeValueTranslation> findByFkProductManagementAttributeValue(int $fk_product_management_attribute_value) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the fk_product_management_attribute_value column
 * @method     ChildSpyProductManagementAttributeValueTranslation[]|ObjectCollection findByTranslation(string $translation) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the translation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductManagementAttributeValueTranslation> findByTranslation(string $translation) Return ChildSpyProductManagementAttributeValueTranslation objects filtered by the translation column
...
abstract class SpyProductManagementAttributeValueTranslationQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductManagementAttributeValueTranslationQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductManagementAttributeValueTranslationTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE_TRANSLATION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductManagementAttributeValueTranslationTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE_TRANSLATION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductManagementAttributeValueTranslationQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyProductManagementAttributeValueTranslationQuery The current query, for fluid interface
     */
    public function filterBySpyProductManagementAttributeValue($spyProductManagementAttributeValue, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductManagementAttributeValueTranslationQuery The current query, for fluid interface
     */
    public function joinSpyProductManagementAttributeValue($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductManagementAttributeValue', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductManagementAttributeValue', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
...
} // SpyProductManagementAttributeValueTranslationQuery
