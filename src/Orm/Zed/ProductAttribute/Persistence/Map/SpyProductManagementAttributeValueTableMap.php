...
class SpyProductManagementAttributeValueTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductAttribute.Persistence.Map.SpyProductManagementAttributeValueTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_management_attribute_value';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductAttribute\\Persistence\\SpyProductManagementAttributeValue';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductAttribute.Persistence.SpyProductManagementAttributeValue';
     ...
     */
    const COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE = 'spy_product_management_attribute_value.id_product_management_attribute_value';

    /**
     * the column name for the fk_product_management_attribute field
     */
    const COL_FK_PRODUCT_MANAGEMENT_ATTRIBUTE = 'spy_product_management_attribute_value.fk_product_management_attribute';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'spy_product_management_attribute_value.value';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductManagementAttributeValue', 'FkProductManagementAttribute', 'Value', ),
        self::TYPE_CAMELNAME     => array('idProductManagementAttributeValue', 'fkProductManagementAttribute', 'value', ),
        self::TYPE_COLNAME       => array(SpyProductManagementAttributeValueTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE, SpyProductManagementAttributeValueTableMap::COL_FK_PRODUCT_MANAGEMENT_ATTRIBUTE, SpyProductManagementAttributeValueTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id_product_management_attribute_value', 'fk_product_management_attribute', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductManagementAttributeValue' => 0, 'FkProductManagementAttribute' => 1, 'Value' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductManagementAttributeValue' => 0, 'fkProductManagementAttribute' => 1, 'value' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductManagementAttributeValueTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE => 0, SpyProductManagementAttributeValueTableMap::COL_FK_PRODUCT_MANAGEMENT_ATTRIBUTE => 1, SpyProductManagementAttributeValueTableMap::COL_VALUE => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_management_attribute_value' => 0, 'fk_product_management_attribute' => 1, 'value' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductManagementAttributeValueTableMap
