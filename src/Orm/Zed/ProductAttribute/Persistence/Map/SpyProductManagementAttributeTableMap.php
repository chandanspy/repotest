...
class SpyProductManagementAttributeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductAttribute.Persistence.Map.SpyProductManagementAttributeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_management_attribute';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductAttribute\\Persistence\\SpyProductManagementAttribute';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductAttribute.Persistence.SpyProductManagementAttribute';
     ...
     */
    const COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE = 'spy_product_management_attribute.id_product_management_attribute';

    /**
     * the column name for the fk_product_attribute_key field
     */
    const COL_FK_PRODUCT_ATTRIBUTE_KEY = 'spy_product_management_attribute.fk_product_attribute_key';

    /**
     * the column name for the allow_input field
     */
    const COL_ALLOW_INPUT = 'spy_product_management_attribute.allow_input';

    /**
     * the column name for the input_type field
     */
    const COL_INPUT_TYPE = 'spy_product_management_attribute.input_type';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductManagementAttribute', 'FkProductAttributeKey', 'AllowInput', 'InputType', ),
        self::TYPE_CAMELNAME     => array('idProductManagementAttribute', 'fkProductAttributeKey', 'allowInput', 'inputType', ),
        self::TYPE_COLNAME       => array(SpyProductManagementAttributeTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE, SpyProductManagementAttributeTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY, SpyProductManagementAttributeTableMap::COL_ALLOW_INPUT, SpyProductManagementAttributeTableMap::COL_INPUT_TYPE, ),
        self::TYPE_FIELDNAME     => array('id_product_management_attribute', 'fk_product_attribute_key', 'allow_input', 'input_type', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductManagementAttribute' => 0, 'FkProductAttributeKey' => 1, 'AllowInput' => 2, 'InputType' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductManagementAttribute' => 0, 'fkProductAttributeKey' => 1, 'allowInput' => 2, 'inputType' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductManagementAttributeTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE => 0, SpyProductManagementAttributeTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY => 1, SpyProductManagementAttributeTableMap::COL_ALLOW_INPUT => 2, SpyProductManagementAttributeTableMap::COL_INPUT_TYPE => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_management_attribute' => 0, 'fk_product_attribute_key' => 1, 'allow_input' => 2, 'input_type' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductManagementAttributeTableMap
