...
class SpyNewsletterSubscriberTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Newsletter.Persistence.Map.SpyNewsletterSubscriberTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Newsletter\\Persistence\\SpyNewsletterSubscriber';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Newsletter.Persistence.SpyNewsletterSubscriber';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdNewsletterSubscriber', 'FkCustomer', 'Email', 'IsConfirmed', 'SubscriberKey', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idNewsletterSubscriber', 'fkCustomer', 'email', 'isConfirmed', 'subscriberKey', 'createdAt', 'updatedAt', ),
        ...
        self::TYPE_FIELDNAME     => array('id_newsletter_subscriber', 'fk_customer', 'email', 'is_confirmed', 'subscriber_key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdNewsletterSubscriber' => 0, 'FkCustomer' => 1, 'Email' => 2, 'IsConfirmed' => 3, 'SubscriberKey' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idNewsletterSubscriber' => 0, 'fkCustomer' => 1, 'email' => 2, 'isConfirmed' => 3, 'subscriberKey' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyNewsletterSubscriberTableMap::COL_ID_NEWSLETTER_SUBSCRIBER => 0, SpyNewsletterSubscriberTableMap::COL_FK_CUSTOMER => 1, SpyNewsletterSubscriberTableMap::COL_EMAIL => 2, SpyNewsletterSubscriberTableMap::COL_IS_CONFIRMED => 3, SpyNewsletterSubscriberTableMap::COL_SUBSCRIBER_KEY => 4, SpyNewsletterSubscriberTableMap::COL_CREATED_AT => 5, SpyNewsletterSubscriberTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_newsletter_subscriber' => 0, 'fk_customer' => 1, 'email' => 2, 'is_confirmed' => 3, 'subscriber_key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
