...
class SpyNewsletterTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Newsletter.Persistence.Map.SpyNewsletterTypeTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Newsletter\\Persistence\\SpyNewsletterType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Newsletter.Persistence.SpyNewsletterType';
