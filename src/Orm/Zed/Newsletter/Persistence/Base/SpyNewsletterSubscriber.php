 ...
 */
abstract class SpyNewsletterSubscriber implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Newsletter\\Persistence\\Map\\SpyNewsletterSubscriberTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyNewsletterType> Cross Collection to store aggregation of ChildSpyNewsletterType objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyNewsletterType>
     */
    ...
    /**
     * Initializes internal state of Orm\Zed\Newsletter\Persistence\Base\SpyNewsletterSubscriber object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Orm\Zed\Newsletter\Persistence\SpyNewsletterSubscriber The current object (for fluent API support)
     */
    public function setIdNewsletterSubscriber($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_newsletter_subscriber !== $v) {
    ...
    public function setIsConfirmed($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->is_confirmed !== $v) {
            $this->is_confirmed = $v;
    ...
    public function setSubscriberKey($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->subscriber_key !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyNewsletterSubscriberTableMap::translateFieldName('IsConfirmed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_confirmed = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyNewsletterSubscriberTableMap::translateFieldName('SubscriberKey', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\Newsletter\\Persistence\\SpyNewsletterSubscriber'), 0, $e);
        }
    }
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getIsConfirmed(),
            $keys[4] => $this->getSubscriberKey(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Newsletter\Persistence\SpyNewsletterSubscriber
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setIsConfirmed($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setSubscriberKey($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Newsletter\Persistence\SpyNewsletterSubscriber The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\Newsletter\Persistence\SpyNewsletterSubscriber (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\Newsletter\Persistence\SpyNewsletterSubscriber Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyNewsletterTypes()
    {
        ...
        $this->collSpyNewsletterTypes = new $collectionClassName;
        $this->collSpyNewsletterTypesPartial = true;
        $this->collSpyNewsletterTypes->setModel('\Orm\Zed\Newsletter\Persistence\SpyNewsletterType');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyNewsletterType> List of ChildSpyNewsletterType objects
     */
