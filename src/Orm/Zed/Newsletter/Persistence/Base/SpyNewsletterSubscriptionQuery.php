 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscription> find(ConnectionInterface $con = null) Return ChildSpyNewsletterSubscription objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscription> findByFkNewsletterSubscriber(int $fk_newsletter_subscriber) Return ChildSpyNewsletterSubscription objects filtered by the fk_newsletter_subscriber column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscription> findByFkNewsletterType(int $fk_newsletter_type) Return ChildSpyNewsletterSubscription objects filtered by the fk_newsletter_type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscription> findByCreatedAt(string $created_at) Return ChildSpyNewsletterSubscription objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscription> findByUpdatedAt(string $updated_at) Return ChildSpyNewsletterSubscription objects filtered by the updated_at column
...
abstract class SpyNewsletterSubscriptionQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('SpyNewsletterType', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyNewsletterType', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
