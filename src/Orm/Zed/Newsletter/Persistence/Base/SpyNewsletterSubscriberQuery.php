 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> find(ConnectionInterface $con = null) Return ChildSpyNewsletterSubscriber objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByIdNewsletterSubscriber(int $id_newsletter_subscriber) Return ChildSpyNewsletterSubscriber objects filtered by the id_newsletter_subscriber column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByFkCustomer(int $fk_customer) Return ChildSpyNewsletterSubscriber objects filtered by the fk_customer column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByEmail(string $email) Return ChildSpyNewsletterSubscriber objects filtered by the email column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByIsConfirmed(boolean $is_confirmed) Return ChildSpyNewsletterSubscriber objects filtered by the is_confirmed column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findBySubscriberKey(string $subscriber_key) Return ChildSpyNewsletterSubscriber objects filtered by the subscriber_key column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByCreatedAt(string $created_at) Return ChildSpyNewsletterSubscriber objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyNewsletterSubscriber> findByUpdatedAt(string $updated_at) Return ChildSpyNewsletterSubscriber objects filtered by the updated_at column
