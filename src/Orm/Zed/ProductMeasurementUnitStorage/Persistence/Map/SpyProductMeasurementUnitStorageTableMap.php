...
class SpyProductMeasurementUnitStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductMeasurementUnitStorage.Persistence.Map.SpyProductMeasurementUnitStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_measurement_unit_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductMeasurementUnitStorage\\Persistence\\SpyProductMeasurementUnitStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductMeasurementUnitStorage.Persistence.SpyProductMeasurementUnitStorage';
     ...
     */
    const COL_ID_PRODUCT_MEASUREMENT_UNIT_STORAGE = 'spy_product_measurement_unit_storage.id_product_measurement_unit_storage';

    /**
     * the column name for the fk_product_measurement_unit field
     */
    const COL_FK_PRODUCT_MEASUREMENT_UNIT = 'spy_product_measurement_unit_storage.fk_product_measurement_unit';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_measurement_unit_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_measurement_unit_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_measurement_unit_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_measurement_unit_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_measurement_unit_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementUnitStorage', 'FkProductMeasurementUnit', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementUnitStorage', 'fkProductMeasurementUnit', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductMeasurementUnitStorageTableMap::COL_ID_PRODUCT_MEASUREMENT_UNIT_STORAGE, SpyProductMeasurementUnitStorageTableMap::COL_FK_PRODUCT_MEASUREMENT_UNIT, SpyProductMeasurementUnitStorageTableMap::COL_DATA, SpyProductMeasurementUnitStorageTableMap::COL_KEY, SpyProductMeasurementUnitStorageTableMap::COL_ALIAS_KEYS, SpyProductMeasurementUnitStorageTableMap::COL_CREATED_AT, SpyProductMeasurementUnitStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_measurement_unit_storage', 'fk_product_measurement_unit', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementUnitStorage' => 0, 'FkProductMeasurementUnit' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementUnitStorage' => 0, 'fkProductMeasurementUnit' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductMeasurementUnitStorageTableMap::COL_ID_PRODUCT_MEASUREMENT_UNIT_STORAGE => 0, SpyProductMeasurementUnitStorageTableMap::COL_FK_PRODUCT_MEASUREMENT_UNIT => 1, SpyProductMeasurementUnitStorageTableMap::COL_DATA => 2, SpyProductMeasurementUnitStorageTableMap::COL_KEY => 3, SpyProductMeasurementUnitStorageTableMap::COL_ALIAS_KEYS => 4, SpyProductMeasurementUnitStorageTableMap::COL_CREATED_AT => 5, SpyProductMeasurementUnitStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_measurement_unit_storage' => 0, 'fk_product_measurement_unit' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
