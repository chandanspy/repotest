...
class SpyProductConcreteMeasurementUnitStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductMeasurementUnitStorage.Persistence.Map.SpyProductConcreteMeasurementUnitStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_concrete_measurement_unit_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductMeasurementUnitStorage\\Persistence\\SpyProductConcreteMeasurementUnitStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductMeasurementUnitStorage.Persistence.SpyProductConcreteMeasurementUnitStorage';
     ...
     */
    const COL_ID_PRODUCT_CONCRETE_MEASUREMENT_UNIT_STORAGE = 'spy_product_concrete_measurement_unit_storage.id_product_concrete_measurement_unit_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_concrete_measurement_unit_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_concrete_measurement_unit_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_concrete_measurement_unit_storage.key';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_product_concrete_measurement_unit_storage.store';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_concrete_measurement_unit_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_concrete_measurement_unit_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_concrete_measurement_unit_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductConcreteMeasurementUnitStorage', 'FkProduct', 'Data', 'Key', 'Store', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductConcreteMeasurementUnitStorage', 'fkProduct', 'data', 'key', 'store', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductConcreteMeasurementUnitStorageTableMap::COL_ID_PRODUCT_CONCRETE_MEASUREMENT_UNIT_STORAGE, SpyProductConcreteMeasurementUnitStorageTableMap::COL_FK_PRODUCT, SpyProductConcreteMeasurementUnitStorageTableMap::COL_DATA, SpyProductConcreteMeasurementUnitStorageTableMap::COL_KEY, SpyProductConcreteMeasurementUnitStorageTableMap::COL_STORE, SpyProductConcreteMeasurementUnitStorageTableMap::COL_ALIAS_KEYS, SpyProductConcreteMeasurementUnitStorageTableMap::COL_CREATED_AT, SpyProductConcreteMeasurementUnitStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_concrete_measurement_unit_storage', 'fk_product', 'data', 'key', 'store', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductConcreteMeasurementUnitStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Key' => 3, 'Store' => 4, 'AliasKeys' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductConcreteMeasurementUnitStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'key' => 3, 'store' => 4, 'aliasKeys' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyProductConcreteMeasurementUnitStorageTableMap::COL_ID_PRODUCT_CONCRETE_MEASUREMENT_UNIT_STORAGE => 0, SpyProductConcreteMeasurementUnitStorageTableMap::COL_FK_PRODUCT => 1, SpyProductConcreteMeasurementUnitStorageTableMap::COL_DATA => 2, SpyProductConcreteMeasurementUnitStorageTableMap::COL_KEY => 3, SpyProductConcreteMeasurementUnitStorageTableMap::COL_STORE => 4, SpyProductConcreteMeasurementUnitStorageTableMap::COL_ALIAS_KEYS => 5, SpyProductConcreteMeasurementUnitStorageTableMap::COL_CREATED_AT => 6, SpyProductConcreteMeasurementUnitStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_product_concrete_measurement_unit_storage' => 0, 'fk_product' => 1, 'data' => 2, 'key' => 3, 'store' => 4, 'alias_keys' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
