...
class SpyProductSearchAttributeMapArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSearch.Persistence.Map.SpyProductSearchAttributeMapArchiveTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_search_attribute_map_archive';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSearch\\Persistence\\SpyProductSearchAttributeMapArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSearch.Persistence.SpyProductSearchAttributeMapArchive';
     ...
     */
    const COL_FK_PRODUCT_ATTRIBUTE_KEY = 'spy_product_search_attribute_map_archive.fk_product_attribute_key';

    /**
     * the column name for the synced field
     */
    const COL_SYNCED = 'spy_product_search_attribute_map_archive.synced';

    /**
     * the column name for the target_field field
     */
    const COL_TARGET_FIELD = 'spy_product_search_attribute_map_archive.target_field';

    /**
     * the column name for the archived_at field
     */
    const COL_ARCHIVED_AT = 'spy_product_search_attribute_map_archive.archived_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkProductAttributeKey', 'Synced', 'TargetField', 'ArchivedAt', ),
        self::TYPE_CAMELNAME     => array('fkProductAttributeKey', 'synced', 'targetField', 'archivedAt', ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeMapArchiveTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY, SpyProductSearchAttributeMapArchiveTableMap::COL_SYNCED, SpyProductSearchAttributeMapArchiveTableMap::COL_TARGET_FIELD, SpyProductSearchAttributeMapArchiveTableMap::COL_ARCHIVED_AT, ),
        self::TYPE_FIELDNAME     => array('fk_product_attribute_key', 'synced', 'target_field', 'archived_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkProductAttributeKey' => 0, 'Synced' => 1, 'TargetField' => 2, 'ArchivedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('fkProductAttributeKey' => 0, 'synced' => 1, 'targetField' => 2, 'archivedAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeMapArchiveTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY => 0, SpyProductSearchAttributeMapArchiveTableMap::COL_SYNCED => 1, SpyProductSearchAttributeMapArchiveTableMap::COL_TARGET_FIELD => 2, SpyProductSearchAttributeMapArchiveTableMap::COL_ARCHIVED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('fk_product_attribute_key' => 0, 'synced' => 1, 'target_field' => 2, 'archived_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductSearchAttributeMapArchiveTableMap
