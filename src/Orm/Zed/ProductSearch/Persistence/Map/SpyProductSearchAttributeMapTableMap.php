...
class SpyProductSearchAttributeMapTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSearch.Persistence.Map.SpyProductSearchAttributeMapTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_search_attribute_map';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSearch\\Persistence\\SpyProductSearchAttributeMap';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSearch.Persistence.SpyProductSearchAttributeMap';
     ...
     */
    const COL_FK_PRODUCT_ATTRIBUTE_KEY = 'spy_product_search_attribute_map.fk_product_attribute_key';

    /**
     * the column name for the synced field
     */
    const COL_SYNCED = 'spy_product_search_attribute_map.synced';

    /**
     * the column name for the target_field field
     */
    const COL_TARGET_FIELD = 'spy_product_search_attribute_map.target_field';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkProductAttributeKey', 'Synced', 'TargetField', ),
        self::TYPE_CAMELNAME     => array('fkProductAttributeKey', 'synced', 'targetField', ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeMapTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY, SpyProductSearchAttributeMapTableMap::COL_SYNCED, SpyProductSearchAttributeMapTableMap::COL_TARGET_FIELD, ),
        self::TYPE_FIELDNAME     => array('fk_product_attribute_key', 'synced', 'target_field', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkProductAttributeKey' => 0, 'Synced' => 1, 'TargetField' => 2, ),
        self::TYPE_CAMELNAME     => array('fkProductAttributeKey' => 0, 'synced' => 1, 'targetField' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeMapTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY => 0, SpyProductSearchAttributeMapTableMap::COL_SYNCED => 1, SpyProductSearchAttributeMapTableMap::COL_TARGET_FIELD => 2, ),
        self::TYPE_FIELDNAME     => array('fk_product_attribute_key' => 0, 'synced' => 1, 'target_field' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductSearchAttributeMapTableMap
