...
class SpyProductSearchAttributeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSearch.Persistence.Map.SpyProductSearchAttributeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_search_attribute';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSearch\\Persistence\\SpyProductSearchAttribute';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSearch.Persistence.SpyProductSearchAttribute';
     ...
     */
    const COL_ID_PRODUCT_SEARCH_ATTRIBUTE = 'spy_product_search_attribute.id_product_search_attribute';

    /**
     * the column name for the fk_product_attribute_key field
     */
    const COL_FK_PRODUCT_ATTRIBUTE_KEY = 'spy_product_search_attribute.fk_product_attribute_key';

    /**
     * the column name for the filter_type field
     */
    const COL_FILTER_TYPE = 'spy_product_search_attribute.filter_type';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_product_search_attribute.position';

    /**
     * the column name for the synced field
     */
    const COL_SYNCED = 'spy_product_search_attribute.synced';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductSearchAttribute', 'FkProductAttributeKey', 'FilterType', 'Position', 'Synced', ),
        self::TYPE_CAMELNAME     => array('idProductSearchAttribute', 'fkProductAttributeKey', 'filterType', 'position', 'synced', ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE, SpyProductSearchAttributeTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY, SpyProductSearchAttributeTableMap::COL_FILTER_TYPE, SpyProductSearchAttributeTableMap::COL_POSITION, SpyProductSearchAttributeTableMap::COL_SYNCED, ),
        self::TYPE_FIELDNAME     => array('id_product_search_attribute', 'fk_product_attribute_key', 'filter_type', 'position', 'synced', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductSearchAttribute' => 0, 'FkProductAttributeKey' => 1, 'FilterType' => 2, 'Position' => 3, 'Synced' => 4, ),
        self::TYPE_CAMELNAME     => array('idProductSearchAttribute' => 0, 'fkProductAttributeKey' => 1, 'filterType' => 2, 'position' => 3, 'synced' => 4, ),
        self::TYPE_COLNAME       => array(SpyProductSearchAttributeTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE => 0, SpyProductSearchAttributeTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY => 1, SpyProductSearchAttributeTableMap::COL_FILTER_TYPE => 2, SpyProductSearchAttributeTableMap::COL_POSITION => 3, SpyProductSearchAttributeTableMap::COL_SYNCED => 4, ),
        self::TYPE_FIELDNAME     => array('id_product_search_attribute' => 0, 'fk_product_attribute_key' => 1, 'filter_type' => 2, 'position' => 3, 'synced' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyProductSearchAttributeTableMap
