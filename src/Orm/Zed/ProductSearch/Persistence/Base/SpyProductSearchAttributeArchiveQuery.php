 ...
 *
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSearchAttributeArchive objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> find(ConnectionInterface $con = null) Return ChildSpyProductSearchAttributeArchive objects based on current ModelCriteria
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findByIdProductSearchAttribute(int $id_product_search_attribute) Return ChildSpyProductSearchAttributeArchive objects filtered by the id_product_search_attribute column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findByIdProductSearchAttribute(int $id_product_search_attribute) Return ChildSpyProductSearchAttributeArchive objects filtered by the id_product_search_attribute column
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findByFkProductAttributeKey(int $fk_product_attribute_key) Return ChildSpyProductSearchAttributeArchive objects filtered by the fk_product_attribute_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findByFkProductAttributeKey(int $fk_product_attribute_key) Return ChildSpyProductSearchAttributeArchive objects filtered by the fk_product_attribute_key column
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findByFilterType(string $filter_type) Return ChildSpyProductSearchAttributeArchive objects filtered by the filter_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findByFilterType(string $filter_type) Return ChildSpyProductSearchAttributeArchive objects filtered by the filter_type column
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findByPosition(int $position) Return ChildSpyProductSearchAttributeArchive objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findByPosition(int $position) Return ChildSpyProductSearchAttributeArchive objects filtered by the position column
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findBySynced(boolean $synced) Return ChildSpyProductSearchAttributeArchive objects filtered by the synced column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findBySynced(boolean $synced) Return ChildSpyProductSearchAttributeArchive objects filtered by the synced column
 * @method     ChildSpyProductSearchAttributeArchive[]|ObjectCollection findByArchivedAt(string $archived_at) Return ChildSpyProductSearchAttributeArchive objects filtered by the archived_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeArchive> findByArchivedAt(string $archived_at) Return ChildSpyProductSearchAttributeArchive objects filtered by the archived_at column
...
abstract class SpyProductSearchAttributeArchiveQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSearchAttributeArchiveQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductSearchAttributeArchiveTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductSearchAttributeArchiveTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE, $keys, Criteria::IN);
    }
...
} // SpyProductSearchAttributeArchiveQuery
