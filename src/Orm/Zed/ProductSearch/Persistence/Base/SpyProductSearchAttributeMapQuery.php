 ...
 *
 * @method     ChildSpyProductSearchAttributeMap[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSearchAttributeMap objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeMap> find(ConnectionInterface $con = null) Return ChildSpyProductSearchAttributeMap objects based on current ModelCriteria
 * @method     ChildSpyProductSearchAttributeMap[]|ObjectCollection findByFkProductAttributeKey(int $fk_product_attribute_key) Return ChildSpyProductSearchAttributeMap objects filtered by the fk_product_attribute_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeMap> findByFkProductAttributeKey(int $fk_product_attribute_key) Return ChildSpyProductSearchAttributeMap objects filtered by the fk_product_attribute_key column
 * @method     ChildSpyProductSearchAttributeMap[]|ObjectCollection findBySynced(boolean $synced) Return ChildSpyProductSearchAttributeMap objects filtered by the synced column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeMap> findBySynced(boolean $synced) Return ChildSpyProductSearchAttributeMap objects filtered by the synced column
 * @method     ChildSpyProductSearchAttributeMap[]|ObjectCollection findByTargetField(string $target_field) Return ChildSpyProductSearchAttributeMap objects filtered by the target_field column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearchAttributeMap> findByTargetField(string $target_field) Return ChildSpyProductSearchAttributeMap objects filtered by the target_field column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSearchAttributeMapQuery The current query, for fluid interface
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductSearchAttributeMapQuery The current query, for fluid interface
     */
...
} // SpyProductSearchAttributeMapQuery
