 ...
 *
 * @method     ChildSpyProductSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearch> find(ConnectionInterface $con = null) Return ChildSpyProductSearch objects based on current ModelCriteria
 * @method     ChildSpyProductSearch[]|ObjectCollection findByIdProductSearch(int $id_product_search) Return ChildSpyProductSearch objects filtered by the id_product_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearch> findByIdProductSearch(int $id_product_search) Return ChildSpyProductSearch objects filtered by the id_product_search column
 * @method     ChildSpyProductSearch[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductSearch objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearch> findByFkLocale(int $fk_locale) Return ChildSpyProductSearch objects filtered by the fk_locale column
 * @method     ChildSpyProductSearch[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductSearch objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearch> findByFkProduct(int $fk_product) Return ChildSpyProductSearch objects filtered by the fk_product column
 * @method     ChildSpyProductSearch[]|ObjectCollection findByIsSearchable(boolean $is_searchable) Return ChildSpyProductSearch objects filtered by the is_searchable column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSearch> findByIsSearchable(boolean $is_searchable) Return ChildSpyProductSearch objects filtered by the is_searchable column
...
abstract class SpyProductSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductSearchTableMap::COL_ID_PRODUCT_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductSearchTableMap::COL_ID_PRODUCT_SEARCH, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductSearchQuery The current query, for fluid interface
     */
