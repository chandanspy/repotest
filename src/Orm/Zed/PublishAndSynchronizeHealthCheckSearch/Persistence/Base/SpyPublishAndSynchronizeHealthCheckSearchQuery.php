 ...
 *
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> find(ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects based on current ModelCriteria
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByIdPublishAndSynchronizeHealthCheckSearch(string $id_publish_and_synchronize_health_check_search) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the id_publish_and_synchronize_health_check_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByIdPublishAndSynchronizeHealthCheckSearch(string $id_publish_and_synchronize_health_check_search) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the id_publish_and_synchronize_health_check_search column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByFkPublishAndSynchronizeHealthCheck(int $fk_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the fk_publish_and_synchronize_health_check column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByFkPublishAndSynchronizeHealthCheck(int $fk_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the fk_publish_and_synchronize_health_check column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByHealthCheckKey(string $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the health_check_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByHealthCheckKey(string $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the health_check_key column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByData(string $data) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByData(string $data) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the data column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByStore(string $store) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByStore(string $store) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the store column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByLocale(string $locale) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByLocale(string $locale) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the locale column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByAliasKeys(string $alias_keys) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the alias_keys column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByKey(string $key) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByKey(string $key) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the key column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByCreatedAt(string $created_at) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the created_at column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckSearch[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckSearch> findByUpdatedAt(string $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheckSearch objects filtered by the updated_at column
...
abstract class SpyPublishAndSynchronizeHealthCheckSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPublishAndSynchronizeHealthCheckSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_SEARCH, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckSearchTableMap::COL_CREATED_AT);
    }

} // SpyPublishAndSynchronizeHealthCheckSearchQuery
