...
class SpyCategoryNodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Category.Persistence.Map.SpyCategoryNodeTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Category\\Persistence\\SpyCategoryNode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Category.Persistence.SpyCategoryNode';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryNode', 'FkCategory', 'FkParentCategoryNode', 'IsMain', 'IsRoot', 'NodeOrder', ),
        self::TYPE_CAMELNAME     => array('idCategoryNode', 'fkCategory', 'fkParentCategoryNode', 'isMain', 'isRoot', 'nodeOrder', ),
        self::TYPE_COLNAME       => array(SpyCategoryNodeTableMap::COL_ID_CATEGORY_NODE, SpyCategoryNodeTableMap::COL_FK_CATEGORY, SpyCategoryNodeTableMap::COL_FK_PARENT_CATEGORY_NODE, SpyCategoryNodeTableMap::COL_IS_MAIN, SpyCategoryNodeTableMap::COL_IS_ROOT, SpyCategoryNodeTableMap::COL_NODE_ORDER, ),
        self::TYPE_FIELDNAME     => array('id_category_node', 'fk_category', 'fk_parent_category_node', 'is_main', 'is_root', 'node_order', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryNode' => 0, 'FkCategory' => 1, 'FkParentCategoryNode' => 2, 'IsMain' => 3, 'IsRoot' => 4, 'NodeOrder' => 5, ),
        self::TYPE_CAMELNAME     => array('idCategoryNode' => 0, 'fkCategory' => 1, 'fkParentCategoryNode' => 2, 'isMain' => 3, 'isRoot' => 4, 'nodeOrder' => 5, ),
        self::TYPE_COLNAME       => array(SpyCategoryNodeTableMap::COL_ID_CATEGORY_NODE => 0, SpyCategoryNodeTableMap::COL_FK_CATEGORY => 1, SpyCategoryNodeTableMap::COL_FK_PARENT_CATEGORY_NODE => 2, SpyCategoryNodeTableMap::COL_IS_MAIN => 3, SpyCategoryNodeTableMap::COL_IS_ROOT => 4, SpyCategoryNodeTableMap::COL_NODE_ORDER => 5, ),
        self::TYPE_FIELDNAME     => array('id_category_node' => 0, 'fk_category' => 1, 'fk_parent_category_node' => 2, 'is_main' => 3, 'is_root' => 4, 'node_order' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
