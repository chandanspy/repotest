...
class SpyCategoryTemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Category.Persistence.Map.SpyCategoryTemplateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_template';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Category\\Persistence\\SpyCategoryTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Category.Persistence.SpyCategoryTemplate';
     ...
     */
    const COL_ID_CATEGORY_TEMPLATE = 'spy_category_template.id_category_template';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_category_template.name';

    /**
     * the column name for the template_path field
     */
    const COL_TEMPLATE_PATH = 'spy_category_template.template_path';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryTemplate', 'Name', 'TemplatePath', ),
        self::TYPE_CAMELNAME     => array('idCategoryTemplate', 'name', 'templatePath', ),
        self::TYPE_COLNAME       => array(SpyCategoryTemplateTableMap::COL_ID_CATEGORY_TEMPLATE, SpyCategoryTemplateTableMap::COL_NAME, SpyCategoryTemplateTableMap::COL_TEMPLATE_PATH, ),
        self::TYPE_FIELDNAME     => array('id_category_template', 'name', 'template_path', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryTemplate' => 0, 'Name' => 1, 'TemplatePath' => 2, ),
        self::TYPE_CAMELNAME     => array('idCategoryTemplate' => 0, 'name' => 1, 'templatePath' => 2, ),
        self::TYPE_COLNAME       => array(SpyCategoryTemplateTableMap::COL_ID_CATEGORY_TEMPLATE => 0, SpyCategoryTemplateTableMap::COL_NAME => 1, SpyCategoryTemplateTableMap::COL_TEMPLATE_PATH => 2, ),
        self::TYPE_FIELDNAME     => array('id_category_template' => 0, 'name' => 1, 'template_path' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
