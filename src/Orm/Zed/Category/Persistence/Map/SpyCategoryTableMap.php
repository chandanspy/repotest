...
class SpyCategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Category.Persistence.Map.SpyCategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Category\\Persistence\\SpyCategory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Category.Persistence.SpyCategory';
     ...
     */
    const COL_FK_CATEGORY_TEMPLATE = 'spy_category.fk_category_template';

    /**
     * the column name for the category_key field
     */
    const COL_CATEGORY_KEY = 'spy_category.category_key';
     ...
     */
    const COL_IS_SEARCHABLE = 'spy_category.is_searchable';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategory', 'FkCategoryTemplate', 'CategoryKey', 'IsActive', 'IsClickable', 'IsInMenu', 'IsSearchable', ),
        self::TYPE_CAMELNAME     => array('idCategory', 'fkCategoryTemplate', 'categoryKey', 'isActive', 'isClickable', 'isInMenu', 'isSearchable', ),
        self::TYPE_COLNAME       => array(SpyCategoryTableMap::COL_ID_CATEGORY, SpyCategoryTableMap::COL_FK_CATEGORY_TEMPLATE, SpyCategoryTableMap::COL_CATEGORY_KEY, SpyCategoryTableMap::COL_IS_ACTIVE, SpyCategoryTableMap::COL_IS_CLICKABLE, SpyCategoryTableMap::COL_IS_IN_MENU, SpyCategoryTableMap::COL_IS_SEARCHABLE, ),
        self::TYPE_FIELDNAME     => array('id_category', 'fk_category_template', 'category_key', 'is_active', 'is_clickable', 'is_in_menu', 'is_searchable', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategory' => 0, 'FkCategoryTemplate' => 1, 'CategoryKey' => 2, 'IsActive' => 3, 'IsClickable' => 4, 'IsInMenu' => 5, 'IsSearchable' => 6, ),
        self::TYPE_CAMELNAME     => array('idCategory' => 0, 'fkCategoryTemplate' => 1, 'categoryKey' => 2, 'isActive' => 3, 'isClickable' => 4, 'isInMenu' => 5, 'isSearchable' => 6, ),
        self::TYPE_COLNAME       => array(SpyCategoryTableMap::COL_ID_CATEGORY => 0, SpyCategoryTableMap::COL_FK_CATEGORY_TEMPLATE => 1, SpyCategoryTableMap::COL_CATEGORY_KEY => 2, SpyCategoryTableMap::COL_IS_ACTIVE => 3, SpyCategoryTableMap::COL_IS_CLICKABLE => 4, SpyCategoryTableMap::COL_IS_IN_MENU => 5, SpyCategoryTableMap::COL_IS_SEARCHABLE => 6, ),
        self::TYPE_FIELDNAME     => array('id_category' => 0, 'fk_category_template' => 1, 'category_key' => 2, 'is_active' => 3, 'is_clickable' => 4, 'is_in_menu' => 5, 'is_searchable' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
