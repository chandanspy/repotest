...
class SpyCategoryStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Category.Persistence.Map.SpyCategoryStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Category\\Persistence\\SpyCategoryStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Category.Persistence.SpyCategoryStore';
     ...
     */
    const COL_ID_CATEGORY_STORE = 'spy_category_store.id_category_store';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_category_store.fk_category';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_category_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryStore', 'FkCategory', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idCategoryStore', 'fkCategory', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyCategoryStoreTableMap::COL_ID_CATEGORY_STORE, SpyCategoryStoreTableMap::COL_FK_CATEGORY, SpyCategoryStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_category_store', 'fk_category', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryStore' => 0, 'FkCategory' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idCategoryStore' => 0, 'fkCategory' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyCategoryStoreTableMap::COL_ID_CATEGORY_STORE => 0, SpyCategoryStoreTableMap::COL_FK_CATEGORY => 1, SpyCategoryStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_category_store' => 0, 'fk_category' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
