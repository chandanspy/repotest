...
class SpyCategoryClosureTableTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Category.Persistence.Map.SpyCategoryClosureTableTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_closure_table';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Category\\Persistence\\SpyCategoryClosureTable';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Category.Persistence.SpyCategoryClosureTable';
     ...
     */
    const COL_ID_CATEGORY_CLOSURE_TABLE = 'spy_category_closure_table.id_category_closure_table';

    /**
     * the column name for the fk_category_node field
     */
    const COL_FK_CATEGORY_NODE = 'spy_category_closure_table.fk_category_node';

    /**
     * the column name for the fk_category_node_descendant field
     */
    const COL_FK_CATEGORY_NODE_DESCENDANT = 'spy_category_closure_table.fk_category_node_descendant';

    /**
     * the column name for the depth field
     */
    const COL_DEPTH = 'spy_category_closure_table.depth';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryClosureTable', 'FkCategoryNode', 'FkCategoryNodeDescendant', 'Depth', ),
        self::TYPE_CAMELNAME     => array('idCategoryClosureTable', 'fkCategoryNode', 'fkCategoryNodeDescendant', 'depth', ),
        self::TYPE_COLNAME       => array(SpyCategoryClosureTableTableMap::COL_ID_CATEGORY_CLOSURE_TABLE, SpyCategoryClosureTableTableMap::COL_FK_CATEGORY_NODE, SpyCategoryClosureTableTableMap::COL_FK_CATEGORY_NODE_DESCENDANT, SpyCategoryClosureTableTableMap::COL_DEPTH, ),
        self::TYPE_FIELDNAME     => array('id_category_closure_table', 'fk_category_node', 'fk_category_node_descendant', 'depth', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryClosureTable' => 0, 'FkCategoryNode' => 1, 'FkCategoryNodeDescendant' => 2, 'Depth' => 3, ),
        self::TYPE_CAMELNAME     => array('idCategoryClosureTable' => 0, 'fkCategoryNode' => 1, 'fkCategoryNodeDescendant' => 2, 'depth' => 3, ),
        self::TYPE_COLNAME       => array(SpyCategoryClosureTableTableMap::COL_ID_CATEGORY_CLOSURE_TABLE => 0, SpyCategoryClosureTableTableMap::COL_FK_CATEGORY_NODE => 1, SpyCategoryClosureTableTableMap::COL_FK_CATEGORY_NODE_DESCENDANT => 2, SpyCategoryClosureTableTableMap::COL_DEPTH => 3, ),
        self::TYPE_FIELDNAME     => array('id_category_closure_table' => 0, 'fk_category_node' => 1, 'fk_category_node_descendant' => 2, 'depth' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyCategoryClosureTableTableMap
