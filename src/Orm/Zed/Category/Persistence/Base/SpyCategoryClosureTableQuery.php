 ...
 *
 * @method     \Orm\Zed\Category\Persistence\SpyCategoryNodeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryClosureTable> find(ConnectionInterface $con = null) Return ChildSpyCategoryClosureTable objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryClosureTable> findByIdCategoryClosureTable(int $id_category_closure_table) Return ChildSpyCategoryClosureTable objects filtered by the id_category_closure_table column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryClosureTable> findByFkCategoryNode(int $fk_category_node) Return ChildSpyCategoryClosureTable objects filtered by the fk_category_node column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryClosureTable> findByFkCategoryNodeDescendant(int $fk_category_node_descendant) Return ChildSpyCategoryClosureTable objects filtered by the fk_category_node_descendant column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryClosureTable> findByDepth(int $depth) Return ChildSpyCategoryClosureTable objects filtered by the depth column
...
abstract class SpyCategoryClosureTableQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('DescendantNode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('DescendantNode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
