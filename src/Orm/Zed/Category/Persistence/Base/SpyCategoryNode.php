...
abstract class SpyCategoryNode implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Category\\Persistence\\Map\\SpyCategoryNodeTableMap';
     ...
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryNode The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryNode
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryNode The current object, for fluid interface
     */
