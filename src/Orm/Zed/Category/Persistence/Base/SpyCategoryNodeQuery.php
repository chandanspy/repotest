 ...
 *
 * @method     \Orm\Zed\Category\Persistence\SpyCategoryNodeQuery|\Orm\Zed\Category\Persistence\SpyCategoryQuery|\Orm\Zed\Category\Persistence\SpyCategoryClosureTableQuery|\Orm\Zed\Url\Persistence\SpyUrlQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> find(ConnectionInterface $con = null) Return ChildSpyCategoryNode objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByIdCategoryNode(int $id_category_node) Return ChildSpyCategoryNode objects filtered by the id_category_node column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByFkCategory(int $fk_category) Return ChildSpyCategoryNode objects filtered by the fk_category column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByFkParentCategoryNode(int $fk_parent_category_node) Return ChildSpyCategoryNode objects filtered by the fk_parent_category_node column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByIsMain(boolean $is_main) Return ChildSpyCategoryNode objects filtered by the is_main column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByIsRoot(boolean $is_root) Return ChildSpyCategoryNode objects filtered by the is_root column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNode> findByNodeOrder(int $node_order) Return ChildSpyCategoryNode objects filtered by the node_order column
...
abstract class SpyCategoryNodeQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('ParentCategoryNode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ParentCategoryNode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->useExistsQuery('ClosureTable', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ClosureTable', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\Category\Persistence\SpyCategoryClosureTable object
     *
    ...
    {
        return $this->useExistsQuery('Descendant', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Descendant', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
