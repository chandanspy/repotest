 ...
 *
 * @method     ChildSpyCategoryStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCategoryStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryStore> find(ConnectionInterface $con = null) Return ChildSpyCategoryStore objects based on current ModelCriteria
 * @method     ChildSpyCategoryStore[]|ObjectCollection findByIdCategoryStore(int $id_category_store) Return ChildSpyCategoryStore objects filtered by the id_category_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryStore> findByIdCategoryStore(int $id_category_store) Return ChildSpyCategoryStore objects filtered by the id_category_store column
 * @method     ChildSpyCategoryStore[]|ObjectCollection findByFkCategory(int $fk_category) Return ChildSpyCategoryStore objects filtered by the fk_category column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryStore> findByFkCategory(int $fk_category) Return ChildSpyCategoryStore objects filtered by the fk_category column
 * @method     ChildSpyCategoryStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyCategoryStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryStore> findByFkStore(int $fk_store) Return ChildSpyCategoryStore objects filtered by the fk_store column
...
abstract class SpyCategoryStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCategoryStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCategoryStoreTableMap::COL_ID_CATEGORY_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCategoryStoreTableMap::COL_ID_CATEGORY_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCategoryStoreQuery The current query, for fluid interface
     */
