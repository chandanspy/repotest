 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> find(ConnectionInterface $con = null) Return ChildSpyCategoryAttribute objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByIdCategoryAttribute(int $id_category_attribute) Return ChildSpyCategoryAttribute objects filtered by the id_category_attribute column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByFkCategory(int $fk_category) Return ChildSpyCategoryAttribute objects filtered by the fk_category column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByFkLocale(int $fk_locale) Return ChildSpyCategoryAttribute objects filtered by the fk_locale column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByCategoryImageName(string $category_image_name) Return ChildSpyCategoryAttribute objects filtered by the category_image_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByMetaDescription(string $meta_description) Return ChildSpyCategoryAttribute objects filtered by the meta_description column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByMetaKeywords(string $meta_keywords) Return ChildSpyCategoryAttribute objects filtered by the meta_keywords column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByMetaTitle(string $meta_title) Return ChildSpyCategoryAttribute objects filtered by the meta_title column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByName(string $name) Return ChildSpyCategoryAttribute objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByCreatedAt(string $created_at) Return ChildSpyCategoryAttribute objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryAttribute> findByUpdatedAt(string $updated_at) Return ChildSpyCategoryAttribute objects filtered by the updated_at column
