...
abstract class SpyCategoryAttribute implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Category\\Persistence\\Map\\SpyCategoryAttributeTableMap';
     ...
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryAttribute The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryAttribute
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Category\Persistence\SpyCategoryAttribute The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyCategoryAttribute The current object (for fluent API support)
     */
