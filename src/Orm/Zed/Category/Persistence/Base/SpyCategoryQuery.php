 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> find(ConnectionInterface $con = null) Return ChildSpyCategory objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByIdCategory(int $id_category) Return ChildSpyCategory objects filtered by the id_category column
 * @method     ChildSpyCategory[]|ObjectCollection findByFkCategoryTemplate(int $fk_category_template) Return ChildSpyCategory objects filtered by the fk_category_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByFkCategoryTemplate(int $fk_category_template) Return ChildSpyCategory objects filtered by the fk_category_template column
 * @method     ChildSpyCategory[]|ObjectCollection findByCategoryKey(string $category_key) Return ChildSpyCategory objects filtered by the category_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByCategoryKey(string $category_key) Return ChildSpyCategory objects filtered by the category_key column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByIsActive(boolean $is_active) Return ChildSpyCategory objects filtered by the is_active column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByIsClickable(boolean $is_clickable) Return ChildSpyCategory objects filtered by the is_clickable column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByIsInMenu(boolean $is_in_menu) Return ChildSpyCategory objects filtered by the is_in_menu column
 * @method     ChildSpyCategory[]|ObjectCollection findByIsSearchable(boolean $is_searchable) Return ChildSpyCategory objects filtered by the is_searchable column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategory> findByIsSearchable(boolean $is_searchable) Return ChildSpyCategory objects filtered by the is_searchable column
...
abstract class SpyCategoryQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('Attribute', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Attribute', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->useExistsQuery('Node', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('Node', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return $this|ChildSpyCategoryQuery The current query, for fluid interface
     */
    public function joinSpyCmsBlockCategoryConnector($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return ChildSpyCategoryQuery The current query, for fluid interface
     */
    public function filterBySpyProductCategoryFilter($spyProductCategoryFilter, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCategoryQuery The current query, for fluid interface
     */
    public function joinSpyProductCategoryFilter($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductCategoryFilter', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductCategoryFilter', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
