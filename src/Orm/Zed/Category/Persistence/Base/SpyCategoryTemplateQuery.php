 ...
 *
 * @method     ChildSpyCategoryTemplate[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCategoryTemplate objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryTemplate> find(ConnectionInterface $con = null) Return ChildSpyCategoryTemplate objects based on current ModelCriteria
 * @method     ChildSpyCategoryTemplate[]|ObjectCollection findByIdCategoryTemplate(int $id_category_template) Return ChildSpyCategoryTemplate objects filtered by the id_category_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryTemplate> findByIdCategoryTemplate(int $id_category_template) Return ChildSpyCategoryTemplate objects filtered by the id_category_template column
 * @method     ChildSpyCategoryTemplate[]|ObjectCollection findByName(string $name) Return ChildSpyCategoryTemplate objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryTemplate> findByName(string $name) Return ChildSpyCategoryTemplate objects filtered by the name column
 * @method     ChildSpyCategoryTemplate[]|ObjectCollection findByTemplatePath(string $template_path) Return ChildSpyCategoryTemplate objects filtered by the template_path column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryTemplate> findByTemplatePath(string $template_path) Return ChildSpyCategoryTemplate objects filtered by the template_path column
...
abstract class SpyCategoryTemplateQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCategoryTemplateQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCategoryTemplateTableMap::COL_ID_CATEGORY_TEMPLATE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCategoryTemplateTableMap::COL_ID_CATEGORY_TEMPLATE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCategoryTemplateQuery The current query, for fluid interface
     */
