 ...
 *
 * @method     ChildSpyProductReview[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductReview objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> find(ConnectionInterface $con = null) Return ChildSpyProductReview objects based on current ModelCriteria
 * @method     ChildSpyProductReview[]|ObjectCollection findByIdProductReview(int $id_product_review) Return ChildSpyProductReview objects filtered by the id_product_review column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByIdProductReview(int $id_product_review) Return ChildSpyProductReview objects filtered by the id_product_review column
 * @method     ChildSpyProductReview[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductReview objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByFkLocale(int $fk_locale) Return ChildSpyProductReview objects filtered by the fk_locale column
 * @method     ChildSpyProductReview[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductReview objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductReview objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductReview[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpyProductReview objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByCustomerReference(string $customer_reference) Return ChildSpyProductReview objects filtered by the customer_reference column
 * @method     ChildSpyProductReview[]|ObjectCollection findByDescription(string $description) Return ChildSpyProductReview objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByDescription(string $description) Return ChildSpyProductReview objects filtered by the description column
 * @method     ChildSpyProductReview[]|ObjectCollection findByNickname(string $nickname) Return ChildSpyProductReview objects filtered by the nickname column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByNickname(string $nickname) Return ChildSpyProductReview objects filtered by the nickname column
 * @method     ChildSpyProductReview[]|ObjectCollection findByRating(int $rating) Return ChildSpyProductReview objects filtered by the rating column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByRating(int $rating) Return ChildSpyProductReview objects filtered by the rating column
 * @method     ChildSpyProductReview[]|ObjectCollection findByStatus(int $status) Return ChildSpyProductReview objects filtered by the status column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByStatus(int $status) Return ChildSpyProductReview objects filtered by the status column
 * @method     ChildSpyProductReview[]|ObjectCollection findBySummary(string $summary) Return ChildSpyProductReview objects filtered by the summary column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findBySummary(string $summary) Return ChildSpyProductReview objects filtered by the summary column
 * @method     ChildSpyProductReview[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductReview objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByCreatedAt(string $created_at) Return ChildSpyProductReview objects filtered by the created_at column
 * @method     ChildSpyProductReview[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductReview objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductReview> findByUpdatedAt(string $updated_at) Return ChildSpyProductReview objects filtered by the updated_at column
...
abstract class SpyProductReviewQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductReviewQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductReviewTableMap::COL_ID_PRODUCT_REVIEW, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductReviewTableMap::COL_ID_PRODUCT_REVIEW, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductReviewQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductReviewTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductReviewTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductReviewTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductReviewTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductReviewTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductReviewTableMap::COL_CREATED_AT);
    }

} // SpyProductReviewQuery
