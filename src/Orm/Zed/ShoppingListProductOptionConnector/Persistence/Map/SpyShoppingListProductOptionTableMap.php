...
class SpyShoppingListProductOptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingListProductOptionConnector.Persistence.Map.SpyShoppingListProductOptionTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_product_option';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingListProductOptionConnector\\Persistence\\SpyShoppingListProductOption';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingListProductOptionConnector.Persistence.SpyShoppingListProductOption';
     ...
     */
    const COL_ID_SHOPPING_LIST_ITEM_PRODUCT_OPTION = 'spy_shopping_list_product_option.id_shopping_list_item_product_option';

    /**
     * the column name for the fk_product_option_value field
     */
    const COL_FK_PRODUCT_OPTION_VALUE = 'spy_shopping_list_product_option.fk_product_option_value';

    /**
     * the column name for the fk_shopping_list_item field
     */
    const COL_FK_SHOPPING_LIST_ITEM = 'spy_shopping_list_product_option.fk_shopping_list_item';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListItemProductOption', 'FkProductOptionValue', 'FkShoppingListItem', ),
        self::TYPE_CAMELNAME     => array('idShoppingListItemProductOption', 'fkProductOptionValue', 'fkShoppingListItem', ),
        self::TYPE_COLNAME       => array(SpyShoppingListProductOptionTableMap::COL_ID_SHOPPING_LIST_ITEM_PRODUCT_OPTION, SpyShoppingListProductOptionTableMap::COL_FK_PRODUCT_OPTION_VALUE, SpyShoppingListProductOptionTableMap::COL_FK_SHOPPING_LIST_ITEM, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_item_product_option', 'fk_product_option_value', 'fk_shopping_list_item', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListItemProductOption' => 0, 'FkProductOptionValue' => 1, 'FkShoppingListItem' => 2, ),
        self::TYPE_CAMELNAME     => array('idShoppingListItemProductOption' => 0, 'fkProductOptionValue' => 1, 'fkShoppingListItem' => 2, ),
        self::TYPE_COLNAME       => array(SpyShoppingListProductOptionTableMap::COL_ID_SHOPPING_LIST_ITEM_PRODUCT_OPTION => 0, SpyShoppingListProductOptionTableMap::COL_FK_PRODUCT_OPTION_VALUE => 1, SpyShoppingListProductOptionTableMap::COL_FK_SHOPPING_LIST_ITEM => 2, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_item_product_option' => 0, 'fk_product_option_value' => 1, 'fk_shopping_list_item' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyShoppingListProductOptionTableMap
