 ...
 *
 * @method     ChildSpyShoppingListProductOption[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShoppingListProductOption objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListProductOption> find(ConnectionInterface $con = null) Return ChildSpyShoppingListProductOption objects based on current ModelCriteria
 * @method     ChildSpyShoppingListProductOption[]|ObjectCollection findByIdShoppingListItemProductOption(int $id_shopping_list_item_product_option) Return ChildSpyShoppingListProductOption objects filtered by the id_shopping_list_item_product_option column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListProductOption> findByIdShoppingListItemProductOption(int $id_shopping_list_item_product_option) Return ChildSpyShoppingListProductOption objects filtered by the id_shopping_list_item_product_option column
 * @method     ChildSpyShoppingListProductOption[]|ObjectCollection findByFkProductOptionValue(int $fk_product_option_value) Return ChildSpyShoppingListProductOption objects filtered by the fk_product_option_value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListProductOption> findByFkProductOptionValue(int $fk_product_option_value) Return ChildSpyShoppingListProductOption objects filtered by the fk_product_option_value column
 * @method     ChildSpyShoppingListProductOption[]|ObjectCollection findByFkShoppingListItem(int $fk_shopping_list_item) Return ChildSpyShoppingListProductOption objects filtered by the fk_shopping_list_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListProductOption> findByFkShoppingListItem(int $fk_shopping_list_item) Return ChildSpyShoppingListProductOption objects filtered by the fk_shopping_list_item column
...
abstract class SpyShoppingListProductOptionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShoppingListProductOptionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShoppingListProductOptionTableMap::COL_ID_SHOPPING_LIST_ITEM_PRODUCT_OPTION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShoppingListProductOptionTableMap::COL_ID_SHOPPING_LIST_ITEM_PRODUCT_OPTION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyShoppingListProductOptionQuery The current query, for fluid interface
     */
...
} // SpyShoppingListProductOptionQuery
