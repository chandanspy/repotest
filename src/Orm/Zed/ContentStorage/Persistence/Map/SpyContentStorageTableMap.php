...
class SpyContentStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ContentStorage.Persistence.Map.SpyContentStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_content_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ContentStorage\\Persistence\\SpyContentStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ContentStorage.Persistence.SpyContentStorage';
     ...
     */
    const COL_ID_CONTENT_STORAGE = 'spy_content_storage.id_content_storage';

    /**
     * the column name for the fk_content field
     */
    const COL_FK_CONTENT = 'spy_content_storage.fk_content';

    /**
     * the column name for the content_key field
     */
    const COL_CONTENT_KEY = 'spy_content_storage.content_key';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_content_storage.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_content_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_content_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_content_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_content_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_content_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdContentStorage', 'FkContent', 'ContentKey', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idContentStorage', 'fkContent', 'contentKey', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyContentStorageTableMap::COL_ID_CONTENT_STORAGE, SpyContentStorageTableMap::COL_FK_CONTENT, SpyContentStorageTableMap::COL_CONTENT_KEY, SpyContentStorageTableMap::COL_DATA, SpyContentStorageTableMap::COL_LOCALE, SpyContentStorageTableMap::COL_ALIAS_KEYS, SpyContentStorageTableMap::COL_KEY, SpyContentStorageTableMap::COL_CREATED_AT, SpyContentStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_content_storage', 'fk_content', 'content_key', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdContentStorage' => 0, 'FkContent' => 1, 'ContentKey' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idContentStorage' => 0, 'fkContent' => 1, 'contentKey' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyContentStorageTableMap::COL_ID_CONTENT_STORAGE => 0, SpyContentStorageTableMap::COL_FK_CONTENT => 1, SpyContentStorageTableMap::COL_CONTENT_KEY => 2, SpyContentStorageTableMap::COL_DATA => 3, SpyContentStorageTableMap::COL_LOCALE => 4, SpyContentStorageTableMap::COL_ALIAS_KEYS => 5, SpyContentStorageTableMap::COL_KEY => 6, SpyContentStorageTableMap::COL_CREATED_AT => 7, SpyContentStorageTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_content_storage' => 0, 'fk_content' => 1, 'content_key' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
