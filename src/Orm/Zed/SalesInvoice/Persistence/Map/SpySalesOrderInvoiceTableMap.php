...
class SpySalesOrderInvoiceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesInvoice.Persistence.Map.SpySalesOrderInvoiceTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_order_invoice';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesInvoice\\Persistence\\SpySalesOrderInvoice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesInvoice.Persistence.SpySalesOrderInvoice';
     ...
     */
    const COL_ID_SALES_ORDER_INVOICE = 'spy_sales_order_invoice.id_sales_order_invoice';

    /**
     * the column name for the fk_sales_order field
     */
    const COL_FK_SALES_ORDER = 'spy_sales_order_invoice.fk_sales_order';

    /**
     * the column name for the reference field
     */
    const COL_REFERENCE = 'spy_sales_order_invoice.reference';

    /**
     * the column name for the issue_date field
     */
    const COL_ISSUE_DATE = 'spy_sales_order_invoice.issue_date';

    /**
     * the column name for the template_path field
     */
    const COL_TEMPLATE_PATH = 'spy_sales_order_invoice.template_path';

    /**
     * the column name for the email_sent field
     */
    const COL_EMAIL_SENT = 'spy_sales_order_invoice.email_sent';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_order_invoice.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_order_invoice.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderInvoice', 'FkSalesOrder', 'Reference', 'IssueDate', 'TemplatePath', 'EmailSent', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderInvoice', 'fkSalesOrder', 'reference', 'issueDate', 'templatePath', 'emailSent', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderInvoiceTableMap::COL_ID_SALES_ORDER_INVOICE, SpySalesOrderInvoiceTableMap::COL_FK_SALES_ORDER, SpySalesOrderInvoiceTableMap::COL_REFERENCE, SpySalesOrderInvoiceTableMap::COL_ISSUE_DATE, SpySalesOrderInvoiceTableMap::COL_TEMPLATE_PATH, SpySalesOrderInvoiceTableMap::COL_EMAIL_SENT, SpySalesOrderInvoiceTableMap::COL_CREATED_AT, SpySalesOrderInvoiceTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_invoice', 'fk_sales_order', 'reference', 'issue_date', 'template_path', 'email_sent', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderInvoice' => 0, 'FkSalesOrder' => 1, 'Reference' => 2, 'IssueDate' => 3, 'TemplatePath' => 4, 'EmailSent' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderInvoice' => 0, 'fkSalesOrder' => 1, 'reference' => 2, 'issueDate' => 3, 'templatePath' => 4, 'emailSent' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpySalesOrderInvoiceTableMap::COL_ID_SALES_ORDER_INVOICE => 0, SpySalesOrderInvoiceTableMap::COL_FK_SALES_ORDER => 1, SpySalesOrderInvoiceTableMap::COL_REFERENCE => 2, SpySalesOrderInvoiceTableMap::COL_ISSUE_DATE => 3, SpySalesOrderInvoiceTableMap::COL_TEMPLATE_PATH => 4, SpySalesOrderInvoiceTableMap::COL_EMAIL_SENT => 5, SpySalesOrderInvoiceTableMap::COL_CREATED_AT => 6, SpySalesOrderInvoiceTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_invoice' => 0, 'fk_sales_order' => 1, 'reference' => 2, 'issue_date' => 3, 'template_path' => 4, 'email_sent' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
