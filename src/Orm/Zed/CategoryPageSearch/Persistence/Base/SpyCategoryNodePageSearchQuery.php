 ...
 *
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCategoryNodePageSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> find(ConnectionInterface $con = null) Return ChildSpyCategoryNodePageSearch objects based on current ModelCriteria
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByIdCategoryNodePageSearch(string $id_category_node_page_search) Return ChildSpyCategoryNodePageSearch objects filtered by the id_category_node_page_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByIdCategoryNodePageSearch(string $id_category_node_page_search) Return ChildSpyCategoryNodePageSearch objects filtered by the id_category_node_page_search column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByFkCategoryNode(int $fk_category_node) Return ChildSpyCategoryNodePageSearch objects filtered by the fk_category_node column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByFkCategoryNode(int $fk_category_node) Return ChildSpyCategoryNodePageSearch objects filtered by the fk_category_node column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByStructuredData(string $structured_data) Return ChildSpyCategoryNodePageSearch objects filtered by the structured_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByStructuredData(string $structured_data) Return ChildSpyCategoryNodePageSearch objects filtered by the structured_data column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByData(string $data) Return ChildSpyCategoryNodePageSearch objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByData(string $data) Return ChildSpyCategoryNodePageSearch objects filtered by the data column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByStore(string $store) Return ChildSpyCategoryNodePageSearch objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByStore(string $store) Return ChildSpyCategoryNodePageSearch objects filtered by the store column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByLocale(string $locale) Return ChildSpyCategoryNodePageSearch objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByLocale(string $locale) Return ChildSpyCategoryNodePageSearch objects filtered by the locale column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyCategoryNodePageSearch objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByAliasKeys(string $alias_keys) Return ChildSpyCategoryNodePageSearch objects filtered by the alias_keys column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByKey(string $key) Return ChildSpyCategoryNodePageSearch objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByKey(string $key) Return ChildSpyCategoryNodePageSearch objects filtered by the key column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCategoryNodePageSearch objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByCreatedAt(string $created_at) Return ChildSpyCategoryNodePageSearch objects filtered by the created_at column
 * @method     ChildSpyCategoryNodePageSearch[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCategoryNodePageSearch objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryNodePageSearch> findByUpdatedAt(string $updated_at) Return ChildSpyCategoryNodePageSearch objects filtered by the updated_at column
...
abstract class SpyCategoryNodePageSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCategoryNodePageSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCategoryNodePageSearchTableMap::COL_ID_CATEGORY_NODE_PAGE_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCategoryNodePageSearchTableMap::COL_ID_CATEGORY_NODE_PAGE_SEARCH, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyCategoryNodePageSearchTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCategoryNodePageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCategoryNodePageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCategoryNodePageSearchTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCategoryNodePageSearchTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCategoryNodePageSearchTableMap::COL_CREATED_AT);
    }
