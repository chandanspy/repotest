 ...
 *
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPriceProductScheduleList objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> find(ConnectionInterface $con = null) Return ChildSpyPriceProductScheduleList objects based on current ModelCriteria
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByIdPriceProductScheduleList(string $id_price_product_schedule_list) Return ChildSpyPriceProductScheduleList objects filtered by the id_price_product_schedule_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByIdPriceProductScheduleList(string $id_price_product_schedule_list) Return ChildSpyPriceProductScheduleList objects filtered by the id_price_product_schedule_list column
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByName(string $name) Return ChildSpyPriceProductScheduleList objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByName(string $name) Return ChildSpyPriceProductScheduleList objects filtered by the name column
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyPriceProductScheduleList objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByIsActive(boolean $is_active) Return ChildSpyPriceProductScheduleList objects filtered by the is_active column
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByFkUser(int $fk_user) Return ChildSpyPriceProductScheduleList objects filtered by the fk_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByFkUser(int $fk_user) Return ChildSpyPriceProductScheduleList objects filtered by the fk_user column
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyPriceProductScheduleList objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByCreatedAt(string $created_at) Return ChildSpyPriceProductScheduleList objects filtered by the created_at column
 * @method     ChildSpyPriceProductScheduleList[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyPriceProductScheduleList objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductScheduleList> findByUpdatedAt(string $updated_at) Return ChildSpyPriceProductScheduleList objects filtered by the updated_at column
...
abstract class SpyPriceProductScheduleListQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPriceProductScheduleListQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPriceProductScheduleListTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE_LIST, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPriceProductScheduleListTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE_LIST, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPriceProductScheduleListQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyPriceProductScheduleListTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPriceProductScheduleListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPriceProductScheduleListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPriceProductScheduleListTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyPriceProductScheduleListTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPriceProductScheduleListTableMap::COL_CREATED_AT);
    }

} // SpyPriceProductScheduleListQuery
