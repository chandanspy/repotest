...
abstract class SpyPriceProductSchedule implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\PriceProductSchedule\\Persistence\\Map\\SpyPriceProductScheduleTableMap';
     ...
     * @return $this|\Orm\Zed\PriceProductSchedule\Persistence\SpyPriceProductSchedule The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\PriceProductSchedule\Persistence\SpyPriceProductSchedule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\PriceProductSchedule\Persistence\SpyPriceProductSchedule The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyPriceProductSchedule The current object (for fluent API support)
     */
