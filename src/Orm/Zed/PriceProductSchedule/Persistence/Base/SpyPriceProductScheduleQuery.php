 ...
 *
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPriceProductSchedule objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> find(ConnectionInterface $con = null) Return ChildSpyPriceProductSchedule objects based on current ModelCriteria
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByIdPriceProductSchedule(string $id_price_product_schedule) Return ChildSpyPriceProductSchedule objects filtered by the id_price_product_schedule column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByIdPriceProductSchedule(string $id_price_product_schedule) Return ChildSpyPriceProductSchedule objects filtered by the id_price_product_schedule column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpyPriceProductSchedule objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkCurrency(int $fk_currency) Return ChildSpyPriceProductSchedule objects filtered by the fk_currency column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyPriceProductSchedule objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkStore(int $fk_store) Return ChildSpyPriceProductSchedule objects filtered by the fk_store column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkPriceType(int $fk_price_type) Return ChildSpyPriceProductSchedule objects filtered by the fk_price_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkPriceType(int $fk_price_type) Return ChildSpyPriceProductSchedule objects filtered by the fk_price_type column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyPriceProductSchedule objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkProduct(int $fk_product) Return ChildSpyPriceProductSchedule objects filtered by the fk_product column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProductSchedule objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProductSchedule objects filtered by the fk_product_abstract column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByFkPriceProductScheduleList(string $fk_price_product_schedule_list) Return ChildSpyPriceProductSchedule objects filtered by the fk_price_product_schedule_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByFkPriceProductScheduleList(string $fk_price_product_schedule_list) Return ChildSpyPriceProductSchedule objects filtered by the fk_price_product_schedule_list column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByNetPrice(int $net_price) Return ChildSpyPriceProductSchedule objects filtered by the net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByNetPrice(int $net_price) Return ChildSpyPriceProductSchedule objects filtered by the net_price column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByGrossPrice(int $gross_price) Return ChildSpyPriceProductSchedule objects filtered by the gross_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByGrossPrice(int $gross_price) Return ChildSpyPriceProductSchedule objects filtered by the gross_price column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByPriceData(string $price_data) Return ChildSpyPriceProductSchedule objects filtered by the price_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByPriceData(string $price_data) Return ChildSpyPriceProductSchedule objects filtered by the price_data column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByActiveFrom(string $active_from) Return ChildSpyPriceProductSchedule objects filtered by the active_from column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByActiveFrom(string $active_from) Return ChildSpyPriceProductSchedule objects filtered by the active_from column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByActiveTo(string $active_to) Return ChildSpyPriceProductSchedule objects filtered by the active_to column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByActiveTo(string $active_to) Return ChildSpyPriceProductSchedule objects filtered by the active_to column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByIsCurrent(boolean $is_current) Return ChildSpyPriceProductSchedule objects filtered by the is_current column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByIsCurrent(boolean $is_current) Return ChildSpyPriceProductSchedule objects filtered by the is_current column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyPriceProductSchedule objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByCreatedAt(string $created_at) Return ChildSpyPriceProductSchedule objects filtered by the created_at column
 * @method     ChildSpyPriceProductSchedule[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyPriceProductSchedule objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductSchedule> findByUpdatedAt(string $updated_at) Return ChildSpyPriceProductSchedule objects filtered by the updated_at column
...
abstract class SpyPriceProductScheduleQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPriceProductScheduleTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPriceProductScheduleTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
    public function joinProductAbstract($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
    public function filterByCurrency($spyCurrency, $comparison = null)
    {
    ...
    {
        return $this->useExistsQuery('PriceType', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('PriceType', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
    public function filterByPriceProductScheduleList($spyPriceProductScheduleList, $comparison = null)
    {
     ...
     * @return $this|ChildSpyPriceProductScheduleQuery The current query, for fluid interface
     */
    public function joinPriceProductScheduleList($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('PriceProductScheduleList', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('PriceProductScheduleList', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyPriceProductScheduleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPriceProductScheduleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPriceProductScheduleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPriceProductScheduleTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyPriceProductScheduleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPriceProductScheduleTableMap::COL_CREATED_AT);
    }
