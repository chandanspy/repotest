...
class SpyPriceProductScheduleListTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProductSchedule.Persistence.Map.SpyPriceProductScheduleListTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_schedule_list';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProductSchedule\\Persistence\\SpyPriceProductScheduleList';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProductSchedule.Persistence.SpyPriceProductScheduleList';
     ...
     */
    const COL_ID_PRICE_PRODUCT_SCHEDULE_LIST = 'spy_price_product_schedule_list.id_price_product_schedule_list';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_price_product_schedule_list.name';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_price_product_schedule_list.is_active';

    /**
     * the column name for the fk_user field
     */
    const COL_FK_USER = 'spy_price_product_schedule_list.fk_user';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_price_product_schedule_list.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_price_product_schedule_list.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductScheduleList', 'Name', 'IsActive', 'FkUser', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPriceProductScheduleList', 'name', 'isActive', 'fkUser', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPriceProductScheduleListTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE_LIST, SpyPriceProductScheduleListTableMap::COL_NAME, SpyPriceProductScheduleListTableMap::COL_IS_ACTIVE, SpyPriceProductScheduleListTableMap::COL_FK_USER, SpyPriceProductScheduleListTableMap::COL_CREATED_AT, SpyPriceProductScheduleListTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_price_product_schedule_list', 'name', 'is_active', 'fk_user', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductScheduleList' => 0, 'Name' => 1, 'IsActive' => 2, 'FkUser' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idPriceProductScheduleList' => 0, 'name' => 1, 'isActive' => 2, 'fkUser' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyPriceProductScheduleListTableMap::COL_ID_PRICE_PRODUCT_SCHEDULE_LIST => 0, SpyPriceProductScheduleListTableMap::COL_NAME => 1, SpyPriceProductScheduleListTableMap::COL_IS_ACTIVE => 2, SpyPriceProductScheduleListTableMap::COL_FK_USER => 3, SpyPriceProductScheduleListTableMap::COL_CREATED_AT => 4, SpyPriceProductScheduleListTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_price_product_schedule_list' => 0, 'name' => 1, 'is_active' => 2, 'fk_user' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpyPriceProductScheduleListTableMap
