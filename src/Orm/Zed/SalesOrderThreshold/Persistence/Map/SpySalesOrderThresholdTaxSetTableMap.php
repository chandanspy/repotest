...
class SpySalesOrderThresholdTaxSetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesOrderThreshold.Persistence.Map.SpySalesOrderThresholdTaxSetTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_order_threshold_tax_set';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesOrderThreshold\\Persistence\\SpySalesOrderThresholdTaxSet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesOrderThreshold.Persistence.SpySalesOrderThresholdTaxSet';
     ...
     */
    const COL_ID_SALES_ORDER_THRESHOLD_TAX_SET = 'spy_sales_order_threshold_tax_set.id_sales_order_threshold_tax_set';

    /**
     * the column name for the fk_tax_set field
     */
    const COL_FK_TAX_SET = 'spy_sales_order_threshold_tax_set.fk_tax_set';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_order_threshold_tax_set.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_order_threshold_tax_set.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderThresholdTaxSet', 'FkTaxSet', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderThresholdTaxSet', 'fkTaxSet', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderThresholdTaxSetTableMap::COL_ID_SALES_ORDER_THRESHOLD_TAX_SET, SpySalesOrderThresholdTaxSetTableMap::COL_FK_TAX_SET, SpySalesOrderThresholdTaxSetTableMap::COL_CREATED_AT, SpySalesOrderThresholdTaxSetTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_threshold_tax_set', 'fk_tax_set', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderThresholdTaxSet' => 0, 'FkTaxSet' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderThresholdTaxSet' => 0, 'fkTaxSet' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        self::TYPE_COLNAME       => array(SpySalesOrderThresholdTaxSetTableMap::COL_ID_SALES_ORDER_THRESHOLD_TAX_SET => 0, SpySalesOrderThresholdTaxSetTableMap::COL_FK_TAX_SET => 1, SpySalesOrderThresholdTaxSetTableMap::COL_CREATED_AT => 2, SpySalesOrderThresholdTaxSetTableMap::COL_UPDATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_threshold_tax_set' => 0, 'fk_tax_set' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpySalesOrderThresholdTaxSetTableMap
