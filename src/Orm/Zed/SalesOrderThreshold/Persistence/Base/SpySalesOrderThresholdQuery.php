 ...
 *
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderThreshold objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> find(ConnectionInterface $con = null) Return ChildSpySalesOrderThreshold objects based on current ModelCriteria
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByIdSalesOrderThreshold(int $id_sales_order_threshold) Return ChildSpySalesOrderThreshold objects filtered by the id_sales_order_threshold column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByIdSalesOrderThreshold(int $id_sales_order_threshold) Return ChildSpySalesOrderThreshold objects filtered by the id_sales_order_threshold column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpySalesOrderThreshold objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByFkCurrency(int $fk_currency) Return ChildSpySalesOrderThreshold objects filtered by the fk_currency column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByFkSalesOrderThresholdType(int $fk_sales_order_threshold_type) Return ChildSpySalesOrderThreshold objects filtered by the fk_sales_order_threshold_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByFkSalesOrderThresholdType(int $fk_sales_order_threshold_type) Return ChildSpySalesOrderThreshold objects filtered by the fk_sales_order_threshold_type column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpySalesOrderThreshold objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByFkStore(int $fk_store) Return ChildSpySalesOrderThreshold objects filtered by the fk_store column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByFee(int $fee) Return ChildSpySalesOrderThreshold objects filtered by the fee column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByFee(int $fee) Return ChildSpySalesOrderThreshold objects filtered by the fee column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByMessageGlossaryKey(string $message_glossary_key) Return ChildSpySalesOrderThreshold objects filtered by the message_glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByMessageGlossaryKey(string $message_glossary_key) Return ChildSpySalesOrderThreshold objects filtered by the message_glossary_key column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByThreshold(int $threshold) Return ChildSpySalesOrderThreshold objects filtered by the threshold column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByThreshold(int $threshold) Return ChildSpySalesOrderThreshold objects filtered by the threshold column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderThreshold objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByCreatedAt(string $created_at) Return ChildSpySalesOrderThreshold objects filtered by the created_at column
 * @method     ChildSpySalesOrderThreshold[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThreshold objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThreshold objects filtered by the updated_at column
...
abstract class SpySalesOrderThresholdQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderThresholdQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderThresholdTableMap::COL_ID_SALES_ORDER_THRESHOLD, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderThresholdTableMap::COL_ID_SALES_ORDER_THRESHOLD, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesOrderThresholdQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTableMap::COL_CREATED_AT);
    }

} // SpySalesOrderThresholdQuery
