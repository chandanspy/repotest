 ...
 *
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderThresholdType objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> find(ConnectionInterface $con = null) Return ChildSpySalesOrderThresholdType objects based on current ModelCriteria
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection findByIdSalesOrderThresholdType(int $id_sales_order_threshold_type) Return ChildSpySalesOrderThresholdType objects filtered by the id_sales_order_threshold_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> findByIdSalesOrderThresholdType(int $id_sales_order_threshold_type) Return ChildSpySalesOrderThresholdType objects filtered by the id_sales_order_threshold_type column
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection findByKey(string $key) Return ChildSpySalesOrderThresholdType objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> findByKey(string $key) Return ChildSpySalesOrderThresholdType objects filtered by the key column
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection findByThresholdGroup(string $threshold_group) Return ChildSpySalesOrderThresholdType objects filtered by the threshold_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> findByThresholdGroup(string $threshold_group) Return ChildSpySalesOrderThresholdType objects filtered by the threshold_group column
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderThresholdType objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> findByCreatedAt(string $created_at) Return ChildSpySalesOrderThresholdType objects filtered by the created_at column
 * @method     ChildSpySalesOrderThresholdType[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThresholdType objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdType> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThresholdType objects filtered by the updated_at column
...
abstract class SpySalesOrderThresholdTypeQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderThresholdTypeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpySalesOrderThresholdTypeQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT);
    }

} // SpySalesOrderThresholdTypeQuery
