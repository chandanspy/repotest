 ...
 *
 * @method     ChildSpySalesOrderThresholdTaxSet[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderThresholdTaxSet objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdTaxSet> find(ConnectionInterface $con = null) Return ChildSpySalesOrderThresholdTaxSet objects based on current ModelCriteria
 * @method     ChildSpySalesOrderThresholdTaxSet[]|ObjectCollection findByIdSalesOrderThresholdTaxSet(int $id_sales_order_threshold_tax_set) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the id_sales_order_threshold_tax_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdTaxSet> findByIdSalesOrderThresholdTaxSet(int $id_sales_order_threshold_tax_set) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the id_sales_order_threshold_tax_set column
 * @method     ChildSpySalesOrderThresholdTaxSet[]|ObjectCollection findByFkTaxSet(int $fk_tax_set) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the fk_tax_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdTaxSet> findByFkTaxSet(int $fk_tax_set) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the fk_tax_set column
 * @method     ChildSpySalesOrderThresholdTaxSet[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdTaxSet> findByCreatedAt(string $created_at) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the created_at column
 * @method     ChildSpySalesOrderThresholdTaxSet[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderThresholdTaxSet> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderThresholdTaxSet objects filtered by the updated_at column
...
abstract class SpySalesOrderThresholdTaxSetQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderThresholdTaxSetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderThresholdTaxSetTableMap::COL_ID_SALES_ORDER_THRESHOLD_TAX_SET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderThresholdTaxSetTableMap::COL_ID_SALES_ORDER_THRESHOLD_TAX_SET, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesOrderThresholdTaxSetQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpySalesOrderThresholdTaxSetQuery The current query, for fluid interface
     */
    public function joinTaxSet($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTaxSetTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTaxSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTaxSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderThresholdTaxSetTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderThresholdTaxSetTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderThresholdTaxSetTableMap::COL_CREATED_AT);
    }

} // SpySalesOrderThresholdTaxSetQuery
