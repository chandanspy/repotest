...
/**
 * Base class that represents a row from the 'spy_sales_order_threshold_type' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.SalesOrderThreshold.Persistence.Base
 */
abstract class SpySalesOrderThresholdType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\SalesOrderThreshold\\Persistence\\Map\\SpySalesOrderThresholdTypeTableMap';
    ...
    /**
     * The value for the id_sales_order_threshold_type field.
     *
     * @var        int
     */
    protected $id_sales_order_threshold_type;
    ...
    /**
     * The value for the threshold_group field.
     *
     * @var        string
     */
    protected $threshold_group;
    ...
    /**
     * @var        ObjectCollection|ChildSpySalesOrderThreshold[] Collection to store aggregation of ChildSpySalesOrderThreshold objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> Collection to store aggregation of ChildSpySalesOrderThreshold objects.
     */
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|ChildSpySalesOrderThreshold[]
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySalesOrderThreshold>
     */
    protected $spySalesOrderThresholdsScheduledForDeletion = null;

    /**
     * Initializes internal state of Orm\Zed\SalesOrderThreshold\Persistence\Base\SpySalesOrderThresholdType object.
     */
    ...
    /**
     * Compares this with another <code>SpySalesOrderThresholdType</code> instance.  If
     * <code>obj</code> is an instance of <code>SpySalesOrderThresholdType</code>, delegates to
     * <code>equals(SpySalesOrderThresholdType)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_sales_order_threshold_type] column value.
     *
     * @return int
     */
    public function getIdSalesOrderThresholdType()
    {
        return $this->id_sales_order_threshold_type;
    }
    ...
    /**
     * Get the [threshold_group] column value.
     *
     * @return string
     */
    public function getThresholdGroup()
    {
        return $this->threshold_group;
    }
    ...
    /**
     * Set the value of [id_sales_order_threshold_type] column.
     *
     * @param int $v New value
     * @return $this|\Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType The current object (for fluent API support)
     */
    public function setIdSalesOrderThresholdType($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_sales_order_threshold_type !== $v) {
            $this->id_sales_order_threshold_type = $v;
            $this->modifiedColumns[SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE] = true;
        }

        return $this;
    } // setIdSalesOrderThresholdType()
    ...
    public function setKey($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[SpySalesOrderThresholdTypeTableMap::COL_KEY] = true;
        }
    ...
    /**
     * Set the value of [threshold_group] column.
     *
     * @param string $v New value
     * @return $this|\Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType The current object (for fluent API support)
     */
    public function setThresholdGroup($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->threshold_group !== $v) {
            $this->threshold_group = $v;
            $this->modifiedColumns[SpySalesOrderThresholdTypeTableMap::COL_THRESHOLD_GROUP] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpySalesOrderThresholdTypeTableMap::translateFieldName('IdSalesOrderThresholdType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_sales_order_threshold_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpySalesOrderThresholdTypeTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpySalesOrderThresholdTypeTableMap::translateFieldName('ThresholdGroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->threshold_group = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpySalesOrderThresholdTypeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpySalesOrderThresholdTypeTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = SpySalesOrderThresholdTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\SalesOrderThreshold\\Persistence\\SpySalesOrderThresholdType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpySalesOrderThresholdTypeTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpySalesOrderThresholdTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SpySalesOrderThresholdType::setDeleted()
     * @see SpySalesOrderThresholdType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpySalesOrderThresholdTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpySalesOrderThresholdTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_threshold_type`';
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_THRESHOLD_GROUP)) {
            $modifiedColumns[':p' . $index++]  = '`threshold_group`';
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `spy_sales_order_threshold_type` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_sales_order_threshold_type`':
                        $stmt->bindValue($identifier, $this->id_sales_order_threshold_type, PDO::PARAM_INT);
                        break;
                    case '`key`':
                        $stmt->bindValue($identifier, $this->key, PDO::PARAM_STR);
                        break;
                    case '`threshold_group`':
                        $stmt->bindValue($identifier, $this->threshold_group, PDO::PARAM_STR);
                        break;
                    case '`created_at`':
        ...
        try {
            $pk = $con->lastInsertId('id_sales_order_threshold_type_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        if ($pk !== null) {
            $this->setIdSalesOrderThresholdType($pk);
        }
    ...
    {
        $pos = SpySalesOrderThresholdTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdSalesOrderThresholdType();
                break;
            case 1:
                return $this->getKey();
                break;
            case 2:
                return $this->getThresholdGroup();
                break;
            case 3:
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SpySalesOrderThresholdType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SpySalesOrderThresholdType'][$this->hashCode()] = true;
        $keys = SpySalesOrderThresholdTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSalesOrderThresholdType(),
            $keys[1] => $this->getKey(),
            $keys[2] => $this->getThresholdGroup(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdSalesOrderThresholdType($value);
                break;
            case 1:
                $this->setKey($value);
                break;
            case 2:
                $this->setThresholdGroup($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdSalesOrderThresholdType($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setKey($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setThresholdGroup($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE)) {
            $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE, $this->id_sales_order_threshold_type);
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_KEY)) {
            $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_KEY, $this->key);
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_THRESHOLD_GROUP)) {
            $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_THRESHOLD_GROUP, $this->threshold_group);
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT)) {
            $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpySalesOrderThresholdTypeQuery::create();
        $criteria->add(SpySalesOrderThresholdTypeTableMap::COL_ID_SALES_ORDER_THRESHOLD_TYPE, $this->id_sales_order_threshold_type);
    ...
    {
        $validPk = null !== $this->getIdSalesOrderThresholdType();
    ...
    /**
     * Generic method to set the primary key (id_sales_order_threshold_type column).
     *
    ...
    {
        $this->setIdSalesOrderThresholdType($key);
    }
    ...
    {
        return null === $this->getIdSalesOrderThresholdType();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setThresholdGroup($this->getThresholdGroup());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSalesOrderThresholdType(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSpySalesOrderThresholdType is new, it will return
        ...
        if (null === $this->collSpyMerchantRelationshipSalesOrderThresholds || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyMerchantRelationshipSalesOrderThresholds = SpyMerchantRelationshipSalesOrderThresholdQuery::create(null, $criteria)
                    ->filterBySalesOrderThresholdType($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpySalesOrderThresholdType The current object (for fluent API support)
     */
    public function setSpyMerchantRelationshipSalesOrderThresholds(Collection $spyMerchantRelationshipSalesOrderThresholds, ConnectionInterface $con = null)
    {
        ...
        foreach ($spyMerchantRelationshipSalesOrderThresholdsToDelete as $spyMerchantRelationshipSalesOrderThresholdRemoved) {
            $spyMerchantRelationshipSalesOrderThresholdRemoved->setSalesOrderThresholdType(null);
        }
    ...
    protected function doAddSpyMerchantRelationshipSalesOrderThreshold(SpyMerchantRelationshipSalesOrderThreshold $spyMerchantRelationshipSalesOrderThreshold)
    {
        ...
        $spyMerchantRelationshipSalesOrderThreshold->setSalesOrderThresholdType($this);
    }
    ...
    public function removeSpyMerchantRelationshipSalesOrderThreshold(SpyMerchantRelationshipSalesOrderThreshold $spyMerchantRelationshipSalesOrderThreshold)
    {
        if ($this->getSpyMerchantRelationshipSalesOrderThresholds()->contains($spyMerchantRelationshipSalesOrderThreshold)) {
            ...
            $spyMerchantRelationshipSalesOrderThreshold->setSalesOrderThresholdType(null);
        }
     ...
     * Otherwise if this SpySalesOrderThresholdType is new, it will return
     * an empty collection; or if this SpySalesOrderThresholdType has previously
     * been saved, it will retrieve related SpyMerchantRelationshipSalesOrderThresholds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpySalesOrderThresholdType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    /**
     * Gets an array of ChildSpySalesOrderThreshold objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildSpySalesOrderThreshold[] List of ChildSpySalesOrderThreshold objects
     * @phpstan-return ObjectCollection&\Traversable<ChildSpySalesOrderThreshold> List of ChildSpySalesOrderThreshold objects
     * @throws PropelException
     */
    public function getSpySalesOrderThresholds(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpySalesOrderThresholds || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpySalesOrderThresholds = ChildSpySalesOrderThresholdQuery::create(null, $criteria)
                    ->filterBySalesOrderThresholdType($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildSpySalesOrderThreshold objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        /** @var ChildSpySalesOrderThreshold[] $spySalesOrderThresholdsToDelete */
        ...
        foreach ($spySalesOrderThresholdsToDelete as $spySalesOrderThresholdRemoved) {
            $spySalesOrderThresholdRemoved->setSalesOrderThresholdType(null);
        }
    ...
    /**
     * Returns the number of related SpySalesOrderThreshold objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related SpySalesOrderThreshold objects.
     * @throws PropelException
     */
    public function countSpySalesOrderThresholds(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpySalesOrderThresholds || null !== $criteria || $partial) {
            ...
            $query = ChildSpySalesOrderThresholdQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildSpySalesOrderThreshold object to this object
     * through the ChildSpySalesOrderThreshold foreign key attribute.
     *
     * @param  ChildSpySalesOrderThreshold $l ChildSpySalesOrderThreshold
     * @return $this|\Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdType The current object (for fluent API support)
     */
    public function addSpySalesOrderThreshold(ChildSpySalesOrderThreshold $l)
    {
        if ($this->collSpySalesOrderThresholds === null) {
            $this->initSpySalesOrderThresholds();
            $this->collSpySalesOrderThresholdsPartial = true;
    ...
    /**
     * @param ChildSpySalesOrderThreshold $spySalesOrderThreshold The ChildSpySalesOrderThreshold object to add.
     */
    protected function doAddSpySalesOrderThreshold(ChildSpySalesOrderThreshold $spySalesOrderThreshold)
    {
        $this->collSpySalesOrderThresholds[]= $spySalesOrderThreshold;
        $spySalesOrderThreshold->setSalesOrderThresholdType($this);
    }

    /**
     * @param  ChildSpySalesOrderThreshold $spySalesOrderThreshold The ChildSpySalesOrderThreshold object to remove.
     * @return $this|ChildSpySalesOrderThresholdType The current object (for fluent API support)
     */
    public function removeSpySalesOrderThreshold(ChildSpySalesOrderThreshold $spySalesOrderThreshold)
    {
        if ($this->getSpySalesOrderThresholds()->contains($spySalesOrderThreshold)) {
            ...
            $spySalesOrderThreshold->setSalesOrderThresholdType(null);
        }
    ...
    {
        $this->id_sales_order_threshold_type = null;
        $this->key = null;
        $this->threshold_group = null;
    ...
    {
        return (string) $this->exportTo(SpySalesOrderThresholdTypeTableMap::DEFAULT_STRING_FORMAT);
    }
