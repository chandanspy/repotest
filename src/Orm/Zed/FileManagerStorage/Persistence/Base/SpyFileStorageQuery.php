 ...
 *
 * @method     ChildSpyFileStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyFileStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> find(ConnectionInterface $con = null) Return ChildSpyFileStorage objects based on current ModelCriteria
 * @method     ChildSpyFileStorage[]|ObjectCollection findByIdFileStorage(int $id_file_storage) Return ChildSpyFileStorage objects filtered by the id_file_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByIdFileStorage(int $id_file_storage) Return ChildSpyFileStorage objects filtered by the id_file_storage column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByFkFile(int $fk_file) Return ChildSpyFileStorage objects filtered by the fk_file column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByFkFile(int $fk_file) Return ChildSpyFileStorage objects filtered by the fk_file column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByFileName(string $file_name) Return ChildSpyFileStorage objects filtered by the file_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByFileName(string $file_name) Return ChildSpyFileStorage objects filtered by the file_name column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByData(string $data) Return ChildSpyFileStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByData(string $data) Return ChildSpyFileStorage objects filtered by the data column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByLocale(string $locale) Return ChildSpyFileStorage objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByLocale(string $locale) Return ChildSpyFileStorage objects filtered by the locale column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyFileStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByAliasKeys(string $alias_keys) Return ChildSpyFileStorage objects filtered by the alias_keys column
 * @method     ChildSpyFileStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyFileStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileStorage> findByKey(string $key) Return ChildSpyFileStorage objects filtered by the key column
...
abstract class SpyFileStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyFileStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyFileStorageTableMap::COL_ID_FILE_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyFileStorageTableMap::COL_ID_FILE_STORAGE, $keys, Criteria::IN);
    }
