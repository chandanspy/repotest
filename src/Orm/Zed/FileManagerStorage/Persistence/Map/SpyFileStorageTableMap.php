...
class SpyFileStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.FileManagerStorage.Persistence.Map.SpyFileStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_file_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\FileManagerStorage\\Persistence\\SpyFileStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.FileManagerStorage.Persistence.SpyFileStorage';
     ...
     */
    const COL_ID_FILE_STORAGE = 'spy_file_storage.id_file_storage';

    /**
     * the column name for the fk_file field
     */
    const COL_FK_FILE = 'spy_file_storage.fk_file';

    /**
     * the column name for the file_name field
     */
    const COL_FILE_NAME = 'spy_file_storage.file_name';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_file_storage.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_file_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_file_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_file_storage.key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdFileStorage', 'FkFile', 'FileName', 'Data', 'Locale', 'AliasKeys', 'Key', ),
        self::TYPE_CAMELNAME     => array('idFileStorage', 'fkFile', 'fileName', 'data', 'locale', 'aliasKeys', 'key', ),
        self::TYPE_COLNAME       => array(SpyFileStorageTableMap::COL_ID_FILE_STORAGE, SpyFileStorageTableMap::COL_FK_FILE, SpyFileStorageTableMap::COL_FILE_NAME, SpyFileStorageTableMap::COL_DATA, SpyFileStorageTableMap::COL_LOCALE, SpyFileStorageTableMap::COL_ALIAS_KEYS, SpyFileStorageTableMap::COL_KEY, ),
        self::TYPE_FIELDNAME     => array('id_file_storage', 'fk_file', 'file_name', 'data', 'locale', 'alias_keys', 'key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdFileStorage' => 0, 'FkFile' => 1, 'FileName' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, ),
        self::TYPE_CAMELNAME     => array('idFileStorage' => 0, 'fkFile' => 1, 'fileName' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, ),
        self::TYPE_COLNAME       => array(SpyFileStorageTableMap::COL_ID_FILE_STORAGE => 0, SpyFileStorageTableMap::COL_FK_FILE => 1, SpyFileStorageTableMap::COL_FILE_NAME => 2, SpyFileStorageTableMap::COL_DATA => 3, SpyFileStorageTableMap::COL_LOCALE => 4, SpyFileStorageTableMap::COL_ALIAS_KEYS => 5, SpyFileStorageTableMap::COL_KEY => 6, ),
        self::TYPE_FIELDNAME     => array('id_file_storage' => 0, 'fk_file' => 1, 'file_name' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
