...
class SpyCmsPageStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsStorage.Persistence.Map.SpyCmsPageStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_page_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsStorage\\Persistence\\SpyCmsPageStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsStorage.Persistence.SpyCmsPageStorage';
     ...
     */
    const COL_ID_CMS_PAGE_STORAGE = 'spy_cms_page_storage.id_cms_page_storage';

    /**
     * the column name for the fk_cms_page field
     */
    const COL_FK_CMS_PAGE = 'spy_cms_page_storage.fk_cms_page';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_cms_page_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_cms_page_storage.store';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_cms_page_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_cms_page_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_cms_page_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_cms_page_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_cms_page_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsPageStorage', 'FkCmsPage', 'Data', 'Store', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCmsPageStorage', 'fkCmsPage', 'data', 'store', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCmsPageStorageTableMap::COL_ID_CMS_PAGE_STORAGE, SpyCmsPageStorageTableMap::COL_FK_CMS_PAGE, SpyCmsPageStorageTableMap::COL_DATA, SpyCmsPageStorageTableMap::COL_STORE, SpyCmsPageStorageTableMap::COL_LOCALE, SpyCmsPageStorageTableMap::COL_ALIAS_KEYS, SpyCmsPageStorageTableMap::COL_KEY, SpyCmsPageStorageTableMap::COL_CREATED_AT, SpyCmsPageStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_cms_page_storage', 'fk_cms_page', 'data', 'store', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsPageStorage' => 0, 'FkCmsPage' => 1, 'Data' => 2, 'Store' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idCmsPageStorage' => 0, 'fkCmsPage' => 1, 'data' => 2, 'store' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyCmsPageStorageTableMap::COL_ID_CMS_PAGE_STORAGE => 0, SpyCmsPageStorageTableMap::COL_FK_CMS_PAGE => 1, SpyCmsPageStorageTableMap::COL_DATA => 2, SpyCmsPageStorageTableMap::COL_STORE => 3, SpyCmsPageStorageTableMap::COL_LOCALE => 4, SpyCmsPageStorageTableMap::COL_ALIAS_KEYS => 5, SpyCmsPageStorageTableMap::COL_KEY => 6, SpyCmsPageStorageTableMap::COL_CREATED_AT => 7, SpyCmsPageStorageTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_cms_page_storage' => 0, 'fk_cms_page' => 1, 'data' => 2, 'store' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
