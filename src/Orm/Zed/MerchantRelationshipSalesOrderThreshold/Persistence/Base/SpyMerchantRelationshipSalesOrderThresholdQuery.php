 ...
 *
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> find(ConnectionInterface $con = null) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects based on current ModelCriteria
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByIdMerchantRelationshipSalesOrderThreshold(int $id_merchant_relationship_sales_order_threshold) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the id_merchant_relationship_sales_order_threshold column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByIdMerchantRelationshipSalesOrderThreshold(int $id_merchant_relationship_sales_order_threshold) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the id_merchant_relationship_sales_order_threshold column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByFkCurrency(int $fk_currency) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_currency column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_merchant_relationship column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_merchant_relationship column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByFkSalesOrderThresholdType(int $fk_sales_order_threshold_type) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_sales_order_threshold_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByFkSalesOrderThresholdType(int $fk_sales_order_threshold_type) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_sales_order_threshold_type column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByFkStore(int $fk_store) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fk_store column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByFee(int $fee) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fee column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByFee(int $fee) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the fee column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByMessageGlossaryKey(string $message_glossary_key) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the message_glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByMessageGlossaryKey(string $message_glossary_key) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the message_glossary_key column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByThreshold(int $threshold) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the threshold column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByThreshold(int $threshold) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the threshold column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByCreatedAt(string $created_at) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the created_at column
 * @method     ChildSpyMerchantRelationshipSalesOrderThreshold[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMerchantRelationshipSalesOrderThreshold> findByUpdatedAt(string $updated_at) Return ChildSpyMerchantRelationshipSalesOrderThreshold objects filtered by the updated_at column
...
abstract class SpyMerchantRelationshipSalesOrderThresholdQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyMerchantRelationshipSalesOrderThresholdQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_ID_MERCHANT_RELATIONSHIP_SALES_ORDER_THRESHOLD, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_ID_MERCHANT_RELATIONSHIP_SALES_ORDER_THRESHOLD, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyMerchantRelationshipSalesOrderThresholdQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyMerchantRelationshipSalesOrderThresholdQuery The current query, for fluid interface
     */
    public function filterBySalesOrderThresholdType($spySalesOrderThresholdType, $comparison = null)
    {
     ...
     * @return $this|ChildSpyMerchantRelationshipSalesOrderThresholdQuery The current query, for fluid interface
     */
    public function joinSalesOrderThresholdType($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SalesOrderThresholdType', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SalesOrderThresholdType', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyMerchantRelationshipSalesOrderThresholdTableMap::COL_CREATED_AT);
    }
