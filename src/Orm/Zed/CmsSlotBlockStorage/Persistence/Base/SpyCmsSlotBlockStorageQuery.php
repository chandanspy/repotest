 ...
 *
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsSlotBlockStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> find(ConnectionInterface $con = null) Return ChildSpyCmsSlotBlockStorage objects based on current ModelCriteria
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByIdCmsSlotBlockStorage(int $id_cms_slot_block_storage) Return ChildSpyCmsSlotBlockStorage objects filtered by the id_cms_slot_block_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByIdCmsSlotBlockStorage(int $id_cms_slot_block_storage) Return ChildSpyCmsSlotBlockStorage objects filtered by the id_cms_slot_block_storage column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByFkCmsSlot(int $fk_cms_slot) Return ChildSpyCmsSlotBlockStorage objects filtered by the fk_cms_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByFkCmsSlot(int $fk_cms_slot) Return ChildSpyCmsSlotBlockStorage objects filtered by the fk_cms_slot column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByFkCmsSlotTemplate(int $fk_cms_slot_template) Return ChildSpyCmsSlotBlockStorage objects filtered by the fk_cms_slot_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByFkCmsSlotTemplate(int $fk_cms_slot_template) Return ChildSpyCmsSlotBlockStorage objects filtered by the fk_cms_slot_template column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByData(string $data) Return ChildSpyCmsSlotBlockStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByData(string $data) Return ChildSpyCmsSlotBlockStorage objects filtered by the data column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyCmsSlotBlockStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByKey(string $key) Return ChildSpyCmsSlotBlockStorage objects filtered by the key column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findBySlotTemplateKey(string $slot_template_key) Return ChildSpyCmsSlotBlockStorage objects filtered by the slot_template_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findBySlotTemplateKey(string $slot_template_key) Return ChildSpyCmsSlotBlockStorage objects filtered by the slot_template_key column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyCmsSlotBlockStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByAliasKeys(string $alias_keys) Return ChildSpyCmsSlotBlockStorage objects filtered by the alias_keys column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCmsSlotBlockStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByCreatedAt(string $created_at) Return ChildSpyCmsSlotBlockStorage objects filtered by the created_at column
 * @method     ChildSpyCmsSlotBlockStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCmsSlotBlockStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlockStorage> findByUpdatedAt(string $updated_at) Return ChildSpyCmsSlotBlockStorage objects filtered by the updated_at column
...
abstract class SpyCmsSlotBlockStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsSlotBlockStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsSlotBlockStorageTableMap::COL_ID_CMS_SLOT_BLOCK_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsSlotBlockStorageTableMap::COL_ID_CMS_SLOT_BLOCK_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsSlotBlockStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsSlotBlockStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsSlotBlockStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsSlotBlockStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsSlotBlockStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsSlotBlockStorageTableMap::COL_CREATED_AT);
    }

} // SpyCmsSlotBlockStorageQuery
