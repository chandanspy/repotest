...
class SpyCmsBlockCategoryConnectorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlockCategoryConnector.Persistence.Map.SpyCmsBlockCategoryConnectorTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_category_connector';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlockCategoryConnector\\Persistence\\SpyCmsBlockCategoryConnector';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlockCategoryConnector.Persistence.SpyCmsBlockCategoryConnector';
     ...
     */
    const COL_ID_CMS_BLOCK_CATEGORY_CONNECTOR = 'spy_cms_block_category_connector.id_cms_block_category_connector';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_cms_block_category_connector.fk_category';

    /**
     * the column name for the fk_category_template field
     */
    const COL_FK_CATEGORY_TEMPLATE = 'spy_cms_block_category_connector.fk_category_template';

    /**
     * the column name for the fk_cms_block field
     */
    const COL_FK_CMS_BLOCK = 'spy_cms_block_category_connector.fk_cms_block';

    /**
     * the column name for the fk_cms_block_category_position field
     */
    const COL_FK_CMS_BLOCK_CATEGORY_POSITION = 'spy_cms_block_category_connector.fk_cms_block_category_position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockCategoryConnector', 'FkCategory', 'FkCategoryTemplate', 'FkCmsBlock', 'FkCmsBlockCategoryPosition', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockCategoryConnector', 'fkCategory', 'fkCategoryTemplate', 'fkCmsBlock', 'fkCmsBlockCategoryPosition', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockCategoryConnectorTableMap::COL_ID_CMS_BLOCK_CATEGORY_CONNECTOR, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CATEGORY, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CATEGORY_TEMPLATE, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CMS_BLOCK, SpyCmsBlockCategoryConnectorTableMap::COL_FK_CMS_BLOCK_CATEGORY_POSITION, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_category_connector', 'fk_category', 'fk_category_template', 'fk_cms_block', 'fk_cms_block_category_position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockCategoryConnector' => 0, 'FkCategory' => 1, 'FkCategoryTemplate' => 2, 'FkCmsBlock' => 3, 'FkCmsBlockCategoryPosition' => 4, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockCategoryConnector' => 0, 'fkCategory' => 1, 'fkCategoryTemplate' => 2, 'fkCmsBlock' => 3, 'fkCmsBlockCategoryPosition' => 4, ),
        ...
        self::TYPE_FIELDNAME     => array('id_cms_block_category_connector' => 0, 'fk_category' => 1, 'fk_category_template' => 2, 'fk_cms_block' => 3, 'fk_cms_block_category_position' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyCmsBlockCategoryConnectorTableMap
