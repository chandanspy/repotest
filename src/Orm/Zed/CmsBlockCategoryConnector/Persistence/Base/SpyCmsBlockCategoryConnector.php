...
abstract class SpyCmsBlockCategoryConnector implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CmsBlockCategoryConnector\\Persistence\\Map\\SpyCmsBlockCategoryConnectorTableMap';
     ...
     * @return $this|\Orm\Zed\CmsBlockCategoryConnector\Persistence\SpyCmsBlockCategoryConnector The current object (for fluent API support)
     */
    public function setIdCmsBlockCategoryConnector($v)
    {
        ...
        return $this;
    } // setIdCmsBlockCategoryConnector()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CmsBlockCategoryConnector\Persistence\SpyCmsBlockCategoryConnector
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CmsBlockCategoryConnector\Persistence\SpyCmsBlockCategoryConnector The current object, for fluid interface
     */
