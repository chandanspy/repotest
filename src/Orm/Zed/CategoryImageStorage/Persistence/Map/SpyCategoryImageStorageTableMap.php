...
class SpyCategoryImageStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CategoryImageStorage.Persistence.Map.SpyCategoryImageStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_image_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CategoryImageStorage\\Persistence\\SpyCategoryImageStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CategoryImageStorage.Persistence.SpyCategoryImageStorage';
     ...
     */
    const COL_ID_CATEGORY_IMAGE_STORAGE = 'spy_category_image_storage.id_category_image_storage';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_category_image_storage.fk_category';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_category_image_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_category_image_storage.key';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_category_image_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_category_image_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_category_image_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_category_image_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageStorage', 'FkCategory', 'Data', 'Key', 'Locale', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCategoryImageStorage', 'fkCategory', 'data', 'key', 'locale', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCategoryImageStorageTableMap::COL_ID_CATEGORY_IMAGE_STORAGE, SpyCategoryImageStorageTableMap::COL_FK_CATEGORY, SpyCategoryImageStorageTableMap::COL_DATA, SpyCategoryImageStorageTableMap::COL_KEY, SpyCategoryImageStorageTableMap::COL_LOCALE, SpyCategoryImageStorageTableMap::COL_ALIAS_KEYS, SpyCategoryImageStorageTableMap::COL_CREATED_AT, SpyCategoryImageStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_category_image_storage', 'fk_category', 'data', 'key', 'locale', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageStorage' => 0, 'FkCategory' => 1, 'Data' => 2, 'Key' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idCategoryImageStorage' => 0, 'fkCategory' => 1, 'data' => 2, 'key' => 3, 'locale' => 4, 'aliasKeys' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyCategoryImageStorageTableMap::COL_ID_CATEGORY_IMAGE_STORAGE => 0, SpyCategoryImageStorageTableMap::COL_FK_CATEGORY => 1, SpyCategoryImageStorageTableMap::COL_DATA => 2, SpyCategoryImageStorageTableMap::COL_KEY => 3, SpyCategoryImageStorageTableMap::COL_LOCALE => 4, SpyCategoryImageStorageTableMap::COL_ALIAS_KEYS => 5, SpyCategoryImageStorageTableMap::COL_CREATED_AT => 6, SpyCategoryImageStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_category_image_storage' => 0, 'fk_category' => 1, 'data' => 2, 'key' => 3, 'locale' => 4, 'alias_keys' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyCategoryImageStorageTableMap
