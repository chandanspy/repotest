 ...
 *
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyUrlRedirectStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> find(ConnectionInterface $con = null) Return ChildSpyUrlRedirectStorage objects based on current ModelCriteria
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByIdUrlRedirectStorage(string $id_url_redirect_storage) Return ChildSpyUrlRedirectStorage objects filtered by the id_url_redirect_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByIdUrlRedirectStorage(string $id_url_redirect_storage) Return ChildSpyUrlRedirectStorage objects filtered by the id_url_redirect_storage column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByFkUrlRedirect(int $fk_url_redirect) Return ChildSpyUrlRedirectStorage objects filtered by the fk_url_redirect column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByFkUrlRedirect(int $fk_url_redirect) Return ChildSpyUrlRedirectStorage objects filtered by the fk_url_redirect column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByData(string $data) Return ChildSpyUrlRedirectStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByData(string $data) Return ChildSpyUrlRedirectStorage objects filtered by the data column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyUrlRedirectStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByAliasKeys(string $alias_keys) Return ChildSpyUrlRedirectStorage objects filtered by the alias_keys column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyUrlRedirectStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByKey(string $key) Return ChildSpyUrlRedirectStorage objects filtered by the key column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyUrlRedirectStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByCreatedAt(string $created_at) Return ChildSpyUrlRedirectStorage objects filtered by the created_at column
 * @method     ChildSpyUrlRedirectStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyUrlRedirectStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrlRedirectStorage> findByUpdatedAt(string $updated_at) Return ChildSpyUrlRedirectStorage objects filtered by the updated_at column
...
abstract class SpyUrlRedirectStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyUrlRedirectStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyUrlRedirectStorageTableMap::COL_ID_URL_REDIRECT_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyUrlRedirectStorageTableMap::COL_ID_URL_REDIRECT_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyUrlRedirectStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyUrlRedirectStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyUrlRedirectStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyUrlRedirectStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyUrlRedirectStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyUrlRedirectStorageTableMap::COL_CREATED_AT);
    }

} // SpyUrlRedirectStorageQuery
