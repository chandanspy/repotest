...
class SpyUrlRedirectStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.UrlStorage.Persistence.Map.SpyUrlRedirectStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_url_redirect_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\UrlStorage\\Persistence\\SpyUrlRedirectStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.UrlStorage.Persistence.SpyUrlRedirectStorage';
     ...
     */
    const COL_ID_URL_REDIRECT_STORAGE = 'spy_url_redirect_storage.id_url_redirect_storage';

    /**
     * the column name for the fk_url_redirect field
     */
    const COL_FK_URL_REDIRECT = 'spy_url_redirect_storage.fk_url_redirect';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_url_redirect_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_url_redirect_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_url_redirect_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_url_redirect_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_url_redirect_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUrlRedirectStorage', 'FkUrlRedirect', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idUrlRedirectStorage', 'fkUrlRedirect', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyUrlRedirectStorageTableMap::COL_ID_URL_REDIRECT_STORAGE, SpyUrlRedirectStorageTableMap::COL_FK_URL_REDIRECT, SpyUrlRedirectStorageTableMap::COL_DATA, SpyUrlRedirectStorageTableMap::COL_ALIAS_KEYS, SpyUrlRedirectStorageTableMap::COL_KEY, SpyUrlRedirectStorageTableMap::COL_CREATED_AT, SpyUrlRedirectStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_url_redirect_storage', 'fk_url_redirect', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUrlRedirectStorage' => 0, 'FkUrlRedirect' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idUrlRedirectStorage' => 0, 'fkUrlRedirect' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_url_redirect_storage' => 0, 'fk_url_redirect' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
