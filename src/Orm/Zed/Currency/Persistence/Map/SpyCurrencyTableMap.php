...
class SpyCurrencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Currency.Persistence.Map.SpyCurrencyTableMap';
     ...
     */
    const TABLE_NAME = 'spy_currency';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Currency\\Persistence\\SpyCurrency';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Currency.Persistence.SpyCurrency';
     ...
     */
    const COL_ID_CURRENCY = 'spy_currency.id_currency';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_currency.name';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'spy_currency.code';

    /**
     * the column name for the symbol field
     */
    const COL_SYMBOL = 'spy_currency.symbol';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCurrency', 'Name', 'Code', 'Symbol', ),
        self::TYPE_CAMELNAME     => array('idCurrency', 'name', 'code', 'symbol', ),
        self::TYPE_COLNAME       => array(SpyCurrencyTableMap::COL_ID_CURRENCY, SpyCurrencyTableMap::COL_NAME, SpyCurrencyTableMap::COL_CODE, SpyCurrencyTableMap::COL_SYMBOL, ),
        self::TYPE_FIELDNAME     => array('id_currency', 'name', 'code', 'symbol', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCurrency' => 0, 'Name' => 1, 'Code' => 2, 'Symbol' => 3, ),
        self::TYPE_CAMELNAME     => array('idCurrency' => 0, 'name' => 1, 'code' => 2, 'symbol' => 3, ),
        self::TYPE_COLNAME       => array(SpyCurrencyTableMap::COL_ID_CURRENCY => 0, SpyCurrencyTableMap::COL_NAME => 1, SpyCurrencyTableMap::COL_CODE => 2, SpyCurrencyTableMap::COL_SYMBOL => 3, ),
        self::TYPE_FIELDNAME     => array('id_currency' => 0, 'name' => 1, 'code' => 2, 'symbol' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPackage('src.Orm.Zed.Currency.Persistence');
