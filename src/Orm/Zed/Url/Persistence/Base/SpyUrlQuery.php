 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> find(ConnectionInterface $con = null) Return ChildSpyUrl objects based on current ModelCriteria
 * @method     ChildSpyUrl[]|ObjectCollection findByIdUrl(int $id_url) Return ChildSpyUrl objects filtered by the id_url column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByIdUrl(int $id_url) Return ChildSpyUrl objects filtered by the id_url column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkLocale(int $fk_locale) Return ChildSpyUrl objects filtered by the fk_locale column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourceCategorynode(int $fk_resource_categorynode) Return ChildSpyUrl objects filtered by the fk_resource_categorynode column
 * @method     ChildSpyUrl[]|ObjectCollection findByFkResourceMerchant(int $fk_resource_merchant) Return ChildSpyUrl objects filtered by the fk_resource_merchant column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourceMerchant(int $fk_resource_merchant) Return ChildSpyUrl objects filtered by the fk_resource_merchant column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourcePage(int $fk_resource_page) Return ChildSpyUrl objects filtered by the fk_resource_page column
 * @method     ChildSpyUrl[]|ObjectCollection findByFkResourceProductAbstract(int $fk_resource_product_abstract) Return ChildSpyUrl objects filtered by the fk_resource_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourceProductAbstract(int $fk_resource_product_abstract) Return ChildSpyUrl objects filtered by the fk_resource_product_abstract column
 * @method     ChildSpyUrl[]|ObjectCollection findByFkResourceProductSet(int $fk_resource_product_set) Return ChildSpyUrl objects filtered by the fk_resource_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourceProductSet(int $fk_resource_product_set) Return ChildSpyUrl objects filtered by the fk_resource_product_set column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByFkResourceRedirect(int $fk_resource_redirect) Return ChildSpyUrl objects filtered by the fk_resource_redirect column
 * @method     ChildSpyUrl[]|ObjectCollection findByUrl(string $url) Return ChildSpyUrl objects filtered by the url column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUrl> findByUrl(string $url) Return ChildSpyUrl objects filtered by the url column
...
abstract class SpyUrlQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('SpyCategoryNode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCategoryNode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->useExistsQuery('CmsPage', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('CmsPage', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return $this|ChildSpyUrlQuery The current query, for fluid interface
     */
    public function joinSpyMerchant($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return ChildSpyUrlQuery The current query, for fluid interface
     */
    public function filterBySpyProduct($spyProductAbstract, $comparison = null)
    {
     ...
     * @return ChildSpyUrlQuery The current query, for fluid interface
     */
    public function filterBySpyUrlRedirect($spyUrlRedirect, $comparison = null)
    {
     ...
     * @return $this|ChildSpyUrlQuery The current query, for fluid interface
     */
    public function joinSpyUrlRedirect($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyUrlRedirect', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyUrlRedirect', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return $this|ChildSpyUrlQuery The current query, for fluid interface
     */
    public function joinSpyNavigationNodeLocalizedAttributes($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
