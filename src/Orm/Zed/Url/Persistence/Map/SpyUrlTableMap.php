...
class SpyUrlTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Url.Persistence.Map.SpyUrlTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Url\\Persistence\\SpyUrl';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Url.Persistence.SpyUrl';
     ...
     */
    const COL_FK_RESOURCE_MERCHANT = 'spy_url.fk_resource_merchant';
     ...
     */
    const COL_FK_RESOURCE_PRODUCT_ABSTRACT = 'spy_url.fk_resource_product_abstract';

    /**
     * the column name for the fk_resource_product_set field
     */
    const COL_FK_RESOURCE_PRODUCT_SET = 'spy_url.fk_resource_product_set';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUrl', 'FkLocale', 'FkResourceCategorynode', 'FkResourceMerchant', 'FkResourcePage', 'FkResourceProductAbstract', 'FkResourceProductSet', 'FkResourceRedirect', 'Url', ),
        self::TYPE_CAMELNAME     => array('idUrl', 'fkLocale', 'fkResourceCategorynode', 'fkResourceMerchant', 'fkResourcePage', 'fkResourceProductAbstract', 'fkResourceProductSet', 'fkResourceRedirect', 'url', ),
        self::TYPE_COLNAME       => array(SpyUrlTableMap::COL_ID_URL, SpyUrlTableMap::COL_FK_LOCALE, SpyUrlTableMap::COL_FK_RESOURCE_CATEGORYNODE, SpyUrlTableMap::COL_FK_RESOURCE_MERCHANT, SpyUrlTableMap::COL_FK_RESOURCE_PAGE, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_ABSTRACT, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_SET, SpyUrlTableMap::COL_FK_RESOURCE_REDIRECT, SpyUrlTableMap::COL_URL, ),
        self::TYPE_FIELDNAME     => array('id_url', 'fk_locale', 'fk_resource_categorynode', 'fk_resource_merchant', 'fk_resource_page', 'fk_resource_product_abstract', 'fk_resource_product_set', 'fk_resource_redirect', 'url', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUrl' => 0, 'FkLocale' => 1, 'FkResourceCategorynode' => 2, 'FkResourceMerchant' => 3, 'FkResourcePage' => 4, 'FkResourceProductAbstract' => 5, 'FkResourceProductSet' => 6, 'FkResourceRedirect' => 7, 'Url' => 8, ),
        self::TYPE_CAMELNAME     => array('idUrl' => 0, 'fkLocale' => 1, 'fkResourceCategorynode' => 2, 'fkResourceMerchant' => 3, 'fkResourcePage' => 4, 'fkResourceProductAbstract' => 5, 'fkResourceProductSet' => 6, 'fkResourceRedirect' => 7, 'url' => 8, ),
        self::TYPE_COLNAME       => array(SpyUrlTableMap::COL_ID_URL => 0, SpyUrlTableMap::COL_FK_LOCALE => 1, SpyUrlTableMap::COL_FK_RESOURCE_CATEGORYNODE => 2, SpyUrlTableMap::COL_FK_RESOURCE_MERCHANT => 3, SpyUrlTableMap::COL_FK_RESOURCE_PAGE => 4, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_ABSTRACT => 5, SpyUrlTableMap::COL_FK_RESOURCE_PRODUCT_SET => 6, SpyUrlTableMap::COL_FK_RESOURCE_REDIRECT => 7, SpyUrlTableMap::COL_URL => 8, ),
        self::TYPE_FIELDNAME     => array('id_url' => 0, 'fk_locale' => 1, 'fk_resource_categorynode' => 2, 'fk_resource_merchant' => 3, 'fk_resource_page' => 4, 'fk_resource_product_abstract' => 5, 'fk_resource_product_set' => 6, 'fk_resource_redirect' => 7, 'url' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
