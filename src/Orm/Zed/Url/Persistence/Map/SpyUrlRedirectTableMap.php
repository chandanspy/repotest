...
class SpyUrlRedirectTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Url.Persistence.Map.SpyUrlRedirectTableMap';
     ...
     */
    const TABLE_NAME = 'spy_url_redirect';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Url\\Persistence\\SpyUrlRedirect';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Url.Persistence.SpyUrlRedirect';
     ...
     */
    const COL_ID_URL_REDIRECT = 'spy_url_redirect.id_url_redirect';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'spy_url_redirect.status';

    /**
     * the column name for the to_url field
     */
    const COL_TO_URL = 'spy_url_redirect.to_url';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUrlRedirect', 'Status', 'ToUrl', ),
        self::TYPE_CAMELNAME     => array('idUrlRedirect', 'status', 'toUrl', ),
        self::TYPE_COLNAME       => array(SpyUrlRedirectTableMap::COL_ID_URL_REDIRECT, SpyUrlRedirectTableMap::COL_STATUS, SpyUrlRedirectTableMap::COL_TO_URL, ),
        self::TYPE_FIELDNAME     => array('id_url_redirect', 'status', 'to_url', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUrlRedirect' => 0, 'Status' => 1, 'ToUrl' => 2, ),
        self::TYPE_CAMELNAME     => array('idUrlRedirect' => 0, 'status' => 1, 'toUrl' => 2, ),
        self::TYPE_COLNAME       => array(SpyUrlRedirectTableMap::COL_ID_URL_REDIRECT => 0, SpyUrlRedirectTableMap::COL_STATUS => 1, SpyUrlRedirectTableMap::COL_TO_URL => 2, ),
        self::TYPE_FIELDNAME     => array('id_url_redirect' => 0, 'status' => 1, 'to_url' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
