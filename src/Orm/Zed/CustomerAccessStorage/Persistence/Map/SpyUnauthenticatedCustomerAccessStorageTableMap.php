...
class SpyUnauthenticatedCustomerAccessStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CustomerAccessStorage.Persistence.Map.SpyUnauthenticatedCustomerAccessStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_unauthenticated_customer_access_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CustomerAccessStorage\\Persistence\\SpyUnauthenticatedCustomerAccessStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CustomerAccessStorage.Persistence.SpyUnauthenticatedCustomerAccessStorage';
     ...
     */
    const COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS_STORAGE = 'spy_unauthenticated_customer_access_storage.id_unauthenticated_customer_access_storage';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_unauthenticated_customer_access_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_unauthenticated_customer_access_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_unauthenticated_customer_access_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_unauthenticated_customer_access_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_unauthenticated_customer_access_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdUnauthenticatedCustomerAccessStorage', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idUnauthenticatedCustomerAccessStorage', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS_STORAGE, SpyUnauthenticatedCustomerAccessStorageTableMap::COL_DATA, SpyUnauthenticatedCustomerAccessStorageTableMap::COL_KEY, SpyUnauthenticatedCustomerAccessStorageTableMap::COL_ALIAS_KEYS, SpyUnauthenticatedCustomerAccessStorageTableMap::COL_CREATED_AT, SpyUnauthenticatedCustomerAccessStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_unauthenticated_customer_access_storage', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdUnauthenticatedCustomerAccessStorage' => 0, 'Data' => 1, 'Key' => 2, 'AliasKeys' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idUnauthenticatedCustomerAccessStorage' => 0, 'data' => 1, 'key' => 2, 'aliasKeys' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        ...
        self::TYPE_FIELDNAME     => array('id_unauthenticated_customer_access_storage' => 0, 'data' => 1, 'key' => 2, 'alias_keys' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpyUnauthenticatedCustomerAccessStorageTableMap
