...
class SpyOmsOrderProcessTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsOrderProcessTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderProcess';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsOrderProcess';
    ...
    protected $normalizedColumnNameMap = [
        'IdOmsOrderProcess' => 'ID_OMS_ORDER_PROCESS',
        'SpyOmsOrderProcess.IdOmsOrderProcess' => 'ID_OMS_ORDER_PROCESS',
        'idOmsOrderProcess' => 'ID_OMS_ORDER_PROCESS',
        'spyOmsOrderProcess.idOmsOrderProcess' => 'ID_OMS_ORDER_PROCESS',
        'SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS' => 'ID_OMS_ORDER_PROCESS',
        'COL_ID_OMS_ORDER_PROCESS' => 'ID_OMS_ORDER_PROCESS',
        'id_oms_order_process' => 'ID_OMS_ORDER_PROCESS',
        'spy_oms_order_process.id_oms_order_process' => 'ID_OMS_ORDER_PROCESS',
        'Name' => 'NAME',
        'SpyOmsOrderProcess.Name' => 'NAME',
        'name' => 'NAME',
        'spyOmsOrderProcess.name' => 'NAME',
        'SpyOmsOrderProcessTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'spy_oms_order_process.name' => 'NAME',
        'CreatedAt' => 'CREATED_AT',
        'SpyOmsOrderProcess.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'spyOmsOrderProcess.createdAt' => 'CREATED_AT',
        'SpyOmsOrderProcessTableMap::COL_CREATED_AT' => 'CREATED_AT',
        'COL_CREATED_AT' => 'CREATED_AT',
        'created_at' => 'CREATED_AT',
        'spy_oms_order_process.created_at' => 'CREATED_AT',
        'UpdatedAt' => 'UPDATED_AT',
        'SpyOmsOrderProcess.UpdatedAt' => 'UPDATED_AT',
        'updatedAt' => 'UPDATED_AT',
        'spyOmsOrderProcess.updatedAt' => 'UPDATED_AT',
        'SpyOmsOrderProcessTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
        'COL_UPDATED_AT' => 'UPDATED_AT',
        'updated_at' => 'UPDATED_AT',
        'spy_oms_order_process.updated_at' => 'UPDATED_AT',
    ];
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderProcess');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS);
            $criteria->removeSelectColumn(SpyOmsOrderProcessTableMap::COL_NAME);
            $criteria->removeSelectColumn(SpyOmsOrderProcessTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(SpyOmsOrderProcessTableMap::COL_UPDATED_AT);
        } else {
            $criteria->removeSelectColumn($alias . '.id_oms_order_process');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Orm\Zed\Oms\Persistence\SpyOmsOrderProcess) { // it's a model object
