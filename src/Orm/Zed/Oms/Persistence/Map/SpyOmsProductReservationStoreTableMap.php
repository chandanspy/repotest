...
class SpyOmsProductReservationStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsProductReservationStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oms_product_reservation_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsProductReservationStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsProductReservationStore';
     ...
     */
    const COL_ID_OMS_PRODUCT_RESERVATION_STORE = 'spy_oms_product_reservation_store.id_oms_product_reservation_store';

    /**
     * the column name for the reservation_quantity field
     */
    const COL_RESERVATION_QUANTITY = 'spy_oms_product_reservation_store.reservation_quantity';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_oms_product_reservation_store.sku';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_oms_product_reservation_store.store';

    /**
     * the column name for the version field
     */
    const COL_VERSION = 'spy_oms_product_reservation_store.version';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_oms_product_reservation_store.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_oms_product_reservation_store.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservationStore', 'ReservationQuantity', 'Sku', 'Store', 'Version', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservationStore', 'reservationQuantity', 'sku', 'store', 'version', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyOmsProductReservationStoreTableMap::COL_ID_OMS_PRODUCT_RESERVATION_STORE, SpyOmsProductReservationStoreTableMap::COL_RESERVATION_QUANTITY, SpyOmsProductReservationStoreTableMap::COL_SKU, SpyOmsProductReservationStoreTableMap::COL_STORE, SpyOmsProductReservationStoreTableMap::COL_VERSION, SpyOmsProductReservationStoreTableMap::COL_CREATED_AT, SpyOmsProductReservationStoreTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation_store', 'reservation_quantity', 'sku', 'store', 'version', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservationStore' => 0, 'ReservationQuantity' => 1, 'Sku' => 2, 'Store' => 3, 'Version' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservationStore' => 0, 'reservationQuantity' => 1, 'sku' => 2, 'store' => 3, 'version' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation_store' => 0, 'reservation_quantity' => 1, 'sku' => 2, 'store' => 3, 'version' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyOmsProductReservationStoreTableMap
