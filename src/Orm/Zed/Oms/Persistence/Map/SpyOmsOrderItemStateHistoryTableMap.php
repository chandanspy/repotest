...
class SpyOmsOrderItemStateHistoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsOrderItemStateHistoryTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderItemStateHistory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsOrderItemStateHistory';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsOrderItemStateHistory', 'FkOmsOrderItemState', 'FkSalesOrderItem', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('idOmsOrderItemStateHistory', 'fkOmsOrderItemState', 'fkSalesOrderItem', 'createdAt', ),
        self::TYPE_COLNAME       => array(SpyOmsOrderItemStateHistoryTableMap::COL_ID_OMS_ORDER_ITEM_STATE_HISTORY, SpyOmsOrderItemStateHistoryTableMap::COL_FK_OMS_ORDER_ITEM_STATE, SpyOmsOrderItemStateHistoryTableMap::COL_FK_SALES_ORDER_ITEM, SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oms_order_item_state_history', 'fk_oms_order_item_state', 'fk_sales_order_item', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsOrderItemStateHistory' => 0, 'FkOmsOrderItemState' => 1, 'FkSalesOrderItem' => 2, 'CreatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idOmsOrderItemStateHistory' => 0, 'fkOmsOrderItemState' => 1, 'fkSalesOrderItem' => 2, 'createdAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyOmsOrderItemStateHistoryTableMap::COL_ID_OMS_ORDER_ITEM_STATE_HISTORY => 0, SpyOmsOrderItemStateHistoryTableMap::COL_FK_OMS_ORDER_ITEM_STATE => 1, SpyOmsOrderItemStateHistoryTableMap::COL_FK_SALES_ORDER_ITEM => 2, SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_oms_order_item_state_history' => 0, 'fk_oms_order_item_state' => 1, 'fk_sales_order_item' => 2, 'created_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
