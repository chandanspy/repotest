...
class SpyOmsProductReservationChangeVersionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsProductReservationChangeVersionTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oms_product_reservation_change_version';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsProductReservationChangeVersion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsProductReservationChangeVersion';
     ...
     */
    const COL_ID_OMS_PRODUCT_RESERVATION_ID = 'spy_oms_product_reservation_change_version.id_oms_product_reservation_id';

    /**
     * the column name for the version field
     */
    const COL_VERSION = 'spy_oms_product_reservation_change_version.version';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_oms_product_reservation_change_version.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_oms_product_reservation_change_version.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservationId', 'Version', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservationId', 'version', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyOmsProductReservationChangeVersionTableMap::COL_ID_OMS_PRODUCT_RESERVATION_ID, SpyOmsProductReservationChangeVersionTableMap::COL_VERSION, SpyOmsProductReservationChangeVersionTableMap::COL_CREATED_AT, SpyOmsProductReservationChangeVersionTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation_id', 'version', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservationId' => 0, 'Version' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservationId' => 0, 'version' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyOmsProductReservationChangeVersionTableMap::COL_ID_OMS_PRODUCT_RESERVATION_ID => 0, SpyOmsProductReservationChangeVersionTableMap::COL_VERSION => 1, SpyOmsProductReservationChangeVersionTableMap::COL_CREATED_AT => 2, SpyOmsProductReservationChangeVersionTableMap::COL_UPDATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation_id' => 0, 'version' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyOmsProductReservationChangeVersionTableMap
