...
class SpyOmsOrderItemStateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsOrderItemStateTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderItemState';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsOrderItemState';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsOrderItemState', 'Description', 'Name', ),
        self::TYPE_CAMELNAME     => array('idOmsOrderItemState', 'description', 'name', ),
        self::TYPE_COLNAME       => array(SpyOmsOrderItemStateTableMap::COL_ID_OMS_ORDER_ITEM_STATE, SpyOmsOrderItemStateTableMap::COL_DESCRIPTION, SpyOmsOrderItemStateTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_oms_order_item_state', 'description', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsOrderItemState' => 0, 'Description' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('idOmsOrderItemState' => 0, 'description' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(SpyOmsOrderItemStateTableMap::COL_ID_OMS_ORDER_ITEM_STATE => 0, SpyOmsOrderItemStateTableMap::COL_DESCRIPTION => 1, SpyOmsOrderItemStateTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id_oms_order_item_state' => 0, 'description' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
