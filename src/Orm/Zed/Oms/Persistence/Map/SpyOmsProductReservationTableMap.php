...
class SpyOmsProductReservationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsProductReservationTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oms_product_reservation';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsProductReservation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsProductReservation';
     ...
     */
    const COL_ID_OMS_PRODUCT_RESERVATION = 'spy_oms_product_reservation.id_oms_product_reservation';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_oms_product_reservation.fk_store';

    /**
     * the column name for the reservation_quantity field
     */
    const COL_RESERVATION_QUANTITY = 'spy_oms_product_reservation.reservation_quantity';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_oms_product_reservation.sku';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservation', 'FkStore', 'ReservationQuantity', 'Sku', ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservation', 'fkStore', 'reservationQuantity', 'sku', ),
        self::TYPE_COLNAME       => array(SpyOmsProductReservationTableMap::COL_ID_OMS_PRODUCT_RESERVATION, SpyOmsProductReservationTableMap::COL_FK_STORE, SpyOmsProductReservationTableMap::COL_RESERVATION_QUANTITY, SpyOmsProductReservationTableMap::COL_SKU, ),
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation', 'fk_store', 'reservation_quantity', 'sku', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsProductReservation' => 0, 'FkStore' => 1, 'ReservationQuantity' => 2, 'Sku' => 3, ),
        self::TYPE_CAMELNAME     => array('idOmsProductReservation' => 0, 'fkStore' => 1, 'reservationQuantity' => 2, 'sku' => 3, ),
        self::TYPE_COLNAME       => array(SpyOmsProductReservationTableMap::COL_ID_OMS_PRODUCT_RESERVATION => 0, SpyOmsProductReservationTableMap::COL_FK_STORE => 1, SpyOmsProductReservationTableMap::COL_RESERVATION_QUANTITY => 2, SpyOmsProductReservationTableMap::COL_SKU => 3, ),
        self::TYPE_FIELDNAME     => array('id_oms_product_reservation' => 0, 'fk_store' => 1, 'reservation_quantity' => 2, 'sku' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyOmsProductReservationTableMap
