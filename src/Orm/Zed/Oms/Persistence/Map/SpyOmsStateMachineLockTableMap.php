...
class SpyOmsStateMachineLockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsStateMachineLockTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oms_state_machine_lock';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsStateMachineLock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsStateMachineLock';
     ...
     */
    const COL_ID_OMS_STATE_MACHINE_LOCK = 'spy_oms_state_machine_lock.id_oms_state_machine_lock';

    /**
     * the column name for the details field
     */
    const COL_DETAILS = 'spy_oms_state_machine_lock.details';

    /**
     * the column name for the expires field
     */
    const COL_EXPIRES = 'spy_oms_state_machine_lock.expires';

    /**
     * the column name for the identifier field
     */
    const COL_IDENTIFIER = 'spy_oms_state_machine_lock.identifier';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_oms_state_machine_lock.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_oms_state_machine_lock.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsStateMachineLock', 'Details', 'Expires', 'Identifier', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idOmsStateMachineLock', 'details', 'expires', 'identifier', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyOmsStateMachineLockTableMap::COL_ID_OMS_STATE_MACHINE_LOCK, SpyOmsStateMachineLockTableMap::COL_DETAILS, SpyOmsStateMachineLockTableMap::COL_EXPIRES, SpyOmsStateMachineLockTableMap::COL_IDENTIFIER, SpyOmsStateMachineLockTableMap::COL_CREATED_AT, SpyOmsStateMachineLockTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oms_state_machine_lock', 'details', 'expires', 'identifier', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsStateMachineLock' => 0, 'Details' => 1, 'Expires' => 2, 'Identifier' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idOmsStateMachineLock' => 0, 'details' => 1, 'expires' => 2, 'identifier' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyOmsStateMachineLockTableMap::COL_ID_OMS_STATE_MACHINE_LOCK => 0, SpyOmsStateMachineLockTableMap::COL_DETAILS => 1, SpyOmsStateMachineLockTableMap::COL_EXPIRES => 2, SpyOmsStateMachineLockTableMap::COL_IDENTIFIER => 3, SpyOmsStateMachineLockTableMap::COL_CREATED_AT => 4, SpyOmsStateMachineLockTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_oms_state_machine_lock' => 0, 'details' => 1, 'expires' => 2, 'identifier' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_oms_state_machine_lock', 'IdOmsStateMachineLock', 'INTEGER', true, null, null);
...
} // SpyOmsStateMachineLockTableMap
