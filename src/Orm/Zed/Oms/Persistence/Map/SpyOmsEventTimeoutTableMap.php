...
class SpyOmsEventTimeoutTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsEventTimeoutTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsEventTimeout';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsEventTimeout';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdOmsEventTimeout', 'FkOmsOrderItemState', 'FkSalesOrderItem', 'Event', 'Timeout', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idOmsEventTimeout', 'fkOmsOrderItemState', 'fkSalesOrderItem', 'event', 'timeout', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyOmsEventTimeoutTableMap::COL_ID_OMS_EVENT_TIMEOUT, SpyOmsEventTimeoutTableMap::COL_FK_OMS_ORDER_ITEM_STATE, SpyOmsEventTimeoutTableMap::COL_FK_SALES_ORDER_ITEM, SpyOmsEventTimeoutTableMap::COL_EVENT, SpyOmsEventTimeoutTableMap::COL_TIMEOUT, SpyOmsEventTimeoutTableMap::COL_CREATED_AT, SpyOmsEventTimeoutTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_oms_event_timeout', 'fk_oms_order_item_state', 'fk_sales_order_item', 'event', 'timeout', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdOmsEventTimeout' => 0, 'FkOmsOrderItemState' => 1, 'FkSalesOrderItem' => 2, 'Event' => 3, 'Timeout' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idOmsEventTimeout' => 0, 'fkOmsOrderItemState' => 1, 'fkSalesOrderItem' => 2, 'event' => 3, 'timeout' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyOmsEventTimeoutTableMap::COL_ID_OMS_EVENT_TIMEOUT => 0, SpyOmsEventTimeoutTableMap::COL_FK_OMS_ORDER_ITEM_STATE => 1, SpyOmsEventTimeoutTableMap::COL_FK_SALES_ORDER_ITEM => 2, SpyOmsEventTimeoutTableMap::COL_EVENT => 3, SpyOmsEventTimeoutTableMap::COL_TIMEOUT => 4, SpyOmsEventTimeoutTableMap::COL_CREATED_AT => 5, SpyOmsEventTimeoutTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_oms_event_timeout' => 0, 'fk_oms_order_item_state' => 1, 'fk_sales_order_item' => 2, 'event' => 3, 'timeout' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
