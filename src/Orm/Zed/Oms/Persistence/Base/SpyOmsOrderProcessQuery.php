 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderProcess> find(ConnectionInterface $con = null) Return ChildSpyOmsOrderProcess objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderProcess> findByIdOmsOrderProcess(int $id_oms_order_process) Return ChildSpyOmsOrderProcess objects filtered by the id_oms_order_process column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderProcess> findByName(string $name) Return ChildSpyOmsOrderProcess objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderProcess> findByCreatedAt(string $created_at) Return ChildSpyOmsOrderProcess objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderProcess> findByUpdatedAt(string $updated_at) Return ChildSpyOmsOrderProcess objects filtered by the updated_at column
