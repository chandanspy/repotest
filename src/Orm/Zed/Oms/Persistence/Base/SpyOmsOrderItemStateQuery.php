 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderItemState> find(ConnectionInterface $con = null) Return ChildSpyOmsOrderItemState objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderItemState> findByIdOmsOrderItemState(int $id_oms_order_item_state) Return ChildSpyOmsOrderItemState objects filtered by the id_oms_order_item_state column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderItemState> findByDescription(string $description) Return ChildSpyOmsOrderItemState objects filtered by the description column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsOrderItemState> findByName(string $name) Return ChildSpyOmsOrderItemState objects filtered by the name column
