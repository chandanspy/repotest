 ...
 *
 * @method     ChildSpyOmsProductReservation[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOmsProductReservation objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservation> find(ConnectionInterface $con = null) Return ChildSpyOmsProductReservation objects based on current ModelCriteria
 * @method     ChildSpyOmsProductReservation[]|ObjectCollection findByIdOmsProductReservation(int $id_oms_product_reservation) Return ChildSpyOmsProductReservation objects filtered by the id_oms_product_reservation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservation> findByIdOmsProductReservation(int $id_oms_product_reservation) Return ChildSpyOmsProductReservation objects filtered by the id_oms_product_reservation column
 * @method     ChildSpyOmsProductReservation[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyOmsProductReservation objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservation> findByFkStore(int $fk_store) Return ChildSpyOmsProductReservation objects filtered by the fk_store column
 * @method     ChildSpyOmsProductReservation[]|ObjectCollection findByReservationQuantity(string $reservation_quantity) Return ChildSpyOmsProductReservation objects filtered by the reservation_quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservation> findByReservationQuantity(string $reservation_quantity) Return ChildSpyOmsProductReservation objects filtered by the reservation_quantity column
 * @method     ChildSpyOmsProductReservation[]|ObjectCollection findBySku(string $sku) Return ChildSpyOmsProductReservation objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservation> findBySku(string $sku) Return ChildSpyOmsProductReservation objects filtered by the sku column
...
abstract class SpyOmsProductReservationQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOmsProductReservationQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOmsProductReservationTableMap::COL_ID_OMS_PRODUCT_RESERVATION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOmsProductReservationTableMap::COL_ID_OMS_PRODUCT_RESERVATION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyOmsProductReservationQuery The current query, for fluid interface
     */
