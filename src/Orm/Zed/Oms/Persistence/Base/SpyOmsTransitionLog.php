...
abstract class SpyOmsTransitionLog implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Oms\\Persistence\\Map\\SpyOmsTransitionLogTableMap';
     ...
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsTransitionLog The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsTransitionLog
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsTransitionLog The current object, for fluid interface
     */
