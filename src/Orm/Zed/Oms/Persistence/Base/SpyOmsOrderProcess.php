...
/**
 * Base class that represents a row from the 'spy_oms_order_process' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.Oms.Persistence.Base
 */
abstract class SpyOmsOrderProcess implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Oms\\Persistence\\Map\\SpyOmsOrderProcessTableMap';
    ...
    /**
     * The value for the id_oms_order_process field.
     *
     * @var        int
     */
    protected $id_oms_order_process;
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> Collection to store aggregation of ChildSpyOmsTransitionLog objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyOmsTransitionLog>
     */
    ...
    /**
     * Initializes internal state of Orm\Zed\Oms\Persistence\Base\SpyOmsOrderProcess object.
     */
    ...
    /**
     * Compares this with another <code>SpyOmsOrderProcess</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyOmsOrderProcess</code>, delegates to
     * <code>equals(SpyOmsOrderProcess)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_oms_order_process] column value.
     *
     * @return int
     */
    public function getIdOmsOrderProcess()
    {
        return $this->id_oms_order_process;
    }
    ...
    /**
     * Set the value of [id_oms_order_process] column.
     *
     * @param int $v New value
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsOrderProcess The current object (for fluent API support)
     */
    public function setIdOmsOrderProcess($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_oms_order_process !== $v) {
            $this->id_oms_order_process = $v;
            $this->modifiedColumns[SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS] = true;
        }

        return $this;
    } // setIdOmsOrderProcess()
    ...
    public function setName($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SpyOmsOrderProcessTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyOmsOrderProcessTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyOmsOrderProcessTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyOmsOrderProcessTableMap::translateFieldName('IdOmsOrderProcess', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_oms_order_process = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyOmsOrderProcessTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyOmsOrderProcessTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyOmsOrderProcessTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = SpyOmsOrderProcessTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderProcess'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpyOmsOrderProcessQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SpyOmsOrderProcess::setDeleted()
     * @see SpyOmsOrderProcess::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyOmsOrderProcessQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyOmsOrderProcessTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyOmsOrderProcessTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyOmsOrderProcessTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyOmsOrderProcessTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS] = true;
        if (null !== $this->id_oms_order_process) {
        ...
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_oms_order_process`';
        }
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `spy_oms_order_process` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_oms_order_process`':
                        $stmt->bindValue($identifier, $this->id_oms_order_process, PDO::PARAM_INT);
                        break;
                    case '`name`':
        ...
        try {
            $pk = $con->lastInsertId('spy_oms_order_process_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        $this->setIdOmsOrderProcess($pk);
    ...
    {
        $pos = SpyOmsOrderProcessTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdOmsOrderProcess();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SpyOmsOrderProcess'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SpyOmsOrderProcess'][$this->hashCode()] = true;
        $keys = SpyOmsOrderProcessTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdOmsOrderProcess(),
            $keys[1] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsOrderProcess
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdOmsOrderProcess($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdOmsOrderProcess($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsOrderProcess The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS)) {
            $criteria->add(SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS, $this->id_oms_order_process);
        }
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_NAME)) {
            $criteria->add(SpyOmsOrderProcessTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyOmsOrderProcessTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyOmsOrderProcessTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyOmsOrderProcessTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyOmsOrderProcessQuery::create();
        $criteria->add(SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS, $this->id_oms_order_process);
    ...
    {
        $validPk = null !== $this->getIdOmsOrderProcess();
    ...
    /**
     * Generic method to set the primary key (id_oms_order_process column).
     *
    ...
    {
        return null === $this->getIdOmsOrderProcess();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\Oms\Persistence\SpyOmsOrderProcess (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdOmsOrderProcess(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\Oms\Persistence\SpyOmsOrderProcess Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSpyOmsOrderProcess is new, it will return
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> List of ChildSpyOmsTransitionLog objects
     * @throws PropelException
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyOmsOrderProcess The current object (for fluent API support)
     */
     ...
     * Otherwise if this SpyOmsOrderProcess is new, it will return
     * an empty collection; or if this SpyOmsOrderProcess has previously
     * been saved, it will retrieve related TransitionLogs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyOmsOrderProcess.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function getItems(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collItems || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collItems = SpySalesOrderItemQuery::create(null, $criteria)
                    ->filterByProcess($this)
                    ->find($con);
    ...
    {
        /** @var SpySalesOrderItem[] $itemsToDelete */
     ...
     * @return $this|\Orm\Zed\Oms\Persistence\SpyOmsOrderProcess The current object (for fluent API support)
     */
    public function addItem(SpySalesOrderItem $l)
    {
        if ($this->collItems === null) {
            $this->initItems();
            $this->collItemsPartial = true;
    ...
    /**
     * @param SpySalesOrderItem $item The SpySalesOrderItem object to add.
     */
    protected function doAddItem(SpySalesOrderItem $item)
    {
        $this->collItems[]= $item;
    ...
    /**
     * @param  SpySalesOrderItem $item The SpySalesOrderItem object to remove.
     * @return $this|ChildSpyOmsOrderProcess The current object (for fluent API support)
     */
    public function removeItem(SpySalesOrderItem $item)
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpySalesOrderItem}> List of SpySalesOrderItem objects
     */
    public function getItemsJoinOrder(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpySalesOrderItemQuery::create(null, $criteria);
        $query->joinWith('Order', $joinBehavior);
    ...
    {
        $this->id_oms_order_process = null;
        $this->name = null;
    ...
    {
        return (string) $this->exportTo(SpyOmsOrderProcessTableMap::DEFAULT_STRING_FORMAT);
    }
