 ...
 *
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOmsProductReservationStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> find(ConnectionInterface $con = null) Return ChildSpyOmsProductReservationStore objects based on current ModelCriteria
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByIdOmsProductReservationStore(int $id_oms_product_reservation_store) Return ChildSpyOmsProductReservationStore objects filtered by the id_oms_product_reservation_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByIdOmsProductReservationStore(int $id_oms_product_reservation_store) Return ChildSpyOmsProductReservationStore objects filtered by the id_oms_product_reservation_store column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByReservationQuantity(string $reservation_quantity) Return ChildSpyOmsProductReservationStore objects filtered by the reservation_quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByReservationQuantity(string $reservation_quantity) Return ChildSpyOmsProductReservationStore objects filtered by the reservation_quantity column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findBySku(string $sku) Return ChildSpyOmsProductReservationStore objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findBySku(string $sku) Return ChildSpyOmsProductReservationStore objects filtered by the sku column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByStore(string $store) Return ChildSpyOmsProductReservationStore objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByStore(string $store) Return ChildSpyOmsProductReservationStore objects filtered by the store column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByVersion(string $version) Return ChildSpyOmsProductReservationStore objects filtered by the version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByVersion(string $version) Return ChildSpyOmsProductReservationStore objects filtered by the version column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyOmsProductReservationStore objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByCreatedAt(string $created_at) Return ChildSpyOmsProductReservationStore objects filtered by the created_at column
 * @method     ChildSpyOmsProductReservationStore[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyOmsProductReservationStore objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsProductReservationStore> findByUpdatedAt(string $updated_at) Return ChildSpyOmsProductReservationStore objects filtered by the updated_at column
...
abstract class SpyOmsProductReservationStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOmsProductReservationStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOmsProductReservationStoreTableMap::COL_ID_OMS_PRODUCT_RESERVATION_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOmsProductReservationStoreTableMap::COL_ID_OMS_PRODUCT_RESERVATION_STORE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsProductReservationStoreTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsProductReservationStoreTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsProductReservationStoreTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsProductReservationStoreTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsProductReservationStoreTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsProductReservationStoreTableMap::COL_CREATED_AT);
    }

} // SpyOmsProductReservationStoreQuery
