 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> find(ConnectionInterface $con = null) Return ChildSpyOmsTransitionLog objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByIdOmsTransitionLog(int $id_oms_transition_log) Return ChildSpyOmsTransitionLog objects filtered by the id_oms_transition_log column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByFkOmsOrderProcess(int $fk_oms_order_process) Return ChildSpyOmsTransitionLog objects filtered by the fk_oms_order_process column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByFkSalesOrder(int $fk_sales_order) Return ChildSpyOmsTransitionLog objects filtered by the fk_sales_order column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpyOmsTransitionLog objects filtered by the fk_sales_order_item column
 * @method     ChildSpyOmsTransitionLog[]|ObjectCollection findByCommand(string $command) Return ChildSpyOmsTransitionLog objects filtered by the command column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByCommand(string $command) Return ChildSpyOmsTransitionLog objects filtered by the command column
 * @method     ChildSpyOmsTransitionLog[]|ObjectCollection findByCondition(string $condition) Return ChildSpyOmsTransitionLog objects filtered by the condition column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByCondition(string $condition) Return ChildSpyOmsTransitionLog objects filtered by the condition column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByErrorMessage(string $error_message) Return ChildSpyOmsTransitionLog objects filtered by the error_message column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByEvent(string $event) Return ChildSpyOmsTransitionLog objects filtered by the event column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByHostname(string $hostname) Return ChildSpyOmsTransitionLog objects filtered by the hostname column
 * @method     ChildSpyOmsTransitionLog[]|ObjectCollection findByIsError(boolean $is_error) Return ChildSpyOmsTransitionLog objects filtered by the is_error column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByIsError(boolean $is_error) Return ChildSpyOmsTransitionLog objects filtered by the is_error column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByLocked(boolean $locked) Return ChildSpyOmsTransitionLog objects filtered by the locked column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByParams(array $params) Return ChildSpyOmsTransitionLog objects filtered by the params column
 * @method     ChildSpyOmsTransitionLog[]|ObjectCollection findByPath(string $path) Return ChildSpyOmsTransitionLog objects filtered by the path column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByPath(string $path) Return ChildSpyOmsTransitionLog objects filtered by the path column
 * @method     ChildSpyOmsTransitionLog[]|ObjectCollection findByQuantity(int $quantity) Return ChildSpyOmsTransitionLog objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByQuantity(int $quantity) Return ChildSpyOmsTransitionLog objects filtered by the quantity column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findBySourceState(string $source_state) Return ChildSpyOmsTransitionLog objects filtered by the source_state column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByTargetState(string $target_state) Return ChildSpyOmsTransitionLog objects filtered by the target_state column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsTransitionLog> findByCreatedAt(string $created_at) Return ChildSpyOmsTransitionLog objects filtered by the created_at column
