 ...
 *
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOmsEventTimeout objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> find(ConnectionInterface $con = null) Return ChildSpyOmsEventTimeout objects based on current ModelCriteria
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByIdOmsEventTimeout(int $id_oms_event_timeout) Return ChildSpyOmsEventTimeout objects filtered by the id_oms_event_timeout column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByIdOmsEventTimeout(int $id_oms_event_timeout) Return ChildSpyOmsEventTimeout objects filtered by the id_oms_event_timeout column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByFkOmsOrderItemState(int $fk_oms_order_item_state) Return ChildSpyOmsEventTimeout objects filtered by the fk_oms_order_item_state column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByFkOmsOrderItemState(int $fk_oms_order_item_state) Return ChildSpyOmsEventTimeout objects filtered by the fk_oms_order_item_state column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpyOmsEventTimeout objects filtered by the fk_sales_order_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpyOmsEventTimeout objects filtered by the fk_sales_order_item column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByEvent(string $event) Return ChildSpyOmsEventTimeout objects filtered by the event column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByEvent(string $event) Return ChildSpyOmsEventTimeout objects filtered by the event column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByTimeout(string $timeout) Return ChildSpyOmsEventTimeout objects filtered by the timeout column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByTimeout(string $timeout) Return ChildSpyOmsEventTimeout objects filtered by the timeout column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyOmsEventTimeout objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByCreatedAt(string $created_at) Return ChildSpyOmsEventTimeout objects filtered by the created_at column
 * @method     ChildSpyOmsEventTimeout[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyOmsEventTimeout objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsEventTimeout> findByUpdatedAt(string $updated_at) Return ChildSpyOmsEventTimeout objects filtered by the updated_at column
...
abstract class SpyOmsEventTimeoutQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOmsEventTimeoutQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_ID_OMS_EVENT_TIMEOUT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_ID_OMS_EVENT_TIMEOUT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyOmsEventTimeoutQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsEventTimeoutTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsEventTimeoutTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsEventTimeoutTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsEventTimeoutTableMap::COL_CREATED_AT);
    }
