 ...
 *
 * @method     ChildSpyOmsStateMachineLock|null findOneByIdOmsStateMachineLock(int $id_oms_state_machine_lock) Return the first ChildSpyOmsStateMachineLock filtered by the id_oms_state_machine_lock column
 ...
 *
 * @method     ChildSpyOmsStateMachineLock requireOneByIdOmsStateMachineLock(int $id_oms_state_machine_lock) Return the first ChildSpyOmsStateMachineLock filtered by the id_oms_state_machine_lock column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyOmsStateMachineLock objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> find(ConnectionInterface $con = null) Return ChildSpyOmsStateMachineLock objects based on current ModelCriteria
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByIdOmsStateMachineLock(int $id_oms_state_machine_lock) Return ChildSpyOmsStateMachineLock objects filtered by the id_oms_state_machine_lock column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByIdOmsStateMachineLock(int $id_oms_state_machine_lock) Return ChildSpyOmsStateMachineLock objects filtered by the id_oms_state_machine_lock column
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByDetails(string $details) Return ChildSpyOmsStateMachineLock objects filtered by the details column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByDetails(string $details) Return ChildSpyOmsStateMachineLock objects filtered by the details column
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByExpires(string $expires) Return ChildSpyOmsStateMachineLock objects filtered by the expires column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByExpires(string $expires) Return ChildSpyOmsStateMachineLock objects filtered by the expires column
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByIdentifier(string $identifier) Return ChildSpyOmsStateMachineLock objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByIdentifier(string $identifier) Return ChildSpyOmsStateMachineLock objects filtered by the identifier column
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyOmsStateMachineLock objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByCreatedAt(string $created_at) Return ChildSpyOmsStateMachineLock objects filtered by the created_at column
 * @method     ChildSpyOmsStateMachineLock[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyOmsStateMachineLock objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyOmsStateMachineLock> findByUpdatedAt(string $updated_at) Return ChildSpyOmsStateMachineLock objects filtered by the updated_at column
...
abstract class SpyOmsStateMachineLockQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyOmsStateMachineLockQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyOmsStateMachineLockTableMap::COL_ID_OMS_STATE_MACHINE_LOCK, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyOmsStateMachineLockTableMap::COL_ID_OMS_STATE_MACHINE_LOCK, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsStateMachineLockTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsStateMachineLockTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsStateMachineLockTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsStateMachineLockTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsStateMachineLockTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsStateMachineLockTableMap::COL_CREATED_AT);
    }

} // SpyOmsStateMachineLockQuery
