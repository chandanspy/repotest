...
abstract class SpySalesReclamationItem implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\SalesReclamation\\Persistence\\Map\\SpySalesReclamationItemTableMap';
     ...
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamationItem The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamationItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamationItem The current object, for fluid interface
     */
