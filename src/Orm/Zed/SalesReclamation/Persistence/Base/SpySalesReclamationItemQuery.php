 ...
 *
 * @method     ChildSpySalesReclamationItem[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesReclamationItem objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReclamationItem> find(ConnectionInterface $con = null) Return ChildSpySalesReclamationItem objects based on current ModelCriteria
 * @method     ChildSpySalesReclamationItem[]|ObjectCollection findByIdSalesReclamationItem(int $id_sales_reclamation_item) Return ChildSpySalesReclamationItem objects filtered by the id_sales_reclamation_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReclamationItem> findByIdSalesReclamationItem(int $id_sales_reclamation_item) Return ChildSpySalesReclamationItem objects filtered by the id_sales_reclamation_item column
 * @method     ChildSpySalesReclamationItem[]|ObjectCollection findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesReclamationItem objects filtered by the fk_sales_order_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReclamationItem> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesReclamationItem objects filtered by the fk_sales_order_item column
 * @method     ChildSpySalesReclamationItem[]|ObjectCollection findByFkSalesReclamation(int $fk_sales_reclamation) Return ChildSpySalesReclamationItem objects filtered by the fk_sales_reclamation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReclamationItem> findByFkSalesReclamation(int $fk_sales_reclamation) Return ChildSpySalesReclamationItem objects filtered by the fk_sales_reclamation column
...
abstract class SpySalesReclamationItemQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesReclamationItemQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesReclamationItemTableMap::COL_ID_SALES_RECLAMATION_ITEM, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesReclamationItemTableMap::COL_ID_SALES_RECLAMATION_ITEM, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesReclamationItemQuery The current query, for fluid interface
     */
    public function filterBySpySalesReclamation($spySalesReclamation, $comparison = null)
    {
     ...
     * @return $this|ChildSpySalesReclamationItemQuery The current query, for fluid interface
     */
    public function joinSpySalesReclamation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpySalesReclamation', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpySalesReclamation', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
