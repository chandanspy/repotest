...
abstract class SpySalesReclamation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\SalesReclamation\\Persistence\\Map\\SpySalesReclamationTableMap';
     ...
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamation The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\SalesReclamation\Persistence\SpySalesReclamation The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpySalesReclamationItems($v = true)
    {
     ...
     * @return void
     */
    public function initSpySalesReclamationItems($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpySalesReclamation The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpySalesReclamationItems(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpySalesReclamationItemsPartial && !$this->isNew();
        if (null === $this->collSpySalesReclamationItems || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpySalesReclamationItem(ChildSpySalesReclamationItem $spySalesReclamationItem)
    {
