...
class SpySalesReclamationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesReclamation.Persistence.Map.SpySalesReclamationTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_reclamation';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesReclamation\\Persistence\\SpySalesReclamation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesReclamation.Persistence.SpySalesReclamation';
     ...
     */
    const COL_ID_SALES_RECLAMATION = 'spy_sales_reclamation.id_sales_reclamation';

    /**
     * the column name for the fk_sales_order field
     */
    const COL_FK_SALES_ORDER = 'spy_sales_reclamation.fk_sales_order';

    /**
     * the column name for the customer_email field
     */
    const COL_CUSTOMER_EMAIL = 'spy_sales_reclamation.customer_email';

    /**
     * the column name for the customer_name field
     */
    const COL_CUSTOMER_NAME = 'spy_sales_reclamation.customer_name';

    /**
     * the column name for the customer_reference field
     */
    const COL_CUSTOMER_REFERENCE = 'spy_sales_reclamation.customer_reference';

    /**
     * the column name for the is_open field
     */
    const COL_IS_OPEN = 'spy_sales_reclamation.is_open';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_reclamation.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_reclamation.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesReclamation', 'FkSalesOrder', 'CustomerEmail', 'CustomerName', 'CustomerReference', 'IsOpen', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesReclamation', 'fkSalesOrder', 'customerEmail', 'customerName', 'customerReference', 'isOpen', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesReclamationTableMap::COL_ID_SALES_RECLAMATION, SpySalesReclamationTableMap::COL_FK_SALES_ORDER, SpySalesReclamationTableMap::COL_CUSTOMER_EMAIL, SpySalesReclamationTableMap::COL_CUSTOMER_NAME, SpySalesReclamationTableMap::COL_CUSTOMER_REFERENCE, SpySalesReclamationTableMap::COL_IS_OPEN, SpySalesReclamationTableMap::COL_CREATED_AT, SpySalesReclamationTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_reclamation', 'fk_sales_order', 'customer_email', 'customer_name', 'customer_reference', 'is_open', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesReclamation' => 0, 'FkSalesOrder' => 1, 'CustomerEmail' => 2, 'CustomerName' => 3, 'CustomerReference' => 4, 'IsOpen' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idSalesReclamation' => 0, 'fkSalesOrder' => 1, 'customerEmail' => 2, 'customerName' => 3, 'customerReference' => 4, 'isOpen' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_reclamation' => 0, 'fk_sales_order' => 1, 'customer_email' => 2, 'customer_name' => 3, 'customer_reference' => 4, 'is_open' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
