...
class SpyCategoryTreeStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CategoryStorage.Persistence.Map.SpyCategoryTreeStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_tree_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CategoryStorage\\Persistence\\SpyCategoryTreeStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CategoryStorage.Persistence.SpyCategoryTreeStorage';
     ...
     */
    const COL_ID_CATEGORY_TREE_STORAGE = 'spy_category_tree_storage.id_category_tree_storage';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_category_tree_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_category_tree_storage.store';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_category_tree_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_category_tree_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_category_tree_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_category_tree_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_category_tree_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryTreeStorage', 'Data', 'Store', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCategoryTreeStorage', 'data', 'store', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCategoryTreeStorageTableMap::COL_ID_CATEGORY_TREE_STORAGE, SpyCategoryTreeStorageTableMap::COL_DATA, SpyCategoryTreeStorageTableMap::COL_STORE, SpyCategoryTreeStorageTableMap::COL_LOCALE, SpyCategoryTreeStorageTableMap::COL_ALIAS_KEYS, SpyCategoryTreeStorageTableMap::COL_KEY, SpyCategoryTreeStorageTableMap::COL_CREATED_AT, SpyCategoryTreeStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_category_tree_storage', 'data', 'store', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryTreeStorage' => 0, 'Data' => 1, 'Store' => 2, 'Locale' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idCategoryTreeStorage' => 0, 'data' => 1, 'store' => 2, 'locale' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyCategoryTreeStorageTableMap::COL_ID_CATEGORY_TREE_STORAGE => 0, SpyCategoryTreeStorageTableMap::COL_DATA => 1, SpyCategoryTreeStorageTableMap::COL_STORE => 2, SpyCategoryTreeStorageTableMap::COL_LOCALE => 3, SpyCategoryTreeStorageTableMap::COL_ALIAS_KEYS => 4, SpyCategoryTreeStorageTableMap::COL_KEY => 5, SpyCategoryTreeStorageTableMap::COL_CREATED_AT => 6, SpyCategoryTreeStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_category_tree_storage' => 0, 'data' => 1, 'store' => 2, 'locale' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
