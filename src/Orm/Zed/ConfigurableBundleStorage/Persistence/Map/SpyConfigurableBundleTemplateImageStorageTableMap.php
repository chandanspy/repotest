...
class SpyConfigurableBundleTemplateImageStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ConfigurableBundleStorage.Persistence.Map.SpyConfigurableBundleTemplateImageStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_configurable_bundle_template_image_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ConfigurableBundleStorage\\Persistence\\SpyConfigurableBundleTemplateImageStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ConfigurableBundleStorage.Persistence.SpyConfigurableBundleTemplateImageStorage';
     ...
     */
    const COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_IMAGE_STORAGE = 'spy_configurable_bundle_template_image_storage.id_configurable_bundle_template_image_storage';

    /**
     * the column name for the fk_configurable_bundle_template field
     */
    const COL_FK_CONFIGURABLE_BUNDLE_TEMPLATE = 'spy_configurable_bundle_template_image_storage.fk_configurable_bundle_template';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_configurable_bundle_template_image_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_configurable_bundle_template_image_storage.key';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_configurable_bundle_template_image_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_configurable_bundle_template_image_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_configurable_bundle_template_image_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_configurable_bundle_template_image_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplateImageStorage', 'FkConfigurableBundleTemplate', 'Data', 'Key', 'Locale', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplateImageStorage', 'fkConfigurableBundleTemplate', 'data', 'key', 'locale', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyConfigurableBundleTemplateImageStorageTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_IMAGE_STORAGE, SpyConfigurableBundleTemplateImageStorageTableMap::COL_FK_CONFIGURABLE_BUNDLE_TEMPLATE, SpyConfigurableBundleTemplateImageStorageTableMap::COL_DATA, SpyConfigurableBundleTemplateImageStorageTableMap::COL_KEY, SpyConfigurableBundleTemplateImageStorageTableMap::COL_LOCALE, SpyConfigurableBundleTemplateImageStorageTableMap::COL_ALIAS_KEYS, SpyConfigurableBundleTemplateImageStorageTableMap::COL_CREATED_AT, SpyConfigurableBundleTemplateImageStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template_image_storage', 'fk_configurable_bundle_template', 'data', 'key', 'locale', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplateImageStorage' => 0, 'FkConfigurableBundleTemplate' => 1, 'Data' => 2, 'Key' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplateImageStorage' => 0, 'fkConfigurableBundleTemplate' => 1, 'data' => 2, 'key' => 3, 'locale' => 4, 'aliasKeys' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template_image_storage' => 0, 'fk_configurable_bundle_template' => 1, 'data' => 2, 'key' => 3, 'locale' => 4, 'alias_keys' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
