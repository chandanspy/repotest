 ...
 *
 * @method     ChildSpyAsset[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyAsset objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> find(ConnectionInterface $con = null) Return ChildSpyAsset objects based on current ModelCriteria
 * @method     ChildSpyAsset[]|ObjectCollection findByIdAsset(int $id_asset) Return ChildSpyAsset objects filtered by the id_asset column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> findByIdAsset(int $id_asset) Return ChildSpyAsset objects filtered by the id_asset column
 * @method     ChildSpyAsset[]|ObjectCollection findByAssetSlot(string $asset_slot) Return ChildSpyAsset objects filtered by the asset_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> findByAssetSlot(string $asset_slot) Return ChildSpyAsset objects filtered by the asset_slot column
 * @method     ChildSpyAsset[]|ObjectCollection findByAssetUuid(string $asset_uuid) Return ChildSpyAsset objects filtered by the asset_uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> findByAssetUuid(string $asset_uuid) Return ChildSpyAsset objects filtered by the asset_uuid column
 * @method     ChildSpyAsset[]|ObjectCollection findByAssetName(string $asset_name) Return ChildSpyAsset objects filtered by the asset_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> findByAssetName(string $asset_name) Return ChildSpyAsset objects filtered by the asset_name column
 * @method     ChildSpyAsset[]|ObjectCollection findByAssetContent(string $asset_content) Return ChildSpyAsset objects filtered by the asset_content column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAsset> findByAssetContent(string $asset_content) Return ChildSpyAsset objects filtered by the asset_content column
...
abstract class SpyAssetQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_asset`, `asset_slot`, `asset_uuid`, `asset_name`, `asset_content` FROM `spy_asset` WHERE `id_asset` = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyAssetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyAssetTableMap::COL_ID_ASSET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyAssetTableMap::COL_ID_ASSET, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyAssetQuery The current query, for fluid interface
     */
