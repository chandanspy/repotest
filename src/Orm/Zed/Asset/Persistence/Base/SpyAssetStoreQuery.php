 ...
 *
 * @method     ChildSpyAssetStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyAssetStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetStore> find(ConnectionInterface $con = null) Return ChildSpyAssetStore objects based on current ModelCriteria
 * @method     ChildSpyAssetStore[]|ObjectCollection findByIdAssetStore(int $id_asset_store) Return ChildSpyAssetStore objects filtered by the id_asset_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetStore> findByIdAssetStore(int $id_asset_store) Return ChildSpyAssetStore objects filtered by the id_asset_store column
 * @method     ChildSpyAssetStore[]|ObjectCollection findByFkAsset(int $fk_asset) Return ChildSpyAssetStore objects filtered by the fk_asset column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetStore> findByFkAsset(int $fk_asset) Return ChildSpyAssetStore objects filtered by the fk_asset column
 * @method     ChildSpyAssetStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyAssetStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAssetStore> findByFkStore(int $fk_store) Return ChildSpyAssetStore objects filtered by the fk_store column
...
abstract class SpyAssetStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyAssetStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyAssetStoreTableMap::COL_ID_ASSET_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyAssetStoreTableMap::COL_ID_ASSET_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyAssetStoreQuery The current query, for fluid interface
     */
    public function filterBySpyAsset($spyAsset, $comparison = null)
    {
     ...
     * @return $this|ChildSpyAssetStoreQuery The current query, for fluid interface
     */
    public function joinSpyAsset($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyAsset', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyAsset', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
