...
class SpyAssetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Asset.Persistence.Map.SpyAssetTableMap';
     ...
     */
    const TABLE_NAME = 'spy_asset';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Asset\\Persistence\\SpyAsset';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Asset.Persistence.SpyAsset';
     ...
     */
    const COL_ID_ASSET = 'spy_asset.id_asset';

    /**
     * the column name for the asset_slot field
     */
    const COL_ASSET_SLOT = 'spy_asset.asset_slot';

    /**
     * the column name for the asset_uuid field
     */
    const COL_ASSET_UUID = 'spy_asset.asset_uuid';

    /**
     * the column name for the asset_name field
     */
    const COL_ASSET_NAME = 'spy_asset.asset_name';

    /**
     * the column name for the asset_content field
     */
    const COL_ASSET_CONTENT = 'spy_asset.asset_content';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAsset', 'AssetSlot', 'AssetUuid', 'AssetName', 'AssetContent', ),
        self::TYPE_CAMELNAME     => array('idAsset', 'assetSlot', 'assetUuid', 'assetName', 'assetContent', ),
        self::TYPE_COLNAME       => array(SpyAssetTableMap::COL_ID_ASSET, SpyAssetTableMap::COL_ASSET_SLOT, SpyAssetTableMap::COL_ASSET_UUID, SpyAssetTableMap::COL_ASSET_NAME, SpyAssetTableMap::COL_ASSET_CONTENT, ),
        self::TYPE_FIELDNAME     => array('id_asset', 'asset_slot', 'asset_uuid', 'asset_name', 'asset_content', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAsset' => 0, 'AssetSlot' => 1, 'AssetUuid' => 2, 'AssetName' => 3, 'AssetContent' => 4, ),
        self::TYPE_CAMELNAME     => array('idAsset' => 0, 'assetSlot' => 1, 'assetUuid' => 2, 'assetName' => 3, 'assetContent' => 4, ),
        self::TYPE_COLNAME       => array(SpyAssetTableMap::COL_ID_ASSET => 0, SpyAssetTableMap::COL_ASSET_SLOT => 1, SpyAssetTableMap::COL_ASSET_UUID => 2, SpyAssetTableMap::COL_ASSET_NAME => 3, SpyAssetTableMap::COL_ASSET_CONTENT => 4, ),
        self::TYPE_FIELDNAME     => array('id_asset' => 0, 'asset_slot' => 1, 'asset_uuid' => 2, 'asset_name' => 3, 'asset_content' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
