...
class SpyCmsBlockGlossaryKeyMappingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlock.Persistence.Map.SpyCmsBlockGlossaryKeyMappingTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_glossary_key_mapping';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlock\\Persistence\\SpyCmsBlockGlossaryKeyMapping';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlock.Persistence.SpyCmsBlockGlossaryKeyMapping';
     ...
     */
    const COL_ID_CMS_BLOCK_GLOSSARY_KEY_MAPPING = 'spy_cms_block_glossary_key_mapping.id_cms_block_glossary_key_mapping';

    /**
     * the column name for the fk_cms_block field
     */
    const COL_FK_CMS_BLOCK = 'spy_cms_block_glossary_key_mapping.fk_cms_block';

    /**
     * the column name for the fk_glossary_key field
     */
    const COL_FK_GLOSSARY_KEY = 'spy_cms_block_glossary_key_mapping.fk_glossary_key';

    /**
     * the column name for the placeholder field
     */
    const COL_PLACEHOLDER = 'spy_cms_block_glossary_key_mapping.placeholder';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockGlossaryKeyMapping', 'FkCmsBlock', 'FkGlossaryKey', 'Placeholder', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockGlossaryKeyMapping', 'fkCmsBlock', 'fkGlossaryKey', 'placeholder', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockGlossaryKeyMappingTableMap::COL_ID_CMS_BLOCK_GLOSSARY_KEY_MAPPING, SpyCmsBlockGlossaryKeyMappingTableMap::COL_FK_CMS_BLOCK, SpyCmsBlockGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY, SpyCmsBlockGlossaryKeyMappingTableMap::COL_PLACEHOLDER, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_glossary_key_mapping', 'fk_cms_block', 'fk_glossary_key', 'placeholder', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockGlossaryKeyMapping' => 0, 'FkCmsBlock' => 1, 'FkGlossaryKey' => 2, 'Placeholder' => 3, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockGlossaryKeyMapping' => 0, 'fkCmsBlock' => 1, 'fkGlossaryKey' => 2, 'placeholder' => 3, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockGlossaryKeyMappingTableMap::COL_ID_CMS_BLOCK_GLOSSARY_KEY_MAPPING => 0, SpyCmsBlockGlossaryKeyMappingTableMap::COL_FK_CMS_BLOCK => 1, SpyCmsBlockGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY => 2, SpyCmsBlockGlossaryKeyMappingTableMap::COL_PLACEHOLDER => 3, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_glossary_key_mapping' => 0, 'fk_cms_block' => 1, 'fk_glossary_key' => 2, 'placeholder' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyCmsBlockGlossaryKeyMappingTableMap
