...
class SpyCmsBlockStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlock.Persistence.Map.SpyCmsBlockStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlock\\Persistence\\SpyCmsBlockStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlock.Persistence.SpyCmsBlockStore';
     ...
     */
    const COL_ID_CMS_BLOCK_STORE = 'spy_cms_block_store.id_cms_block_store';

    /**
     * the column name for the fk_cms_block field
     */
    const COL_FK_CMS_BLOCK = 'spy_cms_block_store.fk_cms_block';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_cms_block_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockStore', 'FkCmsBlock', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockStore', 'fkCmsBlock', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockStoreTableMap::COL_ID_CMS_BLOCK_STORE, SpyCmsBlockStoreTableMap::COL_FK_CMS_BLOCK, SpyCmsBlockStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_store', 'fk_cms_block', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockStore' => 0, 'FkCmsBlock' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockStore' => 0, 'fkCmsBlock' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockStoreTableMap::COL_ID_CMS_BLOCK_STORE => 0, SpyCmsBlockStoreTableMap::COL_FK_CMS_BLOCK => 1, SpyCmsBlockStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_store' => 0, 'fk_cms_block' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
