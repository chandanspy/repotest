...
class SpyCmsBlockTemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlock.Persistence.Map.SpyCmsBlockTemplateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_template';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlock\\Persistence\\SpyCmsBlockTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlock.Persistence.SpyCmsBlockTemplate';
     ...
     */
    const COL_ID_CMS_BLOCK_TEMPLATE = 'spy_cms_block_template.id_cms_block_template';

    /**
     * the column name for the template_name field
     */
    const COL_TEMPLATE_NAME = 'spy_cms_block_template.template_name';

    /**
     * the column name for the template_path field
     */
    const COL_TEMPLATE_PATH = 'spy_cms_block_template.template_path';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockTemplate', 'TemplateName', 'TemplatePath', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockTemplate', 'templateName', 'templatePath', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTemplateTableMap::COL_ID_CMS_BLOCK_TEMPLATE, SpyCmsBlockTemplateTableMap::COL_TEMPLATE_NAME, SpyCmsBlockTemplateTableMap::COL_TEMPLATE_PATH, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_template', 'template_name', 'template_path', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockTemplate' => 0, 'TemplateName' => 1, 'TemplatePath' => 2, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockTemplate' => 0, 'templateName' => 1, 'templatePath' => 2, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTemplateTableMap::COL_ID_CMS_BLOCK_TEMPLATE => 0, SpyCmsBlockTemplateTableMap::COL_TEMPLATE_NAME => 1, SpyCmsBlockTemplateTableMap::COL_TEMPLATE_PATH => 2, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_template' => 0, 'template_name' => 1, 'template_path' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
