...
class SpyCmsBlockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlock.Persistence.Map.SpyCmsBlockTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlock\\Persistence\\SpyCmsBlock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlock.Persistence.SpyCmsBlock';
     ...
     */
    const COL_ID_CMS_BLOCK = 'spy_cms_block.id_cms_block';

    /**
     * the column name for the fk_template field
     */
    const COL_FK_TEMPLATE = 'spy_cms_block.fk_template';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_cms_block.is_active';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_cms_block.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_cms_block.name';

    /**
     * the column name for the valid_from field
     */
    const COL_VALID_FROM = 'spy_cms_block.valid_from';

    /**
     * the column name for the valid_to field
     */
    const COL_VALID_TO = 'spy_cms_block.valid_to';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlock', 'FkTemplate', 'IsActive', 'Key', 'Name', 'ValidFrom', 'ValidTo', ),
        self::TYPE_CAMELNAME     => array('idCmsBlock', 'fkTemplate', 'isActive', 'key', 'name', 'validFrom', 'validTo', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTableMap::COL_ID_CMS_BLOCK, SpyCmsBlockTableMap::COL_FK_TEMPLATE, SpyCmsBlockTableMap::COL_IS_ACTIVE, SpyCmsBlockTableMap::COL_KEY, SpyCmsBlockTableMap::COL_NAME, SpyCmsBlockTableMap::COL_VALID_FROM, SpyCmsBlockTableMap::COL_VALID_TO, ),
        self::TYPE_FIELDNAME     => array('id_cms_block', 'fk_template', 'is_active', 'key', 'name', 'valid_from', 'valid_to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlock' => 0, 'FkTemplate' => 1, 'IsActive' => 2, 'Key' => 3, 'Name' => 4, 'ValidFrom' => 5, 'ValidTo' => 6, ),
        self::TYPE_CAMELNAME     => array('idCmsBlock' => 0, 'fkTemplate' => 1, 'isActive' => 2, 'key' => 3, 'name' => 4, 'validFrom' => 5, 'validTo' => 6, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTableMap::COL_ID_CMS_BLOCK => 0, SpyCmsBlockTableMap::COL_FK_TEMPLATE => 1, SpyCmsBlockTableMap::COL_IS_ACTIVE => 2, SpyCmsBlockTableMap::COL_KEY => 3, SpyCmsBlockTableMap::COL_NAME => 4, SpyCmsBlockTableMap::COL_VALID_FROM => 5, SpyCmsBlockTableMap::COL_VALID_TO => 6, ),
        self::TYPE_FIELDNAME     => array('id_cms_block' => 0, 'fk_template' => 1, 'is_active' => 2, 'key' => 3, 'name' => 4, 'valid_from' => 5, 'valid_to' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
