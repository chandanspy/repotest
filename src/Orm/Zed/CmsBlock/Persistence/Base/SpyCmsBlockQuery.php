 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> find(ConnectionInterface $con = null) Return ChildSpyCmsBlock objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByIdCmsBlock(int $id_cms_block) Return ChildSpyCmsBlock objects filtered by the id_cms_block column
 * @method     ChildSpyCmsBlock[]|ObjectCollection findByFkTemplate(int $fk_template) Return ChildSpyCmsBlock objects filtered by the fk_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByFkTemplate(int $fk_template) Return ChildSpyCmsBlock objects filtered by the fk_template column
 * @method     ChildSpyCmsBlock[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyCmsBlock objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByIsActive(boolean $is_active) Return ChildSpyCmsBlock objects filtered by the is_active column
 * @method     ChildSpyCmsBlock[]|ObjectCollection findByKey(string $key) Return ChildSpyCmsBlock objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByKey(string $key) Return ChildSpyCmsBlock objects filtered by the key column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByName(string $name) Return ChildSpyCmsBlock objects filtered by the name column
 * @method     ChildSpyCmsBlock[]|ObjectCollection findByValidFrom(string $valid_from) Return ChildSpyCmsBlock objects filtered by the valid_from column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByValidFrom(string $valid_from) Return ChildSpyCmsBlock objects filtered by the valid_from column
 * @method     ChildSpyCmsBlock[]|ObjectCollection findByValidTo(string $valid_to) Return ChildSpyCmsBlock objects filtered by the valid_to column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlock> findByValidTo(string $valid_to) Return ChildSpyCmsBlock objects filtered by the valid_to column
...
abstract class SpyCmsBlockQuery extends ModelCriteria
{
     ...
     */
    public function filterByCmsBlockTemplate($spyCmsBlockTemplate, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsBlockQuery The current query, for fluid interface
     */
    public function joinCmsBlockTemplate($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('CmsBlockTemplate', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('CmsBlockTemplate', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCmsBlockQuery The current query, for fluid interface
     */
    public function filterBySpyCmsBlockGlossaryKeyMapping($spyCmsBlockGlossaryKeyMapping, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsBlockQuery The current query, for fluid interface
     */
    public function joinSpyCmsBlockGlossaryKeyMapping($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCmsBlockGlossaryKeyMapping', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCmsBlockGlossaryKeyMapping', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCmsBlockQuery The current query, for fluid interface
     */
    public function filterBySpyCmsSlotBlock($spyCmsSlotBlock, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsBlockQuery The current query, for fluid interface
     */
    public function joinSpyCmsSlotBlock($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCmsSlotBlock', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCmsSlotBlock', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
