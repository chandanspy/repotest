 ...
 *
 * @method     ChildSpyCmsBlockTemplate[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsBlockTemplate objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockTemplate> find(ConnectionInterface $con = null) Return ChildSpyCmsBlockTemplate objects based on current ModelCriteria
 * @method     ChildSpyCmsBlockTemplate[]|ObjectCollection findByIdCmsBlockTemplate(int $id_cms_block_template) Return ChildSpyCmsBlockTemplate objects filtered by the id_cms_block_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockTemplate> findByIdCmsBlockTemplate(int $id_cms_block_template) Return ChildSpyCmsBlockTemplate objects filtered by the id_cms_block_template column
 * @method     ChildSpyCmsBlockTemplate[]|ObjectCollection findByTemplateName(string $template_name) Return ChildSpyCmsBlockTemplate objects filtered by the template_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockTemplate> findByTemplateName(string $template_name) Return ChildSpyCmsBlockTemplate objects filtered by the template_name column
 * @method     ChildSpyCmsBlockTemplate[]|ObjectCollection findByTemplatePath(string $template_path) Return ChildSpyCmsBlockTemplate objects filtered by the template_path column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockTemplate> findByTemplatePath(string $template_path) Return ChildSpyCmsBlockTemplate objects filtered by the template_path column
...
abstract class SpyCmsBlockTemplateQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsBlockTemplateQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsBlockTemplateTableMap::COL_ID_CMS_BLOCK_TEMPLATE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsBlockTemplateTableMap::COL_ID_CMS_BLOCK_TEMPLATE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCmsBlockTemplateQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCmsBlockTemplateQuery The current query, for fluid interface
     */
    public function joinSpyCmsBlock($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyCmsBlock', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCmsBlock', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
