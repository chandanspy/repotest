 ...
 *
 * @method     ChildSpyCmsBlockStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsBlockStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockStore> find(ConnectionInterface $con = null) Return ChildSpyCmsBlockStore objects based on current ModelCriteria
 * @method     ChildSpyCmsBlockStore[]|ObjectCollection findByIdCmsBlockStore(int $id_cms_block_store) Return ChildSpyCmsBlockStore objects filtered by the id_cms_block_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockStore> findByIdCmsBlockStore(int $id_cms_block_store) Return ChildSpyCmsBlockStore objects filtered by the id_cms_block_store column
 * @method     ChildSpyCmsBlockStore[]|ObjectCollection findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsBlockStore objects filtered by the fk_cms_block column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockStore> findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsBlockStore objects filtered by the fk_cms_block column
 * @method     ChildSpyCmsBlockStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyCmsBlockStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockStore> findByFkStore(int $fk_store) Return ChildSpyCmsBlockStore objects filtered by the fk_store column
...
abstract class SpyCmsBlockStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsBlockStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsBlockStoreTableMap::COL_ID_CMS_BLOCK_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsBlockStoreTableMap::COL_ID_CMS_BLOCK_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCmsBlockStoreQuery The current query, for fluid interface
     */
