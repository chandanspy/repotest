...
abstract class SpyCmsBlockTemplate implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CmsBlock\\Persistence\\Map\\SpyCmsBlockTemplateTableMap';
     ...
     * @return $this|\Orm\Zed\CmsBlock\Persistence\SpyCmsBlockTemplate The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CmsBlock\Persistence\SpyCmsBlockTemplate
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CmsBlock\Persistence\SpyCmsBlockTemplate The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCmsBlockTemplate The current object (for fluent API support)
     */
