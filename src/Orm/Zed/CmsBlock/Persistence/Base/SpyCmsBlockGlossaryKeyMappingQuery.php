 ...
 *
 * @method     ChildSpyCmsBlockGlossaryKeyMapping[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsBlockGlossaryKeyMapping objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockGlossaryKeyMapping> find(ConnectionInterface $con = null) Return ChildSpyCmsBlockGlossaryKeyMapping objects based on current ModelCriteria
 * @method     ChildSpyCmsBlockGlossaryKeyMapping[]|ObjectCollection findByIdCmsBlockGlossaryKeyMapping(int $id_cms_block_glossary_key_mapping) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the id_cms_block_glossary_key_mapping column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockGlossaryKeyMapping> findByIdCmsBlockGlossaryKeyMapping(int $id_cms_block_glossary_key_mapping) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the id_cms_block_glossary_key_mapping column
 * @method     ChildSpyCmsBlockGlossaryKeyMapping[]|ObjectCollection findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the fk_cms_block column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockGlossaryKeyMapping> findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the fk_cms_block column
 * @method     ChildSpyCmsBlockGlossaryKeyMapping[]|ObjectCollection findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the fk_glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockGlossaryKeyMapping> findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the fk_glossary_key column
 * @method     ChildSpyCmsBlockGlossaryKeyMapping[]|ObjectCollection findByPlaceholder(string $placeholder) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the placeholder column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsBlockGlossaryKeyMapping> findByPlaceholder(string $placeholder) Return ChildSpyCmsBlockGlossaryKeyMapping objects filtered by the placeholder column
...
abstract class SpyCmsBlockGlossaryKeyMappingQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsBlockGlossaryKeyMappingQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsBlockGlossaryKeyMappingTableMap::COL_ID_CMS_BLOCK_GLOSSARY_KEY_MAPPING, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsBlockGlossaryKeyMappingTableMap::COL_ID_CMS_BLOCK_GLOSSARY_KEY_MAPPING, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCmsBlockGlossaryKeyMappingQuery The current query, for fluid interface
     */
