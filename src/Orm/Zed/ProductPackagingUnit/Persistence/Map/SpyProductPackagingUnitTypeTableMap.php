...
class SpyProductPackagingUnitTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductPackagingUnit.Persistence.Map.SpyProductPackagingUnitTypeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_packaging_unit_type';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductPackagingUnit\\Persistence\\SpyProductPackagingUnitType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductPackagingUnit.Persistence.SpyProductPackagingUnitType';
     ...
     */
    const COL_ID_PRODUCT_PACKAGING_UNIT_TYPE = 'spy_product_packaging_unit_type.id_product_packaging_unit_type';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_product_packaging_unit_type.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_packaging_unit_type.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_packaging_unit_type.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductPackagingUnitType', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductPackagingUnitType', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductPackagingUnitTypeTableMap::COL_ID_PRODUCT_PACKAGING_UNIT_TYPE, SpyProductPackagingUnitTypeTableMap::COL_NAME, SpyProductPackagingUnitTypeTableMap::COL_CREATED_AT, SpyProductPackagingUnitTypeTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_packaging_unit_type', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductPackagingUnitType' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductPackagingUnitType' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductPackagingUnitTypeTableMap::COL_ID_PRODUCT_PACKAGING_UNIT_TYPE => 0, SpyProductPackagingUnitTypeTableMap::COL_NAME => 1, SpyProductPackagingUnitTypeTableMap::COL_CREATED_AT => 2, SpyProductPackagingUnitTypeTableMap::COL_UPDATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_packaging_unit_type' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductPackagingUnitTypeTableMap
