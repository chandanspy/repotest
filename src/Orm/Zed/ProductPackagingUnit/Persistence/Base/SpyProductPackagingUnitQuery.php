 ...
 *
 * @method     \Orm\Zed\Product\Persistence\SpyProductQuery|\Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnitTypeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductPackagingUnit objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> find(ConnectionInterface $con = null) Return ChildSpyProductPackagingUnit objects based on current ModelCriteria
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByIdProductPackagingUnit(int $id_product_packaging_unit) Return ChildSpyProductPackagingUnit objects filtered by the id_product_packaging_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByIdProductPackagingUnit(int $id_product_packaging_unit) Return ChildSpyProductPackagingUnit objects filtered by the id_product_packaging_unit column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByFkLeadProduct(int $fk_lead_product) Return ChildSpyProductPackagingUnit objects filtered by the fk_lead_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByFkLeadProduct(int $fk_lead_product) Return ChildSpyProductPackagingUnit objects filtered by the fk_lead_product column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductPackagingUnit objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByFkProduct(int $fk_product) Return ChildSpyProductPackagingUnit objects filtered by the fk_product column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByFkProductPackagingUnitType(int $fk_product_packaging_unit_type) Return ChildSpyProductPackagingUnit objects filtered by the fk_product_packaging_unit_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByFkProductPackagingUnitType(int $fk_product_packaging_unit_type) Return ChildSpyProductPackagingUnit objects filtered by the fk_product_packaging_unit_type column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByAmountInterval(string $amount_interval) Return ChildSpyProductPackagingUnit objects filtered by the amount_interval column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByAmountInterval(string $amount_interval) Return ChildSpyProductPackagingUnit objects filtered by the amount_interval column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByAmountMax(string $amount_max) Return ChildSpyProductPackagingUnit objects filtered by the amount_max column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByAmountMax(string $amount_max) Return ChildSpyProductPackagingUnit objects filtered by the amount_max column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByAmountMin(string $amount_min) Return ChildSpyProductPackagingUnit objects filtered by the amount_min column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByAmountMin(string $amount_min) Return ChildSpyProductPackagingUnit objects filtered by the amount_min column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByDefaultAmount(string $default_amount) Return ChildSpyProductPackagingUnit objects filtered by the default_amount column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByDefaultAmount(string $default_amount) Return ChildSpyProductPackagingUnit objects filtered by the default_amount column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByIsAmountVariable(boolean $is_amount_variable) Return ChildSpyProductPackagingUnit objects filtered by the is_amount_variable column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByIsAmountVariable(boolean $is_amount_variable) Return ChildSpyProductPackagingUnit objects filtered by the is_amount_variable column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductPackagingUnit objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByCreatedAt(string $created_at) Return ChildSpyProductPackagingUnit objects filtered by the created_at column
 * @method     ChildSpyProductPackagingUnit[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductPackagingUnit objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductPackagingUnit> findByUpdatedAt(string $updated_at) Return ChildSpyProductPackagingUnit objects filtered by the updated_at column
...
abstract class SpyProductPackagingUnitQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductPackagingUnitTableMap::COL_ID_PRODUCT_PACKAGING_UNIT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductPackagingUnitTableMap::COL_ID_PRODUCT_PACKAGING_UNIT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
    public function filterByLeadProduct($spyProduct, $comparison = null)
    {
        if ($spyProduct instanceof \Orm\Zed\Product\Persistence\SpyProduct) {
            return $this
     ...
     * @return $this|ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
    public function joinLeadProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('LeadProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('LeadProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
    public function filterByProductPackagingUnitType($spyProductPackagingUnitType, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductPackagingUnitQuery The current query, for fluid interface
     */
    public function joinProductPackagingUnitType($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductPackagingUnitType', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductPackagingUnitType', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductPackagingUnitTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductPackagingUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductPackagingUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductPackagingUnitTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductPackagingUnitTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductPackagingUnitTableMap::COL_CREATED_AT);
    }

} // SpyProductPackagingUnitQuery
