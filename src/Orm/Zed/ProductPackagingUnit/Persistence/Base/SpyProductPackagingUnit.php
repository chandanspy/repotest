...
abstract class SpyProductPackagingUnit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductPackagingUnit\\Persistence\\Map\\SpyProductPackagingUnitTableMap';
     ...
     * @return $this|\Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnit The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnit
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnit The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyProductPackagingUnit The current object (for fluent API support)
     */
