 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> find(ConnectionInterface $con = null) Return ChildSpySalesOrderAddress objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByIdSalesOrderAddress(int $id_sales_order_address) Return ChildSpySalesOrderAddress objects filtered by the id_sales_order_address column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByFkCountry(int $fk_country) Return ChildSpySalesOrderAddress objects filtered by the fk_country column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByFkRegion(int $fk_region) Return ChildSpySalesOrderAddress objects filtered by the fk_region column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByAddress1(string $address1) Return ChildSpySalesOrderAddress objects filtered by the address1 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByAddress2(string $address2) Return ChildSpySalesOrderAddress objects filtered by the address2 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByAddress3(string $address3) Return ChildSpySalesOrderAddress objects filtered by the address3 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByCellPhone(string $cell_phone) Return ChildSpySalesOrderAddress objects filtered by the cell_phone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByCity(string $city) Return ChildSpySalesOrderAddress objects filtered by the city column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByComment(string $comment) Return ChildSpySalesOrderAddress objects filtered by the comment column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByCompany(string $company) Return ChildSpySalesOrderAddress objects filtered by the company column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByDescription(string $description) Return ChildSpySalesOrderAddress objects filtered by the description column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByEmail(string $email) Return ChildSpySalesOrderAddress objects filtered by the email column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByFirstName(string $first_name) Return ChildSpySalesOrderAddress objects filtered by the first_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByLastName(string $last_name) Return ChildSpySalesOrderAddress objects filtered by the last_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByMiddleName(string $middle_name) Return ChildSpySalesOrderAddress objects filtered by the middle_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByPhone(string $phone) Return ChildSpySalesOrderAddress objects filtered by the phone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByPoBox(string $po_box) Return ChildSpySalesOrderAddress objects filtered by the po_box column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findBySalutation(int $salutation) Return ChildSpySalesOrderAddress objects filtered by the salutation column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByZipCode(string $zip_code) Return ChildSpySalesOrderAddress objects filtered by the zip_code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByCreatedAt(string $created_at) Return ChildSpySalesOrderAddress objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddress> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderAddress objects filtered by the updated_at column
...
abstract class SpySalesOrderAddressQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('SpySalesOrderRelatedByFkSalesOrderAddressBilling', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpySalesOrderRelatedByFkSalesOrderAddressBilling', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\Sales\Persistence\SpySalesOrder object
     *
     ...
     * @return $this|ChildSpySalesOrderAddressQuery The current query, for fluid interface
     */
    public function joinSpySalesOrderRelatedByFkSalesOrderAddressShipping($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpySalesOrderRelatedByFkSalesOrderAddressShipping', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpySalesOrderRelatedByFkSalesOrderAddressShipping', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->useExistsQuery('SalesOrderAddressHistory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SalesOrderAddressHistory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
