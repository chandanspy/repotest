 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> find(ConnectionInterface $con = null) Return ChildSpySalesOrderItemOption objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByIdSalesOrderItemOption(int $id_sales_order_item_option) Return ChildSpySalesOrderItemOption objects filtered by the id_sales_order_item_option column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesOrderItemOption objects filtered by the fk_sales_order_item column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByCanceledAmount(int $canceled_amount) Return ChildSpySalesOrderItemOption objects filtered by the canceled_amount column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByCanceledAmount(int $canceled_amount) Return ChildSpySalesOrderItemOption objects filtered by the canceled_amount column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByDiscountAmountAggregation(int $discount_amount_aggregation) Return ChildSpySalesOrderItemOption objects filtered by the discount_amount_aggregation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByDiscountAmountAggregation(int $discount_amount_aggregation) Return ChildSpySalesOrderItemOption objects filtered by the discount_amount_aggregation column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByGrossPrice(int $gross_price) Return ChildSpySalesOrderItemOption objects filtered by the gross_price column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByGroupName(string $group_name) Return ChildSpySalesOrderItemOption objects filtered by the group_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByGroupName(string $group_name) Return ChildSpySalesOrderItemOption objects filtered by the group_name column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByNetPrice(int $net_price) Return ChildSpySalesOrderItemOption objects filtered by the net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByNetPrice(int $net_price) Return ChildSpySalesOrderItemOption objects filtered by the net_price column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByPrice(int $price) Return ChildSpySalesOrderItemOption objects filtered by the price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByPrice(int $price) Return ChildSpySalesOrderItemOption objects filtered by the price column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findBySku(string $sku) Return ChildSpySalesOrderItemOption objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findBySku(string $sku) Return ChildSpySalesOrderItemOption objects filtered by the sku column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByTaxAmount(int $tax_amount) Return ChildSpySalesOrderItemOption objects filtered by the tax_amount column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByTaxAmount(int $tax_amount) Return ChildSpySalesOrderItemOption objects filtered by the tax_amount column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByTaxRate(string $tax_rate) Return ChildSpySalesOrderItemOption objects filtered by the tax_rate column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByTaxRate(string $tax_rate) Return ChildSpySalesOrderItemOption objects filtered by the tax_rate column
 * @method     ChildSpySalesOrderItemOption[]|ObjectCollection findByValue(string $value) Return ChildSpySalesOrderItemOption objects filtered by the value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByValue(string $value) Return ChildSpySalesOrderItemOption objects filtered by the value column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByCreatedAt(string $created_at) Return ChildSpySalesOrderItemOption objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemOption> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderItemOption objects filtered by the updated_at column
