 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> find(ConnectionInterface $con = null) Return ChildSpySalesDiscount objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByIdSalesDiscount(int $id_sales_discount) Return ChildSpySalesDiscount objects filtered by the id_sales_discount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByFkSalesExpense(int $fk_sales_expense) Return ChildSpySalesDiscount objects filtered by the fk_sales_expense column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByFkSalesOrder(int $fk_sales_order) Return ChildSpySalesDiscount objects filtered by the fk_sales_order column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesDiscount objects filtered by the fk_sales_order_item column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByFkSalesOrderItemOption(int $fk_sales_order_item_option) Return ChildSpySalesDiscount objects filtered by the fk_sales_order_item_option column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByAmount(int $amount) Return ChildSpySalesDiscount objects filtered by the amount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByDescription(string $description) Return ChildSpySalesDiscount objects filtered by the description column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByDisplayName(string $display_name) Return ChildSpySalesDiscount objects filtered by the display_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByName(string $name) Return ChildSpySalesDiscount objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByCreatedAt(string $created_at) Return ChildSpySalesDiscount objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscount> findByUpdatedAt(string $updated_at) Return ChildSpySalesDiscount objects filtered by the updated_at column
...
abstract class SpySalesDiscountQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('DiscountCode', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('DiscountCode', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
