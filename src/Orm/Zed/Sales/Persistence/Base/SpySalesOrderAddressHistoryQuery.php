 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> find(ConnectionInterface $con = null) Return ChildSpySalesOrderAddressHistory objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByIdSalesOrderAddressHistory(int $id_sales_order_address_history) Return ChildSpySalesOrderAddressHistory objects filtered by the id_sales_order_address_history column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByFkCountry(int $fk_country) Return ChildSpySalesOrderAddressHistory objects filtered by the fk_country column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByFkRegion(int $fk_region) Return ChildSpySalesOrderAddressHistory objects filtered by the fk_region column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByFkSalesOrderAddress(int $fk_sales_order_address) Return ChildSpySalesOrderAddressHistory objects filtered by the fk_sales_order_address column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByAddress1(string $address1) Return ChildSpySalesOrderAddressHistory objects filtered by the address1 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByAddress2(string $address2) Return ChildSpySalesOrderAddressHistory objects filtered by the address2 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByAddress3(string $address3) Return ChildSpySalesOrderAddressHistory objects filtered by the address3 column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByCellPhone(string $cell_phone) Return ChildSpySalesOrderAddressHistory objects filtered by the cell_phone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByCity(string $city) Return ChildSpySalesOrderAddressHistory objects filtered by the city column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByComment(string $comment) Return ChildSpySalesOrderAddressHistory objects filtered by the comment column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByCompany(string $company) Return ChildSpySalesOrderAddressHistory objects filtered by the company column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByDescription(string $description) Return ChildSpySalesOrderAddressHistory objects filtered by the description column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByEmail(string $email) Return ChildSpySalesOrderAddressHistory objects filtered by the email column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByFirstName(string $first_name) Return ChildSpySalesOrderAddressHistory objects filtered by the first_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByIsBilling(boolean $is_billing) Return ChildSpySalesOrderAddressHistory objects filtered by the is_billing column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByLastName(string $last_name) Return ChildSpySalesOrderAddressHistory objects filtered by the last_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByMiddleName(string $middle_name) Return ChildSpySalesOrderAddressHistory objects filtered by the middle_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByPhone(string $phone) Return ChildSpySalesOrderAddressHistory objects filtered by the phone column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByPoBox(string $po_box) Return ChildSpySalesOrderAddressHistory objects filtered by the po_box column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findBySalutation(int $salutation) Return ChildSpySalesOrderAddressHistory objects filtered by the salutation column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByZipCode(string $zip_code) Return ChildSpySalesOrderAddressHistory objects filtered by the zip_code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByCreatedAt(string $created_at) Return ChildSpySalesOrderAddressHistory objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderAddressHistory> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderAddressHistory objects filtered by the updated_at column
...
abstract class SpySalesOrderAddressHistoryQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('SalesOrderAddress', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SalesOrderAddress', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
