 ...
 *
 * @method     ChildSpySalesOrderNote[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderNote objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> find(ConnectionInterface $con = null) Return ChildSpySalesOrderNote objects based on current ModelCriteria
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByIdSalesOrderNote(int $id_sales_order_note) Return ChildSpySalesOrderNote objects filtered by the id_sales_order_note column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByIdSalesOrderNote(int $id_sales_order_note) Return ChildSpySalesOrderNote objects filtered by the id_sales_order_note column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByFkSalesOrder(int $fk_sales_order) Return ChildSpySalesOrderNote objects filtered by the fk_sales_order column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByFkSalesOrder(int $fk_sales_order) Return ChildSpySalesOrderNote objects filtered by the fk_sales_order column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByCommand(string $command) Return ChildSpySalesOrderNote objects filtered by the command column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByCommand(string $command) Return ChildSpySalesOrderNote objects filtered by the command column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByMessage(string $message) Return ChildSpySalesOrderNote objects filtered by the message column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByMessage(string $message) Return ChildSpySalesOrderNote objects filtered by the message column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findBySuccess(boolean $success) Return ChildSpySalesOrderNote objects filtered by the success column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findBySuccess(boolean $success) Return ChildSpySalesOrderNote objects filtered by the success column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderNote objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByCreatedAt(string $created_at) Return ChildSpySalesOrderNote objects filtered by the created_at column
 * @method     ChildSpySalesOrderNote[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderNote objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderNote> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderNote objects filtered by the updated_at column
...
abstract class SpySalesOrderNoteQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderNoteQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_ID_SALES_ORDER_NOTE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_ID_SALES_ORDER_NOTE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesOrderNoteQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderNoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderNoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderNoteTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderNoteTableMap::COL_CREATED_AT);
    }
