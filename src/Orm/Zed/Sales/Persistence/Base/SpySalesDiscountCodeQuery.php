 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> find(ConnectionInterface $con = null) Return ChildSpySalesDiscountCode objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByIdSalesDiscountCode(int $id_sales_discount_code) Return ChildSpySalesDiscountCode objects filtered by the id_sales_discount_code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByFkSalesDiscount(int $fk_sales_discount) Return ChildSpySalesDiscountCode objects filtered by the fk_sales_discount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByCode(string $code) Return ChildSpySalesDiscountCode objects filtered by the code column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByCodepoolName(string $codepool_name) Return ChildSpySalesDiscountCode objects filtered by the codepool_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByIsOncePerCustomer(boolean $is_once_per_customer) Return ChildSpySalesDiscountCode objects filtered by the is_once_per_customer column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByIsRefundable(boolean $is_refundable) Return ChildSpySalesDiscountCode objects filtered by the is_refundable column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByIsReusable(boolean $is_reusable) Return ChildSpySalesDiscountCode objects filtered by the is_reusable column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByCreatedAt(string $created_at) Return ChildSpySalesDiscountCode objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesDiscountCode> findByUpdatedAt(string $updated_at) Return ChildSpySalesDiscountCode objects filtered by the updated_at column
