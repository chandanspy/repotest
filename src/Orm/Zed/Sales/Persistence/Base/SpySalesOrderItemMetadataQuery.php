 ...
 *
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderItemMetadata objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> find(ConnectionInterface $con = null) Return ChildSpySalesOrderItemMetadata objects based on current ModelCriteria
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findByIdSalesOrderItemMetadata(int $id_sales_order_item_metadata) Return ChildSpySalesOrderItemMetadata objects filtered by the id_sales_order_item_metadata column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findByIdSalesOrderItemMetadata(int $id_sales_order_item_metadata) Return ChildSpySalesOrderItemMetadata objects filtered by the id_sales_order_item_metadata column
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesOrderItemMetadata objects filtered by the fk_sales_order_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesOrderItemMetadata objects filtered by the fk_sales_order_item column
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findByImage(string $image) Return ChildSpySalesOrderItemMetadata objects filtered by the image column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findByImage(string $image) Return ChildSpySalesOrderItemMetadata objects filtered by the image column
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findBySuperAttributes(string $super_attributes) Return ChildSpySalesOrderItemMetadata objects filtered by the super_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findBySuperAttributes(string $super_attributes) Return ChildSpySalesOrderItemMetadata objects filtered by the super_attributes column
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderItemMetadata objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findByCreatedAt(string $created_at) Return ChildSpySalesOrderItemMetadata objects filtered by the created_at column
 * @method     ChildSpySalesOrderItemMetadata[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderItemMetadata objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderItemMetadata> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderItemMetadata objects filtered by the updated_at column
...
abstract class SpySalesOrderItemMetadataQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_item_metadata, fk_sales_order_item, image, super_attributes, created_at, updated_at FROM spy_sales_order_item_metadata WHERE id_sales_order_item_metadata = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderItemMetadataQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesOrderItemMetadataQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderItemMetadataTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderItemMetadataTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderItemMetadataTableMap::COL_CREATED_AT);
    }
