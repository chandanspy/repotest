...
class SpySalesOrderNoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Sales.Persistence.Map.SpySalesOrderNoteTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Sales\\Persistence\\SpySalesOrderNote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Sales.Persistence.SpySalesOrderNote';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderNote', 'FkSalesOrder', 'Command', 'Message', 'Success', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderNote', 'fkSalesOrder', 'command', 'message', 'success', 'createdAt', 'updatedAt', ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_order_note', 'fk_sales_order', 'command', 'message', 'success', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderNote' => 0, 'FkSalesOrder' => 1, 'Command' => 2, 'Message' => 3, 'Success' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderNote' => 0, 'fkSalesOrder' => 1, 'command' => 2, 'message' => 3, 'success' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_order_note' => 0, 'fk_sales_order' => 1, 'command' => 2, 'message' => 3, 'success' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
