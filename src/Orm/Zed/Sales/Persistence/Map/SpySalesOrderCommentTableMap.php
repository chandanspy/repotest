...
class SpySalesOrderCommentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Sales.Persistence.Map.SpySalesOrderCommentTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Sales\\Persistence\\SpySalesOrderComment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Sales.Persistence.SpySalesOrderComment';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderComment', 'FkSalesOrder', 'Message', 'Username', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderComment', 'fkSalesOrder', 'message', 'username', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderCommentTableMap::COL_ID_SALES_ORDER_COMMENT, SpySalesOrderCommentTableMap::COL_FK_SALES_ORDER, SpySalesOrderCommentTableMap::COL_MESSAGE, SpySalesOrderCommentTableMap::COL_USERNAME, SpySalesOrderCommentTableMap::COL_CREATED_AT, SpySalesOrderCommentTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_comment', 'fk_sales_order', 'message', 'username', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderComment' => 0, 'FkSalesOrder' => 1, 'Message' => 2, 'Username' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderComment' => 0, 'fkSalesOrder' => 1, 'message' => 2, 'username' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_order_comment' => 0, 'fk_sales_order' => 1, 'message' => 2, 'username' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
