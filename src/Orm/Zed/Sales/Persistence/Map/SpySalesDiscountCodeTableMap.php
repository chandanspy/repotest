...
class SpySalesDiscountCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Sales.Persistence.Map.SpySalesDiscountCodeTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Sales\\Persistence\\SpySalesDiscountCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Sales.Persistence.SpySalesDiscountCode';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesDiscountCode', 'FkSalesDiscount', 'Code', 'CodepoolName', 'IsOncePerCustomer', 'IsRefundable', 'IsReusable', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesDiscountCode', 'fkSalesDiscount', 'code', 'codepoolName', 'isOncePerCustomer', 'isRefundable', 'isReusable', 'createdAt', 'updatedAt', ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_discount_code', 'fk_sales_discount', 'code', 'codepool_name', 'is_once_per_customer', 'is_refundable', 'is_reusable', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesDiscountCode' => 0, 'FkSalesDiscount' => 1, 'Code' => 2, 'CodepoolName' => 3, 'IsOncePerCustomer' => 4, 'IsRefundable' => 5, 'IsReusable' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idSalesDiscountCode' => 0, 'fkSalesDiscount' => 1, 'code' => 2, 'codepoolName' => 3, 'isOncePerCustomer' => 4, 'isRefundable' => 5, 'isReusable' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_discount_code' => 0, 'fk_sales_discount' => 1, 'code' => 2, 'codepool_name' => 3, 'is_once_per_customer' => 4, 'is_refundable' => 5, 'is_reusable' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
