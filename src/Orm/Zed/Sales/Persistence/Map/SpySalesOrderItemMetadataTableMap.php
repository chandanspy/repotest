...
class SpySalesOrderItemMetadataTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Sales.Persistence.Map.SpySalesOrderItemMetadataTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_order_item_metadata';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Sales\\Persistence\\SpySalesOrderItemMetadata';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Sales.Persistence.SpySalesOrderItemMetadata';
     ...
     */
    const COL_ID_SALES_ORDER_ITEM_METADATA = 'spy_sales_order_item_metadata.id_sales_order_item_metadata';

    /**
     * the column name for the fk_sales_order_item field
     */
    const COL_FK_SALES_ORDER_ITEM = 'spy_sales_order_item_metadata.fk_sales_order_item';

    /**
     * the column name for the image field
     */
    const COL_IMAGE = 'spy_sales_order_item_metadata.image';

    /**
     * the column name for the super_attributes field
     */
    const COL_SUPER_ATTRIBUTES = 'spy_sales_order_item_metadata.super_attributes';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_order_item_metadata.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_order_item_metadata.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderItemMetadata', 'FkSalesOrderItem', 'Image', 'SuperAttributes', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderItemMetadata', 'fkSalesOrderItem', 'image', 'superAttributes', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA, SpySalesOrderItemMetadataTableMap::COL_FK_SALES_ORDER_ITEM, SpySalesOrderItemMetadataTableMap::COL_IMAGE, SpySalesOrderItemMetadataTableMap::COL_SUPER_ATTRIBUTES, SpySalesOrderItemMetadataTableMap::COL_CREATED_AT, SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_item_metadata', 'fk_sales_order_item', 'image', 'super_attributes', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderItemMetadata' => 0, 'FkSalesOrderItem' => 1, 'Image' => 2, 'SuperAttributes' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderItemMetadata' => 0, 'fkSalesOrderItem' => 1, 'image' => 2, 'superAttributes' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpySalesOrderItemMetadataTableMap::COL_ID_SALES_ORDER_ITEM_METADATA => 0, SpySalesOrderItemMetadataTableMap::COL_FK_SALES_ORDER_ITEM => 1, SpySalesOrderItemMetadataTableMap::COL_IMAGE => 2, SpySalesOrderItemMetadataTableMap::COL_SUPER_ATTRIBUTES => 3, SpySalesOrderItemMetadataTableMap::COL_CREATED_AT => 4, SpySalesOrderItemMetadataTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_item_metadata' => 0, 'fk_sales_order_item' => 1, 'image' => 2, 'super_attributes' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpySalesOrderItemMetadataTableMap
