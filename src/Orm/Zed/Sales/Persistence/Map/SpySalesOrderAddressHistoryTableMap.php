...
class SpySalesOrderAddressHistoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Sales.Persistence.Map.SpySalesOrderAddressHistoryTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Sales\\Persistence\\SpySalesOrderAddressHistory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Sales.Persistence.SpySalesOrderAddressHistory';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderAddressHistory', 'FkCountry', 'FkRegion', 'FkSalesOrderAddress', 'Address1', 'Address2', 'Address3', 'CellPhone', 'City', 'Comment', 'Company', 'Description', 'Email', 'FirstName', 'IsBilling', 'LastName', 'MiddleName', 'Phone', 'PoBox', 'Salutation', 'ZipCode', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderAddressHistory', 'fkCountry', 'fkRegion', 'fkSalesOrderAddress', 'address1', 'address2', 'address3', 'cellPhone', 'city', 'comment', 'company', 'description', 'email', 'firstName', 'isBilling', 'lastName', 'middleName', 'phone', 'poBox', 'salutation', 'zipCode', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderAddressHistoryTableMap::COL_ID_SALES_ORDER_ADDRESS_HISTORY, SpySalesOrderAddressHistoryTableMap::COL_FK_COUNTRY, SpySalesOrderAddressHistoryTableMap::COL_FK_REGION, SpySalesOrderAddressHistoryTableMap::COL_FK_SALES_ORDER_ADDRESS, SpySalesOrderAddressHistoryTableMap::COL_ADDRESS1, SpySalesOrderAddressHistoryTableMap::COL_ADDRESS2, SpySalesOrderAddressHistoryTableMap::COL_ADDRESS3, SpySalesOrderAddressHistoryTableMap::COL_CELL_PHONE, SpySalesOrderAddressHistoryTableMap::COL_CITY, SpySalesOrderAddressHistoryTableMap::COL_COMMENT, SpySalesOrderAddressHistoryTableMap::COL_COMPANY, SpySalesOrderAddressHistoryTableMap::COL_DESCRIPTION, SpySalesOrderAddressHistoryTableMap::COL_EMAIL, SpySalesOrderAddressHistoryTableMap::COL_FIRST_NAME, SpySalesOrderAddressHistoryTableMap::COL_IS_BILLING, SpySalesOrderAddressHistoryTableMap::COL_LAST_NAME, SpySalesOrderAddressHistoryTableMap::COL_MIDDLE_NAME, SpySalesOrderAddressHistoryTableMap::COL_PHONE, SpySalesOrderAddressHistoryTableMap::COL_PO_BOX, SpySalesOrderAddressHistoryTableMap::COL_SALUTATION, SpySalesOrderAddressHistoryTableMap::COL_ZIP_CODE, SpySalesOrderAddressHistoryTableMap::COL_CREATED_AT, SpySalesOrderAddressHistoryTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_address_history', 'fk_country', 'fk_region', 'fk_sales_order_address', 'address1', 'address2', 'address3', 'cell_phone', 'city', 'comment', 'company', 'description', 'email', 'first_name', 'is_billing', 'last_name', 'middle_name', 'phone', 'po_box', 'salutation', 'zip_code', 'created_at', 'updated_at', ),
