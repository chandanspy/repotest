 ...
 *
 * @method     ChildSpySalesReturn[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesReturn objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> find(ConnectionInterface $con = null) Return ChildSpySalesReturn objects based on current ModelCriteria
 * @method     ChildSpySalesReturn[]|ObjectCollection findByIdSalesReturn(int $id_sales_return) Return ChildSpySalesReturn objects filtered by the id_sales_return column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByIdSalesReturn(int $id_sales_return) Return ChildSpySalesReturn objects filtered by the id_sales_return column
 * @method     ChildSpySalesReturn[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpySalesReturn objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByCustomerReference(string $customer_reference) Return ChildSpySalesReturn objects filtered by the customer_reference column
 * @method     ChildSpySalesReturn[]|ObjectCollection findByReturnReference(string $return_reference) Return ChildSpySalesReturn objects filtered by the return_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByReturnReference(string $return_reference) Return ChildSpySalesReturn objects filtered by the return_reference column
 * @method     ChildSpySalesReturn[]|ObjectCollection findByStore(string $store) Return ChildSpySalesReturn objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByStore(string $store) Return ChildSpySalesReturn objects filtered by the store column
 * @method     ChildSpySalesReturn[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesReturn objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByCreatedAt(string $created_at) Return ChildSpySalesReturn objects filtered by the created_at column
 * @method     ChildSpySalesReturn[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesReturn objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturn> findByUpdatedAt(string $updated_at) Return ChildSpySalesReturn objects filtered by the updated_at column
...
abstract class SpySalesReturnQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_return, customer_reference, return_reference, store, created_at, updated_at FROM spy_sales_return WHERE id_sales_return = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesReturnQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesReturnTableMap::COL_ID_SALES_RETURN, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesReturnTableMap::COL_ID_SALES_RETURN, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpySalesReturnQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesReturnTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesReturnTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesReturnTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesReturnTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesReturnTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesReturnTableMap::COL_CREATED_AT);
    }
