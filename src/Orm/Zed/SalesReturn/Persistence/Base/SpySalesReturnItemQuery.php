 ...
 *
 * @method     ChildSpySalesReturnItem[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesReturnItem objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> find(ConnectionInterface $con = null) Return ChildSpySalesReturnItem objects based on current ModelCriteria
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByIdSalesReturnItem(int $id_sales_return_item) Return ChildSpySalesReturnItem objects filtered by the id_sales_return_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByIdSalesReturnItem(int $id_sales_return_item) Return ChildSpySalesReturnItem objects filtered by the id_sales_return_item column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesReturnItem objects filtered by the fk_sales_order_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByFkSalesOrderItem(int $fk_sales_order_item) Return ChildSpySalesReturnItem objects filtered by the fk_sales_order_item column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByFkSalesReturn(int $fk_sales_return) Return ChildSpySalesReturnItem objects filtered by the fk_sales_return column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByFkSalesReturn(int $fk_sales_return) Return ChildSpySalesReturnItem objects filtered by the fk_sales_return column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByReason(string $reason) Return ChildSpySalesReturnItem objects filtered by the reason column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByReason(string $reason) Return ChildSpySalesReturnItem objects filtered by the reason column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByUuid(string $uuid) Return ChildSpySalesReturnItem objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByUuid(string $uuid) Return ChildSpySalesReturnItem objects filtered by the uuid column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesReturnItem objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByCreatedAt(string $created_at) Return ChildSpySalesReturnItem objects filtered by the created_at column
 * @method     ChildSpySalesReturnItem[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesReturnItem objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesReturnItem> findByUpdatedAt(string $updated_at) Return ChildSpySalesReturnItem objects filtered by the updated_at column
...
abstract class SpySalesReturnItemQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesReturnItemQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesReturnItemTableMap::COL_ID_SALES_RETURN_ITEM, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesReturnItemTableMap::COL_ID_SALES_RETURN_ITEM, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpySalesReturnItemQuery The current query, for fluid interface
     */
    public function filterBySpySalesReturn($spySalesReturn, $comparison = null)
    {
     ...
     * @return $this|ChildSpySalesReturnItemQuery The current query, for fluid interface
     */
    public function joinSpySalesReturn($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpySalesReturn', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpySalesReturn', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpySalesReturnItemTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesReturnItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesReturnItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesReturnItemTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesReturnItemTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesReturnItemTableMap::COL_CREATED_AT);
    }

} // SpySalesReturnItemQuery
