...
class SpySalesReturnTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesReturn.Persistence.Map.SpySalesReturnTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_return';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesReturn\\Persistence\\SpySalesReturn';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesReturn.Persistence.SpySalesReturn';
     ...
     */
    const COL_ID_SALES_RETURN = 'spy_sales_return.id_sales_return';

    /**
     * the column name for the customer_reference field
     */
    const COL_CUSTOMER_REFERENCE = 'spy_sales_return.customer_reference';

    /**
     * the column name for the return_reference field
     */
    const COL_RETURN_REFERENCE = 'spy_sales_return.return_reference';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_sales_return.store';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_return.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_return.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesReturn', 'CustomerReference', 'ReturnReference', 'Store', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesReturn', 'customerReference', 'returnReference', 'store', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesReturnTableMap::COL_ID_SALES_RETURN, SpySalesReturnTableMap::COL_CUSTOMER_REFERENCE, SpySalesReturnTableMap::COL_RETURN_REFERENCE, SpySalesReturnTableMap::COL_STORE, SpySalesReturnTableMap::COL_CREATED_AT, SpySalesReturnTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_return', 'customer_reference', 'return_reference', 'store', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesReturn' => 0, 'CustomerReference' => 1, 'ReturnReference' => 2, 'Store' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idSalesReturn' => 0, 'customerReference' => 1, 'returnReference' => 2, 'store' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpySalesReturnTableMap::COL_ID_SALES_RETURN => 0, SpySalesReturnTableMap::COL_CUSTOMER_REFERENCE => 1, SpySalesReturnTableMap::COL_RETURN_REFERENCE => 2, SpySalesReturnTableMap::COL_STORE => 3, SpySalesReturnTableMap::COL_CREATED_AT => 4, SpySalesReturnTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_sales_return' => 0, 'customer_reference' => 1, 'return_reference' => 2, 'store' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
