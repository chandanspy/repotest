 ...
 *
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShipmentMethodPrice objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> find(ConnectionInterface $con = null) Return ChildSpyShipmentMethodPrice objects based on current ModelCriteria
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByIdShipmentMethodPrice(int $id_shipment_method_price) Return ChildSpyShipmentMethodPrice objects filtered by the id_shipment_method_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByIdShipmentMethodPrice(int $id_shipment_method_price) Return ChildSpyShipmentMethodPrice objects filtered by the id_shipment_method_price column
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpyShipmentMethodPrice objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByFkCurrency(int $fk_currency) Return ChildSpyShipmentMethodPrice objects filtered by the fk_currency column
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByFkShipmentMethod(int $fk_shipment_method) Return ChildSpyShipmentMethodPrice objects filtered by the fk_shipment_method column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByFkShipmentMethod(int $fk_shipment_method) Return ChildSpyShipmentMethodPrice objects filtered by the fk_shipment_method column
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyShipmentMethodPrice objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByFkStore(int $fk_store) Return ChildSpyShipmentMethodPrice objects filtered by the fk_store column
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByDefaultGrossPrice(int $default_gross_price) Return ChildSpyShipmentMethodPrice objects filtered by the default_gross_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByDefaultGrossPrice(int $default_gross_price) Return ChildSpyShipmentMethodPrice objects filtered by the default_gross_price column
 * @method     ChildSpyShipmentMethodPrice[]|ObjectCollection findByDefaultNetPrice(int $default_net_price) Return ChildSpyShipmentMethodPrice objects filtered by the default_net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShipmentMethodPrice> findByDefaultNetPrice(int $default_net_price) Return ChildSpyShipmentMethodPrice objects filtered by the default_net_price column
...
abstract class SpyShipmentMethodPriceQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShipmentMethodPriceQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShipmentMethodPriceTableMap::COL_ID_SHIPMENT_METHOD_PRICE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShipmentMethodPriceTableMap::COL_ID_SHIPMENT_METHOD_PRICE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyShipmentMethodPriceQuery The current query, for fluid interface
     */
