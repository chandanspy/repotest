...
abstract class SpyShipmentMethodPrice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Shipment\\Persistence\\Map\\SpyShipmentMethodPriceTableMap';
     ...
     * @return $this|\Orm\Zed\Shipment\Persistence\SpyShipmentMethodPrice The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Shipment\Persistence\SpyShipmentMethodPrice
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Shipment\Persistence\SpyShipmentMethodPrice The current object, for fluid interface
     */
