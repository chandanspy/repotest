 ...
 *
 * @method     ChildSpyCompanyUser[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyUser objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> find(ConnectionInterface $con = null) Return ChildSpyCompanyUser objects based on current ModelCriteria
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByIdCompanyUser(int $id_company_user) Return ChildSpyCompanyUser objects filtered by the id_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByIdCompanyUser(int $id_company_user) Return ChildSpyCompanyUser objects filtered by the id_company_user column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByFkCompany(int $fk_company) Return ChildSpyCompanyUser objects filtered by the fk_company column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByFkCompany(int $fk_company) Return ChildSpyCompanyUser objects filtered by the fk_company column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUser objects filtered by the fk_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUser objects filtered by the fk_company_business_unit column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByFkCustomer(int $fk_customer) Return ChildSpyCompanyUser objects filtered by the fk_customer column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByFkCustomer(int $fk_customer) Return ChildSpyCompanyUser objects filtered by the fk_customer column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyCompanyUser objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByIsActive(boolean $is_active) Return ChildSpyCompanyUser objects filtered by the is_active column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyCompanyUser objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByIsDefault(boolean $is_default) Return ChildSpyCompanyUser objects filtered by the is_default column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByKey(string $key) Return ChildSpyCompanyUser objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByKey(string $key) Return ChildSpyCompanyUser objects filtered by the key column
 * @method     ChildSpyCompanyUser[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCompanyUser objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUser> findByUuid(string $uuid) Return ChildSpyCompanyUser objects filtered by the uuid column
...
abstract class SpyCompanyUserQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyUserTableMap::COL_ID_COMPANY_USER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyUserTableMap::COL_ID_COMPANY_USER, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinCompanyBusinessUnit($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyCompanyRoleToCompanyUser($spyCompanyRoleToCompanyUser, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyCompanyRoleToCompanyUser($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCompanyRoleToCompanyUser', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCompanyRoleToCompanyUser', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyQuoteCompanyUser($spyQuoteCompanyUser, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyQuoteCompanyUser($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyQuoteCompanyUser', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyQuoteCompanyUser', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyQuoteApproval($spyQuoteApproval, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyQuoteApproval($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyQuoteApproval', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyQuoteApproval', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyQuoteRequest($spyQuoteRequest, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyQuoteRequest($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyQuoteRequest', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyQuoteRequest', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyShoppingListCompanyUser($spyShoppingListCompanyUser, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyShoppingListCompanyUser($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyShoppingListCompanyUser', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyShoppingListCompanyUser', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyShoppingListCompanyBusinessUnitBlacklist($spyShoppingListCompanyBusinessUnitBlacklist, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyShoppingListCompanyBusinessUnitBlacklist($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyShoppingListCompanyBusinessUnitBlacklist', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyShoppingListCompanyBusinessUnitBlacklist', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
