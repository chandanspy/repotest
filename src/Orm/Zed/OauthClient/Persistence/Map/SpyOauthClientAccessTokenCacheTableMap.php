...
class SpyOauthClientAccessTokenCacheTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.OauthClient.Persistence.Map.SpyOauthClientAccessTokenCacheTableMap';
     ...
     */
    const TABLE_NAME = 'spy_oauth_client_access_token_cache';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\OauthClient\\Persistence\\SpyOauthClientAccessTokenCache';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.OauthClient.Persistence.SpyOauthClientAccessTokenCache';
     ...
     */
    const COL_ID_SPY_OAUTH_CLIENT_ACCESS_TOKEN_CACHE = 'spy_oauth_client_access_token_cache.id_spy_oauth_client_access_token_cache';

    /**
     * the column name for the cache_key field
     */
    const COL_CACHE_KEY = 'spy_oauth_client_access_token_cache.cache_key';

    /**
     * the column name for the access_token field
     */
    const COL_ACCESS_TOKEN = 'spy_oauth_client_access_token_cache.access_token';

    /**
     * the column name for the expires_at field
     */
    const COL_EXPIRES_AT = 'spy_oauth_client_access_token_cache.expires_at';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_oauth_client_access_token_cache.created_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSpyOauthClientAccessTokenCache', 'CacheKey', 'AccessToken', 'ExpiresAt', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('idSpyOauthClientAccessTokenCache', 'cacheKey', 'accessToken', 'expiresAt', 'createdAt', ),
        self::TYPE_COLNAME       => array(SpyOauthClientAccessTokenCacheTableMap::COL_ID_SPY_OAUTH_CLIENT_ACCESS_TOKEN_CACHE, SpyOauthClientAccessTokenCacheTableMap::COL_CACHE_KEY, SpyOauthClientAccessTokenCacheTableMap::COL_ACCESS_TOKEN, SpyOauthClientAccessTokenCacheTableMap::COL_EXPIRES_AT, SpyOauthClientAccessTokenCacheTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_spy_oauth_client_access_token_cache', 'cache_key', 'access_token', 'expires_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSpyOauthClientAccessTokenCache' => 0, 'CacheKey' => 1, 'AccessToken' => 2, 'ExpiresAt' => 3, 'CreatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idSpyOauthClientAccessTokenCache' => 0, 'cacheKey' => 1, 'accessToken' => 2, 'expiresAt' => 3, 'createdAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyOauthClientAccessTokenCacheTableMap::COL_ID_SPY_OAUTH_CLIENT_ACCESS_TOKEN_CACHE => 0, SpyOauthClientAccessTokenCacheTableMap::COL_CACHE_KEY => 1, SpyOauthClientAccessTokenCacheTableMap::COL_ACCESS_TOKEN => 2, SpyOauthClientAccessTokenCacheTableMap::COL_EXPIRES_AT => 3, SpyOauthClientAccessTokenCacheTableMap::COL_CREATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_spy_oauth_client_access_token_cache' => 0, 'cache_key' => 1, 'access_token' => 2, 'expires_at' => 3, 'created_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyOauthClientAccessTokenCacheTableMap
