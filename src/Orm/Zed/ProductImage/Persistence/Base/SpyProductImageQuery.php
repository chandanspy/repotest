 ...
 *
 * @method     ChildSpyProductImage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductImage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> find(ConnectionInterface $con = null) Return ChildSpyProductImage objects based on current ModelCriteria
 * @method     ChildSpyProductImage[]|ObjectCollection findByIdProductImage(int $id_product_image) Return ChildSpyProductImage objects filtered by the id_product_image column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByIdProductImage(int $id_product_image) Return ChildSpyProductImage objects filtered by the id_product_image column
 * @method     ChildSpyProductImage[]|ObjectCollection findByExternalUrlLarge(string $external_url_large) Return ChildSpyProductImage objects filtered by the external_url_large column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByExternalUrlLarge(string $external_url_large) Return ChildSpyProductImage objects filtered by the external_url_large column
 * @method     ChildSpyProductImage[]|ObjectCollection findByExternalUrlSmall(string $external_url_small) Return ChildSpyProductImage objects filtered by the external_url_small column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByExternalUrlSmall(string $external_url_small) Return ChildSpyProductImage objects filtered by the external_url_small column
 * @method     ChildSpyProductImage[]|ObjectCollection findByProductImageKey(string $product_image_key) Return ChildSpyProductImage objects filtered by the product_image_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByProductImageKey(string $product_image_key) Return ChildSpyProductImage objects filtered by the product_image_key column
 * @method     ChildSpyProductImage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductImage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByCreatedAt(string $created_at) Return ChildSpyProductImage objects filtered by the created_at column
 * @method     ChildSpyProductImage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductImage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImage> findByUpdatedAt(string $updated_at) Return ChildSpyProductImage objects filtered by the updated_at column
...
abstract class SpyProductImageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_product_image, external_url_large, external_url_small, product_image_key, created_at, updated_at FROM spy_product_image WHERE id_product_image = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductImageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductImageQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductImageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductImageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductImageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductImageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductImageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductImageTableMap::COL_CREATED_AT);
    }

} // SpyProductImageQuery
