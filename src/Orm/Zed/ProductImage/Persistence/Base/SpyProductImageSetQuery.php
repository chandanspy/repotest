 ...
 *
 * @method     ChildSpyProductImageSet[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductImageSet objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> find(ConnectionInterface $con = null) Return ChildSpyProductImageSet objects based on current ModelCriteria
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByIdProductImageSet(int $id_product_image_set) Return ChildSpyProductImageSet objects filtered by the id_product_image_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByIdProductImageSet(int $id_product_image_set) Return ChildSpyProductImageSet objects filtered by the id_product_image_set column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductImageSet objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByFkLocale(int $fk_locale) Return ChildSpyProductImageSet objects filtered by the fk_locale column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductImageSet objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByFkProduct(int $fk_product) Return ChildSpyProductImageSet objects filtered by the fk_product column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductImageSet objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductImageSet objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByFkResourceConfigurableBundleTemplate(int $fk_resource_configurable_bundle_template) Return ChildSpyProductImageSet objects filtered by the fk_resource_configurable_bundle_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByFkResourceConfigurableBundleTemplate(int $fk_resource_configurable_bundle_template) Return ChildSpyProductImageSet objects filtered by the fk_resource_configurable_bundle_template column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByFkResourceProductSet(int $fk_resource_product_set) Return ChildSpyProductImageSet objects filtered by the fk_resource_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByFkResourceProductSet(int $fk_resource_product_set) Return ChildSpyProductImageSet objects filtered by the fk_resource_product_set column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByName(string $name) Return ChildSpyProductImageSet objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByName(string $name) Return ChildSpyProductImageSet objects filtered by the name column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByProductImageSetKey(string $product_image_set_key) Return ChildSpyProductImageSet objects filtered by the product_image_set_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByProductImageSetKey(string $product_image_set_key) Return ChildSpyProductImageSet objects filtered by the product_image_set_key column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductImageSet objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByCreatedAt(string $created_at) Return ChildSpyProductImageSet objects filtered by the created_at column
 * @method     ChildSpyProductImageSet[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductImageSet objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductImageSet> findByUpdatedAt(string $updated_at) Return ChildSpyProductImageSet objects filtered by the updated_at column
...
abstract class SpyProductImageSetQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductImageSetTableMap::COL_ID_PRODUCT_IMAGE_SET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductImageSetTableMap::COL_ID_PRODUCT_IMAGE_SET, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function filterBySpyConfigurableBundleTemplate($spyConfigurableBundleTemplate, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function joinSpyConfigurableBundleTemplate($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyConfigurableBundleTemplate', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyConfigurableBundleTemplate', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function filterBySpyProductSet($spyProductSet, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function joinSpyProductSet($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductSet', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductSet', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function filterBySpyProductImageSetToProductImage($spyProductImageSetToProductImage, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductImageSetQuery The current query, for fluid interface
     */
    public function joinSpyProductImageSetToProductImage($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductImageSetToProductImage', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductImageSetToProductImage', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductImageSetTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductImageSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductImageSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductImageSetTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductImageSetTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductImageSetTableMap::COL_CREATED_AT);
    }
