...
abstract class SpyProductImageSet implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductImage\\Persistence\\Map\\SpyProductImageSetTableMap';
     ...
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImageSet The current object (for fluent API support)
     */
    ...
    public function setFkResourceConfigurableBundleTemplate($v)
    {
        ...
        return $this;
    } // setFkResourceConfigurableBundleTemplate()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImageSet
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImageSet The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductImageSet The current object (for fluent API support)
     */
