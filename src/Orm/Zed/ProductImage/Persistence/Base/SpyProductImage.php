...
/**
 * Base class that represents a row from the 'spy_product_image' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.ProductImage.Persistence.Base
 */
abstract class SpyProductImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductImage\\Persistence\\Map\\SpyProductImageTableMap';
    ...
    /**
     * The value for the id_product_image field.
     *
     * @var        int
     */
    protected $id_product_image;
    ...
    /**
     * The value for the product_image_key field.
     *
     * @var        string|null
     */
    protected $product_image_key;
    ...
    /**
     * Initializes internal state of Orm\Zed\ProductImage\Persistence\Base\SpyProductImage object.
     */
    ...
    /**
     * Compares this with another <code>SpyProductImage</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyProductImage</code>, delegates to
     * <code>equals(SpyProductImage)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_product_image] column value.
     *
     * @return int
     */
    public function getIdProductImage()
    {
        return $this->id_product_image;
    }
    ...
    /**
     * Get the [product_image_key] column value.
     *
     * @return string|null
     */
    public function getProductImageKey()
    {
        return $this->product_image_key;
    }
    ...
    /**
     * Set the value of [id_product_image] column.
     *
     * @param int $v New value
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImage The current object (for fluent API support)
     */
    public function setIdProductImage($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_product_image !== $v) {
            $this->id_product_image = $v;
            $this->modifiedColumns[SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE] = true;
        }
    ...
    public function setExternalUrlLarge($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->external_url_large !== $v) {
            ...
            $this->modifiedColumns[SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE] = true;
        }
    ...
    public function setExternalUrlSmall($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->external_url_small !== $v) {
            ...
            $this->modifiedColumns[SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL] = true;
        }
    ...
    /**
     * Set the value of [product_image_key] column.
     *
     * @param string|null $v New value
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImage The current object (for fluent API support)
     */
    public function setProductImageKey($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->product_image_key !== $v) {
            $this->product_image_key = $v;
            $this->modifiedColumns[SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyProductImageTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyProductImageTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyProductImageTableMap::translateFieldName('IdProductImage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_product_image = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyProductImageTableMap::translateFieldName('ExternalUrlLarge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->external_url_large = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyProductImageTableMap::translateFieldName('ExternalUrlSmall', TableMap::TYPE_PHPNAME, $indexType)];
            $this->external_url_small = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductImageTableMap::translateFieldName('ProductImageKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_image_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyProductImageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyProductImageTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = SpyProductImageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\ProductImage\\Persistence\\SpyProductImage'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyProductImageTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyProductImageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SpyProductImage::setDeleted()
     * @see SpyProductImage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyProductImageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyProductImageTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyProductImageTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyProductImageTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                SpyProductImageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'id_product_image';
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE)) {
            $modifiedColumns[':p' . $index++]  = 'external_url_large';
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL)) {
            $modifiedColumns[':p' . $index++]  = 'external_url_small';
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'product_image_key';
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_product_image (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_product_image':
                        $stmt->bindValue($identifier, $this->id_product_image, PDO::PARAM_INT);
                        break;
                    ...
                    case 'product_image_key':
                        $stmt->bindValue($identifier, $this->product_image_key, PDO::PARAM_STR);
                        break;
                    case 'created_at':
        ...
        try {
            $pk = $con->lastInsertId('spy_product_image_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        if ($pk !== null) {
            $this->setIdProductImage($pk);
        }
    ...
    {
        $pos = SpyProductImageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getProductImageKey();
                break;
            case 4:
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SpyProductImage'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SpyProductImage'][$this->hashCode()] = true;
        $keys = SpyProductImageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdProductImage(),
            $keys[1] => $this->getExternalUrlLarge(),
            $keys[2] => $this->getExternalUrlSmall(),
            $keys[3] => $this->getProductImageKey(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImage
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdProductImage($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setProductImageKey($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductImage\Persistence\SpyProductImage The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE)) {
            $criteria->add(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, $this->id_product_image);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE)) {
            $criteria->add(SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE, $this->external_url_large);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL)) {
            $criteria->add(SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL, $this->external_url_small);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY)) {
            $criteria->add(SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY, $this->product_image_key);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyProductImageTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyProductImageTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyProductImageQuery::create();
        $criteria->add(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, $this->id_product_image);
    ...
    {
        $validPk = null !== $this->getIdProductImage();
    ...
    /**
     * Generic method to set the primary key (id_product_image column).
     *
    ...
    {
        return null === $this->getIdProductImage();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\ProductImage\Persistence\SpyProductImage (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductImageKey($this->getProductImageKey());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdProductImage(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\ProductImage\Persistence\SpyProductImage Clone of current object.
     * @throws PropelException
     */
     ...
     */
    public function resetPartialSpyProductImageSetToProductImages($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductImageSetToProductImages($overrideExisting = true)
    {
     ...
     * If this ChildSpyProductImage is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductImage The current object (for fluent API support)
     */
    public function setSpyProductImageSetToProductImages(Collection $spyProductImageSetToProductImages, ConnectionInterface $con = null)
    {
        ...
        foreach ($spyProductImageSetToProductImagesToDelete as $spyProductImageSetToProductImageRemoved) {
            $spyProductImageSetToProductImageRemoved->setSpyProductImage(null);
        }
     ...
     * @throws PropelException
     */
    public function countSpyProductImageSetToProductImages(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductImageSetToProductImagesPartial && !$this->isNew();
        if (null === $this->collSpyProductImageSetToProductImages || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductImageSetToProductImage(ChildSpyProductImageSetToProductImage $spyProductImageSetToProductImage)
    {
        $this->collSpyProductImageSetToProductImages[]= $spyProductImageSetToProductImage;
        $spyProductImageSetToProductImage->setSpyProductImage($this);
    }
    ...
    public function removeSpyProductImageSetToProductImage(ChildSpyProductImageSetToProductImage $spyProductImageSetToProductImage)
    {
        if ($this->getSpyProductImageSetToProductImages()->contains($spyProductImageSetToProductImage)) {
            ...
            $spyProductImageSetToProductImage->setSpyProductImage(null);
        }
     ...
     * Otherwise if this SpyProductImage is new, it will return
     * an empty collection; or if this SpyProductImage has previously
     * been saved, it will retrieve related SpyProductImageSetToProductImages from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyProductImage.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyProductImageSetToProductImage}> List of ChildSpyProductImageSetToProductImage objects
     */
    public function getSpyProductImageSetToProductImagesJoinSpyProductImageSet(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyProductImageSetToProductImageQuery::create(null, $criteria);
        $query->joinWith('SpyProductImageSet', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(SpyProductImageTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        if ($this->isNew()) {
            $this->_eventName = 'Entity.spy_product_image.create';
        } else {
            $this->_eventName = 'Entity.spy_product_image.update';
        }
    ...
    protected function addSaveEventToMemory()
    {
        ...
        if ($this->_eventName !== 'Entity.spy_product_image.create') {
            if (!$this->_isModified) {
                return;
            }
    ...
    protected function getOriginalValues(): array
    {
        ...
        foreach ($this->_modifiedColumns as $modifiedColumn) {
            ...
            $field = str_replace('spy_product_image.', '', $modifiedColumn);
            $after = $this->$field;
    ...
    protected function getAdditionalValues(): array
    {
        ...
        foreach ($this->getAdditionalValueColumnNames() as $additionalValueColumnName) {
            $field = str_replace('spy_product_image.', '', $additionalValueColumnName);
    ...
    {
        $columnType = SpyProductImageTableMap::getTableMap()->getColumn($column)->getType();
