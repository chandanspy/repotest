...
class SpyProductImageSetToProductImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductImage.Persistence.Map.SpyProductImageSetToProductImageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_image_set_to_product_image';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductImage\\Persistence\\SpyProductImageSetToProductImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductImage.Persistence.SpyProductImageSetToProductImage';
     ...
     */
    const COL_ID_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE = 'spy_product_image_set_to_product_image.id_product_image_set_to_product_image';

    /**
     * the column name for the fk_product_image field
     */
    const COL_FK_PRODUCT_IMAGE = 'spy_product_image_set_to_product_image.fk_product_image';

    /**
     * the column name for the fk_product_image_set field
     */
    const COL_FK_PRODUCT_IMAGE_SET = 'spy_product_image_set_to_product_image.fk_product_image_set';

    /**
     * the column name for the sort_order field
     */
    const COL_SORT_ORDER = 'spy_product_image_set_to_product_image.sort_order';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductImageSetToProductImage', 'FkProductImage', 'FkProductImageSet', 'SortOrder', ),
        self::TYPE_CAMELNAME     => array('idProductImageSetToProductImage', 'fkProductImage', 'fkProductImageSet', 'sortOrder', ),
        self::TYPE_COLNAME       => array(SpyProductImageSetToProductImageTableMap::COL_ID_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE, SpyProductImageSetToProductImageTableMap::COL_FK_PRODUCT_IMAGE, SpyProductImageSetToProductImageTableMap::COL_FK_PRODUCT_IMAGE_SET, SpyProductImageSetToProductImageTableMap::COL_SORT_ORDER, ),
        self::TYPE_FIELDNAME     => array('id_product_image_set_to_product_image', 'fk_product_image', 'fk_product_image_set', 'sort_order', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductImageSetToProductImage' => 0, 'FkProductImage' => 1, 'FkProductImageSet' => 2, 'SortOrder' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductImageSetToProductImage' => 0, 'fkProductImage' => 1, 'fkProductImageSet' => 2, 'sortOrder' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductImageSetToProductImageTableMap::COL_ID_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE => 0, SpyProductImageSetToProductImageTableMap::COL_FK_PRODUCT_IMAGE => 1, SpyProductImageSetToProductImageTableMap::COL_FK_PRODUCT_IMAGE_SET => 2, SpyProductImageSetToProductImageTableMap::COL_SORT_ORDER => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_image_set_to_product_image' => 0, 'fk_product_image' => 1, 'fk_product_image_set' => 2, 'sort_order' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductImageSetToProductImageTableMap
