...
class SpyProductImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductImage.Persistence.Map.SpyProductImageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_image';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductImage\\Persistence\\SpyProductImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductImage.Persistence.SpyProductImage';
     ...
     */
    const COL_ID_PRODUCT_IMAGE = 'spy_product_image.id_product_image';

    /**
     * the column name for the external_url_large field
     */
    const COL_EXTERNAL_URL_LARGE = 'spy_product_image.external_url_large';

    /**
     * the column name for the external_url_small field
     */
    const COL_EXTERNAL_URL_SMALL = 'spy_product_image.external_url_small';

    /**
     * the column name for the product_image_key field
     */
    const COL_PRODUCT_IMAGE_KEY = 'spy_product_image.product_image_key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_image.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_image.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductImage', 'ExternalUrlLarge', 'ExternalUrlSmall', 'ProductImageKey', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductImage', 'externalUrlLarge', 'externalUrlSmall', 'productImageKey', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY, SpyProductImageTableMap::COL_CREATED_AT, SpyProductImageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_image', 'external_url_large', 'external_url_small', 'product_image_key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductImage' => 0, 'ExternalUrlLarge' => 1, 'ExternalUrlSmall' => 2, 'ProductImageKey' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductImage' => 0, 'externalUrlLarge' => 1, 'externalUrlSmall' => 2, 'productImageKey' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductImageTableMap::COL_ID_PRODUCT_IMAGE => 0, SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE => 1, SpyProductImageTableMap::COL_EXTERNAL_URL_SMALL => 2, SpyProductImageTableMap::COL_PRODUCT_IMAGE_KEY => 3, SpyProductImageTableMap::COL_CREATED_AT => 4, SpyProductImageTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_image' => 0, 'external_url_large' => 1, 'external_url_small' => 2, 'product_image_key' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
