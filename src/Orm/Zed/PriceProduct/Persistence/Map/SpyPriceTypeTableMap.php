...
class SpyPriceTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProduct.Persistence.Map.SpyPriceTypeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_type';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProduct\\Persistence\\SpyPriceType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProduct.Persistence.SpyPriceType';
     ...
     */
    const COL_ID_PRICE_TYPE = 'spy_price_type.id_price_type';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_price_type.name';

    /**
     * the column name for the price_mode_configuration field
     */
    const COL_PRICE_MODE_CONFIGURATION = 'spy_price_type.price_mode_configuration';
    ...
    const COL_PRICE_MODE_CONFIGURATION_NET_MODE = 'NET_MODE';
    const COL_PRICE_MODE_CONFIGURATION_GROSS_MODE = 'GROSS_MODE';
    const COL_PRICE_MODE_CONFIGURATION_BOTH = 'BOTH';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceType', 'Name', 'PriceModeConfiguration', ),
        self::TYPE_CAMELNAME     => array('idPriceType', 'name', 'priceModeConfiguration', ),
        self::TYPE_COLNAME       => array(SpyPriceTypeTableMap::COL_ID_PRICE_TYPE, SpyPriceTypeTableMap::COL_NAME, SpyPriceTypeTableMap::COL_PRICE_MODE_CONFIGURATION, ),
        self::TYPE_FIELDNAME     => array('id_price_type', 'name', 'price_mode_configuration', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceType' => 0, 'Name' => 1, 'PriceModeConfiguration' => 2, ),
        self::TYPE_CAMELNAME     => array('idPriceType' => 0, 'name' => 1, 'priceModeConfiguration' => 2, ),
        self::TYPE_COLNAME       => array(SpyPriceTypeTableMap::COL_ID_PRICE_TYPE => 0, SpyPriceTypeTableMap::COL_NAME => 1, SpyPriceTypeTableMap::COL_PRICE_MODE_CONFIGURATION => 2, ),
        self::TYPE_FIELDNAME     => array('id_price_type' => 0, 'name' => 1, 'price_mode_configuration' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected static $enumValueSets = array(
                SpyPriceTypeTableMap::COL_PRICE_MODE_CONFIGURATION => array(
