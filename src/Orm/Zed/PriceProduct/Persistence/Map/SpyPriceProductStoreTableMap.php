...
class SpyPriceProductStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProduct.Persistence.Map.SpyPriceProductStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProduct\\Persistence\\SpyPriceProductStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProduct.Persistence.SpyPriceProductStore';
     ...
     */
    const COL_ID_PRICE_PRODUCT_STORE = 'spy_price_product_store.id_price_product_store';

    /**
     * the column name for the fk_currency field
     */
    const COL_FK_CURRENCY = 'spy_price_product_store.fk_currency';

    /**
     * the column name for the fk_price_product field
     */
    const COL_FK_PRICE_PRODUCT = 'spy_price_product_store.fk_price_product';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_price_product_store.fk_store';

    /**
     * the column name for the gross_price field
     */
    const COL_GROSS_PRICE = 'spy_price_product_store.gross_price';

    /**
     * the column name for the net_price field
     */
    const COL_NET_PRICE = 'spy_price_product_store.net_price';

    /**
     * the column name for the price_data field
     */
    const COL_PRICE_DATA = 'spy_price_product_store.price_data';

    /**
     * the column name for the price_data_checksum field
     */
    const COL_PRICE_DATA_CHECKSUM = 'spy_price_product_store.price_data_checksum';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductStore', 'FkCurrency', 'FkPriceProduct', 'FkStore', 'GrossPrice', 'NetPrice', 'PriceData', 'PriceDataChecksum', ),
        self::TYPE_CAMELNAME     => array('idPriceProductStore', 'fkCurrency', 'fkPriceProduct', 'fkStore', 'grossPrice', 'netPrice', 'priceData', 'priceDataChecksum', ),
        self::TYPE_COLNAME       => array(SpyPriceProductStoreTableMap::COL_ID_PRICE_PRODUCT_STORE, SpyPriceProductStoreTableMap::COL_FK_CURRENCY, SpyPriceProductStoreTableMap::COL_FK_PRICE_PRODUCT, SpyPriceProductStoreTableMap::COL_FK_STORE, SpyPriceProductStoreTableMap::COL_GROSS_PRICE, SpyPriceProductStoreTableMap::COL_NET_PRICE, SpyPriceProductStoreTableMap::COL_PRICE_DATA, SpyPriceProductStoreTableMap::COL_PRICE_DATA_CHECKSUM, ),
        self::TYPE_FIELDNAME     => array('id_price_product_store', 'fk_currency', 'fk_price_product', 'fk_store', 'gross_price', 'net_price', 'price_data', 'price_data_checksum', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductStore' => 0, 'FkCurrency' => 1, 'FkPriceProduct' => 2, 'FkStore' => 3, 'GrossPrice' => 4, 'NetPrice' => 5, 'PriceData' => 6, 'PriceDataChecksum' => 7, ),
        self::TYPE_CAMELNAME     => array('idPriceProductStore' => 0, 'fkCurrency' => 1, 'fkPriceProduct' => 2, 'fkStore' => 3, 'grossPrice' => 4, 'netPrice' => 5, 'priceData' => 6, 'priceDataChecksum' => 7, ),
        self::TYPE_COLNAME       => array(SpyPriceProductStoreTableMap::COL_ID_PRICE_PRODUCT_STORE => 0, SpyPriceProductStoreTableMap::COL_FK_CURRENCY => 1, SpyPriceProductStoreTableMap::COL_FK_PRICE_PRODUCT => 2, SpyPriceProductStoreTableMap::COL_FK_STORE => 3, SpyPriceProductStoreTableMap::COL_GROSS_PRICE => 4, SpyPriceProductStoreTableMap::COL_NET_PRICE => 5, SpyPriceProductStoreTableMap::COL_PRICE_DATA => 6, SpyPriceProductStoreTableMap::COL_PRICE_DATA_CHECKSUM => 7, ),
        self::TYPE_FIELDNAME     => array('id_price_product_store' => 0, 'fk_currency' => 1, 'fk_price_product' => 2, 'fk_store' => 3, 'gross_price' => 4, 'net_price' => 5, 'price_data' => 6, 'price_data_checksum' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
