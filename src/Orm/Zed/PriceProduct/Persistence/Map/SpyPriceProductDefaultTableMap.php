...
class SpyPriceProductDefaultTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProduct.Persistence.Map.SpyPriceProductDefaultTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_default';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProduct\\Persistence\\SpyPriceProductDefault';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProduct.Persistence.SpyPriceProductDefault';
     ...
     */
    const COL_ID_PRICE_PRODUCT_DEFAULT = 'spy_price_product_default.id_price_product_default';

    /**
     * the column name for the fk_price_product_store field
     */
    const COL_FK_PRICE_PRODUCT_STORE = 'spy_price_product_default.fk_price_product_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductDefault', 'FkPriceProductStore', ),
        self::TYPE_CAMELNAME     => array('idPriceProductDefault', 'fkPriceProductStore', ),
        self::TYPE_COLNAME       => array(SpyPriceProductDefaultTableMap::COL_ID_PRICE_PRODUCT_DEFAULT, SpyPriceProductDefaultTableMap::COL_FK_PRICE_PRODUCT_STORE, ),
        self::TYPE_FIELDNAME     => array('id_price_product_default', 'fk_price_product_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductDefault' => 0, 'FkPriceProductStore' => 1, ),
        self::TYPE_CAMELNAME     => array('idPriceProductDefault' => 0, 'fkPriceProductStore' => 1, ),
        self::TYPE_COLNAME       => array(SpyPriceProductDefaultTableMap::COL_ID_PRICE_PRODUCT_DEFAULT => 0, SpyPriceProductDefaultTableMap::COL_FK_PRICE_PRODUCT_STORE => 1, ),
        self::TYPE_FIELDNAME     => array('id_price_product_default' => 0, 'fk_price_product_store' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
...
} // SpyPriceProductDefaultTableMap
