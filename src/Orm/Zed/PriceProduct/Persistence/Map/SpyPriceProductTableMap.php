...
class SpyPriceProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProduct.Persistence.Map.SpyPriceProductTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProduct\\Persistence\\SpyPriceProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProduct.Persistence.SpyPriceProduct';
     ...
     */
    const COL_ID_PRICE_PRODUCT = 'spy_price_product.id_price_product';

    /**
     * the column name for the fk_price_type field
     */
    const COL_FK_PRICE_TYPE = 'spy_price_product.fk_price_type';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_price_product.fk_product';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_price_product.fk_product_abstract';

    /**
     * the column name for the price field
     */
    const COL_PRICE = 'spy_price_product.price';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProduct', 'FkPriceType', 'FkProduct', 'FkProductAbstract', 'Price', ),
        self::TYPE_CAMELNAME     => array('idPriceProduct', 'fkPriceType', 'fkProduct', 'fkProductAbstract', 'price', ),
        self::TYPE_COLNAME       => array(SpyPriceProductTableMap::COL_ID_PRICE_PRODUCT, SpyPriceProductTableMap::COL_FK_PRICE_TYPE, SpyPriceProductTableMap::COL_FK_PRODUCT, SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT, SpyPriceProductTableMap::COL_PRICE, ),
        self::TYPE_FIELDNAME     => array('id_price_product', 'fk_price_type', 'fk_product', 'fk_product_abstract', 'price', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProduct' => 0, 'FkPriceType' => 1, 'FkProduct' => 2, 'FkProductAbstract' => 3, 'Price' => 4, ),
        self::TYPE_CAMELNAME     => array('idPriceProduct' => 0, 'fkPriceType' => 1, 'fkProduct' => 2, 'fkProductAbstract' => 3, 'price' => 4, ),
        self::TYPE_COLNAME       => array(SpyPriceProductTableMap::COL_ID_PRICE_PRODUCT => 0, SpyPriceProductTableMap::COL_FK_PRICE_TYPE => 1, SpyPriceProductTableMap::COL_FK_PRODUCT => 2, SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT => 3, SpyPriceProductTableMap::COL_PRICE => 4, ),
        self::TYPE_FIELDNAME     => array('id_price_product' => 0, 'fk_price_type' => 1, 'fk_product' => 2, 'fk_product_abstract' => 3, 'price' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
