 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> find(ConnectionInterface $con = null) Return ChildSpyPriceProduct objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> findByIdPriceProduct(int $id_price_product) Return ChildSpyPriceProduct objects filtered by the id_price_product column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> findByFkPriceType(int $fk_price_type) Return ChildSpyPriceProduct objects filtered by the fk_price_type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> findByFkProduct(int $fk_product) Return ChildSpyPriceProduct objects filtered by the fk_product column
 * @method     ChildSpyPriceProduct[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProduct objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProduct objects filtered by the fk_product_abstract column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProduct> findByPrice(int $price) Return ChildSpyPriceProduct objects filtered by the price column
