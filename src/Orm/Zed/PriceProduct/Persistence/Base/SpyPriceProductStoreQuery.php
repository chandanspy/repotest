 ...
 *
 * @method     ChildSpyPriceProductStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPriceProductStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> find(ConnectionInterface $con = null) Return ChildSpyPriceProductStore objects based on current ModelCriteria
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByIdPriceProductStore(string $id_price_product_store) Return ChildSpyPriceProductStore objects filtered by the id_price_product_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByIdPriceProductStore(string $id_price_product_store) Return ChildSpyPriceProductStore objects filtered by the id_price_product_store column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpyPriceProductStore objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByFkCurrency(int $fk_currency) Return ChildSpyPriceProductStore objects filtered by the fk_currency column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByFkPriceProduct(int $fk_price_product) Return ChildSpyPriceProductStore objects filtered by the fk_price_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByFkPriceProduct(int $fk_price_product) Return ChildSpyPriceProductStore objects filtered by the fk_price_product column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyPriceProductStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByFkStore(int $fk_store) Return ChildSpyPriceProductStore objects filtered by the fk_store column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByGrossPrice(int $gross_price) Return ChildSpyPriceProductStore objects filtered by the gross_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByGrossPrice(int $gross_price) Return ChildSpyPriceProductStore objects filtered by the gross_price column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByNetPrice(int $net_price) Return ChildSpyPriceProductStore objects filtered by the net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByNetPrice(int $net_price) Return ChildSpyPriceProductStore objects filtered by the net_price column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByPriceData(string $price_data) Return ChildSpyPriceProductStore objects filtered by the price_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByPriceData(string $price_data) Return ChildSpyPriceProductStore objects filtered by the price_data column
 * @method     ChildSpyPriceProductStore[]|ObjectCollection findByPriceDataChecksum(string $price_data_checksum) Return ChildSpyPriceProductStore objects filtered by the price_data_checksum column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductStore> findByPriceDataChecksum(string $price_data_checksum) Return ChildSpyPriceProductStore objects filtered by the price_data_checksum column
...
abstract class SpyPriceProductStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPriceProductStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPriceProductStoreTableMap::COL_ID_PRICE_PRODUCT_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPriceProductStoreTableMap::COL_ID_PRICE_PRODUCT_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPriceProductStoreQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyPriceProductStoreQuery The current query, for fluid interface
     */
    public function filterByPriceProductDefault($spyPriceProductDefault, $comparison = null)
    {
     ...
     * @return $this|ChildSpyPriceProductStoreQuery The current query, for fluid interface
     */
    public function joinPriceProductDefault($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('PriceProductDefault', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('PriceProductDefault', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
