 ...
 */
abstract class SpyPriceProduct implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\PriceProduct\\Persistence\\Map\\SpyPriceProductTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildSpyPriceProductStore[] Collection to store aggregation of ChildSpyPriceProductStore objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyPriceProductStore> Collection to store aggregation of ChildSpyPriceProductStore objects.
     */
     ...
     * @var ObjectCollection|ChildSpyPriceProductStore[]
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyPriceProductStore>
     */
    ...
    /**
     * Initializes internal state of Orm\Zed\PriceProduct\Persistence\Base\SpyPriceProduct object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Orm\Zed\PriceProduct\Persistence\SpyPriceProduct The current object (for fluent API support)
     */
    public function setIdPriceProduct($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_price_product !== $v) {
    ...
    public function setFkProductAbstract($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_product_abstract !== $v) {
            ...
            $this->modifiedColumns[SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyPriceProductTableMap::translateFieldName('FkPriceType', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyPriceProductTableMap::translateFieldName('FkProductAbstract', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_product_abstract = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyPriceProductTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\PriceProduct\\Persistence\\SpyPriceProduct'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\PriceProduct\Persistence\SpyPriceProduct
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFkPriceType($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\PriceProduct\Persistence\SpyPriceProduct The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT)) {
            $criteria->add(SpyPriceProductTableMap::COL_FK_PRODUCT_ABSTRACT, $this->fk_product_abstract);
        }
        if ($this->isColumnModified(SpyPriceProductTableMap::COL_PRICE)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\PriceProduct\Persistence\SpyPriceProduct (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\PriceProduct\Persistence\SpyPriceProduct Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSpyProductAbstract(ConnectionInterface $con = null)
    {
        if ($this->aSpyProductAbstract === null && ($this->fk_product_abstract != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpyProductAbstract->addPriceProducts($this);
             */
        }
    ...
    /**
     * Gets an array of ChildSpyPriceProductStore objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildSpyPriceProduct is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildSpyPriceProductStore[] List of ChildSpyPriceProductStore objects
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyPriceProductStore> List of ChildSpyPriceProductStore objects
     * @throws PropelException
     */
    public function getPriceProductStores(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collPriceProductStores || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collPriceProductStores = ChildSpyPriceProductStoreQuery::create(null, $criteria)
                    ->filterByPriceProduct($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildSpyPriceProductStore objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyPriceProduct The current object (for fluent API support)
     */
    public function setPriceProductStores(Collection $priceProductStores, ConnectionInterface $con = null)
    {
        /** @var ChildSpyPriceProductStore[] $priceProductStoresToDelete */
        ...
        foreach ($priceProductStoresToDelete as $priceProductStoreRemoved) {
            $priceProductStoreRemoved->setPriceProduct(null);
        }
    ...
    /**
     * Returns the number of related SpyPriceProductStore objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related SpyPriceProductStore objects.
     * @throws PropelException
     */
    public function countPriceProductStores(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collPriceProductStores || null !== $criteria || $partial) {
            ...
            $query = ChildSpyPriceProductStoreQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildSpyPriceProductStore object to this object
     * through the ChildSpyPriceProductStore foreign key attribute.
     *
     * @param  ChildSpyPriceProductStore $l ChildSpyPriceProductStore
     * @return $this|\Orm\Zed\PriceProduct\Persistence\SpyPriceProduct The current object (for fluent API support)
     */
    public function addPriceProductStore(ChildSpyPriceProductStore $l)
    {
        if ($this->collPriceProductStores === null) {
            $this->initPriceProductStores();
            $this->collPriceProductStoresPartial = true;
    ...
    /**
     * @param ChildSpyPriceProductStore $priceProductStore The ChildSpyPriceProductStore object to add.
     */
    protected function doAddPriceProductStore(ChildSpyPriceProductStore $priceProductStore)
    {
        $this->collPriceProductStores[]= $priceProductStore;
        $priceProductStore->setPriceProduct($this);
    }

    /**
     * @param  ChildSpyPriceProductStore $priceProductStore The ChildSpyPriceProductStore object to remove.
     * @return $this|ChildSpyPriceProduct The current object (for fluent API support)
     */
    public function removePriceProductStore(ChildSpyPriceProductStore $priceProductStore)
    {
        if ($this->getPriceProductStores()->contains($priceProductStore)) {
            ...
            $priceProductStore->setPriceProduct(null);
        }
     ...
     * Otherwise if this SpyPriceProduct is new, it will return
     * an empty collection; or if this SpyPriceProduct has previously
     * been saved, it will retrieve related PriceProductStores from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyPriceProduct.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function clear()
    {
        ...
        if (null !== $this->aSpyProductAbstract) {
            $this->aSpyProductAbstract->removePriceProduct($this);
        }
    ...
    {
        if ($this->isNew()) {
            $this->_eventName = 'Entity.spy_price_product.create';
        } else {
            $this->_eventName = 'Entity.spy_price_product.update';
        }
    ...
    protected function addSaveEventToMemory()
    {
        ...
        if ($this->_eventName !== 'Entity.spy_price_product.create') {
            if (!$this->_isModified) {
                return;
            }
    ...
    protected function addDeleteEventToMemory()
    {
        ...
        $data = [
            'name' => 'spy_price_product',
            'id' => $this->getPrimaryKey(),
            'event' => 'Entity.spy_price_product.delete',
            'foreignKeys' => $this->getForeignKeys(),
            'additionalValues' => $this->getAdditionalValues(),
        ];
    ...
    protected function getOriginalValues(): array
    {
        ...
        foreach ($this->_modifiedColumns as $modifiedColumn) {
            ...
            $field = str_replace('spy_price_product.', '', $modifiedColumn);
            $after = $this->$field;
    ...
    protected function getAdditionalValues(): array
    {
        ...
        foreach ($this->getAdditionalValueColumnNames() as $additionalValueColumnName) {
            $field = str_replace('spy_price_product.', '', $additionalValueColumnName);
    ...
    {
        $columnType = SpyPriceProductTableMap::getTableMap()->getColumn($column)->getType();
