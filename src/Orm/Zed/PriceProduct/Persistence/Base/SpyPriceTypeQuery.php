 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceType> find(ConnectionInterface $con = null) Return ChildSpyPriceType objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceType> findByIdPriceType(int $id_price_type) Return ChildSpyPriceType objects filtered by the id_price_type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceType> findByName(string $name) Return ChildSpyPriceType objects filtered by the name column
 * @method     ChildSpyPriceType[]|ObjectCollection findByPriceModeConfiguration(int $price_mode_configuration) Return ChildSpyPriceType objects filtered by the price_mode_configuration column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceType> findByPriceModeConfiguration(int $price_mode_configuration) Return ChildSpyPriceType objects filtered by the price_mode_configuration column
