...
class SpyRefundTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Refund.Persistence.Map.SpyRefundTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Refund\\Persistence\\SpyRefund';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Refund.Persistence.SpyRefund';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdRefund', 'FkSalesOrder', 'Amount', 'Comment', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('idRefund', 'fkSalesOrder', 'amount', 'comment', 'createdAt', ),
        self::TYPE_COLNAME       => array(SpyRefundTableMap::COL_ID_REFUND, SpyRefundTableMap::COL_FK_SALES_ORDER, SpyRefundTableMap::COL_AMOUNT, SpyRefundTableMap::COL_COMMENT, SpyRefundTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_refund', 'fk_sales_order', 'amount', 'comment', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdRefund' => 0, 'FkSalesOrder' => 1, 'Amount' => 2, 'Comment' => 3, 'CreatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idRefund' => 0, 'fkSalesOrder' => 1, 'amount' => 2, 'comment' => 3, 'createdAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyRefundTableMap::COL_ID_REFUND => 0, SpyRefundTableMap::COL_FK_SALES_ORDER => 1, SpyRefundTableMap::COL_AMOUNT => 2, SpyRefundTableMap::COL_COMMENT => 3, SpyRefundTableMap::COL_CREATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_refund' => 0, 'fk_sales_order' => 1, 'amount' => 2, 'comment' => 3, 'created_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
