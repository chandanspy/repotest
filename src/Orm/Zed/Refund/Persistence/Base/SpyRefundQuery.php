 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> find(ConnectionInterface $con = null) Return ChildSpyRefund objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> findByIdRefund(int $id_refund) Return ChildSpyRefund objects filtered by the id_refund column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> findByFkSalesOrder(int $fk_sales_order) Return ChildSpyRefund objects filtered by the fk_sales_order column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> findByAmount(int $amount) Return ChildSpyRefund objects filtered by the amount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> findByComment(string $comment) Return ChildSpyRefund objects filtered by the comment column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyRefund> findByCreatedAt(string $created_at) Return ChildSpyRefund objects filtered by the created_at column
