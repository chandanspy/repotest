...
class SpyShoppingListCustomerStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingListStorage.Persistence.Map.SpyShoppingListCustomerStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_customer_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingListStorage\\Persistence\\SpyShoppingListCustomerStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingListStorage.Persistence.SpyShoppingListCustomerStorage';
     ...
     */
    const COL_ID_SHOPPING_LIST_CUSTOMER_STORAGE = 'spy_shopping_list_customer_storage.id_shopping_list_customer_storage';

    /**
     * the column name for the customer_reference field
     */
    const COL_CUSTOMER_REFERENCE = 'spy_shopping_list_customer_storage.customer_reference';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_shopping_list_customer_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_shopping_list_customer_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_shopping_list_customer_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_shopping_list_customer_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_shopping_list_customer_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCustomerStorage', 'CustomerReference', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idShoppingListCustomerStorage', 'customerReference', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyShoppingListCustomerStorageTableMap::COL_ID_SHOPPING_LIST_CUSTOMER_STORAGE, SpyShoppingListCustomerStorageTableMap::COL_CUSTOMER_REFERENCE, SpyShoppingListCustomerStorageTableMap::COL_DATA, SpyShoppingListCustomerStorageTableMap::COL_KEY, SpyShoppingListCustomerStorageTableMap::COL_ALIAS_KEYS, SpyShoppingListCustomerStorageTableMap::COL_CREATED_AT, SpyShoppingListCustomerStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_customer_storage', 'customer_reference', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCustomerStorage' => 0, 'CustomerReference' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idShoppingListCustomerStorage' => 0, 'customerReference' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_shopping_list_customer_storage' => 0, 'customer_reference' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyShoppingListCustomerStorageTableMap
