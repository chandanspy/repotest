...
abstract class SpyShoppingListCustomerStorage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ShoppingListStorage\\Persistence\\Map\\SpyShoppingListCustomerStorageTableMap';
     ...
     * @return $this|\Orm\Zed\ShoppingListStorage\Persistence\SpyShoppingListCustomerStorage The current object (for fluent API support)
     */
    public function setIdShoppingListCustomerStorage($v)
    {
        ...
        return $this;
    } // setIdShoppingListCustomerStorage()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ShoppingListStorage\Persistence\SpyShoppingListCustomerStorage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ShoppingListStorage\Persistence\SpyShoppingListCustomerStorage The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyShoppingListCustomerStorage The current object (for fluent API support)
     */
