 ...
 *
 * @method     ChildSpyStockStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStockStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockStore> find(ConnectionInterface $con = null) Return ChildSpyStockStore objects based on current ModelCriteria
 * @method     ChildSpyStockStore[]|ObjectCollection findByIdStockStore(int $id_stock_store) Return ChildSpyStockStore objects filtered by the id_stock_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockStore> findByIdStockStore(int $id_stock_store) Return ChildSpyStockStore objects filtered by the id_stock_store column
 * @method     ChildSpyStockStore[]|ObjectCollection findByFkStock(int $fk_stock) Return ChildSpyStockStore objects filtered by the fk_stock column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockStore> findByFkStock(int $fk_stock) Return ChildSpyStockStore objects filtered by the fk_stock column
 * @method     ChildSpyStockStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyStockStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockStore> findByFkStore(int $fk_store) Return ChildSpyStockStore objects filtered by the fk_store column
...
abstract class SpyStockStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStockStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStockStoreTableMap::COL_ID_STOCK_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStockStoreTableMap::COL_ID_STOCK_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyStockStoreQuery The current query, for fluid interface
     */
