...
class SpyStockStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Stock.Persistence.Map.SpyStockStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_stock_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Stock\\Persistence\\SpyStockStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Stock.Persistence.SpyStockStore';
     ...
     */
    const COL_ID_STOCK_STORE = 'spy_stock_store.id_stock_store';

    /**
     * the column name for the fk_stock field
     */
    const COL_FK_STOCK = 'spy_stock_store.fk_stock';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_stock_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStockStore', 'FkStock', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idStockStore', 'fkStock', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyStockStoreTableMap::COL_ID_STOCK_STORE, SpyStockStoreTableMap::COL_FK_STOCK, SpyStockStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_stock_store', 'fk_stock', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStockStore' => 0, 'FkStock' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idStockStore' => 0, 'fkStock' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyStockStoreTableMap::COL_ID_STOCK_STORE => 0, SpyStockStoreTableMap::COL_FK_STOCK => 1, SpyStockStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_stock_store' => 0, 'fk_stock' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
