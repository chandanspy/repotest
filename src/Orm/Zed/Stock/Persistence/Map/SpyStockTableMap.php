...
class SpyStockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Stock.Persistence.Map.SpyStockTableMap';
     ...
     */
    const TABLE_NAME = 'spy_stock';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Stock\\Persistence\\SpyStock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Stock.Persistence.SpyStock';
     ...
     */
    const COL_ID_STOCK = 'spy_stock.id_stock';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_stock.is_active';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_stock.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStock', 'IsActive', 'Name', ),
        self::TYPE_CAMELNAME     => array('idStock', 'isActive', 'name', ),
        self::TYPE_COLNAME       => array(SpyStockTableMap::COL_ID_STOCK, SpyStockTableMap::COL_IS_ACTIVE, SpyStockTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_stock', 'is_active', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStock' => 0, 'IsActive' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('idStock' => 0, 'isActive' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(SpyStockTableMap::COL_ID_STOCK => 0, SpyStockTableMap::COL_IS_ACTIVE => 1, SpyStockTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id_stock' => 0, 'is_active' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
