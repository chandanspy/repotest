...
class SpyStockProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Stock.Persistence.Map.SpyStockProductTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Stock\\Persistence\\SpyStockProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Stock.Persistence.SpyStockProduct';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStockProduct', 'FkProduct', 'FkStock', 'IsNeverOutOfStock', 'Quantity', ),
        self::TYPE_CAMELNAME     => array('idStockProduct', 'fkProduct', 'fkStock', 'isNeverOutOfStock', 'quantity', ),
        self::TYPE_COLNAME       => array(SpyStockProductTableMap::COL_ID_STOCK_PRODUCT, SpyStockProductTableMap::COL_FK_PRODUCT, SpyStockProductTableMap::COL_FK_STOCK, SpyStockProductTableMap::COL_IS_NEVER_OUT_OF_STOCK, SpyStockProductTableMap::COL_QUANTITY, ),
        self::TYPE_FIELDNAME     => array('id_stock_product', 'fk_product', 'fk_stock', 'is_never_out_of_stock', 'quantity', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStockProduct' => 0, 'FkProduct' => 1, 'FkStock' => 2, 'IsNeverOutOfStock' => 3, 'Quantity' => 4, ),
        self::TYPE_CAMELNAME     => array('idStockProduct' => 0, 'fkProduct' => 1, 'fkStock' => 2, 'isNeverOutOfStock' => 3, 'quantity' => 4, ),
        self::TYPE_COLNAME       => array(SpyStockProductTableMap::COL_ID_STOCK_PRODUCT => 0, SpyStockProductTableMap::COL_FK_PRODUCT => 1, SpyStockProductTableMap::COL_FK_STOCK => 2, SpyStockProductTableMap::COL_IS_NEVER_OUT_OF_STOCK => 3, SpyStockProductTableMap::COL_QUANTITY => 4, ),
        self::TYPE_FIELDNAME     => array('id_stock_product' => 0, 'fk_product' => 1, 'fk_stock' => 2, 'is_never_out_of_stock' => 3, 'quantity' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
