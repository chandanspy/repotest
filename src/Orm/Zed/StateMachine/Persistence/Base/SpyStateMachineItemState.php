...
abstract class SpyStateMachineItemState implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\StateMachine\\Persistence\\Map\\SpyStateMachineItemStateTableMap';
     ...
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineItemState The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineItemState
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineItemState The current object, for fluid interface
     */
     ...
     */
    public function resetPartialStateMachineItemStates($v = true)
    {
     ...
     * @return void
     */
    public function initStateMachineItemStates($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyStateMachineItemState The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countStateMachineItemStates(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collStateMachineItemStatesPartial && !$this->isNew();
        if (null === $this->collStateMachineItemStates || null !== $criteria || $partial) {
     ...
     */
    protected function doAddStateMachineItemState(PyzExampleStateMachineItem $stateMachineItemState)
    {
     ...
     */
    protected function doAddStateHistory(ChildSpyStateMachineItemStateHistory $stateHistory)
    {
     ...
     */
    protected function doAddEventTimeout(ChildSpyStateMachineEventTimeout $eventTimeout)
    {
