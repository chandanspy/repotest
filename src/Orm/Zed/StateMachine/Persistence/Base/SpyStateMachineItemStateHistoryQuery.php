 ...
 *
 * @method     ChildSpyStateMachineItemStateHistory[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStateMachineItemStateHistory objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineItemStateHistory> find(ConnectionInterface $con = null) Return ChildSpyStateMachineItemStateHistory objects based on current ModelCriteria
 * @method     ChildSpyStateMachineItemStateHistory[]|ObjectCollection findByIdStateMachineItemStateHistory(int $id_state_machine_item_state_history) Return ChildSpyStateMachineItemStateHistory objects filtered by the id_state_machine_item_state_history column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineItemStateHistory> findByIdStateMachineItemStateHistory(int $id_state_machine_item_state_history) Return ChildSpyStateMachineItemStateHistory objects filtered by the id_state_machine_item_state_history column
 * @method     ChildSpyStateMachineItemStateHistory[]|ObjectCollection findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildSpyStateMachineItemStateHistory objects filtered by the fk_state_machine_item_state column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineItemStateHistory> findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildSpyStateMachineItemStateHistory objects filtered by the fk_state_machine_item_state column
 * @method     ChildSpyStateMachineItemStateHistory[]|ObjectCollection findByIdentifier(int $identifier) Return ChildSpyStateMachineItemStateHistory objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineItemStateHistory> findByIdentifier(int $identifier) Return ChildSpyStateMachineItemStateHistory objects filtered by the identifier column
 * @method     ChildSpyStateMachineItemStateHistory[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyStateMachineItemStateHistory objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineItemStateHistory> findByCreatedAt(string $created_at) Return ChildSpyStateMachineItemStateHistory objects filtered by the created_at column
...
abstract class SpyStateMachineItemStateHistoryQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStateMachineItemStateHistoryQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStateMachineItemStateHistoryTableMap::COL_ID_STATE_MACHINE_ITEM_STATE_HISTORY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStateMachineItemStateHistoryTableMap::COL_ID_STATE_MACHINE_ITEM_STATE_HISTORY, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyStateMachineItemStateHistoryQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineItemStateHistoryTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyStateMachineItemStateHistoryTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineItemStateHistoryTableMap::COL_CREATED_AT);
    }

} // SpyStateMachineItemStateHistoryQuery
