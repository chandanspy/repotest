 ...
 *
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStateMachineEventTimeout objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> find(ConnectionInterface $con = null) Return ChildSpyStateMachineEventTimeout objects based on current ModelCriteria
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByIdStateMachineEventTimeout(int $id_state_machine_event_timeout) Return ChildSpyStateMachineEventTimeout objects filtered by the id_state_machine_event_timeout column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByIdStateMachineEventTimeout(int $id_state_machine_event_timeout) Return ChildSpyStateMachineEventTimeout objects filtered by the id_state_machine_event_timeout column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildSpyStateMachineEventTimeout objects filtered by the fk_state_machine_item_state column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildSpyStateMachineEventTimeout objects filtered by the fk_state_machine_item_state column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByFkStateMachineProcess(int $fk_state_machine_process) Return ChildSpyStateMachineEventTimeout objects filtered by the fk_state_machine_process column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByFkStateMachineProcess(int $fk_state_machine_process) Return ChildSpyStateMachineEventTimeout objects filtered by the fk_state_machine_process column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByEvent(string $event) Return ChildSpyStateMachineEventTimeout objects filtered by the event column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByEvent(string $event) Return ChildSpyStateMachineEventTimeout objects filtered by the event column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByIdentifier(int $identifier) Return ChildSpyStateMachineEventTimeout objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByIdentifier(int $identifier) Return ChildSpyStateMachineEventTimeout objects filtered by the identifier column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByTimeout(string $timeout) Return ChildSpyStateMachineEventTimeout objects filtered by the timeout column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByTimeout(string $timeout) Return ChildSpyStateMachineEventTimeout objects filtered by the timeout column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyStateMachineEventTimeout objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByCreatedAt(string $created_at) Return ChildSpyStateMachineEventTimeout objects filtered by the created_at column
 * @method     ChildSpyStateMachineEventTimeout[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyStateMachineEventTimeout objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineEventTimeout> findByUpdatedAt(string $updated_at) Return ChildSpyStateMachineEventTimeout objects filtered by the updated_at column
...
abstract class SpyStateMachineEventTimeoutQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStateMachineEventTimeoutQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStateMachineEventTimeoutTableMap::COL_ID_STATE_MACHINE_EVENT_TIMEOUT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStateMachineEventTimeoutTableMap::COL_ID_STATE_MACHINE_EVENT_TIMEOUT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyStateMachineEventTimeoutQuery The current query, for fluid interface
     */
    public function filterByState($spyStateMachineItemState, $comparison = null)
    {
    ...
    {
        return $this->addUsingAlias(SpyStateMachineEventTimeoutTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineEventTimeoutTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineEventTimeoutTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineEventTimeoutTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyStateMachineEventTimeoutTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineEventTimeoutTableMap::COL_CREATED_AT);
    }

} // SpyStateMachineEventTimeoutQuery
