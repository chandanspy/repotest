 ...
 *
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStateMachineTransitionLog objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> find(ConnectionInterface $con = null) Return ChildSpyStateMachineTransitionLog objects based on current ModelCriteria
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByIdStateMachineTransitionLog(int $id_state_machine_transition_log) Return ChildSpyStateMachineTransitionLog objects filtered by the id_state_machine_transition_log column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByIdStateMachineTransitionLog(int $id_state_machine_transition_log) Return ChildSpyStateMachineTransitionLog objects filtered by the id_state_machine_transition_log column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByFkStateMachineProcess(int $fk_state_machine_process) Return ChildSpyStateMachineTransitionLog objects filtered by the fk_state_machine_process column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByFkStateMachineProcess(int $fk_state_machine_process) Return ChildSpyStateMachineTransitionLog objects filtered by the fk_state_machine_process column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByCommand(string $command) Return ChildSpyStateMachineTransitionLog objects filtered by the command column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByCommand(string $command) Return ChildSpyStateMachineTransitionLog objects filtered by the command column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByCondition(string $condition) Return ChildSpyStateMachineTransitionLog objects filtered by the condition column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByCondition(string $condition) Return ChildSpyStateMachineTransitionLog objects filtered by the condition column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByErrorMessage(string $error_message) Return ChildSpyStateMachineTransitionLog objects filtered by the error_message column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByErrorMessage(string $error_message) Return ChildSpyStateMachineTransitionLog objects filtered by the error_message column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByEvent(string $event) Return ChildSpyStateMachineTransitionLog objects filtered by the event column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByEvent(string $event) Return ChildSpyStateMachineTransitionLog objects filtered by the event column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByHostname(string $hostname) Return ChildSpyStateMachineTransitionLog objects filtered by the hostname column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByHostname(string $hostname) Return ChildSpyStateMachineTransitionLog objects filtered by the hostname column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByIdentifier(int $identifier) Return ChildSpyStateMachineTransitionLog objects filtered by the identifier column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByIdentifier(int $identifier) Return ChildSpyStateMachineTransitionLog objects filtered by the identifier column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByIsError(boolean $is_error) Return ChildSpyStateMachineTransitionLog objects filtered by the is_error column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByIsError(boolean $is_error) Return ChildSpyStateMachineTransitionLog objects filtered by the is_error column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByLocked(boolean $locked) Return ChildSpyStateMachineTransitionLog objects filtered by the locked column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByLocked(boolean $locked) Return ChildSpyStateMachineTransitionLog objects filtered by the locked column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByParams(array $params) Return ChildSpyStateMachineTransitionLog objects filtered by the params column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByParams(array $params) Return ChildSpyStateMachineTransitionLog objects filtered by the params column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByPath(string $path) Return ChildSpyStateMachineTransitionLog objects filtered by the path column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByPath(string $path) Return ChildSpyStateMachineTransitionLog objects filtered by the path column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findBySourceState(string $source_state) Return ChildSpyStateMachineTransitionLog objects filtered by the source_state column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findBySourceState(string $source_state) Return ChildSpyStateMachineTransitionLog objects filtered by the source_state column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByTargetState(string $target_state) Return ChildSpyStateMachineTransitionLog objects filtered by the target_state column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByTargetState(string $target_state) Return ChildSpyStateMachineTransitionLog objects filtered by the target_state column
 * @method     ChildSpyStateMachineTransitionLog[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyStateMachineTransitionLog objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineTransitionLog> findByCreatedAt(string $created_at) Return ChildSpyStateMachineTransitionLog objects filtered by the created_at column
...
abstract class SpyStateMachineTransitionLogQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStateMachineTransitionLogQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStateMachineTransitionLogTableMap::COL_ID_STATE_MACHINE_TRANSITION_LOG, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStateMachineTransitionLogTableMap::COL_ID_STATE_MACHINE_TRANSITION_LOG, $keys, Criteria::IN);
    }
    ...
    public function filterByParam($params = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyStateMachineTransitionLogTableMap::COL_PARAMS, $params, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyStateMachineTransitionLogQuery The current query, for fluid interface
     */
    public function filterByProcess($spyStateMachineProcess, $comparison = null)
    {
     ...
     * @return $this|ChildSpyStateMachineTransitionLogQuery The current query, for fluid interface
     */
    public function joinProcess($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineTransitionLogTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyStateMachineTransitionLogTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineTransitionLogTableMap::COL_CREATED_AT);
    }

} // SpyStateMachineTransitionLogQuery
