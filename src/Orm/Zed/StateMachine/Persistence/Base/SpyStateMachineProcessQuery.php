 ...
 *
 * @method     \Orm\Zed\StateMachine\Persistence\SpyStateMachineTransitionLogQuery|\Orm\Zed\StateMachine\Persistence\SpyStateMachineItemStateQuery|\Orm\Zed\StateMachine\Persistence\SpyStateMachineEventTimeoutQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStateMachineProcess objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> find(ConnectionInterface $con = null) Return ChildSpyStateMachineProcess objects based on current ModelCriteria
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection findByIdStateMachineProcess(int $id_state_machine_process) Return ChildSpyStateMachineProcess objects filtered by the id_state_machine_process column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> findByIdStateMachineProcess(int $id_state_machine_process) Return ChildSpyStateMachineProcess objects filtered by the id_state_machine_process column
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection findByName(string $name) Return ChildSpyStateMachineProcess objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> findByName(string $name) Return ChildSpyStateMachineProcess objects filtered by the name column
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection findByStateMachineName(string $state_machine_name) Return ChildSpyStateMachineProcess objects filtered by the state_machine_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> findByStateMachineName(string $state_machine_name) Return ChildSpyStateMachineProcess objects filtered by the state_machine_name column
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyStateMachineProcess objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> findByCreatedAt(string $created_at) Return ChildSpyStateMachineProcess objects filtered by the created_at column
 * @method     ChildSpyStateMachineProcess[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyStateMachineProcess objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStateMachineProcess> findByUpdatedAt(string $updated_at) Return ChildSpyStateMachineProcess objects filtered by the updated_at column
...
abstract class SpyStateMachineProcessQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStateMachineProcessTableMap::COL_ID_STATE_MACHINE_PROCESS, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStateMachineProcessTableMap::COL_ID_STATE_MACHINE_PROCESS, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function filterByTransitionLog($spyStateMachineTransitionLog, $comparison = null)
    {
     ...
     * @return ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function filterByStateMachineProcess($spyStateMachineItemState, $comparison = null)
    {
     ...
     * @return $this|ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function joinStateMachineProcess($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('StateMachineProcess', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('StateMachineProcess', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function filterByStateMachineProcessTimeout($spyStateMachineEventTimeout, $comparison = null)
    {
     ...
     * @return $this|ChildSpyStateMachineProcessQuery The current query, for fluid interface
     */
    public function joinStateMachineProcessTimeout($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('StateMachineProcessTimeout', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('StateMachineProcessTimeout', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyStateMachineProcessTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineProcessTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineProcessTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyStateMachineProcessTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyStateMachineProcessTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyStateMachineProcessTableMap::COL_CREATED_AT);
    }
