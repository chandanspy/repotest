...
abstract class SpyStateMachineTransitionLog implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\StateMachine\\Persistence\\Map\\SpyStateMachineTransitionLogTableMap';
     ...
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineTransitionLog The current object (for fluent API support)
     */
    public function setIdStateMachineTransitionLog($v)
    {
        ...
        return $this;
    } // setIdStateMachineTransitionLog()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineTransitionLog
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\StateMachine\Persistence\SpyStateMachineTransitionLog The current object, for fluid interface
     */
