...
class SpyStateMachineEventTimeoutTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.StateMachine.Persistence.Map.SpyStateMachineEventTimeoutTableMap';
     ...
     */
    const TABLE_NAME = 'spy_state_machine_event_timeout';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\StateMachine\\Persistence\\SpyStateMachineEventTimeout';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.StateMachine.Persistence.SpyStateMachineEventTimeout';
     ...
     */
    const COL_ID_STATE_MACHINE_EVENT_TIMEOUT = 'spy_state_machine_event_timeout.id_state_machine_event_timeout';

    /**
     * the column name for the fk_state_machine_item_state field
     */
    const COL_FK_STATE_MACHINE_ITEM_STATE = 'spy_state_machine_event_timeout.fk_state_machine_item_state';

    /**
     * the column name for the fk_state_machine_process field
     */
    const COL_FK_STATE_MACHINE_PROCESS = 'spy_state_machine_event_timeout.fk_state_machine_process';

    /**
     * the column name for the event field
     */
    const COL_EVENT = 'spy_state_machine_event_timeout.event';

    /**
     * the column name for the identifier field
     */
    const COL_IDENTIFIER = 'spy_state_machine_event_timeout.identifier';

    /**
     * the column name for the timeout field
     */
    const COL_TIMEOUT = 'spy_state_machine_event_timeout.timeout';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_state_machine_event_timeout.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_state_machine_event_timeout.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStateMachineEventTimeout', 'FkStateMachineItemState', 'FkStateMachineProcess', 'Event', 'Identifier', 'Timeout', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idStateMachineEventTimeout', 'fkStateMachineItemState', 'fkStateMachineProcess', 'event', 'identifier', 'timeout', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyStateMachineEventTimeoutTableMap::COL_ID_STATE_MACHINE_EVENT_TIMEOUT, SpyStateMachineEventTimeoutTableMap::COL_FK_STATE_MACHINE_ITEM_STATE, SpyStateMachineEventTimeoutTableMap::COL_FK_STATE_MACHINE_PROCESS, SpyStateMachineEventTimeoutTableMap::COL_EVENT, SpyStateMachineEventTimeoutTableMap::COL_IDENTIFIER, SpyStateMachineEventTimeoutTableMap::COL_TIMEOUT, SpyStateMachineEventTimeoutTableMap::COL_CREATED_AT, SpyStateMachineEventTimeoutTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_state_machine_event_timeout', 'fk_state_machine_item_state', 'fk_state_machine_process', 'event', 'identifier', 'timeout', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStateMachineEventTimeout' => 0, 'FkStateMachineItemState' => 1, 'FkStateMachineProcess' => 2, 'Event' => 3, 'Identifier' => 4, 'Timeout' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idStateMachineEventTimeout' => 0, 'fkStateMachineItemState' => 1, 'fkStateMachineProcess' => 2, 'event' => 3, 'identifier' => 4, 'timeout' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_state_machine_event_timeout' => 0, 'fk_state_machine_item_state' => 1, 'fk_state_machine_process' => 2, 'event' => 3, 'identifier' => 4, 'timeout' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
