...
class SpyStateMachineItemStateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.StateMachine.Persistence.Map.SpyStateMachineItemStateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_state_machine_item_state';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\StateMachine\\Persistence\\SpyStateMachineItemState';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.StateMachine.Persistence.SpyStateMachineItemState';
     ...
     */
    const COL_ID_STATE_MACHINE_ITEM_STATE = 'spy_state_machine_item_state.id_state_machine_item_state';

    /**
     * the column name for the fk_state_machine_process field
     */
    const COL_FK_STATE_MACHINE_PROCESS = 'spy_state_machine_item_state.fk_state_machine_process';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_state_machine_item_state.description';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_state_machine_item_state.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStateMachineItemState', 'FkStateMachineProcess', 'Description', 'Name', ),
        self::TYPE_CAMELNAME     => array('idStateMachineItemState', 'fkStateMachineProcess', 'description', 'name', ),
        self::TYPE_COLNAME       => array(SpyStateMachineItemStateTableMap::COL_ID_STATE_MACHINE_ITEM_STATE, SpyStateMachineItemStateTableMap::COL_FK_STATE_MACHINE_PROCESS, SpyStateMachineItemStateTableMap::COL_DESCRIPTION, SpyStateMachineItemStateTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_state_machine_item_state', 'fk_state_machine_process', 'description', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStateMachineItemState' => 0, 'FkStateMachineProcess' => 1, 'Description' => 2, 'Name' => 3, ),
        self::TYPE_CAMELNAME     => array('idStateMachineItemState' => 0, 'fkStateMachineProcess' => 1, 'description' => 2, 'name' => 3, ),
        self::TYPE_COLNAME       => array(SpyStateMachineItemStateTableMap::COL_ID_STATE_MACHINE_ITEM_STATE => 0, SpyStateMachineItemStateTableMap::COL_FK_STATE_MACHINE_PROCESS => 1, SpyStateMachineItemStateTableMap::COL_DESCRIPTION => 2, SpyStateMachineItemStateTableMap::COL_NAME => 3, ),
        self::TYPE_FIELDNAME     => array('id_state_machine_item_state' => 0, 'fk_state_machine_process' => 1, 'description' => 2, 'name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyStateMachineItemStateTableMap
