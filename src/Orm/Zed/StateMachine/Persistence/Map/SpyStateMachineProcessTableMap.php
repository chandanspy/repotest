...
class SpyStateMachineProcessTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.StateMachine.Persistence.Map.SpyStateMachineProcessTableMap';
     ...
     */
    const TABLE_NAME = 'spy_state_machine_process';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\StateMachine\\Persistence\\SpyStateMachineProcess';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.StateMachine.Persistence.SpyStateMachineProcess';
     ...
     */
    const COL_ID_STATE_MACHINE_PROCESS = 'spy_state_machine_process.id_state_machine_process';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_state_machine_process.name';

    /**
     * the column name for the state_machine_name field
     */
    const COL_STATE_MACHINE_NAME = 'spy_state_machine_process.state_machine_name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_state_machine_process.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_state_machine_process.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStateMachineProcess', 'Name', 'StateMachineName', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idStateMachineProcess', 'name', 'stateMachineName', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyStateMachineProcessTableMap::COL_ID_STATE_MACHINE_PROCESS, SpyStateMachineProcessTableMap::COL_NAME, SpyStateMachineProcessTableMap::COL_STATE_MACHINE_NAME, SpyStateMachineProcessTableMap::COL_CREATED_AT, SpyStateMachineProcessTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_state_machine_process', 'name', 'state_machine_name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStateMachineProcess' => 0, 'Name' => 1, 'StateMachineName' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idStateMachineProcess' => 0, 'name' => 1, 'stateMachineName' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyStateMachineProcessTableMap::COL_ID_STATE_MACHINE_PROCESS => 0, SpyStateMachineProcessTableMap::COL_NAME => 1, SpyStateMachineProcessTableMap::COL_STATE_MACHINE_NAME => 2, SpyStateMachineProcessTableMap::COL_CREATED_AT => 3, SpyStateMachineProcessTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_state_machine_process' => 0, 'name' => 1, 'state_machine_name' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyStateMachineProcessTableMap
