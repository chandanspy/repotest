...
abstract class SpyProductCategory implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductCategory\\Persistence\\Map\\SpyProductCategoryTableMap';
     ...
     * @return $this|\Orm\Zed\ProductCategory\Persistence\SpyProductCategory The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductCategory\Persistence\SpyProductCategory
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductCategory\Persistence\SpyProductCategory The current object, for fluid interface
     */
