 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategory> find(ConnectionInterface $con = null) Return ChildSpyProductCategory objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategory> findByIdProductCategory(int $id_product_category) Return ChildSpyProductCategory objects filtered by the id_product_category column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategory> findByFkCategory(int $fk_category) Return ChildSpyProductCategory objects filtered by the fk_category column
 * @method     ChildSpyProductCategory[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductCategory objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategory> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductCategory objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductCategory[]|ObjectCollection findByProductOrder(int $product_order) Return ChildSpyProductCategory objects filtered by the product_order column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategory> findByProductOrder(int $product_order) Return ChildSpyProductCategory objects filtered by the product_order column
