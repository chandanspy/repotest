...
class SpyCmsSlotBlockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsSlotBlock.Persistence.Map.SpyCmsSlotBlockTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_slot_block';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsSlotBlock\\Persistence\\SpyCmsSlotBlock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsSlotBlock.Persistence.SpyCmsSlotBlock';
     ...
     */
    const COL_ID_CMS_SLOT_BLOCK = 'spy_cms_slot_block.id_cms_slot_block';

    /**
     * the column name for the fk_cms_block field
     */
    const COL_FK_CMS_BLOCK = 'spy_cms_slot_block.fk_cms_block';

    /**
     * the column name for the fk_cms_slot field
     */
    const COL_FK_CMS_SLOT = 'spy_cms_slot_block.fk_cms_slot';

    /**
     * the column name for the fk_cms_slot_template field
     */
    const COL_FK_CMS_SLOT_TEMPLATE = 'spy_cms_slot_block.fk_cms_slot_template';

    /**
     * the column name for the conditions field
     */
    const COL_CONDITIONS = 'spy_cms_slot_block.conditions';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_cms_slot_block.position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotBlock', 'FkCmsBlock', 'FkCmsSlot', 'FkCmsSlotTemplate', 'Conditions', 'Position', ),
        self::TYPE_CAMELNAME     => array('idCmsSlotBlock', 'fkCmsBlock', 'fkCmsSlot', 'fkCmsSlotTemplate', 'conditions', 'position', ),
        self::TYPE_COLNAME       => array(SpyCmsSlotBlockTableMap::COL_ID_CMS_SLOT_BLOCK, SpyCmsSlotBlockTableMap::COL_FK_CMS_BLOCK, SpyCmsSlotBlockTableMap::COL_FK_CMS_SLOT, SpyCmsSlotBlockTableMap::COL_FK_CMS_SLOT_TEMPLATE, SpyCmsSlotBlockTableMap::COL_CONDITIONS, SpyCmsSlotBlockTableMap::COL_POSITION, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_block', 'fk_cms_block', 'fk_cms_slot', 'fk_cms_slot_template', 'conditions', 'position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsSlotBlock' => 0, 'FkCmsBlock' => 1, 'FkCmsSlot' => 2, 'FkCmsSlotTemplate' => 3, 'Conditions' => 4, 'Position' => 5, ),
        self::TYPE_CAMELNAME     => array('idCmsSlotBlock' => 0, 'fkCmsBlock' => 1, 'fkCmsSlot' => 2, 'fkCmsSlotTemplate' => 3, 'conditions' => 4, 'position' => 5, ),
        self::TYPE_COLNAME       => array(SpyCmsSlotBlockTableMap::COL_ID_CMS_SLOT_BLOCK => 0, SpyCmsSlotBlockTableMap::COL_FK_CMS_BLOCK => 1, SpyCmsSlotBlockTableMap::COL_FK_CMS_SLOT => 2, SpyCmsSlotBlockTableMap::COL_FK_CMS_SLOT_TEMPLATE => 3, SpyCmsSlotBlockTableMap::COL_CONDITIONS => 4, SpyCmsSlotBlockTableMap::COL_POSITION => 5, ),
        self::TYPE_FIELDNAME     => array('id_cms_slot_block' => 0, 'fk_cms_block' => 1, 'fk_cms_slot' => 2, 'fk_cms_slot_template' => 3, 'conditions' => 4, 'position' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
