 ...
 *
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsSlotBlock objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> find(ConnectionInterface $con = null) Return ChildSpyCmsSlotBlock objects based on current ModelCriteria
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByIdCmsSlotBlock(string $id_cms_slot_block) Return ChildSpyCmsSlotBlock objects filtered by the id_cms_slot_block column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByIdCmsSlotBlock(string $id_cms_slot_block) Return ChildSpyCmsSlotBlock objects filtered by the id_cms_slot_block column
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_block column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByFkCmsBlock(int $fk_cms_block) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_block column
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByFkCmsSlot(int $fk_cms_slot) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByFkCmsSlot(int $fk_cms_slot) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_slot column
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByFkCmsSlotTemplate(int $fk_cms_slot_template) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_slot_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByFkCmsSlotTemplate(int $fk_cms_slot_template) Return ChildSpyCmsSlotBlock objects filtered by the fk_cms_slot_template column
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByConditions(string $conditions) Return ChildSpyCmsSlotBlock objects filtered by the conditions column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByConditions(string $conditions) Return ChildSpyCmsSlotBlock objects filtered by the conditions column
 * @method     ChildSpyCmsSlotBlock[]|ObjectCollection findByPosition(int $position) Return ChildSpyCmsSlotBlock objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsSlotBlock> findByPosition(int $position) Return ChildSpyCmsSlotBlock objects filtered by the position column
...
abstract class SpyCmsSlotBlockQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsSlotBlockQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsSlotBlockTableMap::COL_ID_CMS_SLOT_BLOCK, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsSlotBlockTableMap::COL_ID_CMS_SLOT_BLOCK, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCmsSlotBlockQuery The current query, for fluid interface
     */
    public function filterByCmsSlotTemplate($spyCmsSlotTemplate, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsSlotBlockQuery The current query, for fluid interface
     */
    public function joinCmsSlotTemplate($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('CmsSlotTemplate', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('CmsSlotTemplate', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCmsSlotBlockQuery The current query, for fluid interface
     */
    public function filterByCmsSlot($spyCmsSlot, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCmsSlotBlockQuery The current query, for fluid interface
     */
    public function joinCmsSlot($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('CmsSlot', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('CmsSlot', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
