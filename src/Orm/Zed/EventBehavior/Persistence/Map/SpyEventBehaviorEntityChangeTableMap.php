...
class SpyEventBehaviorEntityChangeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.EventBehavior.Persistence.Map.SpyEventBehaviorEntityChangeTableMap';
     ...
     */
    const TABLE_NAME = 'spy_event_behavior_entity_change';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\EventBehavior\\Persistence\\SpyEventBehaviorEntityChange';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.EventBehavior.Persistence.SpyEventBehaviorEntityChange';
     ...
     */
    const COL_ID_EVENT_BEHAVIOR_ENTITY_CHANGE = 'spy_event_behavior_entity_change.id_event_behavior_entity_change';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_event_behavior_entity_change.data';

    /**
     * the column name for the process_id field
     */
    const COL_PROCESS_ID = 'spy_event_behavior_entity_change.process_id';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_event_behavior_entity_change.created_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdEventBehaviorEntityChange', 'Data', 'ProcessId', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('idEventBehaviorEntityChange', 'data', 'processId', 'createdAt', ),
        self::TYPE_COLNAME       => array(SpyEventBehaviorEntityChangeTableMap::COL_ID_EVENT_BEHAVIOR_ENTITY_CHANGE, SpyEventBehaviorEntityChangeTableMap::COL_DATA, SpyEventBehaviorEntityChangeTableMap::COL_PROCESS_ID, SpyEventBehaviorEntityChangeTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_event_behavior_entity_change', 'data', 'process_id', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdEventBehaviorEntityChange' => 0, 'Data' => 1, 'ProcessId' => 2, 'CreatedAt' => 3, ),
        self::TYPE_CAMELNAME     => array('idEventBehaviorEntityChange' => 0, 'data' => 1, 'processId' => 2, 'createdAt' => 3, ),
        self::TYPE_COLNAME       => array(SpyEventBehaviorEntityChangeTableMap::COL_ID_EVENT_BEHAVIOR_ENTITY_CHANGE => 0, SpyEventBehaviorEntityChangeTableMap::COL_DATA => 1, SpyEventBehaviorEntityChangeTableMap::COL_PROCESS_ID => 2, SpyEventBehaviorEntityChangeTableMap::COL_CREATED_AT => 3, ),
        self::TYPE_FIELDNAME     => array('id_event_behavior_entity_change' => 0, 'data' => 1, 'process_id' => 2, 'created_at' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPackage('src.Orm.Zed.EventBehavior.Persistence');
...
} // SpyEventBehaviorEntityChangeTableMap
