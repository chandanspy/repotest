 ...
 *
 * @method     ChildSpyEventBehaviorEntityChange[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyEventBehaviorEntityChange objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyEventBehaviorEntityChange> find(ConnectionInterface $con = null) Return ChildSpyEventBehaviorEntityChange objects based on current ModelCriteria
 * @method     ChildSpyEventBehaviorEntityChange[]|ObjectCollection findByIdEventBehaviorEntityChange(string $id_event_behavior_entity_change) Return ChildSpyEventBehaviorEntityChange objects filtered by the id_event_behavior_entity_change column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyEventBehaviorEntityChange> findByIdEventBehaviorEntityChange(string $id_event_behavior_entity_change) Return ChildSpyEventBehaviorEntityChange objects filtered by the id_event_behavior_entity_change column
 * @method     ChildSpyEventBehaviorEntityChange[]|ObjectCollection findByData(string $data) Return ChildSpyEventBehaviorEntityChange objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyEventBehaviorEntityChange> findByData(string $data) Return ChildSpyEventBehaviorEntityChange objects filtered by the data column
 * @method     ChildSpyEventBehaviorEntityChange[]|ObjectCollection findByProcessId(string $process_id) Return ChildSpyEventBehaviorEntityChange objects filtered by the process_id column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyEventBehaviorEntityChange> findByProcessId(string $process_id) Return ChildSpyEventBehaviorEntityChange objects filtered by the process_id column
 * @method     ChildSpyEventBehaviorEntityChange[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyEventBehaviorEntityChange objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyEventBehaviorEntityChange> findByCreatedAt(string $created_at) Return ChildSpyEventBehaviorEntityChange objects filtered by the created_at column
...
abstract class SpyEventBehaviorEntityChangeQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyEventBehaviorEntityChangeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyEventBehaviorEntityChangeTableMap::COL_ID_EVENT_BEHAVIOR_ENTITY_CHANGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyEventBehaviorEntityChangeTableMap::COL_ID_EVENT_BEHAVIOR_ENTITY_CHANGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyEventBehaviorEntityChangeTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyEventBehaviorEntityChangeTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyEventBehaviorEntityChangeTableMap::COL_CREATED_AT);
    }

} // SpyEventBehaviorEntityChangeQuery
