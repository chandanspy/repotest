...
class SpySalesReturnReasonSearchTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesReturnSearch.Persistence.Map.SpySalesReturnReasonSearchTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_return_reason_search';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesReturnSearch\\Persistence\\SpySalesReturnReasonSearch';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesReturnSearch.Persistence.SpySalesReturnReasonSearch';
     ...
     */
    const COL_ID_SALES_RETURN_REASON_SEARCH = 'spy_sales_return_reason_search.id_sales_return_reason_search';

    /**
     * the column name for the fk_sales_return_reason field
     */
    const COL_FK_SALES_RETURN_REASON = 'spy_sales_return_reason_search.fk_sales_return_reason';

    /**
     * the column name for the structured_data field
     */
    const COL_STRUCTURED_DATA = 'spy_sales_return_reason_search.structured_data';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_sales_return_reason_search.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_sales_return_reason_search.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_sales_return_reason_search.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_sales_return_reason_search.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_return_reason_search.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_return_reason_search.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesReturnReasonSearch', 'FkSalesReturnReason', 'StructuredData', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesReturnReasonSearch', 'fkSalesReturnReason', 'structuredData', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesReturnReasonSearchTableMap::COL_ID_SALES_RETURN_REASON_SEARCH, SpySalesReturnReasonSearchTableMap::COL_FK_SALES_RETURN_REASON, SpySalesReturnReasonSearchTableMap::COL_STRUCTURED_DATA, SpySalesReturnReasonSearchTableMap::COL_DATA, SpySalesReturnReasonSearchTableMap::COL_LOCALE, SpySalesReturnReasonSearchTableMap::COL_ALIAS_KEYS, SpySalesReturnReasonSearchTableMap::COL_KEY, SpySalesReturnReasonSearchTableMap::COL_CREATED_AT, SpySalesReturnReasonSearchTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_return_reason_search', 'fk_sales_return_reason', 'structured_data', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesReturnReasonSearch' => 0, 'FkSalesReturnReason' => 1, 'StructuredData' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idSalesReturnReasonSearch' => 0, 'fkSalesReturnReason' => 1, 'structuredData' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_return_reason_search' => 0, 'fk_sales_return_reason' => 1, 'structured_data' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
