...
class SpyProductReviewSearchTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductReviewSearch.Persistence.Map.SpyProductReviewSearchTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_review_search';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductReviewSearch\\Persistence\\SpyProductReviewSearch';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductReviewSearch.Persistence.SpyProductReviewSearch';
     ...
     */
    const COL_ID_PRODUCT_REVIEW_SEARCH = 'spy_product_review_search.id_product_review_search';

    /**
     * the column name for the fk_product_review field
     */
    const COL_FK_PRODUCT_REVIEW = 'spy_product_review_search.fk_product_review';

    /**
     * the column name for the structured_data field
     */
    const COL_STRUCTURED_DATA = 'spy_product_review_search.structured_data';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_review_search.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_review_search.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_review_search.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_review_search.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_review_search.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductReviewSearch', 'FkProductReview', 'StructuredData', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductReviewSearch', 'fkProductReview', 'structuredData', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductReviewSearchTableMap::COL_ID_PRODUCT_REVIEW_SEARCH, SpyProductReviewSearchTableMap::COL_FK_PRODUCT_REVIEW, SpyProductReviewSearchTableMap::COL_STRUCTURED_DATA, SpyProductReviewSearchTableMap::COL_DATA, SpyProductReviewSearchTableMap::COL_ALIAS_KEYS, SpyProductReviewSearchTableMap::COL_KEY, SpyProductReviewSearchTableMap::COL_CREATED_AT, SpyProductReviewSearchTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_review_search', 'fk_product_review', 'structured_data', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductReviewSearch' => 0, 'FkProductReview' => 1, 'StructuredData' => 2, 'Data' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductReviewSearch' => 0, 'fkProductReview' => 1, 'structuredData' => 2, 'data' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyProductReviewSearchTableMap::COL_ID_PRODUCT_REVIEW_SEARCH => 0, SpyProductReviewSearchTableMap::COL_FK_PRODUCT_REVIEW => 1, SpyProductReviewSearchTableMap::COL_STRUCTURED_DATA => 2, SpyProductReviewSearchTableMap::COL_DATA => 3, SpyProductReviewSearchTableMap::COL_ALIAS_KEYS => 4, SpyProductReviewSearchTableMap::COL_KEY => 5, SpyProductReviewSearchTableMap::COL_CREATED_AT => 6, SpyProductReviewSearchTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_product_review_search' => 0, 'fk_product_review' => 1, 'structured_data' => 2, 'data' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
...
} // SpyProductReviewSearchTableMap
