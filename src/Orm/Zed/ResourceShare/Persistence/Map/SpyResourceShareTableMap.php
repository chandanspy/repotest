...
class SpyResourceShareTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ResourceShare.Persistence.Map.SpyResourceShareTableMap';
     ...
     */
    const TABLE_NAME = 'spy_resource_share';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ResourceShare\\Persistence\\SpyResourceShare';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ResourceShare.Persistence.SpyResourceShare';
     ...
     */
    const COL_ID_RESOURCE_SHARE = 'spy_resource_share.id_resource_share';

    /**
     * the column name for the customer_reference field
     */
    const COL_CUSTOMER_REFERENCE = 'spy_resource_share.customer_reference';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_resource_share.uuid';

    /**
     * the column name for the resource_type field
     */
    const COL_RESOURCE_TYPE = 'spy_resource_share.resource_type';

    /**
     * the column name for the resource_data field
     */
    const COL_RESOURCE_DATA = 'spy_resource_share.resource_data';

    /**
     * the column name for the expiry_date field
     */
    const COL_EXPIRY_DATE = 'spy_resource_share.expiry_date';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_resource_share.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_resource_share.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdResourceShare', 'CustomerReference', 'Uuid', 'ResourceType', 'ResourceData', 'ExpiryDate', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idResourceShare', 'customerReference', 'uuid', 'resourceType', 'resourceData', 'expiryDate', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyResourceShareTableMap::COL_ID_RESOURCE_SHARE, SpyResourceShareTableMap::COL_CUSTOMER_REFERENCE, SpyResourceShareTableMap::COL_UUID, SpyResourceShareTableMap::COL_RESOURCE_TYPE, SpyResourceShareTableMap::COL_RESOURCE_DATA, SpyResourceShareTableMap::COL_EXPIRY_DATE, SpyResourceShareTableMap::COL_CREATED_AT, SpyResourceShareTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_resource_share', 'customer_reference', 'uuid', 'resource_type', 'resource_data', 'expiry_date', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdResourceShare' => 0, 'CustomerReference' => 1, 'Uuid' => 2, 'ResourceType' => 3, 'ResourceData' => 4, 'ExpiryDate' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idResourceShare' => 0, 'customerReference' => 1, 'uuid' => 2, 'resourceType' => 3, 'resourceData' => 4, 'expiryDate' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyResourceShareTableMap::COL_ID_RESOURCE_SHARE => 0, SpyResourceShareTableMap::COL_CUSTOMER_REFERENCE => 1, SpyResourceShareTableMap::COL_UUID => 2, SpyResourceShareTableMap::COL_RESOURCE_TYPE => 3, SpyResourceShareTableMap::COL_RESOURCE_DATA => 4, SpyResourceShareTableMap::COL_EXPIRY_DATE => 5, SpyResourceShareTableMap::COL_CREATED_AT => 6, SpyResourceShareTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_resource_share' => 0, 'customer_reference' => 1, 'uuid' => 2, 'resource_type' => 3, 'resource_data' => 4, 'expiry_date' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
