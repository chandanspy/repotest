 ...
 *
 * @method     ChildSpyResourceShare[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyResourceShare objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> find(ConnectionInterface $con = null) Return ChildSpyResourceShare objects based on current ModelCriteria
 * @method     ChildSpyResourceShare[]|ObjectCollection findByIdResourceShare(int $id_resource_share) Return ChildSpyResourceShare objects filtered by the id_resource_share column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByIdResourceShare(int $id_resource_share) Return ChildSpyResourceShare objects filtered by the id_resource_share column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpyResourceShare objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByCustomerReference(string $customer_reference) Return ChildSpyResourceShare objects filtered by the customer_reference column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyResourceShare objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByUuid(string $uuid) Return ChildSpyResourceShare objects filtered by the uuid column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByResourceType(string $resource_type) Return ChildSpyResourceShare objects filtered by the resource_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByResourceType(string $resource_type) Return ChildSpyResourceShare objects filtered by the resource_type column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByResourceData(string $resource_data) Return ChildSpyResourceShare objects filtered by the resource_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByResourceData(string $resource_data) Return ChildSpyResourceShare objects filtered by the resource_data column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByExpiryDate(string $expiry_date) Return ChildSpyResourceShare objects filtered by the expiry_date column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByExpiryDate(string $expiry_date) Return ChildSpyResourceShare objects filtered by the expiry_date column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyResourceShare objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByCreatedAt(string $created_at) Return ChildSpyResourceShare objects filtered by the created_at column
 * @method     ChildSpyResourceShare[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyResourceShare objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyResourceShare> findByUpdatedAt(string $updated_at) Return ChildSpyResourceShare objects filtered by the updated_at column
...
abstract class SpyResourceShareQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyResourceShareQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyResourceShareTableMap::COL_ID_RESOURCE_SHARE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyResourceShareTableMap::COL_ID_RESOURCE_SHARE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyResourceShareTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyResourceShareTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyResourceShareTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyResourceShareTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyResourceShareTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyResourceShareTableMap::COL_CREATED_AT);
    }
