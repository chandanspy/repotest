...
class SpyVaultDepositTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Vault.Persistence.Map.SpyVaultDepositTableMap';
     ...
     */
    const TABLE_NAME = 'spy_vault_deposit';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Vault\\Persistence\\SpyVaultDeposit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Vault.Persistence.SpyVaultDeposit';
     ...
     */
    const COL_ID_VAULT_DEPOSIT = 'spy_vault_deposit.id_vault_deposit';

    /**
     * the column name for the data_type field
     */
    const COL_DATA_TYPE = 'spy_vault_deposit.data_type';

    /**
     * the column name for the data_key field
     */
    const COL_DATA_KEY = 'spy_vault_deposit.data_key';

    /**
     * the column name for the initial_vector field
     */
    const COL_INITIAL_VECTOR = 'spy_vault_deposit.initial_vector';

    /**
     * the column name for the cipher_text field
     */
    const COL_CIPHER_TEXT = 'spy_vault_deposit.cipher_text';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_vault_deposit.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_vault_deposit.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdVaultDeposit', 'DataType', 'DataKey', 'InitialVector', 'CipherText', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idVaultDeposit', 'dataType', 'dataKey', 'initialVector', 'cipherText', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyVaultDepositTableMap::COL_ID_VAULT_DEPOSIT, SpyVaultDepositTableMap::COL_DATA_TYPE, SpyVaultDepositTableMap::COL_DATA_KEY, SpyVaultDepositTableMap::COL_INITIAL_VECTOR, SpyVaultDepositTableMap::COL_CIPHER_TEXT, SpyVaultDepositTableMap::COL_CREATED_AT, SpyVaultDepositTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_vault_deposit', 'data_type', 'data_key', 'initial_vector', 'cipher_text', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdVaultDeposit' => 0, 'DataType' => 1, 'DataKey' => 2, 'InitialVector' => 3, 'CipherText' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idVaultDeposit' => 0, 'dataType' => 1, 'dataKey' => 2, 'initialVector' => 3, 'cipherText' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyVaultDepositTableMap::COL_ID_VAULT_DEPOSIT => 0, SpyVaultDepositTableMap::COL_DATA_TYPE => 1, SpyVaultDepositTableMap::COL_DATA_KEY => 2, SpyVaultDepositTableMap::COL_INITIAL_VECTOR => 3, SpyVaultDepositTableMap::COL_CIPHER_TEXT => 4, SpyVaultDepositTableMap::COL_CREATED_AT => 5, SpyVaultDepositTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_vault_deposit' => 0, 'data_type' => 1, 'data_key' => 2, 'initial_vector' => 3, 'cipher_text' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
