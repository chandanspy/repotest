...
abstract class SpyQuotePermissionGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\SharedCart\\Persistence\\Map\\SpyQuotePermissionGroupTableMap';
     ...
     * @return $this|\Orm\Zed\SharedCart\Persistence\SpyQuotePermissionGroup The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\SharedCart\Persistence\SpyQuotePermissionGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\SharedCart\Persistence\SpyQuotePermissionGroup The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyQuotePermissionGroup The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyQuoteCompanyUser(ChildSpyQuoteCompanyUser $spyQuoteCompanyUser)
    {
     ...
     */
    protected function doAddSpyQuotePermissionGroupToPermission(ChildSpyQuotePermissionGroupToPermission $spyQuotePermissionGroupToPermission)
    {
