 ...
 *
 * @method     ChildSpyQuotePermissionGroup[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuotePermissionGroup objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroup> find(ConnectionInterface $con = null) Return ChildSpyQuotePermissionGroup objects based on current ModelCriteria
 * @method     ChildSpyQuotePermissionGroup[]|ObjectCollection findByIdQuotePermissionGroup(int $id_quote_permission_group) Return ChildSpyQuotePermissionGroup objects filtered by the id_quote_permission_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroup> findByIdQuotePermissionGroup(int $id_quote_permission_group) Return ChildSpyQuotePermissionGroup objects filtered by the id_quote_permission_group column
 * @method     ChildSpyQuotePermissionGroup[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyQuotePermissionGroup objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroup> findByIsDefault(boolean $is_default) Return ChildSpyQuotePermissionGroup objects filtered by the is_default column
 * @method     ChildSpyQuotePermissionGroup[]|ObjectCollection findByName(string $name) Return ChildSpyQuotePermissionGroup objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroup> findByName(string $name) Return ChildSpyQuotePermissionGroup objects filtered by the name column
...
abstract class SpyQuotePermissionGroupQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuotePermissionGroupQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuotePermissionGroupTableMap::COL_ID_QUOTE_PERMISSION_GROUP, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuotePermissionGroupTableMap::COL_ID_QUOTE_PERMISSION_GROUP, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyQuotePermissionGroupQuery The current query, for fluid interface
     */
