 ...
 *
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuoteCompanyUser objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> find(ConnectionInterface $con = null) Return ChildSpyQuoteCompanyUser objects based on current ModelCriteria
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByIdQuoteCompanyUser(int $id_quote_company_user) Return ChildSpyQuoteCompanyUser objects filtered by the id_quote_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByIdQuoteCompanyUser(int $id_quote_company_user) Return ChildSpyQuoteCompanyUser objects filtered by the id_quote_company_user column
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteCompanyUser objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteCompanyUser objects filtered by the fk_company_user column
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByFkQuote(int $fk_quote) Return ChildSpyQuoteCompanyUser objects filtered by the fk_quote column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByFkQuote(int $fk_quote) Return ChildSpyQuoteCompanyUser objects filtered by the fk_quote column
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByFkQuotePermissionGroup(int $fk_quote_permission_group) Return ChildSpyQuoteCompanyUser objects filtered by the fk_quote_permission_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByFkQuotePermissionGroup(int $fk_quote_permission_group) Return ChildSpyQuoteCompanyUser objects filtered by the fk_quote_permission_group column
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyQuoteCompanyUser objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByIsDefault(boolean $is_default) Return ChildSpyQuoteCompanyUser objects filtered by the is_default column
 * @method     ChildSpyQuoteCompanyUser[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyQuoteCompanyUser objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteCompanyUser> findByUuid(string $uuid) Return ChildSpyQuoteCompanyUser objects filtered by the uuid column
...
abstract class SpyQuoteCompanyUserQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuoteCompanyUserQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuoteCompanyUserTableMap::COL_ID_QUOTE_COMPANY_USER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuoteCompanyUserTableMap::COL_ID_QUOTE_COMPANY_USER, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuoteCompanyUserQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyQuoteCompanyUserQuery The current query, for fluid interface
     */
    public function filterBySpyQuotePermissionGroup($spyQuotePermissionGroup, $comparison = null)
    {
     ...
     * @return $this|ChildSpyQuoteCompanyUserQuery The current query, for fluid interface
     */
    public function joinSpyQuotePermissionGroup($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyQuotePermissionGroup', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyQuotePermissionGroup', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
