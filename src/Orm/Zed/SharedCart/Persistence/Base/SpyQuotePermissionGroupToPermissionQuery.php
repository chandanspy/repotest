 ...
 *
 * @method     ChildSpyQuotePermissionGroupToPermission[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuotePermissionGroupToPermission objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroupToPermission> find(ConnectionInterface $con = null) Return ChildSpyQuotePermissionGroupToPermission objects based on current ModelCriteria
 * @method     ChildSpyQuotePermissionGroupToPermission[]|ObjectCollection findByIdQuotePermissionGroupToPermission(int $id_quote_permission_group_to_permission) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the id_quote_permission_group_to_permission column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroupToPermission> findByIdQuotePermissionGroupToPermission(int $id_quote_permission_group_to_permission) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the id_quote_permission_group_to_permission column
 * @method     ChildSpyQuotePermissionGroupToPermission[]|ObjectCollection findByFkPermission(int $fk_permission) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the fk_permission column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroupToPermission> findByFkPermission(int $fk_permission) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the fk_permission column
 * @method     ChildSpyQuotePermissionGroupToPermission[]|ObjectCollection findByFkQuotePermissionGroup(int $fk_quote_permission_group) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the fk_quote_permission_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuotePermissionGroupToPermission> findByFkQuotePermissionGroup(int $fk_quote_permission_group) Return ChildSpyQuotePermissionGroupToPermission objects filtered by the fk_quote_permission_group column
...
abstract class SpyQuotePermissionGroupToPermissionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuotePermissionGroupToPermissionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuotePermissionGroupToPermissionTableMap::COL_ID_QUOTE_PERMISSION_GROUP_TO_PERMISSION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuotePermissionGroupToPermissionTableMap::COL_ID_QUOTE_PERMISSION_GROUP_TO_PERMISSION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuotePermissionGroupToPermissionQuery The current query, for fluid interface
     */
    public function filterByPermission($spyPermission, $comparison = null)
    {
     ...
     * @return ChildSpyQuotePermissionGroupToPermissionQuery The current query, for fluid interface
     */
    public function filterByQuotePermissionGroup($spyQuotePermissionGroup, $comparison = null)
    {
     ...
     * @return $this|ChildSpyQuotePermissionGroupToPermissionQuery The current query, for fluid interface
     */
    public function joinQuotePermissionGroup($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('QuotePermissionGroup', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('QuotePermissionGroup', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
...
} // SpyQuotePermissionGroupToPermissionQuery
