...
class SpyQuoteCompanyUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SharedCart.Persistence.Map.SpyQuoteCompanyUserTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_company_user';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SharedCart\\Persistence\\SpyQuoteCompanyUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SharedCart.Persistence.SpyQuoteCompanyUser';
     ...
     */
    const COL_ID_QUOTE_COMPANY_USER = 'spy_quote_company_user.id_quote_company_user';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_quote_company_user.fk_company_user';

    /**
     * the column name for the fk_quote field
     */
    const COL_FK_QUOTE = 'spy_quote_company_user.fk_quote';

    /**
     * the column name for the fk_quote_permission_group field
     */
    const COL_FK_QUOTE_PERMISSION_GROUP = 'spy_quote_company_user.fk_quote_permission_group';

    /**
     * the column name for the is_default field
     */
    const COL_IS_DEFAULT = 'spy_quote_company_user.is_default';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_quote_company_user.uuid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuoteCompanyUser', 'FkCompanyUser', 'FkQuote', 'FkQuotePermissionGroup', 'IsDefault', 'Uuid', ),
        self::TYPE_CAMELNAME     => array('idQuoteCompanyUser', 'fkCompanyUser', 'fkQuote', 'fkQuotePermissionGroup', 'isDefault', 'uuid', ),
        self::TYPE_COLNAME       => array(SpyQuoteCompanyUserTableMap::COL_ID_QUOTE_COMPANY_USER, SpyQuoteCompanyUserTableMap::COL_FK_COMPANY_USER, SpyQuoteCompanyUserTableMap::COL_FK_QUOTE, SpyQuoteCompanyUserTableMap::COL_FK_QUOTE_PERMISSION_GROUP, SpyQuoteCompanyUserTableMap::COL_IS_DEFAULT, SpyQuoteCompanyUserTableMap::COL_UUID, ),
        self::TYPE_FIELDNAME     => array('id_quote_company_user', 'fk_company_user', 'fk_quote', 'fk_quote_permission_group', 'is_default', 'uuid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuoteCompanyUser' => 0, 'FkCompanyUser' => 1, 'FkQuote' => 2, 'FkQuotePermissionGroup' => 3, 'IsDefault' => 4, 'Uuid' => 5, ),
        self::TYPE_CAMELNAME     => array('idQuoteCompanyUser' => 0, 'fkCompanyUser' => 1, 'fkQuote' => 2, 'fkQuotePermissionGroup' => 3, 'isDefault' => 4, 'uuid' => 5, ),
        self::TYPE_COLNAME       => array(SpyQuoteCompanyUserTableMap::COL_ID_QUOTE_COMPANY_USER => 0, SpyQuoteCompanyUserTableMap::COL_FK_COMPANY_USER => 1, SpyQuoteCompanyUserTableMap::COL_FK_QUOTE => 2, SpyQuoteCompanyUserTableMap::COL_FK_QUOTE_PERMISSION_GROUP => 3, SpyQuoteCompanyUserTableMap::COL_IS_DEFAULT => 4, SpyQuoteCompanyUserTableMap::COL_UUID => 5, ),
        self::TYPE_FIELDNAME     => array('id_quote_company_user' => 0, 'fk_company_user' => 1, 'fk_quote' => 2, 'fk_quote_permission_group' => 3, 'is_default' => 4, 'uuid' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
