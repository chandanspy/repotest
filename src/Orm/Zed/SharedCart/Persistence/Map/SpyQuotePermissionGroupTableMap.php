...
class SpyQuotePermissionGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SharedCart.Persistence.Map.SpyQuotePermissionGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_permission_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SharedCart\\Persistence\\SpyQuotePermissionGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SharedCart.Persistence.SpyQuotePermissionGroup';
     ...
     */
    const COL_ID_QUOTE_PERMISSION_GROUP = 'spy_quote_permission_group.id_quote_permission_group';

    /**
     * the column name for the is_default field
     */
    const COL_IS_DEFAULT = 'spy_quote_permission_group.is_default';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_quote_permission_group.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuotePermissionGroup', 'IsDefault', 'Name', ),
        self::TYPE_CAMELNAME     => array('idQuotePermissionGroup', 'isDefault', 'name', ),
        self::TYPE_COLNAME       => array(SpyQuotePermissionGroupTableMap::COL_ID_QUOTE_PERMISSION_GROUP, SpyQuotePermissionGroupTableMap::COL_IS_DEFAULT, SpyQuotePermissionGroupTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_quote_permission_group', 'is_default', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuotePermissionGroup' => 0, 'IsDefault' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('idQuotePermissionGroup' => 0, 'isDefault' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(SpyQuotePermissionGroupTableMap::COL_ID_QUOTE_PERMISSION_GROUP => 0, SpyQuotePermissionGroupTableMap::COL_IS_DEFAULT => 1, SpyQuotePermissionGroupTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id_quote_permission_group' => 0, 'is_default' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyQuotePermissionGroupTableMap
