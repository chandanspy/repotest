...
class SpyQuotePermissionGroupToPermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SharedCart.Persistence.Map.SpyQuotePermissionGroupToPermissionTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_permission_group_to_permission';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SharedCart\\Persistence\\SpyQuotePermissionGroupToPermission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SharedCart.Persistence.SpyQuotePermissionGroupToPermission';
     ...
     */
    const COL_ID_QUOTE_PERMISSION_GROUP_TO_PERMISSION = 'spy_quote_permission_group_to_permission.id_quote_permission_group_to_permission';

    /**
     * the column name for the fk_permission field
     */
    const COL_FK_PERMISSION = 'spy_quote_permission_group_to_permission.fk_permission';

    /**
     * the column name for the fk_quote_permission_group field
     */
    const COL_FK_QUOTE_PERMISSION_GROUP = 'spy_quote_permission_group_to_permission.fk_quote_permission_group';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuotePermissionGroupToPermission', 'FkPermission', 'FkQuotePermissionGroup', ),
        self::TYPE_CAMELNAME     => array('idQuotePermissionGroupToPermission', 'fkPermission', 'fkQuotePermissionGroup', ),
        self::TYPE_COLNAME       => array(SpyQuotePermissionGroupToPermissionTableMap::COL_ID_QUOTE_PERMISSION_GROUP_TO_PERMISSION, SpyQuotePermissionGroupToPermissionTableMap::COL_FK_PERMISSION, SpyQuotePermissionGroupToPermissionTableMap::COL_FK_QUOTE_PERMISSION_GROUP, ),
        self::TYPE_FIELDNAME     => array('id_quote_permission_group_to_permission', 'fk_permission', 'fk_quote_permission_group', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuotePermissionGroupToPermission' => 0, 'FkPermission' => 1, 'FkQuotePermissionGroup' => 2, ),
        self::TYPE_CAMELNAME     => array('idQuotePermissionGroupToPermission' => 0, 'fkPermission' => 1, 'fkQuotePermissionGroup' => 2, ),
        self::TYPE_COLNAME       => array(SpyQuotePermissionGroupToPermissionTableMap::COL_ID_QUOTE_PERMISSION_GROUP_TO_PERMISSION => 0, SpyQuotePermissionGroupToPermissionTableMap::COL_FK_PERMISSION => 1, SpyQuotePermissionGroupToPermissionTableMap::COL_FK_QUOTE_PERMISSION_GROUP => 2, ),
        self::TYPE_FIELDNAME     => array('id_quote_permission_group_to_permission' => 0, 'fk_permission' => 1, 'fk_quote_permission_group' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyQuotePermissionGroupToPermissionTableMap
