...
class SpyNopaymentPaidTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Nopayment.Persistence.Map.SpyNopaymentPaidTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Nopayment\\Persistence\\SpyNopaymentPaid';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Nopayment.Persistence.SpyNopaymentPaid';
