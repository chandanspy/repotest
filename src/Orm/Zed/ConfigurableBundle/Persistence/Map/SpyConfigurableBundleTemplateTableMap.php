...
class SpyConfigurableBundleTemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ConfigurableBundle.Persistence.Map.SpyConfigurableBundleTemplateTableMap';
     ...
     */
    const TABLE_NAME = 'spy_configurable_bundle_template';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ConfigurableBundle\\Persistence\\SpyConfigurableBundleTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ConfigurableBundle.Persistence.SpyConfigurableBundleTemplate';
     ...
     */
    const COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE = 'spy_configurable_bundle_template.id_configurable_bundle_template';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_configurable_bundle_template.is_active';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_configurable_bundle_template.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_configurable_bundle_template.name';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_configurable_bundle_template.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_configurable_bundle_template.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_configurable_bundle_template.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplate', 'IsActive', 'Key', 'Name', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplate', 'isActive', 'key', 'name', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyConfigurableBundleTemplateTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE, SpyConfigurableBundleTemplateTableMap::COL_IS_ACTIVE, SpyConfigurableBundleTemplateTableMap::COL_KEY, SpyConfigurableBundleTemplateTableMap::COL_NAME, SpyConfigurableBundleTemplateTableMap::COL_UUID, SpyConfigurableBundleTemplateTableMap::COL_CREATED_AT, SpyConfigurableBundleTemplateTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template', 'is_active', 'key', 'name', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdConfigurableBundleTemplate' => 0, 'IsActive' => 1, 'Key' => 2, 'Name' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idConfigurableBundleTemplate' => 0, 'isActive' => 1, 'key' => 2, 'name' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_configurable_bundle_template' => 0, 'is_active' => 1, 'key' => 2, 'name' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
