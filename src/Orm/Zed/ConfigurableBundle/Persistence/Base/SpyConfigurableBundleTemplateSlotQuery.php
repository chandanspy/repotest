 ...
 *
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplateSlot objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> find(ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplateSlot objects based on current ModelCriteria
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByIdConfigurableBundleTemplateSlot(int $id_configurable_bundle_template_slot) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the id_configurable_bundle_template_slot column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByIdConfigurableBundleTemplateSlot(int $id_configurable_bundle_template_slot) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the id_configurable_bundle_template_slot column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByFkConfigurableBundleTemplate(int $fk_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the fk_configurable_bundle_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByFkConfigurableBundleTemplate(int $fk_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the fk_configurable_bundle_template column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByFkProductList(int $fk_product_list) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the fk_product_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByFkProductList(int $fk_product_list) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the fk_product_list column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByKey(string $key) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByKey(string $key) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the key column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByName(string $name) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByName(string $name) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the name column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByUuid(string $uuid) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the uuid column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByCreatedAt(string $created_at) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the created_at column
 * @method     ChildSpyConfigurableBundleTemplateSlot[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplateSlot> findByUpdatedAt(string $updated_at) Return ChildSpyConfigurableBundleTemplateSlot objects filtered by the updated_at column
...
abstract class SpyConfigurableBundleTemplateSlotQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyConfigurableBundleTemplateSlotQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyConfigurableBundleTemplateSlotTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_SLOT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyConfigurableBundleTemplateSlotTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_SLOT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyConfigurableBundleTemplateSlotQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyConfigurableBundleTemplateSlotQuery The current query, for fluid interface
     */
    public function joinSpyConfigurableBundleTemplate($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     * @return ChildSpyConfigurableBundleTemplateSlotQuery The current query, for fluid interface
     */
    public function filterBySpyProductList($spyProductList, $comparison = null)
    {
     ...
     * @return $this|ChildSpyConfigurableBundleTemplateSlotQuery The current query, for fluid interface
     */
    public function joinSpyProductList($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductList', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductList', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyConfigurableBundleTemplateSlotTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateSlotTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateSlotTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateSlotTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyConfigurableBundleTemplateSlotTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateSlotTableMap::COL_CREATED_AT);
    }
