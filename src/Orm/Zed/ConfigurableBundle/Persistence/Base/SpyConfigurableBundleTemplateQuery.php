 ...
 *
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplate objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> find(ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplate objects based on current ModelCriteria
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByIdConfigurableBundleTemplate(int $id_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplate objects filtered by the id_configurable_bundle_template column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByIdConfigurableBundleTemplate(int $id_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplate objects filtered by the id_configurable_bundle_template column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyConfigurableBundleTemplate objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByIsActive(boolean $is_active) Return ChildSpyConfigurableBundleTemplate objects filtered by the is_active column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByKey(string $key) Return ChildSpyConfigurableBundleTemplate objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByKey(string $key) Return ChildSpyConfigurableBundleTemplate objects filtered by the key column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByName(string $name) Return ChildSpyConfigurableBundleTemplate objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByName(string $name) Return ChildSpyConfigurableBundleTemplate objects filtered by the name column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyConfigurableBundleTemplate objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByUuid(string $uuid) Return ChildSpyConfigurableBundleTemplate objects filtered by the uuid column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyConfigurableBundleTemplate objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByCreatedAt(string $created_at) Return ChildSpyConfigurableBundleTemplate objects filtered by the created_at column
 * @method     ChildSpyConfigurableBundleTemplate[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyConfigurableBundleTemplate objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyConfigurableBundleTemplate> findByUpdatedAt(string $updated_at) Return ChildSpyConfigurableBundleTemplate objects filtered by the updated_at column
...
abstract class SpyConfigurableBundleTemplateQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyConfigurableBundleTemplateQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyConfigurableBundleTemplateTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyConfigurableBundleTemplateTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyConfigurableBundleTemplateQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyConfigurableBundleTemplateQuery The current query, for fluid interface
     */
    public function joinSpyConfigurableBundleTemplateSlot($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->addUsingAlias(SpyConfigurableBundleTemplateTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyConfigurableBundleTemplateTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateTableMap::COL_CREATED_AT);
    }
