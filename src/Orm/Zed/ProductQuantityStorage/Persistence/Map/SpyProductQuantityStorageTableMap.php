...
class SpyProductQuantityStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductQuantityStorage.Persistence.Map.SpyProductQuantityStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_quantity_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductQuantityStorage\\Persistence\\SpyProductQuantityStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductQuantityStorage.Persistence.SpyProductQuantityStorage';
     ...
     */
    const COL_ID_PRODUCT_QUANTITY_STORAGE = 'spy_product_quantity_storage.id_product_quantity_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_quantity_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_quantity_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_quantity_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_quantity_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_quantity_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_quantity_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductQuantityStorage', 'FkProduct', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductQuantityStorage', 'fkProduct', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductQuantityStorageTableMap::COL_ID_PRODUCT_QUANTITY_STORAGE, SpyProductQuantityStorageTableMap::COL_FK_PRODUCT, SpyProductQuantityStorageTableMap::COL_DATA, SpyProductQuantityStorageTableMap::COL_KEY, SpyProductQuantityStorageTableMap::COL_ALIAS_KEYS, SpyProductQuantityStorageTableMap::COL_CREATED_AT, SpyProductQuantityStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_quantity_storage', 'fk_product', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductQuantityStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductQuantityStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductQuantityStorageTableMap::COL_ID_PRODUCT_QUANTITY_STORAGE => 0, SpyProductQuantityStorageTableMap::COL_FK_PRODUCT => 1, SpyProductQuantityStorageTableMap::COL_DATA => 2, SpyProductQuantityStorageTableMap::COL_KEY => 3, SpyProductQuantityStorageTableMap::COL_ALIAS_KEYS => 4, SpyProductQuantityStorageTableMap::COL_CREATED_AT => 5, SpyProductQuantityStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_quantity_storage' => 0, 'fk_product' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyProductQuantityStorageTableMap
