 ...
 *
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyGlossaryStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> find(ConnectionInterface $con = null) Return ChildSpyGlossaryStorage objects based on current ModelCriteria
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByIdGlossaryStorage(string $id_glossary_storage) Return ChildSpyGlossaryStorage objects filtered by the id_glossary_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByIdGlossaryStorage(string $id_glossary_storage) Return ChildSpyGlossaryStorage objects filtered by the id_glossary_storage column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyGlossaryStorage objects filtered by the fk_glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByFkGlossaryKey(int $fk_glossary_key) Return ChildSpyGlossaryStorage objects filtered by the fk_glossary_key column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByData(string $data) Return ChildSpyGlossaryStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByData(string $data) Return ChildSpyGlossaryStorage objects filtered by the data column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByGlossaryKey(string $glossary_key) Return ChildSpyGlossaryStorage objects filtered by the glossary_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByGlossaryKey(string $glossary_key) Return ChildSpyGlossaryStorage objects filtered by the glossary_key column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyGlossaryStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByKey(string $key) Return ChildSpyGlossaryStorage objects filtered by the key column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByLocale(string $locale) Return ChildSpyGlossaryStorage objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByLocale(string $locale) Return ChildSpyGlossaryStorage objects filtered by the locale column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyGlossaryStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByAliasKeys(string $alias_keys) Return ChildSpyGlossaryStorage objects filtered by the alias_keys column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyGlossaryStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByCreatedAt(string $created_at) Return ChildSpyGlossaryStorage objects filtered by the created_at column
 * @method     ChildSpyGlossaryStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyGlossaryStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyGlossaryStorage> findByUpdatedAt(string $updated_at) Return ChildSpyGlossaryStorage objects filtered by the updated_at column
...
abstract class SpyGlossaryStorageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_glossary_storage`, `fk_glossary_key`, `data`, `glossary_key`, `key`, `locale`, `alias_keys`, `created_at`, `updated_at` FROM `spy_glossary_storage` WHERE `id_glossary_storage` = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyGlossaryStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyGlossaryStorageTableMap::COL_ID_GLOSSARY_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyGlossaryStorageTableMap::COL_ID_GLOSSARY_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyGlossaryStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyGlossaryStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyGlossaryStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyGlossaryStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyGlossaryStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyGlossaryStorageTableMap::COL_CREATED_AT);
    }

} // SpyGlossaryStorageQuery
