...
class SpySalesOrderConfiguredBundleItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SalesConfigurableBundle.Persistence.Map.SpySalesOrderConfiguredBundleItemTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sales_order_configured_bundle_item';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SalesConfigurableBundle\\Persistence\\SpySalesOrderConfiguredBundleItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SalesConfigurableBundle.Persistence.SpySalesOrderConfiguredBundleItem';
     ...
     */
    const COL_ID_SALES_ORDER_CONFIGURED_BUNDLE_ITEM = 'spy_sales_order_configured_bundle_item.id_sales_order_configured_bundle_item';

    /**
     * the column name for the fk_sales_order_configured_bundle field
     */
    const COL_FK_SALES_ORDER_CONFIGURED_BUNDLE = 'spy_sales_order_configured_bundle_item.fk_sales_order_configured_bundle';

    /**
     * the column name for the fk_sales_order_item field
     */
    const COL_FK_SALES_ORDER_ITEM = 'spy_sales_order_configured_bundle_item.fk_sales_order_item';

    /**
     * the column name for the configurable_bundle_template_slot_uuid field
     */
    const COL_CONFIGURABLE_BUNDLE_TEMPLATE_SLOT_UUID = 'spy_sales_order_configured_bundle_item.configurable_bundle_template_slot_uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_sales_order_configured_bundle_item.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_sales_order_configured_bundle_item.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderConfiguredBundleItem', 'FkSalesOrderConfiguredBundle', 'FkSalesOrderItem', 'ConfigurableBundleTemplateSlotUuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idSalesOrderConfiguredBundleItem', 'fkSalesOrderConfiguredBundle', 'fkSalesOrderItem', 'configurableBundleTemplateSlotUuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpySalesOrderConfiguredBundleItemTableMap::COL_ID_SALES_ORDER_CONFIGURED_BUNDLE_ITEM, SpySalesOrderConfiguredBundleItemTableMap::COL_FK_SALES_ORDER_CONFIGURED_BUNDLE, SpySalesOrderConfiguredBundleItemTableMap::COL_FK_SALES_ORDER_ITEM, SpySalesOrderConfiguredBundleItemTableMap::COL_CONFIGURABLE_BUNDLE_TEMPLATE_SLOT_UUID, SpySalesOrderConfiguredBundleItemTableMap::COL_CREATED_AT, SpySalesOrderConfiguredBundleItemTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_sales_order_configured_bundle_item', 'fk_sales_order_configured_bundle', 'fk_sales_order_item', 'configurable_bundle_template_slot_uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSalesOrderConfiguredBundleItem' => 0, 'FkSalesOrderConfiguredBundle' => 1, 'FkSalesOrderItem' => 2, 'ConfigurableBundleTemplateSlotUuid' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idSalesOrderConfiguredBundleItem' => 0, 'fkSalesOrderConfiguredBundle' => 1, 'fkSalesOrderItem' => 2, 'configurableBundleTemplateSlotUuid' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        ...
        self::TYPE_FIELDNAME     => array('id_sales_order_configured_bundle_item' => 0, 'fk_sales_order_configured_bundle' => 1, 'fk_sales_order_item' => 2, 'configurable_bundle_template_slot_uuid' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
