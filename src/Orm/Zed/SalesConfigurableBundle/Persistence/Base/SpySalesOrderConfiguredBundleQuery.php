 ...
 *
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpySalesOrderConfiguredBundle objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> find(ConnectionInterface $con = null) Return ChildSpySalesOrderConfiguredBundle objects based on current ModelCriteria
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByIdSalesOrderConfiguredBundle(int $id_sales_order_configured_bundle) Return ChildSpySalesOrderConfiguredBundle objects filtered by the id_sales_order_configured_bundle column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByIdSalesOrderConfiguredBundle(int $id_sales_order_configured_bundle) Return ChildSpySalesOrderConfiguredBundle objects filtered by the id_sales_order_configured_bundle column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByConfigurableBundleTemplateUuid(string $configurable_bundle_template_uuid) Return ChildSpySalesOrderConfiguredBundle objects filtered by the configurable_bundle_template_uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByConfigurableBundleTemplateUuid(string $configurable_bundle_template_uuid) Return ChildSpySalesOrderConfiguredBundle objects filtered by the configurable_bundle_template_uuid column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByName(string $name) Return ChildSpySalesOrderConfiguredBundle objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByName(string $name) Return ChildSpySalesOrderConfiguredBundle objects filtered by the name column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByNote(string $note) Return ChildSpySalesOrderConfiguredBundle objects filtered by the note column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByNote(string $note) Return ChildSpySalesOrderConfiguredBundle objects filtered by the note column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByQuantity(int $quantity) Return ChildSpySalesOrderConfiguredBundle objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByQuantity(int $quantity) Return ChildSpySalesOrderConfiguredBundle objects filtered by the quantity column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpySalesOrderConfiguredBundle objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByCreatedAt(string $created_at) Return ChildSpySalesOrderConfiguredBundle objects filtered by the created_at column
 * @method     ChildSpySalesOrderConfiguredBundle[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderConfiguredBundle objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpySalesOrderConfiguredBundle> findByUpdatedAt(string $updated_at) Return ChildSpySalesOrderConfiguredBundle objects filtered by the updated_at column
...
abstract class SpySalesOrderConfiguredBundleQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpySalesOrderConfiguredBundleQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpySalesOrderConfiguredBundleTableMap::COL_ID_SALES_ORDER_CONFIGURED_BUNDLE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderConfiguredBundleTableMap::COL_ID_SALES_ORDER_CONFIGURED_BUNDLE, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpySalesOrderConfiguredBundleQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpySalesOrderConfiguredBundleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderConfiguredBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderConfiguredBundleTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpySalesOrderConfiguredBundleTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpySalesOrderConfiguredBundleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpySalesOrderConfiguredBundleTableMap::COL_CREATED_AT);
    }
