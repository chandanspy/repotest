...
abstract class SpyProductLabel implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductLabel\\Persistence\\Map\\SpyProductLabelTableMap';
     ...
     * @return $this|\Orm\Zed\ProductLabel\Persistence\SpyProductLabel The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductLabel\Persistence\SpyProductLabel
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductLabel\Persistence\SpyProductLabel The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductLabel The current object (for fluent API support)
     */
     ...
     */
    protected function doAddProductLabelStore(ChildSpyProductLabelStore $productLabelStore)
    {
     ...
     */
    protected function doAddSpyProductLabelLocalizedAttributes(ChildSpyProductLabelLocalizedAttributes $spyProductLabelLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyProductLabelProductAbstract(ChildSpyProductLabelProductAbstract $spyProductLabelProductAbstract)
    {
