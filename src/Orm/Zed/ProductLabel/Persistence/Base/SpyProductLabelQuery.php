 ...
 *
 * @method     ChildSpyProductLabel[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductLabel objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> find(ConnectionInterface $con = null) Return ChildSpyProductLabel objects based on current ModelCriteria
 * @method     ChildSpyProductLabel[]|ObjectCollection findByIdProductLabel(int $id_product_label) Return ChildSpyProductLabel objects filtered by the id_product_label column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByIdProductLabel(int $id_product_label) Return ChildSpyProductLabel objects filtered by the id_product_label column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByFrontEndReference(string $front_end_reference) Return ChildSpyProductLabel objects filtered by the front_end_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByFrontEndReference(string $front_end_reference) Return ChildSpyProductLabel objects filtered by the front_end_reference column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyProductLabel objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByIsActive(boolean $is_active) Return ChildSpyProductLabel objects filtered by the is_active column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByIsDynamic(boolean $is_dynamic) Return ChildSpyProductLabel objects filtered by the is_dynamic column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByIsDynamic(boolean $is_dynamic) Return ChildSpyProductLabel objects filtered by the is_dynamic column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByIsExclusive(boolean $is_exclusive) Return ChildSpyProductLabel objects filtered by the is_exclusive column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByIsExclusive(boolean $is_exclusive) Return ChildSpyProductLabel objects filtered by the is_exclusive column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByIsPublished(boolean $is_published) Return ChildSpyProductLabel objects filtered by the is_published column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByIsPublished(boolean $is_published) Return ChildSpyProductLabel objects filtered by the is_published column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByName(string $name) Return ChildSpyProductLabel objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByName(string $name) Return ChildSpyProductLabel objects filtered by the name column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByPosition(int $position) Return ChildSpyProductLabel objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByPosition(int $position) Return ChildSpyProductLabel objects filtered by the position column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByValidFrom(string $valid_from) Return ChildSpyProductLabel objects filtered by the valid_from column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByValidFrom(string $valid_from) Return ChildSpyProductLabel objects filtered by the valid_from column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByValidTo(string $valid_to) Return ChildSpyProductLabel objects filtered by the valid_to column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByValidTo(string $valid_to) Return ChildSpyProductLabel objects filtered by the valid_to column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductLabel objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByCreatedAt(string $created_at) Return ChildSpyProductLabel objects filtered by the created_at column
 * @method     ChildSpyProductLabel[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductLabel objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabel> findByUpdatedAt(string $updated_at) Return ChildSpyProductLabel objects filtered by the updated_at column
...
abstract class SpyProductLabelQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductLabelQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductLabelTableMap::COL_ID_PRODUCT_LABEL, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductLabelTableMap::COL_ID_PRODUCT_LABEL, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductLabelQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductLabelTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductLabelTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductLabelTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductLabelTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductLabelTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductLabelTableMap::COL_CREATED_AT);
    }
