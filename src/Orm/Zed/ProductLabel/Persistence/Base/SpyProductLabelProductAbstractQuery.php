 ...
 *
 * @method     ChildSpyProductLabelProductAbstract[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductLabelProductAbstract objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabelProductAbstract> find(ConnectionInterface $con = null) Return ChildSpyProductLabelProductAbstract objects based on current ModelCriteria
 * @method     ChildSpyProductLabelProductAbstract[]|ObjectCollection findByIdProductLabelProductAbstract(int $id_product_label_product_abstract) Return ChildSpyProductLabelProductAbstract objects filtered by the id_product_label_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabelProductAbstract> findByIdProductLabelProductAbstract(int $id_product_label_product_abstract) Return ChildSpyProductLabelProductAbstract objects filtered by the id_product_label_product_abstract column
 * @method     ChildSpyProductLabelProductAbstract[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductLabelProductAbstract objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabelProductAbstract> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductLabelProductAbstract objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductLabelProductAbstract[]|ObjectCollection findByFkProductLabel(int $fk_product_label) Return ChildSpyProductLabelProductAbstract objects filtered by the fk_product_label column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLabelProductAbstract> findByFkProductLabel(int $fk_product_label) Return ChildSpyProductLabelProductAbstract objects filtered by the fk_product_label column
...
abstract class SpyProductLabelProductAbstractQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductLabelProductAbstractQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductLabelProductAbstractTableMap::COL_ID_PRODUCT_LABEL_PRODUCT_ABSTRACT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductLabelProductAbstractTableMap::COL_ID_PRODUCT_LABEL_PRODUCT_ABSTRACT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductLabelProductAbstractQuery The current query, for fluid interface
     */
...
} // SpyProductLabelProductAbstractQuery
