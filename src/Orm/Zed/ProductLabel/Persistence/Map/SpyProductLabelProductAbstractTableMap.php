...
class SpyProductLabelProductAbstractTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductLabel.Persistence.Map.SpyProductLabelProductAbstractTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_label_product_abstract';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductLabel\\Persistence\\SpyProductLabelProductAbstract';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductLabel.Persistence.SpyProductLabelProductAbstract';
     ...
     */
    const COL_ID_PRODUCT_LABEL_PRODUCT_ABSTRACT = 'spy_product_label_product_abstract.id_product_label_product_abstract';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_label_product_abstract.fk_product_abstract';

    /**
     * the column name for the fk_product_label field
     */
    const COL_FK_PRODUCT_LABEL = 'spy_product_label_product_abstract.fk_product_label';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductLabelProductAbstract', 'FkProductAbstract', 'FkProductLabel', ),
        self::TYPE_CAMELNAME     => array('idProductLabelProductAbstract', 'fkProductAbstract', 'fkProductLabel', ),
        self::TYPE_COLNAME       => array(SpyProductLabelProductAbstractTableMap::COL_ID_PRODUCT_LABEL_PRODUCT_ABSTRACT, SpyProductLabelProductAbstractTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductLabelProductAbstractTableMap::COL_FK_PRODUCT_LABEL, ),
        self::TYPE_FIELDNAME     => array('id_product_label_product_abstract', 'fk_product_abstract', 'fk_product_label', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductLabelProductAbstract' => 0, 'FkProductAbstract' => 1, 'FkProductLabel' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductLabelProductAbstract' => 0, 'fkProductAbstract' => 1, 'fkProductLabel' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductLabelProductAbstractTableMap::COL_ID_PRODUCT_LABEL_PRODUCT_ABSTRACT => 0, SpyProductLabelProductAbstractTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductLabelProductAbstractTableMap::COL_FK_PRODUCT_LABEL => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_label_product_abstract' => 0, 'fk_product_abstract' => 1, 'fk_product_label' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductLabelProductAbstractTableMap
