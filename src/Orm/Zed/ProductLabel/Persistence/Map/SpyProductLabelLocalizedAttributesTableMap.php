...
class SpyProductLabelLocalizedAttributesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductLabel.Persistence.Map.SpyProductLabelLocalizedAttributesTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_label_localized_attributes';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductLabel\\Persistence\\SpyProductLabelLocalizedAttributes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductLabel.Persistence.SpyProductLabelLocalizedAttributes';
     ...
     */
    const COL_ID_PRODUCT_LABEL_LOCALIZED_ATTRIBUTES = 'spy_product_label_localized_attributes.id_product_label_localized_attributes';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_product_label_localized_attributes.fk_locale';

    /**
     * the column name for the fk_product_label field
     */
    const COL_FK_PRODUCT_LABEL = 'spy_product_label_localized_attributes.fk_product_label';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_product_label_localized_attributes.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductLabelLocalizedAttributes', 'FkLocale', 'FkProductLabel', 'Name', ),
        self::TYPE_CAMELNAME     => array('idProductLabelLocalizedAttributes', 'fkLocale', 'fkProductLabel', 'name', ),
        self::TYPE_COLNAME       => array(SpyProductLabelLocalizedAttributesTableMap::COL_ID_PRODUCT_LABEL_LOCALIZED_ATTRIBUTES, SpyProductLabelLocalizedAttributesTableMap::COL_FK_LOCALE, SpyProductLabelLocalizedAttributesTableMap::COL_FK_PRODUCT_LABEL, SpyProductLabelLocalizedAttributesTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_product_label_localized_attributes', 'fk_locale', 'fk_product_label', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductLabelLocalizedAttributes' => 0, 'FkLocale' => 1, 'FkProductLabel' => 2, 'Name' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductLabelLocalizedAttributes' => 0, 'fkLocale' => 1, 'fkProductLabel' => 2, 'name' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductLabelLocalizedAttributesTableMap::COL_ID_PRODUCT_LABEL_LOCALIZED_ATTRIBUTES => 0, SpyProductLabelLocalizedAttributesTableMap::COL_FK_LOCALE => 1, SpyProductLabelLocalizedAttributesTableMap::COL_FK_PRODUCT_LABEL => 2, SpyProductLabelLocalizedAttributesTableMap::COL_NAME => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_label_localized_attributes' => 0, 'fk_locale' => 1, 'fk_product_label' => 2, 'name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyProductLabelLocalizedAttributesTableMap
