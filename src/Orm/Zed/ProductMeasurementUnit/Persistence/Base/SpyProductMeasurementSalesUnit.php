...
abstract class SpyProductMeasurementSalesUnit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductMeasurementUnit\\Persistence\\Map\\SpyProductMeasurementSalesUnitTableMap';
     ...
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementSalesUnit The current object (for fluent API support)
     */
    public function setIdProductMeasurementSalesUnit($v)
    {
        ...
        return $this;
    } // setIdProductMeasurementSalesUnit()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementSalesUnit
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementSalesUnit The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductMeasurementSalesUnit The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductMeasurementSalesUnitStore(ChildSpyProductMeasurementSalesUnitStore $spyProductMeasurementSalesUnitStore)
    {
