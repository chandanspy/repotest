 ...
 *
 * @method     ChildSpyProductMeasurementSalesUnitStore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementSalesUnitStore objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnitStore> find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementSalesUnitStore objects based on current ModelCriteria
 * @method     ChildSpyProductMeasurementSalesUnitStore[]|ObjectCollection findByIdProductMeasurementSalesUnitStore(int $id_product_measurement_sales_unit_store) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the id_product_measurement_sales_unit_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnitStore> findByIdProductMeasurementSalesUnitStore(int $id_product_measurement_sales_unit_store) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the id_product_measurement_sales_unit_store column
 * @method     ChildSpyProductMeasurementSalesUnitStore[]|ObjectCollection findByFkProductMeasurementSalesUnit(int $fk_product_measurement_sales_unit) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the fk_product_measurement_sales_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnitStore> findByFkProductMeasurementSalesUnit(int $fk_product_measurement_sales_unit) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the fk_product_measurement_sales_unit column
 * @method     ChildSpyProductMeasurementSalesUnitStore[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnitStore> findByFkStore(int $fk_store) Return ChildSpyProductMeasurementSalesUnitStore objects filtered by the fk_store column
...
abstract class SpyProductMeasurementSalesUnitStoreQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductMeasurementSalesUnitStoreQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductMeasurementSalesUnitStoreTableMap::COL_ID_PRODUCT_MEASUREMENT_SALES_UNIT_STORE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductMeasurementSalesUnitStoreTableMap::COL_ID_PRODUCT_MEASUREMENT_SALES_UNIT_STORE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductMeasurementSalesUnitStoreQuery The current query, for fluid interface
     */
