...
abstract class SpyProductMeasurementUnit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductMeasurementUnit\\Persistence\\Map\\SpyProductMeasurementUnitTableMap';
     ...
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementUnit The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementUnit
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementUnit The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductMeasurementUnit The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductMeasurementBaseUnit(ChildSpyProductMeasurementBaseUnit $spyProductMeasurementBaseUnit)
    {
     ...
     */
    protected function doAddSpyProductMeasurementSalesUnit(ChildSpyProductMeasurementSalesUnit $spyProductMeasurementSalesUnit)
    {
