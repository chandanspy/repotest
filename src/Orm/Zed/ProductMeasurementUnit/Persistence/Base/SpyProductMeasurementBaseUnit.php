...
abstract class SpyProductMeasurementBaseUnit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductMeasurementUnit\\Persistence\\Map\\SpyProductMeasurementBaseUnitTableMap';
     ...
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementBaseUnit The current object (for fluent API support)
     */
    public function setIdProductMeasurementBaseUnit($v)
    {
        ...
        return $this;
    } // setIdProductMeasurementBaseUnit()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementBaseUnit
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductMeasurementUnit\Persistence\SpyProductMeasurementBaseUnit The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductMeasurementBaseUnit The current object (for fluent API support)
     */
