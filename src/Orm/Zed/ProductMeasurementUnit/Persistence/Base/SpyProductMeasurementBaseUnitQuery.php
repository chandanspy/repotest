 ...
 *
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementBaseUnit objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementBaseUnit objects based on current ModelCriteria
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection findByIdProductMeasurementBaseUnit(int $id_product_measurement_base_unit) Return ChildSpyProductMeasurementBaseUnit objects filtered by the id_product_measurement_base_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> findByIdProductMeasurementBaseUnit(int $id_product_measurement_base_unit) Return ChildSpyProductMeasurementBaseUnit objects filtered by the id_product_measurement_base_unit column
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductMeasurementBaseUnit objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductMeasurementBaseUnit objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection findByFkProductMeasurementUnit(int $fk_product_measurement_unit) Return ChildSpyProductMeasurementBaseUnit objects filtered by the fk_product_measurement_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> findByFkProductMeasurementUnit(int $fk_product_measurement_unit) Return ChildSpyProductMeasurementBaseUnit objects filtered by the fk_product_measurement_unit column
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductMeasurementBaseUnit objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> findByCreatedAt(string $created_at) Return ChildSpyProductMeasurementBaseUnit objects filtered by the created_at column
 * @method     ChildSpyProductMeasurementBaseUnit[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductMeasurementBaseUnit objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementBaseUnit> findByUpdatedAt(string $updated_at) Return ChildSpyProductMeasurementBaseUnit objects filtered by the updated_at column
...
abstract class SpyProductMeasurementBaseUnitQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductMeasurementBaseUnitQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductMeasurementBaseUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_BASE_UNIT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductMeasurementBaseUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_BASE_UNIT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductMeasurementBaseUnitQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductMeasurementBaseUnitTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductMeasurementBaseUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductMeasurementBaseUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductMeasurementBaseUnitTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductMeasurementBaseUnitTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductMeasurementBaseUnitTableMap::COL_CREATED_AT);
    }
