 ...
 *
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementSalesUnit objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> find(ConnectionInterface $con = null) Return ChildSpyProductMeasurementSalesUnit objects based on current ModelCriteria
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByIdProductMeasurementSalesUnit(int $id_product_measurement_sales_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the id_product_measurement_sales_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByIdProductMeasurementSalesUnit(int $id_product_measurement_sales_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the id_product_measurement_sales_unit column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByFkProduct(int $fk_product) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByFkProductMeasurementBaseUnit(int $fk_product_measurement_base_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product_measurement_base_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByFkProductMeasurementBaseUnit(int $fk_product_measurement_base_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product_measurement_base_unit column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByFkProductMeasurementUnit(int $fk_product_measurement_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product_measurement_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByFkProductMeasurementUnit(int $fk_product_measurement_unit) Return ChildSpyProductMeasurementSalesUnit objects filtered by the fk_product_measurement_unit column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByConversion(double $conversion) Return ChildSpyProductMeasurementSalesUnit objects filtered by the conversion column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByConversion(double $conversion) Return ChildSpyProductMeasurementSalesUnit objects filtered by the conversion column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyProductMeasurementSalesUnit objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByIsDefault(boolean $is_default) Return ChildSpyProductMeasurementSalesUnit objects filtered by the is_default column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByIsDisplayed(boolean $is_displayed) Return ChildSpyProductMeasurementSalesUnit objects filtered by the is_displayed column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByIsDisplayed(boolean $is_displayed) Return ChildSpyProductMeasurementSalesUnit objects filtered by the is_displayed column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByKey(string $key) Return ChildSpyProductMeasurementSalesUnit objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByKey(string $key) Return ChildSpyProductMeasurementSalesUnit objects filtered by the key column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByPrecision(int $precision) Return ChildSpyProductMeasurementSalesUnit objects filtered by the precision column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByPrecision(int $precision) Return ChildSpyProductMeasurementSalesUnit objects filtered by the precision column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductMeasurementSalesUnit objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByCreatedAt(string $created_at) Return ChildSpyProductMeasurementSalesUnit objects filtered by the created_at column
 * @method     ChildSpyProductMeasurementSalesUnit[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductMeasurementSalesUnit objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductMeasurementSalesUnit> findByUpdatedAt(string $updated_at) Return ChildSpyProductMeasurementSalesUnit objects filtered by the updated_at column
...
abstract class SpyProductMeasurementSalesUnitQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductMeasurementSalesUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_SALES_UNIT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductMeasurementSalesUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_SALES_UNIT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
    public function filterByProductMeasurementUnit($spyProductMeasurementUnit, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
    public function joinProductMeasurementUnit($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductMeasurementUnit', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductMeasurementUnit', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
    public function filterByProductMeasurementBaseUnit($spyProductMeasurementBaseUnit, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductMeasurementSalesUnitQuery The current query, for fluid interface
     */
    public function joinProductMeasurementBaseUnit($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductMeasurementBaseUnit', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductMeasurementBaseUnit', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyProductMeasurementSalesUnitTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductMeasurementSalesUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductMeasurementSalesUnitTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductMeasurementSalesUnitTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductMeasurementSalesUnitTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductMeasurementSalesUnitTableMap::COL_CREATED_AT);
    }
