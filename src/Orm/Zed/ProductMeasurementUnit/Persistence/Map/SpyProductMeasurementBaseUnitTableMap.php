...
class SpyProductMeasurementBaseUnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductMeasurementUnit.Persistence.Map.SpyProductMeasurementBaseUnitTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_measurement_base_unit';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductMeasurementUnit\\Persistence\\SpyProductMeasurementBaseUnit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductMeasurementUnit.Persistence.SpyProductMeasurementBaseUnit';
     ...
     */
    const COL_ID_PRODUCT_MEASUREMENT_BASE_UNIT = 'spy_product_measurement_base_unit.id_product_measurement_base_unit';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_measurement_base_unit.fk_product_abstract';

    /**
     * the column name for the fk_product_measurement_unit field
     */
    const COL_FK_PRODUCT_MEASUREMENT_UNIT = 'spy_product_measurement_base_unit.fk_product_measurement_unit';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_measurement_base_unit.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_measurement_base_unit.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementBaseUnit', 'FkProductAbstract', 'FkProductMeasurementUnit', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementBaseUnit', 'fkProductAbstract', 'fkProductMeasurementUnit', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductMeasurementBaseUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_BASE_UNIT, SpyProductMeasurementBaseUnitTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductMeasurementBaseUnitTableMap::COL_FK_PRODUCT_MEASUREMENT_UNIT, SpyProductMeasurementBaseUnitTableMap::COL_CREATED_AT, SpyProductMeasurementBaseUnitTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_measurement_base_unit', 'fk_product_abstract', 'fk_product_measurement_unit', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementBaseUnit' => 0, 'FkProductAbstract' => 1, 'FkProductMeasurementUnit' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementBaseUnit' => 0, 'fkProductAbstract' => 1, 'fkProductMeasurementUnit' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_measurement_base_unit' => 0, 'fk_product_abstract' => 1, 'fk_product_measurement_unit' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
