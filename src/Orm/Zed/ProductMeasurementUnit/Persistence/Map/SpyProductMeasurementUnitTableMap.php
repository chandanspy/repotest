...
class SpyProductMeasurementUnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductMeasurementUnit.Persistence.Map.SpyProductMeasurementUnitTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_measurement_unit';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductMeasurementUnit\\Persistence\\SpyProductMeasurementUnit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductMeasurementUnit.Persistence.SpyProductMeasurementUnit';
     ...
     */
    const COL_ID_PRODUCT_MEASUREMENT_UNIT = 'spy_product_measurement_unit.id_product_measurement_unit';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'spy_product_measurement_unit.code';

    /**
     * the column name for the default_precision field
     */
    const COL_DEFAULT_PRECISION = 'spy_product_measurement_unit.default_precision';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_product_measurement_unit.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_measurement_unit.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_measurement_unit.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementUnit', 'Code', 'DefaultPrecision', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementUnit', 'code', 'defaultPrecision', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductMeasurementUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_UNIT, SpyProductMeasurementUnitTableMap::COL_CODE, SpyProductMeasurementUnitTableMap::COL_DEFAULT_PRECISION, SpyProductMeasurementUnitTableMap::COL_NAME, SpyProductMeasurementUnitTableMap::COL_CREATED_AT, SpyProductMeasurementUnitTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_measurement_unit', 'code', 'default_precision', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductMeasurementUnit' => 0, 'Code' => 1, 'DefaultPrecision' => 2, 'Name' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductMeasurementUnit' => 0, 'code' => 1, 'defaultPrecision' => 2, 'name' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductMeasurementUnitTableMap::COL_ID_PRODUCT_MEASUREMENT_UNIT => 0, SpyProductMeasurementUnitTableMap::COL_CODE => 1, SpyProductMeasurementUnitTableMap::COL_DEFAULT_PRECISION => 2, SpyProductMeasurementUnitTableMap::COL_NAME => 3, SpyProductMeasurementUnitTableMap::COL_CREATED_AT => 4, SpyProductMeasurementUnitTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_measurement_unit' => 0, 'code' => 1, 'default_precision' => 2, 'name' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
...
} // SpyProductMeasurementUnitTableMap
