 ...
 *
 * @method     ChildSpyProductQuery leftJoinSpyProductBundleRelatedByFkBundledProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 * @method     ChildSpyProductQuery rightJoinSpyProductBundleRelatedByFkBundledProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 * @method     ChildSpyProductQuery innerJoinSpyProductBundleRelatedByFkBundledProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 *
 * @method     ChildSpyProductQuery joinWithSpyProductBundleRelatedByFkBundledProduct($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 *
 * @method     ChildSpyProductQuery leftJoinWithSpyProductBundleRelatedByFkBundledProduct() Adds a LEFT JOIN clause and with to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 * @method     ChildSpyProductQuery rightJoinWithSpyProductBundleRelatedByFkBundledProduct() Adds a RIGHT JOIN clause and with to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 * @method     ChildSpyProductQuery innerJoinWithSpyProductBundleRelatedByFkBundledProduct() Adds a INNER JOIN clause and with to the query using the SpyProductBundleRelatedByFkBundledProduct relation
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> find(ConnectionInterface $con = null) Return ChildSpyProduct objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByIdProduct(int $id_product) Return ChildSpyProduct objects filtered by the id_product column
 * @method     ChildSpyProduct[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProduct objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProduct objects filtered by the fk_product_abstract column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByAttributes(string $attributes) Return ChildSpyProduct objects filtered by the attributes column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByIsActive(boolean $is_active) Return ChildSpyProduct objects filtered by the is_active column
 * @method     ChildSpyProduct[]|ObjectCollection findByIsQuantitySplittable(boolean $is_quantity_splittable) Return ChildSpyProduct objects filtered by the is_quantity_splittable column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByIsQuantitySplittable(boolean $is_quantity_splittable) Return ChildSpyProduct objects filtered by the is_quantity_splittable column
 * @method     ChildSpyProduct[]|ObjectCollection findBySku(string $sku) Return ChildSpyProduct objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findBySku(string $sku) Return ChildSpyProduct objects filtered by the sku column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByCreatedAt(string $created_at) Return ChildSpyProduct objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProduct> findByUpdatedAt(string $updated_at) Return ChildSpyProduct objects filtered by the updated_at column
...
abstract class SpyProductQuery extends ModelCriteria
{
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductAlternativeRelatedByFkProduct($spyProductAlternative, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductAlternativeRelatedByFkProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductAlternativeRelatedByFkProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductAlternativeRelatedByFkProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\ProductAlternative\Persistence\SpyProductAlternative object
     *
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductAlternativeRelatedByFkProductConcreteAlternative($spyProductAlternative, $comparison = null)
    {
        if ($spyProductAlternative instanceof \Orm\Zed\ProductAlternative\Persistence\SpyProductAlternative) {
            return $this
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductAlternativeRelatedByFkProductConcreteAlternative($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductAlternativeRelatedByFkProductConcreteAlternative', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductAlternativeRelatedByFkProductConcreteAlternative', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductBundleRelatedByFkBundledProduct($spyProductBundle, $comparison = null)
    {
        if ($spyProductBundle instanceof \Orm\Zed\ProductBundle\Persistence\SpyProductBundle) {
            ...
            return $this
                ->useSpyProductBundleRelatedByFkBundledProductQuery()
                ->filterByPrimaryKeys($spyProductBundle->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterBySpyProductBundleRelatedByFkBundledProduct() only accepts arguments of type \Orm\Zed\ProductBundle\Persistence\SpyProductBundle or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the SpyProductBundleRelatedByFkBundledProduct relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductBundleRelatedByFkBundledProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('SpyProductBundleRelatedByFkBundledProduct');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'SpyProductBundleRelatedByFkBundledProduct');
        }
    ...
    /**
     * Use the SpyProductBundleRelatedByFkBundledProduct relation SpyProductBundle object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useSpyProductBundleRelatedByFkBundledProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSpyProductBundleRelatedByFkBundledProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductBundleRelatedByFkBundledProduct', '\Orm\Zed\ProductBundle\Persistence\SpyProductBundleQuery');
    }
     ...
     * @return $this
     */
    public function withSpyProductBundleRelatedByFkBundledProductQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useSpyProductBundleRelatedByFkBundledProductQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the SpyProductBundleRelatedByFkBundledProduct relation to the SpyProductBundle table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     ...
     */
    public function useSpyProductBundleRelatedByFkBundledProductExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        return $this->useExistsQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, $typeOfExists);
    }

    /**
     * Use the SpyProductBundleRelatedByFkBundledProduct relation to the SpyProductBundle table for a NOT EXISTS query.
     *
     * @see useSpyProductBundleRelatedByFkBundledProductExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useSpyProductBundleRelatedByFkBundledProductNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        return $this->useExistsQuery('SpyProductBundleRelatedByFkBundledProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\ProductBundle\Persistence\SpyProductBundle object
     *
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductBundleRelatedByFkProduct($spyProductBundle, $comparison = null)
    {
        if ($spyProductBundle instanceof \Orm\Zed\ProductBundle\Persistence\SpyProductBundle) {
            return $this
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductBundleRelatedByFkProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductBundleRelatedByFkProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductBundleRelatedByFkProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductDiscontinued($spyProductDiscontinued, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductDiscontinued($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductDiscontinued', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductDiscontinued', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductListProductConcrete($spyProductListProductConcrete, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductListProductConcrete($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductListProductConcrete', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductListProductConcrete', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductPackagingUnitRelatedByFkProduct($spyProductPackagingUnit, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductPackagingUnitRelatedByFkProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductPackagingUnitRelatedByFkProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductPackagingUnitRelatedByFkProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnit object
     *
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductPackagingUnitRelatedByFkLeadProduct($spyProductPackagingUnit, $comparison = null)
    {
        if ($spyProductPackagingUnit instanceof \Orm\Zed\ProductPackagingUnit\Persistence\SpyProductPackagingUnit) {
            return $this
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductPackagingUnitRelatedByFkLeadProduct($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductPackagingUnitRelatedByFkLeadProduct', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductPackagingUnitRelatedByFkLeadProduct', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductQuantity($spyProductQuantity, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductQuantity($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductQuantity', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductQuantity', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductValidity($spyProductValidity, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductQuery The current query, for fluid interface
     */
    public function joinSpyProductValidity($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductValidity', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductValidity', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductQuery The current query, for fluid interface
     */
    public function filterBySpyProductList($spyProductList, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useSpyProductListProductConcreteQuery()
