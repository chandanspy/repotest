...
abstract class SpyProductAbstract implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Product\\Persistence\\Map\\SpyProductAbstractTableMap';
    ...
    /**
     * The value for the pyz_color_code field.
     *
     * @var        string|null
     */
    protected $pyz_color_code;
    ...
    /**
     * Get the [pyz_color_code] column value.
     *
     * @return string|null
     */
    public function getPyzColorCode()
    {
        return $this->pyz_color_code;
    }
     ...
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstract The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [pyz_color_code] column.
     *
     * @param string|null $v New value
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstract The current object (for fluent API support)
     */
    public function setPyzColorCode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->pyz_color_code !== $v) {
            $this->pyz_color_code = $v;
            $this->modifiedColumns[SpyProductAbstractTableMap::COL_PYZ_COLOR_CODE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyProductAbstractTableMap::translateFieldName('Attributes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->attributes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductAbstractTableMap::translateFieldName('NewFrom', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->new_from = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyProductAbstractTableMap::translateFieldName('NewTo', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->new_to = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyProductAbstractTableMap::translateFieldName('PyzColorCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pyz_color_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyProductAbstractTableMap::translateFieldName('Sku', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sku = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyProductAbstractTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpyProductAbstractTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = SpyProductAbstractTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyProductAbstractTableMap::COL_PYZ_COLOR_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'pyz_color_code';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'new_to':
                        ...
                        break;
                    case 'pyz_color_code':
                        $stmt->bindValue($identifier, $this->pyz_color_code, PDO::PARAM_STR);
                        break;
                    case 'sku':
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getNewFrom(),
            $keys[4] => $this->getNewTo(),
            $keys[5] => $this->getPyzColorCode(),
            $keys[6] => $this->getSku(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstract
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setNewFrom($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setNewTo($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPyzColorCode($arr[$keys[5]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstract The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyProductAbstractTableMap::COL_PYZ_COLOR_CODE)) {
            $criteria->add(SpyProductAbstractTableMap::COL_PYZ_COLOR_CODE, $this->pyz_color_code);
        }
        if ($this->isColumnModified(SpyProductAbstractTableMap::COL_SKU)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPyzColorCode($this->getPyzColorCode());
     ...
     */
    public function resetPartialSpyCmsBlockProductConnectors($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCmsBlockProductConnectors($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductAbstract The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyCmsBlockProductConnectors(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCmsBlockProductConnectorsPartial && !$this->isNew();
        if (null === $this->collSpyCmsBlockProductConnectors || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCmsBlockProductConnector(SpyCmsBlockProductConnector $spyCmsBlockProductConnector)
    {
     ...
     */
    public function resetPartialSpyProductAbstractLocalizedAttributess($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAbstractLocalizedAttributess($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductAbstractLocalizedAttributess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAbstractLocalizedAttributessPartial && !$this->isNew();
        if (null === $this->collSpyProductAbstractLocalizedAttributess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductAbstractLocalizedAttributes(ChildSpyProductAbstractLocalizedAttributes $spyProductAbstractLocalizedAttributes)
    {
     ...
     */
    public function resetPartialSpyProductAbstractStores($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAbstractStores($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductAbstractStores(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAbstractStoresPartial && !$this->isNew();
        if (null === $this->collSpyProductAbstractStores || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductAbstractStore(ChildSpyProductAbstractStore $spyProductAbstractStore)
    {
     ...
     */
    public function resetPartialSpyProductAlternatives($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAlternatives($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductAlternatives(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAlternativesPartial && !$this->isNew();
        if (null === $this->collSpyProductAlternatives || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductAlternative(SpyProductAlternative $spyProductAlternative)
    {
     ...
     */
    protected function doAddSpyProductCategory(SpyProductCategory $spyProductCategory)
    {
     ...
     */
    public function resetPartialSpyProductCustomerPermissions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductCustomerPermissions($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductCustomerPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductCustomerPermissionsPartial && !$this->isNew();
        if (null === $this->collSpyProductCustomerPermissions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductCustomerPermission(SpyProductCustomerPermission $spyProductCustomerPermission)
    {
     ...
     */
    protected function doAddSpyProductAbstractGroup(SpyProductAbstractGroup $spyProductAbstractGroup)
    {
     ...
     */
    public function resetPartialSpyProductLabelProductAbstracts($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductLabelProductAbstracts($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductLabelProductAbstracts(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductLabelProductAbstractsPartial && !$this->isNew();
        if (null === $this->collSpyProductLabelProductAbstracts || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductLabelProductAbstract(SpyProductLabelProductAbstract $spyProductLabelProductAbstract)
    {
     ...
     */
    public function resetPartialSpyProductMeasurementBaseUnits($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductMeasurementBaseUnits($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductMeasurementBaseUnits(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductMeasurementBaseUnitsPartial && !$this->isNew();
        if (null === $this->collSpyProductMeasurementBaseUnits || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductMeasurementBaseUnit(SpyProductMeasurementBaseUnit $spyProductMeasurementBaseUnit)
    {
     ...
     */
    public function resetPartialSpyProductAbstractProductOptionGroups($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAbstractProductOptionGroups($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductAbstractProductOptionGroups(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAbstractProductOptionGroupsPartial && !$this->isNew();
        if (null === $this->collSpyProductAbstractProductOptionGroups || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductAbstractProductOptionGroup(SpyProductAbstractProductOptionGroup $spyProductAbstractProductOptionGroup)
    {
     ...
     */
    protected function doAddSpyProductRelation(SpyProductRelation $spyProductRelation)
    {
     ...
     */
    public function resetPartialSpyProductRelationProductAbstracts($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductRelationProductAbstracts($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductRelationProductAbstracts(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductRelationProductAbstractsPartial && !$this->isNew();
        if (null === $this->collSpyProductRelationProductAbstracts || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductRelationProductAbstract(SpyProductRelationProductAbstract $spyProductRelationProductAbstract)
    {
     ...
     */
    public function resetPartialSpyProductReviews($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductReviews($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductReviews(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductReviewsPartial && !$this->isNew();
        if (null === $this->collSpyProductReviews || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductReview(SpyProductReview $spyProductReview)
    {
     ...
     */
    public function resetPartialSpyProductAbstractSets($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductAbstractSets($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductAbstractSets(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAbstractSetsPartial && !$this->isNew();
        if (null === $this->collSpyProductAbstractSets || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductAbstractSet(SpyProductAbstractSet $spyProductAbstractSet)
    {
     ...
     */
    protected function doAddSpyUrl(SpyUrl $spyUrl)
    {
     ...
     * @return bool
     */
    public function isSpyProductOptionGroupsLoaded()
    {
     ...
     */
    public function countSpyProductOptionGroups(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductOptionGroupsPartial && !$this->isNew();
        if (null === $this->collSpyProductOptionGroups || null !== $criteria || $partial) {
