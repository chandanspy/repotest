...
abstract class SpyProductAbstractLocalizedAttributes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Product\\Persistence\\Map\\SpyProductAbstractLocalizedAttributesTableMap';
     ...
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstractLocalizedAttributes The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstractLocalizedAttributes
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAbstractLocalizedAttributes The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyProductAbstractLocalizedAttributes The current object (for fluent API support)
     */
