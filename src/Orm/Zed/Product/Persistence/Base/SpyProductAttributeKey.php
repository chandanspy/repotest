...
abstract class SpyProductAttributeKey implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Product\\Persistence\\Map\\SpyProductAttributeKeyTableMap';
     ...
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAttributeKey The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAttributeKey
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Product\Persistence\SpyProductAttributeKey The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyProductManagementAttributes($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductManagementAttributes($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductAttributeKey The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyProductManagementAttributes(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductManagementAttributesPartial && !$this->isNew();
        if (null === $this->collSpyProductManagementAttributes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductManagementAttribute(SpyProductManagementAttribute $spyProductManagementAttribute)
    {
     ...
     */
    public function resetPartialSpyProductSearchAttributeMaps($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductSearchAttributeMaps($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductSearchAttributeMaps(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductSearchAttributeMapsPartial && !$this->isNew();
        if (null === $this->collSpyProductSearchAttributeMaps || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductSearchAttributeMap(SpyProductSearchAttributeMap $spyProductSearchAttributeMap)
    {
     ...
     */
    public function resetPartialSpyProductSearchAttributes($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductSearchAttributes($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductSearchAttributes(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductSearchAttributesPartial && !$this->isNew();
        if (null === $this->collSpyProductSearchAttributes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductSearchAttribute(SpyProductSearchAttribute $spyProductSearchAttribute)
    {
