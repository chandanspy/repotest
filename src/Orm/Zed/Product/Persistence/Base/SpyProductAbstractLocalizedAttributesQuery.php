 ...
 *
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByIdAbstractAttributes(int $id_abstract_attributes) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the id_abstract_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByIdAbstractAttributes(int $id_abstract_attributes) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the id_abstract_attributes column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByAttributes(string $attributes) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByAttributes(string $attributes) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the attributes column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByDescription(string $description) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByDescription(string $description) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the description column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByMetaDescription(string $meta_description) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByMetaDescription(string $meta_description) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_description column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByMetaKeywords(string $meta_keywords) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_keywords column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByMetaKeywords(string $meta_keywords) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_keywords column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByMetaTitle(string $meta_title) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByMetaTitle(string $meta_title) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the meta_title column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByName(string $name) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByName(string $name) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the name column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByCreatedAt(string $created_at) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the created_at column
 * @method     ChildSpyProductAbstractLocalizedAttributes[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractLocalizedAttributes> findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractLocalizedAttributes objects filtered by the updated_at column
...
abstract class SpyProductAbstractLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAbstractLocalizedAttributesTableMap::COL_ID_ABSTRACT_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAbstractLocalizedAttributesTableMap::COL_ID_ABSTRACT_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductAbstractLocalizedAttributesQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractLocalizedAttributesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractLocalizedAttributesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractLocalizedAttributesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractLocalizedAttributesTableMap::COL_CREATED_AT);
    }
