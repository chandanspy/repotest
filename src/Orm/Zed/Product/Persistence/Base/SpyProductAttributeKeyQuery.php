 ...
 *
 * @method     ChildSpyProductAttributeKey[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAttributeKey objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAttributeKey> find(ConnectionInterface $con = null) Return ChildSpyProductAttributeKey objects based on current ModelCriteria
 * @method     ChildSpyProductAttributeKey[]|ObjectCollection findByIdProductAttributeKey(int $id_product_attribute_key) Return ChildSpyProductAttributeKey objects filtered by the id_product_attribute_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAttributeKey> findByIdProductAttributeKey(int $id_product_attribute_key) Return ChildSpyProductAttributeKey objects filtered by the id_product_attribute_key column
 * @method     ChildSpyProductAttributeKey[]|ObjectCollection findByIsSuper(boolean $is_super) Return ChildSpyProductAttributeKey objects filtered by the is_super column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAttributeKey> findByIsSuper(boolean $is_super) Return ChildSpyProductAttributeKey objects filtered by the is_super column
 * @method     ChildSpyProductAttributeKey[]|ObjectCollection findByKey(string $key) Return ChildSpyProductAttributeKey objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAttributeKey> findByKey(string $key) Return ChildSpyProductAttributeKey objects filtered by the key column
...
abstract class SpyProductAttributeKeyQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAttributeKeyTableMap::COL_ID_PRODUCT_ATTRIBUTE_KEY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAttributeKeyTableMap::COL_ID_PRODUCT_ATTRIBUTE_KEY, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
    public function filterBySpyProductSearchAttributeMap($spyProductSearchAttributeMap, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
    public function joinSpyProductSearchAttributeMap($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductSearchAttributeMap', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductSearchAttributeMap', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
    public function filterBySpyProductSearchAttribute($spyProductSearchAttribute, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductAttributeKeyQuery The current query, for fluid interface
     */
    public function joinSpyProductSearchAttribute($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyProductSearchAttribute', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductSearchAttribute', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
