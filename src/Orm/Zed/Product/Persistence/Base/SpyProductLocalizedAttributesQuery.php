 ...
 *
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyProductLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByIdProductAttributes(int $id_product_attributes) Return ChildSpyProductLocalizedAttributes objects filtered by the id_product_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByIdProductAttributes(int $id_product_attributes) Return ChildSpyProductLocalizedAttributes objects filtered by the id_product_attributes column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyProductLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyProductLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyProductLocalizedAttributes objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByFkProduct(int $fk_product) Return ChildSpyProductLocalizedAttributes objects filtered by the fk_product column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByAttributes(string $attributes) Return ChildSpyProductLocalizedAttributes objects filtered by the attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByAttributes(string $attributes) Return ChildSpyProductLocalizedAttributes objects filtered by the attributes column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByDescription(string $description) Return ChildSpyProductLocalizedAttributes objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByDescription(string $description) Return ChildSpyProductLocalizedAttributes objects filtered by the description column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByIsComplete(boolean $is_complete) Return ChildSpyProductLocalizedAttributes objects filtered by the is_complete column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByIsComplete(boolean $is_complete) Return ChildSpyProductLocalizedAttributes objects filtered by the is_complete column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByName(string $name) Return ChildSpyProductLocalizedAttributes objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByName(string $name) Return ChildSpyProductLocalizedAttributes objects filtered by the name column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductLocalizedAttributes objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByCreatedAt(string $created_at) Return ChildSpyProductLocalizedAttributes objects filtered by the created_at column
 * @method     ChildSpyProductLocalizedAttributes[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductLocalizedAttributes objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductLocalizedAttributes> findByUpdatedAt(string $updated_at) Return ChildSpyProductLocalizedAttributes objects filtered by the updated_at column
...
abstract class SpyProductLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductLocalizedAttributesTableMap::COL_ID_PRODUCT_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductLocalizedAttributesTableMap::COL_ID_PRODUCT_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductLocalizedAttributesQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyProductLocalizedAttributesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductLocalizedAttributesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductLocalizedAttributesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductLocalizedAttributesTableMap::COL_CREATED_AT);
    }

} // SpyProductLocalizedAttributesQuery
