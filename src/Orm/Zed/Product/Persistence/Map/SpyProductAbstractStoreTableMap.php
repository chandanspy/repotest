...
class SpyProductAbstractStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Product.Persistence.Map.SpyProductAbstractStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Product\\Persistence\\SpyProductAbstractStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Product.Persistence.SpyProductAbstractStore';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_STORE = 'spy_product_abstract_store.id_product_abstract_store';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_store.fk_product_abstract';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_product_abstract_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractStore', 'FkProductAbstract', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractStore', 'fkProductAbstract', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractStoreTableMap::COL_ID_PRODUCT_ABSTRACT_STORE, SpyProductAbstractStoreTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_store', 'fk_product_abstract', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractStore' => 0, 'FkProductAbstract' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractStore' => 0, 'fkProductAbstract' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductAbstractStoreTableMap::COL_ID_PRODUCT_ABSTRACT_STORE => 0, SpyProductAbstractStoreTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductAbstractStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_store' => 0, 'fk_product_abstract' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductAbstractStoreTableMap
