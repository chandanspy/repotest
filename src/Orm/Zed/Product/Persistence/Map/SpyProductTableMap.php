...
class SpyProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Product.Persistence.Map.SpyProductTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Product\\Persistence\\SpyProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Product.Persistence.SpyProduct';
     ...
     */
    const COL_ID_PRODUCT = 'spy_product.id_product';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product.fk_product_abstract';

    /**
     * the column name for the attributes field
     */
    const COL_ATTRIBUTES = 'spy_product.attributes';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_product.is_active';

    /**
     * the column name for the is_quantity_splittable field
     */
    const COL_IS_QUANTITY_SPLITTABLE = 'spy_product.is_quantity_splittable';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_product.sku';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProduct', 'FkProductAbstract', 'Attributes', 'IsActive', 'IsQuantitySplittable', 'Sku', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProduct', 'fkProductAbstract', 'attributes', 'isActive', 'isQuantitySplittable', 'sku', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductTableMap::COL_ID_PRODUCT, SpyProductTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductTableMap::COL_ATTRIBUTES, SpyProductTableMap::COL_IS_ACTIVE, SpyProductTableMap::COL_IS_QUANTITY_SPLITTABLE, SpyProductTableMap::COL_SKU, SpyProductTableMap::COL_CREATED_AT, SpyProductTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product', 'fk_product_abstract', 'attributes', 'is_active', 'is_quantity_splittable', 'sku', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProduct' => 0, 'FkProductAbstract' => 1, 'Attributes' => 2, 'IsActive' => 3, 'IsQuantitySplittable' => 4, 'Sku' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProduct' => 0, 'fkProductAbstract' => 1, 'attributes' => 2, 'isActive' => 3, 'isQuantitySplittable' => 4, 'sku' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyProductTableMap::COL_ID_PRODUCT => 0, SpyProductTableMap::COL_FK_PRODUCT_ABSTRACT => 1, SpyProductTableMap::COL_ATTRIBUTES => 2, SpyProductTableMap::COL_IS_ACTIVE => 3, SpyProductTableMap::COL_IS_QUANTITY_SPLITTABLE => 4, SpyProductTableMap::COL_SKU => 5, SpyProductTableMap::COL_CREATED_AT => 6, SpyProductTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_product' => 0, 'fk_product_abstract' => 1, 'attributes' => 2, 'is_active' => 3, 'is_quantity_splittable' => 4, 'sku' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
  ...
  array (
    ...
    1 => ':id_product',
        ...
        $this->addRelation('SpyProductBundleRelatedByFkBundledProduct', '\\Orm\\Zed\\ProductBundle\\Persistence\\SpyProductBundle', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_bundled_product',
    1 => ':id_product',
  ),
), 'CASCADE', 'CASCADE', 'SpyProductBundlesRelatedByFkBundledProduct', false);
