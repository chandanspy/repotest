...
class SpyProductAttributeKeyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Product.Persistence.Map.SpyProductAttributeKeyTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_attribute_key';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Product\\Persistence\\SpyProductAttributeKey';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Product.Persistence.SpyProductAttributeKey';
     ...
     */
    const COL_ID_PRODUCT_ATTRIBUTE_KEY = 'spy_product_attribute_key.id_product_attribute_key';

    /**
     * the column name for the is_super field
     */
    const COL_IS_SUPER = 'spy_product_attribute_key.is_super';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_attribute_key.key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAttributeKey', 'IsSuper', 'Key', ),
        self::TYPE_CAMELNAME     => array('idProductAttributeKey', 'isSuper', 'key', ),
        self::TYPE_COLNAME       => array(SpyProductAttributeKeyTableMap::COL_ID_PRODUCT_ATTRIBUTE_KEY, SpyProductAttributeKeyTableMap::COL_IS_SUPER, SpyProductAttributeKeyTableMap::COL_KEY, ),
        self::TYPE_FIELDNAME     => array('id_product_attribute_key', 'is_super', 'key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAttributeKey' => 0, 'IsSuper' => 1, 'Key' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductAttributeKey' => 0, 'isSuper' => 1, 'key' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductAttributeKeyTableMap::COL_ID_PRODUCT_ATTRIBUTE_KEY => 0, SpyProductAttributeKeyTableMap::COL_IS_SUPER => 1, SpyProductAttributeKeyTableMap::COL_KEY => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_attribute_key' => 0, 'is_super' => 1, 'key' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductAttributeKeyTableMap
