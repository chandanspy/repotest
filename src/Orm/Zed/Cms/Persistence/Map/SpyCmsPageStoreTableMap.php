...
class SpyCmsPageStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Cms.Persistence.Map.SpyCmsPageStoreTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_page_store';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Cms\\Persistence\\SpyCmsPageStore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Cms.Persistence.SpyCmsPageStore';
     ...
     */
    const COL_ID_CMS_PAGE_STORE = 'spy_cms_page_store.id_cms_page_store';

    /**
     * the column name for the fk_cms_page field
     */
    const COL_FK_CMS_PAGE = 'spy_cms_page_store.fk_cms_page';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_cms_page_store.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsPageStore', 'FkCmsPage', 'FkStore', ),
        self::TYPE_CAMELNAME     => array('idCmsPageStore', 'fkCmsPage', 'fkStore', ),
        self::TYPE_COLNAME       => array(SpyCmsPageStoreTableMap::COL_ID_CMS_PAGE_STORE, SpyCmsPageStoreTableMap::COL_FK_CMS_PAGE, SpyCmsPageStoreTableMap::COL_FK_STORE, ),
        self::TYPE_FIELDNAME     => array('id_cms_page_store', 'fk_cms_page', 'fk_store', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsPageStore' => 0, 'FkCmsPage' => 1, 'FkStore' => 2, ),
        self::TYPE_CAMELNAME     => array('idCmsPageStore' => 0, 'fkCmsPage' => 1, 'fkStore' => 2, ),
        self::TYPE_COLNAME       => array(SpyCmsPageStoreTableMap::COL_ID_CMS_PAGE_STORE => 0, SpyCmsPageStoreTableMap::COL_FK_CMS_PAGE => 1, SpyCmsPageStoreTableMap::COL_FK_STORE => 2, ),
        self::TYPE_FIELDNAME     => array('id_cms_page_store' => 0, 'fk_cms_page' => 1, 'fk_store' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
