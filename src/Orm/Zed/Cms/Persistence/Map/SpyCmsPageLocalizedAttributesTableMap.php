...
class SpyCmsPageLocalizedAttributesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Cms.Persistence.Map.SpyCmsPageLocalizedAttributesTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_page_localized_attributes';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Cms\\Persistence\\SpyCmsPageLocalizedAttributes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Cms.Persistence.SpyCmsPageLocalizedAttributes';
     ...
     */
    const COL_ID_CMS_PAGE_LOCALIZED_ATTRIBUTES = 'spy_cms_page_localized_attributes.id_cms_page_localized_attributes';

    /**
     * the column name for the fk_cms_page field
     */
    const COL_FK_CMS_PAGE = 'spy_cms_page_localized_attributes.fk_cms_page';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_cms_page_localized_attributes.fk_locale';

    /**
     * the column name for the meta_description field
     */
    const COL_META_DESCRIPTION = 'spy_cms_page_localized_attributes.meta_description';

    /**
     * the column name for the meta_keywords field
     */
    const COL_META_KEYWORDS = 'spy_cms_page_localized_attributes.meta_keywords';

    /**
     * the column name for the meta_title field
     */
    const COL_META_TITLE = 'spy_cms_page_localized_attributes.meta_title';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_cms_page_localized_attributes.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_cms_page_localized_attributes.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_cms_page_localized_attributes.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsPageLocalizedAttributes', 'FkCmsPage', 'FkLocale', 'MetaDescription', 'MetaKeywords', 'MetaTitle', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCmsPageLocalizedAttributes', 'fkCmsPage', 'fkLocale', 'metaDescription', 'metaKeywords', 'metaTitle', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCmsPageLocalizedAttributesTableMap::COL_ID_CMS_PAGE_LOCALIZED_ATTRIBUTES, SpyCmsPageLocalizedAttributesTableMap::COL_FK_CMS_PAGE, SpyCmsPageLocalizedAttributesTableMap::COL_FK_LOCALE, SpyCmsPageLocalizedAttributesTableMap::COL_META_DESCRIPTION, SpyCmsPageLocalizedAttributesTableMap::COL_META_KEYWORDS, SpyCmsPageLocalizedAttributesTableMap::COL_META_TITLE, SpyCmsPageLocalizedAttributesTableMap::COL_NAME, SpyCmsPageLocalizedAttributesTableMap::COL_CREATED_AT, SpyCmsPageLocalizedAttributesTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_cms_page_localized_attributes', 'fk_cms_page', 'fk_locale', 'meta_description', 'meta_keywords', 'meta_title', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsPageLocalizedAttributes' => 0, 'FkCmsPage' => 1, 'FkLocale' => 2, 'MetaDescription' => 3, 'MetaKeywords' => 4, 'MetaTitle' => 5, 'Name' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idCmsPageLocalizedAttributes' => 0, 'fkCmsPage' => 1, 'fkLocale' => 2, 'metaDescription' => 3, 'metaKeywords' => 4, 'metaTitle' => 5, 'name' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        ...
        self::TYPE_FIELDNAME     => array('id_cms_page_localized_attributes' => 0, 'fk_cms_page' => 1, 'fk_locale' => 2, 'meta_description' => 3, 'meta_keywords' => 4, 'meta_title' => 5, 'name' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
