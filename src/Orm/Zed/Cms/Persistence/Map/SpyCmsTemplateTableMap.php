...
class SpyCmsTemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Cms.Persistence.Map.SpyCmsTemplateTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Cms\\Persistence\\SpyCmsTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Cms.Persistence.SpyCmsTemplate';
