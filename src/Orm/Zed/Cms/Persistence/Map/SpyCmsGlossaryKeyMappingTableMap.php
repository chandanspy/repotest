...
class SpyCmsGlossaryKeyMappingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Cms.Persistence.Map.SpyCmsGlossaryKeyMappingTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_glossary_key_mapping';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Cms\\Persistence\\SpyCmsGlossaryKeyMapping';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Cms.Persistence.SpyCmsGlossaryKeyMapping';
     ...
     */
    const COL_ID_CMS_GLOSSARY_KEY_MAPPING = 'spy_cms_glossary_key_mapping.id_cms_glossary_key_mapping';

    /**
     * the column name for the fk_glossary_key field
     */
    const COL_FK_GLOSSARY_KEY = 'spy_cms_glossary_key_mapping.fk_glossary_key';

    /**
     * the column name for the fk_page field
     */
    const COL_FK_PAGE = 'spy_cms_glossary_key_mapping.fk_page';

    /**
     * the column name for the placeholder field
     */
    const COL_PLACEHOLDER = 'spy_cms_glossary_key_mapping.placeholder';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsGlossaryKeyMapping', 'FkGlossaryKey', 'FkPage', 'Placeholder', ),
        self::TYPE_CAMELNAME     => array('idCmsGlossaryKeyMapping', 'fkGlossaryKey', 'fkPage', 'placeholder', ),
        self::TYPE_COLNAME       => array(SpyCmsGlossaryKeyMappingTableMap::COL_ID_CMS_GLOSSARY_KEY_MAPPING, SpyCmsGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY, SpyCmsGlossaryKeyMappingTableMap::COL_FK_PAGE, SpyCmsGlossaryKeyMappingTableMap::COL_PLACEHOLDER, ),
        self::TYPE_FIELDNAME     => array('id_cms_glossary_key_mapping', 'fk_glossary_key', 'fk_page', 'placeholder', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsGlossaryKeyMapping' => 0, 'FkGlossaryKey' => 1, 'FkPage' => 2, 'Placeholder' => 3, ),
        self::TYPE_CAMELNAME     => array('idCmsGlossaryKeyMapping' => 0, 'fkGlossaryKey' => 1, 'fkPage' => 2, 'placeholder' => 3, ),
        self::TYPE_COLNAME       => array(SpyCmsGlossaryKeyMappingTableMap::COL_ID_CMS_GLOSSARY_KEY_MAPPING => 0, SpyCmsGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY => 1, SpyCmsGlossaryKeyMappingTableMap::COL_FK_PAGE => 2, SpyCmsGlossaryKeyMappingTableMap::COL_PLACEHOLDER => 3, ),
        self::TYPE_FIELDNAME     => array('id_cms_glossary_key_mapping' => 0, 'fk_glossary_key' => 1, 'fk_page' => 2, 'placeholder' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyCmsGlossaryKeyMappingTableMap
