...
class SpyCmsPageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Cms.Persistence.Map.SpyCmsPageTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Cms\\Persistence\\SpyCmsPage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Cms.Persistence.SpyCmsPage';
     ...
     */
    const COL_IS_SEARCHABLE = 'spy_cms_page.is_searchable';

    /**
     * the column name for the page_key field
     */
    const COL_PAGE_KEY = 'spy_cms_page.page_key';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_cms_page.uuid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsPage', 'FkTemplate', 'IsActive', 'IsSearchable', 'PageKey', 'Uuid', 'ValidFrom', 'ValidTo', ),
        self::TYPE_CAMELNAME     => array('idCmsPage', 'fkTemplate', 'isActive', 'isSearchable', 'pageKey', 'uuid', 'validFrom', 'validTo', ),
        self::TYPE_COLNAME       => array(SpyCmsPageTableMap::COL_ID_CMS_PAGE, SpyCmsPageTableMap::COL_FK_TEMPLATE, SpyCmsPageTableMap::COL_IS_ACTIVE, SpyCmsPageTableMap::COL_IS_SEARCHABLE, SpyCmsPageTableMap::COL_PAGE_KEY, SpyCmsPageTableMap::COL_UUID, SpyCmsPageTableMap::COL_VALID_FROM, SpyCmsPageTableMap::COL_VALID_TO, ),
        self::TYPE_FIELDNAME     => array('id_cms_page', 'fk_template', 'is_active', 'is_searchable', 'page_key', 'uuid', 'valid_from', 'valid_to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsPage' => 0, 'FkTemplate' => 1, 'IsActive' => 2, 'IsSearchable' => 3, 'PageKey' => 4, 'Uuid' => 5, 'ValidFrom' => 6, 'ValidTo' => 7, ),
        self::TYPE_CAMELNAME     => array('idCmsPage' => 0, 'fkTemplate' => 1, 'isActive' => 2, 'isSearchable' => 3, 'pageKey' => 4, 'uuid' => 5, 'validFrom' => 6, 'validTo' => 7, ),
        self::TYPE_COLNAME       => array(SpyCmsPageTableMap::COL_ID_CMS_PAGE => 0, SpyCmsPageTableMap::COL_FK_TEMPLATE => 1, SpyCmsPageTableMap::COL_IS_ACTIVE => 2, SpyCmsPageTableMap::COL_IS_SEARCHABLE => 3, SpyCmsPageTableMap::COL_PAGE_KEY => 4, SpyCmsPageTableMap::COL_UUID => 5, SpyCmsPageTableMap::COL_VALID_FROM => 6, SpyCmsPageTableMap::COL_VALID_TO => 7, ),
        self::TYPE_FIELDNAME     => array('id_cms_page' => 0, 'fk_template' => 1, 'is_active' => 2, 'is_searchable' => 3, 'page_key' => 4, 'uuid' => 5, 'valid_from' => 6, 'valid_to' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
