 ...
 *
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsPageLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyCmsPageLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByIdCmsPageLocalizedAttributes(int $id_cms_page_localized_attributes) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the id_cms_page_localized_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByIdCmsPageLocalizedAttributes(int $id_cms_page_localized_attributes) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the id_cms_page_localized_attributes column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the fk_cms_page column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the fk_cms_page column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByMetaDescription(string $meta_description) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByMetaDescription(string $meta_description) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_description column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByMetaKeywords(string $meta_keywords) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_keywords column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByMetaKeywords(string $meta_keywords) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_keywords column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByMetaTitle(string $meta_title) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByMetaTitle(string $meta_title) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the meta_title column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByName(string $name) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByName(string $name) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the name column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByCreatedAt(string $created_at) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the created_at column
 * @method     ChildSpyCmsPageLocalizedAttributes[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsPageLocalizedAttributes> findByUpdatedAt(string $updated_at) Return ChildSpyCmsPageLocalizedAttributes objects filtered by the updated_at column
...
abstract class SpyCmsPageLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsPageLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsPageLocalizedAttributesTableMap::COL_ID_CMS_PAGE_LOCALIZED_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsPageLocalizedAttributesTableMap::COL_ID_CMS_PAGE_LOCALIZED_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCmsPageLocalizedAttributesQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyCmsPageLocalizedAttributesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsPageLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsPageLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsPageLocalizedAttributesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsPageLocalizedAttributesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsPageLocalizedAttributesTableMap::COL_CREATED_AT);
    }

} // SpyCmsPageLocalizedAttributesQuery
