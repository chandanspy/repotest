...
abstract class SpyCmsPage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Cms\\Persistence\\Map\\SpyCmsPageTableMap';
     ...
     * @return $this|\Orm\Zed\Cms\Persistence\SpyCmsPage The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Cms\Persistence\SpyCmsPage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Cms\Persistence\SpyCmsPage The current object, for fluid interface
     */
     ...
     */
    protected function doAddSpyCmsVersion(ChildSpyCmsVersion $spyCmsVersion)
    {
     ...
     */
    protected function doAddSpyCmsPageLocalizedAttributes(ChildSpyCmsPageLocalizedAttributes $spyCmsPageLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyCmsPageStore(ChildSpyCmsPageStore $spyCmsPageStore)
    {
