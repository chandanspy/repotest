 ...
 *
 * @method     ChildSpyCmsVersion[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCmsVersion objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> find(ConnectionInterface $con = null) Return ChildSpyCmsVersion objects based on current ModelCriteria
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByIdCmsVersion(int $id_cms_version) Return ChildSpyCmsVersion objects filtered by the id_cms_version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByIdCmsVersion(int $id_cms_version) Return ChildSpyCmsVersion objects filtered by the id_cms_version column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsVersion objects filtered by the fk_cms_page column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByFkCmsPage(int $fk_cms_page) Return ChildSpyCmsVersion objects filtered by the fk_cms_page column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByFkUser(int $fk_user) Return ChildSpyCmsVersion objects filtered by the fk_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByFkUser(int $fk_user) Return ChildSpyCmsVersion objects filtered by the fk_user column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByData(string $data) Return ChildSpyCmsVersion objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByData(string $data) Return ChildSpyCmsVersion objects filtered by the data column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByVersion(int $version) Return ChildSpyCmsVersion objects filtered by the version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByVersion(int $version) Return ChildSpyCmsVersion objects filtered by the version column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByVersionName(string $version_name) Return ChildSpyCmsVersion objects filtered by the version_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByVersionName(string $version_name) Return ChildSpyCmsVersion objects filtered by the version_name column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCmsVersion objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByCreatedAt(string $created_at) Return ChildSpyCmsVersion objects filtered by the created_at column
 * @method     ChildSpyCmsVersion[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCmsVersion objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCmsVersion> findByUpdatedAt(string $updated_at) Return ChildSpyCmsVersion objects filtered by the updated_at column
...
abstract class SpyCmsVersionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCmsVersionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCmsVersionTableMap::COL_ID_CMS_VERSION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCmsVersionTableMap::COL_ID_CMS_VERSION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCmsVersionQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyCmsVersionTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsVersionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsVersionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCmsVersionTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCmsVersionTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCmsVersionTableMap::COL_CREATED_AT);
    }
