 ...
 *
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyAvailabilityNotificationSubscription objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> find(ConnectionInterface $con = null) Return ChildSpyAvailabilityNotificationSubscription objects based on current ModelCriteria
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByIdAvailabilityNotificationSubscription(int $id_availability_notification_subscription) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the id_availability_notification_subscription column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByIdAvailabilityNotificationSubscription(int $id_availability_notification_subscription) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the id_availability_notification_subscription column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByFkLocale(int $fk_locale) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the fk_locale column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByFkStore(int $fk_store) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the fk_store column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByCustomerReference(string $customer_reference) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the customer_reference column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByEmail(string $email) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the email column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByEmail(string $email) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the email column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findBySku(string $sku) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findBySku(string $sku) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the sku column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findBySubscriptionKey(string $subscription_key) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the subscription_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findBySubscriptionKey(string $subscription_key) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the subscription_key column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByCreatedAt(string $created_at) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the created_at column
 * @method     ChildSpyAvailabilityNotificationSubscription[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailabilityNotificationSubscription> findByUpdatedAt(string $updated_at) Return ChildSpyAvailabilityNotificationSubscription objects filtered by the updated_at column
...
abstract class SpyAvailabilityNotificationSubscriptionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyAvailabilityNotificationSubscriptionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyAvailabilityNotificationSubscriptionTableMap::COL_ID_AVAILABILITY_NOTIFICATION_SUBSCRIPTION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyAvailabilityNotificationSubscriptionTableMap::COL_ID_AVAILABILITY_NOTIFICATION_SUBSCRIPTION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyAvailabilityNotificationSubscriptionQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyAvailabilityNotificationSubscriptionTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyAvailabilityNotificationSubscriptionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyAvailabilityNotificationSubscriptionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyAvailabilityNotificationSubscriptionTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyAvailabilityNotificationSubscriptionTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyAvailabilityNotificationSubscriptionTableMap::COL_CREATED_AT);
    }

} // SpyAvailabilityNotificationSubscriptionQuery
