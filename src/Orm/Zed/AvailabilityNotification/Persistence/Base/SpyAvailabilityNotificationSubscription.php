...
abstract class SpyAvailabilityNotificationSubscription implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\AvailabilityNotification\\Persistence\\Map\\SpyAvailabilityNotificationSubscriptionTableMap';
     ...
     * @return $this|\Orm\Zed\AvailabilityNotification\Persistence\SpyAvailabilityNotificationSubscription The current object (for fluent API support)
     */
    public function setIdAvailabilityNotificationSubscription($v)
    {
        ...
        return $this;
    } // setIdAvailabilityNotificationSubscription()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\AvailabilityNotification\Persistence\SpyAvailabilityNotificationSubscription
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\AvailabilityNotification\Persistence\SpyAvailabilityNotificationSubscription The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyAvailabilityNotificationSubscription The current object (for fluent API support)
     */
