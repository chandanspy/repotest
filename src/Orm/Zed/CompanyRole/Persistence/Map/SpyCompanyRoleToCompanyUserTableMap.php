...
class SpyCompanyRoleToCompanyUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CompanyRole.Persistence.Map.SpyCompanyRoleToCompanyUserTableMap';
     ...
     */
    const TABLE_NAME = 'spy_company_role_to_company_user';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CompanyRole\\Persistence\\SpyCompanyRoleToCompanyUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CompanyRole.Persistence.SpyCompanyRoleToCompanyUser';
     ...
     */
    const COL_ID_COMPANY_ROLE_TO_COMPANY_USER = 'spy_company_role_to_company_user.id_company_role_to_company_user';

    /**
     * the column name for the fk_company_role field
     */
    const COL_FK_COMPANY_ROLE = 'spy_company_role_to_company_user.fk_company_role';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_company_role_to_company_user.fk_company_user';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_company_role_to_company_user.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_company_role_to_company_user.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCompanyRoleToCompanyUser', 'FkCompanyRole', 'FkCompanyUser', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCompanyRoleToCompanyUser', 'fkCompanyRole', 'fkCompanyUser', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCompanyRoleToCompanyUserTableMap::COL_ID_COMPANY_ROLE_TO_COMPANY_USER, SpyCompanyRoleToCompanyUserTableMap::COL_FK_COMPANY_ROLE, SpyCompanyRoleToCompanyUserTableMap::COL_FK_COMPANY_USER, SpyCompanyRoleToCompanyUserTableMap::COL_CREATED_AT, SpyCompanyRoleToCompanyUserTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_company_role_to_company_user', 'fk_company_role', 'fk_company_user', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCompanyRoleToCompanyUser' => 0, 'FkCompanyRole' => 1, 'FkCompanyUser' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idCompanyRoleToCompanyUser' => 0, 'fkCompanyRole' => 1, 'fkCompanyUser' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyCompanyRoleToCompanyUserTableMap::COL_ID_COMPANY_ROLE_TO_COMPANY_USER => 0, SpyCompanyRoleToCompanyUserTableMap::COL_FK_COMPANY_ROLE => 1, SpyCompanyRoleToCompanyUserTableMap::COL_FK_COMPANY_USER => 2, SpyCompanyRoleToCompanyUserTableMap::COL_CREATED_AT => 3, SpyCompanyRoleToCompanyUserTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_company_role_to_company_user' => 0, 'fk_company_role' => 1, 'fk_company_user' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyCompanyRoleToCompanyUserTableMap
