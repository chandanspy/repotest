...
class SpyCompanyRoleToPermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CompanyRole.Persistence.Map.SpyCompanyRoleToPermissionTableMap';
     ...
     */
    const TABLE_NAME = 'spy_company_role_to_permission';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CompanyRole\\Persistence\\SpyCompanyRoleToPermission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CompanyRole.Persistence.SpyCompanyRoleToPermission';
     ...
     */
    const COL_ID_COMPANY_ROLE_TO_PERMISSION = 'spy_company_role_to_permission.id_company_role_to_permission';

    /**
     * the column name for the fk_company_role field
     */
    const COL_FK_COMPANY_ROLE = 'spy_company_role_to_permission.fk_company_role';

    /**
     * the column name for the fk_permission field
     */
    const COL_FK_PERMISSION = 'spy_company_role_to_permission.fk_permission';

    /**
     * the column name for the configuration field
     */
    const COL_CONFIGURATION = 'spy_company_role_to_permission.configuration';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCompanyRoleToPermission', 'FkCompanyRole', 'FkPermission', 'Configuration', ),
        self::TYPE_CAMELNAME     => array('idCompanyRoleToPermission', 'fkCompanyRole', 'fkPermission', 'configuration', ),
        self::TYPE_COLNAME       => array(SpyCompanyRoleToPermissionTableMap::COL_ID_COMPANY_ROLE_TO_PERMISSION, SpyCompanyRoleToPermissionTableMap::COL_FK_COMPANY_ROLE, SpyCompanyRoleToPermissionTableMap::COL_FK_PERMISSION, SpyCompanyRoleToPermissionTableMap::COL_CONFIGURATION, ),
        self::TYPE_FIELDNAME     => array('id_company_role_to_permission', 'fk_company_role', 'fk_permission', 'configuration', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCompanyRoleToPermission' => 0, 'FkCompanyRole' => 1, 'FkPermission' => 2, 'Configuration' => 3, ),
        self::TYPE_CAMELNAME     => array('idCompanyRoleToPermission' => 0, 'fkCompanyRole' => 1, 'fkPermission' => 2, 'configuration' => 3, ),
        self::TYPE_COLNAME       => array(SpyCompanyRoleToPermissionTableMap::COL_ID_COMPANY_ROLE_TO_PERMISSION => 0, SpyCompanyRoleToPermissionTableMap::COL_FK_COMPANY_ROLE => 1, SpyCompanyRoleToPermissionTableMap::COL_FK_PERMISSION => 2, SpyCompanyRoleToPermissionTableMap::COL_CONFIGURATION => 3, ),
        self::TYPE_FIELDNAME     => array('id_company_role_to_permission' => 0, 'fk_company_role' => 1, 'fk_permission' => 2, 'configuration' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyCompanyRoleToPermissionTableMap
