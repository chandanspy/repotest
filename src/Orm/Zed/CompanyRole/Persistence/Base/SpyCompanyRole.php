...
abstract class SpyCompanyRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CompanyRole\\Persistence\\Map\\SpyCompanyRoleTableMap';
     ...
     * @return $this|\Orm\Zed\CompanyRole\Persistence\SpyCompanyRole The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CompanyRole\Persistence\SpyCompanyRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CompanyRole\Persistence\SpyCompanyRole The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCompanyRole The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyCompanyRoleToPermission(ChildSpyCompanyRoleToPermission $spyCompanyRoleToPermission)
    {
     ...
     */
    protected function doAddSpyCompanyRoleToCompanyUser(ChildSpyCompanyRoleToCompanyUser $spyCompanyRoleToCompanyUser)
    {
     ...
     * @return bool
     */
    public function isPermissionIdCompanyRoleToPermissionsLoaded()
    {
     ...
     */
    public function getPermissionIdCompanyRoleToPermissions($criteria = null, ConnectionInterface $con = null)
    {
     ...
     */
    public function countPermissionIdCompanyRoleToPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->combinationCollPermissionIdCompanyRoleToPermissionsPartial && !$this->isNew();
        if (null === $this->combinationCollPermissionIdCompanyRoleToPermissions || null !== $criteria || $partial) {
     ...
     * @return integer
     */
    public function countPermissions($idCompanyRoleToPermission = null, Criteria $criteria = null, ConnectionInterface $con = null)
    {
