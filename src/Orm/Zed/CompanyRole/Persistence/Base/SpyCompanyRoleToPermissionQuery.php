 ...
 *
 * @method     ChildSpyCompanyRoleToPermission[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyRoleToPermission objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToPermission> find(ConnectionInterface $con = null) Return ChildSpyCompanyRoleToPermission objects based on current ModelCriteria
 * @method     ChildSpyCompanyRoleToPermission[]|ObjectCollection findByIdCompanyRoleToPermission(int $id_company_role_to_permission) Return ChildSpyCompanyRoleToPermission objects filtered by the id_company_role_to_permission column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToPermission> findByIdCompanyRoleToPermission(int $id_company_role_to_permission) Return ChildSpyCompanyRoleToPermission objects filtered by the id_company_role_to_permission column
 * @method     ChildSpyCompanyRoleToPermission[]|ObjectCollection findByFkCompanyRole(int $fk_company_role) Return ChildSpyCompanyRoleToPermission objects filtered by the fk_company_role column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToPermission> findByFkCompanyRole(int $fk_company_role) Return ChildSpyCompanyRoleToPermission objects filtered by the fk_company_role column
 * @method     ChildSpyCompanyRoleToPermission[]|ObjectCollection findByFkPermission(int $fk_permission) Return ChildSpyCompanyRoleToPermission objects filtered by the fk_permission column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToPermission> findByFkPermission(int $fk_permission) Return ChildSpyCompanyRoleToPermission objects filtered by the fk_permission column
 * @method     ChildSpyCompanyRoleToPermission[]|ObjectCollection findByConfiguration(string $configuration) Return ChildSpyCompanyRoleToPermission objects filtered by the configuration column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToPermission> findByConfiguration(string $configuration) Return ChildSpyCompanyRoleToPermission objects filtered by the configuration column
...
abstract class SpyCompanyRoleToPermissionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyRoleToPermissionQuery The current query, for fluid interface
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyRoleToPermissionQuery The current query, for fluid interface
     */
...
} // SpyCompanyRoleToPermissionQuery
