 ...
 *
 * @method     ChildSpyCompanyRole[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyRole objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> find(ConnectionInterface $con = null) Return ChildSpyCompanyRole objects based on current ModelCriteria
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByIdCompanyRole(int $id_company_role) Return ChildSpyCompanyRole objects filtered by the id_company_role column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByIdCompanyRole(int $id_company_role) Return ChildSpyCompanyRole objects filtered by the id_company_role column
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByFkCompany(int $fk_company) Return ChildSpyCompanyRole objects filtered by the fk_company column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByFkCompany(int $fk_company) Return ChildSpyCompanyRole objects filtered by the fk_company column
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyCompanyRole objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByIsDefault(boolean $is_default) Return ChildSpyCompanyRole objects filtered by the is_default column
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByKey(string $key) Return ChildSpyCompanyRole objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByKey(string $key) Return ChildSpyCompanyRole objects filtered by the key column
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByName(string $name) Return ChildSpyCompanyRole objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByName(string $name) Return ChildSpyCompanyRole objects filtered by the name column
 * @method     ChildSpyCompanyRole[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCompanyRole objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRole> findByUuid(string $uuid) Return ChildSpyCompanyRole objects filtered by the uuid column
...
abstract class SpyCompanyRoleQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyRoleQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyRoleTableMap::COL_ID_COMPANY_ROLE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyRoleTableMap::COL_ID_COMPANY_ROLE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyRoleQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyCompanyRoleQuery The current query, for fluid interface
     */
    public function filterBySpyCompanyRoleToPermission($spyCompanyRoleToPermission, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyRoleQuery The current query, for fluid interface
     */
    public function joinSpyCompanyRoleToPermission($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCompanyRoleToPermission', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCompanyRoleToPermission', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyRoleQuery The current query, for fluid interface
     */
    public function filterByPermission($spyPermission, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useSpyCompanyRoleToPermissionQuery()
