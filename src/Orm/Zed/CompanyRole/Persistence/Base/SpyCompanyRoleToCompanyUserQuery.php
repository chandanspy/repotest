 ...
 *
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyRoleToCompanyUser objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> find(ConnectionInterface $con = null) Return ChildSpyCompanyRoleToCompanyUser objects based on current ModelCriteria
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection findByIdCompanyRoleToCompanyUser(int $id_company_role_to_company_user) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the id_company_role_to_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> findByIdCompanyRoleToCompanyUser(int $id_company_role_to_company_user) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the id_company_role_to_company_user column
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection findByFkCompanyRole(int $fk_company_role) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the fk_company_role column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> findByFkCompanyRole(int $fk_company_role) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the fk_company_role column
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> findByFkCompanyUser(int $fk_company_user) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the fk_company_user column
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> findByCreatedAt(string $created_at) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the created_at column
 * @method     ChildSpyCompanyRoleToCompanyUser[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyRoleToCompanyUser> findByUpdatedAt(string $updated_at) Return ChildSpyCompanyRoleToCompanyUser objects filtered by the updated_at column
...
abstract class SpyCompanyRoleToCompanyUserQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyRoleToCompanyUserQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyRoleToCompanyUserTableMap::COL_ID_COMPANY_ROLE_TO_COMPANY_USER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyRoleToCompanyUserTableMap::COL_ID_COMPANY_ROLE_TO_COMPANY_USER, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyRoleToCompanyUserQuery The current query, for fluid interface
     */
    public function filterByCompanyRole($spyCompanyRole, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyRoleToCompanyUserQuery The current query, for fluid interface
     */
    public function joinCompanyRole($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('CompanyRole', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('CompanyRole', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyCompanyRoleToCompanyUserTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCompanyRoleToCompanyUserTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCompanyRoleToCompanyUserTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCompanyRoleToCompanyUserTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCompanyRoleToCompanyUserTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCompanyRoleToCompanyUserTableMap::COL_CREATED_AT);
    }

} // SpyCompanyRoleToCompanyUserQuery
