...
abstract class SpyLocale implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Locale\\Persistence\\Map\\SpyLocaleTableMap';
     ...
     * @return $this|\Orm\Zed\Locale\Persistence\SpyLocale The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Locale\Persistence\SpyLocale
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Locale\Persistence\SpyLocale The current object, for fluid interface
     */
     ...
     */
    protected function doAddSpyCategoryAttribute(SpyCategoryAttribute $spyCategoryAttribute)
    {
     ...
     */
    public function resetPartialSpyCategoryImageSets($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCategoryImageSets($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyCategoryImageSets(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCategoryImageSetsPartial && !$this->isNew();
        if (null === $this->collSpyCategoryImageSets || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCategoryImageSet(SpyCategoryImageSet $spyCategoryImageSet)
    {
     ...
     */
    public function resetPartialSpyCmsPageLocalizedAttributess($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCmsPageLocalizedAttributess($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyCmsPageLocalizedAttributess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCmsPageLocalizedAttributessPartial && !$this->isNew();
        if (null === $this->collSpyCmsPageLocalizedAttributess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCmsPageLocalizedAttributes(SpyCmsPageLocalizedAttributes $spyCmsPageLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyContentLocalized(SpyContentLocalized $spyContentLocalized)
    {
     ...
     */
    public function resetPartialSpyCustomers($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCustomers($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyCustomers(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCustomersPartial && !$this->isNew();
        if (null === $this->collSpyCustomers || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCustomer(SpyCustomer $spyCustomer)
    {
     ...
     */
    public function resetPartialSpyFileLocalizedAttributess($v = true)
    {
     ...
     * @return void
     */
    public function initSpyFileLocalizedAttributess($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyFileLocalizedAttributess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyFileLocalizedAttributessPartial && !$this->isNew();
        if (null === $this->collSpyFileLocalizedAttributess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyFileLocalizedAttributes(SpyFileLocalizedAttributes $spyFileLocalizedAttributes)
    {
     ...
     */
    public function resetPartialSpyFileDirectoryLocalizedAttributess($v = true)
    {
     ...
     * @return void
     */
    public function initSpyFileDirectoryLocalizedAttributess($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyFileDirectoryLocalizedAttributess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyFileDirectoryLocalizedAttributessPartial && !$this->isNew();
        if (null === $this->collSpyFileDirectoryLocalizedAttributess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyFileDirectoryLocalizedAttributes(SpyFileDirectoryLocalizedAttributes $spyFileDirectoryLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyGlossaryTranslation(SpyGlossaryTranslation $spyGlossaryTranslation)
    {
     ...
     */
    protected function doAddSpyNavigationNodeLocalizedAttributes(SpyNavigationNodeLocalizedAttributes $spyNavigationNodeLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyProductAbstractLocalizedAttributes(SpyProductAbstractLocalizedAttributes $spyProductAbstractLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyProductLocalizedAttributes(SpyProductLocalizedAttributes $spyProductLocalizedAttributes)
    {
     ...
     */
    protected function doAddSpyProductManagementAttributeValueTranslation(SpyProductManagementAttributeValueTranslation $spyProductManagementAttributeValueTranslation)
    {
     ...
     */
    public function resetPartialSpyProductDiscontinuedNotes($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductDiscontinuedNotes($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductDiscontinuedNotes(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductDiscontinuedNotesPartial && !$this->isNew();
        if (null === $this->collSpyProductDiscontinuedNotes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductDiscontinuedNote(SpyProductDiscontinuedNote $spyProductDiscontinuedNote)
    {
     ...
     */
    public function resetPartialSpyProductLabelLocalizedAttributess($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductLabelLocalizedAttributess($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductLabelLocalizedAttributess(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductLabelLocalizedAttributessPartial && !$this->isNew();
        if (null === $this->collSpyProductLabelLocalizedAttributess || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductLabelLocalizedAttributes(SpyProductLabelLocalizedAttributes $spyProductLabelLocalizedAttributes)
    {
     ...
     */
    public function resetPartialSpyProductSetDatas($v = true)
    {
     ...
     * @return void
     */
    public function initSpyProductSetDatas($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyProductSetDatas(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductSetDatasPartial && !$this->isNew();
        if (null === $this->collSpyProductSetDatas || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductSetData(SpyProductSetData $spyProductSetData)
    {
     ...
     */
    public function resetPartialSpySalesOrders($v = true)
    {
     ...
     * @return void
     */
    public function initSpySalesOrders($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpySalesOrders(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpySalesOrdersPartial && !$this->isNew();
        if (null === $this->collSpySalesOrders || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpySalesOrder(SpySalesOrder $spySalesOrder)
    {
     ...
     */
    public function resetPartialSpyUsers($v = true)
    {
     ...
     * @return void
     */
    public function initSpyUsers($overrideExisting = true)
    {
