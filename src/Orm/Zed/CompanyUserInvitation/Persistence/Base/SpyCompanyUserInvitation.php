...
abstract class SpyCompanyUserInvitation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CompanyUserInvitation\\Persistence\\Map\\SpyCompanyUserInvitationTableMap';
     ...
     * @return $this|\Orm\Zed\CompanyUserInvitation\Persistence\SpyCompanyUserInvitation The current object (for fluent API support)
     */
    ...
    public function setFkCompanyUserInvitationStatus($v)
    {
        ...
        return $this;
    } // setFkCompanyUserInvitationStatus()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CompanyUserInvitation\Persistence\SpyCompanyUserInvitation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CompanyUserInvitation\Persistence\SpyCompanyUserInvitation The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyCompanyUserInvitation The current object (for fluent API support)
     */
