 ...
 *
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCompanyUserInvitation objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> find(ConnectionInterface $con = null) Return ChildSpyCompanyUserInvitation objects based on current ModelCriteria
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByIdCompanyUserInvitation(int $id_company_user_invitation) Return ChildSpyCompanyUserInvitation objects filtered by the id_company_user_invitation column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByIdCompanyUserInvitation(int $id_company_user_invitation) Return ChildSpyCompanyUserInvitation objects filtered by the id_company_user_invitation column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_business_unit column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByFkCompanyUser(int $fk_company_user) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_user column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByFkCompanyUserInvitationStatus(int $fk_company_user_invitation_status) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_user_invitation_status column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByFkCompanyUserInvitationStatus(int $fk_company_user_invitation_status) Return ChildSpyCompanyUserInvitation objects filtered by the fk_company_user_invitation_status column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByEmail(string $email) Return ChildSpyCompanyUserInvitation objects filtered by the email column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByEmail(string $email) Return ChildSpyCompanyUserInvitation objects filtered by the email column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByFirstName(string $first_name) Return ChildSpyCompanyUserInvitation objects filtered by the first_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByFirstName(string $first_name) Return ChildSpyCompanyUserInvitation objects filtered by the first_name column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByHash(string $hash) Return ChildSpyCompanyUserInvitation objects filtered by the hash column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByHash(string $hash) Return ChildSpyCompanyUserInvitation objects filtered by the hash column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByLastName(string $last_name) Return ChildSpyCompanyUserInvitation objects filtered by the last_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByLastName(string $last_name) Return ChildSpyCompanyUserInvitation objects filtered by the last_name column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCompanyUserInvitation objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByCreatedAt(string $created_at) Return ChildSpyCompanyUserInvitation objects filtered by the created_at column
 * @method     ChildSpyCompanyUserInvitation[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCompanyUserInvitation objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCompanyUserInvitation> findByUpdatedAt(string $updated_at) Return ChildSpyCompanyUserInvitation objects filtered by the updated_at column
...
abstract class SpyCompanyUserInvitationQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCompanyUserInvitationTableMap::COL_ID_COMPANY_USER_INVITATION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCompanyUserInvitationTableMap::COL_ID_COMPANY_USER_INVITATION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function joinSpyCompanyBusinessUnit($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     * @return ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function filterBySpyCompanyUserInvitationStatus($spyCompanyUserInvitationStatus, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function joinSpyCompanyUserInvitationStatus($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCompanyUserInvitationStatus', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCompanyUserInvitationStatus', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function filterBySpyCompanyUser($spyCompanyUser, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCompanyUserInvitationQuery The current query, for fluid interface
     */
    public function joinSpyCompanyUser($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCompanyUser', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCompanyUser', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyCompanyUserInvitationTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCompanyUserInvitationTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCompanyUserInvitationTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCompanyUserInvitationTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCompanyUserInvitationTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCompanyUserInvitationTableMap::COL_CREATED_AT);
    }
