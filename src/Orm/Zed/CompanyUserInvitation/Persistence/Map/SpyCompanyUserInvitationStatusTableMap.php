...
class SpyCompanyUserInvitationStatusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CompanyUserInvitation.Persistence.Map.SpyCompanyUserInvitationStatusTableMap';
     ...
     */
    const TABLE_NAME = 'spy_company_user_invitation_status';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CompanyUserInvitation\\Persistence\\SpyCompanyUserInvitationStatus';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CompanyUserInvitation.Persistence.SpyCompanyUserInvitationStatus';
     ...
     */
    const COL_ID_COMPANY_USER_INVITATION_STATUS = 'spy_company_user_invitation_status.id_company_user_invitation_status';

    /**
     * the column name for the status_key field
     */
    const COL_STATUS_KEY = 'spy_company_user_invitation_status.status_key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCompanyUserInvitationStatus', 'StatusKey', ),
        self::TYPE_CAMELNAME     => array('idCompanyUserInvitationStatus', 'statusKey', ),
        self::TYPE_COLNAME       => array(SpyCompanyUserInvitationStatusTableMap::COL_ID_COMPANY_USER_INVITATION_STATUS, SpyCompanyUserInvitationStatusTableMap::COL_STATUS_KEY, ),
        self::TYPE_FIELDNAME     => array('id_company_user_invitation_status', 'status_key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCompanyUserInvitationStatus' => 0, 'StatusKey' => 1, ),
        self::TYPE_CAMELNAME     => array('idCompanyUserInvitationStatus' => 0, 'statusKey' => 1, ),
        self::TYPE_COLNAME       => array(SpyCompanyUserInvitationStatusTableMap::COL_ID_COMPANY_USER_INVITATION_STATUS => 0, SpyCompanyUserInvitationStatusTableMap::COL_STATUS_KEY => 1, ),
        self::TYPE_FIELDNAME     => array('id_company_user_invitation_status' => 0, 'status_key' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
...
} // SpyCompanyUserInvitationStatusTableMap
