...
class SpyCategoryImageSetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CategoryImage.Persistence.Map.SpyCategoryImageSetTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_image_set';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CategoryImage\\Persistence\\SpyCategoryImageSet';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CategoryImage.Persistence.SpyCategoryImageSet';
     ...
     */
    const COL_ID_CATEGORY_IMAGE_SET = 'spy_category_image_set.id_category_image_set';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_category_image_set.fk_category';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_category_image_set.fk_locale';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_category_image_set.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_category_image_set.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_category_image_set.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageSet', 'FkCategory', 'FkLocale', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCategoryImageSet', 'fkCategory', 'fkLocale', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCategoryImageSetTableMap::COL_ID_CATEGORY_IMAGE_SET, SpyCategoryImageSetTableMap::COL_FK_CATEGORY, SpyCategoryImageSetTableMap::COL_FK_LOCALE, SpyCategoryImageSetTableMap::COL_NAME, SpyCategoryImageSetTableMap::COL_CREATED_AT, SpyCategoryImageSetTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_category_image_set', 'fk_category', 'fk_locale', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageSet' => 0, 'FkCategory' => 1, 'FkLocale' => 2, 'Name' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idCategoryImageSet' => 0, 'fkCategory' => 1, 'fkLocale' => 2, 'name' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyCategoryImageSetTableMap::COL_ID_CATEGORY_IMAGE_SET => 0, SpyCategoryImageSetTableMap::COL_FK_CATEGORY => 1, SpyCategoryImageSetTableMap::COL_FK_LOCALE => 2, SpyCategoryImageSetTableMap::COL_NAME => 3, SpyCategoryImageSetTableMap::COL_CREATED_AT => 4, SpyCategoryImageSetTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_category_image_set' => 0, 'fk_category' => 1, 'fk_locale' => 2, 'name' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
