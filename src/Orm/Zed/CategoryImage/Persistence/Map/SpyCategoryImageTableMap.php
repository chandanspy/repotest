...
class SpyCategoryImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CategoryImage.Persistence.Map.SpyCategoryImageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_image';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CategoryImage\\Persistence\\SpyCategoryImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CategoryImage.Persistence.SpyCategoryImage';
     ...
     */
    const COL_ID_CATEGORY_IMAGE = 'spy_category_image.id_category_image';

    /**
     * the column name for the external_url_large field
     */
    const COL_EXTERNAL_URL_LARGE = 'spy_category_image.external_url_large';

    /**
     * the column name for the external_url_small field
     */
    const COL_EXTERNAL_URL_SMALL = 'spy_category_image.external_url_small';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_category_image.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_category_image.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryImage', 'ExternalUrlLarge', 'ExternalUrlSmall', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCategoryImage', 'externalUrlLarge', 'externalUrlSmall', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCategoryImageTableMap::COL_ID_CATEGORY_IMAGE, SpyCategoryImageTableMap::COL_EXTERNAL_URL_LARGE, SpyCategoryImageTableMap::COL_EXTERNAL_URL_SMALL, SpyCategoryImageTableMap::COL_CREATED_AT, SpyCategoryImageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_category_image', 'external_url_large', 'external_url_small', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryImage' => 0, 'ExternalUrlLarge' => 1, 'ExternalUrlSmall' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idCategoryImage' => 0, 'externalUrlLarge' => 1, 'externalUrlSmall' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyCategoryImageTableMap::COL_ID_CATEGORY_IMAGE => 0, SpyCategoryImageTableMap::COL_EXTERNAL_URL_LARGE => 1, SpyCategoryImageTableMap::COL_EXTERNAL_URL_SMALL => 2, SpyCategoryImageTableMap::COL_CREATED_AT => 3, SpyCategoryImageTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_category_image' => 0, 'external_url_large' => 1, 'external_url_small' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
