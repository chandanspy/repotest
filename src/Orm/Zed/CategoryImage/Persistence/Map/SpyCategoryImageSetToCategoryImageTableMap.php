...
class SpyCategoryImageSetToCategoryImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CategoryImage.Persistence.Map.SpyCategoryImageSetToCategoryImageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_category_image_set_to_category_image';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CategoryImage\\Persistence\\SpyCategoryImageSetToCategoryImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CategoryImage.Persistence.SpyCategoryImageSetToCategoryImage';
     ...
     */
    const COL_ID_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE = 'spy_category_image_set_to_category_image.id_category_image_set_to_category_image';

    /**
     * the column name for the fk_category_image field
     */
    const COL_FK_CATEGORY_IMAGE = 'spy_category_image_set_to_category_image.fk_category_image';

    /**
     * the column name for the fk_category_image_set field
     */
    const COL_FK_CATEGORY_IMAGE_SET = 'spy_category_image_set_to_category_image.fk_category_image_set';

    /**
     * the column name for the sort_order field
     */
    const COL_SORT_ORDER = 'spy_category_image_set_to_category_image.sort_order';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageSetToCategoryImage', 'FkCategoryImage', 'FkCategoryImageSet', 'SortOrder', ),
        self::TYPE_CAMELNAME     => array('idCategoryImageSetToCategoryImage', 'fkCategoryImage', 'fkCategoryImageSet', 'sortOrder', ),
        self::TYPE_COLNAME       => array(SpyCategoryImageSetToCategoryImageTableMap::COL_ID_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE, SpyCategoryImageSetToCategoryImageTableMap::COL_FK_CATEGORY_IMAGE, SpyCategoryImageSetToCategoryImageTableMap::COL_FK_CATEGORY_IMAGE_SET, SpyCategoryImageSetToCategoryImageTableMap::COL_SORT_ORDER, ),
        self::TYPE_FIELDNAME     => array('id_category_image_set_to_category_image', 'fk_category_image', 'fk_category_image_set', 'sort_order', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategoryImageSetToCategoryImage' => 0, 'FkCategoryImage' => 1, 'FkCategoryImageSet' => 2, 'SortOrder' => 3, ),
        self::TYPE_CAMELNAME     => array('idCategoryImageSetToCategoryImage' => 0, 'fkCategoryImage' => 1, 'fkCategoryImageSet' => 2, 'sortOrder' => 3, ),
        self::TYPE_COLNAME       => array(SpyCategoryImageSetToCategoryImageTableMap::COL_ID_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE => 0, SpyCategoryImageSetToCategoryImageTableMap::COL_FK_CATEGORY_IMAGE => 1, SpyCategoryImageSetToCategoryImageTableMap::COL_FK_CATEGORY_IMAGE_SET => 2, SpyCategoryImageSetToCategoryImageTableMap::COL_SORT_ORDER => 3, ),
        self::TYPE_FIELDNAME     => array('id_category_image_set_to_category_image' => 0, 'fk_category_image' => 1, 'fk_category_image_set' => 2, 'sort_order' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyCategoryImageSetToCategoryImageTableMap
