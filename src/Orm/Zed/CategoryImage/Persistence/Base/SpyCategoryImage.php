...
abstract class SpyCategoryImage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\CategoryImage\\Persistence\\Map\\SpyCategoryImageTableMap';
     ...
     * @return $this|\Orm\Zed\CategoryImage\Persistence\SpyCategoryImage The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\CategoryImage\Persistence\SpyCategoryImage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\CategoryImage\Persistence\SpyCategoryImage The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCategoryImage The current object (for fluent API support)
     */
