 ...
 *
 * @method     ChildSpyCategoryImageSetToCategoryImage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCategoryImageSetToCategoryImage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSetToCategoryImage> find(ConnectionInterface $con = null) Return ChildSpyCategoryImageSetToCategoryImage objects based on current ModelCriteria
 * @method     ChildSpyCategoryImageSetToCategoryImage[]|ObjectCollection findByIdCategoryImageSetToCategoryImage(int $id_category_image_set_to_category_image) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the id_category_image_set_to_category_image column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSetToCategoryImage> findByIdCategoryImageSetToCategoryImage(int $id_category_image_set_to_category_image) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the id_category_image_set_to_category_image column
 * @method     ChildSpyCategoryImageSetToCategoryImage[]|ObjectCollection findByFkCategoryImage(int $fk_category_image) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the fk_category_image column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSetToCategoryImage> findByFkCategoryImage(int $fk_category_image) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the fk_category_image column
 * @method     ChildSpyCategoryImageSetToCategoryImage[]|ObjectCollection findByFkCategoryImageSet(int $fk_category_image_set) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the fk_category_image_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSetToCategoryImage> findByFkCategoryImageSet(int $fk_category_image_set) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the fk_category_image_set column
 * @method     ChildSpyCategoryImageSetToCategoryImage[]|ObjectCollection findBySortOrder(int $sort_order) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the sort_order column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSetToCategoryImage> findBySortOrder(int $sort_order) Return ChildSpyCategoryImageSetToCategoryImage objects filtered by the sort_order column
...
abstract class SpyCategoryImageSetToCategoryImageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCategoryImageSetToCategoryImageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCategoryImageSetToCategoryImageTableMap::COL_ID_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCategoryImageSetToCategoryImageTableMap::COL_ID_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCategoryImageSetToCategoryImageQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCategoryImageSetToCategoryImageQuery The current query, for fluid interface
     */
    public function joinSpyCategoryImageSet($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     * @return ChildSpyCategoryImageSetToCategoryImageQuery The current query, for fluid interface
     */
    public function filterBySpyCategoryImage($spyCategoryImage, $comparison = null)
    {
     ...
     * @return $this|ChildSpyCategoryImageSetToCategoryImageQuery The current query, for fluid interface
     */
    public function joinSpyCategoryImage($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCategoryImage', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCategoryImage', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
...
} // SpyCategoryImageSetToCategoryImageQuery
