 ...
 *
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCategoryImageSet objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> find(ConnectionInterface $con = null) Return ChildSpyCategoryImageSet objects based on current ModelCriteria
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByIdCategoryImageSet(int $id_category_image_set) Return ChildSpyCategoryImageSet objects filtered by the id_category_image_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByIdCategoryImageSet(int $id_category_image_set) Return ChildSpyCategoryImageSet objects filtered by the id_category_image_set column
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByFkCategory(int $fk_category) Return ChildSpyCategoryImageSet objects filtered by the fk_category column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByFkCategory(int $fk_category) Return ChildSpyCategoryImageSet objects filtered by the fk_category column
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyCategoryImageSet objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByFkLocale(int $fk_locale) Return ChildSpyCategoryImageSet objects filtered by the fk_locale column
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByName(string $name) Return ChildSpyCategoryImageSet objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByName(string $name) Return ChildSpyCategoryImageSet objects filtered by the name column
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCategoryImageSet objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByCreatedAt(string $created_at) Return ChildSpyCategoryImageSet objects filtered by the created_at column
 * @method     ChildSpyCategoryImageSet[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCategoryImageSet objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCategoryImageSet> findByUpdatedAt(string $updated_at) Return ChildSpyCategoryImageSet objects filtered by the updated_at column
...
abstract class SpyCategoryImageSetQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCategoryImageSetQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCategoryImageSetTableMap::COL_ID_CATEGORY_IMAGE_SET, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCategoryImageSetTableMap::COL_ID_CATEGORY_IMAGE_SET, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyCategoryImageSetQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyCategoryImageSetQuery The current query, for fluid interface
     */
    public function joinSpyCategory($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyCategory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyCategory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyCategoryImageSetTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCategoryImageSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCategoryImageSetTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCategoryImageSetTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCategoryImageSetTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCategoryImageSetTableMap::COL_CREATED_AT);
    }
