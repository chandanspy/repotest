...
class SpyProductCategoryFilterStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductCategoryFilterStorage.Persistence.Map.SpyProductCategoryFilterStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_category_filter_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductCategoryFilterStorage\\Persistence\\SpyProductCategoryFilterStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductCategoryFilterStorage.Persistence.SpyProductCategoryFilterStorage';
     ...
     */
    const COL_ID_PRODUCT_CATEGORY_FILTER_STORAGE = 'spy_product_category_filter_storage.id_product_category_filter_storage';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_product_category_filter_storage.fk_category';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_category_filter_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_category_filter_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_category_filter_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_category_filter_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_category_filter_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductCategoryFilterStorage', 'FkCategory', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductCategoryFilterStorage', 'fkCategory', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductCategoryFilterStorageTableMap::COL_ID_PRODUCT_CATEGORY_FILTER_STORAGE, SpyProductCategoryFilterStorageTableMap::COL_FK_CATEGORY, SpyProductCategoryFilterStorageTableMap::COL_DATA, SpyProductCategoryFilterStorageTableMap::COL_ALIAS_KEYS, SpyProductCategoryFilterStorageTableMap::COL_KEY, SpyProductCategoryFilterStorageTableMap::COL_CREATED_AT, SpyProductCategoryFilterStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_category_filter_storage', 'fk_category', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductCategoryFilterStorage' => 0, 'FkCategory' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductCategoryFilterStorage' => 0, 'fkCategory' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_category_filter_storage' => 0, 'fk_category' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyProductCategoryFilterStorageTableMap
