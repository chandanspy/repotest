...
abstract class SpyCommentTag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Comment\\Persistence\\Map\\SpyCommentTagTableMap';
     ...
     * @return $this|\Orm\Zed\Comment\Persistence\SpyCommentTag The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Comment\Persistence\SpyCommentTag
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Comment\Persistence\SpyCommentTag The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyCommentTag The current object (for fluent API support)
     */
     ...
     * @return bool
     */
    public function isSpyCommentsLoaded()
    {
