...
abstract class SpyComment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Comment\\Persistence\\Map\\SpyCommentTableMap';
     ...
     * @return $this|\Orm\Zed\Comment\Persistence\SpyComment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyCommentTableMap::translateFieldName('IsDeleted', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_deleted = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyCommentTableMap::translateFieldName('IsUpdated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_updated = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyCommentTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyCommentTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyCommentTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpyCommentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SpyCommentTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 10; // 10 = SpyCommentTableMap::NUM_HYDRATE_COLUMNS.
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Comment\Persistence\SpyComment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Comment\Persistence\SpyComment The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyCommentToCommentTags($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCommentToCommentTags($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyComment The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyCommentToCommentTags(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCommentToCommentTagsPartial && !$this->isNew();
        if (null === $this->collSpyCommentToCommentTags || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCommentToCommentTag(ChildSpyCommentToCommentTag $spyCommentToCommentTag)
    {
     ...
     * @return bool
     */
    public function isSpyCommentTagsLoaded()
    {
     ...
     */
    public function countSpyCommentTags(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCommentTagsPartial && !$this->isNew();
        if (null === $this->collSpyCommentTags || null !== $criteria || $partial) {
