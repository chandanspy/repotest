 ...
 *
 * @method     ChildSpyCommentThread[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyCommentThread objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> find(ConnectionInterface $con = null) Return ChildSpyCommentThread objects based on current ModelCriteria
 * @method     ChildSpyCommentThread[]|ObjectCollection findByIdCommentThread(int $id_comment_thread) Return ChildSpyCommentThread objects filtered by the id_comment_thread column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByIdCommentThread(int $id_comment_thread) Return ChildSpyCommentThread objects filtered by the id_comment_thread column
 * @method     ChildSpyCommentThread[]|ObjectCollection findByOwnerId(int $owner_id) Return ChildSpyCommentThread objects filtered by the owner_id column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByOwnerId(int $owner_id) Return ChildSpyCommentThread objects filtered by the owner_id column
 * @method     ChildSpyCommentThread[]|ObjectCollection findByOwnerType(string $owner_type) Return ChildSpyCommentThread objects filtered by the owner_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByOwnerType(string $owner_type) Return ChildSpyCommentThread objects filtered by the owner_type column
 * @method     ChildSpyCommentThread[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyCommentThread objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByUuid(string $uuid) Return ChildSpyCommentThread objects filtered by the uuid column
 * @method     ChildSpyCommentThread[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyCommentThread objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByCreatedAt(string $created_at) Return ChildSpyCommentThread objects filtered by the created_at column
 * @method     ChildSpyCommentThread[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyCommentThread objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyCommentThread> findByUpdatedAt(string $updated_at) Return ChildSpyCommentThread objects filtered by the updated_at column
...
abstract class SpyCommentThreadQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyCommentThreadQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyCommentThreadTableMap::COL_ID_COMMENT_THREAD, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyCommentThreadTableMap::COL_ID_COMMENT_THREAD, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyCommentThreadQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyCommentThreadTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCommentThreadTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCommentThreadTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyCommentThreadTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyCommentThreadTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyCommentThreadTableMap::COL_CREATED_AT);
    }
