...
class SpyCommentThreadTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Comment.Persistence.Map.SpyCommentThreadTableMap';
     ...
     */
    const TABLE_NAME = 'spy_comment_thread';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Comment\\Persistence\\SpyCommentThread';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Comment.Persistence.SpyCommentThread';
     ...
     */
    const COL_ID_COMMENT_THREAD = 'spy_comment_thread.id_comment_thread';

    /**
     * the column name for the owner_id field
     */
    const COL_OWNER_ID = 'spy_comment_thread.owner_id';

    /**
     * the column name for the owner_type field
     */
    const COL_OWNER_TYPE = 'spy_comment_thread.owner_type';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_comment_thread.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_comment_thread.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_comment_thread.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCommentThread', 'OwnerId', 'OwnerType', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCommentThread', 'ownerId', 'ownerType', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCommentThreadTableMap::COL_ID_COMMENT_THREAD, SpyCommentThreadTableMap::COL_OWNER_ID, SpyCommentThreadTableMap::COL_OWNER_TYPE, SpyCommentThreadTableMap::COL_UUID, SpyCommentThreadTableMap::COL_CREATED_AT, SpyCommentThreadTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_comment_thread', 'owner_id', 'owner_type', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCommentThread' => 0, 'OwnerId' => 1, 'OwnerType' => 2, 'Uuid' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idCommentThread' => 0, 'ownerId' => 1, 'ownerType' => 2, 'uuid' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyCommentThreadTableMap::COL_ID_COMMENT_THREAD => 0, SpyCommentThreadTableMap::COL_OWNER_ID => 1, SpyCommentThreadTableMap::COL_OWNER_TYPE => 2, SpyCommentThreadTableMap::COL_UUID => 3, SpyCommentThreadTableMap::COL_CREATED_AT => 4, SpyCommentThreadTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_comment_thread' => 0, 'owner_id' => 1, 'owner_type' => 2, 'uuid' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
