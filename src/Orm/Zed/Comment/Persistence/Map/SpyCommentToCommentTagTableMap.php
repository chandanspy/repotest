...
class SpyCommentToCommentTagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Comment.Persistence.Map.SpyCommentToCommentTagTableMap';
     ...
     */
    const TABLE_NAME = 'spy_comment_to_comment_tag';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Comment\\Persistence\\SpyCommentToCommentTag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Comment.Persistence.SpyCommentToCommentTag';
     ...
     */
    const COL_FK_COMMENT = 'spy_comment_to_comment_tag.fk_comment';

    /**
     * the column name for the fk_comment_tag field
     */
    const COL_FK_COMMENT_TAG = 'spy_comment_to_comment_tag.fk_comment_tag';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkComment', 'FkCommentTag', ),
        self::TYPE_CAMELNAME     => array('fkComment', 'fkCommentTag', ),
        self::TYPE_COLNAME       => array(SpyCommentToCommentTagTableMap::COL_FK_COMMENT, SpyCommentToCommentTagTableMap::COL_FK_COMMENT_TAG, ),
        self::TYPE_FIELDNAME     => array('fk_comment', 'fk_comment_tag', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkComment' => 0, 'FkCommentTag' => 1, ),
        self::TYPE_CAMELNAME     => array('fkComment' => 0, 'fkCommentTag' => 1, ),
        self::TYPE_COLNAME       => array(SpyCommentToCommentTagTableMap::COL_FK_COMMENT => 0, SpyCommentToCommentTagTableMap::COL_FK_COMMENT_TAG => 1, ),
        self::TYPE_FIELDNAME     => array('fk_comment' => 0, 'fk_comment_tag' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
...
} // SpyCommentToCommentTagTableMap
