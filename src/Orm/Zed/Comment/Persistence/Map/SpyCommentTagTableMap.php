...
class SpyCommentTagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Comment.Persistence.Map.SpyCommentTagTableMap';
     ...
     */
    const TABLE_NAME = 'spy_comment_tag';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Comment\\Persistence\\SpyCommentTag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Comment.Persistence.SpyCommentTag';
     ...
     */
    const COL_ID_COMMENT_TAG = 'spy_comment_tag.id_comment_tag';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_comment_tag.name';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_comment_tag.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_comment_tag.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_comment_tag.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCommentTag', 'Name', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCommentTag', 'name', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCommentTagTableMap::COL_ID_COMMENT_TAG, SpyCommentTagTableMap::COL_NAME, SpyCommentTagTableMap::COL_UUID, SpyCommentTagTableMap::COL_CREATED_AT, SpyCommentTagTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_comment_tag', 'name', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCommentTag' => 0, 'Name' => 1, 'Uuid' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idCommentTag' => 0, 'name' => 1, 'uuid' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyCommentTagTableMap::COL_ID_COMMENT_TAG => 0, SpyCommentTagTableMap::COL_NAME => 1, SpyCommentTagTableMap::COL_UUID => 2, SpyCommentTagTableMap::COL_CREATED_AT => 3, SpyCommentTagTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_comment_tag' => 0, 'name' => 1, 'uuid' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
