...
abstract class SpyQuote implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Quote\\Persistence\\Map\\SpyQuoteTableMap';
     ...
     * @return $this|\Orm\Zed\Quote\Persistence\SpyQuote The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Quote\Persistence\SpyQuote
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Quote\Persistence\SpyQuote The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyQuote The current object (for fluent API support)
     */
