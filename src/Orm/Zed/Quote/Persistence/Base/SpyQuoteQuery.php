 ...
 *
 * @method     ChildSpyQuote[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuote objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> find(ConnectionInterface $con = null) Return ChildSpyQuote objects based on current ModelCriteria
 * @method     ChildSpyQuote[]|ObjectCollection findByIdQuote(int $id_quote) Return ChildSpyQuote objects filtered by the id_quote column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByIdQuote(int $id_quote) Return ChildSpyQuote objects filtered by the id_quote column
 * @method     ChildSpyQuote[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyQuote objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByFkStore(int $fk_store) Return ChildSpyQuote objects filtered by the fk_store column
 * @method     ChildSpyQuote[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpyQuote objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByCustomerReference(string $customer_reference) Return ChildSpyQuote objects filtered by the customer_reference column
 * @method     ChildSpyQuote[]|ObjectCollection findByIsDefault(boolean $is_default) Return ChildSpyQuote objects filtered by the is_default column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByIsDefault(boolean $is_default) Return ChildSpyQuote objects filtered by the is_default column
 * @method     ChildSpyQuote[]|ObjectCollection findByKey(string $key) Return ChildSpyQuote objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByKey(string $key) Return ChildSpyQuote objects filtered by the key column
 * @method     ChildSpyQuote[]|ObjectCollection findByName(string $name) Return ChildSpyQuote objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByName(string $name) Return ChildSpyQuote objects filtered by the name column
 * @method     ChildSpyQuote[]|ObjectCollection findByQuoteData(string $quote_data) Return ChildSpyQuote objects filtered by the quote_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByQuoteData(string $quote_data) Return ChildSpyQuote objects filtered by the quote_data column
 * @method     ChildSpyQuote[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyQuote objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByUuid(string $uuid) Return ChildSpyQuote objects filtered by the uuid column
 * @method     ChildSpyQuote[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyQuote objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByCreatedAt(string $created_at) Return ChildSpyQuote objects filtered by the created_at column
 * @method     ChildSpyQuote[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyQuote objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuote> findByUpdatedAt(string $updated_at) Return ChildSpyQuote objects filtered by the updated_at column
...
abstract class SpyQuoteQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuoteQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuoteTableMap::COL_ID_QUOTE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuoteTableMap::COL_ID_QUOTE, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuoteQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyQuoteTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyQuoteTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteTableMap::COL_CREATED_AT);
    }
