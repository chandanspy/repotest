...
class SpyProductQuantityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductQuantity.Persistence.Map.SpyProductQuantityTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_quantity';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductQuantity\\Persistence\\SpyProductQuantity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductQuantity.Persistence.SpyProductQuantity';
     ...
     */
    const COL_ID_PRODUCT_QUANTITY = 'spy_product_quantity.id_product_quantity';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_quantity.fk_product';

    /**
     * the column name for the quantity_interval field
     */
    const COL_QUANTITY_INTERVAL = 'spy_product_quantity.quantity_interval';

    /**
     * the column name for the quantity_max field
     */
    const COL_QUANTITY_MAX = 'spy_product_quantity.quantity_max';

    /**
     * the column name for the quantity_min field
     */
    const COL_QUANTITY_MIN = 'spy_product_quantity.quantity_min';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_quantity.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_quantity.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductQuantity', 'FkProduct', 'QuantityInterval', 'QuantityMax', 'QuantityMin', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductQuantity', 'fkProduct', 'quantityInterval', 'quantityMax', 'quantityMin', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductQuantityTableMap::COL_ID_PRODUCT_QUANTITY, SpyProductQuantityTableMap::COL_FK_PRODUCT, SpyProductQuantityTableMap::COL_QUANTITY_INTERVAL, SpyProductQuantityTableMap::COL_QUANTITY_MAX, SpyProductQuantityTableMap::COL_QUANTITY_MIN, SpyProductQuantityTableMap::COL_CREATED_AT, SpyProductQuantityTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_quantity', 'fk_product', 'quantity_interval', 'quantity_max', 'quantity_min', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductQuantity' => 0, 'FkProduct' => 1, 'QuantityInterval' => 2, 'QuantityMax' => 3, 'QuantityMin' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductQuantity' => 0, 'fkProduct' => 1, 'quantityInterval' => 2, 'quantityMax' => 3, 'quantityMin' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductQuantityTableMap::COL_ID_PRODUCT_QUANTITY => 0, SpyProductQuantityTableMap::COL_FK_PRODUCT => 1, SpyProductQuantityTableMap::COL_QUANTITY_INTERVAL => 2, SpyProductQuantityTableMap::COL_QUANTITY_MAX => 3, SpyProductQuantityTableMap::COL_QUANTITY_MIN => 4, SpyProductQuantityTableMap::COL_CREATED_AT => 5, SpyProductQuantityTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_quantity' => 0, 'fk_product' => 1, 'quantity_interval' => 2, 'quantity_max' => 3, 'quantity_min' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
