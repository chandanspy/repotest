...
class SpyProductValidityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductValidity.Persistence.Map.SpyProductValidityTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_validity';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductValidity\\Persistence\\SpyProductValidity';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductValidity.Persistence.SpyProductValidity';
     ...
     */
    const COL_ID_PRODUCT_VALIDITY = 'spy_product_validity.id_product_validity';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_validity.fk_product';

    /**
     * the column name for the valid_from field
     */
    const COL_VALID_FROM = 'spy_product_validity.valid_from';

    /**
     * the column name for the valid_to field
     */
    const COL_VALID_TO = 'spy_product_validity.valid_to';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductValidity', 'FkProduct', 'ValidFrom', 'ValidTo', ),
        self::TYPE_CAMELNAME     => array('idProductValidity', 'fkProduct', 'validFrom', 'validTo', ),
        self::TYPE_COLNAME       => array(SpyProductValidityTableMap::COL_ID_PRODUCT_VALIDITY, SpyProductValidityTableMap::COL_FK_PRODUCT, SpyProductValidityTableMap::COL_VALID_FROM, SpyProductValidityTableMap::COL_VALID_TO, ),
        self::TYPE_FIELDNAME     => array('id_product_validity', 'fk_product', 'valid_from', 'valid_to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductValidity' => 0, 'FkProduct' => 1, 'ValidFrom' => 2, 'ValidTo' => 3, ),
        self::TYPE_CAMELNAME     => array('idProductValidity' => 0, 'fkProduct' => 1, 'validFrom' => 2, 'validTo' => 3, ),
        self::TYPE_COLNAME       => array(SpyProductValidityTableMap::COL_ID_PRODUCT_VALIDITY => 0, SpyProductValidityTableMap::COL_FK_PRODUCT => 1, SpyProductValidityTableMap::COL_VALID_FROM => 2, SpyProductValidityTableMap::COL_VALID_TO => 3, ),
        self::TYPE_FIELDNAME     => array('id_product_validity' => 0, 'fk_product' => 1, 'valid_from' => 2, 'valid_to' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
