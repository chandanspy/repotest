...
class SpyMimeTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.FileManager.Persistence.Map.SpyMimeTypeTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\FileManager\\Persistence\\SpyMimeType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.FileManager.Persistence.SpyMimeType';
     ...
     */
    const COL_ID_MIME_TYPE = 'spy_mime_type.id_mime_type';

    /**
     * the column name for the comment field
     */
    const COL_COMMENT = 'spy_mime_type.comment';

    /**
     * the column name for the is_allowed field
     */
    const COL_IS_ALLOWED = 'spy_mime_type.is_allowed';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_mime_type.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdMimeType', 'Comment', 'IsAllowed', 'Name', ),
        self::TYPE_CAMELNAME     => array('idMimeType', 'comment', 'isAllowed', 'name', ),
        self::TYPE_COLNAME       => array(SpyMimeTypeTableMap::COL_ID_MIME_TYPE, SpyMimeTypeTableMap::COL_COMMENT, SpyMimeTypeTableMap::COL_IS_ALLOWED, SpyMimeTypeTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_mime_type', 'comment', 'is_allowed', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdMimeType' => 0, 'Comment' => 1, 'IsAllowed' => 2, 'Name' => 3, ),
        self::TYPE_CAMELNAME     => array('idMimeType' => 0, 'comment' => 1, 'isAllowed' => 2, 'name' => 3, ),
        self::TYPE_COLNAME       => array(SpyMimeTypeTableMap::COL_ID_MIME_TYPE => 0, SpyMimeTypeTableMap::COL_COMMENT => 1, SpyMimeTypeTableMap::COL_IS_ALLOWED => 2, SpyMimeTypeTableMap::COL_NAME => 3, ),
        self::TYPE_FIELDNAME     => array('id_mime_type' => 0, 'comment' => 1, 'is_allowed' => 2, 'name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
