...
class SpyFileLocalizedAttributesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.FileManager.Persistence.Map.SpyFileLocalizedAttributesTableMap';
     ...
     */
    const TABLE_NAME = 'spy_file_localized_attributes';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\FileManager\\Persistence\\SpyFileLocalizedAttributes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.FileManager.Persistence.SpyFileLocalizedAttributes';
     ...
     */
    const COL_ID_FILE_LOCALIZED_ATTRIBUTES = 'spy_file_localized_attributes.id_file_localized_attributes';

    /**
     * the column name for the fk_file field
     */
    const COL_FK_FILE = 'spy_file_localized_attributes.fk_file';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_file_localized_attributes.fk_locale';

    /**
     * the column name for the alt field
     */
    const COL_ALT = 'spy_file_localized_attributes.alt';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'spy_file_localized_attributes.title';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdFileLocalizedAttributes', 'FkFile', 'FkLocale', 'Alt', 'Title', ),
        self::TYPE_CAMELNAME     => array('idFileLocalizedAttributes', 'fkFile', 'fkLocale', 'alt', 'title', ),
        self::TYPE_COLNAME       => array(SpyFileLocalizedAttributesTableMap::COL_ID_FILE_LOCALIZED_ATTRIBUTES, SpyFileLocalizedAttributesTableMap::COL_FK_FILE, SpyFileLocalizedAttributesTableMap::COL_FK_LOCALE, SpyFileLocalizedAttributesTableMap::COL_ALT, SpyFileLocalizedAttributesTableMap::COL_TITLE, ),
        self::TYPE_FIELDNAME     => array('id_file_localized_attributes', 'fk_file', 'fk_locale', 'alt', 'title', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdFileLocalizedAttributes' => 0, 'FkFile' => 1, 'FkLocale' => 2, 'Alt' => 3, 'Title' => 4, ),
        self::TYPE_CAMELNAME     => array('idFileLocalizedAttributes' => 0, 'fkFile' => 1, 'fkLocale' => 2, 'alt' => 3, 'title' => 4, ),
        self::TYPE_COLNAME       => array(SpyFileLocalizedAttributesTableMap::COL_ID_FILE_LOCALIZED_ATTRIBUTES => 0, SpyFileLocalizedAttributesTableMap::COL_FK_FILE => 1, SpyFileLocalizedAttributesTableMap::COL_FK_LOCALE => 2, SpyFileLocalizedAttributesTableMap::COL_ALT => 3, SpyFileLocalizedAttributesTableMap::COL_TITLE => 4, ),
        self::TYPE_FIELDNAME     => array('id_file_localized_attributes' => 0, 'fk_file' => 1, 'fk_locale' => 2, 'alt' => 3, 'title' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyFileLocalizedAttributesTableMap
