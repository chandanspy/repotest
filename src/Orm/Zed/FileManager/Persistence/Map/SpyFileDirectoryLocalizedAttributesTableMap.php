...
class SpyFileDirectoryLocalizedAttributesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.FileManager.Persistence.Map.SpyFileDirectoryLocalizedAttributesTableMap';
     ...
     */
    const TABLE_NAME = 'spy_file_directory_localized_attributes';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\FileManager\\Persistence\\SpyFileDirectoryLocalizedAttributes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.FileManager.Persistence.SpyFileDirectoryLocalizedAttributes';
     ...
     */
    const COL_ID_FILE_DIRECTORY_LOCALIZED_ATTRIBUTES = 'spy_file_directory_localized_attributes.id_file_directory_localized_attributes';

    /**
     * the column name for the fk_file_directory field
     */
    const COL_FK_FILE_DIRECTORY = 'spy_file_directory_localized_attributes.fk_file_directory';

    /**
     * the column name for the fk_locale field
     */
    const COL_FK_LOCALE = 'spy_file_directory_localized_attributes.fk_locale';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'spy_file_directory_localized_attributes.title';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_file_directory_localized_attributes.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_file_directory_localized_attributes.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdFileDirectoryLocalizedAttributes', 'FkFileDirectory', 'FkLocale', 'Title', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idFileDirectoryLocalizedAttributes', 'fkFileDirectory', 'fkLocale', 'title', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyFileDirectoryLocalizedAttributesTableMap::COL_ID_FILE_DIRECTORY_LOCALIZED_ATTRIBUTES, SpyFileDirectoryLocalizedAttributesTableMap::COL_FK_FILE_DIRECTORY, SpyFileDirectoryLocalizedAttributesTableMap::COL_FK_LOCALE, SpyFileDirectoryLocalizedAttributesTableMap::COL_TITLE, SpyFileDirectoryLocalizedAttributesTableMap::COL_CREATED_AT, SpyFileDirectoryLocalizedAttributesTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_file_directory_localized_attributes', 'fk_file_directory', 'fk_locale', 'title', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdFileDirectoryLocalizedAttributes' => 0, 'FkFileDirectory' => 1, 'FkLocale' => 2, 'Title' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idFileDirectoryLocalizedAttributes' => 0, 'fkFileDirectory' => 1, 'fkLocale' => 2, 'title' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        ...
        self::TYPE_FIELDNAME     => array('id_file_directory_localized_attributes' => 0, 'fk_file_directory' => 1, 'fk_locale' => 2, 'title' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
