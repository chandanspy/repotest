...
class SpyFileDirectoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.FileManager.Persistence.Map.SpyFileDirectoryTableMap';
     ...
     */
    const TABLE_NAME = 'spy_file_directory';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\FileManager\\Persistence\\SpyFileDirectory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.FileManager.Persistence.SpyFileDirectory';
     ...
     */
    const COL_ID_FILE_DIRECTORY = 'spy_file_directory.id_file_directory';

    /**
     * the column name for the fk_parent_file_directory field
     */
    const COL_FK_PARENT_FILE_DIRECTORY = 'spy_file_directory.fk_parent_file_directory';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_file_directory.is_active';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_file_directory.name';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_file_directory.position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdFileDirectory', 'FkParentFileDirectory', 'IsActive', 'Name', 'Position', ),
        self::TYPE_CAMELNAME     => array('idFileDirectory', 'fkParentFileDirectory', 'isActive', 'name', 'position', ),
        self::TYPE_COLNAME       => array(SpyFileDirectoryTableMap::COL_ID_FILE_DIRECTORY, SpyFileDirectoryTableMap::COL_FK_PARENT_FILE_DIRECTORY, SpyFileDirectoryTableMap::COL_IS_ACTIVE, SpyFileDirectoryTableMap::COL_NAME, SpyFileDirectoryTableMap::COL_POSITION, ),
        self::TYPE_FIELDNAME     => array('id_file_directory', 'fk_parent_file_directory', 'is_active', 'name', 'position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdFileDirectory' => 0, 'FkParentFileDirectory' => 1, 'IsActive' => 2, 'Name' => 3, 'Position' => 4, ),
        self::TYPE_CAMELNAME     => array('idFileDirectory' => 0, 'fkParentFileDirectory' => 1, 'isActive' => 2, 'name' => 3, 'position' => 4, ),
        self::TYPE_COLNAME       => array(SpyFileDirectoryTableMap::COL_ID_FILE_DIRECTORY => 0, SpyFileDirectoryTableMap::COL_FK_PARENT_FILE_DIRECTORY => 1, SpyFileDirectoryTableMap::COL_IS_ACTIVE => 2, SpyFileDirectoryTableMap::COL_NAME => 3, SpyFileDirectoryTableMap::COL_POSITION => 4, ),
        self::TYPE_FIELDNAME     => array('id_file_directory' => 0, 'fk_parent_file_directory' => 1, 'is_active' => 2, 'name' => 3, 'position' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
