 ...
 *
 * @method     \Orm\Zed\FileManager\Persistence\SpyFileDirectoryQuery|\Orm\Zed\FileManager\Persistence\SpyFileQuery|\Orm\Zed\FileManager\Persistence\SpyFileDirectoryLocalizedAttributesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyFileDirectory[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyFileDirectory objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> find(ConnectionInterface $con = null) Return ChildSpyFileDirectory objects based on current ModelCriteria
 * @method     ChildSpyFileDirectory[]|ObjectCollection findByIdFileDirectory(int $id_file_directory) Return ChildSpyFileDirectory objects filtered by the id_file_directory column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> findByIdFileDirectory(int $id_file_directory) Return ChildSpyFileDirectory objects filtered by the id_file_directory column
 * @method     ChildSpyFileDirectory[]|ObjectCollection findByFkParentFileDirectory(int $fk_parent_file_directory) Return ChildSpyFileDirectory objects filtered by the fk_parent_file_directory column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> findByFkParentFileDirectory(int $fk_parent_file_directory) Return ChildSpyFileDirectory objects filtered by the fk_parent_file_directory column
 * @method     ChildSpyFileDirectory[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyFileDirectory objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> findByIsActive(boolean $is_active) Return ChildSpyFileDirectory objects filtered by the is_active column
 * @method     ChildSpyFileDirectory[]|ObjectCollection findByName(string $name) Return ChildSpyFileDirectory objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> findByName(string $name) Return ChildSpyFileDirectory objects filtered by the name column
 * @method     ChildSpyFileDirectory[]|ObjectCollection findByPosition(int $position) Return ChildSpyFileDirectory objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectory> findByPosition(int $position) Return ChildSpyFileDirectory objects filtered by the position column
...
abstract class SpyFileDirectoryQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyFileDirectoryTableMap::COL_ID_FILE_DIRECTORY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyFileDirectoryTableMap::COL_ID_FILE_DIRECTORY, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function filterByParentFileDirectory($spyFileDirectory, $comparison = null)
    {
     ...
     * @return $this|ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function joinParentFileDirectory($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('ParentFileDirectory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ParentFileDirectory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function filterBySpyFile($spyFile, $comparison = null)
    {
     ...
     * @return $this|ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function joinSpyFile($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyFile', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyFile', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     * Filter the query by a related \Orm\Zed\FileManager\Persistence\SpyFileDirectory object
     *
     ...
     * @return ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function filterByChildrenFileDirectory($spyFileDirectory, $comparison = null)
    {
        if ($spyFileDirectory instanceof \Orm\Zed\FileManager\Persistence\SpyFileDirectory) {
            return $this
     ...
     * @return $this|ChildSpyFileDirectoryQuery The current query, for fluid interface
     */
    public function joinChildrenFileDirectory($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ChildrenFileDirectory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ChildrenFileDirectory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
