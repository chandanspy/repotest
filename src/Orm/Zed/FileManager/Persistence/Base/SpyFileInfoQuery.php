 ...
 *
 * @method     ChildSpyFileInfo[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyFileInfo objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> find(ConnectionInterface $con = null) Return ChildSpyFileInfo objects based on current ModelCriteria
 * @method     ChildSpyFileInfo[]|ObjectCollection findByIdFileInfo(int $id_file_info) Return ChildSpyFileInfo objects filtered by the id_file_info column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByIdFileInfo(int $id_file_info) Return ChildSpyFileInfo objects filtered by the id_file_info column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByFkFile(int $fk_file) Return ChildSpyFileInfo objects filtered by the fk_file column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByFkFile(int $fk_file) Return ChildSpyFileInfo objects filtered by the fk_file column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByExtension(string $extension) Return ChildSpyFileInfo objects filtered by the extension column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByExtension(string $extension) Return ChildSpyFileInfo objects filtered by the extension column
 * @method     ChildSpyFileInfo[]|ObjectCollection findBySize(int $size) Return ChildSpyFileInfo objects filtered by the size column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findBySize(int $size) Return ChildSpyFileInfo objects filtered by the size column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByStorageFileName(string $storage_file_name) Return ChildSpyFileInfo objects filtered by the storage_file_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByStorageFileName(string $storage_file_name) Return ChildSpyFileInfo objects filtered by the storage_file_name column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByStorageName(string $storage_name) Return ChildSpyFileInfo objects filtered by the storage_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByStorageName(string $storage_name) Return ChildSpyFileInfo objects filtered by the storage_name column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByType(string $type) Return ChildSpyFileInfo objects filtered by the type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByType(string $type) Return ChildSpyFileInfo objects filtered by the type column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByVersion(int $version) Return ChildSpyFileInfo objects filtered by the version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByVersion(int $version) Return ChildSpyFileInfo objects filtered by the version column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByVersionName(string $version_name) Return ChildSpyFileInfo objects filtered by the version_name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByVersionName(string $version_name) Return ChildSpyFileInfo objects filtered by the version_name column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyFileInfo objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByCreatedAt(string $created_at) Return ChildSpyFileInfo objects filtered by the created_at column
 * @method     ChildSpyFileInfo[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyFileInfo objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileInfo> findByUpdatedAt(string $updated_at) Return ChildSpyFileInfo objects filtered by the updated_at column
...
abstract class SpyFileInfoQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyFileInfoQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyFileInfoTableMap::COL_ID_FILE_INFO, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyFileInfoTableMap::COL_ID_FILE_INFO, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyFileInfoQuery The current query, for fluid interface
     */
    public function filterByFile($spyFile, $comparison = null)
    {
    ...
    {
        return $this->useExistsQuery('File', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('File', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyFileInfoTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyFileInfoTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyFileInfoTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyFileInfoTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyFileInfoTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyFileInfoTableMap::COL_CREATED_AT);
    }
