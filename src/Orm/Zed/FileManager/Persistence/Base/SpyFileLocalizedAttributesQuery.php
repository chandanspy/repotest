 ...
 *
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyFileLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyFileLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection findByIdFileLocalizedAttributes(int $id_file_localized_attributes) Return ChildSpyFileLocalizedAttributes objects filtered by the id_file_localized_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> findByIdFileLocalizedAttributes(int $id_file_localized_attributes) Return ChildSpyFileLocalizedAttributes objects filtered by the id_file_localized_attributes column
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection findByFkFile(int $fk_file) Return ChildSpyFileLocalizedAttributes objects filtered by the fk_file column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> findByFkFile(int $fk_file) Return ChildSpyFileLocalizedAttributes objects filtered by the fk_file column
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyFileLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyFileLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection findByAlt(string $alt) Return ChildSpyFileLocalizedAttributes objects filtered by the alt column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> findByAlt(string $alt) Return ChildSpyFileLocalizedAttributes objects filtered by the alt column
 * @method     ChildSpyFileLocalizedAttributes[]|ObjectCollection findByTitle(string $title) Return ChildSpyFileLocalizedAttributes objects filtered by the title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileLocalizedAttributes> findByTitle(string $title) Return ChildSpyFileLocalizedAttributes objects filtered by the title column
...
abstract class SpyFileLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyFileLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyFileLocalizedAttributesTableMap::COL_ID_FILE_LOCALIZED_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyFileLocalizedAttributesTableMap::COL_ID_FILE_LOCALIZED_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyFileLocalizedAttributesQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyFileLocalizedAttributesQuery The current query, for fluid interface
     */
    public function joinSpyFile($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
...
} // SpyFileLocalizedAttributesQuery
