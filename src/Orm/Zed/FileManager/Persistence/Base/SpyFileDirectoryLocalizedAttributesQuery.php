 ...
 *
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyFileDirectoryLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> find(ConnectionInterface $con = null) Return ChildSpyFileDirectoryLocalizedAttributes objects based on current ModelCriteria
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByIdFileDirectoryLocalizedAttributes(int $id_file_directory_localized_attributes) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the id_file_directory_localized_attributes column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByIdFileDirectoryLocalizedAttributes(int $id_file_directory_localized_attributes) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the id_file_directory_localized_attributes column
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByFkFileDirectory(int $fk_file_directory) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the fk_file_directory column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByFkFileDirectory(int $fk_file_directory) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the fk_file_directory column
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByFkLocale(int $fk_locale) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByTitle(string $title) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the title column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByTitle(string $title) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the title column
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByCreatedAt(string $created_at) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the created_at column
 * @method     ChildSpyFileDirectoryLocalizedAttributes[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyFileDirectoryLocalizedAttributes> findByUpdatedAt(string $updated_at) Return ChildSpyFileDirectoryLocalizedAttributes objects filtered by the updated_at column
...
abstract class SpyFileDirectoryLocalizedAttributesQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyFileDirectoryLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyFileDirectoryLocalizedAttributesTableMap::COL_ID_FILE_DIRECTORY_LOCALIZED_ATTRIBUTES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyFileDirectoryLocalizedAttributesTableMap::COL_ID_FILE_DIRECTORY_LOCALIZED_ATTRIBUTES, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyFileDirectoryLocalizedAttributesQuery The current query, for fluid interface
     */
    public function filterBySpyFileDirectory($spyFileDirectory, $comparison = null)
    {
     ...
     * @return $this|ChildSpyFileDirectoryLocalizedAttributesQuery The current query, for fluid interface
     */
    public function joinSpyFileDirectory($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyFileDirectory', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyFileDirectory', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyFileDirectoryLocalizedAttributesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyFileDirectoryLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyFileDirectoryLocalizedAttributesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyFileDirectoryLocalizedAttributesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyFileDirectoryLocalizedAttributesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyFileDirectoryLocalizedAttributesTableMap::COL_CREATED_AT);
    }

} // SpyFileDirectoryLocalizedAttributesQuery
