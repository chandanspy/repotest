 ...
 *
 * @method     ChildSpyMimeType[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyMimeType objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMimeType> find(ConnectionInterface $con = null) Return ChildSpyMimeType objects based on current ModelCriteria
 * @method     ChildSpyMimeType[]|ObjectCollection findByIdMimeType(int $id_mime_type) Return ChildSpyMimeType objects filtered by the id_mime_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMimeType> findByIdMimeType(int $id_mime_type) Return ChildSpyMimeType objects filtered by the id_mime_type column
 * @method     ChildSpyMimeType[]|ObjectCollection findByComment(string $comment) Return ChildSpyMimeType objects filtered by the comment column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMimeType> findByComment(string $comment) Return ChildSpyMimeType objects filtered by the comment column
 * @method     ChildSpyMimeType[]|ObjectCollection findByIsAllowed(boolean $is_allowed) Return ChildSpyMimeType objects filtered by the is_allowed column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMimeType> findByIsAllowed(boolean $is_allowed) Return ChildSpyMimeType objects filtered by the is_allowed column
 * @method     ChildSpyMimeType[]|ObjectCollection findByName(string $name) Return ChildSpyMimeType objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyMimeType> findByName(string $name) Return ChildSpyMimeType objects filtered by the name column
...
abstract class SpyMimeTypeQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_mime_type, comment, is_allowed, name FROM spy_mime_type WHERE id_mime_type = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyMimeTypeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyMimeTypeTableMap::COL_ID_MIME_TYPE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyMimeTypeTableMap::COL_ID_MIME_TYPE, $keys, Criteria::IN);
    }
