 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> find(ConnectionInterface $con = null) Return ChildSpyTouch objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> findByIdTouch(int $id_touch) Return ChildSpyTouch objects filtered by the id_touch column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> findByItemEvent(int $item_event) Return ChildSpyTouch objects filtered by the item_event column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> findByItemId(int $item_id) Return ChildSpyTouch objects filtered by the item_id column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> findByItemType(string $item_type) Return ChildSpyTouch objects filtered by the item_type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouch> findByTouched(string $touched) Return ChildSpyTouch objects filtered by the touched column
...
abstract class SpyTouchQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_touch`, `item_event`, `item_id`, `item_type`, `touched` FROM `spy_touch` WHERE `id_touch` = :p0';
        try {
