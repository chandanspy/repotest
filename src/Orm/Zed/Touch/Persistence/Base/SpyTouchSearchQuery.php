 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> find(ConnectionInterface $con = null) Return ChildSpyTouchSearch objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> findByIdTouchSearch(int $id_touch_search) Return ChildSpyTouchSearch objects filtered by the id_touch_search column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> findByFkLocale(int $fk_locale) Return ChildSpyTouchSearch objects filtered by the fk_locale column
 * @method     ChildSpyTouchSearch[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyTouchSearch objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> findByFkStore(int $fk_store) Return ChildSpyTouchSearch objects filtered by the fk_store column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> findByFkTouch(int $fk_touch) Return ChildSpyTouchSearch objects filtered by the fk_touch column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyTouchSearch> findByKey(string $key) Return ChildSpyTouchSearch objects filtered by the key column
