...
abstract class SpyTouchSearch implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Touch\\Persistence\\Map\\SpyTouchSearchTableMap';
     ...
     * @return $this|\Orm\Zed\Touch\Persistence\SpyTouchSearch The current object (for fluent API support)
     */
    public function setIdTouchSearch($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_touch_search !== $v) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Touch\Persistence\SpyTouchSearch
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Touch\Persistence\SpyTouchSearch The current object, for fluid interface
     */
