...
class SpyTouchStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Touch.Persistence.Map.SpyTouchStorageTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Touch\\Persistence\\SpyTouchStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Touch.Persistence.SpyTouchStorage';
     ...
     */
    const COL_FK_STORE = 'spy_touch_storage.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTouchStorage', 'FkLocale', 'FkStore', 'FkTouch', 'Key', ),
        self::TYPE_CAMELNAME     => array('idTouchStorage', 'fkLocale', 'fkStore', 'fkTouch', 'key', ),
        self::TYPE_COLNAME       => array(SpyTouchStorageTableMap::COL_ID_TOUCH_STORAGE, SpyTouchStorageTableMap::COL_FK_LOCALE, SpyTouchStorageTableMap::COL_FK_STORE, SpyTouchStorageTableMap::COL_FK_TOUCH, SpyTouchStorageTableMap::COL_KEY, ),
        self::TYPE_FIELDNAME     => array('id_touch_storage', 'fk_locale', 'fk_store', 'fk_touch', 'key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTouchStorage' => 0, 'FkLocale' => 1, 'FkStore' => 2, 'FkTouch' => 3, 'Key' => 4, ),
        self::TYPE_CAMELNAME     => array('idTouchStorage' => 0, 'fkLocale' => 1, 'fkStore' => 2, 'fkTouch' => 3, 'key' => 4, ),
        self::TYPE_COLNAME       => array(SpyTouchStorageTableMap::COL_ID_TOUCH_STORAGE => 0, SpyTouchStorageTableMap::COL_FK_LOCALE => 1, SpyTouchStorageTableMap::COL_FK_STORE => 2, SpyTouchStorageTableMap::COL_FK_TOUCH => 3, SpyTouchStorageTableMap::COL_KEY => 4, ),
        self::TYPE_FIELDNAME     => array('id_touch_storage' => 0, 'fk_locale' => 1, 'fk_store' => 2, 'fk_touch' => 3, 'key' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
