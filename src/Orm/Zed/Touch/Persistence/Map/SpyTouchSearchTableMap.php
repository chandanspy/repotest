...
class SpyTouchSearchTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Touch.Persistence.Map.SpyTouchSearchTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Touch\\Persistence\\SpyTouchSearch';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Touch.Persistence.SpyTouchSearch';
     ...
     */
    const COL_FK_STORE = 'spy_touch_search.fk_store';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTouchSearch', 'FkLocale', 'FkStore', 'FkTouch', 'Key', ),
        self::TYPE_CAMELNAME     => array('idTouchSearch', 'fkLocale', 'fkStore', 'fkTouch', 'key', ),
        self::TYPE_COLNAME       => array(SpyTouchSearchTableMap::COL_ID_TOUCH_SEARCH, SpyTouchSearchTableMap::COL_FK_LOCALE, SpyTouchSearchTableMap::COL_FK_STORE, SpyTouchSearchTableMap::COL_FK_TOUCH, SpyTouchSearchTableMap::COL_KEY, ),
        self::TYPE_FIELDNAME     => array('id_touch_search', 'fk_locale', 'fk_store', 'fk_touch', 'key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTouchSearch' => 0, 'FkLocale' => 1, 'FkStore' => 2, 'FkTouch' => 3, 'Key' => 4, ),
        self::TYPE_CAMELNAME     => array('idTouchSearch' => 0, 'fkLocale' => 1, 'fkStore' => 2, 'fkTouch' => 3, 'key' => 4, ),
        self::TYPE_COLNAME       => array(SpyTouchSearchTableMap::COL_ID_TOUCH_SEARCH => 0, SpyTouchSearchTableMap::COL_FK_LOCALE => 1, SpyTouchSearchTableMap::COL_FK_STORE => 2, SpyTouchSearchTableMap::COL_FK_TOUCH => 3, SpyTouchSearchTableMap::COL_KEY => 4, ),
        self::TYPE_FIELDNAME     => array('id_touch_search' => 0, 'fk_locale' => 1, 'fk_store' => 2, 'fk_touch' => 3, 'key' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
