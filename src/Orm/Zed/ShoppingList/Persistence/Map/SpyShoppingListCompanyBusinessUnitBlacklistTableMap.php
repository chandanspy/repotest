...
class SpyShoppingListCompanyBusinessUnitBlacklistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListCompanyBusinessUnitBlacklistTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_company_business_unit_blacklist';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingListCompanyBusinessUnitBlacklist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingListCompanyBusinessUnitBlacklist';
     ...
     */
    const COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_BLACKLIST = 'spy_shopping_list_company_business_unit_blacklist.id_shopping_list_company_business_unit_blacklist';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_shopping_list_company_business_unit_blacklist.fk_company_user';

    /**
     * the column name for the fk_shopping_list_company_business_unit field
     */
    const COL_FK_SHOPPING_LIST_COMPANY_BUSINESS_UNIT = 'spy_shopping_list_company_business_unit_blacklist.fk_shopping_list_company_business_unit';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyBusinessUnitBlacklist', 'FkCompanyUser', 'FkShoppingListCompanyBusinessUnit', ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyBusinessUnitBlacklist', 'fkCompanyUser', 'fkShoppingListCompanyBusinessUnit', ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_BLACKLIST, SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_FK_COMPANY_USER, SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_FK_SHOPPING_LIST_COMPANY_BUSINESS_UNIT, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_business_unit_blacklist', 'fk_company_user', 'fk_shopping_list_company_business_unit', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyBusinessUnitBlacklist' => 0, 'FkCompanyUser' => 1, 'FkShoppingListCompanyBusinessUnit' => 2, ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyBusinessUnitBlacklist' => 0, 'fkCompanyUser' => 1, 'fkShoppingListCompanyBusinessUnit' => 2, ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_BLACKLIST => 0, SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_FK_COMPANY_USER => 1, SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_FK_SHOPPING_LIST_COMPANY_BUSINESS_UNIT => 2, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_business_unit_blacklist' => 0, 'fk_company_user' => 1, 'fk_shopping_list_company_business_unit' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyShoppingListCompanyBusinessUnitBlacklistTableMap
