...
class SpyShoppingListCompanyBusinessUnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListCompanyBusinessUnitTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_company_business_unit';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingListCompanyBusinessUnit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingListCompanyBusinessUnit';
     ...
     */
    const COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT = 'spy_shopping_list_company_business_unit.id_shopping_list_company_business_unit';

    /**
     * the column name for the fk_company_business_unit field
     */
    const COL_FK_COMPANY_BUSINESS_UNIT = 'spy_shopping_list_company_business_unit.fk_company_business_unit';

    /**
     * the column name for the fk_shopping_list field
     */
    const COL_FK_SHOPPING_LIST = 'spy_shopping_list_company_business_unit.fk_shopping_list';

    /**
     * the column name for the fk_shopping_list_permission_group field
     */
    const COL_FK_SHOPPING_LIST_PERMISSION_GROUP = 'spy_shopping_list_company_business_unit.fk_shopping_list_permission_group';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyBusinessUnit', 'FkCompanyBusinessUnit', 'FkShoppingList', 'FkShoppingListPermissionGroup', ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyBusinessUnit', 'fkCompanyBusinessUnit', 'fkShoppingList', 'fkShoppingListPermissionGroup', ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyBusinessUnitTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_COMPANY_BUSINESS_UNIT, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_SHOPPING_LIST, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_business_unit', 'fk_company_business_unit', 'fk_shopping_list', 'fk_shopping_list_permission_group', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyBusinessUnit' => 0, 'FkCompanyBusinessUnit' => 1, 'FkShoppingList' => 2, 'FkShoppingListPermissionGroup' => 3, ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyBusinessUnit' => 0, 'fkCompanyBusinessUnit' => 1, 'fkShoppingList' => 2, 'fkShoppingListPermissionGroup' => 3, ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyBusinessUnitTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT => 0, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_COMPANY_BUSINESS_UNIT => 1, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_SHOPPING_LIST => 2, SpyShoppingListCompanyBusinessUnitTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP => 3, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_business_unit' => 0, 'fk_company_business_unit' => 1, 'fk_shopping_list' => 2, 'fk_shopping_list_permission_group' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyShoppingListCompanyBusinessUnitTableMap
