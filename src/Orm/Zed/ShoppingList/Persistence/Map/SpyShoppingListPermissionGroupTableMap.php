...
class SpyShoppingListPermissionGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListPermissionGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_permission_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingListPermissionGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingListPermissionGroup';
     ...
     */
    const COL_ID_SHOPPING_LIST_PERMISSION_GROUP = 'spy_shopping_list_permission_group.id_shopping_list_permission_group';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_shopping_list_permission_group.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListPermissionGroup', 'Name', ),
        self::TYPE_CAMELNAME     => array('idShoppingListPermissionGroup', 'name', ),
        self::TYPE_COLNAME       => array(SpyShoppingListPermissionGroupTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP, SpyShoppingListPermissionGroupTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_permission_group', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListPermissionGroup' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('idShoppingListPermissionGroup' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(SpyShoppingListPermissionGroupTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP => 0, SpyShoppingListPermissionGroupTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_permission_group' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
...
} // SpyShoppingListPermissionGroupTableMap
