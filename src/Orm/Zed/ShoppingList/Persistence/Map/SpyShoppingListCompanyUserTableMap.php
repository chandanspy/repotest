...
class SpyShoppingListCompanyUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListCompanyUserTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list_company_user';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingListCompanyUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingListCompanyUser';
     ...
     */
    const COL_ID_SHOPPING_LIST_COMPANY_USER = 'spy_shopping_list_company_user.id_shopping_list_company_user';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_shopping_list_company_user.fk_company_user';

    /**
     * the column name for the fk_shopping_list field
     */
    const COL_FK_SHOPPING_LIST = 'spy_shopping_list_company_user.fk_shopping_list';

    /**
     * the column name for the fk_shopping_list_permission_group field
     */
    const COL_FK_SHOPPING_LIST_PERMISSION_GROUP = 'spy_shopping_list_company_user.fk_shopping_list_permission_group';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyUser', 'FkCompanyUser', 'FkShoppingList', 'FkShoppingListPermissionGroup', ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyUser', 'fkCompanyUser', 'fkShoppingList', 'fkShoppingListPermissionGroup', ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyUserTableMap::COL_ID_SHOPPING_LIST_COMPANY_USER, SpyShoppingListCompanyUserTableMap::COL_FK_COMPANY_USER, SpyShoppingListCompanyUserTableMap::COL_FK_SHOPPING_LIST, SpyShoppingListCompanyUserTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_user', 'fk_company_user', 'fk_shopping_list', 'fk_shopping_list_permission_group', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingListCompanyUser' => 0, 'FkCompanyUser' => 1, 'FkShoppingList' => 2, 'FkShoppingListPermissionGroup' => 3, ),
        self::TYPE_CAMELNAME     => array('idShoppingListCompanyUser' => 0, 'fkCompanyUser' => 1, 'fkShoppingList' => 2, 'fkShoppingListPermissionGroup' => 3, ),
        self::TYPE_COLNAME       => array(SpyShoppingListCompanyUserTableMap::COL_ID_SHOPPING_LIST_COMPANY_USER => 0, SpyShoppingListCompanyUserTableMap::COL_FK_COMPANY_USER => 1, SpyShoppingListCompanyUserTableMap::COL_FK_SHOPPING_LIST => 2, SpyShoppingListCompanyUserTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP => 3, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list_company_user' => 0, 'fk_company_user' => 1, 'fk_shopping_list' => 2, 'fk_shopping_list_permission_group' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyShoppingListCompanyUserTableMap
