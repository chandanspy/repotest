...
class SpyShoppingListTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListTableMap';
     ...
     */
    const TABLE_NAME = 'spy_shopping_list';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingList';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingList';
     ...
     */
    const COL_ID_SHOPPING_LIST = 'spy_shopping_list.id_shopping_list';

    /**
     * the column name for the customer_reference field
     */
    const COL_CUSTOMER_REFERENCE = 'spy_shopping_list.customer_reference';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_shopping_list.description';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_shopping_list.key';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_shopping_list.name';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_shopping_list.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_shopping_list.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_shopping_list.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdShoppingList', 'CustomerReference', 'Description', 'Key', 'Name', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idShoppingList', 'customerReference', 'description', 'key', 'name', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyShoppingListTableMap::COL_ID_SHOPPING_LIST, SpyShoppingListTableMap::COL_CUSTOMER_REFERENCE, SpyShoppingListTableMap::COL_DESCRIPTION, SpyShoppingListTableMap::COL_KEY, SpyShoppingListTableMap::COL_NAME, SpyShoppingListTableMap::COL_UUID, SpyShoppingListTableMap::COL_CREATED_AT, SpyShoppingListTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list', 'customer_reference', 'description', 'key', 'name', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdShoppingList' => 0, 'CustomerReference' => 1, 'Description' => 2, 'Key' => 3, 'Name' => 4, 'Uuid' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idShoppingList' => 0, 'customerReference' => 1, 'description' => 2, 'key' => 3, 'name' => 4, 'uuid' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyShoppingListTableMap::COL_ID_SHOPPING_LIST => 0, SpyShoppingListTableMap::COL_CUSTOMER_REFERENCE => 1, SpyShoppingListTableMap::COL_DESCRIPTION => 2, SpyShoppingListTableMap::COL_KEY => 3, SpyShoppingListTableMap::COL_NAME => 4, SpyShoppingListTableMap::COL_UUID => 5, SpyShoppingListTableMap::COL_CREATED_AT => 6, SpyShoppingListTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_shopping_list' => 0, 'customer_reference' => 1, 'description' => 2, 'key' => 3, 'name' => 4, 'uuid' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
