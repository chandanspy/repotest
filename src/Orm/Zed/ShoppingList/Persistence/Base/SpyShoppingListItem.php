...
abstract class SpyShoppingListItem implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ShoppingList\\Persistence\\Map\\SpyShoppingListItemTableMap';
     ...
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingListItem The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyShoppingListItemTableMap::translateFieldName('Quantity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyShoppingListItemTableMap::translateFieldName('Sku', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sku = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyShoppingListItemTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyShoppingListItemTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyShoppingListItemTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = SpyShoppingListItemTableMap::NUM_HYDRATE_COLUMNS.
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingListItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingListItem The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyShoppingListItemNotes($v = true)
    {
     ...
     * @return void
     */
    public function initSpyShoppingListItemNotes($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyShoppingListItem The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyShoppingListItemNotes(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyShoppingListItemNotesPartial && !$this->isNew();
        if (null === $this->collSpyShoppingListItemNotes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyShoppingListItemNote(SpyShoppingListItemNote $spyShoppingListItemNote)
    {
     ...
     */
    public function resetPartialSpyShoppingListProductOptions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyShoppingListProductOptions($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyShoppingListProductOptions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyShoppingListProductOptionsPartial && !$this->isNew();
        if (null === $this->collSpyShoppingListProductOptions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyShoppingListProductOption(SpyShoppingListProductOption $spyShoppingListProductOption)
    {
