 ...
 *
 * @method     ChildSpyShoppingListItem[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShoppingListItem objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> find(ConnectionInterface $con = null) Return ChildSpyShoppingListItem objects based on current ModelCriteria
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByIdShoppingListItem(int $id_shopping_list_item) Return ChildSpyShoppingListItem objects filtered by the id_shopping_list_item column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByIdShoppingListItem(int $id_shopping_list_item) Return ChildSpyShoppingListItem objects filtered by the id_shopping_list_item column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByFkShoppingList(int $fk_shopping_list) Return ChildSpyShoppingListItem objects filtered by the fk_shopping_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByFkShoppingList(int $fk_shopping_list) Return ChildSpyShoppingListItem objects filtered by the fk_shopping_list column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByKey(string $key) Return ChildSpyShoppingListItem objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByKey(string $key) Return ChildSpyShoppingListItem objects filtered by the key column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByQuantity(int $quantity) Return ChildSpyShoppingListItem objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByQuantity(int $quantity) Return ChildSpyShoppingListItem objects filtered by the quantity column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findBySku(string $sku) Return ChildSpyShoppingListItem objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findBySku(string $sku) Return ChildSpyShoppingListItem objects filtered by the sku column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyShoppingListItem objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByUuid(string $uuid) Return ChildSpyShoppingListItem objects filtered by the uuid column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyShoppingListItem objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByCreatedAt(string $created_at) Return ChildSpyShoppingListItem objects filtered by the created_at column
 * @method     ChildSpyShoppingListItem[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyShoppingListItem objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListItem> findByUpdatedAt(string $updated_at) Return ChildSpyShoppingListItem objects filtered by the updated_at column
...
abstract class SpyShoppingListItemQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_shopping_list_item`, `fk_shopping_list`, `key`, `quantity`, `sku`, `uuid`, `created_at`, `updated_at` FROM `spy_shopping_list_item` WHERE `id_shopping_list_item` = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShoppingListItemTableMap::COL_ID_SHOPPING_LIST_ITEM, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShoppingListItemTableMap::COL_ID_SHOPPING_LIST_ITEM, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function filterBySpyShoppingList($spyShoppingList, $comparison = null)
    {
     ...
     * @return $this|ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function joinSpyShoppingList($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyShoppingList', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyShoppingList', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function filterBySpyShoppingListItemNote($spyShoppingListItemNote, $comparison = null)
    {
     ...
     * @return $this|ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function joinSpyShoppingListItemNote($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyShoppingListItemNote', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyShoppingListItemNote', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function filterBySpyShoppingListProductOption($spyShoppingListProductOption, $comparison = null)
    {
     ...
     * @return $this|ChildSpyShoppingListItemQuery The current query, for fluid interface
     */
    public function joinSpyShoppingListProductOption($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyShoppingListProductOption', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyShoppingListProductOption', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyShoppingListItemTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyShoppingListItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyShoppingListItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyShoppingListItemTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyShoppingListItemTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyShoppingListItemTableMap::COL_CREATED_AT);
    }
