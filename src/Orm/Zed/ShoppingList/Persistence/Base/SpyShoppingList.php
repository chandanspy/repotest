...
abstract class SpyShoppingList implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ShoppingList\\Persistence\\Map\\SpyShoppingListTableMap';
     ...
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingList The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingList
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ShoppingList\Persistence\SpyShoppingList The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyShoppingListItems($v = true)
    {
     ...
     * @return void
     */
    public function initSpyShoppingListItems($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyShoppingList The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyShoppingListItems(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyShoppingListItemsPartial && !$this->isNew();
        if (null === $this->collSpyShoppingListItems || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyShoppingListItem(ChildSpyShoppingListItem $spyShoppingListItem)
    {
