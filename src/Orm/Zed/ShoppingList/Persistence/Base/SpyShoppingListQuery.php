 ...
 *
 * @method     ChildSpyShoppingList[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShoppingList objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> find(ConnectionInterface $con = null) Return ChildSpyShoppingList objects based on current ModelCriteria
 * @method     ChildSpyShoppingList[]|ObjectCollection findByIdShoppingList(int $id_shopping_list) Return ChildSpyShoppingList objects filtered by the id_shopping_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByIdShoppingList(int $id_shopping_list) Return ChildSpyShoppingList objects filtered by the id_shopping_list column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByCustomerReference(string $customer_reference) Return ChildSpyShoppingList objects filtered by the customer_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByCustomerReference(string $customer_reference) Return ChildSpyShoppingList objects filtered by the customer_reference column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByDescription(string $description) Return ChildSpyShoppingList objects filtered by the description column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByDescription(string $description) Return ChildSpyShoppingList objects filtered by the description column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByKey(string $key) Return ChildSpyShoppingList objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByKey(string $key) Return ChildSpyShoppingList objects filtered by the key column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByName(string $name) Return ChildSpyShoppingList objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByName(string $name) Return ChildSpyShoppingList objects filtered by the name column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyShoppingList objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByUuid(string $uuid) Return ChildSpyShoppingList objects filtered by the uuid column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyShoppingList objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByCreatedAt(string $created_at) Return ChildSpyShoppingList objects filtered by the created_at column
 * @method     ChildSpyShoppingList[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyShoppingList objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingList> findByUpdatedAt(string $updated_at) Return ChildSpyShoppingList objects filtered by the updated_at column
...
abstract class SpyShoppingListQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShoppingListQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShoppingListTableMap::COL_ID_SHOPPING_LIST, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShoppingListTableMap::COL_ID_SHOPPING_LIST, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyShoppingListQuery The current query, for fluid interface
     */
     ...
     * @return $this|ChildSpyShoppingListQuery The current query, for fluid interface
     */
    public function joinSpyShoppingListCompanyUser($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->addUsingAlias(SpyShoppingListTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyShoppingListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyShoppingListTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyShoppingListTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyShoppingListTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyShoppingListTableMap::COL_CREATED_AT);
    }
