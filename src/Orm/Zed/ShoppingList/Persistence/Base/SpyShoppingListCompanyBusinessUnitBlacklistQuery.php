 ...
 *
 * @method     ChildSpyShoppingListCompanyBusinessUnitBlacklist[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnitBlacklist> find(ConnectionInterface $con = null) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects based on current ModelCriteria
 * @method     ChildSpyShoppingListCompanyBusinessUnitBlacklist[]|ObjectCollection findByIdShoppingListCompanyBusinessUnitBlacklist(int $id_shopping_list_company_business_unit_blacklist) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the id_shopping_list_company_business_unit_blacklist column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnitBlacklist> findByIdShoppingListCompanyBusinessUnitBlacklist(int $id_shopping_list_company_business_unit_blacklist) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the id_shopping_list_company_business_unit_blacklist column
 * @method     ChildSpyShoppingListCompanyBusinessUnitBlacklist[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnitBlacklist> findByFkCompanyUser(int $fk_company_user) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the fk_company_user column
 * @method     ChildSpyShoppingListCompanyBusinessUnitBlacklist[]|ObjectCollection findByFkShoppingListCompanyBusinessUnit(int $fk_shopping_list_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the fk_shopping_list_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnitBlacklist> findByFkShoppingListCompanyBusinessUnit(int $fk_shopping_list_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnitBlacklist objects filtered by the fk_shopping_list_company_business_unit column
...
abstract class SpyShoppingListCompanyBusinessUnitBlacklistQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShoppingListCompanyBusinessUnitBlacklistQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_BLACKLIST, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShoppingListCompanyBusinessUnitBlacklistTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_BLACKLIST, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyShoppingListCompanyBusinessUnitBlacklistQuery The current query, for fluid interface
     */
...
} // SpyShoppingListCompanyBusinessUnitBlacklistQuery
