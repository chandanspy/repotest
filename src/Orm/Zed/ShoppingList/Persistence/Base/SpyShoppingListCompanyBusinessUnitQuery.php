 ...
 *
 * @method     ChildSpyShoppingListCompanyBusinessUnit[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyShoppingListCompanyBusinessUnit objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnit> find(ConnectionInterface $con = null) Return ChildSpyShoppingListCompanyBusinessUnit objects based on current ModelCriteria
 * @method     ChildSpyShoppingListCompanyBusinessUnit[]|ObjectCollection findByIdShoppingListCompanyBusinessUnit(int $id_shopping_list_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the id_shopping_list_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnit> findByIdShoppingListCompanyBusinessUnit(int $id_shopping_list_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the id_shopping_list_company_business_unit column
 * @method     ChildSpyShoppingListCompanyBusinessUnit[]|ObjectCollection findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnit> findByFkCompanyBusinessUnit(int $fk_company_business_unit) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @method     ChildSpyShoppingListCompanyBusinessUnit[]|ObjectCollection findByFkShoppingList(int $fk_shopping_list) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_shopping_list column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnit> findByFkShoppingList(int $fk_shopping_list) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_shopping_list column
 * @method     ChildSpyShoppingListCompanyBusinessUnit[]|ObjectCollection findByFkShoppingListPermissionGroup(int $fk_shopping_list_permission_group) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_shopping_list_permission_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyShoppingListCompanyBusinessUnit> findByFkShoppingListPermissionGroup(int $fk_shopping_list_permission_group) Return ChildSpyShoppingListCompanyBusinessUnit objects filtered by the fk_shopping_list_permission_group column
...
abstract class SpyShoppingListCompanyBusinessUnitQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyShoppingListCompanyBusinessUnitQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyShoppingListCompanyBusinessUnitTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyShoppingListCompanyBusinessUnitTableMap::COL_ID_SHOPPING_LIST_COMPANY_BUSINESS_UNIT, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyShoppingListCompanyBusinessUnitQuery The current query, for fluid interface
     */
...
} // SpyShoppingListCompanyBusinessUnitQuery
