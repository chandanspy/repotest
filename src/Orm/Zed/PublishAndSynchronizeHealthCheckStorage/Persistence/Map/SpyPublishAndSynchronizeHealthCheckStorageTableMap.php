...
class SpyPublishAndSynchronizeHealthCheckStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PublishAndSynchronizeHealthCheckStorage.Persistence.Map.SpyPublishAndSynchronizeHealthCheckStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_publish_and_synchronize_health_check_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PublishAndSynchronizeHealthCheckStorage\\Persistence\\SpyPublishAndSynchronizeHealthCheckStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PublishAndSynchronizeHealthCheckStorage.Persistence.SpyPublishAndSynchronizeHealthCheckStorage';
     ...
     */
    const COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_STORAGE = 'spy_publish_and_synchronize_health_check_storage.id_publish_and_synchronize_health_check_storage';

    /**
     * the column name for the fk_publish_and_synchronize_health_check field
     */
    const COL_FK_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK = 'spy_publish_and_synchronize_health_check_storage.fk_publish_and_synchronize_health_check';

    /**
     * the column name for the health_check_key field
     */
    const COL_HEALTH_CHECK_KEY = 'spy_publish_and_synchronize_health_check_storage.health_check_key';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_publish_and_synchronize_health_check_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_publish_and_synchronize_health_check_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_publish_and_synchronize_health_check_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_publish_and_synchronize_health_check_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_publish_and_synchronize_health_check_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPublishAndSynchronizeHealthCheckStorage', 'FkPublishAndSynchronizeHealthCheck', 'HealthCheckKey', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPublishAndSynchronizeHealthCheckStorage', 'fkPublishAndSynchronizeHealthCheck', 'healthCheckKey', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_STORAGE, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_FK_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_HEALTH_CHECK_KEY, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_DATA, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ALIAS_KEYS, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_KEY, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_CREATED_AT, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_publish_and_synchronize_health_check_storage', 'fk_publish_and_synchronize_health_check', 'health_check_key', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPublishAndSynchronizeHealthCheckStorage' => 0, 'FkPublishAndSynchronizeHealthCheck' => 1, 'HealthCheckKey' => 2, 'Data' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idPublishAndSynchronizeHealthCheckStorage' => 0, 'fkPublishAndSynchronizeHealthCheck' => 1, 'healthCheckKey' => 2, 'data' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_STORAGE => 0, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_FK_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK => 1, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_HEALTH_CHECK_KEY => 2, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_DATA => 3, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ALIAS_KEYS => 4, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_KEY => 5, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_CREATED_AT => 6, SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_publish_and_synchronize_health_check_storage' => 0, 'fk_publish_and_synchronize_health_check' => 1, 'health_check_key' => 2, 'data' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
