 ...
 *
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractPageSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractPageSearch objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByIdProductAbstractPageSearch(string $id_product_abstract_page_search) Return ChildSpyProductAbstractPageSearch objects filtered by the id_product_abstract_page_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByIdProductAbstractPageSearch(string $id_product_abstract_page_search) Return ChildSpyProductAbstractPageSearch objects filtered by the id_product_abstract_page_search column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractPageSearch objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractPageSearch objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByStructuredData(string $structured_data) Return ChildSpyProductAbstractPageSearch objects filtered by the structured_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByStructuredData(string $structured_data) Return ChildSpyProductAbstractPageSearch objects filtered by the structured_data column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByData(string $data) Return ChildSpyProductAbstractPageSearch objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByData(string $data) Return ChildSpyProductAbstractPageSearch objects filtered by the data column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByStore(string $store) Return ChildSpyProductAbstractPageSearch objects filtered by the store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByStore(string $store) Return ChildSpyProductAbstractPageSearch objects filtered by the store column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByLocale(string $locale) Return ChildSpyProductAbstractPageSearch objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByLocale(string $locale) Return ChildSpyProductAbstractPageSearch objects filtered by the locale column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractPageSearch objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractPageSearch objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByKey(string $key) Return ChildSpyProductAbstractPageSearch objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByKey(string $key) Return ChildSpyProductAbstractPageSearch objects filtered by the key column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductAbstractPageSearch objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByCreatedAt(string $created_at) Return ChildSpyProductAbstractPageSearch objects filtered by the created_at column
 * @method     ChildSpyProductAbstractPageSearch[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractPageSearch objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractPageSearch> findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractPageSearch objects filtered by the updated_at column
...
abstract class SpyProductAbstractPageSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractPageSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAbstractPageSearchTableMap::COL_ID_PRODUCT_ABSTRACT_PAGE_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAbstractPageSearchTableMap::COL_ID_PRODUCT_ABSTRACT_PAGE_SEARCH, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractPageSearchTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractPageSearchTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractPageSearchTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractPageSearchTableMap::COL_CREATED_AT);
    }

} // SpyProductAbstractPageSearchQuery
