...
abstract class SpyOauthRefreshToken implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\OauthRevoke\\Persistence\\Map\\SpyOauthRefreshTokenTableMap';
     ...
     * @return $this|\Orm\Zed\OauthRevoke\Persistence\SpyOauthRefreshToken The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\OauthRevoke\Persistence\SpyOauthRefreshToken
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\OauthRevoke\Persistence\SpyOauthRefreshToken The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyOauthRefreshToken The current object (for fluent API support)
     */
