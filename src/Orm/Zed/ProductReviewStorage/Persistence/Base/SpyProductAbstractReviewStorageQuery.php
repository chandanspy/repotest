 ...
 *
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractReviewStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractReviewStorage objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByIdProductAbstractReviewStorage(string $id_product_abstract_review_storage) Return ChildSpyProductAbstractReviewStorage objects filtered by the id_product_abstract_review_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByIdProductAbstractReviewStorage(string $id_product_abstract_review_storage) Return ChildSpyProductAbstractReviewStorage objects filtered by the id_product_abstract_review_storage column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractReviewStorage objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractReviewStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByData(string $data) Return ChildSpyProductAbstractReviewStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByData(string $data) Return ChildSpyProductAbstractReviewStorage objects filtered by the data column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractReviewStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractReviewStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyProductAbstractReviewStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByKey(string $key) Return ChildSpyProductAbstractReviewStorage objects filtered by the key column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductAbstractReviewStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByCreatedAt(string $created_at) Return ChildSpyProductAbstractReviewStorage objects filtered by the created_at column
 * @method     ChildSpyProductAbstractReviewStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractReviewStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractReviewStorage> findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractReviewStorage objects filtered by the updated_at column
...
abstract class SpyProductAbstractReviewStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractReviewStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAbstractReviewStorageTableMap::COL_ID_PRODUCT_ABSTRACT_REVIEW_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAbstractReviewStorageTableMap::COL_ID_PRODUCT_ABSTRACT_REVIEW_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractReviewStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractReviewStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractReviewStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractReviewStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractReviewStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractReviewStorageTableMap::COL_CREATED_AT);
    }

} // SpyProductAbstractReviewStorageQuery
