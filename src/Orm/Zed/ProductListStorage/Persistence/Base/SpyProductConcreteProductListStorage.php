...
abstract class SpyProductConcreteProductListStorage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductListStorage\\Persistence\\Map\\SpyProductConcreteProductListStorageTableMap';
     ...
     * @return $this|\Orm\Zed\ProductListStorage\Persistence\SpyProductConcreteProductListStorage The current object (for fluent API support)
     */
    public function setIdProductConcreteProductListStorage($v)
    {
        ...
        return $this;
    } // setIdProductConcreteProductListStorage()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductListStorage\Persistence\SpyProductConcreteProductListStorage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductListStorage\Persistence\SpyProductConcreteProductListStorage The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildSpyProductConcreteProductListStorage The current object (for fluent API support)
     */
