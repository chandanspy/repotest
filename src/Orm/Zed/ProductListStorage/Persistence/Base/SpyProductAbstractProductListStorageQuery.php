 ...
 *
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractProductListStorage objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractProductListStorage objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByIdProductAbstractProductListStorage(int $id_product_abstract_product_list_storage) Return ChildSpyProductAbstractProductListStorage objects filtered by the id_product_abstract_product_list_storage column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByIdProductAbstractProductListStorage(int $id_product_abstract_product_list_storage) Return ChildSpyProductAbstractProductListStorage objects filtered by the id_product_abstract_product_list_storage column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractProductListStorage objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractProductListStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByData(string $data) Return ChildSpyProductAbstractProductListStorage objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByData(string $data) Return ChildSpyProductAbstractProductListStorage objects filtered by the data column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByKey(string $key) Return ChildSpyProductAbstractProductListStorage objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByKey(string $key) Return ChildSpyProductAbstractProductListStorage objects filtered by the key column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractProductListStorage objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByAliasKeys(string $alias_keys) Return ChildSpyProductAbstractProductListStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductAbstractProductListStorage objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByCreatedAt(string $created_at) Return ChildSpyProductAbstractProductListStorage objects filtered by the created_at column
 * @method     ChildSpyProductAbstractProductListStorage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractProductListStorage objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractProductListStorage> findByUpdatedAt(string $updated_at) Return ChildSpyProductAbstractProductListStorage objects filtered by the updated_at column
...
abstract class SpyProductAbstractProductListStorageQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractProductListStorageQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductAbstractProductListStorageTableMap::COL_ID_PRODUCT_ABSTRACT_PRODUCT_LIST_STORAGE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductAbstractProductListStorageTableMap::COL_ID_PRODUCT_ABSTRACT_PRODUCT_LIST_STORAGE, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractProductListStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractProductListStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractProductListStorageTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductAbstractProductListStorageTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductAbstractProductListStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductAbstractProductListStorageTableMap::COL_CREATED_AT);
    }

} // SpyProductAbstractProductListStorageQuery
