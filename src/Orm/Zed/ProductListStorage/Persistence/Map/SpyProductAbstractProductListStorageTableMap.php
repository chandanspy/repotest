...
class SpyProductAbstractProductListStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductListStorage.Persistence.Map.SpyProductAbstractProductListStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_product_list_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductListStorage\\Persistence\\SpyProductAbstractProductListStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductListStorage.Persistence.SpyProductAbstractProductListStorage';
     ...
     */
    const COL_ID_PRODUCT_ABSTRACT_PRODUCT_LIST_STORAGE = 'spy_product_abstract_product_list_storage.id_product_abstract_product_list_storage';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_product_list_storage.fk_product_abstract';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_abstract_product_list_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_abstract_product_list_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_abstract_product_list_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_abstract_product_list_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_abstract_product_list_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractProductListStorage', 'FkProductAbstract', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductAbstractProductListStorage', 'fkProductAbstract', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractProductListStorageTableMap::COL_ID_PRODUCT_ABSTRACT_PRODUCT_LIST_STORAGE, SpyProductAbstractProductListStorageTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractProductListStorageTableMap::COL_DATA, SpyProductAbstractProductListStorageTableMap::COL_KEY, SpyProductAbstractProductListStorageTableMap::COL_ALIAS_KEYS, SpyProductAbstractProductListStorageTableMap::COL_CREATED_AT, SpyProductAbstractProductListStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_abstract_product_list_storage', 'fk_product_abstract', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductAbstractProductListStorage' => 0, 'FkProductAbstract' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductAbstractProductListStorage' => 0, 'fkProductAbstract' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_abstract_product_list_storage' => 0, 'fk_product_abstract' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
