...
class SpyCustomerGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CustomerGroup.Persistence.Map.SpyCustomerGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_customer_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CustomerGroup\\Persistence\\SpyCustomerGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CustomerGroup.Persistence.SpyCustomerGroup';
     ...
     */
    const COL_ID_CUSTOMER_GROUP = 'spy_customer_group.id_customer_group';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'spy_customer_group.description';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_customer_group.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_customer_group.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_customer_group.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCustomerGroup', 'Description', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCustomerGroup', 'description', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCustomerGroupTableMap::COL_ID_CUSTOMER_GROUP, SpyCustomerGroupTableMap::COL_DESCRIPTION, SpyCustomerGroupTableMap::COL_NAME, SpyCustomerGroupTableMap::COL_CREATED_AT, SpyCustomerGroupTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_customer_group', 'description', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCustomerGroup' => 0, 'Description' => 1, 'Name' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idCustomerGroup' => 0, 'description' => 1, 'name' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyCustomerGroupTableMap::COL_ID_CUSTOMER_GROUP => 0, SpyCustomerGroupTableMap::COL_DESCRIPTION => 1, SpyCustomerGroupTableMap::COL_NAME => 2, SpyCustomerGroupTableMap::COL_CREATED_AT => 3, SpyCustomerGroupTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_customer_group' => 0, 'description' => 1, 'name' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
