...
class SpyCustomerGroupToCustomerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CustomerGroup.Persistence.Map.SpyCustomerGroupToCustomerTableMap';
     ...
     */
    const TABLE_NAME = 'spy_customer_group_to_customer';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CustomerGroup\\Persistence\\SpyCustomerGroupToCustomer';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CustomerGroup.Persistence.SpyCustomerGroupToCustomer';
     ...
     */
    const COL_ID_CUSTOMER_GROUP_TO_CUSTOMER = 'spy_customer_group_to_customer.id_customer_group_to_customer';

    /**
     * the column name for the fk_customer field
     */
    const COL_FK_CUSTOMER = 'spy_customer_group_to_customer.fk_customer';

    /**
     * the column name for the fk_customer_group field
     */
    const COL_FK_CUSTOMER_GROUP = 'spy_customer_group_to_customer.fk_customer_group';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_customer_group_to_customer.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_customer_group_to_customer.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCustomerGroupToCustomer', 'FkCustomer', 'FkCustomerGroup', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCustomerGroupToCustomer', 'fkCustomer', 'fkCustomerGroup', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCustomerGroupToCustomerTableMap::COL_ID_CUSTOMER_GROUP_TO_CUSTOMER, SpyCustomerGroupToCustomerTableMap::COL_FK_CUSTOMER, SpyCustomerGroupToCustomerTableMap::COL_FK_CUSTOMER_GROUP, SpyCustomerGroupToCustomerTableMap::COL_CREATED_AT, SpyCustomerGroupToCustomerTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_customer_group_to_customer', 'fk_customer', 'fk_customer_group', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCustomerGroupToCustomer' => 0, 'FkCustomer' => 1, 'FkCustomerGroup' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idCustomerGroupToCustomer' => 0, 'fkCustomer' => 1, 'fkCustomerGroup' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyCustomerGroupToCustomerTableMap::COL_ID_CUSTOMER_GROUP_TO_CUSTOMER => 0, SpyCustomerGroupToCustomerTableMap::COL_FK_CUSTOMER => 1, SpyCustomerGroupToCustomerTableMap::COL_FK_CUSTOMER_GROUP => 2, SpyCustomerGroupToCustomerTableMap::COL_CREATED_AT => 3, SpyCustomerGroupToCustomerTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_customer_group_to_customer' => 0, 'fk_customer' => 1, 'fk_customer_group' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyCustomerGroupToCustomerTableMap
