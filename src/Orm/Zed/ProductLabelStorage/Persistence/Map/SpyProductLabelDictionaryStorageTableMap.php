...
class SpyProductLabelDictionaryStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductLabelStorage.Persistence.Map.SpyProductLabelDictionaryStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_label_dictionary_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductLabelStorage\\Persistence\\SpyProductLabelDictionaryStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductLabelStorage.Persistence.SpyProductLabelDictionaryStorage';
     ...
     */
    const COL_ID_PRODUCT_LABEL_DICTIONARY_STORAGE = 'spy_product_label_dictionary_storage.id_product_label_dictionary_storage';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_label_dictionary_storage.data';

    /**
     * the column name for the store field
     */
    const COL_STORE = 'spy_product_label_dictionary_storage.store';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_product_label_dictionary_storage.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_label_dictionary_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_label_dictionary_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_label_dictionary_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_label_dictionary_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductLabelDictionaryStorage', 'Data', 'Store', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductLabelDictionaryStorage', 'data', 'store', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductLabelDictionaryStorageTableMap::COL_ID_PRODUCT_LABEL_DICTIONARY_STORAGE, SpyProductLabelDictionaryStorageTableMap::COL_DATA, SpyProductLabelDictionaryStorageTableMap::COL_STORE, SpyProductLabelDictionaryStorageTableMap::COL_LOCALE, SpyProductLabelDictionaryStorageTableMap::COL_ALIAS_KEYS, SpyProductLabelDictionaryStorageTableMap::COL_KEY, SpyProductLabelDictionaryStorageTableMap::COL_CREATED_AT, SpyProductLabelDictionaryStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_label_dictionary_storage', 'data', 'store', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductLabelDictionaryStorage' => 0, 'Data' => 1, 'Store' => 2, 'Locale' => 3, 'AliasKeys' => 4, 'Key' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idProductLabelDictionaryStorage' => 0, 'data' => 1, 'store' => 2, 'locale' => 3, 'aliasKeys' => 4, 'key' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_label_dictionary_storage' => 0, 'data' => 1, 'store' => 2, 'locale' => 3, 'alias_keys' => 4, 'key' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
