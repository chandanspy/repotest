...
class SpyProductGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductGroup.Persistence.Map.SpyProductGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductGroup\\Persistence\\SpyProductGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductGroup.Persistence.SpyProductGroup';
     ...
     */
    const COL_ID_PRODUCT_GROUP = 'spy_product_group.id_product_group';

    /**
     * the column name for the product_group_key field
     */
    const COL_PRODUCT_GROUP_KEY = 'spy_product_group.product_group_key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductGroup', 'ProductGroupKey', ),
        self::TYPE_CAMELNAME     => array('idProductGroup', 'productGroupKey', ),
        self::TYPE_COLNAME       => array(SpyProductGroupTableMap::COL_ID_PRODUCT_GROUP, SpyProductGroupTableMap::COL_PRODUCT_GROUP_KEY, ),
        self::TYPE_FIELDNAME     => array('id_product_group', 'product_group_key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductGroup' => 0, 'ProductGroupKey' => 1, ),
        self::TYPE_CAMELNAME     => array('idProductGroup' => 0, 'productGroupKey' => 1, ),
        self::TYPE_COLNAME       => array(SpyProductGroupTableMap::COL_ID_PRODUCT_GROUP => 0, SpyProductGroupTableMap::COL_PRODUCT_GROUP_KEY => 1, ),
        self::TYPE_FIELDNAME     => array('id_product_group' => 0, 'product_group_key' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
