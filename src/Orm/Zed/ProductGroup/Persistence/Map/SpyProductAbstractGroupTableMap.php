...
class SpyProductAbstractGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductGroup.Persistence.Map.SpyProductAbstractGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_abstract_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductGroup\\Persistence\\SpyProductAbstractGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductGroup.Persistence.SpyProductAbstractGroup';
     ...
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_group.fk_product_abstract';

    /**
     * the column name for the fk_product_group field
     */
    const COL_FK_PRODUCT_GROUP = 'spy_product_abstract_group.fk_product_group';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'spy_product_abstract_group.position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkProductAbstract', 'FkProductGroup', 'Position', ),
        self::TYPE_CAMELNAME     => array('fkProductAbstract', 'fkProductGroup', 'position', ),
        self::TYPE_COLNAME       => array(SpyProductAbstractGroupTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractGroupTableMap::COL_FK_PRODUCT_GROUP, SpyProductAbstractGroupTableMap::COL_POSITION, ),
        self::TYPE_FIELDNAME     => array('fk_product_abstract', 'fk_product_group', 'position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkProductAbstract' => 0, 'FkProductGroup' => 1, 'Position' => 2, ),
        self::TYPE_CAMELNAME     => array('fkProductAbstract' => 0, 'fkProductGroup' => 1, 'position' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductAbstractGroupTableMap::COL_FK_PRODUCT_ABSTRACT => 0, SpyProductAbstractGroupTableMap::COL_FK_PRODUCT_GROUP => 1, SpyProductAbstractGroupTableMap::COL_POSITION => 2, ),
        self::TYPE_FIELDNAME     => array('fk_product_abstract' => 0, 'fk_product_group' => 1, 'position' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductAbstractGroupTableMap
