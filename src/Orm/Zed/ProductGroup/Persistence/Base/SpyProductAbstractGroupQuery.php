 ...
 *
 * @method     ChildSpyProductAbstractGroup[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductAbstractGroup objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractGroup> find(ConnectionInterface $con = null) Return ChildSpyProductAbstractGroup objects based on current ModelCriteria
 * @method     ChildSpyProductAbstractGroup[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractGroup objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractGroup> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyProductAbstractGroup objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractGroup[]|ObjectCollection findByFkProductGroup(int $fk_product_group) Return ChildSpyProductAbstractGroup objects filtered by the fk_product_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractGroup> findByFkProductGroup(int $fk_product_group) Return ChildSpyProductAbstractGroup objects filtered by the fk_product_group column
 * @method     ChildSpyProductAbstractGroup[]|ObjectCollection findByPosition(int $position) Return ChildSpyProductAbstractGroup objects filtered by the position column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductAbstractGroup> findByPosition(int $position) Return ChildSpyProductAbstractGroup objects filtered by the position column
...
abstract class SpyProductAbstractGroupQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductAbstractGroupQuery The current query, for fluid interface
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductAbstractGroupQuery The current query, for fluid interface
     */
    public function filterBySpyProductGroup($spyProductGroup, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductAbstractGroupQuery The current query, for fluid interface
     */
    public function joinSpyProductGroup($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyProductGroup', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductGroup', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
