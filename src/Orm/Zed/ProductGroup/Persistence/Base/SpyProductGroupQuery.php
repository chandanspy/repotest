 ...
 *
 * @method     ChildSpyProductGroup[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductGroup objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductGroup> find(ConnectionInterface $con = null) Return ChildSpyProductGroup objects based on current ModelCriteria
 * @method     ChildSpyProductGroup[]|ObjectCollection findByIdProductGroup(int $id_product_group) Return ChildSpyProductGroup objects filtered by the id_product_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductGroup> findByIdProductGroup(int $id_product_group) Return ChildSpyProductGroup objects filtered by the id_product_group column
 * @method     ChildSpyProductGroup[]|ObjectCollection findByProductGroupKey(string $product_group_key) Return ChildSpyProductGroup objects filtered by the product_group_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductGroup> findByProductGroupKey(string $product_group_key) Return ChildSpyProductGroup objects filtered by the product_group_key column
...
abstract class SpyProductGroupQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductGroupQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductGroupTableMap::COL_ID_PRODUCT_GROUP, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductGroupTableMap::COL_ID_PRODUCT_GROUP, $keys, Criteria::IN);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductGroupQuery The current query, for fluid interface
     */
