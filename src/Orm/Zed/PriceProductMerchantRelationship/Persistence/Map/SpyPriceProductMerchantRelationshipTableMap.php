...
class SpyPriceProductMerchantRelationshipTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PriceProductMerchantRelationship.Persistence.Map.SpyPriceProductMerchantRelationshipTableMap';
     ...
     */
    const TABLE_NAME = 'spy_price_product_merchant_relationship';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PriceProductMerchantRelationship\\Persistence\\SpyPriceProductMerchantRelationship';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PriceProductMerchantRelationship.Persistence.SpyPriceProductMerchantRelationship';
     ...
     */
    const COL_ID_PRICE_PRODUCT_MERCHANT_RELATIONSHIP = 'spy_price_product_merchant_relationship.id_price_product_merchant_relationship';

    /**
     * the column name for the fk_merchant_relationship field
     */
    const COL_FK_MERCHANT_RELATIONSHIP = 'spy_price_product_merchant_relationship.fk_merchant_relationship';

    /**
     * the column name for the fk_price_product_store field
     */
    const COL_FK_PRICE_PRODUCT_STORE = 'spy_price_product_merchant_relationship.fk_price_product_store';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_price_product_merchant_relationship.fk_product';

    /**
     * the column name for the fk_product_abstract field
     */
    const COL_FK_PRODUCT_ABSTRACT = 'spy_price_product_merchant_relationship.fk_product_abstract';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProductMerchantRelationship', 'FkMerchantRelationship', 'FkPriceProductStore', 'FkProduct', 'FkProductAbstract', ),
        self::TYPE_CAMELNAME     => array('idPriceProductMerchantRelationship', 'fkMerchantRelationship', 'fkPriceProductStore', 'fkProduct', 'fkProductAbstract', ),
        self::TYPE_COLNAME       => array(SpyPriceProductMerchantRelationshipTableMap::COL_ID_PRICE_PRODUCT_MERCHANT_RELATIONSHIP, SpyPriceProductMerchantRelationshipTableMap::COL_FK_MERCHANT_RELATIONSHIP, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRICE_PRODUCT_STORE, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRODUCT, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRODUCT_ABSTRACT, ),
        self::TYPE_FIELDNAME     => array('id_price_product_merchant_relationship', 'fk_merchant_relationship', 'fk_price_product_store', 'fk_product', 'fk_product_abstract', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProductMerchantRelationship' => 0, 'FkMerchantRelationship' => 1, 'FkPriceProductStore' => 2, 'FkProduct' => 3, 'FkProductAbstract' => 4, ),
        self::TYPE_CAMELNAME     => array('idPriceProductMerchantRelationship' => 0, 'fkMerchantRelationship' => 1, 'fkPriceProductStore' => 2, 'fkProduct' => 3, 'fkProductAbstract' => 4, ),
        self::TYPE_COLNAME       => array(SpyPriceProductMerchantRelationshipTableMap::COL_ID_PRICE_PRODUCT_MERCHANT_RELATIONSHIP => 0, SpyPriceProductMerchantRelationshipTableMap::COL_FK_MERCHANT_RELATIONSHIP => 1, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRICE_PRODUCT_STORE => 2, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRODUCT => 3, SpyPriceProductMerchantRelationshipTableMap::COL_FK_PRODUCT_ABSTRACT => 4, ),
        self::TYPE_FIELDNAME     => array('id_price_product_merchant_relationship' => 0, 'fk_merchant_relationship' => 1, 'fk_price_product_store' => 2, 'fk_product' => 3, 'fk_product_abstract' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyPriceProductMerchantRelationshipTableMap
