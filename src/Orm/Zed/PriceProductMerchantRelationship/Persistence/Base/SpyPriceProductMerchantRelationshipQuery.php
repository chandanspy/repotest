 ...
 *
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPriceProductMerchantRelationship objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> find(ConnectionInterface $con = null) Return ChildSpyPriceProductMerchantRelationship objects based on current ModelCriteria
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection findByIdPriceProductMerchantRelationship(string $id_price_product_merchant_relationship) Return ChildSpyPriceProductMerchantRelationship objects filtered by the id_price_product_merchant_relationship column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> findByIdPriceProductMerchantRelationship(string $id_price_product_merchant_relationship) Return ChildSpyPriceProductMerchantRelationship objects filtered by the id_price_product_merchant_relationship column
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_merchant_relationship column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> findByFkMerchantRelationship(int $fk_merchant_relationship) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_merchant_relationship column
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection findByFkPriceProductStore(string $fk_price_product_store) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_price_product_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> findByFkPriceProductStore(string $fk_price_product_store) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_price_product_store column
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection findByFkProduct(int $fk_product) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_product column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> findByFkProduct(int $fk_product) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_product column
 * @method     ChildSpyPriceProductMerchantRelationship[]|ObjectCollection findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_product_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPriceProductMerchantRelationship> findByFkProductAbstract(int $fk_product_abstract) Return ChildSpyPriceProductMerchantRelationship objects filtered by the fk_product_abstract column
...
abstract class SpyPriceProductMerchantRelationshipQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPriceProductMerchantRelationshipQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPriceProductMerchantRelationshipTableMap::COL_ID_PRICE_PRODUCT_MERCHANT_RELATIONSHIP, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPriceProductMerchantRelationshipTableMap::COL_ID_PRICE_PRODUCT_MERCHANT_RELATIONSHIP, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyPriceProductMerchantRelationshipQuery The current query, for fluid interface
     */
