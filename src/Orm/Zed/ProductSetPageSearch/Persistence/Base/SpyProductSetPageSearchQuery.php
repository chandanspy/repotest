 ...
 *
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductSetPageSearch objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> find(ConnectionInterface $con = null) Return ChildSpyProductSetPageSearch objects based on current ModelCriteria
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByIdProductSetPageSearch(string $id_product_set_page_search) Return ChildSpyProductSetPageSearch objects filtered by the id_product_set_page_search column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByIdProductSetPageSearch(string $id_product_set_page_search) Return ChildSpyProductSetPageSearch objects filtered by the id_product_set_page_search column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByFkProductSet(int $fk_product_set) Return ChildSpyProductSetPageSearch objects filtered by the fk_product_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByFkProductSet(int $fk_product_set) Return ChildSpyProductSetPageSearch objects filtered by the fk_product_set column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByStructuredData(string $structured_data) Return ChildSpyProductSetPageSearch objects filtered by the structured_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByStructuredData(string $structured_data) Return ChildSpyProductSetPageSearch objects filtered by the structured_data column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByData(string $data) Return ChildSpyProductSetPageSearch objects filtered by the data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByData(string $data) Return ChildSpyProductSetPageSearch objects filtered by the data column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByLocale(string $locale) Return ChildSpyProductSetPageSearch objects filtered by the locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByLocale(string $locale) Return ChildSpyProductSetPageSearch objects filtered by the locale column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByAliasKeys(string $alias_keys) Return ChildSpyProductSetPageSearch objects filtered by the alias_keys column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByAliasKeys(string $alias_keys) Return ChildSpyProductSetPageSearch objects filtered by the alias_keys column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByKey(string $key) Return ChildSpyProductSetPageSearch objects filtered by the key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByKey(string $key) Return ChildSpyProductSetPageSearch objects filtered by the key column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductSetPageSearch objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByCreatedAt(string $created_at) Return ChildSpyProductSetPageSearch objects filtered by the created_at column
 * @method     ChildSpyProductSetPageSearch[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductSetPageSearch objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductSetPageSearch> findByUpdatedAt(string $updated_at) Return ChildSpyProductSetPageSearch objects filtered by the updated_at column
...
abstract class SpyProductSetPageSearchQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductSetPageSearchQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductSetPageSearchTableMap::COL_ID_PRODUCT_SET_PAGE_SEARCH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductSetPageSearchTableMap::COL_ID_PRODUCT_SET_PAGE_SEARCH, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductSetPageSearchTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetPageSearchTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductSetPageSearchTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductSetPageSearchTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductSetPageSearchTableMap::COL_CREATED_AT);
    }

} // SpyProductSetPageSearchQuery
