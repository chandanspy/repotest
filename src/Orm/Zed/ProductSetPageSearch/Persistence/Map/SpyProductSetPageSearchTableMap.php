...
class SpyProductSetPageSearchTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductSetPageSearch.Persistence.Map.SpyProductSetPageSearchTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_set_page_search';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductSetPageSearch\\Persistence\\SpyProductSetPageSearch';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductSetPageSearch.Persistence.SpyProductSetPageSearch';
     ...
     */
    const COL_ID_PRODUCT_SET_PAGE_SEARCH = 'spy_product_set_page_search.id_product_set_page_search';

    /**
     * the column name for the fk_product_set field
     */
    const COL_FK_PRODUCT_SET = 'spy_product_set_page_search.fk_product_set';

    /**
     * the column name for the structured_data field
     */
    const COL_STRUCTURED_DATA = 'spy_product_set_page_search.structured_data';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_set_page_search.data';

    /**
     * the column name for the locale field
     */
    const COL_LOCALE = 'spy_product_set_page_search.locale';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_set_page_search.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_set_page_search.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_set_page_search.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_set_page_search.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductSetPageSearch', 'FkProductSet', 'StructuredData', 'Data', 'Locale', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductSetPageSearch', 'fkProductSet', 'structuredData', 'data', 'locale', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductSetPageSearchTableMap::COL_ID_PRODUCT_SET_PAGE_SEARCH, SpyProductSetPageSearchTableMap::COL_FK_PRODUCT_SET, SpyProductSetPageSearchTableMap::COL_STRUCTURED_DATA, SpyProductSetPageSearchTableMap::COL_DATA, SpyProductSetPageSearchTableMap::COL_LOCALE, SpyProductSetPageSearchTableMap::COL_ALIAS_KEYS, SpyProductSetPageSearchTableMap::COL_KEY, SpyProductSetPageSearchTableMap::COL_CREATED_AT, SpyProductSetPageSearchTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_set_page_search', 'fk_product_set', 'structured_data', 'data', 'locale', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductSetPageSearch' => 0, 'FkProductSet' => 1, 'StructuredData' => 2, 'Data' => 3, 'Locale' => 4, 'AliasKeys' => 5, 'Key' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idProductSetPageSearch' => 0, 'fkProductSet' => 1, 'structuredData' => 2, 'data' => 3, 'locale' => 4, 'aliasKeys' => 5, 'key' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyProductSetPageSearchTableMap::COL_ID_PRODUCT_SET_PAGE_SEARCH => 0, SpyProductSetPageSearchTableMap::COL_FK_PRODUCT_SET => 1, SpyProductSetPageSearchTableMap::COL_STRUCTURED_DATA => 2, SpyProductSetPageSearchTableMap::COL_DATA => 3, SpyProductSetPageSearchTableMap::COL_LOCALE => 4, SpyProductSetPageSearchTableMap::COL_ALIAS_KEYS => 5, SpyProductSetPageSearchTableMap::COL_KEY => 6, SpyProductSetPageSearchTableMap::COL_CREATED_AT => 7, SpyProductSetPageSearchTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_product_set_page_search' => 0, 'fk_product_set' => 1, 'structured_data' => 2, 'data' => 3, 'locale' => 4, 'alias_keys' => 5, 'key' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
