...
class SpyCmsBlockCategoryStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CmsBlockCategoryStorage.Persistence.Map.SpyCmsBlockCategoryStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_cms_block_category_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CmsBlockCategoryStorage\\Persistence\\SpyCmsBlockCategoryStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlockCategoryStorage.Persistence.SpyCmsBlockCategoryStorage';
     ...
     */
    const COL_ID_CMS_BLOCK_CATEGORY_STORAGE = 'spy_cms_block_category_storage.id_cms_block_category_storage';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_cms_block_category_storage.fk_category';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_cms_block_category_storage.data';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_cms_block_category_storage.alias_keys';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_cms_block_category_storage.key';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_cms_block_category_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_cms_block_category_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockCategoryStorage', 'FkCategory', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idCmsBlockCategoryStorage', 'fkCategory', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockCategoryStorageTableMap::COL_ID_CMS_BLOCK_CATEGORY_STORAGE, SpyCmsBlockCategoryStorageTableMap::COL_FK_CATEGORY, SpyCmsBlockCategoryStorageTableMap::COL_DATA, SpyCmsBlockCategoryStorageTableMap::COL_ALIAS_KEYS, SpyCmsBlockCategoryStorageTableMap::COL_KEY, SpyCmsBlockCategoryStorageTableMap::COL_CREATED_AT, SpyCmsBlockCategoryStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_category_storage', 'fk_category', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlockCategoryStorage' => 0, 'FkCategory' => 1, 'Data' => 2, 'AliasKeys' => 3, 'Key' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idCmsBlockCategoryStorage' => 0, 'fkCategory' => 1, 'data' => 2, 'aliasKeys' => 3, 'key' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockCategoryStorageTableMap::COL_ID_CMS_BLOCK_CATEGORY_STORAGE => 0, SpyCmsBlockCategoryStorageTableMap::COL_FK_CATEGORY => 1, SpyCmsBlockCategoryStorageTableMap::COL_DATA => 2, SpyCmsBlockCategoryStorageTableMap::COL_ALIAS_KEYS => 3, SpyCmsBlockCategoryStorageTableMap::COL_KEY => 4, SpyCmsBlockCategoryStorageTableMap::COL_CREATED_AT => 5, SpyCmsBlockCategoryStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_cms_block_category_storage' => 0, 'fk_category' => 1, 'data' => 2, 'alias_keys' => 3, 'key' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
