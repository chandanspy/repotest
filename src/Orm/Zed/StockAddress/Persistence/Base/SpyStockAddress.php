...
abstract class SpyStockAddress implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\StockAddress\\Persistence\\Map\\SpyStockAddressTableMap';
     ...
     * @return $this|\Orm\Zed\StockAddress\Persistence\SpyStockAddress The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\StockAddress\Persistence\SpyStockAddress
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\StockAddress\Persistence\SpyStockAddress The current object, for fluid interface
     */
