 ...
 *
 * @method     ChildSpyStockAddress[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyStockAddress objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> find(ConnectionInterface $con = null) Return ChildSpyStockAddress objects based on current ModelCriteria
 * @method     ChildSpyStockAddress[]|ObjectCollection findByIdStockAddress(int $id_stock_address) Return ChildSpyStockAddress objects filtered by the id_stock_address column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByIdStockAddress(int $id_stock_address) Return ChildSpyStockAddress objects filtered by the id_stock_address column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByFkStock(int $fk_stock) Return ChildSpyStockAddress objects filtered by the fk_stock column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByFkStock(int $fk_stock) Return ChildSpyStockAddress objects filtered by the fk_stock column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByFkCountry(int $fk_country) Return ChildSpyStockAddress objects filtered by the fk_country column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByFkCountry(int $fk_country) Return ChildSpyStockAddress objects filtered by the fk_country column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByFkRegion(int $fk_region) Return ChildSpyStockAddress objects filtered by the fk_region column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByFkRegion(int $fk_region) Return ChildSpyStockAddress objects filtered by the fk_region column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByAddress1(string $address1) Return ChildSpyStockAddress objects filtered by the address1 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByAddress1(string $address1) Return ChildSpyStockAddress objects filtered by the address1 column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByAddress2(string $address2) Return ChildSpyStockAddress objects filtered by the address2 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByAddress2(string $address2) Return ChildSpyStockAddress objects filtered by the address2 column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByAddress3(string $address3) Return ChildSpyStockAddress objects filtered by the address3 column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByAddress3(string $address3) Return ChildSpyStockAddress objects filtered by the address3 column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByCity(string $city) Return ChildSpyStockAddress objects filtered by the city column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByCity(string $city) Return ChildSpyStockAddress objects filtered by the city column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByZipCode(string $zip_code) Return ChildSpyStockAddress objects filtered by the zip_code column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByZipCode(string $zip_code) Return ChildSpyStockAddress objects filtered by the zip_code column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByPhone(string $phone) Return ChildSpyStockAddress objects filtered by the phone column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByPhone(string $phone) Return ChildSpyStockAddress objects filtered by the phone column
 * @method     ChildSpyStockAddress[]|ObjectCollection findByComment(string $comment) Return ChildSpyStockAddress objects filtered by the comment column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyStockAddress> findByComment(string $comment) Return ChildSpyStockAddress objects filtered by the comment column
...
abstract class SpyStockAddressQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyStockAddressQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyStockAddressTableMap::COL_ID_STOCK_ADDRESS, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyStockAddressTableMap::COL_ID_STOCK_ADDRESS, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyStockAddressQuery The current query, for fluid interface
     */
