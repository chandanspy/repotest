 ...
 *
 * @method     ChildPyzExampleStateMachineItem[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildPyzExampleStateMachineItem objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildPyzExampleStateMachineItem> find(ConnectionInterface $con = null) Return ChildPyzExampleStateMachineItem objects based on current ModelCriteria
 * @method     ChildPyzExampleStateMachineItem[]|ObjectCollection findByIdExampleStateMachineItem(int $id_example_state_machine_item) Return ChildPyzExampleStateMachineItem objects filtered by the id_example_state_machine_item column
 * @psalm-method ObjectCollection&\Traversable<ChildPyzExampleStateMachineItem> findByIdExampleStateMachineItem(int $id_example_state_machine_item) Return ChildPyzExampleStateMachineItem objects filtered by the id_example_state_machine_item column
 * @method     ChildPyzExampleStateMachineItem[]|ObjectCollection findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildPyzExampleStateMachineItem objects filtered by the fk_state_machine_item_state column
 * @psalm-method ObjectCollection&\Traversable<ChildPyzExampleStateMachineItem> findByFkStateMachineItemState(int $fk_state_machine_item_state) Return ChildPyzExampleStateMachineItem objects filtered by the fk_state_machine_item_state column
 * @method     ChildPyzExampleStateMachineItem[]|ObjectCollection findByName(string $name) Return ChildPyzExampleStateMachineItem objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildPyzExampleStateMachineItem> findByName(string $name) Return ChildPyzExampleStateMachineItem objects filtered by the name column
...
abstract class PyzExampleStateMachineItemQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildPyzExampleStateMachineItemQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(PyzExampleStateMachineItemTableMap::COL_ID_EXAMPLE_STATE_MACHINE_ITEM, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PyzExampleStateMachineItemTableMap::COL_ID_EXAMPLE_STATE_MACHINE_ITEM, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildPyzExampleStateMachineItemQuery The current query, for fluid interface
     */
