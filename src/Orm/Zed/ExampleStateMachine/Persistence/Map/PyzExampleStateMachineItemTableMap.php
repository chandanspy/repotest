...
class PyzExampleStateMachineItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ExampleStateMachine.Persistence.Map.PyzExampleStateMachineItemTableMap';
     ...
     */
    const TABLE_NAME = 'pyz_example_state_machine_item';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ExampleStateMachine\\Persistence\\PyzExampleStateMachineItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ExampleStateMachine.Persistence.PyzExampleStateMachineItem';
     ...
     */
    const COL_ID_EXAMPLE_STATE_MACHINE_ITEM = 'pyz_example_state_machine_item.id_example_state_machine_item';

    /**
     * the column name for the fk_state_machine_item_state field
     */
    const COL_FK_STATE_MACHINE_ITEM_STATE = 'pyz_example_state_machine_item.fk_state_machine_item_state';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'pyz_example_state_machine_item.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdExampleStateMachineItem', 'FkStateMachineItemState', 'Name', ),
        self::TYPE_CAMELNAME     => array('idExampleStateMachineItem', 'fkStateMachineItemState', 'name', ),
        self::TYPE_COLNAME       => array(PyzExampleStateMachineItemTableMap::COL_ID_EXAMPLE_STATE_MACHINE_ITEM, PyzExampleStateMachineItemTableMap::COL_FK_STATE_MACHINE_ITEM_STATE, PyzExampleStateMachineItemTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_example_state_machine_item', 'fk_state_machine_item_state', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdExampleStateMachineItem' => 0, 'FkStateMachineItemState' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('idExampleStateMachineItem' => 0, 'fkStateMachineItemState' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(PyzExampleStateMachineItemTableMap::COL_ID_EXAMPLE_STATE_MACHINE_ITEM => 0, PyzExampleStateMachineItemTableMap::COL_FK_STATE_MACHINE_ITEM_STATE => 1, PyzExampleStateMachineItemTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id_example_state_machine_item' => 0, 'fk_state_machine_item_state' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // PyzExampleStateMachineItemTableMap
