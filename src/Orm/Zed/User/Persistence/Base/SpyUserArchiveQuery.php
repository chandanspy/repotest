 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> find(ConnectionInterface $con = null) Return ChildSpyUserArchive objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByIdUser(int $id_user) Return ChildSpyUserArchive objects filtered by the id_user column
 * @method     ChildSpyUserArchive[]|ObjectCollection findByFkLocale(int $fk_locale) Return ChildSpyUserArchive objects filtered by the fk_locale column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByFkLocale(int $fk_locale) Return ChildSpyUserArchive objects filtered by the fk_locale column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByFirstName(string $first_name) Return ChildSpyUserArchive objects filtered by the first_name column
 * @method     ChildSpyUserArchive[]|ObjectCollection findByIsAgent(boolean $is_agent) Return ChildSpyUserArchive objects filtered by the is_agent column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByIsAgent(boolean $is_agent) Return ChildSpyUserArchive objects filtered by the is_agent column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByLastLogin(string $last_login) Return ChildSpyUserArchive objects filtered by the last_login column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByLastName(string $last_name) Return ChildSpyUserArchive objects filtered by the last_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByPassword(string $password) Return ChildSpyUserArchive objects filtered by the password column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByStatus(int $status) Return ChildSpyUserArchive objects filtered by the status column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByUsername(string $username) Return ChildSpyUserArchive objects filtered by the username column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByCreatedAt(string $created_at) Return ChildSpyUserArchive objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByUpdatedAt(string $updated_at) Return ChildSpyUserArchive objects filtered by the updated_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyUserArchive> findByArchivedAt(string $archived_at) Return ChildSpyUserArchive objects filtered by the archived_at column
...
abstract class SpyUserArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_user, fk_locale, first_name, is_agent, last_login, last_name, password, status, username, created_at, updated_at, archived_at FROM spy_user_archive WHERE id_user = :p0';
        try {
