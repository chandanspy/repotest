 ...
 *
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyDiscountPromotion objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> find(ConnectionInterface $con = null) Return ChildSpyDiscountPromotion objects based on current ModelCriteria
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByIdDiscountPromotion(int $id_discount_promotion) Return ChildSpyDiscountPromotion objects filtered by the id_discount_promotion column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByIdDiscountPromotion(int $id_discount_promotion) Return ChildSpyDiscountPromotion objects filtered by the id_discount_promotion column
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByFkDiscount(int $fk_discount) Return ChildSpyDiscountPromotion objects filtered by the fk_discount column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByFkDiscount(int $fk_discount) Return ChildSpyDiscountPromotion objects filtered by the fk_discount column
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByAbstractSku(string $abstract_sku) Return ChildSpyDiscountPromotion objects filtered by the abstract_sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByAbstractSku(string $abstract_sku) Return ChildSpyDiscountPromotion objects filtered by the abstract_sku column
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByAbstractSkus(string $abstract_skus) Return ChildSpyDiscountPromotion objects filtered by the abstract_skus column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByAbstractSkus(string $abstract_skus) Return ChildSpyDiscountPromotion objects filtered by the abstract_skus column
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByQuantity(int $quantity) Return ChildSpyDiscountPromotion objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByQuantity(int $quantity) Return ChildSpyDiscountPromotion objects filtered by the quantity column
 * @method     ChildSpyDiscountPromotion[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyDiscountPromotion objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountPromotion> findByUuid(string $uuid) Return ChildSpyDiscountPromotion objects filtered by the uuid column
...
abstract class SpyDiscountPromotionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyDiscountPromotionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyDiscountPromotionTableMap::COL_ID_DISCOUNT_PROMOTION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyDiscountPromotionTableMap::COL_ID_DISCOUNT_PROMOTION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyDiscountPromotionQuery The current query, for fluid interface
     */
