...
abstract class SpyProductOptionGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductOption\\Persistence\\Map\\SpyProductOptionGroupTableMap';
     ...
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductOptionGroupTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyProductOptionGroupTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyProductOptionGroupTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = SpyProductOptionGroupTableMap::NUM_HYDRATE_COLUMNS.
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionGroup The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductOptionGroup The current object (for fluent API support)
     */
     ...
     */
    protected function doAddSpyProductAbstractProductOptionGroup(ChildSpyProductAbstractProductOptionGroup $spyProductAbstractProductOptionGroup)
    {
     ...
     * @return bool
     */
    public function isSpyProductAbstractsLoaded()
    {
     ...
     */
    public function countSpyProductAbstracts(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyProductAbstractsPartial && !$this->isNew();
        if (null === $this->collSpyProductAbstracts || null !== $criteria || $partial) {
