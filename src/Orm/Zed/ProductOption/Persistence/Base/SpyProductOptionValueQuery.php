 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> find(ConnectionInterface $con = null) Return ChildSpyProductOptionValue objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByIdProductOptionValue(int $id_product_option_value) Return ChildSpyProductOptionValue objects filtered by the id_product_option_value column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findByFkProductOptionGroup(int $fk_product_option_group) Return ChildSpyProductOptionValue objects filtered by the fk_product_option_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByFkProductOptionGroup(int $fk_product_option_group) Return ChildSpyProductOptionValue objects filtered by the fk_product_option_group column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findByPrice(int $price) Return ChildSpyProductOptionValue objects filtered by the price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByPrice(int $price) Return ChildSpyProductOptionValue objects filtered by the price column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findBySku(string $sku) Return ChildSpyProductOptionValue objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findBySku(string $sku) Return ChildSpyProductOptionValue objects filtered by the sku column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findByValue(string $value) Return ChildSpyProductOptionValue objects filtered by the value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByValue(string $value) Return ChildSpyProductOptionValue objects filtered by the value column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductOptionValue objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByCreatedAt(string $created_at) Return ChildSpyProductOptionValue objects filtered by the created_at column
 * @method     ChildSpyProductOptionValue[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductOptionValue objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValue> findByUpdatedAt(string $updated_at) Return ChildSpyProductOptionValue objects filtered by the updated_at column
...
abstract class SpyProductOptionValueQuery extends ModelCriteria
{
    ...
    {
        return $this->addUsingAlias(SpyProductOptionValueTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductOptionValueTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductOptionValueTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductOptionValueTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductOptionValueTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductOptionValueTableMap::COL_CREATED_AT);
    }
