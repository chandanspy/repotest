 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> find(ConnectionInterface $con = null) Return ChildSpyProductOptionValuePrice objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByIdProductOptionValuePrice(int $id_product_option_value_price) Return ChildSpyProductOptionValuePrice objects filtered by the id_product_option_value_price column
 * @method     ChildSpyProductOptionValuePrice[]|ObjectCollection findByFkCurrency(int $fk_currency) Return ChildSpyProductOptionValuePrice objects filtered by the fk_currency column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByFkCurrency(int $fk_currency) Return ChildSpyProductOptionValuePrice objects filtered by the fk_currency column
 * @method     ChildSpyProductOptionValuePrice[]|ObjectCollection findByFkProductOptionValue(int $fk_product_option_value) Return ChildSpyProductOptionValuePrice objects filtered by the fk_product_option_value column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByFkProductOptionValue(int $fk_product_option_value) Return ChildSpyProductOptionValuePrice objects filtered by the fk_product_option_value column
 * @method     ChildSpyProductOptionValuePrice[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyProductOptionValuePrice objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByFkStore(int $fk_store) Return ChildSpyProductOptionValuePrice objects filtered by the fk_store column
 * @method     ChildSpyProductOptionValuePrice[]|ObjectCollection findByGrossPrice(int $gross_price) Return ChildSpyProductOptionValuePrice objects filtered by the gross_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByGrossPrice(int $gross_price) Return ChildSpyProductOptionValuePrice objects filtered by the gross_price column
 * @method     ChildSpyProductOptionValuePrice[]|ObjectCollection findByNetPrice(int $net_price) Return ChildSpyProductOptionValuePrice objects filtered by the net_price column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionValuePrice> findByNetPrice(int $net_price) Return ChildSpyProductOptionValuePrice objects filtered by the net_price column
...
abstract class SpyProductOptionValuePriceQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductOptionValuePriceQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductOptionValuePriceTableMap::COL_ID_PRODUCT_OPTION_VALUE_PRICE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductOptionValuePriceTableMap::COL_ID_PRODUCT_OPTION_VALUE_PRICE, $keys, Criteria::IN);
    }
     ...
     * @return ChildSpyProductOptionValuePriceQuery The current query, for fluid interface
     */
    public function filterByProductOptionValue($spyProductOptionValue, $comparison = null)
    {
     ...
     * @return $this|ChildSpyProductOptionValuePriceQuery The current query, for fluid interface
     */
    public function joinProductOptionValue($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('ProductOptionValue', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('ProductOptionValue', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
