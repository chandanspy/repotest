 ...
 *
 * @method     \Orm\Zed\Tax\Persistence\SpyTaxSetQuery|\Orm\Zed\ProductOption\Persistence\SpyProductAbstractProductOptionGroupQuery|\Orm\Zed\ProductOption\Persistence\SpyProductOptionValueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductOptionGroup objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> find(ConnectionInterface $con = null) Return ChildSpyProductOptionGroup objects based on current ModelCriteria
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByIdProductOptionGroup(int $id_product_option_group) Return ChildSpyProductOptionGroup objects filtered by the id_product_option_group column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByIdProductOptionGroup(int $id_product_option_group) Return ChildSpyProductOptionGroup objects filtered by the id_product_option_group column
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByFkTaxSet(int $fk_tax_set) Return ChildSpyProductOptionGroup objects filtered by the fk_tax_set column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByFkTaxSet(int $fk_tax_set) Return ChildSpyProductOptionGroup objects filtered by the fk_tax_set column
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByActive(boolean $active) Return ChildSpyProductOptionGroup objects filtered by the active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByActive(boolean $active) Return ChildSpyProductOptionGroup objects filtered by the active column
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByName(string $name) Return ChildSpyProductOptionGroup objects filtered by the name column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByName(string $name) Return ChildSpyProductOptionGroup objects filtered by the name column
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyProductOptionGroup objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByCreatedAt(string $created_at) Return ChildSpyProductOptionGroup objects filtered by the created_at column
 * @method     ChildSpyProductOptionGroup[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyProductOptionGroup objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductOptionGroup> findByUpdatedAt(string $updated_at) Return ChildSpyProductOptionGroup objects filtered by the updated_at column
...
abstract class SpyProductOptionGroupQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_product_option_group, fk_tax_set, active, name, created_at, updated_at FROM spy_product_option_group WHERE id_product_option_group = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductOptionGroupQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductOptionGroupQuery The current query, for fluid interface
     */
    ...
    {
        return $this->useExistsQuery('SpyProductOptionValue', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyProductOptionValue', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyProductOptionGroupQuery The current query, for fluid interface
     */
    public function filterBySpyProductAbstract($spyProductAbstract, $comparison = Criteria::EQUAL)
    {
        return $this
            ->useSpyProductAbstractProductOptionGroupQuery()
    ...
    {
        return $this->addUsingAlias(SpyProductOptionGroupTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductOptionGroupTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductOptionGroupTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyProductOptionGroupTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyProductOptionGroupTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyProductOptionGroupTableMap::COL_CREATED_AT);
    }

} // SpyProductOptionGroupQuery
