...
abstract class SpyProductOptionValue implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\ProductOption\\Persistence\\Map\\SpyProductOptionValueTableMap';
     ...
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionValue The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionValue
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\ProductOption\Persistence\SpyProductOptionValue The current object, for fluid interface
     */
     ...
     */
    protected function doAddProductOptionValuePrice(ChildSpyProductOptionValuePrice $productOptionValuePrice)
    {
