...
class SpyProductOptionValuePriceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductOption.Persistence.Map.SpyProductOptionValuePriceTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductOption\\Persistence\\SpyProductOptionValuePrice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductOption.Persistence.SpyProductOptionValuePrice';
     ...
     */
    const COL_FK_CURRENCY = 'spy_product_option_value_price.fk_currency';

    /**
     * the column name for the fk_product_option_value field
     */
    const COL_FK_PRODUCT_OPTION_VALUE = 'spy_product_option_value_price.fk_product_option_value';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_product_option_value_price.fk_store';

    /**
     * the column name for the gross_price field
     */
    const COL_GROSS_PRICE = 'spy_product_option_value_price.gross_price';

    /**
     * the column name for the net_price field
     */
    const COL_NET_PRICE = 'spy_product_option_value_price.net_price';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductOptionValuePrice', 'FkCurrency', 'FkProductOptionValue', 'FkStore', 'GrossPrice', 'NetPrice', ),
        self::TYPE_CAMELNAME     => array('idProductOptionValuePrice', 'fkCurrency', 'fkProductOptionValue', 'fkStore', 'grossPrice', 'netPrice', ),
        self::TYPE_COLNAME       => array(SpyProductOptionValuePriceTableMap::COL_ID_PRODUCT_OPTION_VALUE_PRICE, SpyProductOptionValuePriceTableMap::COL_FK_CURRENCY, SpyProductOptionValuePriceTableMap::COL_FK_PRODUCT_OPTION_VALUE, SpyProductOptionValuePriceTableMap::COL_FK_STORE, SpyProductOptionValuePriceTableMap::COL_GROSS_PRICE, SpyProductOptionValuePriceTableMap::COL_NET_PRICE, ),
        self::TYPE_FIELDNAME     => array('id_product_option_value_price', 'fk_currency', 'fk_product_option_value', 'fk_store', 'gross_price', 'net_price', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductOptionValuePrice' => 0, 'FkCurrency' => 1, 'FkProductOptionValue' => 2, 'FkStore' => 3, 'GrossPrice' => 4, 'NetPrice' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductOptionValuePrice' => 0, 'fkCurrency' => 1, 'fkProductOptionValue' => 2, 'fkStore' => 3, 'grossPrice' => 4, 'netPrice' => 5, ),
        ...
        self::TYPE_FIELDNAME     => array('id_product_option_value_price' => 0, 'fk_currency' => 1, 'fk_product_option_value' => 2, 'fk_store' => 3, 'gross_price' => 4, 'net_price' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
