...
class SpyProductOptionGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductOption.Persistence.Map.SpyProductOptionGroupTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_option_group';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductOption\\Persistence\\SpyProductOptionGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductOption.Persistence.SpyProductOptionGroup';
     ...
     */
    const COL_ID_PRODUCT_OPTION_GROUP = 'spy_product_option_group.id_product_option_group';

    /**
     * the column name for the fk_tax_set field
     */
    const COL_FK_TAX_SET = 'spy_product_option_group.fk_tax_set';

    /**
     * the column name for the active field
     */
    const COL_ACTIVE = 'spy_product_option_group.active';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_product_option_group.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_option_group.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_option_group.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductOptionGroup', 'FkTaxSet', 'Active', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductOptionGroup', 'fkTaxSet', 'active', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP, SpyProductOptionGroupTableMap::COL_FK_TAX_SET, SpyProductOptionGroupTableMap::COL_ACTIVE, SpyProductOptionGroupTableMap::COL_NAME, SpyProductOptionGroupTableMap::COL_CREATED_AT, SpyProductOptionGroupTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_option_group', 'fk_tax_set', 'active', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductOptionGroup' => 0, 'FkTaxSet' => 1, 'Active' => 2, 'Name' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('idProductOptionGroup' => 0, 'fkTaxSet' => 1, 'active' => 2, 'name' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(SpyProductOptionGroupTableMap::COL_ID_PRODUCT_OPTION_GROUP => 0, SpyProductOptionGroupTableMap::COL_FK_TAX_SET => 1, SpyProductOptionGroupTableMap::COL_ACTIVE => 2, SpyProductOptionGroupTableMap::COL_NAME => 3, SpyProductOptionGroupTableMap::COL_CREATED_AT => 4, SpyProductOptionGroupTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id_product_option_group' => 0, 'fk_tax_set' => 1, 'active' => 2, 'name' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
