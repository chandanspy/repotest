 ...
 *
 * @method     ChildSpyAvailability[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyAvailability objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> find(ConnectionInterface $con = null) Return ChildSpyAvailability objects based on current ModelCriteria
 * @method     ChildSpyAvailability[]|ObjectCollection findByIdAvailability(int $id_availability) Return ChildSpyAvailability objects filtered by the id_availability column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findByIdAvailability(int $id_availability) Return ChildSpyAvailability objects filtered by the id_availability column
 * @method     ChildSpyAvailability[]|ObjectCollection findByFkAvailabilityAbstract(int $fk_availability_abstract) Return ChildSpyAvailability objects filtered by the fk_availability_abstract column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findByFkAvailabilityAbstract(int $fk_availability_abstract) Return ChildSpyAvailability objects filtered by the fk_availability_abstract column
 * @method     ChildSpyAvailability[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyAvailability objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findByFkStore(int $fk_store) Return ChildSpyAvailability objects filtered by the fk_store column
 * @method     ChildSpyAvailability[]|ObjectCollection findByIsNeverOutOfStock(boolean $is_never_out_of_stock) Return ChildSpyAvailability objects filtered by the is_never_out_of_stock column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findByIsNeverOutOfStock(boolean $is_never_out_of_stock) Return ChildSpyAvailability objects filtered by the is_never_out_of_stock column
 * @method     ChildSpyAvailability[]|ObjectCollection findByQuantity(string $quantity) Return ChildSpyAvailability objects filtered by the quantity column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findByQuantity(string $quantity) Return ChildSpyAvailability objects filtered by the quantity column
 * @method     ChildSpyAvailability[]|ObjectCollection findBySku(string $sku) Return ChildSpyAvailability objects filtered by the sku column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyAvailability> findBySku(string $sku) Return ChildSpyAvailability objects filtered by the sku column
...
abstract class SpyAvailabilityQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyAvailabilityQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyAvailabilityTableMap::COL_ID_AVAILABILITY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyAvailabilityTableMap::COL_ID_AVAILABILITY, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyAvailabilityQuery The current query, for fluid interface
     */
    public function filterBySpyAvailabilityAbstract($spyAvailabilityAbstract, $comparison = null)
    {
     ...
     * @return $this|ChildSpyAvailabilityQuery The current query, for fluid interface
     */
    public function joinSpyAvailabilityAbstract($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        return $this->useExistsQuery('SpyAvailabilityAbstract', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyAvailabilityAbstract', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
