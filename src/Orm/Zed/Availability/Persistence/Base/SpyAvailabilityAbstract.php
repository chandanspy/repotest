...
abstract class SpyAvailabilityAbstract implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Availability\\Persistence\\Map\\SpyAvailabilityAbstractTableMap';
     ...
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailabilityAbstract The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailabilityAbstract
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailabilityAbstract The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyAvailabilities($v = true)
    {
     ...
     * @return void
     */
    public function initSpyAvailabilities($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyAvailabilityAbstract The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyAvailabilities(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyAvailabilitiesPartial && !$this->isNew();
        if (null === $this->collSpyAvailabilities || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyAvailability(ChildSpyAvailability $spyAvailability)
    {
