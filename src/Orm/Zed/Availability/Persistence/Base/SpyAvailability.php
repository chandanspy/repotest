...
abstract class SpyAvailability implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Availability\\Persistence\\Map\\SpyAvailabilityTableMap';
     ...
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailability The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailability
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Availability\Persistence\SpyAvailability The current object, for fluid interface
     */
