...
class SpyAvailabilityAbstractTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Availability.Persistence.Map.SpyAvailabilityAbstractTableMap';
     ...
     */
    const TABLE_NAME = 'spy_availability_abstract';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Availability\\Persistence\\SpyAvailabilityAbstract';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Availability.Persistence.SpyAvailabilityAbstract';
     ...
     */
    const COL_ID_AVAILABILITY_ABSTRACT = 'spy_availability_abstract.id_availability_abstract';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_availability_abstract.fk_store';

    /**
     * the column name for the abstract_sku field
     */
    const COL_ABSTRACT_SKU = 'spy_availability_abstract.abstract_sku';

    /**
     * the column name for the quantity field
     */
    const COL_QUANTITY = 'spy_availability_abstract.quantity';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAvailabilityAbstract', 'FkStore', 'AbstractSku', 'Quantity', ),
        self::TYPE_CAMELNAME     => array('idAvailabilityAbstract', 'fkStore', 'abstractSku', 'quantity', ),
        self::TYPE_COLNAME       => array(SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT, SpyAvailabilityAbstractTableMap::COL_FK_STORE, SpyAvailabilityAbstractTableMap::COL_ABSTRACT_SKU, SpyAvailabilityAbstractTableMap::COL_QUANTITY, ),
        self::TYPE_FIELDNAME     => array('id_availability_abstract', 'fk_store', 'abstract_sku', 'quantity', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAvailabilityAbstract' => 0, 'FkStore' => 1, 'AbstractSku' => 2, 'Quantity' => 3, ),
        self::TYPE_CAMELNAME     => array('idAvailabilityAbstract' => 0, 'fkStore' => 1, 'abstractSku' => 2, 'quantity' => 3, ),
        self::TYPE_COLNAME       => array(SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT => 0, SpyAvailabilityAbstractTableMap::COL_FK_STORE => 1, SpyAvailabilityAbstractTableMap::COL_ABSTRACT_SKU => 2, SpyAvailabilityAbstractTableMap::COL_QUANTITY => 3, ),
        self::TYPE_FIELDNAME     => array('id_availability_abstract' => 0, 'fk_store' => 1, 'abstract_sku' => 2, 'quantity' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
...
} // SpyAvailabilityAbstractTableMap
