...
class SpyAvailabilityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Availability.Persistence.Map.SpyAvailabilityTableMap';
     ...
     */
    const TABLE_NAME = 'spy_availability';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Availability\\Persistence\\SpyAvailability';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Availability.Persistence.SpyAvailability';
     ...
     */
    const COL_ID_AVAILABILITY = 'spy_availability.id_availability';

    /**
     * the column name for the fk_availability_abstract field
     */
    const COL_FK_AVAILABILITY_ABSTRACT = 'spy_availability.fk_availability_abstract';

    /**
     * the column name for the fk_store field
     */
    const COL_FK_STORE = 'spy_availability.fk_store';

    /**
     * the column name for the is_never_out_of_stock field
     */
    const COL_IS_NEVER_OUT_OF_STOCK = 'spy_availability.is_never_out_of_stock';

    /**
     * the column name for the quantity field
     */
    const COL_QUANTITY = 'spy_availability.quantity';

    /**
     * the column name for the sku field
     */
    const COL_SKU = 'spy_availability.sku';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdAvailability', 'FkAvailabilityAbstract', 'FkStore', 'IsNeverOutOfStock', 'Quantity', 'Sku', ),
        self::TYPE_CAMELNAME     => array('idAvailability', 'fkAvailabilityAbstract', 'fkStore', 'isNeverOutOfStock', 'quantity', 'sku', ),
        self::TYPE_COLNAME       => array(SpyAvailabilityTableMap::COL_ID_AVAILABILITY, SpyAvailabilityTableMap::COL_FK_AVAILABILITY_ABSTRACT, SpyAvailabilityTableMap::COL_FK_STORE, SpyAvailabilityTableMap::COL_IS_NEVER_OUT_OF_STOCK, SpyAvailabilityTableMap::COL_QUANTITY, SpyAvailabilityTableMap::COL_SKU, ),
        self::TYPE_FIELDNAME     => array('id_availability', 'fk_availability_abstract', 'fk_store', 'is_never_out_of_stock', 'quantity', 'sku', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdAvailability' => 0, 'FkAvailabilityAbstract' => 1, 'FkStore' => 2, 'IsNeverOutOfStock' => 3, 'Quantity' => 4, 'Sku' => 5, ),
        self::TYPE_CAMELNAME     => array('idAvailability' => 0, 'fkAvailabilityAbstract' => 1, 'fkStore' => 2, 'isNeverOutOfStock' => 3, 'quantity' => 4, 'sku' => 5, ),
        self::TYPE_COLNAME       => array(SpyAvailabilityTableMap::COL_ID_AVAILABILITY => 0, SpyAvailabilityTableMap::COL_FK_AVAILABILITY_ABSTRACT => 1, SpyAvailabilityTableMap::COL_FK_STORE => 2, SpyAvailabilityTableMap::COL_IS_NEVER_OUT_OF_STOCK => 3, SpyAvailabilityTableMap::COL_QUANTITY => 4, SpyAvailabilityTableMap::COL_SKU => 5, ),
        self::TYPE_FIELDNAME     => array('id_availability' => 0, 'fk_availability_abstract' => 1, 'fk_store' => 2, 'is_never_out_of_stock' => 3, 'quantity' => 4, 'sku' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
