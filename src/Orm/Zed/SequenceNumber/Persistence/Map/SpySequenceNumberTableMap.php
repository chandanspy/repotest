...
class SpySequenceNumberTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.SequenceNumber.Persistence.Map.SpySequenceNumberTableMap';
     ...
     */
    const TABLE_NAME = 'spy_sequence_number';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\SequenceNumber\\Persistence\\SpySequenceNumber';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.SequenceNumber.Persistence.SpySequenceNumber';
     ...
     */
    const COL_ID_SEQUENCE_NUMBER = 'spy_sequence_number.id_sequence_number';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_sequence_number.name';

    /**
     * the column name for the current_id field
     */
    const COL_CURRENT_ID = 'spy_sequence_number.current_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdSequenceNumber', 'Name', 'CurrentId', ),
        self::TYPE_CAMELNAME     => array('idSequenceNumber', 'name', 'currentId', ),
        self::TYPE_COLNAME       => array(SpySequenceNumberTableMap::COL_ID_SEQUENCE_NUMBER, SpySequenceNumberTableMap::COL_NAME, SpySequenceNumberTableMap::COL_CURRENT_ID, ),
        self::TYPE_FIELDNAME     => array('id_sequence_number', 'name', 'current_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdSequenceNumber' => 0, 'Name' => 1, 'CurrentId' => 2, ),
        self::TYPE_CAMELNAME     => array('idSequenceNumber' => 0, 'name' => 1, 'currentId' => 2, ),
        self::TYPE_COLNAME       => array(SpySequenceNumberTableMap::COL_ID_SEQUENCE_NUMBER => 0, SpySequenceNumberTableMap::COL_NAME => 1, SpySequenceNumberTableMap::COL_CURRENT_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id_sequence_number' => 0, 'name' => 1, 'current_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPackage('src.Orm.Zed.SequenceNumber.Persistence');
