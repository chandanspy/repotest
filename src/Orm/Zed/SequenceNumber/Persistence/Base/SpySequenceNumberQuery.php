 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySequenceNumber> find(ConnectionInterface $con = null) Return ChildSpySequenceNumber objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySequenceNumber> findByIdSequenceNumber(int $id_sequence_number) Return ChildSpySequenceNumber objects filtered by the id_sequence_number column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySequenceNumber> findByName(string $name) Return ChildSpySequenceNumber objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpySequenceNumber> findByCurrentId(int $current_id) Return ChildSpySequenceNumber objects filtered by the current_id column
