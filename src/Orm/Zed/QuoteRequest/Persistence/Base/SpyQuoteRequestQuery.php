 ...
 *
 * @method     ChildSpyQuoteRequest[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuoteRequest objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> find(ConnectionInterface $con = null) Return ChildSpyQuoteRequest objects based on current ModelCriteria
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByIdQuoteRequest(int $id_quote_request) Return ChildSpyQuoteRequest objects filtered by the id_quote_request column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByIdQuoteRequest(int $id_quote_request) Return ChildSpyQuoteRequest objects filtered by the id_quote_request column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteRequest objects filtered by the fk_company_user column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByFkCompanyUser(int $fk_company_user) Return ChildSpyQuoteRequest objects filtered by the fk_company_user column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByQuoteRequestReference(string $quote_request_reference) Return ChildSpyQuoteRequest objects filtered by the quote_request_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByQuoteRequestReference(string $quote_request_reference) Return ChildSpyQuoteRequest objects filtered by the quote_request_reference column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByValidUntil(string $valid_until) Return ChildSpyQuoteRequest objects filtered by the valid_until column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByValidUntil(string $valid_until) Return ChildSpyQuoteRequest objects filtered by the valid_until column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByStatus(string $status) Return ChildSpyQuoteRequest objects filtered by the status column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByStatus(string $status) Return ChildSpyQuoteRequest objects filtered by the status column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByIsLatestVersionVisible(boolean $is_latest_version_visible) Return ChildSpyQuoteRequest objects filtered by the is_latest_version_visible column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByIsLatestVersionVisible(boolean $is_latest_version_visible) Return ChildSpyQuoteRequest objects filtered by the is_latest_version_visible column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByUuid(string $uuid) Return ChildSpyQuoteRequest objects filtered by the uuid column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByUuid(string $uuid) Return ChildSpyQuoteRequest objects filtered by the uuid column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyQuoteRequest objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByCreatedAt(string $created_at) Return ChildSpyQuoteRequest objects filtered by the created_at column
 * @method     ChildSpyQuoteRequest[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyQuoteRequest objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequest> findByUpdatedAt(string $updated_at) Return ChildSpyQuoteRequest objects filtered by the updated_at column
...
abstract class SpyQuoteRequestQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuoteRequestQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuoteRequestTableMap::COL_ID_QUOTE_REQUEST, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuoteRequestTableMap::COL_ID_QUOTE_REQUEST, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuoteRequestQuery The current query, for fluid interface
     */
     ...
     * @return ChildSpyQuoteRequestQuery The current query, for fluid interface
     */
    public function filterBySpyQuoteRequestVersion($spyQuoteRequestVersion, $comparison = null)
    {
     ...
     * @return $this|ChildSpyQuoteRequestQuery The current query, for fluid interface
     */
    public function joinSpyQuoteRequestVersion($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('SpyQuoteRequestVersion', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('SpyQuoteRequestVersion', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
    ...
    {
        return $this->addUsingAlias(SpyQuoteRequestTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteRequestTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteRequestTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteRequestTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyQuoteRequestTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteRequestTableMap::COL_CREATED_AT);
    }
