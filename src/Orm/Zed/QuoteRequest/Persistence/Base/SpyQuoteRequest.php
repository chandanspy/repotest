...
abstract class SpyQuoteRequest implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\QuoteRequest\\Persistence\\Map\\SpyQuoteRequestTableMap';
     ...
     * @return $this|\Orm\Zed\QuoteRequest\Persistence\SpyQuoteRequest The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\QuoteRequest\Persistence\SpyQuoteRequest
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\QuoteRequest\Persistence\SpyQuoteRequest The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyQuoteRequestVersions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyQuoteRequestVersions($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyQuoteRequest The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyQuoteRequestVersions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyQuoteRequestVersionsPartial && !$this->isNew();
        if (null === $this->collSpyQuoteRequestVersions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyQuoteRequestVersion(ChildSpyQuoteRequestVersion $spyQuoteRequestVersion)
    {
