 ...
 *
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyQuoteRequestVersion objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> find(ConnectionInterface $con = null) Return ChildSpyQuoteRequestVersion objects based on current ModelCriteria
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByIdQuoteRequestVersion(int $id_quote_request_version) Return ChildSpyQuoteRequestVersion objects filtered by the id_quote_request_version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByIdQuoteRequestVersion(int $id_quote_request_version) Return ChildSpyQuoteRequestVersion objects filtered by the id_quote_request_version column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByFkQuoteRequest(int $fk_quote_request) Return ChildSpyQuoteRequestVersion objects filtered by the fk_quote_request column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByFkQuoteRequest(int $fk_quote_request) Return ChildSpyQuoteRequestVersion objects filtered by the fk_quote_request column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByVersion(int $version) Return ChildSpyQuoteRequestVersion objects filtered by the version column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByVersion(int $version) Return ChildSpyQuoteRequestVersion objects filtered by the version column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByVersionReference(string $version_reference) Return ChildSpyQuoteRequestVersion objects filtered by the version_reference column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByVersionReference(string $version_reference) Return ChildSpyQuoteRequestVersion objects filtered by the version_reference column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByMetadata(string $metadata) Return ChildSpyQuoteRequestVersion objects filtered by the metadata column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByMetadata(string $metadata) Return ChildSpyQuoteRequestVersion objects filtered by the metadata column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByQuote(string $quote) Return ChildSpyQuoteRequestVersion objects filtered by the quote column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByQuote(string $quote) Return ChildSpyQuoteRequestVersion objects filtered by the quote column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyQuoteRequestVersion objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByCreatedAt(string $created_at) Return ChildSpyQuoteRequestVersion objects filtered by the created_at column
 * @method     ChildSpyQuoteRequestVersion[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyQuoteRequestVersion objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyQuoteRequestVersion> findByUpdatedAt(string $updated_at) Return ChildSpyQuoteRequestVersion objects filtered by the updated_at column
...
abstract class SpyQuoteRequestVersionQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyQuoteRequestVersionQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyQuoteRequestVersionTableMap::COL_ID_QUOTE_REQUEST_VERSION, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyQuoteRequestVersionTableMap::COL_ID_QUOTE_REQUEST_VERSION, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyQuoteRequestVersionQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyQuoteRequestVersionTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteRequestVersionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteRequestVersionTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyQuoteRequestVersionTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyQuoteRequestVersionTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyQuoteRequestVersionTableMap::COL_CREATED_AT);
    }

} // SpyQuoteRequestVersionQuery
