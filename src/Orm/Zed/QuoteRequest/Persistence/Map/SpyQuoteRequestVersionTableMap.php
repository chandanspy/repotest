...
class SpyQuoteRequestVersionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.QuoteRequest.Persistence.Map.SpyQuoteRequestVersionTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_request_version';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\QuoteRequest\\Persistence\\SpyQuoteRequestVersion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.QuoteRequest.Persistence.SpyQuoteRequestVersion';
     ...
     */
    const COL_ID_QUOTE_REQUEST_VERSION = 'spy_quote_request_version.id_quote_request_version';

    /**
     * the column name for the fk_quote_request field
     */
    const COL_FK_QUOTE_REQUEST = 'spy_quote_request_version.fk_quote_request';

    /**
     * the column name for the version field
     */
    const COL_VERSION = 'spy_quote_request_version.version';

    /**
     * the column name for the version_reference field
     */
    const COL_VERSION_REFERENCE = 'spy_quote_request_version.version_reference';

    /**
     * the column name for the metadata field
     */
    const COL_METADATA = 'spy_quote_request_version.metadata';

    /**
     * the column name for the quote field
     */
    const COL_QUOTE = 'spy_quote_request_version.quote';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_quote_request_version.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_quote_request_version.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuoteRequestVersion', 'FkQuoteRequest', 'Version', 'VersionReference', 'Metadata', 'Quote', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idQuoteRequestVersion', 'fkQuoteRequest', 'version', 'versionReference', 'metadata', 'quote', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyQuoteRequestVersionTableMap::COL_ID_QUOTE_REQUEST_VERSION, SpyQuoteRequestVersionTableMap::COL_FK_QUOTE_REQUEST, SpyQuoteRequestVersionTableMap::COL_VERSION, SpyQuoteRequestVersionTableMap::COL_VERSION_REFERENCE, SpyQuoteRequestVersionTableMap::COL_METADATA, SpyQuoteRequestVersionTableMap::COL_QUOTE, SpyQuoteRequestVersionTableMap::COL_CREATED_AT, SpyQuoteRequestVersionTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_quote_request_version', 'fk_quote_request', 'version', 'version_reference', 'metadata', 'quote', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuoteRequestVersion' => 0, 'FkQuoteRequest' => 1, 'Version' => 2, 'VersionReference' => 3, 'Metadata' => 4, 'Quote' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('idQuoteRequestVersion' => 0, 'fkQuoteRequest' => 1, 'version' => 2, 'versionReference' => 3, 'metadata' => 4, 'quote' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(SpyQuoteRequestVersionTableMap::COL_ID_QUOTE_REQUEST_VERSION => 0, SpyQuoteRequestVersionTableMap::COL_FK_QUOTE_REQUEST => 1, SpyQuoteRequestVersionTableMap::COL_VERSION => 2, SpyQuoteRequestVersionTableMap::COL_VERSION_REFERENCE => 3, SpyQuoteRequestVersionTableMap::COL_METADATA => 4, SpyQuoteRequestVersionTableMap::COL_QUOTE => 5, SpyQuoteRequestVersionTableMap::COL_CREATED_AT => 6, SpyQuoteRequestVersionTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id_quote_request_version' => 0, 'fk_quote_request' => 1, 'version' => 2, 'version_reference' => 3, 'metadata' => 4, 'quote' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
