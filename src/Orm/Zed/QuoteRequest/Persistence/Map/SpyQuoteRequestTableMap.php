...
class SpyQuoteRequestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.QuoteRequest.Persistence.Map.SpyQuoteRequestTableMap';
     ...
     */
    const TABLE_NAME = 'spy_quote_request';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\QuoteRequest\\Persistence\\SpyQuoteRequest';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.QuoteRequest.Persistence.SpyQuoteRequest';
     ...
     */
    const COL_ID_QUOTE_REQUEST = 'spy_quote_request.id_quote_request';

    /**
     * the column name for the fk_company_user field
     */
    const COL_FK_COMPANY_USER = 'spy_quote_request.fk_company_user';

    /**
     * the column name for the quote_request_reference field
     */
    const COL_QUOTE_REQUEST_REFERENCE = 'spy_quote_request.quote_request_reference';

    /**
     * the column name for the valid_until field
     */
    const COL_VALID_UNTIL = 'spy_quote_request.valid_until';

    /**
     * the column name for the status field
     */
    const COL_STATUS = 'spy_quote_request.status';

    /**
     * the column name for the is_latest_version_visible field
     */
    const COL_IS_LATEST_VERSION_VISIBLE = 'spy_quote_request.is_latest_version_visible';

    /**
     * the column name for the uuid field
     */
    const COL_UUID = 'spy_quote_request.uuid';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_quote_request.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_quote_request.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQuoteRequest', 'FkCompanyUser', 'QuoteRequestReference', 'ValidUntil', 'Status', 'IsLatestVersionVisible', 'Uuid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idQuoteRequest', 'fkCompanyUser', 'quoteRequestReference', 'validUntil', 'status', 'isLatestVersionVisible', 'uuid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyQuoteRequestTableMap::COL_ID_QUOTE_REQUEST, SpyQuoteRequestTableMap::COL_FK_COMPANY_USER, SpyQuoteRequestTableMap::COL_QUOTE_REQUEST_REFERENCE, SpyQuoteRequestTableMap::COL_VALID_UNTIL, SpyQuoteRequestTableMap::COL_STATUS, SpyQuoteRequestTableMap::COL_IS_LATEST_VERSION_VISIBLE, SpyQuoteRequestTableMap::COL_UUID, SpyQuoteRequestTableMap::COL_CREATED_AT, SpyQuoteRequestTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_quote_request', 'fk_company_user', 'quote_request_reference', 'valid_until', 'status', 'is_latest_version_visible', 'uuid', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQuoteRequest' => 0, 'FkCompanyUser' => 1, 'QuoteRequestReference' => 2, 'ValidUntil' => 3, 'Status' => 4, 'IsLatestVersionVisible' => 5, 'Uuid' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idQuoteRequest' => 0, 'fkCompanyUser' => 1, 'quoteRequestReference' => 2, 'validUntil' => 3, 'status' => 4, 'isLatestVersionVisible' => 5, 'uuid' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(SpyQuoteRequestTableMap::COL_ID_QUOTE_REQUEST => 0, SpyQuoteRequestTableMap::COL_FK_COMPANY_USER => 1, SpyQuoteRequestTableMap::COL_QUOTE_REQUEST_REFERENCE => 2, SpyQuoteRequestTableMap::COL_VALID_UNTIL => 3, SpyQuoteRequestTableMap::COL_STATUS => 4, SpyQuoteRequestTableMap::COL_IS_LATEST_VERSION_VISIBLE => 5, SpyQuoteRequestTableMap::COL_UUID => 6, SpyQuoteRequestTableMap::COL_CREATED_AT => 7, SpyQuoteRequestTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id_quote_request' => 0, 'fk_company_user' => 1, 'quote_request_reference' => 2, 'valid_until' => 3, 'status' => 4, 'is_latest_version_visible' => 5, 'uuid' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
