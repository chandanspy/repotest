...
class SpyDiscountVoucherPoolTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Discount.Persistence.Map.SpyDiscountVoucherPoolTableMap';
     ...
     */
    const TABLE_NAME = 'spy_discount_voucher_pool';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Discount\\Persistence\\SpyDiscountVoucherPool';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Discount.Persistence.SpyDiscountVoucherPool';
     ...
     */
    const COL_ID_DISCOUNT_VOUCHER_POOL = 'spy_discount_voucher_pool.id_discount_voucher_pool';

    /**
     * the column name for the is_active field
     */
    const COL_IS_ACTIVE = 'spy_discount_voucher_pool.is_active';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'spy_discount_voucher_pool.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_discount_voucher_pool.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_discount_voucher_pool.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDiscountVoucherPool', 'IsActive', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idDiscountVoucherPool', 'isActive', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyDiscountVoucherPoolTableMap::COL_ID_DISCOUNT_VOUCHER_POOL, SpyDiscountVoucherPoolTableMap::COL_IS_ACTIVE, SpyDiscountVoucherPoolTableMap::COL_NAME, SpyDiscountVoucherPoolTableMap::COL_CREATED_AT, SpyDiscountVoucherPoolTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_discount_voucher_pool', 'is_active', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdDiscountVoucherPool' => 0, 'IsActive' => 1, 'Name' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idDiscountVoucherPool' => 0, 'isActive' => 1, 'name' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyDiscountVoucherPoolTableMap::COL_ID_DISCOUNT_VOUCHER_POOL => 0, SpyDiscountVoucherPoolTableMap::COL_IS_ACTIVE => 1, SpyDiscountVoucherPoolTableMap::COL_NAME => 2, SpyDiscountVoucherPoolTableMap::COL_CREATED_AT => 3, SpyDiscountVoucherPoolTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_discount_voucher_pool' => 0, 'is_active' => 1, 'name' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyDiscountVoucherPoolTableMap
