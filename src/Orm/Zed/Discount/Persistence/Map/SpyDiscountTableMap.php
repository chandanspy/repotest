...
class SpyDiscountTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Discount.Persistence.Map.SpyDiscountTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Discount\\Persistence\\SpyDiscount';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Discount.Persistence.SpyDiscount';
     ...
     */
    const COL_FK_STORE = 'spy_discount.fk_store';
     ...
     */
    const COL_COLLECTOR_QUERY_STRING = 'spy_discount.collector_query_string';

    /**
     * the column name for the decision_rule_query_string field
     */
    const COL_DECISION_RULE_QUERY_STRING = 'spy_discount.decision_rule_query_string';
     ...
     */
    const COL_DISCOUNT_KEY = 'spy_discount.discount_key';

    /**
     * the column name for the discount_type field
     */
    const COL_DISCOUNT_TYPE = 'spy_discount.discount_type';
     ...
     */
    const COL_IS_EXCLUSIVE = 'spy_discount.is_exclusive';

    /**
     * the column name for the minimum_item_amount field
     */
    const COL_MINIMUM_ITEM_AMOUNT = 'spy_discount.minimum_item_amount';

    /**
     * the column name for the priority field
     */
    const COL_PRIORITY = 'spy_discount.priority';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDiscount', 'FkDiscountVoucherPool', 'FkStore', 'Amount', 'CalculatorPlugin', 'CollectorQueryString', 'DecisionRuleQueryString', 'Description', 'DiscountKey', 'DiscountType', 'DisplayName', 'IsActive', 'IsExclusive', 'MinimumItemAmount', 'Priority', 'ValidFrom', 'ValidTo', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idDiscount', 'fkDiscountVoucherPool', 'fkStore', 'amount', 'calculatorPlugin', 'collectorQueryString', 'decisionRuleQueryString', 'description', 'discountKey', 'discountType', 'displayName', 'isActive', 'isExclusive', 'minimumItemAmount', 'priority', 'validFrom', 'validTo', 'createdAt', 'updatedAt', ),
        ...
        self::TYPE_FIELDNAME     => array('id_discount', 'fk_discount_voucher_pool', 'fk_store', 'amount', 'calculator_plugin', 'collector_query_string', 'decision_rule_query_string', 'description', 'discount_key', 'discount_type', 'display_name', 'is_active', 'is_exclusive', 'minimum_item_amount', 'priority', 'valid_from', 'valid_to', 'created_at', 'updated_at', ),
