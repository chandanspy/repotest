...
class SpyDiscountVoucherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Discount.Persistence.Map.SpyDiscountVoucherTableMap';
     ...
     */
    const OM_CLASS = '\\Orm\\Zed\\Discount\\Persistence\\SpyDiscountVoucher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Discount.Persistence.SpyDiscountVoucher';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDiscountVoucher', 'FkDiscountVoucherPool', 'Code', 'IsActive', 'MaxNumberOfUses', 'NumberOfUses', 'VoucherBatch', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idDiscountVoucher', 'fkDiscountVoucherPool', 'code', 'isActive', 'maxNumberOfUses', 'numberOfUses', 'voucherBatch', 'createdAt', 'updatedAt', ),
        ...
        self::TYPE_FIELDNAME     => array('id_discount_voucher', 'fk_discount_voucher_pool', 'code', 'is_active', 'max_number_of_uses', 'number_of_uses', 'voucher_batch', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdDiscountVoucher' => 0, 'FkDiscountVoucherPool' => 1, 'Code' => 2, 'IsActive' => 3, 'MaxNumberOfUses' => 4, 'NumberOfUses' => 5, 'VoucherBatch' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('idDiscountVoucher' => 0, 'fkDiscountVoucherPool' => 1, 'code' => 2, 'isActive' => 3, 'maxNumberOfUses' => 4, 'numberOfUses' => 5, 'voucherBatch' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        ...
        self::TYPE_FIELDNAME     => array('id_discount_voucher' => 0, 'fk_discount_voucher_pool' => 1, 'code' => 2, 'is_active' => 3, 'max_number_of_uses' => 4, 'number_of_uses' => 5, 'voucher_batch' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
