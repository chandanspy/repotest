...
class SpyDiscountAmountTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.Discount.Persistence.Map.SpyDiscountAmountTableMap';
     ...
     */
    const TABLE_NAME = 'spy_discount_amount';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Discount\\Persistence\\SpyDiscountAmount';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.Discount.Persistence.SpyDiscountAmount';
     ...
     */
    const COL_ID_DISCOUNT_AMOUNT = 'spy_discount_amount.id_discount_amount';

    /**
     * the column name for the fk_currency field
     */
    const COL_FK_CURRENCY = 'spy_discount_amount.fk_currency';

    /**
     * the column name for the fk_discount field
     */
    const COL_FK_DISCOUNT = 'spy_discount_amount.fk_discount';

    /**
     * the column name for the gross_amount field
     */
    const COL_GROSS_AMOUNT = 'spy_discount_amount.gross_amount';

    /**
     * the column name for the net_amount field
     */
    const COL_NET_AMOUNT = 'spy_discount_amount.net_amount';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDiscountAmount', 'FkCurrency', 'FkDiscount', 'GrossAmount', 'NetAmount', ),
        self::TYPE_CAMELNAME     => array('idDiscountAmount', 'fkCurrency', 'fkDiscount', 'grossAmount', 'netAmount', ),
        self::TYPE_COLNAME       => array(SpyDiscountAmountTableMap::COL_ID_DISCOUNT_AMOUNT, SpyDiscountAmountTableMap::COL_FK_CURRENCY, SpyDiscountAmountTableMap::COL_FK_DISCOUNT, SpyDiscountAmountTableMap::COL_GROSS_AMOUNT, SpyDiscountAmountTableMap::COL_NET_AMOUNT, ),
        self::TYPE_FIELDNAME     => array('id_discount_amount', 'fk_currency', 'fk_discount', 'gross_amount', 'net_amount', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdDiscountAmount' => 0, 'FkCurrency' => 1, 'FkDiscount' => 2, 'GrossAmount' => 3, 'NetAmount' => 4, ),
        self::TYPE_CAMELNAME     => array('idDiscountAmount' => 0, 'fkCurrency' => 1, 'fkDiscount' => 2, 'grossAmount' => 3, 'netAmount' => 4, ),
        self::TYPE_COLNAME       => array(SpyDiscountAmountTableMap::COL_ID_DISCOUNT_AMOUNT => 0, SpyDiscountAmountTableMap::COL_FK_CURRENCY => 1, SpyDiscountAmountTableMap::COL_FK_DISCOUNT => 2, SpyDiscountAmountTableMap::COL_GROSS_AMOUNT => 3, SpyDiscountAmountTableMap::COL_NET_AMOUNT => 4, ),
        self::TYPE_FIELDNAME     => array('id_discount_amount' => 0, 'fk_currency' => 1, 'fk_discount' => 2, 'gross_amount' => 3, 'net_amount' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
