...
abstract class SpyDiscountVoucherPool implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Discount\\Persistence\\Map\\SpyDiscountVoucherPoolTableMap';
     ...
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucherPool The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucherPool
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucherPool The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyDiscountVoucherPool The current object (for fluent API support)
     */
     ...
     */
    protected function doAddDiscount(ChildSpyDiscount $discount)
    {
     ...
     */
    public function resetPartialDiscountVouchers($v = true)
    {
     ...
     * @return void
     */
    public function initDiscountVouchers($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countDiscountVouchers(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collDiscountVouchersPartial && !$this->isNew();
        if (null === $this->collDiscountVouchers || null !== $criteria || $partial) {
     ...
     */
    protected function doAddDiscountVoucher(ChildSpyDiscountVoucher $discountVoucher)
    {
