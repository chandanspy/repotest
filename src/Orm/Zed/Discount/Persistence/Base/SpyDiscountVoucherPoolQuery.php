 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> find(ConnectionInterface $con = null) Return ChildSpyDiscountVoucherPool objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> findByIdDiscountVoucherPool(int $id_discount_voucher_pool) Return ChildSpyDiscountVoucherPool objects filtered by the id_discount_voucher_pool column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> findByIsActive(boolean $is_active) Return ChildSpyDiscountVoucherPool objects filtered by the is_active column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> findByName(string $name) Return ChildSpyDiscountVoucherPool objects filtered by the name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> findByCreatedAt(string $created_at) Return ChildSpyDiscountVoucherPool objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucherPool> findByUpdatedAt(string $updated_at) Return ChildSpyDiscountVoucherPool objects filtered by the updated_at column
...
abstract class SpyDiscountVoucherPoolQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('DiscountVoucher', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('DiscountVoucher', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
