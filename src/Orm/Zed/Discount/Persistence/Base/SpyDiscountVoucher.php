 ...
 */
abstract class SpyDiscountVoucher implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Discount\\Persistence\\Map\\SpyDiscountVoucherTableMap';
    ...
    /**
     * Initializes internal state of Orm\Zed\Discount\Persistence\Base\SpyDiscountVoucher object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucher The current object (for fluent API support)
     */
    public function setIdDiscountVoucher($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_discount_voucher !== $v) {
    ...
    public function setMaxNumberOfUses($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->max_number_of_uses !== $v) {
    ...
    public function setNumberOfUses($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->number_of_uses !== $v) {
    ...
    public function setVoucherBatch($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->voucher_batch !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyDiscountVoucherTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyDiscountVoucherTableMap::translateFieldName('NumberOfUses', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\Discount\\Persistence\\SpyDiscountVoucher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucher
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setNumberOfUses($arr[$keys[5]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountVoucher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Orm\Zed\Discount\Persistence\SpyDiscountVoucher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\Discount\Persistence\SpyDiscountVoucher Clone of current object.
     * @throws PropelException
     */
