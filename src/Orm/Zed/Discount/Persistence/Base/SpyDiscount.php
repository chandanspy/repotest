...
abstract class SpyDiscount implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Discount\\Persistence\\Map\\SpyDiscountTableMap';
     ...
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscount The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscount
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscount The current object, for fluid interface
     */
     ...
     */
    protected function doAddSpyDiscountStore(ChildSpyDiscountStore $spyDiscountStore)
    {
     ...
     */
    protected function doAddDiscountAmount(ChildSpyDiscountAmount $discountAmount)
    {
     ...
     */
    public function resetPartialDiscountPromotions($v = true)
    {
     ...
     * @return void
     */
    public function initDiscountPromotions($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countDiscountPromotions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collDiscountPromotionsPartial && !$this->isNew();
        if (null === $this->collDiscountPromotions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddDiscountPromotion(SpyDiscountPromotion $discountPromotion)
    {
