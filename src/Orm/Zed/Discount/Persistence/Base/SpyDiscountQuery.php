 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> find(ConnectionInterface $con = null) Return ChildSpyDiscount objects based on current ModelCriteria
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByIdDiscount(int $id_discount) Return ChildSpyDiscount objects filtered by the id_discount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByFkDiscountVoucherPool(int $fk_discount_voucher_pool) Return ChildSpyDiscount objects filtered by the fk_discount_voucher_pool column
 * @method     ChildSpyDiscount[]|ObjectCollection findByFkStore(int $fk_store) Return ChildSpyDiscount objects filtered by the fk_store column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByFkStore(int $fk_store) Return ChildSpyDiscount objects filtered by the fk_store column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByAmount(int $amount) Return ChildSpyDiscount objects filtered by the amount column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByCalculatorPlugin(string $calculator_plugin) Return ChildSpyDiscount objects filtered by the calculator_plugin column
 * @method     ChildSpyDiscount[]|ObjectCollection findByCollectorQueryString(string $collector_query_string) Return ChildSpyDiscount objects filtered by the collector_query_string column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByCollectorQueryString(string $collector_query_string) Return ChildSpyDiscount objects filtered by the collector_query_string column
 * @method     ChildSpyDiscount[]|ObjectCollection findByDecisionRuleQueryString(string $decision_rule_query_string) Return ChildSpyDiscount objects filtered by the decision_rule_query_string column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByDecisionRuleQueryString(string $decision_rule_query_string) Return ChildSpyDiscount objects filtered by the decision_rule_query_string column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByDescription(string $description) Return ChildSpyDiscount objects filtered by the description column
 * @method     ChildSpyDiscount[]|ObjectCollection findByDiscountKey(string $discount_key) Return ChildSpyDiscount objects filtered by the discount_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByDiscountKey(string $discount_key) Return ChildSpyDiscount objects filtered by the discount_key column
 * @method     ChildSpyDiscount[]|ObjectCollection findByDiscountType(string $discount_type) Return ChildSpyDiscount objects filtered by the discount_type column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByDiscountType(string $discount_type) Return ChildSpyDiscount objects filtered by the discount_type column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByDisplayName(string $display_name) Return ChildSpyDiscount objects filtered by the display_name column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByIsActive(boolean $is_active) Return ChildSpyDiscount objects filtered by the is_active column
 * @method     ChildSpyDiscount[]|ObjectCollection findByIsExclusive(boolean $is_exclusive) Return ChildSpyDiscount objects filtered by the is_exclusive column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByIsExclusive(boolean $is_exclusive) Return ChildSpyDiscount objects filtered by the is_exclusive column
 * @method     ChildSpyDiscount[]|ObjectCollection findByMinimumItemAmount(int $minimum_item_amount) Return ChildSpyDiscount objects filtered by the minimum_item_amount column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByMinimumItemAmount(int $minimum_item_amount) Return ChildSpyDiscount objects filtered by the minimum_item_amount column
 * @method     ChildSpyDiscount[]|ObjectCollection findByPriority(int $priority) Return ChildSpyDiscount objects filtered by the priority column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByPriority(int $priority) Return ChildSpyDiscount objects filtered by the priority column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByValidFrom(string $valid_from) Return ChildSpyDiscount objects filtered by the valid_from column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByValidTo(string $valid_to) Return ChildSpyDiscount objects filtered by the valid_to column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByCreatedAt(string $created_at) Return ChildSpyDiscount objects filtered by the created_at column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscount> findByUpdatedAt(string $updated_at) Return ChildSpyDiscount objects filtered by the updated_at column
...
abstract class SpyDiscountQuery extends ModelCriteria
{
    ...
    {
        return $this->useExistsQuery('VoucherPool', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('VoucherPool', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
     ...
     * @return ChildSpyDiscountQuery The current query, for fluid interface
     */
    public function filterByDiscountPromotion($spyDiscountPromotion, $comparison = null)
    {
     ...
     * @return $this|ChildSpyDiscountQuery The current query, for fluid interface
     */
    public function joinDiscountPromotion($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        return $this->useExistsQuery('DiscountPromotion', $modelAlias, $queryClass, $typeOfExists);
    }
    ...
    {
        return $this->useExistsQuery('DiscountPromotion', $modelAlias, $queryClass, 'NOT EXISTS');
    }
    /**
