 ...
 *
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyDiscountVoucher objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> find(ConnectionInterface $con = null) Return ChildSpyDiscountVoucher objects based on current ModelCriteria
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByIdDiscountVoucher(int $id_discount_voucher) Return ChildSpyDiscountVoucher objects filtered by the id_discount_voucher column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByIdDiscountVoucher(int $id_discount_voucher) Return ChildSpyDiscountVoucher objects filtered by the id_discount_voucher column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByFkDiscountVoucherPool(int $fk_discount_voucher_pool) Return ChildSpyDiscountVoucher objects filtered by the fk_discount_voucher_pool column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByFkDiscountVoucherPool(int $fk_discount_voucher_pool) Return ChildSpyDiscountVoucher objects filtered by the fk_discount_voucher_pool column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByCode(string $code) Return ChildSpyDiscountVoucher objects filtered by the code column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByCode(string $code) Return ChildSpyDiscountVoucher objects filtered by the code column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByIsActive(boolean $is_active) Return ChildSpyDiscountVoucher objects filtered by the is_active column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByIsActive(boolean $is_active) Return ChildSpyDiscountVoucher objects filtered by the is_active column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByMaxNumberOfUses(int $max_number_of_uses) Return ChildSpyDiscountVoucher objects filtered by the max_number_of_uses column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByMaxNumberOfUses(int $max_number_of_uses) Return ChildSpyDiscountVoucher objects filtered by the max_number_of_uses column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByNumberOfUses(int $number_of_uses) Return ChildSpyDiscountVoucher objects filtered by the number_of_uses column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByNumberOfUses(int $number_of_uses) Return ChildSpyDiscountVoucher objects filtered by the number_of_uses column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByVoucherBatch(int $voucher_batch) Return ChildSpyDiscountVoucher objects filtered by the voucher_batch column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByVoucherBatch(int $voucher_batch) Return ChildSpyDiscountVoucher objects filtered by the voucher_batch column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyDiscountVoucher objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByCreatedAt(string $created_at) Return ChildSpyDiscountVoucher objects filtered by the created_at column
 * @method     ChildSpyDiscountVoucher[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyDiscountVoucher objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyDiscountVoucher> findByUpdatedAt(string $updated_at) Return ChildSpyDiscountVoucher objects filtered by the updated_at column
...
abstract class SpyDiscountVoucherQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_ID_DISCOUNT_VOUCHER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_ID_DISCOUNT_VOUCHER, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyDiscountVoucherTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyDiscountVoucherTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyDiscountVoucherTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyDiscountVoucherTableMap::COL_CREATED_AT);
    }
