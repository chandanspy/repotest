...
abstract class SpyDiscountAmount implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Discount\\Persistence\\Map\\SpyDiscountAmountTableMap';
     ...
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountAmount The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountAmount
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Discount\Persistence\SpyDiscountAmount The current object, for fluid interface
     */
