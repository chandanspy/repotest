 ...
 *
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheck objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> find(ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheck objects based on current ModelCriteria
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection findByIdPublishAndSynchronizeHealthCheck(int $id_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the id_publish_and_synchronize_health_check column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> findByIdPublishAndSynchronizeHealthCheck(int $id_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the id_publish_and_synchronize_health_check column
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection findByHealthCheckKey(string $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the health_check_key column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> findByHealthCheckKey(string $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the health_check_key column
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection findByHealthCheckData(string $health_check_data) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the health_check_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> findByHealthCheckData(string $health_check_data) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the health_check_data column
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> findByCreatedAt(string $created_at) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the created_at column
 * @method     ChildSpyPublishAndSynchronizeHealthCheck[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheck> findByUpdatedAt(string $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheck objects filtered by the updated_at column
...
abstract class SpyPublishAndSynchronizeHealthCheckQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyPublishAndSynchronizeHealthCheckQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK, $keys, Criteria::IN);
    }
    ...
    {
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckTableMap::COL_CREATED_AT);
    }
