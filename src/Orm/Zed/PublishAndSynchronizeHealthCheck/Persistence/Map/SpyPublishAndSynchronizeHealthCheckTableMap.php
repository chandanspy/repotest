...
class SpyPublishAndSynchronizeHealthCheckTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.PublishAndSynchronizeHealthCheck.Persistence.Map.SpyPublishAndSynchronizeHealthCheckTableMap';
     ...
     */
    const TABLE_NAME = 'spy_publish_and_synchronize_health_check';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\PublishAndSynchronizeHealthCheck\\Persistence\\SpyPublishAndSynchronizeHealthCheck';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.PublishAndSynchronizeHealthCheck.Persistence.SpyPublishAndSynchronizeHealthCheck';
     ...
     */
    const COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK = 'spy_publish_and_synchronize_health_check.id_publish_and_synchronize_health_check';

    /**
     * the column name for the health_check_key field
     */
    const COL_HEALTH_CHECK_KEY = 'spy_publish_and_synchronize_health_check.health_check_key';

    /**
     * the column name for the health_check_data field
     */
    const COL_HEALTH_CHECK_DATA = 'spy_publish_and_synchronize_health_check.health_check_data';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_publish_and_synchronize_health_check.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_publish_and_synchronize_health_check.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPublishAndSynchronizeHealthCheck', 'HealthCheckKey', 'HealthCheckData', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPublishAndSynchronizeHealthCheck', 'healthCheckKey', 'healthCheckData', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPublishAndSynchronizeHealthCheckTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK, SpyPublishAndSynchronizeHealthCheckTableMap::COL_HEALTH_CHECK_KEY, SpyPublishAndSynchronizeHealthCheckTableMap::COL_HEALTH_CHECK_DATA, SpyPublishAndSynchronizeHealthCheckTableMap::COL_CREATED_AT, SpyPublishAndSynchronizeHealthCheckTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_publish_and_synchronize_health_check', 'health_check_key', 'health_check_data', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPublishAndSynchronizeHealthCheck' => 0, 'HealthCheckKey' => 1, 'HealthCheckData' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idPublishAndSynchronizeHealthCheck' => 0, 'healthCheckKey' => 1, 'healthCheckData' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        ...
        self::TYPE_FIELDNAME     => array('id_publish_and_synchronize_health_check' => 0, 'health_check_key' => 1, 'health_check_data' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
...
} // SpyPublishAndSynchronizeHealthCheckTableMap
