...
abstract class SpyPermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Orm\\Zed\\Permission\\Persistence\\Map\\SpyPermissionTableMap';
     ...
     * @return $this|\Orm\Zed\Permission\Persistence\SpyPermission The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Orm\Zed\Permission\Persistence\SpyPermission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Orm\Zed\Permission\Persistence\SpyPermission The current object, for fluid interface
     */
     ...
     */
    public function resetPartialSpyCompanyRoleToPermissions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyCompanyRoleToPermissions($overrideExisting = true)
    {
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyPermission The current object (for fluent API support)
     */
     ...
     * @throws PropelException
     */
    public function countSpyCompanyRoleToPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyCompanyRoleToPermissionsPartial && !$this->isNew();
        if (null === $this->collSpyCompanyRoleToPermissions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCompanyRoleToPermission(SpyCompanyRoleToPermission $spyCompanyRoleToPermission)
    {
     ...
     */
    public function resetPartialSpyQuotePermissionGroupToPermissions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyQuotePermissionGroupToPermissions($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyQuotePermissionGroupToPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyQuotePermissionGroupToPermissionsPartial && !$this->isNew();
        if (null === $this->collSpyQuotePermissionGroupToPermissions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyQuotePermissionGroupToPermission(SpyQuotePermissionGroupToPermission $spyQuotePermissionGroupToPermission)
    {
     ...
     */
    public function resetPartialSpyShoppingListPermissionGroupToPermissions($v = true)
    {
     ...
     * @return void
     */
    public function initSpyShoppingListPermissionGroupToPermissions($overrideExisting = true)
    {
     ...
     * @throws PropelException
     */
    public function countSpyShoppingListPermissionGroupToPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collSpyShoppingListPermissionGroupToPermissionsPartial && !$this->isNew();
        if (null === $this->collSpyShoppingListPermissionGroupToPermissions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyShoppingListPermissionGroupToPermission(SpyShoppingListPermissionGroupToPermission $spyShoppingListPermissionGroupToPermission)
    {
     ...
     * @return bool
     */
    public function isCompanyRoleIdCompanyRoleToPermissionsLoaded()
    {
     ...
     */
    public function getCompanyRoleIdCompanyRoleToPermissions($criteria = null, ConnectionInterface $con = null)
    {
     ...
     */
    public function countCompanyRoleIdCompanyRoleToPermissions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->combinationCollCompanyRoleIdCompanyRoleToPermissionsPartial && !$this->isNew();
        if (null === $this->combinationCollCompanyRoleIdCompanyRoleToPermissions || null !== $criteria || $partial) {
     ...
     * @return integer
     */
    public function countCompanyRoles($idCompanyRoleToPermission = null, Criteria $criteria = null, ConnectionInterface $con = null)
    {
