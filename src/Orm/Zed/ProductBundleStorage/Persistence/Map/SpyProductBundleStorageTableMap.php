...
class SpyProductBundleStorageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductBundleStorage.Persistence.Map.SpyProductBundleStorageTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_bundle_storage';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductBundleStorage\\Persistence\\SpyProductBundleStorage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductBundleStorage.Persistence.SpyProductBundleStorage';
     ...
     */
    const COL_ID_PRODUCT_BUNDLE_STORAGE = 'spy_product_bundle_storage.id_product_bundle_storage';

    /**
     * the column name for the fk_product field
     */
    const COL_FK_PRODUCT = 'spy_product_bundle_storage.fk_product';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'spy_product_bundle_storage.data';

    /**
     * the column name for the key field
     */
    const COL_KEY = 'spy_product_bundle_storage.key';

    /**
     * the column name for the alias_keys field
     */
    const COL_ALIAS_KEYS = 'spy_product_bundle_storage.alias_keys';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_product_bundle_storage.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_product_bundle_storage.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductBundleStorage', 'FkProduct', 'Data', 'Key', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idProductBundleStorage', 'fkProduct', 'data', 'key', 'aliasKeys', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyProductBundleStorageTableMap::COL_ID_PRODUCT_BUNDLE_STORAGE, SpyProductBundleStorageTableMap::COL_FK_PRODUCT, SpyProductBundleStorageTableMap::COL_DATA, SpyProductBundleStorageTableMap::COL_KEY, SpyProductBundleStorageTableMap::COL_ALIAS_KEYS, SpyProductBundleStorageTableMap::COL_CREATED_AT, SpyProductBundleStorageTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_product_bundle_storage', 'fk_product', 'data', 'key', 'alias_keys', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductBundleStorage' => 0, 'FkProduct' => 1, 'Data' => 2, 'Key' => 3, 'AliasKeys' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idProductBundleStorage' => 0, 'fkProduct' => 1, 'data' => 2, 'key' => 3, 'aliasKeys' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyProductBundleStorageTableMap::COL_ID_PRODUCT_BUNDLE_STORAGE => 0, SpyProductBundleStorageTableMap::COL_FK_PRODUCT => 1, SpyProductBundleStorageTableMap::COL_DATA => 2, SpyProductBundleStorageTableMap::COL_KEY => 3, SpyProductBundleStorageTableMap::COL_ALIAS_KEYS => 4, SpyProductBundleStorageTableMap::COL_CREATED_AT => 5, SpyProductBundleStorageTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_product_bundle_storage' => 0, 'fk_product' => 1, 'data' => 2, 'key' => 3, 'alias_keys' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
...
} // SpyProductBundleStorageTableMap
