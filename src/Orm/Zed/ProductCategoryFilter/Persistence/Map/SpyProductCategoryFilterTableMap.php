...
class SpyProductCategoryFilterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.ProductCategoryFilter.Persistence.Map.SpyProductCategoryFilterTableMap';
     ...
     */
    const TABLE_NAME = 'spy_product_category_filter';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\ProductCategoryFilter\\Persistence\\SpyProductCategoryFilter';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.ProductCategoryFilter.Persistence.SpyProductCategoryFilter';
     ...
     */
    const COL_ID_PRODUCT_CATEGORY_FILTER = 'spy_product_category_filter.id_product_category_filter';

    /**
     * the column name for the fk_category field
     */
    const COL_FK_CATEGORY = 'spy_product_category_filter.fk_category';

    /**
     * the column name for the filter_data field
     */
    const COL_FILTER_DATA = 'spy_product_category_filter.filter_data';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdProductCategoryFilter', 'FkCategory', 'FilterData', ),
        self::TYPE_CAMELNAME     => array('idProductCategoryFilter', 'fkCategory', 'filterData', ),
        self::TYPE_COLNAME       => array(SpyProductCategoryFilterTableMap::COL_ID_PRODUCT_CATEGORY_FILTER, SpyProductCategoryFilterTableMap::COL_FK_CATEGORY, SpyProductCategoryFilterTableMap::COL_FILTER_DATA, ),
        self::TYPE_FIELDNAME     => array('id_product_category_filter', 'fk_category', 'filter_data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdProductCategoryFilter' => 0, 'FkCategory' => 1, 'FilterData' => 2, ),
        self::TYPE_CAMELNAME     => array('idProductCategoryFilter' => 0, 'fkCategory' => 1, 'filterData' => 2, ),
        self::TYPE_COLNAME       => array(SpyProductCategoryFilterTableMap::COL_ID_PRODUCT_CATEGORY_FILTER => 0, SpyProductCategoryFilterTableMap::COL_FK_CATEGORY => 1, SpyProductCategoryFilterTableMap::COL_FILTER_DATA => 2, ),
        self::TYPE_FIELDNAME     => array('id_product_category_filter' => 0, 'fk_category' => 1, 'filter_data' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
...
} // SpyProductCategoryFilterTableMap
