 ...
 *
 * @method     ChildSpyProductCategoryFilter[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyProductCategoryFilter objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategoryFilter> find(ConnectionInterface $con = null) Return ChildSpyProductCategoryFilter objects based on current ModelCriteria
 * @method     ChildSpyProductCategoryFilter[]|ObjectCollection findByIdProductCategoryFilter(int $id_product_category_filter) Return ChildSpyProductCategoryFilter objects filtered by the id_product_category_filter column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategoryFilter> findByIdProductCategoryFilter(int $id_product_category_filter) Return ChildSpyProductCategoryFilter objects filtered by the id_product_category_filter column
 * @method     ChildSpyProductCategoryFilter[]|ObjectCollection findByFkCategory(int $fk_category) Return ChildSpyProductCategoryFilter objects filtered by the fk_category column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategoryFilter> findByFkCategory(int $fk_category) Return ChildSpyProductCategoryFilter objects filtered by the fk_category column
 * @method     ChildSpyProductCategoryFilter[]|ObjectCollection findByFilterData(string $filter_data) Return ChildSpyProductCategoryFilter objects filtered by the filter_data column
 * @psalm-method ObjectCollection&\Traversable<ChildSpyProductCategoryFilter> findByFilterData(string $filter_data) Return ChildSpyProductCategoryFilter objects filtered by the filter_data column
...
abstract class SpyProductCategoryFilterQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildSpyProductCategoryFilterQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(SpyProductCategoryFilterTableMap::COL_ID_PRODUCT_CATEGORY_FILTER, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SpyProductCategoryFilterTableMap::COL_ID_PRODUCT_CATEGORY_FILTER, $keys, Criteria::IN);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildSpyProductCategoryFilterQuery The current query, for fluid interface
     */
