...
class SpyCustomerNoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Orm.Zed.CustomerNote.Persistence.Map.SpyCustomerNoteTableMap';
     ...
     */
    const TABLE_NAME = 'spy_customer_note';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\CustomerNote\\Persistence\\SpyCustomerNote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Orm.Zed.CustomerNote.Persistence.SpyCustomerNote';
     ...
     */
    const COL_ID_CUSTOMER_NOTE = 'spy_customer_note.id_customer_note';

    /**
     * the column name for the fk_customer field
     */
    const COL_FK_CUSTOMER = 'spy_customer_note.fk_customer';

    /**
     * the column name for the fk_user field
     */
    const COL_FK_USER = 'spy_customer_note.fk_user';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_customer_note.created_at';

    /**
     * the column name for the message field
     */
    const COL_MESSAGE = 'spy_customer_note.message';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_customer_note.updated_at';

    /**
     * the column name for the username field
     */
    const COL_USERNAME = 'spy_customer_note.username';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCustomerNote', 'FkCustomer', 'FkUser', 'CreatedAt', 'Message', 'UpdatedAt', 'Username', ),
        self::TYPE_CAMELNAME     => array('idCustomerNote', 'fkCustomer', 'fkUser', 'createdAt', 'message', 'updatedAt', 'username', ),
        self::TYPE_COLNAME       => array(SpyCustomerNoteTableMap::COL_ID_CUSTOMER_NOTE, SpyCustomerNoteTableMap::COL_FK_CUSTOMER, SpyCustomerNoteTableMap::COL_FK_USER, SpyCustomerNoteTableMap::COL_CREATED_AT, SpyCustomerNoteTableMap::COL_MESSAGE, SpyCustomerNoteTableMap::COL_UPDATED_AT, SpyCustomerNoteTableMap::COL_USERNAME, ),
        self::TYPE_FIELDNAME     => array('id_customer_note', 'fk_customer', 'fk_user', 'created_at', 'message', 'updated_at', 'username', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCustomerNote' => 0, 'FkCustomer' => 1, 'FkUser' => 2, 'CreatedAt' => 3, 'Message' => 4, 'UpdatedAt' => 5, 'Username' => 6, ),
        self::TYPE_CAMELNAME     => array('idCustomerNote' => 0, 'fkCustomer' => 1, 'fkUser' => 2, 'createdAt' => 3, 'message' => 4, 'updatedAt' => 5, 'username' => 6, ),
        self::TYPE_COLNAME       => array(SpyCustomerNoteTableMap::COL_ID_CUSTOMER_NOTE => 0, SpyCustomerNoteTableMap::COL_FK_CUSTOMER => 1, SpyCustomerNoteTableMap::COL_FK_USER => 2, SpyCustomerNoteTableMap::COL_CREATED_AT => 3, SpyCustomerNoteTableMap::COL_MESSAGE => 4, SpyCustomerNoteTableMap::COL_UPDATED_AT => 5, SpyCustomerNoteTableMap::COL_USERNAME => 6, ),
        self::TYPE_FIELDNAME     => array('id_customer_note' => 0, 'fk_customer' => 1, 'fk_user' => 2, 'created_at' => 3, 'message' => 4, 'updated_at' => 5, 'username' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
